...
assert(isreal(qJ) && all(size(qJ) == [2 1]), ...
  'S2RR2_energypot_fixb_slag_vp1: qJ has to be [2x1] (double)');
...
t10 = cos(qJ(1));
t8 = sin(qJ(1));
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (t10 * rSges(2,1) - t8 * rSges(2,2)) + g(2) * rSges(2,3) + g(3) * (-t8 * rSges(2,1) - t10 * rSges(2,2))) - m(3) * (g(2) * (t7 * rSges(3,1) + t9 * rSges(3,2)) + (g(1) * t12 - g(3) * t11) * t8 + (g(1) * t11 + g(3) * t12) * t10);
U  = t1;
