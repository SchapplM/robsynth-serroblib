...
%% Function calls
if link_index == 0
	JgD_rot=S3RPR1_jacobigD_rot_0_sym_varpar(qJ, qJD, pkin);
elseif link_index == 1
	JgD_rot=S3RPR1_jacobigD_rot_1_sym_varpar(qJ, qJD, pkin);
elseif link_index == 2
	JgD_rot=S3RPR1_jacobigD_rot_2_sym_varpar(qJ, qJD, pkin);
elseif link_index == 3
	JgD_rot=S3RPR1_jacobigD_rot_3_sym_varpar(qJ, qJD, pkin);
else
	JgD_rot=NaN(3,3);
end