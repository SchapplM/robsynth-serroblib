...
t29 = t32 * t30 + t34 * t37;
t28 = t34 * t30 - t32 * t37;
t1 = m(4) * (t28 ^ 2 + t29 ^ 2) / 0.2e1 + (m(3) * (t33 ^ 2 + t35 ^ 2) / 0.2e1 + m(2) / 0.2e1) * qJD(1) ^ 2 + (t28 * mrSges(4,1) - t29 * mrSges(4,2) + Ifges(4,3) * t31 / 0.2e1) * t31 + (Ifges(3,3) * qJD(2) / 0.2e1 + (t35 * mrSges(3,1) - t33 * mrSges(3,2)) * qJD(1)) * qJD(2);
T  = t1;
