...
%% Function calls
if link_index == 0
	Ja=S3RRP1_jacobia_0_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 1
	Ja=S3RRP1_jacobia_1_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 2
	Ja=S3RRP1_jacobia_2_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 3
	Ja=S3RRP1_jacobia_3_sym_varpar(qJ, r_i_i_C, pkin);
else
	Ja=NaN(6,3);
end