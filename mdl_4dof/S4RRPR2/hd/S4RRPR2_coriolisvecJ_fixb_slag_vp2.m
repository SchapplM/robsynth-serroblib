...
t17 = qJD(3) + t40;
t15 = -t21 * pkin(2) + t32;
t5 = -t29 * qJD(4) - t22 * t17 + t24 * t41;
t4 = t30 * qJD(4) + t24 * t17 + t22 * t41;
t8 = [-t4 * t46 + t5 * t20 * mrSges(5,1) + t17 * t47 + m(5) * (t2 * t29 + t3 * t30 + t7 * t4 + t6 * t5) + m(4) * (t14 * t19 + t16 * t17 + (t39 * qJD(1) + t15) * t41) + t36 + (-t21 * t40 - t34) * mrSges(3,2) + t45 * (-t21 * t41 - t35); mrSges(4,3) * t42 + m(4) * (t14 * qJ(3) + t16 * qJD(3)) + (t51 * mrSges(5,1) + t50 * mrSges(5,2)) * t20 + (-m(4) * (t15 * t23 + t16 * t25) + ((mrSges(3,2) - mrSges(4,3)) * t25 + t45 * t23) * t21 + (-t25 * mrSges(3,2) + (-m(4) * pkin(2) - t45) * t23) * qJD(2)) * t44 + t36 + (t2 * t28 + t3 * t27 - t50 * t7 + t51 * t6) * m(5); m(4) * t35 + m(5) * (t33 * qJD(4) + t2 * t22 + t3 * t24) - qJD(4) * t49 + (-m(4) * t16 - m(5) * t33 - t47 + t49) * t21; t6 * t46 - t1 + (t20 * t7 + t3) * mrSges(5,1);];
tauc  = t8(:);
