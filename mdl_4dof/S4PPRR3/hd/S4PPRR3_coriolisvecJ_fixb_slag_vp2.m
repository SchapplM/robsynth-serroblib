...
t9 = t25 * t13 - t32;
t8 = -t23 * t13 - t30;
t5 = -t27 * qJD(4) - t23 * t15 - t25 * t16;
t4 = t28 * qJD(4) + t25 * t15 - t23 * t16;
t3 = -qJD(4) * t7 - t23 * t11 - t25 * t12;
t2 = qJD(4) * t6 + t25 * t11 - t23 * t12;
t1 = t3 * mrSges(5,1);
t19 = [(t5 * mrSges(5,1) - t4 * mrSges(5,2)) * t20 + (-t16 * mrSges(4,1) - t15 * mrSges(4,2)) * qJD(3) + m(4) * (t11 * t18 - t12 * t17 - t13 * t16 + t14 * t15) + m(5) * (t2 * t27 + t3 * t28 + t7 * t4 + t6 * t5); 0; t1 - t8 * t33 - m(5) * (t6 * t8 + t7 * t9) + (t9 * t20 - t2) * mrSges(5,2) + (t13 * qJD(3) - t11) * mrSges(4,2) + (t14 * qJD(3) - t12) * mrSges(4,1) + (m(5) * (t2 * t23 + t3 * t25 + (-t23 * t6 + t25 * t7) * qJD(4)) + (-mrSges(5,1) * t23 - mrSges(5,2) * t25) * qJD(4) * t20) * pkin(3); t7 * t33 + t1 + (t20 * t6 - t2) * mrSges(5,2);];
tauc  = t19(:);
