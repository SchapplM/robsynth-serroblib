...
t1 = [0.2e1 * m(4) * (t10 * t6 - t9 * t7) + 0.2e1 * m(5) * (t5 * t2 + t4 * t3); 0; 0; -t7 * mrSges(4,1) - t6 * mrSges(4,2) + m(5) * (t13 * t2 + t15 * t3 + (-t13 * t4 + t15 * t5) * qJD(4)) * pkin(3) + t17; 0; 0.2e1 * t8; t17; 0; t8; 0;];
