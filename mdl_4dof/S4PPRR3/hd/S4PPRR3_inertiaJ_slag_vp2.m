...
% OptimizationMode: 2
% StartTime: 2018-11-14 14:08:21
% EndTime: 2018-11-14 14:08:21
...
t13 = (t10 * mrSges(5,1) - t8 * mrSges(5,2)) * pkin(3);
t1 = [m(2) + m(3) * (t6 ^ 2 + t7 ^ 2) + m(4) * (t4 ^ 2 + t5 ^ 2) + m(5) * (t2 ^ 2 + t3 ^ 2); 0; m(3) + m(4) + m(5); t4 * mrSges(4,1) - t5 * mrSges(4,2) + m(5) * (t10 * t2 + t3 * t8) * pkin(3) + t14; 0; Ifges(4,3) + Ifges(5,3) + m(5) * (t10 ^ 2 + t8 ^ 2) * pkin(3) ^ 2 + 0.2e1 * t13; t14; 0; Ifges(5,3) + t13; Ifges(5,3);];
