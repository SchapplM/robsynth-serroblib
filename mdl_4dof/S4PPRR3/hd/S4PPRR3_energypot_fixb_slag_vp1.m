...
t18 = cos(t21);
t17 = sin(t21);
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (qJ(1) + rSges(2,3)) + g(2) * rSges(2,1) + g(3) * rSges(2,2)) - m(3) * (g(1) * (t25 * rSges(3,1) + t26 * rSges(3,2) + qJ(1)) + g(2) * (t26 * rSges(3,1) - t25 * rSges(3,2) + pkin(1)) + g(3) * (-qJ(2) - rSges(3,3))) - m(4) * (g(1) * (t19 * rSges(4,1) + t20 * rSges(4,2) + t27) + g(2) * (t20 * rSges(4,1) - t19 * rSges(4,2) + t29) + g(3) * (-rSges(4,3) + t28)) - m(5) * (g(1) * (t17 * rSges(5,1) + t18 * rSges(5,2) + pkin(3) * t19 + t27) + g(2) * (t18 * rSges(5,1) - t17 * rSges(5,2) + pkin(3) * t20 + t29) + g(3) * (-pkin(5) - rSges(5,3) + t28));
U  = t1;
