...
t2 = cos(t5);
t1 = sin(t5);
t6 = -m(1) * (g(1) * (r_base(1) + rSges(1,1)) + g(2) * (r_base(2) + rSges(1,2)) + g(3) * (r_base(3) + rSges(1,3))) - m(2) * (g(1) * (rSges(2,3) + t15) + g(2) * (r_base(2) + rSges(2,1)) + g(3) * (r_base(3) + rSges(2,2))) - m(3) * (g(1) * (t9 * rSges(3,1) + t10 * rSges(3,2) + t15) + g(2) * (t10 * rSges(3,1) - t9 * rSges(3,2) + t16) + g(3) * (-rSges(3,3) + t14)) - m(4) * (g(1) * (t3 * rSges(4,1) + t4 * rSges(4,2) + t12) + g(2) * (t4 * rSges(4,1) - t3 * rSges(4,2) + t13) + g(3) * (-rSges(4,3) + t11)) - m(5) * (g(1) * (t1 * rSges(5,1) + t2 * rSges(5,2) + pkin(3) * t3 + t12) + g(2) * (t2 * rSges(5,1) - t1 * rSges(5,2) + pkin(3) * t4 + t13) + g(3) * (-pkin(5) - rSges(5,3) + t11));
U  = t6;
