...
t2 = -t19 * t31 - t22 * t6;
t1 = -t18 * t31 - t22 * t28;
t5 = [m(5) * t1 - t8 * t27; 0; m(5) * (t1 * (pkin(3) * t19 + t11) + t2 * (-pkin(3) * t18 - t10) + t4 * t14) + 0.2e1 * (-t24 / 0.2e1 + m(5) * (-t4 * t15 - t30) / 0.2e1) * t22 + 0.2e1 * (-t23 * t12 * t13 / 0.2e1 + t7 * t32) * m(4) + 0.2e1 * (t13 * t32 + (t7 / 0.2e1 + t25) * t12) * t27; m(5) * (t1 * t11 - t2 * t10 - t28 * t3 - t4 * t6) - t22 * t24;];
tauc  = t5(:);
