...
t18 = cos(t21);
t27 = sin(qJ(4));
t39 = qJD(4) * t27 * t7 + g(1) * t17 + g(2) * t18;
t5 = qJD(3) * pkin(3) + t6;
t38 = -pkin(3) * t24 - t5;
t35 = t46 * qJDD(1);
t9 = t11 * qJD(3);
...
t8 = t46 * qJD(3);
t3 = qJD(1) * t8 + t44;
t31 = -g(1) * t18 + g(2) * t17 + t29 * t2 - t27 * t3;
t20 = cos(t23);
t19 = sin(t23);
t1 = [qJDD(1) - g(1), -g(1) + (t25 ^ 2 + t26 ^ 2) * qJDD(1), 0, -t9 * qJD(3) + qJDD(3) * t46, -t8 * qJD(3) - t11 * qJDD(3), 0 (-qJD(4) * t33 - t27 * t8 - t29 * t9) * t24 + t34 * t22 -(qJD(4) * t34 - t27 * t9 + t29 * t8) * t24 - t33 * t22; 0, qJDD(2) + g(3), 0, 0, 0, 0, 0, 0; 0, 0, qJDD(3), -g(1) * t20 + g(2) * t19 + t35, g(1) * t19 + g(2) * t20 - t44, t22, t29 * t43 - (-t27 * t6 - t42) * t24 + (t38 * t27 - t42) * qJD(4) + t31 (t37 - t43) * t27 + (t38 * qJD(4) + t6 * t24 - t3) * t29 + t39; 0, 0, 0, 0, 0, t22, t31 + t45 * (-t27 * t5 - t42) t37 * t27 + (-t45 * t5 - t3) * t29 + t39;];
tau_reg  = t1;
