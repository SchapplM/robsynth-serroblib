...
t5 = cos(t7);
t4 = sin(t7);
t1 = [(-m(2) - t10) * g(1), t10 * g(3), -m(4) * (g(1) * (t5 * rSges(4,1) - t4 * rSges(4,2)) + g(2) * (-t4 * rSges(4,1) - t5 * rSges(4,2))) - m(5) * (g(1) * (pkin(3) * t5 + t9) + g(2) * (-pkin(3) * t4 + t8)) -m(5) * (g(1) * t9 + g(2) * t8)];
taug  = t1(:);
