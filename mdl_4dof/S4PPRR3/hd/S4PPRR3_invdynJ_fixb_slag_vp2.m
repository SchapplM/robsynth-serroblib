...
t26 = cos(t30);
t19 = t21 * qJD(3);
t12 = -qJD(1) * t19 + t20 * qJDD(1);
t10 = qJDD(3) * pkin(3) + t12;
t18 = t20 * qJD(3);
t11 = qJD(1) * t18 + t21 * qJDD(1);
t16 = t20 * qJD(1);
t15 = qJD(3) * pkin(3) + t16;
t7 = t36 * t15 + t47;
t3 = -qJD(4) * t7 + t38 * t10 - t36 * t11;
t31 = qJDD(3) + qJDD(4);
t42 = Ifges(5,3) * t31 + (-g(1) * t26 + t3) * mrSges(5,1);
t28 = sin(t32);
t29 = cos(t32);
t41 = -g(1) * t29 + g(2) * t28;
t6 = t38 * t15 - t49;
...
t40 = g(1) * t25 + g(2) * t26 - t2;
t33 = qJD(3) + qJD(4);
t9 = t38 * t16 - t49;
t8 = -t36 * t16 - t47;
t5 = -t14 * qJD(4) - t36 * t18 - t38 * t19;
t4 = t13 * qJD(4) + t38 * t18 - t36 * t19;
t1 = [(-t14 * t31 - t4 * t33) * mrSges(5,2) + (-t18 * qJD(3) - t21 * qJDD(3)) * mrSges(4,2) + (t13 * t31 + t5 * t33) * mrSges(5,1) + (-t19 * qJD(3) + t20 * qJDD(3)) * mrSges(4,1) + m(4) * (t11 * t21 + t12 * t20 - t16 * t19 + t17 * t18) + m(5) * (t3 * t13 + t2 * t14 + t7 * t4 + t6 * t5) + (-m(2) - t43) * g(1) + (m(2) + m(3) * (t34 ^ 2 + t35 ^ 2)) * qJDD(1); (g(3) + qJDD(2)) * t43; Ifges(4,3) * qJDD(3) - m(5) * (t6 * t8 + t7 * t9) + (-t8 * t33 + t50) * mrSges(5,1) + (t9 * t33 + t40) * mrSges(5,2) + (g(1) * t28 + g(2) * t29 + t16 * qJD(3) - t11) * mrSges(4,2) + (t17 * qJD(3) + t12 + t41) * mrSges(4,1) + ((-t36 * t31 - t33 * t44) * mrSges(5,2) + (t38 * t31 - t33 * t45) * mrSges(5,1) + (t2 * t36 + t3 * t38 + t7 * t44 - t6 * t45 + t41) * m(5)) * pkin(3) + t42; (t7 * t33 + t50) * mrSges(5,1) + (t6 * t33 + t40) * mrSges(5,2) + t42;];
tau  = t1;
