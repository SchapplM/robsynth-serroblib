...
t10 = m(2) * (t21 ^ 2 + t22 ^ 2 + t38) / 0.2e1 + m(1) * (V_base(1) ^ 2 + V_base(2) ^ 2 + t38) / 0.2e1 + m(3) * (t7 ^ 2 + t8 ^ 2 + t9 ^ 2) / 0.2e1 + m(5) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) / 0.2e1 + m(4) * (t4 ^ 2 + t5 ^ 2 + t6 ^ 2) / 0.2e1 + (V_base(2) * mrSges(1,1) - V_base(1) * mrSges(1,2) + Ifges(1,3) * V_base(6) / 0.2e1) * V_base(6) + (t21 * mrSges(2,1) - t22 * mrSges(2,2) + Ifges(2,3) * t32 / 0.2e1) * t32 + (-V_base(3) * mrSges(1,1) + V_base(1) * mrSges(1,3) + Ifges(1,6) * V_base(6) + Ifges(1,2) * V_base(5) / 0.2e1) * V_base(5) + (V_base(3) * mrSges(2,2) - t21 * mrSges(2,3) + Ifges(2,5) * t32 + Ifges(2,1) * t25 / 0.2e1) * t25 + (V_base(3) * mrSges(1,2) - V_base(2) * mrSges(1,3) + Ifges(1,4) * V_base(5) + Ifges(1,5) * V_base(6) + Ifges(1,1) * V_base(4) / 0.2e1) * V_base(4) + (-V_base(3) * mrSges(2,1) + t22 * mrSges(2,3) + Ifges(2,4) * t25 + Ifges(2,6) * t32 + Ifges(2,2) * t24 / 0.2e1) * t24 + (t7 * mrSges(3,1) - t8 * mrSges(3,2) + t5 * mrSges(4,2) + t3 * mrSges(5,2) - t6 * mrSges(4,3) - t1 * mrSges(5,3) + (Ifges(3,3) / 0.2e1 + Ifges(5,1) / 0.2e1 + Ifges(4,1) / 0.2e1) * t20) * t20 + (t5 * mrSges(4,1) + t1 * mrSges(5,1) + t9 * mrSges(3,2) - t2 * mrSges(5,2) - t7 * mrSges(3,3) - t4 * mrSges(4,3) + (Ifges(3,1) / 0.2e1 + Ifges(5,3) / 0.2e1 + Ifges(4,2) / 0.2e1) * t15 + (-Ifges(4,4) + Ifges(3,5) + Ifges(5,5)) * t20) * t15 + (t9 * mrSges(3,1) + t6 * mrSges(4,1) - t3 * mrSges(5,1) - t4 * mrSges(4,2) - t8 * mrSges(3,3) + t2 * mrSges(5,3) + (Ifges(3,2) / 0.2e1 + Ifges(5,2) / 0.2e1 + Ifges(4,3) / 0.2e1) * t14 + (Ifges(5,4) + Ifges(4,5) - Ifges(3,6)) * t20 + (-Ifges(3,4) - Ifges(4,6) + Ifges(5,6)) * t15) * t14;
T  = t10;
