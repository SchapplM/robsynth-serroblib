...
t1 = m(3) * (t53 ^ 2 + t54 ^ 2 + t58 ^ 2) / 0.2e1 + m(4) * (t50 ^ 2 + t51 ^ 2 + t52 ^ 2) / 0.2e1 + m(5) * (t47 ^ 2 + t48 ^ 2 + t49 ^ 2) / 0.2e1 + (Ifges(2,3) * qJD(1) / 0.2e1 + ((-t58 * mrSges(3,1) - t52 * mrSges(4,1) + t48 * mrSges(5,1) + t51 * mrSges(4,2) + t54 * mrSges(3,3) - t49 * mrSges(5,3) + (Ifges(5,2) / 0.2e1 + Ifges(3,2) / 0.2e1 + Ifges(4,3) / 0.2e1) * t66) * t61 + (t58 * mrSges(3,2) - t53 * mrSges(3,3) + t50 * mrSges(4,1) - t51 * mrSges(4,3) + t47 * mrSges(5,1) - t49 * mrSges(5,2) + (Ifges(5,3) / 0.2e1 + Ifges(3,1) / 0.2e1 + Ifges(4,2) / 0.2e1) * t59 * t70 + (Ifges(3,4) + Ifges(4,6) - Ifges(5,6)) * t66) * t59) * t60 + (-t54 * mrSges(3,2) + t53 * mrSges(3,1) + t50 * mrSges(4,2) - t52 * mrSges(4,3) + t48 * mrSges(5,2) - t47 * mrSges(5,3) + (Ifges(5,1) / 0.2e1 + Ifges(3,3) / 0.2e1 + Ifges(4,1) / 0.2e1) * t69 + ((-Ifges(5,4) - Ifges(4,5) + Ifges(3,6)) * t61 + (-Ifges(4,4) + Ifges(3,5) + Ifges(5,5)) * t59) * t70) * t62) * qJD(1);
T  = t1;
