...
elseif link_index == 4
	...
	t54 = -sin(t51) * t70 + t55;
	t1 = [-cos(qJ(1)) * t66 + t56, t56, t57, r_i_i_C(1) * t72 + t58 * r_i_i_C(2); -sin(qJ(1)) * t66 + t54, t54, t55, (-t45 * t67 + t61) * r_i_i_C(2) - t71 * r_i_i_C(1); 0, 0, 0, (-r_i_i_C(1) * t52 - r_i_i_C(2) * t53) * qJD(4);];
	JaD_transl = t1;
else
	JaD_transl=NaN(3,4);
end