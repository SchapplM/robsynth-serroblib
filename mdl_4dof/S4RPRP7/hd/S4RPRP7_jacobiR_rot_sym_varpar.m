...
function JR_rot = S4RPRP7_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(5,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RPRP7_jacobiR_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4RPRP7_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4RPRP7_jacobiR_rot_sym_varpar: pkin has to be [5x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t42 = t41 * t40;
	t37 = t39 * t38;
	t1 = [t43, 0, t44, 0; t37, 0, -t42, 0; 0, 0, -t38, 0; -t39, 0, 0, 0; t41, 0, 0, 0; 0, 0, 0, 0; -t42, 0, t37, 0; -t44, 0, -t43, 0; 0, 0, t40, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,4);
end