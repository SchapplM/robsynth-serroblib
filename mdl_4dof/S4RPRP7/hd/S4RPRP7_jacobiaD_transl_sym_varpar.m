...
function JaD_transl = S4RPRP7_jacobiaD_transl_sym_varpar(qJ, qJD, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RPRP7_jacobiaD_transl_sym_varpar: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'S4RPRP7_jacobiaD_transl_sym_varpar: qJD has to be [4x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S4RPRP7_jacobiaD_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4RPRP7_jacobiaD_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4RPRP7_jacobiaD_transl_sym_varpar: pkin has to be [5x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t140 = qJD(1) * t147;
	t139 = qJD(1) * t146;
	t138 = qJD(2) + (-pkin(1) - pkin(5) - r_i_i_C(2)) * qJD(1) - t151;
	t1 = [t138 * t137 - t148 * t145, t144, (t137 * t140 + t146 * t143) * t136 + (-t150 * t135 + t137 * t139) * t134, t134 * t143 - t136 * t144; t138 * t135 + t148 * t144, t145, (t135 * t140 - t146 * t142) * t136 + (t135 * t139 + t150 * t137) * t134, -t134 * t142 - t136 * t145; 0, 0, t151, qJD(3) * t136;];
	JaD_transl = t1;
else
	JaD_transl=NaN(3,4);
end