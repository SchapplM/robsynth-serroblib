...
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRPR3_energypot_fixb_reg2_slag_vp: pkin has to be [6x1] (double)');
...
t21 = cos(t24);
t20 = sin(t24);
t1 = [0, 0, 0, 0, 0, 0, -g(2), -g(3), -g(1), -t32, 0, 0, 0, 0, 0, 0, -g(1) * t28 - g(2) * t29, -g(1) * t29 + g(2) * t28, g(3), -g(2) * pkin(1) + g(3) * pkin(4) - t32, 0, 0, 0, 0, 0, 0, -g(1) * t22 - g(2) * t23, -g(1) * t23 + g(2) * t22, g(3), -g(1) * t30 - g(2) * t33 - g(3) * t31, 0, 0, 0, 0, 0, 0, -g(1) * t20 - g(2) * t21, -g(1) * t21 + g(2) * t20, g(3), -g(1) * (pkin(3) * t22 + t30) - g(2) * (pkin(3) * t23 + t33) - g(3) * (-pkin(5) + t31);];
U_reg  = t1;
