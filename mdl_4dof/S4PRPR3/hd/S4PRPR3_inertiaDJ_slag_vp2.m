...
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRPR3_inertiaDJ_slag_vp2: pkin has to be [6x1] (double)');
...
t1 = [0.2e1 * m(4) * (-t12 * t10 + t13 * t11) + 0.2e1 * m(5) * (t5 * t2 + t4 * t3); -t10 * mrSges(4,1) - t11 * mrSges(4,2) + (-t18 * mrSges(3,1) - t20 * mrSges(3,2)) * qJD(2) + m(5) * (t9 * t2 + t8 * t3 - t7 * t4 + t6 * t5) + m(4) * (-t10 * t16 + t11 * t15) * pkin(2) + t22; 0.2e1 * m(5) * (t9 * t6 - t8 * t7) + 0.2e1 * t21; 0; 0; 0; t22; t21; 0; 0;];
