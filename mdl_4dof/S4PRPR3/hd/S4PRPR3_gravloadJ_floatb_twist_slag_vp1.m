...
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRPR3_gravloadJ_floatb_twist_slag_vp1: pkin has to be [6x1] (double)');
...
t5 = cos(t8);
t4 = sin(t8);
t1 = [(-m(2) - m(3) - t13) * g(1), -m(3) * (g(1) * (rSges(3,1) * t10 - t9 * rSges(3,2)) + g(2) * (-t9 * rSges(3,1) - rSges(3,2) * t10)) - m(4) * (g(1) * (rSges(4,1) * t5 - rSges(4,2) * t4 + t7) + g(2) * (-rSges(4,1) * t4 - rSges(4,2) * t5 - t14)) - m(5) * (g(1) * (pkin(3) * t5 + t12 + t7) + g(2) * (-pkin(3) * t4 + t11 - t14)) t13 * g(3), -m(5) * (g(1) * t12 + g(2) * t11)];
taug  = t1(:);
