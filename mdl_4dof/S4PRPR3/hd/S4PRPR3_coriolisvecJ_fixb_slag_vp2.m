...
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRPR3_coriolisvecJ_fixb_slag_vp2: pkin has to be [6x1] (double)');
...
t39 = pkin(2) * t27;
t34 = t31 * t25 - t29 * t39;
t41 = t34 * qJD(4) + t29 * t17 - t31 * t19;
t35 = t29 * t25 + t31 * t39;
t40 = -t35 * qJD(4) + t31 * t17 + t29 * t19;
t38 = qJD(1) * t30;
...
t16 = qJD(1) * t20;
t15 = qJD(1) * t18;
t5 = -qJD(4) * t36 - t31 * t18 - t29 * t20;
t4 = qJD(4) * t37 - t29 * t18 + t31 * t20;
t3 = -qJD(4) * t7 - t31 * t15 - t29 * t16;
t2 = qJD(4) * t6 - t29 * t15 + t31 * t16;
t1 = t3 * mrSges(5,1);
t8 = [(t5 * mrSges(5,1) - t4 * mrSges(5,2)) * t26 + m(4) * (-t11 * t18 + t12 * t20 - t15 * t21 + t16 * t22) + m(5) * (t2 * t36 + t3 * t37 + t7 * t4 + t6 * t5) + (-t18 * mrSges(4,1) - t20 * mrSges(4,2) + (-t30 * mrSges(3,1) - t32 * mrSges(3,2)) * qJD(2)) * qJD(2); -t2 * mrSges(5,2) + t1 + (t19 * qJD(2) - t16) * mrSges(4,2) + (t17 * qJD(2) - t15) * mrSges(4,1) + (t40 * mrSges(5,1) - t41 * mrSges(5,2)) * t26 + (t2 * t35 + t3 * t34 + t40 * t6 + t41 * t7) * m(5) + ((-t15 * t28 + t16 * t27) * pkin(2) + t11 * t17 - t12 * t19) * m(4); 0; t7 * t26 * mrSges(5,1) + t1 + (t26 * t6 - t2) * mrSges(5,2);];
tauc  = t8(:);
