...
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRPR3_coriolismatJ_fixb_slag_vp2: pkin has to be [6x1] (double)');
...
t15 = t27 * t20 - t28 * t21;
t30 = t28 * t20 + t27 * t21;
t2 = -t15 * mrSges(5,1) - t30 * mrSges(5,2);
t39 = pkin(2) * t25;
...
t31 = t6 * qJD(4);
t29 = t6 * qJD(2);
t1 = [0, t2 * qJD(4) + (-t37 * mrSges(3,1) + t21 * mrSges(4,1) - t38 * mrSges(3,2) - t20 * mrSges(4,2) + m(5) * (-t15 * t17 + t18 * t30) + m(4) * (t20 * t25 + t21 * t26) * pkin(2) + t2) * qJD(2), 0 (qJD(4) + qJD(2)) * t2; 0, -t31, 0, -t29 - t31; 0, 0, 0, 0; 0, t29, 0, 0;];
Cq  = t1;
