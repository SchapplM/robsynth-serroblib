...
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRPR3_gravloadJ_floatb_twist_slag_vp2: pkin has to be [6x1] (double)');
...
% Computational Cost: add. (46->19), mult. (40->20), div. (0->0), fcn. (22->6), ass. (0->14)
t13 = m(4) + m(5);
...
t5 = cos(t7);
t4 = sin(t7);
t1 = [(-m(2) - m(3) - t13) * g(1) (t9 * mrSges(3,2) + t5 * mrSges(4,2) + t12 * t4 + t14 * t8 - t10) * g(2) + (t8 * mrSges(3,2) + t4 * mrSges(4,2) - t12 * t5 - t14 * t9 - t11) * g(1), t13 * g(3), -g(1) * t11 - g(2) * t10];
taug  = t1(:);
