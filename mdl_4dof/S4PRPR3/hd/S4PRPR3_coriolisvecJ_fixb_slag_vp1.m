...
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRPR3_coriolisvecJ_fixb_slag_vp1: pkin has to be [6x1] (double)');
...
t2 = -t29 * t8 - t33 * t49;
t1 = -t29 * t41 + t33 * t38;
t5 = [-m(3) * qJD(2) * t15 + m(4) * t33 * (-t25 * rSges(4,1) - t26 * rSges(4,2) - t44) + m(5) * t1; (-t14 * t15 + (-t15 * t19 + 0.2e1 * t18 * t40) * qJD(2) - (-qJD(2) * t14 + t19 * t33) * t18) * m(3) + m(5) * (t1 * (t11 + t49) + t2 * (-t10 + t38)); 0; (t1 * t11 - t2 * t10 - t3 * t41 - t4 * t8 - (-t3 * t10 - t4 * t11) * t29) * m(5);];
tauc  = t5(:);
