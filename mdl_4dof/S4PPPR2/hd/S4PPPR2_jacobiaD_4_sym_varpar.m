...
function JaD = S4PPPR2_jacobiaD_4_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)

JaD_transl = S4PPPR2_jacobiaD_transl_4_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin);
JaD_rot = S4PPPR2_jacobiaD_rot_4_sym_varpar(qJ, qJD, ...
  pkin);
