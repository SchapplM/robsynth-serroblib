...
function JR_rot = S4RRRP5_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(6,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RRRP5_jacobiR_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4RRRP5_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4RRRP5_jacobiR_rot_sym_varpar: pkin has to be [6x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t66 = t71 * t68;
	t65 = t70 * t68;
	t1 = [-t65, -t72, -t72, 0; t66, -t73, -t73, 0; 0, t68, t68, 0; t71, 0, 0, 0; t70, 0, 0, 0; 0, 0, 0, 0; -t73, t66, t66, 0; t72, t65, t65, 0; 0, t67, t67, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,4);
end