...
function Ja_transl = S4RRRP5_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RRRP5_jacobia_transl_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S4RRRP5_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4RRRP5_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4RRRP5_jacobia_transl_sym_varpar: pkin has to be [6x1] (double)');
if link_index == 0
	%% Symbolic Calculation
	% From jacobia_transl_0_floatb_twist_matlab.m
	% OptimizationMode: 2
	% StartTime: 2019-12-31 17:17:25
	% EndTime: 2019-12-31 17:17:25
...
elseif link_index == 4
	...
	t16 = cos(qJ(1));
	t25 = t30 * t16;
	t23 = r_i_i_C(2) + pkin(6) + pkin(5);
	t20 = t27 * t10;
	t18 = -sin(qJ(2)) * pkin(2) - t20;
	t1 = [-t28 * t15 + t23 * t16, t18 * t16 + t25, -t16 * t20 + t25, t16 * t10; t23 * t15 + t28 * t16, t18 * t15 + t26, -t15 * t20 + t26, t15 * t10; 0, t31, t19, -t11;];
	Ja_transl = t1;
else
	Ja_transl=NaN(3,4);
end