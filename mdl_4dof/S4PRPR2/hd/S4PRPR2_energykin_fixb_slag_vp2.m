...
t41 = t50 * t42 + t52 * t44;
t40 = t52 * t42 - t50 * t44;
t1 = m(4) * (t43 ^ 2 + t44 ^ 2 + t54) / 0.2e1 + m(5) * (t40 ^ 2 + t41 ^ 2 + t54) / 0.2e1 + (m(2) / 0.2e1 + m(3) * (t51 ^ 2 + t53 ^ 2) / 0.2e1) * qJD(1) ^ 2 + (t40 * mrSges(5,1) - t41 * mrSges(5,2) + Ifges(5,3) * t47 / 0.2e1) * t47 + (t43 * mrSges(4,1) - t44 * mrSges(4,2) + (mrSges(3,1) * t53 - mrSges(3,2) * t51) * qJD(1) + (Ifges(3,3) / 0.2e1 + Ifges(4,3) / 0.2e1) * qJD(2)) * qJD(2);
T  = t1;
