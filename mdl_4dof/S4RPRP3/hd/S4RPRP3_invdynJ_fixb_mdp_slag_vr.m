...
%% Coder Information
%#codegen
%$cgargs {zeros(27,1), zeros(13,1)}
assert(isreal(MDP) && all(size(MDP) == [13 1]), ...
  'S4RPRP3_invdynJ_fixb_mdp_slag_vr: MDP has to be [13x1] (double)'); 

%% Symbolic Calculation
% From invdyn_joint_fixb_mdp_mult_matlab.m
t1 = [RV(1) * MDP(1) + RV(2) * MDP(2) + RV(3) * MDP(3) + RV(4) * MDP(4) + RV(6) * MDP(5) + RV(8) * MDP(6) + RV(10) * MDP(7) + RV(12) * MDP(8) + RV(15) * MDP(10) + RV(18) * MDP(11) + RV(21) * MDP(12) + RV(24) * MDP(13); RV(5) * MDP(4) + RV(16) * MDP(10) + RV(19) * MDP(11) + RV(25) * MDP(13); RV(7) * MDP(5) + RV(9) * MDP(6) + RV(11) * MDP(7) + RV(13) * MDP(8) + RV(14) * MDP(9) + RV(17) * MDP(10) + RV(20) * MDP(11) + RV(22) * MDP(12) + RV(26) * MDP(13); RV(23) * MDP(12) + RV(27) * MDP(13);];
tauJ = t1;
