...
function JR_rot = S4RRRP7_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(6,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RRRP7_jacobiR_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4RRRP7_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4RRRP7_jacobiR_rot_sym_varpar: pkin has to be [6x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t72 = -t80 * t75 + t77 * t84;
	t71 = -t77 * t85 - t82;
	t1 = [-t72, -t76 * t82, -t73, 0; t74, -t76 * t86, t71, 0; 0, t84, -t76 * t75, 0; -t87, t81, 0, 0; t83, t77 * t79, 0, 0; 0, t76, 0, 0; t71, -t75 * t83, t74, 0; t73, -t75 * t87, t72, 0; 0, t85, t76 * t78, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,4);
end