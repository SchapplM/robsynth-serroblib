...
%% Coder Information
%#codegen
%$cgargs {zeros(50,1), zeros(21,1)}
assert(isreal(MDP) && all(size(MDP) == [21 1]), ...
  'S4RRPR6_invdynJ_fixb_mdp_slag_vr: MDP has to be [21x1] (double)'); 

%% Symbolic Calculation
% From invdyn_joint_fixb_mdp_mult_matlab.m
% OptimizationMode: 2
% StartTime: 2021-01-15 10:46:34
% EndTime: 2021-01-15 10:46:34
% DurationCPUTime: 0.03s
% Computational Cost: add. (46->46), mult. (50->50), div. (0->0), fcn. (50->50), ass. (0->1)
