% Umwandlung der Kinematikparameter von S4RRPR6V1 zu S4RRPR6
% Eingabe:
% pkin_var (5x1) double
...
%
% Siehe auch: S4RRPR6_structural_kinematic_parameters.m
function pkin_gen = S4RRPR6V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(7,1);
