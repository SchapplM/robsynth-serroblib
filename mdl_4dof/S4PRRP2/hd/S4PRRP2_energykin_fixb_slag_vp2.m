...
t35 = t37 ^ 2;
t34 = pkin(3) * t41 + t36;
t1 = m(4) * (t36 ^ 2 + t35) / 0.2e1 + m(5) * (qJD(4) ^ 2 + t34 ^ 2 + t35) / 0.2e1 + (m(3) * (t43 ^ 2 + t45 ^ 2) / 0.2e1 + m(2) / 0.2e1) * qJD(1) ^ 2 + (Ifges(3,3) * qJD(2) / 0.2e1 + (t45 * mrSges(3,1) - t43 * mrSges(3,2)) * qJD(1)) * qJD(2) + (t36 * mrSges(4,1) + t34 * mrSges(5,1) + (-mrSges(4,2) - mrSges(5,2)) * t37 + (Ifges(4,3) / 0.2e1 + Ifges(5,3) / 0.2e1) * t41) * t41;
T  = t1;
