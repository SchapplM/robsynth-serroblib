...
t1 = m(4) * (t49 + (t46 ^ 2 + t47 ^ 2) * pkin(2) ^ 2 * t48) / 0.2e1 + m(5) * (t42 ^ 2 + t43 ^ 2 + t49) / 0.2e1 + t48 * Ifges(3,3) / 0.2e1 + (m(2) + m(3)) * t49 / 0.2e1 + (-t42 * mrSges(5,1) + t43 * mrSges(5,3) + (mrSges(4,1) * t47 - mrSges(4,2) * t46) * t51 + (Ifges(5,2) / 0.2e1 + Ifges(4,3) / 0.2e1) * t45) * t45;
T  = t1;
