...
%% Function calls
if link_index == 0
	Ja_transl=S4PRRP1_jacobia_transl_0_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 1
	Ja_transl=S4PRRP1_jacobia_transl_1_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 2
	Ja_transl=S4PRRP1_jacobia_transl_2_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 3
	Ja_transl=S4PRRP1_jacobia_transl_3_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 4
	Ja_transl=S4PRRP1_jacobia_transl_4_sym_varpar(qJ, r_i_i_C, pkin);
else
	Ja_transl=NaN(3,4);
end