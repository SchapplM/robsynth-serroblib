...
assert(isreal(Ifges) && all(size(Ifges) == [5 6]), ...
  'S4RRPP1_convert_par2_MPV_fixb: Ifges has to be [5x6] (double)'); 

%% Symbolic Calculation
% From minimal_parameter_vector_fixb_matlab.m
t40 = sin(pkin(6));
t41 = cos(pkin(6));
t42 = t41 * mrSges(4,1) - t40 * mrSges(4,2);
t1 = [pkin(1) ^ 2 * m(3) + Ifges(2,3); m(3) * pkin(1) + mrSges(2,1); mrSges(2,2); 0.2e1 * pkin(2) * t42 + Ifges(5,2) + Ifges(3,3) + Ifges(4,3); mrSges(3,1) + t42; t40 * mrSges(4,1) + t41 * mrSges(4,2) + mrSges(3,2); m(4); mrSges(5,1); mrSges(5,3); m(5);];
MPV  = t1;
