...
function JaD = S4PPRP2_jacobiaD_2_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)

JaD_transl = S4PPRP2_jacobiaD_transl_2_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin);
JaD_rot = S4PPRP2_jacobiaD_rot_2_sym_varpar(qJ, qJD, ...
  pkin);
