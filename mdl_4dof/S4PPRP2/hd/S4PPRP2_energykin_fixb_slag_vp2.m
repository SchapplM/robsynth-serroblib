...
t1 = m(4) * (t35 ^ 2 + t36 ^ 2 + t44) / 0.2e1 + m(5) * (t33 ^ 2 + t34 ^ 2 + t44) / 0.2e1 + m(2) * t45 / 0.2e1 + m(3) * (t44 + (t39 ^ 2 + t40 ^ 2) * t45) / 0.2e1 + (-t35 * mrSges(4,1) - t33 * mrSges(5,1) - t36 * mrSges(4,2) + t34 * mrSges(5,3) + (Ifges(5,2) / 0.2e1 + Ifges(4,3) / 0.2e1) * qJD(3)) * qJD(3);
T  = t1;
