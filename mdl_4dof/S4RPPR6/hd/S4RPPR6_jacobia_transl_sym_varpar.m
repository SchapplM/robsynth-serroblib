...
elseif link_index == 3
	...
	t4 = cos(qJ(1));
	t3 = sin(qJ(1));
	t5 = [-t3 * t8 + t4 * t6, t3, t4 * t1, 0; t3 * t6 + t4 * t8, -t4, t3 * t1, 0; 0, 0, -t2, 0;];
	Ja_transl = t5;
elseif link_index == 4
	%% Symbolic Calculation
	...
	t2 = t11 * t8;
	t1 = t12 * t8;
	t13 = [-t2 * r_i_i_C(1) - t1 * r_i_i_C(2) + t14 * t10 - t16 * t8, t8, t10 * t5, r_i_i_C(1) * t3 - r_i_i_C(2) * t4; t4 * r_i_i_C(1) + t3 * r_i_i_C(2) + t16 * t10 + t14 * t8, -t10, t8 * t5, r_i_i_C(1) * t1 - r_i_i_C(2) * t2; 0, 0, -t6, -t11 * r_i_i_C(1) - t12 * r_i_i_C(2);];
	Ja_transl = t13;
else
	Ja_transl=NaN(3,4);
end