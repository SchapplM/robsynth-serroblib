...
t118 = t95 * t144;
t51 = -t118 + t139;
t168 = -t51 * rSges(5,1) - rSges(5,2) * t107 - pkin(3) * t139;
t101 = t107 * qJD(3);
t25 = t107 * qJD(1) - t101;
t124 = qJD(1) * t96;
t157 = t51 * qJD(3) - t94 * t124;
t26 = -qJD(1) * t118 - t157;
t11 = rSges(4,1) * t25 - rSges(4,2) * t26;
t132 = t51 * rSges(4,1) + rSges(4,2) * t107;
t122 = qJD(1) * qJD(2);
t128 = qJDD(2) * t95 + t96 * t122;
t91 = t96 * pkin(1);
t60 = t95 * qJ(2) + t91;
t84 = qJD(2) * t96;
t39 = qJD(1) * t60 - t84;
...
t163 = t93 * t132;
t160 = t27 * t93;
t30 = rSges(5,1) * t107 - t51 * rSges(5,2);
t71 = pkin(3) * t138;
t116 = -t96 * t79 - t30 - t71;
t159 = t90 + t116;
t158 = -t25 * rSges(5,1) + t26 * rSges(5,2) - qJD(1) * t71 - t79 * t124;
t156 = t60 + t90;
t61 = t96 * rSges(3,1) + t95 * rSges(3,3);
t155 = pkin(3) * t118 + t168;
t154 = pkin(3) * t117 + t71;
t153 = -pkin(2) * t124 - pkin(3) * t101 - t158;
t100 = -t26 * rSges(5,1) - t25 * rSges(5,2) + t157 * pkin(3);
...
t5 = [-m(2) * (-g(1) * t59 + g(2) * t62) - t110 + (Icges(2,3) + Icges(3,2) + m(2) * (t59 ^ 2 + t62 ^ 2)) * qJDD(1) + (-(-t7 + t109 + t164) * t8 + t7 * (qJD(3) * t154 + t158 + t84) + t8 * (-t100 + t127) + (-t7 * t91 + (-t7 * qJ(2) + t8 * (-pkin(1) - t79)) * t95) * qJD(1) + (-g(2) + t2) * (-t116 + t60) + (-g(1) + t1) * (-t57 + t166)) * m(5) + (-(t109 - t15 + t163) * t16 + t15 * (-t11 + t84) + t16 * (t12 + t127) + (t15 * t148 * t96 + (-t15 * qJ(2) + t16 * t148) * t95) * qJD(1) + t165 * (-t27 + t156) + t167 * (t148 * t95 + t132 + t86)) * m(4) + (-(-qJD(1) * t58 + t126 - t32) * t33 + t32 * t84 + t33 * (t81 + t127) + (t32 * t146 * t96 + (t32 * (-rSges(3,3) - qJ(2)) + t33 * t146) * t95) * qJD(1) + (-g(2) + t10) * t38 + (-g(1) + t9) * (t146 * t95 + t86 + t88)) * m(3); (-m(3) - m(4) - m(5)) * (g(1) * t95 - g(2) * t96) + 0.2e1 * (t1 * t150 + t2 * t149) * m(5) + 0.2e1 * (t4 * t149 + t3 * t150) * m(4) + 0.2e1 * (t10 * t149 + t9 * t150) * m(3); t110 + (-g(1) * t155 + g(2) * t104 - t1 * t135 + t7 * t153 + t2 * t159 - t8 * t152 - (t7 * t104 + t155 * t8) * t93) * m(5) + (-t12 * t16 + (t11 + t160) * t15 - (-t16 * t93 + t167) * t132 + t165 * t27) * m(4); (g(3) + qJDD(4)) * m(5);];
tau  = t5;
