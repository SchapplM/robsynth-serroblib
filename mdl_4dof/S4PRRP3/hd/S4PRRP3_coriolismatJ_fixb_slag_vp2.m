...
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4PRRP3_coriolismatJ_fixb_slag_vp2: pkin has to be [5x1] (double)');
...
t21 = t7 * qJD(2);
t11 = t15 * t26;
t2 = [0, t22 + (-t18 * mrSges(3,1) - t20 * mrSges(3,2) + m(4) * (t16 * t25 + t11) + m(5) * (t11 + (pkin(3) + t25) * t16) + t31) * qJD(2), t1 * qJD(2) + t22, 0; 0, -t7 * qJD(3) (-t28 * t17 - t19 * t29) * qJD(3) * pkin(2) - t21, 0; 0, t21, 0, 0; 0, 0, 0, 0;];
Cq  = t2;
