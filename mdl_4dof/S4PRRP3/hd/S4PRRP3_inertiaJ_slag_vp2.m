...
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4PRRP3_inertiaJ_slag_vp2: pkin has to be [5x1] (double)');
...
t5 = -t10 * t9 + t11 * t12;
t6 = t10 * t11 + t12 * t9;
t14 = t17 * t6 + (mrSges(4,1) + mrSges(5,1)) * t5;
t13 = pkin(2) ^ 2;
t8 = t9 ^ 2 * t13;
t7 = pkin(3) + t19;
t2 = t9 * pkin(2) * t6;
t1 = [m(2) + m(3) * (t10 ^ 2 + t12 ^ 2) + 0.2e1 * (m(4) / 0.2e1 + m(5) / 0.2e1) * (t5 ^ 2 + t6 ^ 2); t12 * mrSges(3,1) - t10 * mrSges(3,2) + m(4) * (t5 * t19 + t2) + m(5) * (t5 * t7 + t2) + t14; t7 * t21 + Ifges(3,3) + m(4) * (t11 ^ 2 * t13 + t8) + m(5) * (t7 ^ 2 + t8) + 0.2e1 * t22 + t16; t5 * t20 + t14; t7 * t20 + (pkin(3) + t7) * mrSges(5,1) + t22 + t16; (t21 + t20) * pkin(3) + t16; 0; 0; 0; m(5);];
