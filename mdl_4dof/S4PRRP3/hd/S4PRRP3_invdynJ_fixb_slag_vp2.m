...
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4PRRP3_invdynJ_fixb_slag_vp2: pkin has to be [5x1] (double)');
...
t14 = t36 * pkin(3) + t15;
t12 = t36 * t22;
t1 = [m(2) * qJDD(1) + (-t39 * qJDD(2) - t42 * t41) * mrSges(3,2) + (t41 * qJDD(2) - t42 * t39) * mrSges(3,1) + m(3) * (t23 * t41 + t24 * t39) + m(4) * (-t15 * t12 + t7 * t21 + t56) + m(5) * (-t14 * t12 + t3 * t21 + t56) + (-t11 * t53 - t12 * t54) * t36 + (t21 * t54 - t22 * t53) * t35 + (-m(2) - m(3) - t57) * g(1); Ifges(3,3) * qJDD(2) + (-t24 + t45) * mrSges(3,2) + (t23 + t46) * mrSges(3,1) + (t41 * mrSges(3,2) + t47 + t59 * t39 + (t54 + t58) * t33) * g(2) + (t39 * mrSges(3,2) - t34 * t58 - t59 * t41 + t44) * g(1) + (t29 * mrSges(5,1) + (mrSges(4,1) * t40 - t38 * t53) * pkin(2)) * t35 + (t53 * t19 + t54 * t18 + (-t38 * t54 - t40 * t53) * t52) * t36 + t43 + (t3 * t29 + (-pkin(2) * t50 + t18) * t14 + t60) * m(5) + (t15 * t18 + (-t15 * t50 + t40 * t7) * pkin(2) + t60) * m(4); (t54 * t33 + t47) * g(2) + t44 * g(1) + (t35 * mrSges(5,1) + (-g(1) * t34 + g(2) * t33 + t3) * m(5)) * pkin(3) + t53 * t15 * t36 + t43 + (-m(5) * (-t14 + t15) + t54 * t36) * t16; (g(3) + qJDD(4)) * m(5);];
tau  = t1;
