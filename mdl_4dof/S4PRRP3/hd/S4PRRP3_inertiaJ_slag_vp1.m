...
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4PRRP3_inertiaJ_slag_vp1: pkin has to be [5x1] (double)');
...
% OptimizationMode: 2
% StartTime: 2018-11-14 14:12:23
% EndTime: 2018-11-14 14:12:23
...
t14 = sin(t17);
t15 = cos(t17);
t8 = t15 * rSges(4,1) - t14 * rSges(4,2);
t4 = -t14 * rSges(5,2) + t22 * t15;
t7 = -t14 * rSges(4,1) - t15 * rSges(4,2);
t3 = -t15 * rSges(5,2) - t22 * t14;
t19 = cos(qJ(2));
t16 = t19 * pkin(2);
...
t2 = t16 + t4;
t1 = t3 - t21;
t11 = [m(2) + m(3) + m(4) + m(5); m(3) * t10 + m(4) * t6 + m(5) * t2; Icges(3,3) + m(3) * (t10 ^ 2 + t9 ^ 2) + m(4) * (t5 ^ 2 + t6 ^ 2) + m(5) * (t1 ^ 2 + t2 ^ 2) + t20; m(4) * t8 + m(5) * t4; m(4) * (t7 * t5 + t8 * t6) + m(5) * (t3 * t1 + t4 * t2) + t20; m(4) * (t7 ^ 2 + t8 ^ 2) + m(5) * (t3 ^ 2 + t4 ^ 2) + t20; 0; 0; 0; m(5);];
