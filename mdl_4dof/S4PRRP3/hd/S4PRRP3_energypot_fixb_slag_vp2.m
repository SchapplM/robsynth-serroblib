...
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4PRRP3_energypot_fixb_slag_vp2: pkin has to be [5x1] (double)');
...
t19 = cos(t22);
t18 = sin(t22);
t1 = (-mrSges(1,3) - mrSges(2,2) + m(3) * pkin(4) + mrSges(3,3) - m(4) * t28 + mrSges(4,3) - m(5) * (-qJ(4) + t28) + mrSges(5,3)) * g(3) + (-m(3) * pkin(1) - t24 * mrSges(3,1) + t23 * mrSges(3,2) + t26 * t18 + t25 * t19 - mrSges(2,1) - mrSges(1,2) + t29 * (t24 * pkin(2) + pkin(1))) * g(2) + (-t24 * mrSges(3,2) - mrSges(1,1) - mrSges(2,3) - t26 * t19 + t25 * t18 + (-m(2) - m(3) + t29) * qJ(1) + (t29 * pkin(2) - mrSges(3,1)) * t23) * g(1);
U  = t1;
