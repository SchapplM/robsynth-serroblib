...
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4PRRP3_inertiaDJ_slag_vp2: pkin has to be [5x1] (double)');
...
t15 = t19 * t5 - t25 * t6;
t10 = pkin(3) + t24;
t1 = [0.4e1 * (m(4) / 0.2e1 + m(5) / 0.2e1) * (t9 * t5 - t8 * t6); (-t12 * mrSges(3,1) - t14 * mrSges(3,2)) * qJD(2) + m(4) * ((-t13 * t6 - t17) * pkin(2) + t20) + m(5) * (-pkin(2) * t17 - t10 * t6 + t20) + t15; 0.2e1 * (t16 + ((-t10 + t24) * m(5) - t25) * t11) * t18; -t6 * t21 + t15; (t16 + (-t21 - t25) * t11) * t18; 0; 0; 0; 0; 0;];
