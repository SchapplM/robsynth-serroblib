...
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'S4PRRP3_gravloadJ_regmin_slag_vp: pkin has to be [5x1] (double)');
...
t6 = sin(qJ(2));
t1 = g(1) * t3 + g(2) * t4;
t8 = [-g(1), 0, 0, 0, 0, 0, 0, -g(1); 0, 0, -g(1) * t7 + g(2) * t6, g(1) * t6 + g(2) * t7, 0, t2, t1, -g(1) * (t7 * pkin(2) + pkin(3) * t4) - g(2) * (-t6 * pkin(2) - pkin(3) * t3); 0, 0, 0, 0, 0, t2, t1, t2 * pkin(3); 0, 0, 0, 0, 0, 0, 0, g(3);];
taug_reg  = t8;
