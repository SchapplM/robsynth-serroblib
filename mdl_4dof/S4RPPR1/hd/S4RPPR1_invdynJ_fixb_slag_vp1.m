...
t89 = t68 + t111;
t22 = t89 + t39;
t40 = t67 * rSges(3,1) - t66 * rSges(3,2);
t30 = t40 + t68;
t109 = t66 / 0.2e1;
t108 = -t67 / 0.2e1;
t107 = -m(4) - m(5);
...
t5 = [-m(2) * (-g(1) * t46 + g(2) * t47) + t94 + ((-t37 * t75 - g(2) + t85) * t30 + (-g(1) - t118 + (-0.2e1 * t40 - t68 + t30) * t75) * t29) * m(3) + (Icges(2,3) + Icges(3,3) + Icges(4,2) + m(2) * (t46 ^ 2 + t47 ^ 2) + m(3) * (t29 ^ 2 + t40 * t30)) * qJDD(1) + ((t115 - t7) * t9 + t120 * ((-pkin(2) - pkin(3)) * t66 + t86 + t98) + t119 * (-t18 + t89 + t104) + (-t105 * qJD(1) - t114 + t117 + t8 + t9) * t10) * m(5) + ((-g(2) + t4) * t22 + (-g(1) + t3) * (t61 + t86 + t116) + (t57 + (-t62 - t68 - t64 + (-rSges(4,3) - qJ(3)) * t66) * qJD(1)) * t14 + (t14 + t54 + (-t106 - t87 + t116) * qJD(1) + t117) * (t22 * qJD(1) - t57)) * m(4); (-g(3) + qJDD(2)) * (m(3) - t107); t107 * (g(1) * t66 - g(2) * t67) + 0.2e1 * (t1 * t109 + t2 * t108) * m(5) + 0.2e1 * (t4 * t108 + t3 * t109) * m(4); -t94 + (-t10 * t8 + t9 * t7 - (-t10 * t70 + t120) * t98 + (t9 * t70 + t119) * t18) * m(5);];
tau  = t5;
