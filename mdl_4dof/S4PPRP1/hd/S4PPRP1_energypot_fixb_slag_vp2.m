...
t38 = sin(pkin(5));
t39 = cos(pkin(5));
t44 = pkin(1) * t39 + qJ(2) * t38;
t42 = m(5) * pkin(3) + mrSges(4,1) + mrSges(5,1);
t41 = m(5) * qJ(4) - mrSges(4,2) + mrSges(5,3);
t35 = t38 * pkin(1);
t29 = -t38 * t49 + t39 * t48;
t28 = -t38 * t48 - t39 * t49;
t1 = (-mrSges(3,2) + mrSges(5,2) - mrSges(1,3) - mrSges(2,3) + mrSges(4,3) + t50 * (-pkin(4) + qJ(1)) + (-m(2) - m(3)) * qJ(1)) * g(3) + (-mrSges(1,2) - m(3) * t35 + ((m(3) - t50) * qJ(2) - t46) * t39 + t47 * t38 + t42 * t29 + t41 * t28 + t50 * (pkin(2) * t38 + t35)) * g(2) + (-m(3) * t44 + t42 * t28 - t41 * t29 + t46 * t38 + t47 * t39 - mrSges(1,1) + t50 * (pkin(2) * t39 + t44)) * g(1);
U  = t1;
