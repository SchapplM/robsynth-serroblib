...
function JR_rot = S4PRRP6_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(6,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4PRRP6_jacobiR_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4PRRP6_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4PRRP6_jacobiR_rot_sym_varpar: pkin has to be [6x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t61 = cos(pkin(6));
	t60 = sin(pkin(6));
	t1 = [0, -t61 * t68, t60 * t64 - t61 * t67, 0; 0, -t60 * t68, -t60 * t67 - t61 * t64, 0; 0, t66, -t69, 0; 0, t61 * t65, 0, 0; 0, t60 * t65, 0, 0; 0, t63, 0, 0; 0, -t61 * t69, t60 * t62 + t61 * t66, 0; 0, -t60 * t69, t60 * t66 - t61 * t62, 0; 0, t67, t68, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,4);
end