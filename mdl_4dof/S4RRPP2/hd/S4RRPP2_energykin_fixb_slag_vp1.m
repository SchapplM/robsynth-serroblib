...
t144 = cos(t147);
t146 = qJD(1) + qJD(2);
t153 = t146 * (pkin(2) * t144 + qJ(3) * t143) + t142;
t148 = sin(qJ(1));
t152 = t148 * t154;
t151 = qJD(3) * t143 - t152;
t140 = rSges(2,1) * t149 - rSges(2,2) * t148;
t139 = rSges(2,1) * t148 + rSges(2,2) * t149;
t138 = pkin(2) * t143 - qJ(3) * t144;
t136 = t142 + t146 * (rSges(3,1) * t144 - rSges(3,2) * t143);
t135 = -t152 - t146 * (rSges(3,1) * t143 + rSges(3,2) * t144);
t134 = -qJD(3) * t144 + t146 * (rSges(4,1) * t144 + rSges(4,3) * t143) + t153;
t133 = (-rSges(4,1) * t143 + rSges(4,3) * t144 - t138) * t146 + t151;
t132 = t146 * t143 * rSges(5,2) + (t146 * t155 - qJD(3)) * t144 + t153;
t131 = (t144 * rSges(5,2) - t143 * t155 - t138) * t146 + t151;
