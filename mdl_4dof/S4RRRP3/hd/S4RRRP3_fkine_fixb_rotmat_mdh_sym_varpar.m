...
function [T_c_mdh, Tc_stack] = S4RRRP3_fkine_fixb_rotmat_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(6,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RRRP3_fkine_fixb_rotmat_mdh_sym_varpar: qJ has to be [4x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4RRRP3_fkine_fixb_rotmat_mdh_sym_varpar: pkin has to be [6x1] (double)');

%% Symbolic Calculation
% From fkine_mdh_floatb_twist_rotmat_matlab.m
% OptimizationMode: 2
% StartTime: 2019-12-31 17:13:56
...
t19 = t15 * pkin(1) + 0;
t8 = pkin(5) + t21;
t18 = t7 * pkin(2) + t6 * pkin(6) + t19;
t14 = cos(qJ(3));
t17 = pkin(3) * t14 + qJ(4) * t12;
t16 = t6 * pkin(2) - t7 * pkin(6) + t20;
t2 = t7 * t14;
t1 = t6 * t14;
