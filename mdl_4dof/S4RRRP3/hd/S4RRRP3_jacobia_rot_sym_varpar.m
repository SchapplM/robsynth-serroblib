...
function Ja_rot = S4RRRP3_jacobia_rot_sym_varpar(qJ, link_index, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(6,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RRRP3_jacobia_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4RRRP3_jacobia_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4RRRP3_jacobia_rot_sym_varpar: pkin has to be [6x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t1 = [t32, t32, t31, 0; t25, t25, (t47 * t28 - (-t40 * t53 + t34 * t46 + (-t34 * t50 + t53) * t31) * t54) * t41 * t26, 0; t27, t27, -0.1e1 / t41 * t44 * t35 * t50, 0;];
	Ja_rot = t1;
else
	Ja_rot=NaN(3,4);
end