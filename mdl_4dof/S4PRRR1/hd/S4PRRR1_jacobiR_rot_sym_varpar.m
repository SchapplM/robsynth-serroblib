...
%% Function calls
if link_index == 0
	JR_rot=S4PRRR1_jacobiR_rot_0_sym_varpar(qJ, pkin);
elseif link_index == 1
	JR_rot=S4PRRR1_jacobiR_rot_1_sym_varpar(qJ, pkin);
elseif link_index == 2
	JR_rot=S4PRRR1_jacobiR_rot_2_sym_varpar(qJ, pkin);
elseif link_index == 3
	JR_rot=S4PRRR1_jacobiR_rot_3_sym_varpar(qJ, pkin);
elseif link_index == 4
	JR_rot=S4PRRR1_jacobiR_rot_4_sym_varpar(qJ, pkin);
else
	JR_rot=NaN(9,4);
end