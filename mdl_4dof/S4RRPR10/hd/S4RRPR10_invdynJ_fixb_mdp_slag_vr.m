...
%   see S4RRPR10_invdynJ_fixb_regmin2vec.m
% MDP [21x1]
...
function tauJ = S4RRPR10_invdynJ_fixb_mdp_slag_vr(RV, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(51,1), zeros(21,1)}
assert(isreal(MDP) && all(size(MDP) == [21 1]), ...
  'S4RRPR10_invdynJ_fixb_mdp_slag_vr: MDP has to be [21x1] (double)'); 
