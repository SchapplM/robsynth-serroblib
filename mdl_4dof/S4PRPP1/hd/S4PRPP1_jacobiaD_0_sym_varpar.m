...
function JaD = S4PRPP1_jacobiaD_0_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)

JaD_transl = S4PRPP1_jacobiaD_transl_0_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin);
JaD_rot = S4PRPP1_jacobiaD_rot_0_sym_varpar(qJ, qJD, ...
  pkin);
