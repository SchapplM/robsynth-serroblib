...
t11 = [0.2e1 * m(5) * (t4 * t1 + t3 * t2) - 0.2e1 * t18 + 0.2e1 * (t12 * mrSges(4,1) + mrSges(3,3) + m(3) * qJ(2) + t13 * mrSges(4,2) + m(4) * (t10 * t13 - t19 * t12)) * qJD(2); m(5) * (t8 * t1 + t7 * t2 - t6 * t3 + t5 * t4) - t17; 0.2e1 * m(5) * (t8 * t5 - t7 * t6); 0; 0; 0; t18; t17; 0; 0;];
