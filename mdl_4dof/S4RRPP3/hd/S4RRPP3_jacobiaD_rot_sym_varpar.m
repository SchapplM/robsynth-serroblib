...
function JaD_rot = S4RRPP3_jacobiaD_rot_sym_varpar(qJ, qJD, link_index, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),uint8(0),zeros(6,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4RRPP3_jacobiaD_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'S4RRPP3_jacobiaD_rot_sym_varpar: qJD has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S4RRPP3_jacobiaD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'S4RRPP3_jacobiaD_rot_sym_varpar: pkin has to be [6x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t1 = [t93 * t80 * t108 + (qJD(2) * t104 - t122 * t125) * t72, t55, 0, 0; (t62 * t109 + (-t62 * t120 + (qJD(1) * t57 + t54) * t133) * t59) * t92 + (t63 * t109 * t57 + (-((t106 * t58 + t120 * t136 + t108) * t69 + (t107 * t128 - t134 + (t134 + (-t78 * t81 + t137) * t119) * t72) * t70) * t115 + (t117 * t83 - t120 * t63) * t57 + (-t62 + ((-t87 + t88) * t70 * t113 + t136 * t114) * t63) * t83 * qJD(1)) * t59) * t93, (t133 * t56 - t62 * t84) * t93 * t118 + ((-t62 * t122 + (-qJD(2) * t56 - t54) * t132) * t84 + (-t93 * qJD(2) * t62 - (-t55 * t70 * t92 - t139 * t69 + (-qJD(2) * t69 - t121 * t70 + t130 * t58) * t67) * t115 + (t117 * t93 + t122 * t63) * t56 - ((t55 - t121) * t69 + ((-t67 * t92 + 0.1e1) * qJD(2) + (t67 - t92) * t58) * t70) * t84 * t132) * t83) * t59, 0, 0; t110 * t80 * t116 + (-qJD(2) * t102 - 0.2e1 * t138 * t80) * t75, t89 * t81 * t116 * t123 + ((-0.2e1 * t79 * t82 - t80) * t89 * t119 - qJD(1) * t102) * t75, 0, 0;];
	JaD_rot = t1;
else
	JaD_rot=NaN(3,4);
end