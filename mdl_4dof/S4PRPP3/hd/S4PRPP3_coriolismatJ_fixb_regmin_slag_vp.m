...
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'S4PRPP3_coriolismatJ_fixb_regmin_slag_vp: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'S4PRPP3_coriolismatJ_fixb_regmin_slag_vp: qJD has to be [4x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'S4PRPP3_coriolismatJ_fixb_regmin_slag_vp: pkin has to be [4x1] (double)');
