...
t25 = -t36 * t30 + t35 * t31;
t24 = -t35 * t30 - t36 * t31;
t1 = (-mrSges(1,3) - mrSges(2,3) - mrSges(3,2) + m(4) * pkin(4) + mrSges(4,3) - m(5) * (-pkin(5) - pkin(4)) + mrSges(5,3) + (-m(2) - t41) * qJ(1)) * g(3) + (-t27 * mrSges(4,1) - t25 * mrSges(5,1) - t26 * mrSges(4,2) - t24 * mrSges(5,2) - mrSges(1,2) + (qJ(2) * t41 + t40) * t36 + (-t41 * pkin(1) + t39) * t35) * g(2) + (t26 * mrSges(4,1) + t24 * mrSges(5,1) - t27 * mrSges(4,2) - t25 * mrSges(5,2) - t40 * t35 + t39 * t36 - mrSges(1,1) - t41 * (t36 * pkin(1) + t35 * qJ(2))) * g(1);
U  = t1;
