...
t43 = (pkin(5) * m(4));
t42 = (-Ifges(4,2) - Ifges(5,2));
t1 = [Ifges(3,1) + Ifges(2,3) + (2 * mrSges(4,3) + t43) * pkin(5) - t42; mrSges(2,1); mrSges(2,2); mrSges(3,2) - mrSges(4,3) - t43; mrSges(3,3); m(3) + m(4); Ifges(4,1) + Ifges(5,1) + t42; Ifges(4,4) + Ifges(5,4); Ifges(4,5) + Ifges(5,5); Ifges(4,6) + Ifges(5,6); 2 * pkin(3) * mrSges(5,1) + Ifges(4,3) + Ifges(5,3); mrSges(4,1) + mrSges(5,1); mrSges(4,2) + mrSges(5,2); mrSges(5,3); m(5);];
MPV = t1;
