...
function JRD_rot = S6RRRPRR5_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),uint8(0),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRPRR5_jacobiRD_rot_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRPRR5_jacobiRD_rot_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRPRR5_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRRPRR5_jacobiRD_rot_sym_varpar: pkin has to be [10x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t318 = t335 * t331 + t334 * t355;
	t317 = t335 * t333 - t334 * t354;
...
elseif link_index == 6
	...
	% OptimizationMode: 2
	% StartTime: 2019-10-10 12:00:38
	% EndTime: 2019-10-10 12:00:38
	% DurationCPUTime: 0.21s
	% Computational Cost: add. (346->34), mult. (286->49), div. (0->0), fcn. (286->6), ass. (0->48)
	t412 = qJ(5) + qJ(6);
	t408 = cos(t412);
	t413 = qJ(2) + qJ(3);
	t407 = sin(t413);
	...
	t422 = t409 * t431;
	t421 = t407 * t430;
	t418 = -qJD(1) * t407 - t410;
	t417 = -t407 * t432 + t409 * t429;
	t416 = -t407 * t431 - t409 * t430;
	t399 = t421 - t422;
	t398 = -t406 * t437 + t408 * t434;
	t397 = t407 * t436 + t426;
	t396 = t408 * t433 + t428;
	t395 = -t406 * t433 + t427;
	t394 = t417 * t408 - t409 * t425;
	t393 = t417 * t406 + t414 * t427;
	t392 = t416 * t408 - t415 * t428;
	t391 = t416 * t406 + t409 * t423;
	t390 = -t406 * t421 - t425 + (t426 + t439) * t415;
	t389 = -t419 * t415 * t406 + (t418 * t414 + t422) * t408;
	t388 = -t414 * t439 + (t418 * t415 - t424) * t406;
	t387 = t400 * t408 + t419 * t438 - t423;
	t1 = [t388, t391, t391, 0, t389, t389; t390, t393, t393, 0, -t387, -t387; 0, t397, t397, 0, t396, t396; t387, t392, t392, 0, -t390, -t390; t389, t394, t394, 0, t388, t388; 0, t398, t398, 0, t395, t395; -t417, t399, t399, 0, 0, 0; t416, t400, t400, 0, 0, 0; 0, -t433, -t433, 0, 0, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,6);
end