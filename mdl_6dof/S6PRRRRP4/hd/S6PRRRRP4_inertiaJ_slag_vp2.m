...
t1 = [m(2) + m(5) * (t32 ^ 2 + t33 ^ 2 + t56) + m(4) * (t59 ^ 2 + t56 + t82) + m(3) * (t103 ^ 2 * t93 + t99 ^ 2 + t82) + (m(6) + m(7)) * (t11 ^ 2 + t13 ^ 2 + t56); mrSges(4,3) * t127 + t32 * t71 + t33 * t70 + t135 * t13 + t134 * t11 + (-t103 * mrSges(3,2) + (mrSges(3,1) - t75) * t107) * t98 + (t102 * mrSges(4,3) + t19 + t20 + t60) * t57 + m(6) * (-t11 * t6 + t13 * t7 + t57 * t72) + m(7) * (t11 * t4 + t13 * t3 + t14 * t57) + m(5) * (pkin(8) * t129 + t32 * t45 + t33 * t46) + m(4) * (pkin(2) * t126 + (t127 + t129) * pkin(8)); -0.2e1 * pkin(2) * t75 + 0.2e1 * t14 * t19 + 0.2e1 * t72 * t20 + 0.2e1 * t3 * t41 + 0.2e1 * t4 * t44 + 0.2e1 * t7 * t42 + 0.2e1 * t6 * t43 + 0.2e1 * t45 * t71 + 0.2e1 * t46 * t70 + Ifges(3,3) - (t17 + t18) * t55 + (t15 - t16) * t54 + (t95 + t97) * mrSges(4,3) * t142 + (Ifges(4,1) * t102 - t101 * t52 + t105 * t53 + t142 * t60) * t102 + m(4) * (pkin(2) ^ 2 + t109 * t97 + t91) + m(5) * (t45 ^ 2 + t46 ^ 2 + t91) + m(6) * (t6 ^ 2 + t7 ^ 2 + t72 ^ 2) + m(7) * (t14 ^ 2 + t3 ^ 2 + t4 ^ 2) + (-t79 + (Ifges(4,2) + t122) * t106 + (Ifges(5,6) * t101 + (2 * Ifges(4,4))) * t102 + t118) * t106; -t59 * mrSges(4,2) + t115 * mrSges(5,3) + (t26 + t27 + t133) * t57 + m(6) * (t57 * t87 + t120) + m(7) * (t22 * t57 + t120) + m(5) * (-pkin(3) * t57 + pkin(9) * t115) + t141 * (t11 * t68 - t13 * t67); -pkin(3) * t60 + t14 * t26 + t22 * t19 + t87 * t20 + t72 * t27 - (t30 / 0.2e1 + t31 / 0.2e1) * t55 + (t28 / 0.2e1 - t29 / 0.2e1) * t54 + t135 * t40 + t134 * t38 + (-t90 / 0.2e1 - t89 / 0.2e1 - t63 / 0.2e1 + t62 / 0.2e1 - t64 / 0.2e1 - t61 / 0.2e1 + Ifges(4,6) - pkin(8) * mrSges(4,2)) * t106 + (t52 / 0.2e1 + pkin(9) * t70 + t46 * mrSges(5,3)) * t105 + (t53 / 0.2e1 - pkin(9) * t71 - t45 * mrSges(5,3)) * t101 + (Ifges(4,5) + t105 * t77 / 0.2e1 - t101 * t76 / 0.2e1 + t133 * pkin(8)) * t102 + m(5) * (-pkin(3) * t92 + (-t101 * t45 + t105 * t46) * pkin(9)) + m(6) * (-t38 * t6 + t40 * t7 + t72 * t87) + m(7) * (t14 * t22 + t3 * t40 + t38 * t4) + (t17 / 0.2e1 + t18 / 0.2e1 + t4 * mrSges(7,2) - t6 * mrSges(6,3)) * t68 + (t15 / 0.2e1 - t16 / 0.2e1 - t3 * mrSges(7,2) - t7 * mrSges(6,3)) * t67; -0.2e1 * pkin(3) * t74 + t101 * t77 + t105 * t76 + 0.2e1 * t22 * t26 + 0.2e1 * t87 * t27 + Ifges(4,3) + m(7) * (t22 ^ 2 + t123) + m(6) * (t87 ^ 2 + t123) + m(5) * (pkin(9) ^ 2 * t132 + pkin(3) ^ 2) + (t30 + t31) * t68 + (t28 - t29) * t67 + 0.2e1 * t132 * pkin(9) * mrSges(5,3) + 0.2e1 * (t38 * t68 - t40 * t67) * t141; t32 * mrSges(5,1) - t33 * mrSges(5,2) + m(7) * (t11 * t86 + t13 * t84) + m(6) * (t100 * t13 - t104 * t11) * pkin(4) + t114; t112 + (m(6) * (t100 * t7 + t104 * t6) + t100 * t42 + t104 * t43) * pkin(4) + m(7) * (t3 * t84 + t4 * t86) - t122 * t106 + t79 + t84 * t41 + t86 * t44 + t45 * mrSges(5,1) - t46 * mrSges(5,2) - Ifges(5,6) * t125; m(7) * (t38 * t86 + t40 * t84) + t90 + t89 - t116 * pkin(9) + (-t67 * t84 + t68 * t86) * mrSges(7,2) + (m(6) * (t100 * t40 - t104 * t38) + (-t100 * t67 - t104 * t68) * mrSges(6,3)) * pkin(4) + t111; -0.2e1 * t86 * mrSges(7,1) + t84 * t140 + 0.2e1 * t113 + m(7) * (t84 ^ 2 + t86 ^ 2) + m(6) * (t100 ^ 2 + t104 ^ 2) * pkin(4) ^ 2 + t122; m(7) * (-pkin(5) * t11 + qJ(6) * t13) + t114; -pkin(5) * t44 + m(7) * (-pkin(5) * t4 + qJ(6) * t3) + qJ(6) * t41 - t136 * t106 + t112; m(7) * (-pkin(5) * t38 + qJ(6) * t40) + (-pkin(5) * t68 - qJ(6) * t67) * mrSges(7,2) + t111; m(7) * (-pkin(5) * t86 + qJ(6) * t84) + t113 + (t84 + qJ(6)) * mrSges(7,3) + (-t86 + pkin(5)) * mrSges(7,1) + t136; 0.2e1 * pkin(5) * mrSges(7,1) + qJ(6) * t140 + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t136; m(7) * t11; m(7) * t4 + t44; m(7) * t38 + t68 * mrSges(7,2); m(7) * t86 - mrSges(7,1); -m(7) * pkin(5) - mrSges(7,1); m(7);];
