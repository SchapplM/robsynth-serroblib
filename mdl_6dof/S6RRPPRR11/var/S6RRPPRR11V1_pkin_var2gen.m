% Umwandlung der Kinematikparameter von S6RRPPRR11V1 zu S6RRPPRR11
% Eingabe:
% pkin_var (10x1) double
%   Kinematikparameter (pkin) von S6RRPPRR11V1
%   pkin_var=[a2 a3 a4 a5 a6 alpha2 d1 d2 d5 theta4]
% Ausgabe:
...
function pkin_gen = S6RRPPRR11V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
