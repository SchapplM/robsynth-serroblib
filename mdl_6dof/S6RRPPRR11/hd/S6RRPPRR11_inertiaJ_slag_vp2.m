...
t3 = -pkin(5) * t143 - t5;
t14 = [m(3) * (t70 ^ 2 + t71 ^ 2) + (t132 - 0.2e1 * t155 + 0.2e1 * t156) * t119 + m(5) * (t23 ^ 2 + t24 ^ 2 + t59 ^ 2) + m(4) * (t62 ^ 2 + t63 ^ 2 + t65 ^ 2) + m(6) * (t34 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) + (m(3) * pkin(1) ^ 2 * t117 + (0.2e1 * t63 * mrSges(4,2) + 0.2e1 * t71 * mrSges(3,3) + (-(2 * Ifges(4,5)) + Ifges(3,6)) * t119 + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(3,2) + Ifges(4,3)) * t125) * t117) * t125 + (-0.2e1 * t70 * mrSges(3,3) - 0.2e1 * t63 * mrSges(4,3) + Ifges(5,5) * t69 + Ifges(5,6) * t68 + (Ifges(3,5) - (2 * Ifges(4,4))) * t119 + (-0.2e1 * pkin(1) * mrSges(3,2) + (Ifges(3,1) + Ifges(4,2) + Ifges(5,3)) * t123 + 0.2e1 * (Ifges(3,4) + Ifges(4,6)) * t125) * t117 + t139) * t123) * t117 + 0.2e1 * t62 * t82 + 0.2e1 * t65 * t83 + t68 * t35 + t69 * t36 + 0.2e1 * t59 * t43 + 0.2e1 * t24 * t60 + 0.2e1 * t23 * t61 + t42 * t16 + 0.2e1 * t6 * t32 + 0.2e1 * t5 * t33 + 0.2e1 * t34 * t20 + t27 * t8 + t28 * t9 + 0.2e1 * t3 * t11 + 0.2e1 * t2 * t12 + 0.2e1 * t1 * t13 + (-t15 + t7) * t41 + Ifges(2,3); (t9 * t161 + t8 * t163 + t5 * mrSges(6,3) - t16 / 0.2e1) * t79 + t153 * t52 + m(5) * (qJ(3) * t59 + t120 * t129) + (-Ifges(4,4) * t123 - Ifges(4,5) * t125 + (Ifges(5,5) * t118 - Ifges(5,6) * t116 + t152) * t123 / 0.2e1) * t117 - pkin(2) * t83 + t59 * t85 + t68 * t86 / 0.2e1 + t69 * t87 / 0.2e1 + t100 * t20 - t62 * mrSges(4,3) + t65 * mrSges(4,2) + t54 * t32 + t34 * t55 + t42 * t57 / 0.2e1 + t3 * t45 + t2 * t48 + t1 * t49 + t21 * t13 + t22 * t12 + (-t23 * mrSges(5,3) + t120 * t61 + t36 / 0.2e1) * t118 + (t120 * t60 - t24 * mrSges(5,3) - t35 / 0.2e1) * t116 + (-t82 + t43) * qJ(3) + m(6) * (t100 * t34 - t5 * t52 + t54 * t6) + m(4) * (-pkin(2) * t65 - qJ(3) * t62) + m(7) * (t1 * t21 + t2 * t22 + t3 * t52) + (-t6 * mrSges(6,3) - t15 / 0.2e1 + t7 / 0.2e1) * t80 + (-t56 / 0.2e1 + t29 / 0.2e1) * t41 + t31 * t165 + t30 * t166 - t155 + t156 + t132; -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t100 * t55 - t116 * t86 + t118 * t87 + 0.2e1 * t21 * t49 + 0.2e1 * t22 * t48 + 0.2e1 * t52 * t45 + (t167 * t54 + t29 - t56) * t80 + (t121 * t30 - t124 * t31 + t167 * t52 - t57) * t79 + m(7) * (t21 ^ 2 + t22 ^ 2 + t168) + m(6) * (t100 ^ 2 + t54 ^ 2 + t168) + m(5) * (t120 ^ 2 * t141 + t126) + m(4) * (pkin(2) ^ 2 + t126) + 0.2e1 * (mrSges(4,3) + t85) * qJ(3) - 0.2e1 * t120 * t134 + t172; t116 * t60 + t118 * t61 + t153 * t79 + (t32 + t170) * t80 + m(7) * (t131 * t80 + t3 * t79) + m(6) * (-t5 * t79 + t6 * t80) + m(5) * t129 + m(4) * t65 + t83; -m(4) * pkin(2) - t78 * mrSges(6,3) + t79 * t45 + mrSges(4,2) - t134 + (-mrSges(6,3) * t80 + t171) * t80 + m(7) * (t128 * t80 + t157) + m(6) * (t54 * t80 + t157) + t120 * t137; m(4) + t137 + m(6) * (t77 + t78) + m(7) * (t140 * t77 + t78); t121 * t12 + t124 * t13 + m(7) * (t1 * t124 + t121 * t2) + m(6) * t34 + m(5) * t59 + t20 + t43; m(5) * qJ(3) + t121 * t48 + t124 * t49 + m(7) * (t121 * t22 + t124 * t21) + m(6) * t100 + t55 + t85; 0; m(7) * t140 + m(5) + m(6); t5 * mrSges(6,1) - t6 * mrSges(6,2) + t131 * mrSges(7,3) + t8 * t160 + t9 * t163 + t41 * t164 + t91 * t165 + t90 * t166 + t3 * t88 + t139 + (-m(7) * t3 - t11) * pkin(5) + (m(7) * t131 + t170) * pkin(10); t30 * t160 + t31 * t163 - pkin(5) * t45 + t80 * t164 - t54 * mrSges(6,2) + (t161 * t91 + t163 * t90) * t79 + t128 * mrSges(7,3) + t152 + t169 * t52 + (m(7) * t128 + t171) * pkin(10); t169 * t79 + (-mrSges(6,2) + (m(7) * pkin(10) + mrSges(7,3)) * t140) * t80; 0; Ifges(6,3) + t121 * t91 + m(7) * (pkin(10) ^ 2 * t140 + pkin(5) ^ 2) + t124 * t90 - 0.2e1 * pkin(5) * t88 + 0.2e1 * t140 * pkin(10) * mrSges(7,3); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t21 - mrSges(7,2) * t22 + t29; t130 * t80; -t88; pkin(10) * t130 + t89; Ifges(7,3);];
