...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:34:26
% EndTime: 2018-11-23 15:34:28
...
t191 = t24 - t53;
t101 = pkin(2) * t144 * t149 + pkin(9) * t178;
...
t172 = t116 * t151 + t118 * t146 + Ifges(6,3);
...
t160 = mrSges(6,1) * t16 - t17 * mrSges(6,2) + t10 * t113 + t116 * t203 + t13 * t198 + t14 * t199 - t186 * t2 + t189 * t3 + t200 * t47 + t201 * t61 - t190;
...
t1 = [m(2) + m(7) * (t6 ^ 2 + t7 ^ 2 + t206) + m(6) * (t23 ^ 2 + t206 + t70) + m(5) * (t40 ^ 2 + t41 ^ 2 + t70) + m(4) * (t73 ^ 2 + t96 ^ 2 + t70) + m(3) * (t145 ^ 2 + (t150 ^ 2 + t155 ^ 2) * t143 ^ 2); t73 * t106 + t23 * t52 + t7 * t25 + t6 * t26 + t40 * t81 + t41 * t80 + t96 * t99 + t191 * t21 + (mrSges(3,1) * t155 - mrSges(3,2) * t150) * t143 + (-t105 + t29 + t64) * t71 + m(7) * (t10 * t21 + t2 * t6 + t3 * t7) + m(6) * (-t16 * t21 + t17 * t23 + t63 * t71) + m(5) * (t40 * t54 + t41 * t55 + t71 * t89) + m(4) * (-pkin(2) * t142 * t96 - t100 * t71 + t101 * t73); t144 * t170 + t97 * t56 + t98 * t57 + 0.2e1 * t100 * t105 + 0.2e1 * t101 * t106 + 0.2e1 * t89 * t64 + 0.2e1 * t55 * t80 + 0.2e1 * t54 * t81 + t62 * t28 + 0.2e1 * t63 * t29 + t46 * t13 + t47 * t14 + 0.2e1 * t17 * t52 + 0.2e1 * t16 * t53 + 0.2e1 * t3 * t25 + 0.2e1 * t2 * t26 + 0.2e1 * t10 * t24 + Ifges(3,3) + (t12 - t27) * t61 + (-0.2e1 * pkin(2) * t99 + (Ifges(4,1) * t179 + Ifges(4,5) * t144) * t149 + (Ifges(4,6) * t144 + (0.2e1 * Ifges(4,4) * t149 + (Ifges(4,2) + t192) * t154) * t142 + t190 + t207) * t154) * t142 + m(4) * (pkin(2) ^ 2 * t142 ^ 2 + t100 ^ 2 + t101 ^ 2) + m(5) * (t54 ^ 2 + t55 ^ 2 + t89 ^ 2) + m(6) * (t16 ^ 2 + t17 ^ 2 + t63 ^ 2) + m(7) * (t10 ^ 2 + t2 ^ 2 + t3 ^ 2); -t73 * mrSges(4,2) + t21 * t66 + t6 * t69 + t7 * t68 + (-t109 * t23 + t110 * t21) * mrSges(6,3) + t164 * mrSges(5,3) + (-mrSges(4,1) + t114 + t74) * t71 + m(7) * (t34 * t6 + t35 * t7 + t193) + m(6) * (t131 * t71 + t23 * t84 + t193) + m(5) * (-pkin(3) * t71 + pkin(10) * t164); t131 * t29 + t89 * t114 + t97 * t117 / 0.2e1 + t98 * t119 / 0.2e1 + m(6) * (t131 * t63 - t16 * t82 + t17 * t84) + m(7) * (t10 * t82 + t2 * t34 + t3 * t35) + t170 + m(5) * (-pkin(3) * t89 + (-t148 * t54 + t153 * t55) * pkin(10)) + (-t75 / 0.2e1 + t49 / 0.2e1) * t61 + t100 * mrSges(4,1) - t101 * mrSges(4,2) + t84 * t52 + t3 * t68 + t2 * t69 + t63 * t74 + t62 * t76 / 0.2e1 - pkin(3) * t64 + t10 * t66 + t47 * t51 / 0.2e1 + t35 * t25 + t34 * t26 + (t12 / 0.2e1 - t27 / 0.2e1 - t17 * mrSges(6,3)) * t109 + (pkin(10) * t80 + t55 * mrSges(5,3) + t56 / 0.2e1) * t153 + (-pkin(10) * t81 - t54 * mrSges(5,3) + t57 / 0.2e1) * t148 + (t14 * t198 - t146 * t13 / 0.2e1 + t28 / 0.2e1 - t16 * mrSges(6,3)) * t110 + t191 * t82 - (t175 + t176) * t178 / 0.2e1 + t50 * t203; -0.2e1 * pkin(3) * t114 + t153 * t117 + t148 * t119 + 0.2e1 * t131 * t74 + 0.2e1 * t34 * t69 + 0.2e1 * t35 * t68 + t66 * t204 + Ifges(4,3) + 0.2e1 * t173 * pkin(10) * mrSges(5,3) + (-0.2e1 * mrSges(6,3) * t84 + t49 - t75) * t109 + m(7) * (t34 ^ 2 + t35 ^ 2 + t205) + m(6) * (t131 ^ 2 + t84 ^ 2 + t205) + m(5) * (pkin(10) ^ 2 * t173 + pkin(3) ^ 2) + (mrSges(6,3) * t204 - t146 * t50 + t151 * t51 + t76) * t110; t40 * mrSges(5,1) - t41 * mrSges(5,2) + m(7) * (t129 * t167 + t130 * t21) + m(6) * (t147 * t23 - t152 * t21) * pkin(4) + t161; t25 * t180 - t26 * t181 + t130 * t24 + m(7) * (t10 * t130 + t129 * t168) + (m(6) * (t147 * t17 + t152 * t16) + t152 * t53 + t147 * t52) * pkin(4) + t54 * mrSges(5,1) - t55 * mrSges(5,2) - t192 * t178 + t160 - t207; t68 * t180 - t69 * t181 + t130 * t66 + m(7) * (t129 * t165 + t130 * t82) + (m(6) * (t147 * t84 - t152 * t82) + (-t109 * t147 - t110 * t152) * mrSges(6,3)) * pkin(4) + (-mrSges(5,1) * t148 - mrSges(5,2) * t153) * pkin(10) + t159 + t175; 0.2e1 * t130 * t113 + Ifges(5,3) + 0.2e1 * t162 + t129 * t163 + m(7) * (t129 ^ 2 * t174 + t130 ^ 2) + m(6) * (t147 ^ 2 + t152 ^ 2) * pkin(4) ^ 2 + t172; m(7) * (-pkin(5) * t21 + pkin(12) * t167) + t161; -Ifges(6,3) * t178 + t25 * t194 - t26 * t195 + m(7) * (-pkin(5) * t10 + pkin(12) * t168) - pkin(5) * t24 + t160; t68 * t194 - t69 * t195 + m(7) * (-pkin(5) * t82 + pkin(12) * t165) - pkin(5) * t66 + t159; m(7) * (-pkin(5) * t130 + pkin(12) * t169) + (-pkin(5) + t130) * t113 + t162 + (pkin(12) * t174 + t169) * mrSges(7,3) + t172; -0.2e1 * pkin(5) * t113 + m(7) * (pkin(12) ^ 2 * t174 + pkin(5) ^ 2) + pkin(12) * t163 + t172; mrSges(7,1) * t6 - mrSges(7,2) * t7; mrSges(7,1) * t2 - mrSges(7,2) * t3 + t12; mrSges(7,1) * t34 - mrSges(7,2) * t35 + t49; -t129 * t166 + t115; -pkin(12) * t166 + t115; Ifges(7,3);];
