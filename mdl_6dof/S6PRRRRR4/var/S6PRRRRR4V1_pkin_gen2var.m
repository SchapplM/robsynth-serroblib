% Umwandlung der Kinematikparameter von S6PRRRRR4 zu S6PRRRRR4V1
% Eingabe:
...
%   pkin_var=[a2 a3 a4 a5 a6 alpha2 alpha3 d2 d3 d4 d5 theta1]
% I_gv (12x1)
%   Vektor mit Indizes zur Selektion von Kinematikparametern
function [pkin_var, I_gv] = S6PRRRRR4V1_pkin_gen2var(pkin_gen)
