...
t191 = sin(qJ(6));
t193 = cos(qJ(6));
t132 = -qJD(3) * t188 - t152 * t186;
t230 = -pkin(2) * t189 - pkin(1);
t168 = qJD(1) * t230 + qJD(2);
t198 = -qJ(4) * t153 + t168;
t69 = t152 * t260 + t198;
t125 = t164 * t268 + t165 * t192;
...
t225 = t132 * t191 + t133 * t193;
t41 = qJD(6) * t225 + t144 * t211;
t283 = t41 / 0.2e1;
...
t31 = t153 * t266 + t37;
t298 = -qJD(5) * t211 + qJD(6) * t127 - t191 * t24 - t193 * t31;
t128 = t166 * t193 + t167 * t191;
t297 = -qJD(5) * t289 - qJD(6) * t128 + t191 * t31 - t193 * t24;
...
t131 = -t169 * t192 + t170 * t268;
t103 = qJD(3) * t131 + t199;
t71 = -pkin(4) * t156 + t103;
...
t119 = Ifges(4,1) * t153 + Ifges(4,5) * qJD(3) - t146;
t118 = Ifges(4,4) * t153 - t152 * Ifges(4,2) + Ifges(4,6) * qJD(3);
t117 = Ifges(5,4) * qJD(3) - t153 * Ifges(5,2) + t145;
t116 = Ifges(5,5) * qJD(3) - t153 * Ifges(5,6) + t152 * Ifges(5,3);
t115 = t211 * t161;
t113 = -pkin(4) * t161 + t131;
...
t68 = t188 * t71;
t65 = -Ifges(6,5) * t143 + t144 * t219;
t64 = -t143 * Ifges(6,6) + t144 * t218;
t63 = t153 * t229 - t125;
t62 = -Ifges(6,1) * t132 + Ifges(6,4) * t133 + Ifges(6,5) * t153;
t61 = -Ifges(6,4) * t132 + Ifges(6,2) * t133 + Ifges(6,6) * t153;
t60 = Ifges(6,3) * t153 + t250 - t251;
...
t7 = [(Ifges(7,4) * t115 + Ifges(7,2) * t114) * t282 + (Ifges(7,1) * t115 + Ifges(7,4) * t114) * t283 + t115 * t284 + t114 * t285 + 0.2e1 * t286 * t232 + (Ifges(7,5) * t115 + Ifges(7,6) * t114) * t299 - (t119 + t60 + t25) * t156 / 0.2e1 + m(5) * (t102 * t121 + t103 * t120 + t124 * t75 + t131 * t195 + t92 * t99 + t252) + (t58 * t220 - t75 * mrSges(5,2) - t195 * mrSges(5,1) - t90 * mrSges(4,3) + t65 * t271 + t64 * t269 + (t204 + t261) * t143 + t215 * mrSges(6,3) + (Ifges(4,2) + Ifges(5,3) + Ifges(6,2) * t188 ^ 2 / 0.2e1 + (t255 + t257 / 0.2e1) * t186) * t144) * t161 + ((-Ifges(4,4) + t217) * t157 + t295 * t156) * t153 / 0.2e1 + (t156 * t294 + t157 * t293) * qJD(3) / 0.2e1 + t133 * (-Ifges(6,6) * t156 + t157 * t218) / 0.2e1 - t132 * (-Ifges(6,5) * t156 + t157 * t219) / 0.2e1 + (-t120 * t156 + t121 * t157 + t212) * mrSges(5,1) + (t1 * t114 - t115 * t2 - t49 * t5 + t50 * t6) * mrSges(7,3) - t238 * t103 - t239 * t102 + t230 * (t144 * mrSges(4,1) - t140) + (-t125 * t156 - t157 * t291 + t212) * mrSges(4,3) + m(4) * (-t102 * t291 + t103 * t125 + t131 * t90 + t252) + m(7) * (t1 * t10 + t2 * t9 + t3 * t6 + t4 * t5 + t46 * t74 + t52 * t53) + m(6) * (t113 * t58 + t17 * t44 + t18 * t45 + t22 * t32 + t23 * t33 + t70 * t84) + t168 * (mrSges(4,1) * t157 - mrSges(4,2) * t156) - t152 * (-Ifges(4,4) * t156 - Ifges(4,2) * t157) / 0.2e1 - t157 * t118 / 0.2e1 - t153 * (Ifges(5,2) * t156 + Ifges(5,6) * t157) / 0.2e1 + t152 * (Ifges(5,6) * t156 + Ifges(5,3) * t157) / 0.2e1 + t99 * (-mrSges(5,2) * t157 + mrSges(5,3) * t156) + t157 * t116 / 0.2e1 + t156 * t117 / 0.2e1 + t124 * (-t144 * mrSges(5,2) + t139) + t92 * t123 + (t17 * mrSges(6,1) - t18 * mrSges(6,2) - t75 * mrSges(5,3) - t141 / 0.2e1 + t302 * t91 + (t217 - t261) * t144 + (-Ifges(7,3) / 0.2e1 - Ifges(5,2) + t295) * t143 + t287) * t163 + t44 * t110 + t45 * t111 + t113 * t98 + t46 * (-mrSges(7,1) * t114 + mrSges(7,2) * t115) + t22 * t105 + t23 * t104 + t70 * t85 + t74 * t14 + t3 * t56 + t4 * t57 + t49 * t27 / 0.2e1 + t50 * t26 / 0.2e1 + t52 * t34 + t53 * (-mrSges(7,1) * t50 + mrSges(7,2) * t49) + (Ifges(7,5) * t49 + Ifges(7,6) * t50 - Ifges(7,3) * t156) * t274 + t156 * t276 + (Ifges(7,1) * t49 + Ifges(7,4) * t50 - Ifges(7,5) * t156) * t278 + (Ifges(7,4) * t49 + Ifges(7,2) * t50 - Ifges(7,6) * t156) * t280 + t157 * t203 + t61 * t243 / 0.2e1 + t33 * (mrSges(6,2) * t156 + mrSges(6,3) * t243) + t62 * t244 / 0.2e1 + t32 * (-mrSges(6,1) * t156 - mrSges(6,3) * t244) - t156 * t277 + t9 * t29 + t10 * t30; -t186 * t110 + t188 * t111 - t211 * t29 + t289 * t30 + t139 - t140 - t290 * t57 + t235 * t56 - t262 * t144 + (-t104 * t186 - t105 * t188 + t238) * t153 + (t135 - t231) * t152 - m(4) * (t125 * t153 - t152 * t291) - t286 * qJD(1) ^ 2 + (t1 * t289 + t152 * t53 - t2 * t211 + t235 * t6 - t290 * t5) * m(7) + (t152 * t84 - t153 * t214 + t215) * m(6) + (-t120 * t153 - t121 * t152 + t75) * m(5); (-t155 / 0.2e1 - t200 / 0.2e1) * t27 + (-Ifges(7,5) * t155 - Ifges(7,6) * t154) * t274 + (-Ifges(7,1) * t155 - Ifges(7,4) * t154) * t278 + (-Ifges(7,4) * t155 - Ifges(7,2) * t154) * t280 + (-pkin(3) * t91 + qJ(4) * t195 - t120 * t291 + t121 * t288 - t122 * t99) * m(5) + t195 * mrSges(5,3) + (Ifges(6,5) * t270 + Ifges(6,6) * t271 - Ifges(7,5) * t289 / 0.2e1 + Ifges(7,6) * t211 / 0.2e1 + pkin(3) * mrSges(5,1) + t294) * t143 + (Ifges(7,4) * t289 - Ifges(7,2) * t211) * t282 + (Ifges(7,1) * t289 - Ifges(7,4) * t211) * t283 + t46 * (mrSges(7,1) * t211 + mrSges(7,2) * t289) + t289 * t284 + (Ifges(7,1) * t200 + Ifges(7,4) * t292) * t279 + (Ifges(7,4) * t200 + Ifges(7,2) * t292) * t281 + (-t154 / 0.2e1 - t292 / 0.2e1) * t26 + (-qJ(4) * mrSges(5,1) + (Ifges(6,1) * t188 - t256) * t271 + (-Ifges(6,2) * t186 + t255) * t269 + t293) * t144 + (qJ(4) * t58 - qJD(5) * t214 - t216 * t260 + t300 * t84 - t32 * t36 - t33 * t37) * m(6) + t239 * t125 - t231 * qJD(4) + t297 * t57 + t298 * t56 + (t1 * t128 + t127 * t2 + t177 * t46 + t298 * t6 + (-t63 + qJD(4)) * t53 + t297 * t5) * m(7) + (Ifges(7,5) * t200 + Ifges(7,6) * t292) * t275 + t303 * mrSges(7,3) + t205 * t85 + t238 * t291 + (t132 * t219 / 0.2e1 - t133 * t218 / 0.2e1 - t203 - t168 * mrSges(4,1) + t118 / 0.2e1 + t99 * mrSges(5,2) - t116 / 0.2e1 - t121 * mrSges(5,1) + t291 * mrSges(4,3) - t186 * t62 / 0.2e1 + t61 * t270 + (Ifges(4,4) / 0.2e1 + Ifges(5,6) / 0.2e1 + t204) * t153 + (Ifges(4,6) / 0.2e1 - Ifges(5,5) / 0.2e1) * qJD(3) + t213 * mrSges(6,3) + (Ifges(6,3) / 0.2e1 + Ifges(4,1) / 0.2e1 + Ifges(5,2) / 0.2e1 - Ifges(4,2) / 0.2e1 - Ifges(5,3) / 0.2e1) * t152) * t153 - t211 * t285 + (t58 * mrSges(6,2) + t65 / 0.2e1 - t17 * mrSges(6,3) - qJD(5) * t105 - t260 * t110) * t188 + (t58 * mrSges(6,1) - t64 / 0.2e1 - t18 * mrSges(6,3) - qJD(5) * t104 - t260 * t111) * t186 + (t168 * mrSges(4,2) - t251 / 0.2e1 + t250 / 0.2e1 - t146 / 0.2e1 - t145 / 0.2e1 - t99 * mrSges(5,3) - t33 * mrSges(6,2) + t32 * mrSges(6,1) + t249 / 0.2e1 + t119 / 0.2e1 - t276 + t265 / 0.2e1 - t264 / 0.2e1 + t277 + t60 / 0.2e1 + t25 / 0.2e1 - t117 / 0.2e1 + t120 * mrSges(5,1) + t125 * mrSges(4,3) + (-Ifges(5,4) / 0.2e1 + Ifges(4,5) / 0.2e1) * qJD(3)) * t152 + (mrSges(7,1) * t290 + mrSges(7,2) * t235) * t53 + t177 * t14 + t127 * t29 + t128 * t30 - t122 * t123 - t36 * t105 + qJ(4) * t98 - t37 * t104 - t90 * mrSges(4,2) - t63 * t34 + t262 * t91; -t143 * mrSges(5,1) + t188 * t110 + t186 * t111 + t211 * t30 + t289 * t29 + t235 * t57 + t290 * t56 + (t104 * t188 - t105 * t186 + t123) * t153 + t231 * qJD(3) + (-qJD(3) * t53 - t303) * m(7) + (-qJD(3) * t84 - t153 * t213 + t216) * m(6) + (qJD(3) * t121 + t153 * t99 + t91) * m(5); -t133 * t104 - t132 * t105 - t225 * t56 - t78 * t57 + t14 + t98 + (-t225 * t6 - t5 * t78 + t46) * m(7) + (-t132 * t32 - t133 * t33 + t58) * m(6); -t141 - t53 * (-mrSges(7,1) * t78 + mrSges(7,2) * t225) + (Ifges(7,1) * t225 + t267) * t279 + t26 * t278 + (Ifges(7,5) * t225 + Ifges(7,6) * t78) * t275 - t5 * t56 + t6 * t57 + (t225 * t5 - t6 * t78) * mrSges(7,3) + (Ifges(7,2) * t78 + t27 + t76) * t281 + t287;];
tauc  = t7(:);
