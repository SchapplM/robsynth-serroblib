...
function Tc_mdh = S6RRPRPR3_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRPRPR3_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRPRPR3_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRPRPR3_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [11x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:08:39
	% EndTime: 2020-11-04 22:08:39
...
elseif link_index == 5
	...
	t101 = cos(qJ(1));
	t104 = t101 * t94;
	t103 = pkin(4) * sin(qJ(4)) + pkin(7) + qJ(3);
	t89 = cos(qJ(4)) * pkin(4) + pkin(3);
	t92 = sin(t96);
	t97 = -qJ(5) - pkin(8);
	t102 = t89 * t94 - t92 * t97 + cos(qJ(2)) * pkin(2) + pkin(1);
	t95 = qJ(4) + pkin(11);
	t93 = cos(t95);
	t91 = sin(t95);
	t1 = [t100 * t91 + t93 * t104, t100 * t93 - t91 * t104, t101 * t92, t103 * t100 + t102 * t101 + 0; -t101 * t91 + t93 * t105, -t101 * t93 - t91 * t105, t100 * t92, t102 * t100 - t103 * t101 + 0; t92 * t93, -t92 * t91, -t94, t92 * t89 + t94 * t97 + sin(qJ(2)) * pkin(2) + pkin(6) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 6
	...
	t123 = t119 * t108;
	t122 = t119 * t109;
	t121 = pkin(5) * sin(t115) + pkin(4) * sin(qJ(4)) + qJ(3) + pkin(7);
	t106 = pkin(5) * cos(t115) + cos(qJ(4)) * pkin(4) + pkin(3);
	t116 = qJ(2) + pkin(10);
	t111 = sin(t116);
	t112 = cos(t116);
	t114 = -pkin(9) - qJ(5) - pkin(8);
