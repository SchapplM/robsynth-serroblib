...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:12:29
% EndTime: 2018-11-23 17:12:30
...
t1 = [-0.2e1 * pkin(1) * (-t105 * mrSges(3,1) + t102 * mrSges(3,2)) + t105 * (Ifges(3,4) * t102 + Ifges(3,2) * t105) + t102 * (Ifges(3,1) * t102 + Ifges(3,4) * t105) + t61 * t137 + t41 * t138 + 0.2e1 * t19 * t46 + 0.2e1 * t18 * t47 + 0.2e1 * t27 * t17 + 0.2e1 * t6 * t20 + 0.2e1 * t5 * t21 + 0.2e1 * t3 * t22 + 0.2e1 * t2 * t23 + 0.2e1 * t7 * t16 + Ifges(2,3) - (t12 + t13) * t34 + (t10 - t11) * t33 + 0.2e1 * t125 * pkin(7) * mrSges(3,3) + (mrSges(4,3) * t138 + Ifges(4,1) * t73 - t101 * t24 + t104 * t25) * t73 + (mrSges(4,1) * t137 - 0.2e1 * t57 * mrSges(4,3) + Ifges(4,2) * t72 + (-Ifges(5,6) * t101 - (2 * Ifges(4,4))) * t73 + t113 + t142) * t72 + m(3) * (t125 * pkin(7) ^ 2 + pkin(1) ^ 2) + m(4) * (t57 ^ 2 + t91 ^ 2 + t140) + m(5) * (t18 ^ 2 + t19 ^ 2 + t140) + m(6) * (t27 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t7 ^ 2); (t80 - mrSges(4,1)) * t55 + m(5) * (t55 * t88 + (-t18 * t101 + t19 * t104) * t86) + (t24 / 0.2e1 + t86 * t46 + t73 * t83 / 0.2e1 + t19 * mrSges(5,3)) * t104 + (t25 / 0.2e1 - t86 * t47 - t73 * t82 / 0.2e1 - t18 * mrSges(5,3)) * t101 + m(6) * (t27 * t79 - t42 * t5 + t44 * t6) + m(7) * (t2 * t44 + t3 * t42 + t35 * t7) + (-t5 * mrSges(6,3) + t3 * mrSges(7,2) + t12 / 0.2e1 + t13 / 0.2e1) * t78 + ((-t72 * t98 - t73 * t99) * mrSges(4,3) + m(4) * (-t55 * t99 + t57 * t98)) * pkin(2) + (-t2 * mrSges(7,2) - t6 * mrSges(6,3) - t11 / 0.2e1 + t10 / 0.2e1) * t76 - (t53 / 0.2e1 + t54 / 0.2e1) * t34 + (t51 / 0.2e1 - t52 / 0.2e1) * t33 + Ifges(3,6) * t105 + Ifges(3,5) * t102 + t88 * t41 + t79 * t17 - Ifges(4,6) * t72 + Ifges(4,5) * t73 + (-t102 * mrSges(3,1) - t105 * mrSges(3,2)) * pkin(7) + t7 * t49 + t27 * t50 - t57 * mrSges(4,2) + t35 * t16 + t130 * t42 + t131 * t44 + (t127 + t141) * t72 / 0.2e1; t101 * t83 + t104 * t82 + 0.2e1 * t35 * t49 + 0.2e1 * t79 * t50 + 0.2e1 * t88 * t80 + Ifges(3,3) + Ifges(4,3) + (t53 + t54) * t78 + (t51 - t52) * t76 + m(7) * (t35 ^ 2 + t120) + m(6) * (t79 ^ 2 + t120) + m(5) * (t126 * t86 ^ 2 + t88 ^ 2) + m(4) * (t98 ^ 2 + t99 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t99 - mrSges(4,2) * t98) * pkin(2) + 0.2e1 * t126 * t86 * mrSges(5,3) + 0.2e1 * (t42 * t78 - t44 * t76) * (mrSges(7,2) + mrSges(6,3)); t72 * mrSges(4,1) + t101 * t46 + t104 * t47 + t61 + t131 * t78 + t130 * t76 + m(7) * (t2 * t78 + t3 * t76) + m(6) * (-t5 * t76 + t6 * t78) + m(5) * (t101 * t19 + t104 * t18) + m(4) * t91; t143 * (t42 * t76 + t78 * t44); m(5) * t126 + m(4) + t143 * (t76 ^ 2 + t78 ^ 2); (m(6) * (t100 * t6 + t103 * t5) + t100 * t20 + t103 * t21) * pkin(4) + m(7) * (t2 * t87 + t3 * t90) - Ifges(5,6) * t122 + t87 * t23 + t90 * t22 + t18 * mrSges(5,1) - t19 * mrSges(5,2) + t109 + t142; m(7) * (t42 * t90 + t44 * t87) - t114 * t86 + (-t76 * t87 + t78 * t90) * mrSges(7,2) + (m(6) * (t100 * t44 - t103 * t42) + (-t100 * t76 - t103 * t78) * mrSges(6,3)) * pkin(4) + t110 + t127; m(7) * (t76 * t90 + t78 * t87) + m(6) * (t100 * t78 - t103 * t76) * pkin(4) + t111 - t80; -0.2e1 * t90 * mrSges(7,1) + t87 * t139 + Ifges(5,3) + 0.2e1 * t112 + m(7) * (t87 ^ 2 + t90 ^ 2) + m(6) * (t100 ^ 2 + t103 ^ 2) * pkin(4) ^ 2 + t133; -pkin(5) * t22 + m(7) * (-pkin(5) * t3 + qJ(6) * t2) + qJ(6) * t23 + t109; m(7) * (-pkin(5) * t42 + qJ(6) * t44) + (-pkin(5) * t78 - qJ(6) * t76) * mrSges(7,2) + t110; m(7) * t115 + t111; m(7) * (-pkin(5) * t90 + qJ(6) * t87) + t112 + (qJ(6) + t87) * mrSges(7,3) + (pkin(5) - t90) * mrSges(7,1) + t133; 0.2e1 * pkin(5) * mrSges(7,1) + qJ(6) * t139 + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t133; m(7) * t3 + t22; m(7) * t42 + t78 * mrSges(7,2); m(7) * t76; m(7) * t90 - mrSges(7,1); -m(7) * pkin(5) - mrSges(7,1); m(7);];
