...
t1 = [-0.2e1 * pkin(1) * (-t108 * mrSges(3,1) + t105 * mrSges(3,2)) + t108 * (Ifges(3,4) * t105 + Ifges(3,2) * t108) + t105 * (Ifges(3,1) * t105 + Ifges(3,4) * t108) + t65 * t141 + 0.2e1 * t20 * t45 + 0.2e1 * t19 * t46 + t41 * t142 + 0.2e1 * t6 * t22 + 0.2e1 * t2 * t23 + 0.2e1 * t5 * t24 + 0.2e1 * t30 * t18 + 0.2e1 * t16 * t17 + 0.2e1 * t3 * t21 + Ifges(2,3) + (t13 + t12) * t37 - (t10 + t11) * t36 + 0.2e1 * t121 * pkin(7) * mrSges(3,3) + (mrSges(4,3) * t142 + Ifges(4,1) * t79 - t104 * t26 + t107 * t27) * t79 + (mrSges(4,1) * t141 - 0.2e1 * t57 * mrSges(4,3) + Ifges(4,2) * t78 + (-Ifges(5,6) * t104 - (2 * Ifges(4,4))) * t79 + t114 + t147) * t78 + m(3) * (t121 * pkin(7) ^ 2 + pkin(1) ^ 2) + m(4) * (t57 ^ 2 + t93 ^ 2 + t144) + m(5) * (t19 ^ 2 + t20 ^ 2 + t144) + m(6) * (t30 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t16 ^ 2 + t2 ^ 2 + t3 ^ 2); (t84 - mrSges(4,1)) * t55 + (t26 / 0.2e1 + t79 * t87 / 0.2e1 + t90 * t45 + t20 * mrSges(5,3)) * t107 + (t27 / 0.2e1 - t79 * t86 / 0.2e1 - t90 * t46 - t19 * mrSges(5,3)) * t104 + m(5) * (t55 * t91 + (-t19 * t104 + t20 * t107) * t90) + m(7) * (t16 * t58 + t2 * t28 + t29 * t3) + ((-t101 * t78 - t102 * t79) * mrSges(4,3) + m(4) * (t101 * t57 - t102 * t55)) * pkin(2) + m(6) * (t30 * t83 + t42 * t5 + t43 * t6) + (t13 / 0.2e1 + t12 / 0.2e1 - t2 * mrSges(7,3) - t5 * mrSges(6,3)) * t82 + (t10 / 0.2e1 + t11 / 0.2e1 + t3 * mrSges(7,3) + t6 * mrSges(6,3)) * t81 + (t52 / 0.2e1 + t53 / 0.2e1) * t37 - (t50 / 0.2e1 + t51 / 0.2e1) * t36 + Ifges(3,6) * t108 + Ifges(3,5) * t105 + t91 * t41 + t83 * t18 - Ifges(4,6) * t78 + Ifges(4,5) * t79 + t43 * t22 + t16 * t48 + t30 * t49 - t57 * mrSges(4,2) + t58 * t17 + t42 * t24 + t28 * t23 + t29 * t21 + (t129 + t146) * t78 / 0.2e1 + (-t105 * mrSges(3,1) - t108 * mrSges(3,2)) * pkin(7); t104 * t87 + t107 * t86 + 0.2e1 * t58 * t48 + 0.2e1 * t83 * t49 + 0.2e1 * t91 * t84 + Ifges(3,3) + Ifges(4,3) + (-0.2e1 * mrSges(6,3) * t42 - 0.2e1 * mrSges(7,3) * t28 + t52 + t53) * t82 + (0.2e1 * mrSges(6,3) * t43 + 0.2e1 * mrSges(7,3) * t29 + t50 + t51) * t81 + m(7) * (t28 ^ 2 + t29 ^ 2 + t58 ^ 2) + m(6) * (t42 ^ 2 + t43 ^ 2 + t83 ^ 2) + m(5) * (t128 * t90 ^ 2 + t91 ^ 2) + m(4) * (t101 ^ 2 + t102 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t102 - mrSges(4,2) * t101) * pkin(2) + 0.2e1 * t128 * t90 * mrSges(5,3); t78 * mrSges(4,1) + t104 * t45 + t107 * t46 + t65 + t132 * t82 + (t23 + t24) * t81 + m(6) * (t5 * t81 + t6 * t82) + m(7) * (t2 * t81 + t3 * t82) + m(5) * (t104 * t20 + t107 * t19) + m(4) * t93; m(7) * (t28 * t81 + t29 * t82) + m(6) * (t42 * t81 + t43 * t82); m(4) + m(5) * t128 + 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * (t81 ^ 2 + t82 ^ 2); t120 * t92 + (t106 * t24 + t132 * t103 + m(6) * (t103 * t6 + t106 * t5) + t3 * t136) * pkin(4) + t19 * mrSges(5,1) - t20 * mrSges(5,2) + t112 - Ifges(5,6) * t124 + t147; t117 * t92 - t116 * t90 + (mrSges(7,3) * t125 + (-t106 * t82 + t125) * mrSges(6,3) + t29 * t136 + m(6) * (t103 * t43 + t106 * t42)) * pkin(4) + t113 + t129; m(6) * (t81 * t135 + t64) + m(7) * (t81 * t92 + t64) + t115 - t84; t92 * t143 + Ifges(5,3) + m(7) * (t92 ^ 2 + t96) + m(6) * (t106 ^ 2 * t110 + t96) + 0.2e1 * t145 + t134; t120 * pkin(5) + t112; t117 * pkin(5) + t113; m(7) * t138 + t115; t92 * t140 + (pkin(5) + t92) * mrSges(7,1) + t145 + t134; (t143 + t140) * pkin(5) + t134; m(7) * t16 + t17; m(7) * t58 + t48; 0; 0; 0; m(7);];
