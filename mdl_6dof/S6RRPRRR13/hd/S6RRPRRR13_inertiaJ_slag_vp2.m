...
t1 = [(0.2e1 * t69 * (mrSges(4,2) * t147 - mrSges(4,3) * t143) + t143 * t167 + (m(3) * pkin(1) ^ 2 + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(4,3) + Ifges(3,2)) * t147) * t147 + (-0.2e1 * pkin(1) * mrSges(3,2) + (Ifges(3,1) + Ifges(4,2)) * t143 + 0.2e1 * (Ifges(3,4) + Ifges(4,6)) * t147) * t143) * t138 + 0.2e1 * (-t143 * t87 + t147 * t88) * mrSges(3,3) + ((-(2 * Ifges(4,5)) + Ifges(3,6)) * t147 + (-(2 * Ifges(4,4)) + Ifges(3,5)) * t143) * t139) * t138 + (t160 - 0.2e1 * t180 + 0.2e1 * t181) * t139 + t86 * t40 + 0.2e1 * t68 * t95 + 0.2e1 * t70 * t96 + t56 * t17 + 0.2e1 * t58 * t42 + 0.2e1 * t27 * t60 + 0.2e1 * t26 * t61 + t55 * t16 + m(3) * (t87 ^ 2 + t88 ^ 2) + t30 * t7 + t31 * t8 + 0.2e1 * t19 * t33 + 0.2e1 * t10 * t34 + 0.2e1 * t9 * t35 + 0.2e1 * t12 * t11 + 0.2e1 * t3 * t13 + 0.2e1 * t2 * t14 + m(4) * (t68 ^ 2 + t69 ^ 2 + t70 ^ 2) + m(5) * (t26 ^ 2 + t27 ^ 2 + t58 ^ 2) + m(6) * (t10 ^ 2 + t19 ^ 2 + t9 ^ 2) + m(7) * (t12 ^ 2 + t2 ^ 2 + t3 ^ 2) + (t15 + t6 - t39) * t85 + Ifges(2,3); -t180 + t181 + (t40 / 0.2e1 + t145 * t193 - t141 * t16 / 0.2e1 - t26 * mrSges(5,3) + t179 * t148) * t146 + m(6) * (t10 * t67 - t170 * t19 + t66 * t9) + t160 + m(5) * (qJ(3) * t58 + t148 * t156) + t10 * t99 + t9 * t100 + t58 * t103 + t86 * t108 / 0.2e1 + t19 * t89 + t94 * t11 - pkin(2) * t96 - t68 * mrSges(4,3) + t70 * mrSges(4,2) + t3 * t64 + t2 * t65 + t66 * t35 + t67 * t34 + t12 * t41 + (-t39 / 0.2e1 + t15 / 0.2e1 + t6 / 0.2e1 + t148 * t60 - t27 * mrSges(5,3)) * t142 + t22 * t14 + t23 * t13 + (-t95 + t42) * qJ(3) + m(7) * (t12 * t94 + t2 * t22 + t23 * t3) + m(4) * (-pkin(2) * t70 - qJ(3) * t68) + (-t106 / 0.2e1 + t74 / 0.2e1 + t36 / 0.2e1) * t85 + t8 * t187 + t7 * t188 + t56 * t189 + t55 * t190 + t38 * t191 + t37 * t192 + (-Ifges(4,5) * t147 + t143 * (-Ifges(5,6) * t142 + t132) / 0.2e1 - Ifges(4,4) * t143) * t138; -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t66 * t100 + 0.2e1 * t22 * t65 + 0.2e1 * t23 * t64 - t78 * t37 + t80 * t38 + 0.2e1 * t94 * t41 + 0.2e1 * t67 * t99 + (-t106 + t74 + t36) * t142 + (-t141 * t75 + t145 * t76 + t89 * t194 + t108) * t146 + m(5) * (t134 * t137 + t122 + t149) + m(4) * (pkin(2) ^ 2 + t149) + m(6) * (t66 ^ 2 + t67 ^ 2 + t122) + m(7) * (t22 ^ 2 + t23 ^ 2 + t94 ^ 2) + 0.2e1 * (t103 + mrSges(4,3)) * qJ(3) + t161 * t194 + t195; t79 * t13 - t77 * t14 + (-t11 + t179) * t146 + (-t141 * t35 + t145 * t34 + t60) * t142 + m(7) * (-t12 * t146 - t2 * t77 + t3 * t79) + m(6) * (t142 * t159 - t146 * t19) + m(5) * t156 + m(4) * t70 + t96; -m(4) * pkin(2) + t79 * t64 - t77 * t65 + mrSges(4,2) + (-t41 - t89) * t146 + (-t141 * t100 + t145 * t99) * t142 - t161 + m(7) * (-t146 * t94 - t22 * t77 + t23 * t79) + m(6) * (t142 * t157 + t123) + m(5) * (t134 * t148 + t123); m(4) + m(5) * t168 + m(6) * (t134 * t169 + t136) + m(7) * (t77 ^ 2 + t79 ^ 2 + t136); t167 + t166 * t85 + m(6) * (-pkin(4) * t19 + pkin(10) * t159) + t19 * t102 + t55 * t105 / 0.2e1 + t56 * t183 + t121 * t11 + t7 * t186 + t8 * t185 + t62 * t14 + t63 * t13 + t12 * t51 + t53 * t192 + t54 * t191 - pkin(4) * t33 + t26 * mrSges(5,1) - t27 * mrSges(5,2) + (t16 / 0.2e1 + pkin(10) * t34 + t10 * mrSges(6,3)) * t145 + (-t9 * mrSges(6,3) - pkin(10) * t35 + t193) * t141 + m(7) * (t12 * t121 + t2 * t62 + t3 * t63) + (-t2 * t98 + t3 * t97) * mrSges(7,3); t132 + t121 * t41 - pkin(4) * t89 + t94 * t51 + t37 * t186 + t38 * t185 + t53 * t188 + t54 * t187 + t63 * t64 + t62 * t65 + t176 * t170 + (-t22 * t98 + t23 * t97) * mrSges(7,3) + (t67 * mrSges(6,3) + pkin(10) * t99 + t146 * t183 + t190) * t145 + (t189 - t146 * t105 / 0.2e1 - pkin(10) * t100 - t66 * mrSges(6,3)) * t141 + m(6) * (pkin(4) * t170 + pkin(10) * t157) + m(7) * (t121 * t94 + t22 * t62 + t23 * t63) + (-t148 * mrSges(5,2) - Ifges(5,6) + t166) * t142; (t77 * t98 + t79 * t97) * mrSges(7,3) + (-t51 + t176) * t146 + (-mrSges(5,2) + t162) * t142 + m(6) * (pkin(10) * t142 * t169 + pkin(4) * t146) + m(7) * (-t121 * t146 - t62 * t77 + t63 * t79); -0.2e1 * pkin(4) * t102 + t145 * t105 + t141 * t107 + 0.2e1 * t121 * t51 + t97 * t53 + t98 * t54 + Ifges(5,3) + m(7) * (t121 ^ 2 + t62 ^ 2 + t63 ^ 2) + m(6) * (pkin(10) ^ 2 * t169 + pkin(4) ^ 2) + 0.2e1 * (-t62 * t98 + t63 * t97) * mrSges(7,3) + 0.2e1 * pkin(10) * t162; t9 * mrSges(6,1) - t10 * mrSges(6,2) + (t140 * t13 + t144 * t14 + m(7) * (t140 * t3 + t144 * t2)) * pkin(5) + t154 + t15; t66 * mrSges(6,1) - t67 * mrSges(6,2) + (m(7) * (t140 * t23 + t144 * t22) + t140 * t64 + t144 * t65) * pkin(5) + t153 + t74; -t158 * t142 + m(7) * (t140 * t79 - t144 * t77) * pkin(5) + t164; -t158 * pkin(10) + (m(7) * (t140 * t63 + t144 * t62) + (t140 * t97 - t144 * t98) * mrSges(7,3)) * pkin(5) + t155 + t104; Ifges(6,3) + Ifges(7,3) + m(7) * (t140 ^ 2 + t144 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t152; t154; t153; t164; t155; Ifges(7,3) + t152; Ifges(7,3);];
