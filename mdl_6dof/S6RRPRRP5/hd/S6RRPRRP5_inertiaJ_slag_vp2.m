...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:13:19
% EndTime: 2018-11-23 17:13:21
...
t12 = [t56 * t27 + 0.2e1 * t39 * t58 + 0.2e1 * t38 * t59 + 0.2e1 * t19 * t44 + 0.2e1 * t18 * t45 + 0.2e1 * t31 * t30 + 0.2e1 * t5 * t20 + 0.2e1 * t13 * t21 + 0.2e1 * t2 * t22 + 0.2e1 * t4 * t23 + 0.2e1 * t1 * t24 + 0.2e1 * t3 * t25 + ((Ifges(3,5) * t138 + Ifges(3,6) * t141) * t135 + 0.2e1 * (-t138 * t79 + t141 * t80) * mrSges(3,3) + (-0.2e1 * pkin(1) * (-mrSges(3,1) * t141 + mrSges(3,2) * t138) + t138 * (Ifges(3,1) * t138 + Ifges(3,4) * t141) + t141 * (Ifges(3,4) * t138 + Ifges(3,2) * t141) + m(3) * pkin(1) ^ 2) * t133) * t133 + (mrSges(4,1) * t180 - 0.2e1 * Ifges(4,4) * t68 + Ifges(4,2) * t67 + t153) * t67 + m(4) * (t38 ^ 2 + t39 ^ 2 + t84 ^ 2) + m(5) * (t18 ^ 2 + t19 ^ 2 + t31 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t13 ^ 2 + t3 ^ 2 + t4 ^ 2) + (t10 + t11) * t42 + (t8 + t9) * t41 + (-t26 + t183) * t55 + (t144 - 0.2e1 * t172 + 0.2e1 * t173 + t182) * t135 + m(3) * (t79 ^ 2 + t80 ^ 2) + Ifges(2,3) + t63 * t180 + Ifges(4,1) * t68 ^ 2; t144 + t31 * t93 + t56 * t102 / 0.2e1 + t117 * t30 + t5 * t81 + t13 * t82 + t2 * t85 + t4 * t86 + t1 * t87 + t3 * t88 + t77 * t20 + t53 * t25 + t54 * t23 + t46 * t24 + t47 * t22 + t38 * mrSges(4,1) - t39 * mrSges(4,2) + (t116 * t44 + t19 * mrSges(5,3) + t26 / 0.2e1 - t6 / 0.2e1 - t7 / 0.2e1) * t140 + (-t18 * mrSges(5,3) + t27 / 0.2e1 + t152 * t139 + t154 * t136 + t168 * t116) * t137 + t67 * t157 / 0.2e1 + t151 * t41 + t150 * t42 + m(6) * (t116 * t13 * t137 + t3 * t53 + t4 * t54) + m(7) * (t1 * t46 + t2 * t47 + t5 * t77) + (-t99 / 0.2e1 + t69 / 0.2e1 + t70 / 0.2e1) * t55 + m(5) * (t117 * t31 + (-t137 * t18 + t140 * t19) * t116) + (t132 * t58 + t134 * t59 + m(4) * (t132 * t39 + t134 * t38)) * pkin(2) - t172 + t173; 0.2e1 * t117 * t93 + 0.2e1 * t46 * t87 + 0.2e1 * t47 * t85 + 0.2e1 * t53 * t88 + 0.2e1 * t54 * t86 + 0.2e1 * t77 * t81 + (t99 - t69 - t70) * t140 + m(5) * (t114 * t131 + t117 ^ 2 + t103) + m(6) * (t53 ^ 2 + t54 ^ 2 + t103) + m(7) * (t46 ^ 2 + t47 ^ 2 + t77 ^ 2) + m(4) * (t132 ^ 2 + t134 ^ 2) * pkin(2) ^ 2 + (t82 * t184 + t102 + (t73 + t74) * t139 + (-t71 - t72) * t136) * t137 + 0.2e1 * (mrSges(4,1) * t134 - mrSges(4,2) * t132) * pkin(2) + t155 * mrSges(5,3) * t184 + t186; t67 * mrSges(4,1) + t63 + (-t20 - t168) * t140 + (t44 + (t22 + t23) * t139 + (-t24 - t25) * t136) * t137 + m(6) * (-t13 * t140 + (-t136 * t3 + t139 * t4) * t137) + m(7) * (-t140 * t5 + (-t1 * t136 + t139 * t2) * t137) + m(5) * (t137 * t19 + t140 * t18) + m(4) * t84; (-t82 - t181) * t140 + ((t85 + t86) * t139 + (-t87 - t88) * t136 + m(7) * (-t136 * t46 + t139 * t47) + m(6) * (-t136 * t53 + t139 * t54 - t162)) * t137; m(4) + m(5) * t155 + 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * (t156 * t129 + t131); t18 * mrSges(5,1) - t19 * mrSges(5,2) - pkin(4) * t21 + t118 * t20 - t94 * t22 + t90 * t24 + t5 * t91 + t149 * t55 + t147 * t42 + t148 * t41 + m(7) * (t1 * t90 + t118 * t5 - t2 * t94) + (t2 * mrSges(7,3) + t4 * mrSges(6,3) + (m(6) * t4 + t23) * pkin(10) - t154) * t139 + (-t1 * mrSges(7,3) - t3 * mrSges(6,3) + (-m(6) * t3 - t25) * pkin(10) + t152) * t136 + t153 + (t92 - t179) * t13; m(7) * (t118 * t77 + t46 * t90 - t47 * t94) + t77 * t91 - t94 * t85 + t118 * t81 - pkin(4) * t82 + t90 * t87 - t149 * t140 + (-t140 * mrSges(5,2) + (-t171 - t179) * t137) * t116 + (t54 * mrSges(6,3) + t47 * mrSges(7,3) + t147 * t137 + (m(6) * t54 + t86) * pkin(10) + t151) * t139 + (-t53 * mrSges(6,3) - t46 * mrSges(7,3) - t148 * t137 + (-m(6) * t53 - t88) * pkin(10) + t150) * t136 + t157; (-t91 + t171) * t140 + (t156 * mrSges(7,3) - mrSges(5,2) + t146) * t137 + m(6) * (t156 * t174 + t175) + m(7) * (-t118 * t140 + (-t136 * t90 - t139 * t94) * t137); -0.2e1 * pkin(4) * t92 + 0.2e1 * t118 * t91 + Ifges(5,3) + 0.2e1 * pkin(10) * t146 + m(7) * (t118 ^ 2 + t90 ^ 2 + t94 ^ 2) + m(6) * (t156 * pkin(10) ^ 2 + pkin(4) ^ 2) + (t185 * t94 + t97 + t98) * t139 + (t185 * t90 + t100 + t101) * t136; mrSges(6,1) * t3 + mrSges(7,1) * t1 - mrSges(6,2) * t4 - mrSges(7,2) * t2 + (m(7) * t1 + t24) * pkin(5) + t183; mrSges(6,1) * t53 + mrSges(7,1) * t46 - mrSges(6,2) * t54 - mrSges(7,2) * t47 + t112 + t113 + t170 * t140 + (-Ifges(6,6) - Ifges(7,6)) * t159 + (m(7) * t46 + t87) * pkin(5); (-t167 + (-mrSges(6,1) - t178) * t136) * t137 - t81; mrSges(7,1) * t90 + mrSges(7,2) * t94 - t145 * pkin(10) + (m(7) * t90 - t136 * mrSges(7,3)) * pkin(5) + t96 + t95; (0.2e1 * mrSges(7,1) + t178) * pkin(5) - t170; m(7) * t5 + t20; t181; -m(7) * t140; m(7) * t118 + t91; 0; m(7);];
