% Umwandlung der Kinematikparameter von S6PRPRRP3V1 zu S6PRPRRP3
% Eingabe:
% pkin_var (9x1) double
...
%
% Siehe auch: S6PRPRRP3_structural_kinematic_parameters.m
function pkin_gen = S6PRPRRP3V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
