...
t1 = [m(4) * (t63 ^ 2 + t65 ^ 2 + t93 ^ 2) + m(7) * (t15 ^ 2 + t2 ^ 2 + t3 ^ 2) + 0.2e1 * t12 * t39 + 0.2e1 * t11 * t40 - t36 * t8 + t37 * t9 + 0.2e1 * t15 * t13 + 0.2e1 * t3 * t16 + 0.2e1 * t2 * t17 + Ifges(3,2) * t101 + (-0.2e1 * t63 * mrSges(4,3) + Ifges(4,1) * t81 + Ifges(4,4) * t140) * t81 + (mrSges(5,1) * t141 - 0.2e1 * t32 * mrSges(5,3) + (Ifges(6,3) + Ifges(5,2)) * t57 + t125) * t57 + (mrSges(5,3) * t143 + Ifges(5,1) * t58 - t102 * t22 + t104 * t23 + (Ifges(6,5) * t104 - Ifges(6,6) * t102 - (2 * Ifges(5,4))) * t57) * t58 + m(5) * (t32 ^ 2 + t66 ^ 2 + t144) + m(6) * (t11 ^ 2 + t12 ^ 2 + t144) + m(3) * (qJ(2) ^ 2 * t128 + pkin(1) ^ 2) - 0.2e1 * pkin(1) * t123 + 0.2e1 * t93 * t124 + 0.2e1 * t128 * qJ(2) * mrSges(3,3) + Ifges(2,3) + t65 * mrSges(4,3) * t140 + t53 * t141 + t38 * t143 + Ifges(4,2) * t79 ^ 2 + (Ifges(3,1) * t103 + 0.2e1 * Ifges(3,4) * t105) * t103; -m(3) * pkin(1) + t57 * mrSges(5,1) + t102 * t39 + t104 * t40 + t80 * t16 + t78 * t17 + t53 + m(7) * (t2 * t78 + t3 * t80) + m(6) * (t102 * t12 + t104 * t11) + m(5) * t66 + m(4) * t93 + t123 + t124; m(3) + m(4) + m(5) + m(6) * t127 + m(7) * (t78 ^ 2 + t80 ^ 2); (m(5) * (t107 * t32 - t110 * t30) + (-t107 * t57 - t110 * t58) * mrSges(5,3)) * pkin(3) + t82 * t13 + t94 * t38 + Ifges(4,6) * t79 + Ifges(4,5) * t81 + t63 * mrSges(4,1) - t65 * mrSges(4,2) + t51 * t17 + t52 * t16 + t39 * t129 + t115 + m(6) * (t119 * t91 + t30 * t94) + (-t11 * mrSges(6,3) - t91 * t40) * t102 + m(7) * (t15 * t82 + t2 * t51 + t3 * t52); m(7) * (t51 * t78 + t52 * t80); t82 * t142 + 0.2e1 * t94 * t84 + Ifges(4,3) + 0.2e1 * t118 + (-t51 * t80 + t52 * t78) * t126 + t91 * t120 + m(7) * (t51 ^ 2 + t52 ^ 2 + t82 ^ 2) + m(6) * (t127 * t91 ^ 2 + t94 ^ 2) + m(5) * (t107 ^ 2 + t110 ^ 2) * pkin(3) ^ 2 + t121; t92 * t13 + t62 * t17 + t64 * t16 - pkin(4) * t38 - mrSges(6,3) * t133 + t115 + m(6) * (-pkin(4) * t30 + qJ(5) * t119) + m(7) * (t15 * t92 + t2 * t62 + t3 * t64) + (-t102 * t40 + t104 * t39) * qJ(5); m(7) * (t62 * t78 + t64 * t80); (t94 - pkin(4)) * t84 + (t82 + t92) * t59 + t118 + m(7) * (t51 * t62 + t52 * t64 + t82 * t92) + m(6) * (-pkin(4) * t94 + t122 * t91) + ((-t51 - t62) * t80 + (t52 + t64) * t78) * mrSges(7,3) + (t127 * t91 + t122) * mrSges(6,3) + t121; -0.2e1 * pkin(4) * t84 + t92 * t142 + (-t62 * t80 + t64 * t78) * t126 + qJ(5) * t120 + m(7) * (t62 ^ 2 + t64 ^ 2 + t92 ^ 2) + m(6) * (qJ(5) ^ 2 * t127 + pkin(4) ^ 2) + t121; m(6) * t30 + m(7) * t15 + t13 + t38; 0; m(6) * t94 + m(7) * t82 + t117; -m(6) * pkin(4) + m(7) * t92 + t117; m(6) + m(7); mrSges(7,1) * t2 - mrSges(7,2) * t3 + t125; -t59; mrSges(7,1) * t51 - mrSges(7,2) * t52 + t136; mrSges(7,1) * t62 - t64 * mrSges(7,2) + t136; 0; Ifges(7,3);];
