...
t18 = t58 * mrSges(7,1) - t59 * mrSges(7,3);
t19 = t58 * mrSges(6,1) + t59 * mrSges(6,2);
t124 = -t18 - t19;
t93 = cos(qJ(3));
t122 = pkin(3) * t93;
t121 = pkin(8) * t91;
...
t33 = t93 * mrSges(7,1) - t46 * mrSges(7,2);
t112 = -t32 + t33;
...
t2 = pkin(5) * t93 - t3;
t1 = -qJ(6) * t93 + t4;
t6 = [0.2e1 * t1 * t30 + 0.2e1 * t5 * t14 + 0.2e1 * t49 * t15 + 0.2e1 * t2 * t33 + 0.2e1 * t24 * t62 + 0.2e1 * t25 * t61 + 0.2e1 * t3 * t32 + 0.2e1 * t4 * t31 + Ifges(2,3) + Ifges(3,3) - (t9 + t10) * t46 + (t7 - t8) * t44 + (0.2e1 * mrSges(4,2) * t77 + Ifges(4,1) * t91 + t56 * t127 - t42 * t90 + t43 * t92) * t91 + (-0.2e1 * t77 * mrSges(4,1) + (Ifges(4,2) - t106) * t93 + (Ifges(5,6) * t90 + (2 * Ifges(4,4))) * t91 + t101) * t93 + m(4) * (t72 * t85 + t77 ^ 2 + t68) + m(5) * (t24 ^ 2 + t25 ^ 2 + t68) + m(6) * (t3 ^ 2 + t4 ^ 2 + t49 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(3) * (t87 ^ 2 + t89 ^ 2) * pkin(1) ^ 2 + 0.2e1 * (mrSges(3,1) * t89 - mrSges(3,2) * t87) * pkin(1) + t109 * mrSges(4,3) * t127; -t113 * t46 + t112 * t44 + t128 * t93 + m(6) * (-t3 * t44 - t4 * t46 - t49 * t93) + m(7) * (-t1 * t46 + t2 * t44 - t5 * t93) + (t92 * t61 - t90 * t62 + m(5) * (t99 - t118)) * t91; m(3) + m(5) * (t110 * t83 + t85) + m(4) * t109 + t123 * (t44 ^ 2 + t46 ^ 2 + t85); -pkin(3) * t56 + t17 * t14 + t78 * t15 + t5 * t18 + t49 * t19 + (Ifges(4,6) - t81 / 0.2e1 - t80 / 0.2e1 - t54 / 0.2e1 + t53 / 0.2e1 - t55 / 0.2e1 - t52 / 0.2e1 - t75 * mrSges(4,2)) * t93 - (t22 / 0.2e1 + t23 / 0.2e1) * t46 + (t20 / 0.2e1 - t21 / 0.2e1) * t44 + t113 * t29 + t112 * t27 + (t42 / 0.2e1 + pkin(8) * t61 + t25 * mrSges(5,3)) * t92 + (t43 / 0.2e1 - pkin(8) * t62 - t24 * mrSges(5,3)) * t90 + (Ifges(4,5) + t92 * t67 / 0.2e1 - t90 * t66 / 0.2e1 + t111 * t75) * t91 + m(5) * (-pkin(3) * t69 + pkin(8) * t99) + m(6) * (-t27 * t3 + t29 * t4 + t49 * t78) + m(7) * (t1 * t29 + t17 * t5 + t2 * t27) + (t9 / 0.2e1 + t10 / 0.2e1 - t3 * mrSges(6,3) + t2 * mrSges(7,2)) * t59 + (t7 / 0.2e1 - t8 / 0.2e1 - t1 * mrSges(7,2) - t4 * mrSges(6,3)) * t58; (-mrSges(4,2) + t103) * t91 + (-t111 + t124) * t93 + m(6) * (-t78 * t93 + t105) + m(7) * (-t17 * t93 + t105) + m(5) * (t110 * t121 + t122) + t125 * (t44 * t59 + t46 * t58); -0.2e1 * pkin(3) * t64 + 0.2e1 * t17 * t18 + 0.2e1 * t78 * t19 + t92 * t66 + t90 * t67 + Ifges(4,3) + m(6) * (t78 ^ 2 + t107) + m(7) * (t17 ^ 2 + t107) + m(5) * (pkin(8) ^ 2 * t110 + pkin(3) ^ 2) + (t22 + t23) * t59 + (t20 - t21) * t58 + 0.2e1 * pkin(8) * t103 + 0.2e1 * (t27 * t59 - t29 * t58) * t125; -Ifges(5,6) * t117 - t4 * mrSges(6,2) + t3 * mrSges(6,1) - t2 * mrSges(7,1) + t76 * t33 + t1 * mrSges(7,3) + t73 * t30 + m(7) * (t1 * t73 + t2 * t76) - t25 * mrSges(5,2) + t24 * mrSges(5,1) + t106 * t93 + (m(6) * (t3 * t88 + t4 * t86) + t86 * t31 + t88 * t32) * pkin(4) - t101; m(7) * (t44 * t76 - t46 * t73) + (-t44 * t88 - t46 * t86) * t126 + t128; t29 * mrSges(7,3) - t29 * mrSges(6,2) - t27 * mrSges(6,1) - t27 * mrSges(7,1) + m(7) * (t27 * t76 + t29 * t73) + t54 - t53 + t81 + t80 + t55 + t52 - t100 * pkin(8) + (-t58 * t73 + t59 * t76) * mrSges(7,2) + (m(6) * (-t27 * t88 + t29 * t86) + (-t58 * t86 - t59 * t88) * mrSges(6,3)) * pkin(4); -0.2e1 * t76 * mrSges(7,1) + 0.2e1 * t73 * mrSges(7,3) + m(7) * (t73 ^ 2 + t76 ^ 2) - t106 + (0.2e1 * mrSges(6,1) * t88 - 0.2e1 * mrSges(6,2) * t86 + (t86 ^ 2 + t88 ^ 2) * t126) * pkin(4); m(6) * t49 + m(7) * t5 - t97; -t123 * t93; m(6) * t78 + m(7) * t17 - t124; 0; t123; m(7) * t2 + t33; m(7) * t44; m(7) * t27 + t59 * mrSges(7,2); m(7) * t76 - mrSges(7,1); 0; m(7);];
