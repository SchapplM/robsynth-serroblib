...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:39:29
% EndTime: 2018-11-23 18:39:30
...
t1 = [(0.2e1 * pkin(1) * mrSges(3,1) - t120 + (Ifges(3,2) + t161) * t145 + (Ifges(4,6) * t139 + (2 * Ifges(3,4))) * t140 + t172 + t183 + t184) * t145 + m(7) * (t2 ^ 2 + t3 ^ 2 + t37 ^ 2) + m(6) * (t13 ^ 2 + t14 ^ 2 + t73 ^ 2) + m(5) * (t112 ^ 2 + t46 ^ 2 + t47 ^ 2) + m(4) * (t84 ^ 2 + t85 ^ 2 + t130) + m(3) * (pkin(1) ^ 2 + t135 * t147 + t130) + 0.2e1 * t73 * t31 + 0.2e1 * t47 * t82 + 0.2e1 * t46 * t83 - t93 * t53 + t94 * t54 + 0.2e1 * t85 * t110 + 0.2e1 * t84 * t111 + 0.2e1 * t112 * t63 + Ifges(2,3) + (t133 + t135) * mrSges(3,3) * t185 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t140 + t100 * t185 - t139 * t89 + t144 * t90) * t140 + 0.2e1 * t3 * t20 + 0.2e1 * t2 * t21 + t28 * t9 + t29 * t10 + 0.2e1 * t37 * t11 + 0.2e1 * t14 * t49 + 0.2e1 * t13 * t50 + t56 * t24 + t57 * t25; m(7) * (t2 * t5 + t3 * t6 + t37 * t48) + m(6) * (t13 * t34 + t14 * t35 + t73 * t86) + m(5) * (t112 * t125 + t46 * t80 + t47 * t81) + (-t2 * t41 + t3 * t40) * mrSges(7,3) + (-t13 * t71 + t14 * t70) * mrSges(6,3) + (t47 * t105 - t46 * t106) * mrSges(5,3) + (-t139 * t115 / 0.2e1 + t144 * t116 / 0.2e1 + Ifges(3,5) + (-mrSges(3,1) + t114) * pkin(7)) * t140 + t70 * t24 / 0.2e1 + t71 * t25 / 0.2e1 + t73 * t42 + t81 * t82 + t80 * t83 + t86 * t31 - t93 * t76 / 0.2e1 + t94 * t77 / 0.2e1 - pkin(2) * t100 + m(4) * (-pkin(2) * t131 + (-t84 * t139 + t85 * t144) * pkin(8)) + t105 * t53 / 0.2e1 + t106 * t54 / 0.2e1 + t112 * t75 + t125 * t63 + (-pkin(7) * mrSges(3,2) - t69 / 0.2e1 - t68 / 0.2e1 - t102 / 0.2e1 - t101 / 0.2e1 - t129 / 0.2e1 - t128 / 0.2e1 + Ifges(3,6) - t39 / 0.2e1 - t38 / 0.2e1) * t145 + t6 * t20 + t5 * t21 + t28 * t16 / 0.2e1 + t29 * t17 / 0.2e1 + t37 * t15 + t40 * t9 / 0.2e1 + t41 * t10 / 0.2e1 + t48 * t11 + t35 * t49 + t34 * t50 + (-t84 * mrSges(4,3) - pkin(8) * t111 + t90 / 0.2e1) * t139 + (t85 * mrSges(4,3) + pkin(8) * t110 + t89 / 0.2e1) * t144 + t56 * t43 / 0.2e1 + t57 * t44 / 0.2e1; -0.2e1 * pkin(2) * t114 + t105 * t76 + t106 * t77 + t144 * t115 + t139 * t116 + 0.2e1 * t125 * t75 + 0.2e1 * t48 * t15 + t40 * t16 + t41 * t17 + 0.2e1 * t86 * t42 + t70 * t43 + t71 * t44 + Ifges(3,3) + m(7) * (t48 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(6) * (t34 ^ 2 + t35 ^ 2 + t86 ^ 2) + m(5) * (t125 ^ 2 + t80 ^ 2 + t81 ^ 2) + m(4) * (t165 * pkin(8) ^ 2 + pkin(2) ^ 2) + 0.2e1 * (t40 * t6 - t41 * t5) * mrSges(7,3) + 0.2e1 * (-t34 * t71 + t35 * t70) * mrSges(6,3) + 0.2e1 * (t105 * t81 - t106 * t80) * mrSges(5,3) + 0.2e1 * t165 * pkin(8) * mrSges(4,3); m(7) * (t2 * t61 + t3 * t62) + m(6) * (t13 * t97 + t14 * t99) - t161 * t145 + (t138 * t82 + t143 * t83 + m(5) * (t138 * t47 + t143 * t46)) * pkin(3) + t120 + t152 + t84 * mrSges(4,1) - t85 * mrSges(4,2) + t97 * t50 + t99 * t49 - Ifges(4,6) * t167 + t61 * t21 + t62 * t20; m(7) * (t5 * t61 + t6 * t62) + m(6) * (t34 * t97 + t35 * t99) - t157 * pkin(8) + (t40 * t62 - t41 * t61) * mrSges(7,3) + (t70 * t99 - t71 * t97) * mrSges(6,3) + (m(5) * (t138 * t81 + t143 * t80) + (t105 * t138 - t106 * t143) * mrSges(5,3)) * pkin(3) + t128 + t129 + t151; -0.2e1 * t175 - 0.2e1 * t177 + 0.2e1 * t55 + 0.2e1 * t92 + 0.2e1 * t155 + m(7) * (t61 ^ 2 + t62 ^ 2) + m(6) * (t97 ^ 2 + t99 ^ 2) + m(5) * (t138 ^ 2 + t143 ^ 2) * pkin(3) ^ 2 + t161; m(7) * (t2 * t96 + t3 * t98) + t162 * t145 + (t142 * t50 + t137 * t49 + m(6) * (t13 * t142 + t137 * t14)) * pkin(4) + t152 + t96 * t21 + t98 * t20; (t40 * t98 - t41 * t96) * mrSges(7,3) + m(7) * (t5 * t96 + t6 * t98) + (m(6) * (t137 * t35 + t142 * t34) + (t137 * t70 - t142 * t71) * mrSges(6,3)) * pkin(4) + t151; Ifges(5,3) + m(7) * (t61 * t96 + t62 * t98) + t91 + t127 + t155 + (-t98 - t62) * mrSges(7,2) + (-t168 + m(6) * (t137 * t99 + t142 * t97)) * pkin(4) + t156; -0.2e1 * t163 - 0.2e1 * t176 + 0.2e1 * t127 + 0.2e1 * t91 + m(7) * (t96 ^ 2 + t98 ^ 2) + m(6) * (t137 ^ 2 + t142 ^ 2) * pkin(4) ^ 2 - t162; t174 * t145 + (t136 * t20 + t141 * t21 + m(7) * (t136 * t3 + t141 * t2)) * pkin(5) + t154; (m(7) * (t136 * t6 + t141 * t5) + (t136 * t40 - t141 * t41) * mrSges(7,3)) * pkin(5) + t153; -t177 + t126 + (m(7) * (t136 * t62 + t141 * t61) - t169) * pkin(5) + t156; -t163 + Ifges(6,3) + t126 + t127 + (-t169 + m(7) * (t136 * t98 + t141 * t96)) * pkin(5) + t160; -0.2e1 * t164 + 0.2e1 * t126 + m(7) * (t136 ^ 2 + t141 ^ 2) * pkin(5) ^ 2 - t174; -Ifges(7,3) * t145 + t159; t158; t173 - t177; t160; Ifges(7,3) + t126 - t164; Ifges(7,3);];
