...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:23:29
% EndTime: 2018-11-23 17:23:31
...
t1 = [Ifges(4,1) * t91 ^ 2 + 0.2e1 * t12 * t11 + m(3) * (t100 ^ 2 + t101 ^ 2) + ((Ifges(3,5) * t151 + Ifges(3,6) * t155) * t147 + 0.2e1 * (-t100 * t151 + t101 * t155) * mrSges(3,3) + (-0.2e1 * pkin(1) * (-mrSges(3,1) * t155 + mrSges(3,2) * t151) + t151 * (Ifges(3,1) * t151 + Ifges(3,4) * t155) + t155 * (Ifges(3,4) * t151 + Ifges(3,2) * t155) + m(3) * pkin(1) ^ 2) * t145) * t145 + (t160 - 0.2e1 * t181 + 0.2e1 * t182 + t204) * t147 + 0.2e1 * t3 * t13 + 0.2e1 * t2 * t14 + t28 * t9 + t29 * t10 + 0.2e1 * t19 * t30 + 0.2e1 * t7 * t31 + 0.2e1 * t6 * t32 + 0.2e1 * t41 * t40 + t48 * t16 + t49 * t17 + 0.2e1 * t25 * t51 + 0.2e1 * t24 * t52 + (t8 + t15 - t36) * t66 + Ifges(2,3) + t67 * t37 + 0.2e1 * t46 * t74 + 0.2e1 * t45 * t75 + t83 * t203 + (mrSges(4,1) * t203 - 0.2e1 * Ifges(4,4) * t91 + Ifges(4,2) * t90 + t170) * t90 + m(7) * (t12 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t19 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(5) * (t24 ^ 2 + t25 ^ 2 + t41 ^ 2) + m(4) * (t108 ^ 2 + t45 ^ 2 + t46 ^ 2); m(5) * (t132 * t41 + (-t24 * t150 + t25 * t154) * t131) + (t25 * mrSges(5,3) + t131 * t51 - t8 / 0.2e1 - t15 / 0.2e1 + t36 / 0.2e1) * t154 + t182 - t181 + (t144 * t74 + t146 * t75 + m(4) * (t144 * t46 + t146 * t45)) * pkin(2) + t90 * t173 / 0.2e1 + t34 * t14 + t35 * t13 + m(6) * (t179 * t19 + t6 * t64 + t65 * t7) + t45 * mrSges(4,1) - t46 * mrSges(4,2) + t160 + t12 * t57 + t64 * t32 + t65 * t31 + t3 * t80 + t2 * t81 + t99 * t11 + t19 * t102 + t10 * t196 + t9 * t197 + t49 * t198 + t48 * t199 + t55 * t200 + t54 * t201 + t7 * t109 + t6 * t110 + t41 * t113 + (-t24 * mrSges(5,3) - t149 * t16 / 0.2e1 + t153 * t202 + t37 / 0.2e1 + t187 * t131) * t150 + t67 * t118 / 0.2e1 + t132 * t40 + (t53 / 0.2e1 + t92 / 0.2e1 - t116 / 0.2e1) * t66 + m(7) * (t12 * t99 + t2 * t34 + t3 * t35); 0.2e1 * t65 * t109 + 0.2e1 * t64 * t110 + 0.2e1 * t132 * t113 + 0.2e1 * t34 * t81 + 0.2e1 * t35 * t80 - t95 * t54 + t96 * t55 + 0.2e1 * t99 * t57 + (-t53 - t92 + t116) * t154 + (t102 * t205 - t149 * t93 + t153 * t94 + t118) * t150 + m(7) * (t34 ^ 2 + t35 ^ 2 + t99 ^ 2) + m(6) * (t64 ^ 2 + t65 ^ 2 + t119) + m(5) * (t129 * t143 + t132 ^ 2 + t119) + m(4) * (t144 ^ 2 + t146 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t146 - mrSges(4,2) * t144) * pkin(2) + t171 * mrSges(5,3) * t205 + t207; t90 * mrSges(4,1) + t96 * t13 - t95 * t14 + t83 + (-t11 - t187) * t154 + (-t149 * t32 + t153 * t31 + t51) * t150 + m(7) * (-t12 * t154 - t2 * t95 + t3 * t96) + m(6) * (t150 * t166 - t154 * t19) + m(5) * (t150 * t25 + t154 * t24) + m(4) * t108; t96 * t80 - t95 * t81 + m(7) * (-t34 * t95 + t35 * t96) + (t153 * t109 - t149 * t110 + m(6) * (t164 - t178)) * t150 + (-m(7) * t99 + t206) * t154; m(4) + m(5) * t171 + m(6) * (t141 * t172 + t143) + m(7) * (t95 ^ 2 + t96 ^ 2 + t143); (t7 * mrSges(6,3) + pkin(10) * t31 + t16 / 0.2e1) * t153 + (-t6 * mrSges(6,3) - pkin(10) * t32 + t202) * t149 + m(7) * (t12 * t133 + t2 * t78 + t3 * t79) + (t106 * t3 - t107 * t2) * mrSges(7,3) + t169 * t66 + m(6) * (-pkin(4) * t19 + pkin(10) * t166) + t170 + t24 * mrSges(5,1) - t25 * mrSges(5,2) - pkin(4) * t30 + t12 * t68 + t70 * t201 + t71 * t200 + t78 * t14 + t79 * t13 + t9 * t194 + t10 * t193 + t19 * t112 + t48 * t115 / 0.2e1 + t49 * t192 + t133 * t11; t79 * t80 + t78 * t81 + t70 * t197 + t71 * t196 + t99 * t68 - pkin(4) * t102 + t54 * t194 + t55 * t193 + t133 * t57 + t180 * t179 + (t106 * t35 - t107 * t34) * mrSges(7,3) + (t65 * mrSges(6,3) + pkin(10) * t109 + t150 * t192 + t199) * t153 + (-t64 * mrSges(6,3) - pkin(10) * t110 - t150 * t115 / 0.2e1 + t198) * t149 + m(7) * (t133 * t99 + t34 * t78 + t35 * t79) + m(6) * (-pkin(4) * t179 + pkin(10) * t164) + (-t131 * mrSges(5,2) - t169) * t154 + t173; (t106 * t96 + t107 * t95) * mrSges(7,3) + (-t68 - t180) * t154 + (-mrSges(5,2) + t168) * t150 + m(6) * (t172 * t189 + t190) + m(7) * (-t133 * t154 - t78 * t95 + t79 * t96); -0.2e1 * pkin(4) * t112 + t106 * t70 + t107 * t71 + t153 * t115 + t149 * t117 + 0.2e1 * t133 * t68 + Ifges(5,3) + m(7) * (t133 ^ 2 + t78 ^ 2 + t79 ^ 2) + m(6) * (pkin(10) ^ 2 * t172 + pkin(4) ^ 2) + 0.2e1 * (t106 * t79 - t107 * t78) * mrSges(7,3) + 0.2e1 * pkin(10) * t168; t6 * mrSges(6,1) - t7 * mrSges(6,2) + (m(7) * (t148 * t3 + t152 * t2) + t148 * t13 + t152 * t14) * pkin(5) + t161 + t15; t64 * mrSges(6,1) - t65 * mrSges(6,2) + t188 * t154 + (t148 * t80 + t152 * t81 + m(7) * (t148 * t35 + t152 * t34)) * pkin(5) + t163 + t167; m(7) * (t148 * t96 - t152 * t95) * pkin(5) + t206; -t165 * pkin(10) + (m(7) * (t148 * t79 + t152 * t78) + (t106 * t148 - t107 * t152) * mrSges(7,3)) * pkin(5) + t162 + t114; m(7) * (t148 ^ 2 + t152 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t159 - t188; t161; t163 - t183; -t57; t162; Ifges(7,3) + t159; Ifges(7,3);];
