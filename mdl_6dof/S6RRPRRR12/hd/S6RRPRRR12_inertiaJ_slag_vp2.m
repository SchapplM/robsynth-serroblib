...
t1 = [0.2e1 * t78 * t98 + 0.2e1 * t80 * t99 + t87 * t46 + t88 * t47 + 0.2e1 * t70 * t54 + 0.2e1 * t30 * t74 + 0.2e1 * t29 * t75 + t52 * t22 + 0.2e1 * t9 * t43 + 0.2e1 * t8 * t44 + 0.2e1 * t45 * t25 + t37 * t13 + t38 * t14 + 0.2e1 * t5 * t16 + 0.2e1 * t3 * t17 + 0.2e1 * t2 * t18 + m(3) * (t89 ^ 2 + t90 ^ 2) + m(5) * (t29 ^ 2 + t30 ^ 2 + t70 ^ 2) + m(4) * (t78 ^ 2 + t79 ^ 2 + t80 ^ 2) + m(6) * (t45 ^ 2 + t8 ^ 2 + t9 ^ 2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t5 ^ 2) + (-t21 + t12) * t51 + (m(3) * pkin(1) ^ 2 * t140 + (0.2e1 * t79 * mrSges(4,2) + 0.2e1 * t90 * mrSges(3,3) + (-(2 * Ifges(4,5)) + Ifges(3,6)) * t141 + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(4,3) + Ifges(3,2)) * t149) * t140) * t149 + (-0.2e1 * t89 * mrSges(3,3) - 0.2e1 * t79 * mrSges(4,3) + (-(2 * Ifges(4,4)) + Ifges(3,5)) * t141 + (-0.2e1 * pkin(1) * mrSges(3,2) + (Ifges(4,2) + Ifges(3,1)) * t145 + 0.2e1 * (Ifges(3,4) + Ifges(4,6)) * t149) * t140 + t173 + t209) * t145) * t140 + Ifges(2,3) + (t164 - 0.2e1 * t196 + 0.2e1 * t197) * t141; t197 + (-t98 + t54) * qJ(3) + m(6) * (t123 * t45 - t67 * t8 + t69 * t9) + m(4) * (-pkin(2) * t80 - qJ(3) * t78) + m(7) * (t2 * t27 + t28 * t3 + t5 * t67) - t196 + t88 * t112 / 0.2e1 + t123 * t25 + t70 * t107 + t87 * t110 / 0.2e1 - pkin(2) * t99 - t78 * mrSges(4,3) + t80 * mrSges(4,2) + t45 * t64 + t52 * t66 / 0.2e1 + t69 * t43 + t5 * t55 + t3 * t59 + t2 * t60 + (-t65 / 0.2e1 + t40 / 0.2e1) * t51 + t37 * t41 / 0.2e1 + t27 * t18 + t28 * t17 + (-Ifges(4,4) * t145 - Ifges(4,5) * t149 + (-Ifges(5,6) * t144 + t133 + t193) * t145 / 0.2e1) * t140 + (t12 / 0.2e1 - t21 / 0.2e1 - t9 * mrSges(6,3)) * t103 + (t150 * t74 - t46 / 0.2e1 - t30 * mrSges(5,3)) * t144 + (t150 * t75 + t47 / 0.2e1 - t29 * mrSges(5,3)) * t148 + m(5) * (qJ(3) * t70 + t150 * t160) + t164 + t42 * t206 + t194 * t67 + (-t22 / 0.2e1 - t146 * t14 / 0.2e1 + t13 * t203 + t8 * mrSges(6,3)) * t102; -0.2e1 * pkin(2) * mrSges(4,2) - t144 * t110 + t148 * t112 + 0.2e1 * t123 * t64 + 0.2e1 * t27 * t60 + 0.2e1 * t28 * t59 + 0.2e1 * t67 * t55 + (t207 * t69 + t40 - t65) * t103 + (t142 * t41 - t146 * t42 + t207 * t67 - t66) * t102 + m(7) * (t27 ^ 2 + t28 ^ 2 + t208) + m(6) * (t123 ^ 2 + t69 ^ 2 + t208) + m(5) * (t150 ^ 2 * t174 + t151) + m(4) * (pkin(2) ^ 2 + t151) + 0.2e1 * (t107 + mrSges(4,3)) * qJ(3) - 0.2e1 * t150 * t166 + t213; t144 * t74 + t148 * t75 + t194 * t102 + (t43 + t210) * t103 + m(7) * (t102 * t5 + t103 * t163) + m(6) * (-t102 * t8 + t103 * t9) + m(5) * t160 + m(4) * t80 + t99; -m(4) * pkin(2) - t97 * mrSges(6,3) + t102 * t55 + mrSges(4,2) - t166 + (-mrSges(6,3) * t103 + t211) * t103 + m(7) * (t103 * t161 + t189) + m(6) * (t103 * t69 + t189) + t150 * t170; m(4) + t170 + m(6) * (t96 + t97) + m(7) * (t175 * t96 + t97); t126 * t16 + m(7) * (t125 * t163 + t126 * t5) + (m(6) * (t143 * t9 + t147 * t8) + t147 * t44 + t143 * t43) * pkin(4) + t17 * t178 - t18 * t179 - t30 * mrSges(5,2) + t29 * mrSges(5,1) + t154 + t209; t150 * t182 + t133 + t126 * t55 + m(7) * (t125 * t161 + t126 * t67) + (m(6) * (t143 * t69 - t147 * t67) + t158 * mrSges(6,3)) * pkin(4) + t59 * t178 - t60 * t179 + t155 + (-mrSges(5,2) * t150 - Ifges(5,6)) * t144; t182 - t144 * mrSges(5,2) + m(7) * (t126 * t102 + t103 * t165) - m(6) * t158 * pkin(4) + t157; 0.2e1 * t126 * t106 + Ifges(5,3) + 0.2e1 * t156 + t125 * t159 + m(7) * (t125 ^ 2 * t175 + t126 ^ 2) + m(6) * (t143 ^ 2 + t147 ^ 2) * pkin(4) ^ 2 + t172; t154 + (-m(7) * t5 - t16) * pkin(5) + (m(7) * t163 + t210) * pkin(11); t155 + (-m(7) * t67 - t55) * pkin(5) + (m(7) * t161 + t211) * pkin(11); m(7) * (-pkin(5) * t102 + t103 * t168) + t157; m(7) * (-pkin(5) * t126 + pkin(11) * t165) + (t126 - pkin(5)) * t106 + t156 + (t165 + t168) * mrSges(7,3) + t172; -0.2e1 * pkin(5) * t106 + m(7) * (pkin(11) ^ 2 * t175 + pkin(5) ^ 2) + pkin(11) * t159 + t172; mrSges(7,1) * t2 - mrSges(7,2) * t3 + t12; mrSges(7,1) * t27 - mrSges(7,2) * t28 + t40; t162 * t103; t125 * t162 + t108; pkin(11) * t162 + t108; Ifges(7,3);];
