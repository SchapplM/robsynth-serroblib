...
% Computational Cost: add. (1553->231), mult. (2875->347), div. (0->0), fcn. (3054->10), ass. (0->85)
t73 = sin(pkin(11));
t75 = cos(pkin(11));
t79 = sin(qJ(3));
t82 = cos(qJ(3));
...
t1 = [0.2e1 * t66 * t90 + Ifges(4,2) * t113 + t39 * t109 + 0.2e1 * t9 * t32 + 0.2e1 * t8 * t33 - t23 * t6 + t24 * t7 + t29 * t110 + 0.2e1 * t3 * t11 + 0.2e1 * t2 * t12 - 0.2e1 * t13 * t10 + Ifges(2,3) + Ifges(3,3) + (mrSges(5,1) * t109 - 0.2e1 * mrSges(5,3) * t28 + Ifges(5,2) * t50 + t112 + t94) * t50 + (mrSges(5,3) * t110 + Ifges(5,1) * t52 - t78 * t14 + t81 * t15 + (-Ifges(6,6) * t78 - (2 * Ifges(5,4))) * t50) * t52 + m(4) * (t64 ^ 2 * t96 + t66 ^ 2) + m(5) * (t28 ^ 2 + t56 ^ 2 + t111) + m(7) * (t13 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t8 ^ 2 + t9 ^ 2 + t111) + m(3) * (t74 ^ 2 + t76 ^ 2) * pkin(1) ^ 2 + (Ifges(4,1) * t79 + 0.2e1 * Ifges(4,4) * t82) * t79 + 0.2e1 * (mrSges(3,1) * t76 - mrSges(3,2) * t74) * pkin(1) + 0.2e1 * t96 * t64 * mrSges(4,3); t24 * t11 - t23 * t12 + (t81 * t32 - t78 * t33) * t52 + t114 * t50 + m(7) * (t13 * t50 - t2 * t23 + t24 * t3) + m(6) * (t52 * t91 + t103) + m(5) * (t28 * t52 + t103); m(3) + m(7) * (t23 ^ 2 + t24 ^ 2 + t48) + m(6) * (t49 * t97 + t48) + m(5) * (t49 + t48) + m(4) * t96; Ifges(4,6) * t82 + Ifges(4,5) * t79 + t65 * t29 + t53 * t6 / 0.2e1 + t54 * t7 / 0.2e1 - t55 * t10 - Ifges(5,6) * t50 + t31 * t11 + t13 * t34 - t23 * t35 / 0.2e1 + t24 * t36 / 0.2e1 - t28 * mrSges(5,2) + t30 * t12 + (-t79 * mrSges(4,1) - t82 * mrSges(4,2)) * t64 + t99 * t26 + (-t2 * t54 + t3 * t53) * mrSges(7,3) + (t63 * t32 + t9 * mrSges(6,3) + t14 / 0.2e1) * t81 + (-t63 * t33 - t8 * mrSges(6,3) + t15 / 0.2e1) * t78 + m(6) * (t26 * t65 + t91 * t63) + m(7) * (t13 * t55 + t2 * t30 + t3 * t31) + (t81 * t59 / 0.2e1 - t78 * t58 / 0.2e1 + Ifges(5,5)) * t52 + (m(5) * (-t26 * t75 + t28 * t73) + (-t73 * t50 - t75 * t52) * mrSges(5,3)) * pkin(3) + (t98 + t100) * t50 / 0.2e1; -t39 + (t23 * t54 + t24 * t53) * mrSges(7,3) + t97 * t52 * mrSges(6,3) + (t34 + t99) * t50 + m(7) * (-t23 * t30 + t24 * t31 + t50 * t55) + m(6) * (t50 * t65 + t52 * t93) + m(5) * (-t50 * t75 + t52 * t73) * pkin(3) - t90; 0.2e1 * t55 * t34 + t53 * t35 + t54 * t36 + 0.2e1 * t65 * t57 + t81 * t58 + t78 * t59 + Ifges(4,3) + Ifges(5,3) + m(7) * (t30 ^ 2 + t31 ^ 2 + t55 ^ 2) + m(6) * (t63 ^ 2 * t97 + t65 ^ 2) + m(5) * (t73 ^ 2 + t75 ^ 2) * pkin(3) ^ 2 + 0.2e1 * (mrSges(5,1) * t75 - mrSges(5,2) * t73) * pkin(3) + 0.2e1 * (-t30 * t54 + t31 * t53) * mrSges(7,3) + 0.2e1 * mrSges(6,3) * t93; t50 * mrSges(5,1) + t54 * t11 + t53 * t12 + t78 * t32 + t81 * t33 + t39 + m(7) * (t2 * t53 + t3 * t54) + m(6) * (t78 * t9 + t8 * t81) + m(5) * t56; m(7) * (-t23 * t53 + t24 * t54); m(7) * (t30 * t53 + t31 * t54); m(5) + m(6) * t97 + m(7) * (t53 ^ 2 + t54 ^ 2); -Ifges(6,6) * t102 + t8 * mrSges(6,1) - t9 * mrSges(6,2) + (m(7) * (t2 * t80 + t3 * t77) + t77 * t11 + t80 * t12) * pkin(5) + t87 + t112; (-t23 * t80 + t24 * t77) * t108 - t114; -t89 * t63 + (m(7) * (t30 * t80 + t31 * t77) + (t53 * t77 - t54 * t80) * mrSges(7,3)) * pkin(5) + t88 + t98; (t53 * t80 + t54 * t77) * t108 - t57 - t34; Ifges(6,3) + Ifges(7,3) + m(7) * (t77 ^ 2 + t80 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t86; t87; t10; t88; -t34; Ifges(7,3) + t86; Ifges(7,3);];
