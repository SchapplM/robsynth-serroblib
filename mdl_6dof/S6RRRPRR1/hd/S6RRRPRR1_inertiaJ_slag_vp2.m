...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:50:37
% EndTime: 2018-11-23 17:50:38
...
t79 = t143 * t98;
t80 = t143 * t101;
t52 = t100 * t79 + t97 * t80;
t109 = -t73 * qJ(4) + t52;
t53 = -t100 * t80 + t97 * t79;
t110 = t72 * qJ(4) + t53;
...
t26 = t31 * mrSges(6,2);
t14 = t114 * t31;
t1 = [-0.2e1 * pkin(1) * (-mrSges(3,1) * t101 + mrSges(3,2) * t98) + t98 * (Ifges(3,1) * t98 + Ifges(3,4) * t101) + t101 * (Ifges(3,4) * t98 + Ifges(3,2) * t101) + 0.2e1 * t84 * (-mrSges(4,1) * t72 + mrSges(4,2) * t73) + t73 * (Ifges(4,1) * t73 + Ifges(4,4) * t72) + t72 * (Ifges(4,4) * t73 + Ifges(4,2) * t72) + Ifges(5,2) * t48 ^ 2 + 0.2e1 * t58 * t118 + t21 * mrSges(5,3) * t144 + t26 * t145 + t14 * t146 + 0.2e1 * t3 * t15 + 0.2e1 * t2 * t16 + Ifges(2,3) + (mrSges(6,1) * t145 - 0.2e1 * t8 * mrSges(6,3) + Ifges(6,2) * t30 + t124) * t30 + (-0.2e1 * t20 * mrSges(5,3) + Ifges(5,1) * t49 + Ifges(5,4) * t144) * t49 + (mrSges(6,3) * t146 + Ifges(6,1) * t31 - t95 * t11 + t99 * t12 + (-Ifges(7,6) * t95 - (2 * Ifges(6,4))) * t30) * t31 + m(3) * (t121 * pkin(7) ^ 2 + pkin(1) ^ 2) + m(4) * (t52 ^ 2 + t53 ^ 2 + t84 ^ 2) + m(5) * (t20 ^ 2 + t21 ^ 2 + t58 ^ 2) + m(6) * (t32 ^ 2 + t8 ^ 2 + t147) + m(7) * (t2 ^ 2 + t3 ^ 2 + t147) + 0.2e1 * (-t52 * t73 + t53 * t72) * mrSges(4,3) + 0.2e1 * t121 * pkin(7) * mrSges(3,3); Ifges(3,6) * t101 + Ifges(3,5) * t98 + (-t98 * mrSges(3,1) - t101 * mrSges(3,2)) * pkin(7) + (-t43 * t30 - t42 * t31) * mrSges(6,3) + (t66 * t48 - t64 * t49) * mrSges(5,3) + t38 * t14 + m(7) * (t116 * t39 + t38 * t6) + t113 * t39 + m(5) * (t20 * t64 + t21 * t66) + m(6) * (-t42 * t6 + t43 * t8) + t106 + ((-t100 * t73 + t72 * t97) * mrSges(4,3) + m(4) * (t100 * t52 + t53 * t97)) * pkin(2); 0.2e1 * t130 - 0.2e1 * t129 - 0.2e1 * t131 + Ifges(3,3) + 0.2e1 * t33 + 0.2e1 * t34 + 0.2e1 * t35 + 0.2e1 * t36 + 0.2e1 * t112 + m(7) * (t122 * t39 ^ 2 + t38 ^ 2) + m(6) * (t42 ^ 2 + t43 ^ 2) + m(5) * (t64 ^ 2 + t66 ^ 2) + m(4) * (t100 ^ 2 + t97 ^ 2) * pkin(2) ^ 2 + t117; t113 * t63 + t62 * t14 + (m(5) * (t20 * t94 + t21 * t93) + (t93 * t48 - t94 * t49) * mrSges(5,3)) * pkin(3) + m(7) * (t116 * t63 + t6 * t62) + m(6) * (-t6 * t65 + t67 * t8) + t106 + (-t67 * t30 - t65 * t31) * mrSges(6,3); t130 - t129 + t117 + m(7) * (t39 * t119 + t38 * t62) + (m(5) * (t64 * t94 + t66 * t93) + t115) * pkin(3) + t112 + (-t43 - t67) * mrSges(6,2) + m(6) * (t42 * t65 + t43 * t67) + t148 + t149; -0.2e1 * t128 + 0.2e1 * t50 + 0.2e1 * t54 + 0.2e1 * t55 + 0.2e1 * t59 + m(7) * (t122 * t63 ^ 2 + t62 ^ 2) + m(6) * (t65 ^ 2 + t67 ^ 2) + t117 + (0.2e1 * t115 + m(5) * (t93 ^ 2 + t94 ^ 2) * pkin(3)) * pkin(3); t30 * mrSges(6,1) + t95 * t15 + t99 * t16 + t26 + m(7) * (t2 * t99 + t95 * t3) + m(6) * t32 + m(5) * t58 + t118; 0; 0; m(7) * t122 + m(5) + m(6); t108 + (-m(7) * t6 - t14) * pkin(5) + (m(7) * t116 + t113) * pkin(10); m(7) * (t122 * t39 * pkin(10) - pkin(5) * t38) - t131 + t111 + t149; m(7) * (-pkin(5) * t62 + pkin(10) * t119) - t128 + t111 + t148; 0; -0.2e1 * t141 + m(7) * (t122 * pkin(10) ^ 2 + pkin(5) ^ 2) + 0.2e1 * t86 + 0.2e1 * t85 + t120; mrSges(7,1) * t2 - mrSges(7,2) * t3 - Ifges(7,6) * t133 + t124; -t114 * t39 + t123; -t114 * t63 + t123; -t74; -t114 * pkin(10) + t123; Ifges(7,3);];
