...
function JaD_rot = S6RRRPRR1_jacobiaD_rot_6_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRPRR1_jacobiaD_rot_6_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRPRR1_jacobiaD_rot_6_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRRPRR1_jacobiaD_rot_6_sym_varpar: pkin has to be [11x1] (double)');
...
t243 = t161 - 0.1e1;
t235 = t155 * t174;
t134 = (-t139 * t183 + t179) * t235 + (t175 * t244 - t206) * t154;
t242 = t134 * t144 * t145;
t194 = t175 * t220 + t218;
t223 = t179 * t185;
t208 = t174 * t223;
t148 = t194 * qJD(1) - qJD(6) * t166 + t182 * t208;
t219 = t183 * t184;
t222 = t182 * t185;
t165 = t175 * t222 - t219;
t157 = t165 ^ 2;
...
t149 = -t201 * t222 + (t183 * t200 - t208) * t184;
t237 = t149 * t158 * t159;
...
t150 = t205 * t183 * t161;
t140 = 0.1e1 / t142;
t138 = (t154 * t174 * t243 - t183 * t199) * t185;
