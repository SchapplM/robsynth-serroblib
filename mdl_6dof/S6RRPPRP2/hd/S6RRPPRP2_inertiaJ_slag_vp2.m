...
t6 = [t34 * t103 + t35 * t104 + t73 * (Ifges(3,4) * t71 + Ifges(3,2) * t73) - 0.2e1 * pkin(1) * (-t73 * mrSges(3,1) + t71 * mrSges(3,2)) + t71 * (Ifges(3,1) * t71 + Ifges(3,4) * t73) + 0.2e1 * t5 * t16 + 0.2e1 * t15 * t17 + 0.2e1 * t1 * t19 + 0.2e1 * t3 * t20 + 0.2e1 * t2 * t21 + 0.2e1 * t4 * t22 + Ifges(2,3) + 0.2e1 * t85 * pkin(7) * mrSges(3,3) + m(3) * (t85 * pkin(7) ^ 2 + pkin(1) ^ 2) + m(4) * (t59 ^ 2 + t81) + m(6) * (t15 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(5) * (t18 ^ 2 + t81) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + ((Ifges(5,2) + Ifges(4,1)) * t39 + 0.2e1 * t90 * t23 + t77) * t39 + (mrSges(4,1) * t103 + mrSges(5,2) * t104 + (Ifges(4,2) + Ifges(5,3)) * t38 + (t7 + t8) * t72 + (t10 + t9) * t70 + 0.2e1 * (-Ifges(4,4) - Ifges(5,6)) * t39 - 0.2e1 * t90 * t25) * t38; Ifges(3,5) * t71 + Ifges(3,6) * t73 + t15 * t46 + t43 * t16 + t55 * t17 + t33 * t19 + t32 * t21 + t5 * t45 + (-mrSges(4,2) + mrSges(5,3)) * t25 + t89 * t23 + (-mrSges(3,1) * t71 - mrSges(3,2) * t73) * pkin(7) + (t54 * t22 - t2 * mrSges(7,3) - t4 * mrSges(6,3) - t8 / 0.2e1 - t7 / 0.2e1) * t70 + (t58 * mrSges(5,1) + t62 / 0.2e1 + t63 / 0.2e1 - Ifges(5,4) + Ifges(4,5) - mrSges(4,3) * t100 + (-Ifges(7,6) / 0.2e1 - Ifges(6,6) / 0.2e1) * t70) * t39 + (t54 * t20 - t1 * mrSges(7,3) - t3 * mrSges(6,3) + t9 / 0.2e1 + t10 / 0.2e1) * t72 + m(6) * (t15 * t55 + t78 * t54) + m(7) * (t1 * t33 + t2 * t32 + t43 * t5) + m(5) * (t23 * t58 + t25 * t55) + m(4) * (-t23 * t69 + t25 * t68) * pkin(2) + (-mrSges(4,3) * t101 - t55 * mrSges(5,1) + Ifges(5,5) - Ifges(4,6) + (t48 / 0.2e1 + t49 / 0.2e1) * t72 + (t50 / 0.2e1 + t51 / 0.2e1) * t70) * t38; 0.2e1 * t58 * mrSges(5,2) + 0.2e1 * t43 * t45 + Ifges(5,1) + Ifges(3,3) + Ifges(4,3) + (t33 * t105 + t50 + t51) * t72 + (t32 * t105 - t48 - t49) * t70 + m(7) * (t32 ^ 2 + t33 ^ 2 + t43 ^ 2) + m(6) * (t53 * t54 ^ 2 + t106) + m(5) * (t58 ^ 2 + t106) + m(4) * (t68 ^ 2 + t69 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (t46 + mrSges(5,3)) * t55 + 0.2e1 * (mrSges(4,1) * t69 - mrSges(4,2) * t68) * pkin(2) - 0.2e1 * t54 * t79; t34 - t35 + t86 * t72 - t87 * t70 - t89 * t38 + m(7) * (-t1 * t70 + t2 * t72) + m(6) * (-t3 * t70 + t4 * t72) + m(5) * t18 + m(4) * t59; m(7) * (t32 * t72 - t33 * t70); m(4) + t82; t39 * mrSges(5,1) + t87 * t72 + t86 * t70 + m(7) * (t1 * t72 + t2 * t70) + m(6) * t78 + m(5) * t23; mrSges(5,2) - t53 * mrSges(7,3) - t79 + m(7) * (t32 * t70 + t33 * t72) + m(5) * t58 + t54 * t42; 0; t82; mrSges(6,1) * t3 + mrSges(7,1) * t1 - mrSges(6,2) * t4 - mrSges(7,2) * t2 + (m(7) * t1 + t19) * pkin(5) + t77; t54 * t99 + mrSges(7,1) * t33 - mrSges(7,2) * t32 + t62 + t63 + (m(7) * t33 - t91) * pkin(5) + (-mrSges(6,2) * t54 - t108) * t70; t80 * t70 - t45 - t98; (-mrSges(6,2) - mrSges(7,2)) * t70 + (mrSges(7,1) - t80) * t72; (0.2e1 * mrSges(7,1) + t102) * pkin(5) + t107; m(7) * t5 + t16; m(7) * t43 + t45; 0; 0; 0; m(7);];
