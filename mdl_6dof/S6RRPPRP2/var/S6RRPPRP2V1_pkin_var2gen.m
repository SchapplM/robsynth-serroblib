% Umwandlung der Kinematikparameter von S6RRPPRP2V1 zu S6RRPPRP2
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S6RRPPRP2_structural_kinematic_parameters.m
function pkin_gen = S6RRPPRP2V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
