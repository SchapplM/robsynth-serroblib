...
function Tc_mdh = S6RRRPPR2_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRPPR2_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRPPR2_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRRPPR2_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [10x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:22:43
	% EndTime: 2020-11-04 22:22:43
...
elseif link_index == 2
	...
	t59 = sin(qJ(1));
	t58 = sin(qJ(2));
	t1 = [t61 * t60, -t61 * t58, t59, pkin(1) * t61 + pkin(7) * t59 + 0; t59 * t60, -t59 * t58, -t61, pkin(1) * t59 - pkin(7) * t61 + 0; t58, t60, 0, pkin(6) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 3
...
elseif link_index == 6
	...
	t102 = pkin(4) + pkin(9);
	t101 = pkin(5) + qJ(4) + pkin(8) + pkin(7);
	t92 = sin(qJ(6));
	t93 = sin(qJ(1));
	t100 = t93 * t92;
	t94 = cos(qJ(6));
