...
% OptimizationMode: 2
% StartTime: 2019-03-10 02:00:25
% EndTime: 2019-03-10 02:00:30
...
t16 = -pkin(5) * t42 + t30;
t1 = [m(7) * (t16 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t30 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(5) * (t21 ^ 2 + t22 ^ 2 + t49 ^ 2) + m(4) * (t102 ^ 2 + t53 ^ 2 + t54 ^ 2) + m(3) * (pkin(1) ^ 2 * t174 ^ 2 + t122 ^ 2 + t123 ^ 2) + 0.2e1 * t49 * t44 + 0.2e1 * t22 * t51 + 0.2e1 * t21 * t52 + 0.2e1 * t3 * t26 + 0.2e1 * t6 * t27 + 0.2e1 * t2 * t28 + 0.2e1 * t5 * t29 + 0.2e1 * t30 * t20 + 0.2e1 * t16 * t19 + (t14 + t15) * t43 + (t12 + t13) * t42 + (t31 - t61 + t232) * t120 + (t196 - 0.2e1 * t216 + 0.2e1 * t217) * t175 + ((-0.2e1 * t122 * mrSges(3,3) + Ifges(3,5) * t175 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t179) * t174) * t179 + (0.2e1 * t123 * mrSges(3,3) + Ifges(3,6) * t175 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t179 + (Ifges(4,3) + Ifges(3,2)) * t183) * t174 + t207) * t183) * t174 + t84 * t32 + t85 * t33 + 0.2e1 * t54 * t88 + 0.2e1 * t53 * t89 + 0.2e1 * t102 * t68 + Ifges(2,3) + t121 * t62; t16 * t66 + t30 * t67 - pkin(2) * t68 + t35 * t29 + t36 * t27 + t25 * t26 + t24 * t28 + (t54 * mrSges(4,3) + pkin(9) * t88 + t61 / 0.2e1 - t31 / 0.2e1 - t10 / 0.2e1 - t11 / 0.2e1) * t182 + m(4) * (-pkin(2) * t102 + (-t53 * t178 + t54 * t182) * pkin(9)) + m(7) * (t16 * t72 + t2 * t24 + t25 * t3) + m(6) * (t139 * t30 + t35 * t5 + t36 * t6) + t196 + (t55 / 0.2e1 + t56 / 0.2e1 + t110 / 0.2e1 - t145 / 0.2e1) * t120 + m(5) * (t100 * t22 + t49 * t169 + t21 * t99) - t206 * t212 / 0.2e1 - t203 * t113 + t200 * t43 + t201 * t42 + t202 * t114 + t217 - t216 + t72 * t19 + (-t53 * mrSges(4,3) - t177 * t32 / 0.2e1 + t181 * t228 + t62 / 0.2e1 + (t44 - t89) * pkin(9)) * t178 + t3 * t92 + t6 * t93 + t2 * t94 + t5 * t95 + t99 * t52 + t100 * t51 + t49 * t124 + t22 * t137 + t21 * t138 + t139 * t20 + t102 * t142 + t121 * t147 / 0.2e1 + t85 * t225 + t84 * t226; -0.2e1 * pkin(2) * t142 + 0.2e1 * t100 * t137 + 0.2e1 * t99 * t138 + 0.2e1 * t139 * t67 + 0.2e1 * t24 * t94 + 0.2e1 * t25 * t92 + 0.2e1 * t35 * t95 + 0.2e1 * t36 * t93 + 0.2e1 * t72 * t66 + Ifges(3,3) + (t60 + t59) * t114 - (t57 + t58) * t113 + (t171 + t173) * mrSges(4,3) * t233 + (-t55 - t56 - t110 + t145) * t182 + (-t111 * t177 + t112 * t181 + t124 * t233 + t147) * t178 + m(7) * (t24 ^ 2 + t25 ^ 2 + t72 ^ 2) + m(6) * (t139 ^ 2 + t35 ^ 2 + t36 ^ 2) + m(5) * (t100 ^ 2 + t99 ^ 2 + t168) + m(4) * (pkin(2) ^ 2 + t173 * t185 + t168); t64 * t28 + t65 * t26 + t53 * mrSges(4,1) - t54 * mrSges(4,2) - pkin(3) * t44 + m(7) * (t101 * t16 + t2 * t64 + t3 * t65) + m(6) * (t161 * t30 + t5 * t90 + t6 * t91) + m(5) * (-pkin(3) * t49 + (-t21 * t177 + t22 * t181) * pkin(10)) + (t22 * mrSges(5,3) + pkin(10) * t51 + t32 / 0.2e1) * t181 - Ifges(4,3) * t212 + (t6 * mrSges(6,3) + t3 * mrSges(7,3) + t203) * t132 + t198 * t43 + t199 * t42 + (-t5 * mrSges(6,3) - t2 * mrSges(7,3) + t202) * t133 + t193 * t120 - t207 + (-t21 * mrSges(5,3) - pkin(10) * t52 + t228) * t177 + t16 * t76 + t30 * t77 + t90 * t29 + t91 * t27 + t101 * t19 + t49 * t141 + t84 * t144 / 0.2e1 + t161 * t20 + t85 * t224; (-mrSges(4,1) + t141) * t169 + m(7) * (t101 * t72 + t24 * t64 + t25 * t65) + m(6) * (t139 * t161 + t35 * t90 + t36 * t91) + m(5) * (-pkin(3) * t169 + (t100 * t181 - t177 * t99) * pkin(10)) + t198 * t114 - t199 * t113 + (-t35 * mrSges(6,3) - t24 * mrSges(7,3) + t200) * t133 + (t36 * mrSges(6,3) + t25 * mrSges(7,3) + t201) * t132 + (-pkin(9) * mrSges(4,2) - t193) * t182 + t206 + t72 * t76 + t65 * t92 + t91 * t93 + t64 * t94 + t90 * t95 + t101 * t66 - pkin(3) * t124 + t139 * t77 + t161 * t67 + (-t99 * mrSges(5,3) - pkin(10) * t138 - t178 * t144 / 0.2e1 + t225) * t177 + (t100 * mrSges(5,3) + pkin(10) * t137 + t178 * t224 + t226) * t181; -0.2e1 * pkin(3) * t141 + 0.2e1 * t101 * t76 + t181 * t144 + t177 * t146 + 0.2e1 * t161 * t77 + Ifges(4,3) + 0.2e1 * t205 * pkin(10) * mrSges(5,3) + m(7) * (t101 ^ 2 + t64 ^ 2 + t65 ^ 2) + m(6) * (t161 ^ 2 + t90 ^ 2 + t91 ^ 2) + m(5) * (t205 * pkin(10) ^ 2 + pkin(3) ^ 2) + (-0.2e1 * mrSges(6,3) * t90 - 0.2e1 * mrSges(7,3) * t64 + t82 + t83) * t133 + (0.2e1 * mrSges(6,3) * t91 + 0.2e1 * mrSges(7,3) * t65 + t80 + t81) * t132; t21 * mrSges(5,1) - t22 * mrSges(5,2) + t197 * t160 + (t180 * t29 + (t26 + t27) * t176 + t3 * t223 + m(6) * (t176 * t6 + t180 * t5)) * pkin(4) + t187 + t31; t99 * mrSges(5,1) - t100 * mrSges(5,2) + t195 * t160 + (t180 * t95 + (t92 + t93) * t176 + t25 * t223 + m(6) * (t176 * t36 + t180 * t35)) * pkin(4) + t204 * t182 + t189 + t192; t191 * t160 - t190 * pkin(10) + (mrSges(7,3) * t214 + (-t133 * t180 + t214) * mrSges(6,3) + t65 * t223 + m(6) * (t176 * t91 + t180 * t90)) * pkin(4) + t188 + t143; t160 * t230 + m(7) * (t160 ^ 2 + t167) + m(6) * (t180 ^ 2 * t186 + t167) + 0.2e1 * t231 - t204; pkin(5) * t197 + t187; t195 * pkin(5) - t220 * t182 + t189; pkin(5) * t191 + t188; t160 * t229 + (pkin(5) + t160) * mrSges(7,1) + t231 + t220; (t230 + t229) * pkin(5) + t220; m(7) * t16 + t19; m(7) * t72 + t66; m(7) * t101 + t76; 0; 0; m(7);];
