% Umwandlung der Kinematikparameter von S6RRRRRP9V4 zu S6RRRRRP9
% Eingabe:
% pkin_var (5x1) double
%   Kinematikparameter (pkin) von S6RRRRRP9V4
...
function pkin_gen = S6RRRRRP9V4_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
pkin_gen([3, 4, 7, 10, 11]) = pkin_var;
