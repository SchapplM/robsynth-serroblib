...
%% Function calls
if link_index == 0
	JaD_transl=S6RRPRRP7_jacobiaD_transl_0_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 1
	JaD_transl=S6RRPRRP7_jacobiaD_transl_1_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 2
	JaD_transl=S6RRPRRP7_jacobiaD_transl_2_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 3
	JaD_transl=S6RRPRRP7_jacobiaD_transl_3_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 4
	JaD_transl=S6RRPRRP7_jacobiaD_transl_4_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 5
	JaD_transl=S6RRPRRP7_jacobiaD_transl_5_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 6
	JaD_transl=S6RRPRRP7_jacobiaD_transl_6_sym_varpar(qJ, qJD, r_i_i_C, pkin);
else
	JaD_transl=NaN(3,6);
end