...
function JRD_rot = S6RRPRRP7_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRPRRP7_jacobiRD_rot_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRPRRP7_jacobiRD_rot_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRPRRP7_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S6RRPRRP7_jacobiRD_rot_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 6
	...
	t523 = cos(qJ(4));
	t524 = cos(qJ(2));
	t559 = t524 * t519 - t520 * t523;
	t500 = t520 * t519 + t524 * t523;
	t525 = cos(qJ(1));
	t499 = t500 * t525;
	t550 = qJD(2) * t524;
	t551 = qJD(2) * t520;
	t495 = -t559 * qJD(4) + t519 * t550 - t523 * t551;
	t560 = t559 * qJD(1);
	t494 = t500 * qJD(4) - t519 * t551 - t523 * t550;
	t521 = sin(qJ(1));
	t530 = qJD(1) * t500;
	t493 = t495 * t521 + t525 * t530;
	t497 = t500 * t521;
	t518 = sin(qJ(5));
	t522 = cos(qJ(5));
	t553 = qJD(1) * t521;
	t558 = (t497 * t518 - t522 * t525) * qJD(5) - t493 * t522 + t518 * t553;
	t552 = qJD(1) * t525;
	t548 = qJD(5) * t518;
	t547 = qJD(5) * t522;
	t491 = t560 * t521 + (qJD(2) - qJD(4)) * t499;
	t498 = t559 * t525;
	t536 = -t491 * t518 + t498 * t547;
	t535 = t491 * t522 + t498 * t548;
	t492 = t494 * t521 + t560 * t525;
	t496 = t559 * t521;
	t534 = t492 * t518 + t496 * t547;
	t533 = -t492 * t522 + t496 * t548;
	t532 = t495 * t518 + t500 * t547;
	t531 = -t495 * t522 + t500 * t548;
	t526 = -t522 * t553 - t493 * t518 + (-t497 * t522 - t518 * t525) * qJD(5);
	t490 = -t495 * t525 + t521 * t530;
	t489 = -t518 * t552 - t490 * t522 + (-t499 * t518 - t521 * t522) * qJD(5);
	t488 = t522 * t552 - t490 * t518 + (t499 * t522 - t518 * t521) * qJD(5);
	t1 = [t558, -t535, 0, t535, -t488, 0; t489, -t533, 0, t533, t526, 0; 0, -t531, 0, t531, t494 * t518 + t547 * t559, 0; -t492, t490, 0, -t490, 0, 0; -t491, -t493, 0, t493, 0, 0; 0, t494, 0, -t494, 0, 0; t526, t536, 0, -t536, t489, 0; t488, t534, 0, -t534, -t558, 0; 0, t532, 0, -t532, -t494 * t522 + t548 * t559, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,6);
end