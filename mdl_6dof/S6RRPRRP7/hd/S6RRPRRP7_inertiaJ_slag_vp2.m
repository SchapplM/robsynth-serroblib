...
t64 = Ifges(7,6) * t81;
t141 = (mrSges(7,2) * qJ(6) + Ifges(6,6)) * t81 - (mrSges(7,2) * pkin(5) - t152) * t78 - t64;
t130 = Ifges(7,5) * t78;
...
t88 = (t54 + t53) * t78 - (t49 - t52) * t81 + Ifges(5,3);
t139 = t19 ^ 2;
t138 = 0.2e1 * t19;
