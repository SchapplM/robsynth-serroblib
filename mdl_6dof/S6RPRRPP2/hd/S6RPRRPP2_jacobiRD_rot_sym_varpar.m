...
function JRD_rot = S6RPRRPP2_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RPRRPP2_jacobiRD_rot_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RPRRPP2_jacobiRD_rot_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RPRRPP2_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S6RPRRPP2_jacobiRD_rot_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 6
	...
	t279 = t271 * t286;
	t278 = qJD(1) - t283;
	t276 = -t269 * t284 + t271 * t285;
	t275 = -t269 * t285 - t271 * t284;
	t274 = t278 * t271 + t280;
	t273 = t278 * t269 - t279;
	t268 = qJ(1) + pkin(9);
	t267 = cos(t268);
	t266 = sin(t268);
	t265 = t273 * t266 + t267 * t289;
	t264 = t274 * t266 - t267 * t290;
	t263 = -t266 * t289 + t273 * t267;
	t262 = t266 * t290 + t274 * t267;
	t1 = [-t265, 0, t266 * t281 - t276 * t267, t262, 0, 0; t263, 0, -t276 * t266 - t267 * t281, t264, 0, 0; 0, 0, -t269 * t283 - t279, t275, 0, 0; t264, 0, t266 * t282 + t275 * t267, t263, 0, 0; -t262, 0, t275 * t266 - t267 * t282, t265, 0, 0; 0, 0, t271 * t283 - t280, t276, 0, 0; t266 * t285 + t267 * t288, 0, t266 * t287 + t267 * t286, 0, 0, 0; t266 * t288 - t267 * t285, 0, t266 * t286 - t267 * t287, 0, 0, 0; 0, 0, -t285, 0, 0, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,6);
end