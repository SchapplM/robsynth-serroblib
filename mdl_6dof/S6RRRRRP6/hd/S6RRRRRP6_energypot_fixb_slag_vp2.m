...
function U = S6RRRRRP6_energypot_fixb_slag_vp2(qJ, g, ...
  pkin, m, mrSges)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(3,1),zeros(10,1),zeros(7,1),zeros(7,3)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRRP6_energypot_fixb_slag_vp2: qJ has to be [6x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'S6RRRRRP6_energypot_fixb_slag_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRRRRP6_energypot_fixb_slag_vp2: pkin has to be [10x1] (double)');
assert(isreal(m) && all(size(m) == [7 1]), ...
  'S6RRRRRP6_energypot_fixb_slag_vp2: m has to be [7x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [7,3]), ...
  'S6RRRRRP6_energypot_fixb_slag_vp2: mrSges has to be [7x3] (double)');
...
t78 = cos(t85);
t86 = sin(qJ(3));
t119 = -m(4) * pkin(2) - m(5) * t76 - t89 * mrSges(4,1) - t78 * mrSges(5,1) + t86 * mrSges(4,2) + t77 * mrSges(5,2) - mrSges(3,1);
t92 = -pkin(9) - pkin(8);
...
t108 = pkin(3) * t86;
t109 = m(5) * t108 + t86 * mrSges(4,1) + t77 * mrSges(5,1) + t89 * mrSges(4,2) + t78 * mrSges(5,2) - mrSges(2,2) + mrSges(3,3);
t88 = sin(qJ(1));
t107 = t87 * t88;
t91 = cos(qJ(1));
t106 = t87 * t91;
