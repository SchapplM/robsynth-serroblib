...
function Tc_mdh = S6PRRRRR1_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PRRRRR1_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6PRRRRR1_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6PRRRRR1_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [12x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 21:20:22
	% EndTime: 2020-11-04 21:20:22
...
elseif link_index == 6
	...
	t1 = [t161 * t181 + t166 * t179, -t161 * t179 + t166 * t181, t160, t177 * pkin(1) + t161 * pkin(5) + t160 * pkin(11) - t166 * t173 + t167 * t168 + t189 * t188 + 0; t159 * t181 + t164 * t179, -t159 * t179 + t164 * t181, t158, t175 * pkin(1) + t159 * pkin(5) + t158 * pkin(11) - t164 * t173 + t165 * t168 - t189 * t187 + 0; t163 * t181 - t179 * t185, -t163 * t179 - t181 * t185, t162, t163 * pkin(5) + t162 * pkin(11) + qJ(1) + 0 + t189 * t178 + (t168 * t180 + t173 * t182) * t176; 0, 0, 0, 1;];
	Tc_mdh = t1;
end