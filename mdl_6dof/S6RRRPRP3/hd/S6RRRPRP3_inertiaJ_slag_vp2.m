...
% OptimizationMode: 2
% StartTime: 2019-03-09 16:39:20
% EndTime: 2019-03-09 16:39:23
...
t140 = t131 * t38 / 0.2e1 + t130 * t39 / 0.2e1 - Ifges(4,6) * t108 + Ifges(4,5) * t109 - t85 * mrSges(4,2) + t8 * t69 + t46 * t70 + t115 * t162 / 0.2e1 - t114 * t163 / 0.2e1 + t4 * t93 + (t112 - mrSges(4,1)) * t83 + (t71 / 0.2e1 - t72 / 0.2e1) * t55 + t188 * t56 / 0.2e1 + t152 * mrSges(5,3) + (Ifges(5,5) * t130 + Ifges(5,6) * t131 + t187) * t108 / 0.2e1 + (t16 / 0.2e1 - t15 / 0.2e1 + t3 * mrSges(7,2) + t6 * mrSges(6,3)) * t147 + (-t5 * mrSges(6,3) + t189 / 0.2e1) * t107;
t122 = -pkin(3) - t172;
t111 = t120 - t172;
t47 = t64 - t172;
t1 = [-0.2e1 * pkin(1) * (-mrSges(3,1) * t136 + mrSges(3,2) * t134) + t134 * (Ifges(3,1) * t134 + Ifges(3,4) * t136) + t136 * (Ifges(3,4) * t134 + Ifges(3,2) * t136) + t65 * t179 + 0.2e1 * t30 * t67 + 0.2e1 * t29 * t68 + 0.2e1 * t5 * t33 + 0.2e1 * t4 * t34 + 0.2e1 * t3 * t35 + 0.2e1 * t46 * t22 + 0.2e1 * t8 * t21 + 0.2e1 * t6 * t32 + Ifges(2,3) + t189 * t56 + (t15 - t16) * t55 + 0.2e1 * t160 * pkin(7) * mrSges(3,3) + (mrSges(4,2) * t178 + mrSges(4,3) * t179 + Ifges(4,1) * t109 - t130 * t38 + t131 * t39) * t109 + (mrSges(4,1) * t178 - 0.2e1 * t85 * mrSges(4,3) + (Ifges(5,3) + Ifges(4,2)) * t108 + (Ifges(5,5) * t131 - Ifges(5,6) * t130 - (2 * Ifges(4,4))) * t109 + t149) * t108 + m(3) * (t160 * pkin(7) ^ 2 + pkin(1) ^ 2) + m(4) * (t123 ^ 2 + t85 ^ 2 + t182) + m(5) * (t29 ^ 2 + t30 ^ 2 + t182) + m(6) * (t46 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t3 ^ 2 + t4 ^ 2 + t8 ^ 2); t140 + m(5) * (t152 * t119 + t122 * t83) + t170 * t62 + t171 * t60 + t151 * t119 + m(6) * (t111 * t46 - t5 * t60 + t6 * t62) + m(7) * (t3 * t62 + t4 * t60 + t47 * t8) + Ifges(3,5) * t134 + Ifges(3,6) * t136 + t122 * t65 + t111 * t22 + t47 * t21 + (-t134 * mrSges(3,1) - t136 * mrSges(3,2)) * pkin(7) + (m(4) * (t133 * t85 - t135 * t83) + (-t108 * t133 - t109 * t135) * mrSges(4,3)) * pkin(2); t146 + m(5) * (t161 * t119 ^ 2 + t122 ^ 2) + m(6) * (t111 ^ 2 + t159) + m(7) * (t47 ^ 2 + t159) + 0.2e1 * t122 * t112 + t111 * t180 + t47 * t181 + t119 * t150 + 0.2e1 * t148 + m(4) * (t133 ^ 2 + t135 ^ 2) * pkin(2) ^ 2 + Ifges(3,3) + (t60 * t107 + t147 * t62) * t191; t140 + m(5) * (-pkin(3) * t83 + qJ(4) * t152) + t120 * t22 + t64 * t21 - pkin(3) * t65 + t170 * t81 + t171 * t79 + t151 * qJ(4) + m(6) * (t120 * t46 - t5 * t79 + t6 * t81) + m(7) * (t3 * t81 + t4 * t79 + t64 * t8); t146 + (t111 + t120) * t70 + (t64 + t47) * t69 + (t122 - pkin(3)) * t112 + t148 + m(5) * (-pkin(3) * t122 + qJ(4) * t153) + (t161 * qJ(4) + t153) * mrSges(5,3) + m(6) * (t111 * t120 + t156) + m(7) * (t47 * t64 + t156) + t186 * ((t60 + t79) * t107 - (-t62 - t81) * t147); -0.2e1 * pkin(3) * t112 + t120 * t180 + t64 * t181 + qJ(4) * t150 + m(7) * (t64 ^ 2 + t158) + m(6) * (t120 ^ 2 + t158) + m(5) * (t161 * qJ(4) ^ 2 + pkin(3) ^ 2) + t146 + (t79 * t107 + t147 * t81) * t191; m(5) * t83 + m(6) * t46 + m(7) * t8 + t21 + t22 + t65; m(5) * t122 + m(6) * t111 + m(7) * t47 + t142; -m(5) * pkin(3) + m(6) * t120 + m(7) * t64 + t142; m(5) + m(6) + m(7); -pkin(5) * t34 + m(7) * (-pkin(5) * t4 + qJ(6) * t3) + qJ(6) * t35 + t3 * mrSges(7,3) - t4 * mrSges(7,1) - t6 * mrSges(6,2) + t5 * mrSges(6,1) + t149; t183 * t62 + t184 * t60 + t141; t183 * t81 + t184 * t79 + t141; 0; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t190; m(7) * t4 + t34; m(7) * t60 + t93; m(7) * t79 + t93; 0; t185; m(7);];
