% Umwandlung der Kinematikparameter von S6RRRPRP3V1 zu S6RRRPRP3
% Eingabe:
% pkin_var (8x1) double
...
%
% Siehe auch: S6RRRPRP3_structural_kinematic_parameters.m
function pkin_gen = S6RRRPRP3V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
