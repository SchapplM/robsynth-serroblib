% Umwandlung der Kinematikparameter von S6RPRPRR10V1 zu S6RPRPRR10
% Eingabe:
% pkin_var (9x1) double
...
%
% Siehe auch: S6RPRPRR10_structural_kinematic_parameters.m
function pkin_gen = S6RPRPRR10V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
