...
t3 = t101 * pkin(5) - t4;
t2 = -qJ(6) * t101 + t5;
t1 = [m(2) + m(5) * (t28 ^ 2 + t29 ^ 2 + t52) + m(4) * (t55 ^ 2 + t52 + t81) + m(3) * (t100 ^ 2 * t90 + t97 ^ 2 + t81) + t139 * (t7 ^ 2 + t9 ^ 2 + t52); mrSges(4,3) * t115 + t28 * t69 + t29 * t68 + t120 * t9 + t119 * t7 + (-t100 * mrSges(3,2) + (mrSges(3,1) - t76) * t102) * t95 + (t99 * mrSges(4,3) + t136) * t53 + m(7) * (t10 * t53 + t2 * t9 + t3 * t7) + m(6) * (-t4 * t7 + t5 * t9 + t53 * t70) + m(5) * (pkin(8) * t126 + t28 * t39 + t29 * t40) + m(4) * (pkin(2) * t114 + (t115 + t126) * pkin(8)); -0.2e1 * pkin(2) * t76 + 0.2e1 * t10 * t15 + 0.2e1 * t70 * t16 + 0.2e1 * t2 * t35 + 0.2e1 * t3 * t38 + 0.2e1 * t5 * t36 + 0.2e1 * t4 * t37 + 0.2e1 * t39 * t69 + 0.2e1 * t40 * t68 + Ifges(3,3) + (t13 + t14) * t51 + (t11 - t12) * t50 + (t92 + t93) * mrSges(4,3) * t140 + (Ifges(4,1) * t99 + t56 * t140 - t94 * t48 + t96 * t49) * t99 + m(4) * (pkin(2) ^ 2 + t104 * t93 + t87) + m(5) * (t39 ^ 2 + t40 ^ 2 + t87) + m(6) * (t4 ^ 2 + t5 ^ 2 + t70 ^ 2) + m(7) * (t10 ^ 2 + t2 ^ 2 + t3 ^ 2) + ((Ifges(5,3) + Ifges(4,2) + t122) * t101 + (-Ifges(5,5) * t96 + Ifges(5,6) * t94 + (2 * Ifges(4,4))) * t99 + t109) * t101; -t55 * mrSges(4,2) + t107 * mrSges(5,3) + (t118 + t137) * t53 + m(7) * (t18 * t53 + t112) + m(6) * (t53 * t84 + t112) + m(5) * (-pkin(3) * t53 + qJ(4) * t107) + t138 * (t105 * t9 + t67 * t7); t48 * t131 + t94 * t49 / 0.2e1 + t70 * t23 + t84 * t16 - pkin(3) * t56 + t10 * t22 + t18 * t15 + (t26 / 0.2e1 + t27 / 0.2e1) * t51 + (t24 / 0.2e1 - t25 / 0.2e1) * t50 + t120 * t34 + t119 * t32 + (Ifges(5,5) * t132 - Ifges(5,6) * t96 / 0.2e1 - t61 / 0.2e1 - t60 / 0.2e1 - t62 / 0.2e1 + t59 / 0.2e1 + Ifges(4,6) - pkin(8) * mrSges(4,2)) * t101 + (t96 * t68 - t94 * t69) * qJ(4) + t106 * mrSges(5,3) + (pkin(8) * t118 + t131 * t75 + t132 * t74 + Ifges(4,5)) * t99 + m(5) * (-pkin(3) * t88 + qJ(4) * t106) + m(6) * (-t32 * t4 + t34 * t5 + t70 * t84) + m(7) * (t10 * t18 + t2 * t34 + t32 * t3) + (t13 / 0.2e1 + t14 / 0.2e1 + t3 * mrSges(7,2) - t4 * mrSges(6,3)) * t67 - (t11 / 0.2e1 - t12 / 0.2e1 - t5 * mrSges(6,3) - t2 * mrSges(7,2)) * t105; -0.2e1 * pkin(3) * t72 + 0.2e1 * t18 * t22 + 0.2e1 * t84 * t23 + t96 * t74 + t94 * t75 + Ifges(4,3) + m(6) * (t84 ^ 2 + t113) + m(7) * (t18 ^ 2 + t113) + m(5) * (qJ(4) ^ 2 * t117 + pkin(3) ^ 2) + (t26 + t27) * t67 - (t24 - t25) * t105 + 0.2e1 * t117 * qJ(4) * mrSges(5,3) + 0.2e1 * (t105 * t34 + t32 * t67) * t138; 0.2e1 * (m(7) / 0.2e1 + m(6) / 0.2e1 + m(5) / 0.2e1) * t53; m(5) * t88 + m(6) * t70 + m(7) * t10 + t136; -m(5) * pkin(3) + m(6) * t84 + m(7) * t18 + t137 + t72; m(5) + t139; t133 * t9 + t134 * t7; qJ(6) * t35 + m(7) * (-pkin(5) * t3 + qJ(6) * t2) + t2 * mrSges(7,3) - t5 * mrSges(6,2) - pkin(5) * t38 - t3 * mrSges(7,1) + t4 * mrSges(6,1) - t122 * t101 - t109; t62 - t59 + t61 + t60 + (-pkin(5) * t67 + qJ(6) * t105) * mrSges(7,2) + t133 * t34 + t134 * t32; 0; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t122; m(7) * t7; m(7) * t3 + t38; m(7) * t32 + t67 * mrSges(7,2); 0; t135; m(7);];
