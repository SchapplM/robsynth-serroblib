...
t71 = t86 * mrSges(6,1) - qJD(4) * mrSges(6,3);
t170 = t69 - t71;
...
t22 = [(m(4) * (t101 * t146 + t131) + 0.2e1 * t206) * qJD(3) + t53 * (-t80 * mrSges(6,2) + t73) + t3 * t51 + t4 * t52 + t46 * t61 + t24 * t42 + t44 * t13 + t11 * t29 + t12 * t30 + (Ifges(7,5) * t158 + Ifges(7,6) * t156 - Ifges(7,3) * t88) * t191 + (Ifges(7,1) * t158 + Ifges(7,4) * t156 - Ifges(7,5) * t88) * t193 + (Ifges(7,4) * t158 + Ifges(7,2) * t156 - Ifges(7,6) * t88) * t195 + m(7) * (t1 * t12 + t11 * t2 + t14 * t44 + t21 * t24 + t3 * t6 + t4 * t5) + (-t36 * t88 - t37 * t89 + t139) * mrSges(5,3) + (-t33 * t88 + t34 * t89 + t139) * mrSges(6,1) + t124 * (t80 * mrSges(5,1) - t74) + t27 * t156 / 0.2e1 + t6 * (mrSges(7,2) * t88 + mrSges(7,3) * t156) + t28 * t158 / 0.2e1 + t5 * (-mrSges(7,1) * t88 - mrSges(7,3) * t158) + t21 * (-mrSges(7,1) * t156 + mrSges(7,2) * t158) - t169 * t39 + (-t75 / 0.2e1 - t35 * mrSges(6,3) + t173 * t80 + t174 * t20 + (-Ifges(5,1) - Ifges(6,2) - Ifges(7,3) / 0.2e1) * t79 + t200) * t94 - t170 * t38 + m(5) * (t19 * t59 + t36 * t39 - t37 * t38 + t181) - (t57 + t26) * t88 / 0.2e1 + m(6) * (-t17 * t59 + t33 * t39 + t34 * t38 + t35 * t53 + t45 * t46 + t181) + (t203 * t89 + t204 * t88) * qJD(4) / 0.2e1 + (t133 * t197 + t135 * t198 + t111 * t10 / 0.2e1 + t9 * t186 + t17 * mrSges(6,1) - t19 * mrSges(5,3) - t35 * mrSges(6,2) - t14 * t138 + (Ifges(6,3) + Ifges(5,2)) * t80 + (-t164 / 0.2e1 - t161 / 0.2e1 - t173) * t79 + t143 * mrSges(7,3) + (t27 * t187 + t28 * t186 + (-t162 + t163) * t191 + t21 * t137 + t134 * t195 + t136 * t193 - t141 * mrSges(7,3)) * qJD(6)) * t93 + t88 * t55 / 0.2e1 + t89 * t54 / 0.2e1 + t45 * (-mrSges(6,2) * t89 + mrSges(6,3) * t88) + t86 * (Ifges(6,6) * t88 + Ifges(6,3) * t89) / 0.2e1 - t87 * (Ifges(6,2) * t88 + Ifges(6,6) * t89) / 0.2e1 - t89 * t56 / 0.2e1 + t85 * (mrSges(5,1) * t89 - mrSges(5,2) * t88) - t86 * (-Ifges(5,4) * t88 - Ifges(5,2) * t89) / 0.2e1 + t87 * (-Ifges(5,1) * t88 - Ifges(5,4) * t89) / 0.2e1; (-t174 * t80 + t13) * t94 - t152 * t88 + t121 * t89 + (t129 * qJD(6) - t174 * t79 + t130) * t93 + m(5) * (t19 * t94 + t36 * t89 - t37 * t88 + t180) + m(6) * (-t17 * t94 + t33 * t89 + t34 * t88 + t180) + m(7) * (t117 * t93 + t14 * t94 + t141 * t89 - t21 * t88); -t111 * t29 + t113 * t30 + t73 - t74 - t175 * t80 + t128 * qJD(6) + t152 * t86 - t121 * t87 - m(5) * (t36 * t87 - t37 * t86) + (-m(4) * t131 - t206) * qJD(1) + (-t84 * t141 + t21 * t86 + t143) * m(7) + (-t33 * t87 - t34 * t86 + t35) * m(6); (qJ(5) * t14 + t205 * t21 - t5 * t7 - t6 * t8) * m(7) + t123 * t42 - t202 * mrSges(7,3) - t8 * t51 - t7 * t52 - t60 * t61 - t17 * mrSges(6,3) - t19 * mrSges(5,2) + qJ(5) * t13 + t10 * t186 + t9 * t187 + (-t34 * mrSges(6,1) + t37 * mrSges(5,3) - t54 / 0.2e1 + t45 * mrSges(6,2) + t56 / 0.2e1 - t85 * mrSges(5,1) + (Ifges(6,6) / 0.2e1 + Ifges(5,4) / 0.2e1) * t87 + (-Ifges(6,5) / 0.2e1 + Ifges(5,6) / 0.2e1) * qJD(4) + (-Ifges(6,3) / 0.2e1 - Ifges(5,2) / 0.2e1 + Ifges(6,2) / 0.2e1 + Ifges(5,1) / 0.2e1) * t86 + t199) * t87 + t199 * qJD(6) + t14 * t137 + t134 * t197 + t136 * t198 + t168 * qJD(5) + t169 * t37 + t170 * t36 + t175 * t20 + (-pkin(4) * t20 - qJ(5) * t17 + t201 * t34 - t33 * t37 - t45 * t60) * m(6) - (t130 + m(7) * t202 + (-m(7) * t140 + t129) * qJD(6)) * t189 + (t179 / 0.2e1 + t178 / 0.2e1 + t177 / 0.2e1 - t82 / 0.2e1 - t83 / 0.2e1 + t33 * mrSges(6,1) + t36 * mrSges(5,3) + t85 * mrSges(5,2) + t5 * mrSges(7,1) - t6 * mrSges(7,2) - t55 / 0.2e1 + t57 / 0.2e1 + t26 / 0.2e1 - t45 * mrSges(6,3) + (Ifges(5,5) / 0.2e1 - Ifges(6,4) / 0.2e1) * qJD(4)) * t86 + (-mrSges(6,1) * qJ(5) + t203) * t80 + (pkin(4) * mrSges(6,1) - t163 / 0.2e1 + t162 / 0.2e1 + t204) * t79; -t79 * mrSges(6,1) + t87 * t61 - t168 * qJD(4) + (t51 * t84 + t29) * t113 + (-t52 * t84 + t30) * t111 + (-qJD(4) * t21 - t140 * t87 + t117) * m(7) + (qJD(4) * t34 + t45 * t87 + t20) * m(6); -t75 - t21 * (mrSges(7,1) * t68 + mrSges(7,2) * t67) + (Ifges(7,1) * t67 - t184) * t194 + t27 * t193 + (Ifges(7,5) * t67 - Ifges(7,6) * t68) * t192 - t5 * t51 + t6 * t52 + (t5 * t67 + t6 * t68) * mrSges(7,3) + (-Ifges(7,2) * t68 + t28 + t64) * t196 + t200;];
tauc  = t22(:);
