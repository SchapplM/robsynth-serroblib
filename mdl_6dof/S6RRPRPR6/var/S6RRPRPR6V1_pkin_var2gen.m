% Umwandlung der Kinematikparameter von S6RRPRPR6V1 zu S6RRPRPR6
% Eingabe:
...
%
% Siehe auch: S6RRPRPR6_structural_kinematic_parameters.m
function pkin_gen = S6RRPRPR6V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
