...
t4 = -pkin(5) * t47 - t9;
t21 = [m(4) * (t29 ^ 2 + t30 ^ 2 + t73 ^ 2) + m(5) * (t12 ^ 2 + t13 ^ 2 + t25 ^ 2) + m(6) * (t10 ^ 2 + t11 ^ 2 + t9 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t4 ^ 2) + (-t18 + t20 + t6) * t48 + (t17 - t19) * t47 + (mrSges(4,1) * t163 - 0.2e1 * Ifges(4,4) * t62 + Ifges(4,2) * t61 + t127) * t61 + 0.2e1 * t30 * t50 + 0.2e1 * t29 * t51 + 0.2e1 * t9 * t35 + 0.2e1 * t10 * t36 + 0.2e1 * t13 * t37 + 0.2e1 * t12 * t38 + 0.2e1 * t11 * t24 + 0.2e1 * t25 * t23 + t32 * t7 + t33 * t8 + 0.2e1 * t4 * t14 + 0.2e1 * t2 * t15 + 0.2e1 * t1 * t16 + ((t118 * Ifges(3,5) + t121 * Ifges(3,6)) * t115 + 0.2e1 * (-t67 * t118 + t68 * t121) * mrSges(3,3) + (t118 * (Ifges(3,1) * t118 + Ifges(3,4) * t121) + t121 * (Ifges(3,4) * t118 + Ifges(3,2) * t121) - 0.2e1 * pkin(1) * (-mrSges(3,1) * t121 + mrSges(3,2) * t118) + m(3) * pkin(1) ^ 2) * t113) * t113 + m(3) * (t67 ^ 2 + t68 ^ 2) + t56 * t163 + (t126 - 0.2e1 * t150 + 0.2e1 * t151 + t165) * t115 + Ifges(4,1) * t62 ^ 2 + Ifges(2,3); m(5) * (t25 * t99 + (-t12 * t117 + t13 * t120) * t98) + m(6) * (t11 * t69 + (t10 * t117 - t9 * t120) * t98) + (t7 * t157 + t8 * t158 - t9 * mrSges(6,1) + t13 * mrSges(5,3) - t152 / 0.2e1 - t17 / 0.2e1 + t19 / 0.2e1 + t149 * t98) * t120 + (t10 * mrSges(6,1) - t12 * mrSges(5,3) - t153 / 0.2e1 - t18 / 0.2e1 + t20 / 0.2e1 + t6 / 0.2e1 + t148 * t98) * t117 + t61 * t137 / 0.2e1 + t99 * t23 + t69 * t24 - t4 * t70 + t72 * t14 + t1 * t74 + t2 * t75 + t11 * t76 + t25 * t77 + t39 * t16 + t40 * t15 + t29 * mrSges(4,1) - t30 * mrSges(4,2) + (m(4) * (t112 * t30 + t114 * t29) + t112 * t50 + t114 * t51) * pkin(2) + m(7) * (t1 * t39 + t2 * t40 + t4 * t72) + (-t80 / 0.2e1 + t85 / 0.2e1 + t64 / 0.2e1) * t48 + (t79 / 0.2e1 - t83 / 0.2e1) * t47 + t33 * t161 + t65 * t162 + t126 - t150 + t151; 0.2e1 * t39 * t74 + 0.2e1 * t40 * t75 + 0.2e1 * t69 * t76 - 0.2e1 * t72 * t70 + 0.2e1 * t99 * t77 + (t64 - t80 + t85) * t117 + (-t116 * t66 - t119 * t65 - t79 + t83) * t120 + m(7) * (t39 ^ 2 + t40 ^ 2 + t72 ^ 2) + m(6) * (t69 ^ 2 + t146) + m(5) * (t99 ^ 2 + t146) + (mrSges(6,1) + mrSges(5,3)) * t98 * t167 + (0.2e1 * t114 * mrSges(4,1) - 0.2e1 * t112 * mrSges(4,2) + m(4) * (t112 ^ 2 + t114 ^ 2) * pkin(2)) * pkin(2) + t169; t61 * mrSges(4,1) + t56 + (t14 + t149) * t117 + (-t129 - t148) * t120 + m(7) * (t117 * t4 - t120 * t130) + m(6) * (-t10 * t120 - t117 * t9) + m(5) * (t117 * t13 + t12 * t120) + m(4) * t73; m(7) * (t117 * t72 - t120 * t128) - t75 * t140 - t74 * t139 - t117 * t70; m(4) + m(7) * (t110 * t136 + t108) + (m(5) / 0.2e1 + m(6) / 0.2e1) * t167; m(7) * (qJ(5) * t4 - t130 * t159) + t48 * t160 + t82 * t162 + t33 * t84 / 0.2e1 + t4 * t78 - pkin(4) * t36 + t12 * mrSges(5,1) - t13 * mrSges(5,2) - t9 * mrSges(6,3) + t10 * mrSges(6,2) + t127 + m(6) * (-pkin(4) * t10 - qJ(5) * t9) + (-t35 + t14) * qJ(5) + (-t159 * t15 - t2 * mrSges(7,3) - t7 / 0.2e1) * t116 + (-t159 * t16 - t1 * mrSges(7,3) + t8 / 0.2e1) * t119; -t159 * t143 - t74 * t138 + m(7) * (qJ(5) * t72 - t128 * t159) + t65 * t158 + t72 * t78 + t119 * t161 - qJ(5) * t70 - t128 * mrSges(7,3) + (-pkin(4) * mrSges(6,1) - Ifges(6,4) + t160) * t117 + (qJ(5) * mrSges(6,1) + t82 * t157 + t84 * t158 - Ifges(6,5)) * t120 + ((m(6) * qJ(5) - mrSges(5,2) + mrSges(6,3)) * t120 + (-mrSges(5,1) + mrSges(6,2) - t166) * t117) * t98 + t137; (mrSges(5,1) + t164) * t120 + m(6) * (t102 + t154) + m(7) * (t120 * t133 + t102) + (-mrSges(5,2) + t147) * t117; -0.2e1 * pkin(4) * mrSges(6,2) - t116 * t82 + t119 * t84 + m(7) * (t136 * t159 ^ 2 + t123) + m(6) * (pkin(4) ^ 2 + t123) + 0.2e1 * mrSges(7,3) * t133 + 0.2e1 * qJ(5) * t147 + t170; m(6) * t10 + m(7) * t130 + t129 + t36; m(7) * t128 + t143 + t119 * t74 + (m(6) * t98 + mrSges(6,1)) * t117; -t171 * t120; -t134 * t159 - t164 - t166; t171; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t6; mrSges(7,1) * t39 - mrSges(7,2) * t40 + t64; t70; -mrSges(7,1) * t138 + t105 + (mrSges(7,2) * t159 - Ifges(7,6)) * t116; mrSges(7,1) * t119 - t116 * mrSges(7,2); Ifges(7,3);];
