...
t321 = -qJD(4) * t139 + qJD(6) * t86 - t192 * t37 - t194 * t42;
t212 = t192 * t189 + t194 * t190;
t87 = t147 * t194 - t148 * t192;
t320 = qJD(4) * t212 - qJD(6) * t87 + t192 * t42 - t194 * t37;
t275 = Ifges(6,5) * t190;
t279 = Ifges(5,4) * t190;
t319 = t326 * t189 - t275 + t279;
t244 = Ifges(6,6) / 0.2e1 - Ifges(5,6) / 0.2e1;
t204 = t207 * qJD(2);
t117 = (qJD(1) * t325 - qJD(4)) * qJD(2);
t249 = qJD(1) * qJD(2);
t238 = t193 * t249;
t167 = pkin(2) * t238;
t251 = t193 * qJD(3);
...
t125 = t139 * qJD(6);
t259 = -t125 - t105;
t318 = t1 * t139 - t2 * t212 + t258 * t6 + t259 * t5;
...
t306 = 0.2e1 * t244 * t136 + t246 * t137 + t151 * mrSges(4,1) + t39 * mrSges(6,3) + t45 * mrSges(5,1) + t6 * mrSges(7,2) + Ifges(3,5) * t308 + t175 / 0.2e1 + Ifges(4,4) * t309 + (-Ifges(4,2) * t193 - t274) * t310 - t168 * Ifges(7,3) - t213 * Ifges(7,5) - t76 * Ifges(7,6) - t134 * mrSges(4,3) - t38 * mrSges(6,1) - t46 * mrSges(5,2) - t5 * mrSges(7,1) + t322 * t315 + (Ifges(3,1) + Ifges(5,3) + Ifges(6,2)) * t256 / 0.2e1;
t188 = qJD(2) * qJ(3);
...
t145 = t296 * t254;
t230 = m(4) * t151 + (mrSges(4,1) + mrSges(3,3)) * t256 + t324 * qJD(2);
...
t40 = qJD(1) * t203 + t234;
t200 = -t116 * mrSges(5,2) - t25 * mrSges(6,2) + t32 * mrSges(5,3) + t40 * mrSges(6,3) + (t193 * t319 + t195 * t322) * t314;
t199 = -t33 * mrSges(5,3) - t20 * mrSges(6,2) + (Ifges(6,6) * t195 + t193 * t221) * t249 / 0.2e1 + (Ifges(5,6) * t195 + t193 * t222) * t314 + t116 * mrSges(5,1) + t40 * mrSges(6,1);
...
t7 = [(t108 * mrSges(4,2) - t243 * t150 + t199 * t190 + t200 * t189 + (t247 * qJD(2) + ((t201 + t248) * t195 + Ifges(7,5) * t113 / 0.2e1 + t112 * t303 - 0.2e1 * t293 - t152 * mrSges(4,3)) * qJD(1) + t230 * pkin(7) + t306) * qJD(2)) * t195 + t28 * (-mrSges(7,1) * t112 - mrSges(7,2) * t113) + (t1 * t112 + t113 * t2 - t5 * t58 + t57 * t6) * mrSges(7,3) + (-Ifges(7,4) * t113 + Ifges(7,2) * t112) * t301 + (-Ifges(7,1) * t113 + Ifges(7,4) * t112) * t302 + t123 * t141 - t145 * t84 + t79 * t119 + t72 * t120 + t80 * t121 + t71 * t122 + t96 * t109 - t113 * t8 / 0.2e1 + t36 * t101 + t49 * t102 + t48 * t103 + t41 * t104 + t64 * t83 + t85 * t9 + t57 * t17 / 0.2e1 + t31 * (-mrSges(7,1) * t57 + mrSges(7,2) * t58) + t58 * t18 / 0.2e1 + t51 * t21 + t3 * t52 + t4 * t53 + t12 * t22 + t13 * t23 + m(5) * (t116 * t325 - t124 * t145 + t32 * t79 + t33 * t80 + t45 * t48 + t46 * t49) + t325 * t110 + (-t108 * mrSges(4,3) + t32 * mrSges(5,1) - t25 * mrSges(6,1) - t33 * mrSges(5,2) + t20 * mrSges(6,3) + (t245 * qJD(2) + ((0.3e1 / 0.2e1 * t278 - 0.3e1 / 0.2e1 * t272 + 0.3e1 / 0.2e1 * t277 + 0.3e1 / 0.2e1 * t273 - t248) * t193 - 0.2e1 * t294 - t152 * mrSges(4,2) + (0.3e1 / 0.2e1 * Ifges(6,2) + 0.3e1 / 0.2e1 * Ifges(5,3) + 0.3e1 / 0.2e1 * Ifges(4,2) + 0.3e1 / 0.2e1 * Ifges(3,1) - 0.3e1 / 0.2e1 * Ifges(4,3) - 0.3e1 / 0.2e1 * Ifges(3,2) + Ifges(7,3) + t243 * pkin(7) + (-Ifges(6,3) / 0.2e1 - Ifges(5,2) / 0.2e1) * t190 ^ 2 + ((-Ifges(5,1) / 0.2e1 - Ifges(6,1) / 0.2e1) * t189 + t323 * t190) * t189) * t195) * qJD(1) + t305) * qJD(2) + t307) * t193 + m(6) * (t20 * t71 + t25 * t72 + t36 * t39 + t38 * t41 + t40 * t96 + t50 * t64) + m(7) * (t1 * t13 + t12 * t2 + t28 * t85 + t3 * t6 + t31 * t51 + t4 * t5) + (Ifges(7,5) * t58 + Ifges(7,6) * t57) * t290 + (Ifges(7,1) * t58 + Ifges(7,4) * t57) * t297 + (Ifges(7,4) * t58 + Ifges(7,2) * t57) * t299 + t112 * t304 + m(4) * (t108 * t152 + t134 * t123); t28 * (-mrSges(7,1) * t139 + mrSges(7,2) * t212) + (Ifges(7,4) * t212 + Ifges(7,2) * t139) * t301 + (Ifges(7,1) * t212 + Ifges(7,4) * t139) * t302 + t212 * t8 / 0.2e1 + (-t45 * t61 - t46 * t62 + qJ(3) * t116 + t218 * t191 + (-t189 * t46 - t190 * t45) * qJD(4) + (t257 + qJD(3)) * t124) * m(5) + t257 * t84 + (-t126 / 0.2e1 + t106 / 0.2e1) * t17 + (-Ifges(7,5) * t105 - Ifges(7,6) * t106) * t291 + (-Ifges(7,1) * t105 - Ifges(7,4) * t106) * t298 + (-Ifges(7,4) * t105 - Ifges(7,2) * t106) * t300 + (-t38 * t56 - t39 * t54 + t149 * t40 + t219 * t191 + (-t189 * t39 + t190 * t38) * qJD(4) + (-t88 + t166) * t50) * m(6) + (-m(4) * t134 - t141) * (-qJ(3) * t255 + t178) + (Ifges(7,5) * t125 - Ifges(7,6) * t126) * t290 + (Ifges(7,1) * t125 - Ifges(7,4) * t126) * t297 + (Ifges(7,4) * t125 - Ifges(7,2) * t126) * t299 + t320 * t53 + (t1 * t87 + t127 * t28 + t2 * t86 + t321 * t6 + t320 * t5 + (-t166 - t63) * t31) * m(7) + t321 * t52 + t318 * mrSges(7,3) - t150 * mrSges(4,3) + t149 * t109 + t127 * t9 + qJ(3) * t110 - t54 * t101 - t62 * t102 - t61 * t103 - t56 * t104 + t87 * t23 - t88 * t83 + t86 * t22 - t63 * t21 + (t125 / 0.2e1 + t105 / 0.2e1) * t18 + ((-t175 / 0.2e1 + (t293 - t274 / 0.2e1) * qJD(1) + (-pkin(2) * mrSges(4,1) - Ifges(7,5) * t212 / 0.2e1 + t139 * t303 + t246 * t190 + t244 * t189 + t247) * qJD(2) + ((-m(4) * pkin(2) + t324) * qJD(2) - t230) * pkin(7) - t306) * t195 + ((-Ifges(5,3) / 0.2e1 - Ifges(6,2) / 0.2e1 + Ifges(3,2) / 0.2e1 - Ifges(4,2) / 0.2e1 + Ifges(4,3) / 0.2e1 - Ifges(3,1) / 0.2e1) * t255 + ((Ifges(4,6) / 0.2e1 + Ifges(3,4) / 0.2e1 + t201) * t193 + t294) * qJD(1) + ((-Ifges(5,2) * t189 + t279) * t287 + (Ifges(6,3) * t189 + t275) * t288 - qJ(3) * mrSges(4,1) + pkin(7) * mrSges(3,2) + t245 + (t190 * t326 + t276 - t280) * t289) * qJD(2) - t305) * t193) * qJD(1) + t282 * t166 + t270 * qJD(3) + (-qJD(4) * t262 + t191 * t261 - t200) * t190 + (-qJD(4) * t263 + t191 * t260 + t199) * t189 + (-mrSges(7,1) * t258 - mrSges(7,2) * t259) * t31 + t139 * t304 + m(4) * (-t150 * qJ(3) - t157 * qJD(3)); -t212 * t22 + t139 * t23 + t259 * t53 + t258 * t52 + t261 * t190 + t260 * t189 + (-t270 - t282) * qJD(2) + (t243 * t253 + (-t189 * t262 + t190 * t263 + t141) * t193) * qJD(1) - m(4) * (-qJD(2) * t157 - t134 * t256) + (qJD(2) * t31 + t318) * m(7) + (-qJD(2) * t50 + t217 * t256 + t219) * m(6) + (-qJD(2) * t124 - t216 * t256 + t218) * m(5); t76 * t52 - t213 * t53 + t155 + t262 * t137 + t263 * t136 + (-t281 + (-mrSges(5,1) - mrSges(6,1)) * t190) * t238 - t9 + (-t213 * t5 + t6 * t76 - t28) * m(7) + (t136 * t39 - t137 * t38 + t40) * m(6) + (t136 * t46 + t137 * t45 + t116) * m(5); t192 * t23 + t194 * t22 + t154 + t282 * t137 + t215 * qJD(6) + (-mrSges(6,1) * t253 + (-t101 - t215) * t193) * qJD(1) + (t1 * t192 - t137 * t31 + t194 * t2 + t168 * (-t192 * t5 + t194 * t6)) * m(7) + (t137 * t50 - t256 * t39 + t25) * m(6); -Ifges(7,3) * t237 - t31 * (mrSges(7,1) * t213 + mrSges(7,2) * t76) + (Ifges(7,1) * t76 - t286) * t298 + t17 * t297 + (Ifges(7,5) * t76 - Ifges(7,6) * t213) * t291 - t5 * t52 + t6 * t53 + (t213 * t6 + t5 * t76) * mrSges(7,3) + (-Ifges(7,2) * t213 + t18 + t73) * t300 - t307;];
tauc  = t7(:);
