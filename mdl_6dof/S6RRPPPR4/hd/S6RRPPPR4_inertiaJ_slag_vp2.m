...
t13 = [0.2e1 * t1 * t20 + 0.2e1 * t10 * t44 + 0.2e1 * t11 * t46 + 0.2e1 * t12 * t7 + 0.2e1 * t2 * t19 + 0.2e1 * t21 * t34 + t28 * t4 - t29 * t5 + 0.2e1 * t59 * t35 + 0.2e1 * t9 * t45 + 0.2e1 * t8 * t47 + Ifges(2,3) + m(4) * (t51 ^ 2 + t104) + m(3) * (pkin(1) ^ 2 + t104) + m(5) * (t10 ^ 2 + t11 ^ 2 + t59 ^ 2) + m(7) * (t1 ^ 2 + t12 ^ 2 + t2 ^ 2) + m(6) * (t21 ^ 2 + t8 ^ 2 + t9 ^ 2) + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * t51 * mrSges(4,2) + (Ifges(4,3) + Ifges(3,2)) * t86 + (t24 - t25) * t81 + (-t26 - t27) * t80) * t86 + (-0.2e1 * pkin(1) * mrSges(3,2) - 0.2e1 * t51 * mrSges(4,3) + (Ifges(6,2) + Ifges(5,3) + Ifges(4,2) + Ifges(3,1) + Ifges(7,3)) * t84 + ((2 * Ifges(3,4)) + (2 * Ifges(4,6)) + (-Ifges(5,6) + Ifges(6,6)) * t81 + (-Ifges(6,4) - Ifges(5,5)) * t80) * t86 + t108) * t84 + 0.2e1 * (mrSges(4,1) + mrSges(3,3)) * pkin(7) * t119; t50 * t34 + t21 * t52 + t59 * t53 + t90 * t5 / 0.2e1 + t42 * t4 / 0.2e1 + t28 * t17 / 0.2e1 - t29 * t18 / 0.2e1 - t32 * t7 + qJ(3) * t35 + t12 * t16 + t15 * t19 + t14 * t20 + t95 * mrSges(7,3) + (-t10 * mrSges(5,3) + t9 * mrSges(6,2) + t26 / 0.2e1 + t27 / 0.2e1 + t107 * t82) * t81 + (-t11 * mrSges(5,3) - t8 * mrSges(6,2) + t24 / 0.2e1 - t25 / 0.2e1 + t106 * t82) * t80 + m(6) * (t21 * t50 + t82 * t94) + m(5) * (qJ(3) * t59 + t82 * t93) + m(7) * (t1 * t14 - t12 * t32 + t15 * t2) + (-pkin(2) * mrSges(4,1) - t37 / 0.2e1 - t36 / 0.2e1 - Ifges(4,4) + Ifges(3,5) + (Ifges(6,4) / 0.2e1 + Ifges(5,5) / 0.2e1) * t81 + (Ifges(6,6) / 0.2e1 - Ifges(5,6) / 0.2e1) * t80 + (-mrSges(3,1) + t100) * pkin(7)) * t84 + (qJ(3) * mrSges(4,1) - Ifges(4,5) + Ifges(3,6) + (t54 / 0.2e1 - t55 / 0.2e1) * t81 + (-t56 / 0.2e1 - t57 / 0.2e1) * t80 + (m(4) * qJ(3) - mrSges(3,2) + mrSges(4,3)) * pkin(7)) * t86; -0.2e1 * pkin(2) * mrSges(4,2) - 0.2e1 * t32 * t16 + t42 * t17 + t90 * t18 + 0.2e1 * t50 * t52 + Ifges(4,1) + Ifges(3,3) + (t56 + t57) * t81 + (t54 - t55) * t80 + m(7) * (t14 ^ 2 + t15 ^ 2 + t32 ^ 2) + m(6) * (t50 ^ 2 - t105) + m(5) * (t87 - t105) + m(4) * (pkin(2) ^ 2 + t87) + 0.2e1 * t82 * t118 + 0.2e1 * (t53 + mrSges(4,3)) * qJ(3) + 0.2e1 * t92 * mrSges(7,3); t42 * t19 - t90 * t20 + (m(4) * pkin(7) + mrSges(4,1)) * t84 + t107 * t81 + t106 * t80 + m(7) * t95 + m(6) * t94 + m(5) * t93; m(7) * t92 + t101 * mrSges(7,3) + t82 * t89 + t100 + t118; m(7) * t101 + m(4) + t89; m(5) * t59 + m(6) * t21 - m(7) * t12 + t34 + t35 - t7; m(5) * qJ(3) + m(6) * t50 + m(7) * t32 - t16 + t52 + t53; 0; m(5) + m(6) + m(7); t83 * t19 + t85 * t20 + m(7) * (t1 * t85 + t2 * t83) + m(6) * t9 + t45; m(7) * (t14 * t85 + t15 * t83) + (-m(6) * t82 + mrSges(6,2)) * t81 + t91 * mrSges(7,3); -m(6) * t81 + m(7) * t91; 0; m(6) + m(7) * (t83 ^ 2 + t85 ^ 2); mrSges(7,1) * t1 - mrSges(7,2) * t2 - Ifges(7,3) * t84 - t108; mrSges(7,1) * t14 - mrSges(7,2) * t15 + t36 + t37; -mrSges(7,1) * t90 - mrSges(7,2) * t42; 0; mrSges(7,1) * t85 - t83 * mrSges(7,2); Ifges(7,3);];
