% Umwandlung der Kinematikparameter von S6RRRRRP11V7 zu S6RRRRRP11
% Eingabe:
% pkin_var (4x1) double
%   Kinematikparameter (pkin) von S6RRRRRP11V7
...
function pkin_gen = S6RRRRRP11V7_pkin_var2gen(pkin_var)
pkin_gen = zeros(12,1);
pkin_gen([2, 7, 8, 10]) = pkin_var;
