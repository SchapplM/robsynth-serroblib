...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:35:39
% EndTime: 2018-11-23 16:35:40
...
t7 = -t27 * t76 + t28 * t43;
t8 = t27 * t43 + t28 * t76;
t87 = mrSges(7,1) * t7 - mrSges(7,2) * t8;
t96 = -mrSges(6,1) * t15 + mrSges(6,2) * t16 - t87;
t13 = t31 * t75 + t72;
t14 = -t31 * t73 + t74;
t77 = t31 * t43;
t5 = t27 * t77 + t28 * t45;
t6 = t27 * t45 - t28 * t77;
t88 = -mrSges(7,1) * t5 + mrSges(7,2) * t6;
t95 = mrSges(6,1) * t13 - mrSges(6,2) * t14 - t88;
t94 = m(4) + m(5) + m(6) + m(7);
...
t20 = t31 * t68 + t71;
t18 = -t31 * t69 + t70;
t1 = [(-t71 * t90 - t20 * mrSges(5,1) - t16 * mrSges(6,1) - t8 * mrSges(7,1) - t19 * mrSges(5,2) - t15 * mrSges(6,2) - t7 * mrSges(7,2) - t94 * (t25 * t45 - t43 * t41) + t92 * t43 + (-m(5) * t60 - m(6) * t54 - m(7) * t55 - t91) * t45) * g(2) + (-t18 * mrSges(5,1) - t14 * mrSges(6,1) - t6 * mrSges(7,1) - t17 * mrSges(5,2) - t13 * mrSges(6,2) - t5 * mrSges(7,2) + (t41 * t94 - t100 + t92) * t45 + (m(4) * t25 - m(5) * (-t25 - t60) - m(6) * (-t25 - t54) - m(7) * (-t25 - t55) + t91) * t43) * g(1) (-g(1) * t43 + g(2) * t45) * (m(3) + t94) (t101 * t30 + t102 * t31 - t59) * g(3) + (g(1) * t45 + g(2) * t43) * ((mrSges(4,2) + t101) * t31 + (mrSges(4,1) - t102) * t30) (mrSges(5,1) * t42 + mrSges(5,2) * t44 + t100 + t97 + t99) * t82 + (-t18 * mrSges(5,2) - m(7) * (-t22 * t77 - t23 * t45) + t98 * t17 + t95) * g(2) + (t20 * mrSges(5,2) - m(7) * (-t22 * t76 + t23 * t43) - t98 * t19 + t96) * g(1) (m(7) * t85 + t97) * t82 + (t13 * t89 + t95) * g(2) + (-t15 * t89 + t96) * g(1), -g(1) * t87 - g(2) * t88 - t56 * t82];
taug  = t1(:);
