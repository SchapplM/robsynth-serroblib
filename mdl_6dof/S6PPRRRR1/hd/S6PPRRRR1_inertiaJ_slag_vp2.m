...
% OptimizationMode: 2
% StartTime: 2018-11-23 14:51:52
% EndTime: 2018-11-23 14:51:53
...
t107 = t131 * t86;
t63 = t131 * t90;
t40 = -t107 * t89 - t63 * t85;
t138 = m(7) * t40 + t28;
t54 = t85 * t86 - t89 * t90;
t69 = -pkin(4) * t90 - pkin(3);
t29 = pkin(5) * t54 - pkin(11) * t55 + t69;
t42 = t107 * t85 - t89 * t63;
t10 = t29 * t88 - t42 * t84;
t11 = t29 * t84 + t42 * t88;
t125 = t11 * t88;
t117 = t84 * mrSges(7,3);
t31 = -mrSges(7,2) * t54 - t117 * t55;
t121 = t55 * t88;
...
t83 = cos(pkin(6));
t91 = cos(qJ(3));
t35 = t83 * t120 + (t118 * t87 + t78 * t91) * t80;
t45 = -t79 * t80 * t81 + t82 * t83;
t14 = -t35 * t86 + t45 * t90;
t15 = t35 * t90 + t45 * t86;
t6 = -t14 * t89 + t15 * t85;
t136 = t6 ^ 2;
t47 = -t120 * t86 + t82 * t90;
t48 = t120 * t90 + t82 * t86;
t24 = -t47 * t89 + t48 * t85;
t135 = t24 ^ 2;
t119 = t79 * t91;
...
t108 = t60 * t88 + t61 * t84 + Ifges(6,3);
t67 = pkin(4) * t85 + pkin(11);
t106 = t112 * t67;
t2 = t33 * t88 - t8 * t84;
t105 = -t2 * t84 + t129;
t102 = -t14 * t86 + t15 * t90;
t18 = -t119 * t88 - t26 * t84;
t101 = -t18 * t84 + t124;
...
t65 = t72 * t91 ^ 2;
t1 = [m(2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t136) + m(6) * (t8 ^ 2 + t136 + t30) + m(5) * (t14 ^ 2 + t15 ^ 2 + t30) + m(4) * (t35 ^ 2 + t45 ^ 2 + t30) + m(3) * (t83 ^ 2 + (t78 ^ 2 + t81 ^ 2) * t80 ^ 2); m(3) * t83 + m(7) * (t18 * t2 + t19 * t3 + t130) + m(6) * (t26 * t8 - t110 + t130) + m(5) * (t14 * t47 + t15 * t48 - t110) + m(4) * (t82 * t45 + (-t33 * t91 + t35 * t87) * t79); m(3) + m(7) * (t18 ^ 2 + t19 ^ 2 + t135) + m(6) * (t26 ^ 2 + t135 + t65) + m(5) * (t47 ^ 2 + t48 ^ 2 + t65) + m(4) * (t72 * t87 ^ 2 + t82 ^ 2 + t65); -t35 * mrSges(4,2) + t2 * t32 + t6 * t28 + t3 * t31 + (-t54 * t8 + t55 * t6) * mrSges(6,3) + t102 * mrSges(5,3) - t109 * t33 + m(7) * (t10 * t2 + t11 * t3 + t128) + m(6) * (t33 * t69 + t42 * t8 + t128) + m(5) * (-pkin(3) * t33 + pkin(9) * t102); t18 * t32 + t19 * t31 + t24 * t28 + (t24 * t55 - t26 * t54) * mrSges(6,3) + t100 * mrSges(5,3) + (-t87 * mrSges(4,2) + t109 * t91) * t79 + m(7) * (t10 * t18 + t11 * t19 + t123) + m(6) * (-t119 * t69 + t26 * t42 + t123) + m(5) * (pkin(3) * t119 + pkin(9) * t100); Ifges(5,2) * t77 - 0.2e1 * pkin(3) * t59 + 0.2e1 * t10 * t32 + 0.2e1 * t11 * t31 + t28 * t133 + 0.2e1 * t69 * t36 + Ifges(4,3) + (Ifges(5,1) * t86 + 0.2e1 * Ifges(5,4) * t90) * t86 + 0.2e1 * t111 * pkin(9) * mrSges(5,3) + (-0.2e1 * mrSges(6,3) * t42 + Ifges(6,2) * t54 + t114) * t54 + m(7) * (t10 ^ 2 + t11 ^ 2 + t134) + m(6) * (t42 ^ 2 + t69 ^ 2 + t134) + m(5) * (pkin(9) ^ 2 * t111 + pkin(3) ^ 2) + (mrSges(6,3) * t133 + Ifges(6,1) * t55 - t84 * t21 + t88 * t22 + (-Ifges(7,6) * t84 - (2 * Ifges(6,4))) * t54) * t55; t14 * mrSges(5,1) - t15 * mrSges(5,2) + m(7) * (t105 * t67 + t6 * t68) + (-t6 * t89 + t8 * t85) * t132 + t97; t47 * mrSges(5,1) - t48 * mrSges(5,2) + m(7) * (t101 * t67 + t68 * t24) + (-t24 * t89 + t26 * t85) * t132 + t96; (m(6) * (-t40 * t89 + t42 * t85) + (-t54 * t85 - t55 * t89) * mrSges(6,3)) * pkin(4) + (-mrSges(5,1) * t86 - mrSges(5,2) * t90) * pkin(9) + Ifges(5,6) * t90 + Ifges(5,5) * t86 + t95 + t138 * t68 + t137 * t67; 0.2e1 * t68 * t58 + Ifges(5,3) + 0.2e1 * t98 + t67 * t99 + m(7) * (t112 * t67 ^ 2 + t68 ^ 2) + m(6) * (t85 ^ 2 + t89 ^ 2) * pkin(4) ^ 2 + t108; m(7) * (-pkin(5) * t6 + pkin(11) * t105) + t97; m(7) * (-pkin(5) * t24 + pkin(11) * t101) + t96; -pkin(5) * t138 + pkin(11) * t137 + t95; m(7) * (-pkin(5) * t68 + pkin(11) * t106) + (t68 - pkin(5)) * t58 + t98 + (pkin(11) * t112 + t106) * mrSges(7,3) + t108; -0.2e1 * pkin(5) * t58 + m(7) * (pkin(11) ^ 2 * t112 + pkin(5) ^ 2) + pkin(11) * t99 + t108; mrSges(7,1) * t2 - mrSges(7,2) * t3; mrSges(7,1) * t18 - mrSges(7,2) * t19; mrSges(7,1) * t10 - mrSges(7,2) * t11 - Ifges(7,6) * t122 + t114; -t104 * t67 + t113; -pkin(11) * t104 + t113; Ifges(7,3);];
