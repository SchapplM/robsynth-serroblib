...
function JRD_rot = S6RRPPRR10_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),uint8(0),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRPPRR10_jacobiRD_rot_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRPPRR10_jacobiRD_rot_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRPPRR10_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRPPRR10_jacobiRD_rot_sym_varpar: pkin has to be [10x1] (double)');
if link_index == 0
...
elseif link_index == 6
	...
	t319 = t305 * t326;
	t317 = t311 * t325;
	t315 = -qJD(1) * t309 - t308;
	t314 = -t310 * t327 + t311 * t328;
	t313 = -t309 * t325 - t311 * t329;
	t299 = t306 * t327 + t324;
	t298 = -t305 * t327 + t323;
	t297 = -t305 * t321 - t308 * t332 + (t319 + t334) * t312;
	t296 = -t316 * t312 * t305 + (t315 * t310 + t317) * t306;
	t295 = -t310 * t334 + (t315 * t312 - t318) * t305;
	t294 = t333 * t306 + t316 * t332 - t322;
	t1 = [t295, t313 * t305 + t311 * t322, 0, 0, t296, t296; t297, t314 * t305 + t310 * t323, 0, 0, -t294, -t294; 0, t306 * t331 + t319, 0, 0, t299, t299; t294, t313 * t306 - t312 * t324, 0, 0, -t297, -t297; t296, t314 * t306 - t310 * t324, 0, 0, t295, t295; 0, -t305 * t331 + t306 * t326, 0, 0, t298, t298; -t314, -t317 + t321, 0, 0, 0, 0; t313, t333, 0, 0, 0, 0; 0, -t327, 0, 0, 0, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,6);
end