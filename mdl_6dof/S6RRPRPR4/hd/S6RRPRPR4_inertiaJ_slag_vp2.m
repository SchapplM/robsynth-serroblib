...
t3 = -pkin(5) * t81 - t5;
t12 = [(mrSges(4,1) * t174 - 0.2e1 * Ifges(4,4) * t82 + Ifges(4,2) * t81 + t143) * t81 + (t7 - t16) * t38 + ((Ifges(3,5) * t136 + Ifges(3,6) * t139) * t133 + 0.2e1 * (-t136 * t85 + t139 * t86) * mrSges(3,3) + (m(3) * pkin(1) ^ 2 - 0.2e1 * pkin(1) * (-mrSges(3,1) * t139 + mrSges(3,2) * t136) + t139 * (Ifges(3,4) * t136 + Ifges(3,2) * t139) + t136 * (Ifges(3,1) * t136 + Ifges(3,4) * t139)) * t130) * t130 + Ifges(4,1) * t82 ^ 2 + t76 * t174 + m(3) * (t85 ^ 2 + t86 ^ 2) + m(5) * (t21 ^ 2 + t22 ^ 2 + t42 ^ 2) + m(6) * (t27 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(4) * (t44 ^ 2 + t45 ^ 2 + t96 ^ 2) + 0.2e1 * t3 * t11 + 0.2e1 * t2 * t14 + 0.2e1 * t1 * t15 + t25 * t8 + t26 * t9 + 0.2e1 * t27 * t20 + 0.2e1 * t6 * t28 + 0.2e1 * t5 * t29 + Ifges(2,3) + t39 * t17 + 0.2e1 * t42 * t41 + 0.2e1 * t22 * t49 + 0.2e1 * t21 * t50 + t68 * t32 + t69 * t33 + 0.2e1 * t45 * t71 + 0.2e1 * t44 * t72 + (t142 - 0.2e1 * t163 + 0.2e1 * t164 + t179) * t133; (-t5 * mrSges(6,3) + t8 * t169 + t9 * t167 + t17 / 0.2e1) * t95 + t162 * t55 + (t22 * mrSges(5,3) + t115 * t49 + t32 / 0.2e1) * t138 + (-t21 * mrSges(5,3) - t115 * t50 + t33 / 0.2e1) * t135 + m(7) * (t1 * t30 + t2 * t31 + t3 * t55) + m(6) * (t27 * t97 - t5 * t55 + t57 * t6) + (-t6 * mrSges(6,3) + t7 / 0.2e1 - t16 / 0.2e1) * t93 + (t51 / 0.2e1 - t65 / 0.2e1) * t38 + t142 + (t129 * t71 + t132 * t72 + m(4) * (t129 * t45 + t132 * t44)) * pkin(2) + t53 * t172 + t52 * t173 - t163 + t164 + t30 * t15 + t31 * t14 + m(5) * (t117 * t42 + (-t135 * t21 + t138 * t22) * t115) + t44 * mrSges(4,1) - t45 * mrSges(4,2) + t57 * t28 + t3 * t58 + t2 * t59 + t1 * t60 + t27 * t64 + t39 * t66 / 0.2e1 + t97 * t20 + t42 * t99 + t68 * t102 / 0.2e1 + t69 * t104 / 0.2e1 + t117 * t41 + t178 * t81 / 0.2e1; t138 * t102 + t135 * t104 + 0.2e1 * t117 * t99 + 0.2e1 * t30 * t60 + 0.2e1 * t31 * t59 + t58 * t175 + 0.2e1 * t97 * t64 + (-0.2e1 * mrSges(6,3) * t57 + t51 - t65) * t93 + (mrSges(6,3) * t175 - t134 * t52 + t137 * t53 + t66) * t95 + m(7) * (t30 ^ 2 + t31 ^ 2 + t177) + m(6) * (t57 ^ 2 + t97 ^ 2 + t177) + m(5) * (t115 ^ 2 * t149 + t117 ^ 2) + m(4) * (t129 ^ 2 + t132 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t132 - mrSges(4,2) * t129) * pkin(2) + 0.2e1 * t149 * t115 * mrSges(5,3) + t181; t81 * mrSges(4,1) + t135 * t49 + t138 * t50 + t76 + t162 * t93 + (-t134 * t15 + t137 * t14 + t28) * t95 + m(7) * (t146 * t95 + t3 * t93) + m(6) * (-t5 * t93 + t6 * t95) + m(5) * (t135 * t22 + t138 * t21) + m(4) * t96; t93 * t58 + (-t134 * t60 + t137 * t59) * t95 + m(7) * (t144 * t95 + t165) + m(6) * (t57 * t95 + t165); m(4) + m(5) * t149 + m(6) * (t92 + t176) + m(7) * (t150 * t92 + t176); t143 + t146 * mrSges(7,3) - t15 * t156 + t14 * t155 + t5 * mrSges(6,1) - t6 * mrSges(6,2) + t21 * mrSges(5,1) - t22 * mrSges(5,2) + t3 * t98 + t38 * t170 + t101 * t173 + t103 * t172 + t116 * t11 + t9 * t168 + t8 * t167 + m(7) * (t114 * t146 + t116 * t3) + (t128 * t28 + t131 * t29 + m(6) * (t128 * t6 + t131 * t5)) * pkin(4); t55 * t98 + t93 * t170 + t53 * t168 + t52 * t167 + t116 * t58 + m(7) * (t114 * t144 + t116 * t55) - t55 * mrSges(6,1) - t57 * mrSges(6,2) + t59 * t155 - t60 * t156 + (t101 * t169 + t103 * t167) * t95 + (-mrSges(5,1) * t135 - mrSges(5,2) * t138) * t115 + t144 * mrSges(7,3) + (m(6) * (t128 * t57 - t131 * t55) + (-t128 * t93 - t131 * t95) * mrSges(6,3)) * pkin(4) + t178; -t87 + (-mrSges(6,1) + t98) * t93 + t150 * t95 * mrSges(7,3) + m(7) * (t116 * t93 + t148 * t95) + m(6) * (t128 * t95 - t131 * t93) * pkin(4) - t99; t137 * t101 + t134 * t103 + 0.2e1 * t116 * t98 + m(7) * (t114 ^ 2 * t150 + t116 ^ 2) + m(6) * (t128 ^ 2 + t131 ^ 2) * pkin(4) ^ 2 + 0.2e1 * (mrSges(6,1) * t131 - mrSges(6,2) * t128) * pkin(4) + 0.2e1 * mrSges(7,3) * t148 + t180; t134 * t14 + t137 * t15 + m(7) * (t1 * t137 + t134 * t2) + m(6) * t27 + t20; t134 * t59 + t137 * t60 + m(7) * (t134 * t31 + t137 * t30) + m(6) * t97 + t64; 0; 0; m(7) * t150 + m(6); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t30 - mrSges(7,2) * t31 + t51; -t58; -t114 * t145 + t100; -t98; Ifges(7,3);];
