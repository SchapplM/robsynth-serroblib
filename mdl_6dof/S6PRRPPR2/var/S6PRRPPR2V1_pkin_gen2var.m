% Umwandlung der Kinematikparameter von S6PRRPPR2 zu S6PRRPPR2V1
% Eingabe:
...
%   Kinematikparameter (pkin) von S6PRRPPR2V1
%   pkin_var=[a2 a3 a4 a5 a6 alpha2 d2 d3 theta1 theta4]
% I_gv (10x1)
%   Vektor mit Indizes zur Selektion von Kinematikparametern
function [pkin_var, I_gv] = S6PRRPPR2V1_pkin_gen2var(pkin_gen)
