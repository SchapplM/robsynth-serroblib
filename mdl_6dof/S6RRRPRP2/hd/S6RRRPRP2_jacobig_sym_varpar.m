...
%% Function calls
if link_index == 0
	Jg=S6RRRPRP2_jacobig_0_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 1
	Jg=S6RRRPRP2_jacobig_1_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 2
	Jg=S6RRRPRP2_jacobig_2_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 3
	Jg=S6RRRPRP2_jacobig_3_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 4
	Jg=S6RRRPRP2_jacobig_4_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 5
	Jg=S6RRRPRP2_jacobig_5_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 6
	Jg=S6RRRPRP2_jacobig_6_sym_varpar(qJ, r_i_i_C, pkin);
else
	Jg=NaN(6,6);
end