...
elseif link_index == 5
	...
	t13 = cos(qJ(3));
	t11 = sin(qJ(3));
	t20 = pkin(8) + r_i_i_C(1);
	t16 = t20 * t11;
	t23 = pkin(3) * t13 + pkin(2) + t16;
	t10 = sin(qJ(4));
	t12 = cos(qJ(4));
	t17 = r_i_i_C(3) + qJ(5);
	t21 = pkin(4) - r_i_i_C(2);
...
elseif link_index == 6
	...
	% EndTime: 2019-10-10 01:13:10
	% DurationCPUTime: 0.16s
	% Computational Cost: add. (160->25), mult. (186->38), div. (0->0), fcn. (216->8), ass. (0->21)
	t13 = cos(qJ(3));
	t11 = sin(qJ(3));
	t18 = pkin(5) + pkin(8) + r_i_i_C(1);
	t15 = t18 * t11;
	t23 = t13 * pkin(3) + pkin(2) + t15;
	t10 = sin(qJ(4));
	t12 = cos(qJ(4));
	t17 = pkin(4) + r_i_i_C(3) + qJ(6);
	t19 = r_i_i_C(2) + qJ(5);
	t22 = t19 * t10 + t17 * t12 + pkin(3);
	t21 = t10 * t13;
	t20 = t12 * t13;
	t14 = -t22 * t11 + t18 * t13;
	t9 = qJ(1) + pkin(9);
	...
	t2 = -t8 * t10 + t7 * t20;
	t1 = t8 * t12 + t7 * t21;
	t5 = [-sin(qJ(1)) * pkin(1) + t8 * pkin(7) - t19 * t1 - t17 * t2 - t23 * t7, 0, t14 * t8, -t17 * t3 + t19 * t4, t3, t4; cos(qJ(1)) * pkin(1) + t7 * pkin(7) + t19 * t3 + t17 * t4 + t23 * t8, 0, t14 * t7, -t17 * t1 + t19 * t2, t1, t2; 0, 1, t22 * t13 + t15, (-t17 * t10 + t19 * t12) * t11, t11 * t10, t11 * t12;];
	Ja_transl = t5;
else
	Ja_transl=NaN(3,6);
end