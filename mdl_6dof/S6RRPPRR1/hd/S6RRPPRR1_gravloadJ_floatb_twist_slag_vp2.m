...
t2 = -t29 * t31 - t32 * t5;
t1 = t29 * t5 - t31 * t32;
t9 = [(-m(4) * t56 - m(5) * (t56 + t76) - m(6) * t54 + t5 * mrSges(6,1) - m(7) * (-pkin(5) * t5 + t54) - t2 * mrSges(7,1) - t1 * mrSges(7,2) - t82 * t6 + t83 * t34 + t81 * t31) * g(2) + (-m(6) * t36 + t4 * mrSges(6,1) - t47 * mrSges(7,1) - t48 * mrSges(7,2) - (-t4 * pkin(5) + t36) * m(7) - t82 * t3 + (m(4) * t23 - m(5) * (t55 - t22) - t83) * t31 + ((m(4) + m(5)) * t28 + t81) * t34) * g(1) (-m(5) * t13 - t35 * t31 - m(6) * t77 + t4 * mrSges(7,3) - (-pkin(9) * t4 + t77) * m(7) + t85) * g(2) + (-m(5) * t15 - t35 * t34 - m(6) * t75 - t5 * mrSges(7,3) - (t5 * pkin(9) + t75) * m(7) + t86) * g(1) + (-m(4) * t26 - m(5) * t64 - m(6) * t53 - m(7) * (-pkin(9) * t8 + t53) + t8 * mrSges(7,3) + t87 + t89) * g(3) + (m(4) * t73 + mrSges(3,1) * t30 + mrSges(4,1) * t24 + mrSges(3,2) * t33 + mrSges(4,2) * t25) * t84 (-g(1) * t31 + g(2) * t34) * (m(4) + t65) (t25 * g(3) - t84 * t24) * t65 (-t61 * t8 - t87) * g(3) + (-t61 * t4 - t85) * g(2) + (t61 * t5 - t86) * g(1), -g(1) * (mrSges(7,1) * t1 - mrSges(7,2) * t2) - g(2) * (-t48 * mrSges(7,1) + t47 * mrSges(7,2)) - g(3) * (-t29 * mrSges(7,1) - t32 * mrSges(7,2)) * t8];
taug  = t9(:);
