...
% OptimizationMode: 2
% StartTime: 2018-11-23 14:51:24
% EndTime: 2018-11-23 14:51:24
...
t21 = -t84 * qJ(6) + t24;
t1 = [m(2) + m(5) * (t11 ^ 2 + t128 + t8) + m(4) * (t16 ^ 2 + t31 ^ 2 + t128) + m(3) * (t79 ^ 2 + (t74 ^ 2 + t77 ^ 2) * t76 ^ 2) + t133 * (t4 ^ 2 + t6 ^ 2 + t8); m(3) * t79 + m(5) * (t35 * t11 - t14 * t113 + t7) + m(4) * (t78 * t31 + (-t14 * t85 + t16 * t82) * t75) + t133 * (t18 * t4 + t20 * t6 + t7); m(3) + m(5) * (t35 ^ 2 + t32 + t59) + m(4) * (t68 * t82 ^ 2 + t78 ^ 2 + t59) + t133 * (t18 ^ 2 + t20 ^ 2 + t32); t11 * t108 - t16 * mrSges(4,2) + t105 * t6 + t104 * t4 - t107 * t14 + t93 * t9 + m(7) * (t21 * t6 + t22 * t4 + t30 * t9) + m(6) * (pkin(9) * t124 - t23 * t4 + t24 * t6) + m(5) * (-pkin(3) * t14 + (t11 * t84 + t124) * pkin(9)); t35 * t108 + t105 * t20 + t104 * t18 + (-t82 * mrSges(4,2) + t107 * t85) * t75 + t93 * t33 + m(7) * (t22 * t18 + t21 * t20 + t30 * t33) + m(6) * (pkin(9) * t115 - t23 * t18 + t24 * t20) + m(5) * (pkin(3) * t113 + (t35 * t84 + t115) * pkin(9)); -0.2e1 * pkin(3) * t48 + 0.2e1 * t21 * t43 + 0.2e1 * t22 * t42 + 0.2e1 * t23 * t41 + 0.2e1 * t24 * t40 + 0.2e1 * t30 * t36 + Ifges(4,3) + (t71 + t73) * mrSges(5,3) * t134 + m(7) * (t21 ^ 2 + t22 ^ 2 + t30 ^ 2) + m(6) * (t23 ^ 2 + t24 ^ 2 + t66) + m(5) * (pkin(3) ^ 2 + t73 * t87 + t66) + ((Ifges(5,2) - t106) * t84 + t100) * t84 + (Ifges(5,1) * t81 + 0.2e1 * Ifges(5,4) * t84 + t37 * t134 + (t28 + t29) * t83 + (t26 - t27 + t119) * t80) * t81; -t11 * mrSges(5,2) + t101 * t9 + m(7) * (t44 * t9 + t97) + m(6) * (-pkin(4) * t9 + t97) + t132 * t135; -t35 * mrSges(5,2) + t101 * t33 + m(7) * (t44 * t33 + t94) + m(6) * (-pkin(4) * t33 + t94) + t132 * t136; -pkin(4) * t37 + t44 * t36 + (m(7) * t44 + t46) * t30 + (-pkin(9) * mrSges(5,2) - t64 / 0.2e1 - t63 / 0.2e1 - t62 / 0.2e1 + Ifges(5,6)) * t84 + (t21 * mrSges(7,2) + t24 * mrSges(6,3) + t118 / 0.2e1 - t26 / 0.2e1 + t27 / 0.2e1) * t83 + (t22 * mrSges(7,2) - t23 * mrSges(6,3) + t28 / 0.2e1 + t29 / 0.2e1) * t80 + (t105 * t83 + t104 * t80 + m(6) * (-t23 * t80 + t24 * t83) + m(7) * (t21 * t83 + t22 * t80)) * pkin(10) + (Ifges(5,5) + (t51 / 0.2e1 + t52 / 0.2e1) * t83 + (t49 / 0.2e1 - t50 / 0.2e1) * t80 + (-m(6) * pkin(4) + t103) * pkin(9)) * t81; -0.2e1 * pkin(4) * t47 + 0.2e1 * t44 * t46 + Ifges(5,3) + (t50 - t49) * t83 + (t51 + t52) * t80 + m(7) * (t44 ^ 2 + t102) + m(6) * (pkin(4) ^ 2 + t102) + 0.2e1 * t132 * pkin(10) * t137; t129 * t6 + t130 * t4; t129 * t20 + t130 * t18; -pkin(5) * t42 + m(7) * (-pkin(5) * t22 + qJ(6) * t21) + qJ(6) * t43 + t21 * mrSges(7,3) - Ifges(6,6) * t111 - t22 * mrSges(7,1) - t24 * mrSges(6,2) + t23 * mrSges(6,1) + t106 * t84 - t100; -Ifges(7,6) * t83 + t62 + t63 + t64 + t89 * mrSges(7,2) + (m(7) * t89 - t90 - t91) * pkin(10); 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) - t106; m(7) * t4; m(7) * t18; m(7) * t22 + t42; (m(7) * pkin(10) + mrSges(7,2)) * t80; t131; m(7);];
