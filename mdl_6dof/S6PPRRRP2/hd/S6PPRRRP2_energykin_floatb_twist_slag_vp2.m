...
function T = S6PPRRRP2_energykin_floatb_twist_slag_vp2(qJ, qJD, V_base, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(6,1),zeros(12,1),zeros(7,1),zeros(7,3),zeros(7,6)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PPRRRP2_energykin_floatb_twist_slag_vp2: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6PPRRRP2_energykin_floatb_twist_slag_vp2: qJD has to be [6x1] (double)');
assert(isreal(V_base) && all(size(V_base) == [6 1]), ...
  'S6PPRRRP2_energykin_floatb_twist_slag_vp2: V_base has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6PPRRRP2_energykin_floatb_twist_slag_vp2: pkin has to be [12x1] (double)');
assert(isreal(m) && all(size(m) == [7 1]), ...
  'S6PPRRRP2_energykin_floatb_twist_slag_vp2: m has to be [7x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [7,3]), ...
  'S6PPRRRP2_energykin_floatb_twist_slag_vp2: mrSges has to be [7x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [7 6]), ...
  'S6PPRRRP2_energykin_floatb_twist_slag_vp2: Ifges has to be [7x6] (double)'); 
...
% Computational Cost: add. (6659->162), mult. (12565->232), div. (0->0), fcn. (10888->14), ass. (0->65)
...
t81 = qJ(2) * t58;
t49 = V_base(6) * pkin(1) - t72 * t81 + t55;
t57 = -t66 * V_base(4) + t70 * V_base(5);
t64 = V_base(3) + qJD(1);
t68 = sin(pkin(6));
t53 = -pkin(1) * t57 - t68 * t81 + t64;
t90 = t49 * t72 + t53 * t68;
t56 = t70 * t62 + t66 * t63;
t78 = t57 * t72 + t68 * V_base(6);
t46 = t78 * qJ(2) + t56;
t65 = sin(pkin(12));
t69 = cos(pkin(12));
t35 = -t46 * t65 + t90 * t69;
...
t48 = t58 * t69 + t78 * t65;
t88 = pkin(8) * t48;
t28 = pkin(2) * t54 - t71 * t88 + t35;
t41 = -t49 * t68 + t72 * t53 + qJD(2);
t47 = -t58 * t65 + t78 * t69;
t67 = sin(pkin(7));
t34 = -pkin(2) * t47 - t67 * t88 + t41;
t89 = t28 * t71 + t34 * t67;
t36 = t69 * t46 + t90 * t65;
t79 = t47 * t71 + t54 * t67;
t27 = t79 * pkin(8) + t36;
...
t30 = -t40 * t74 + t42 * t76;
t31 = t40 * t76 + t42 * t74;
t12 = -t30 * pkin(4) - t31 * pkin(10) + t15;
t73 = sin(qJ(5));
t20 = t77 * t27 + t89 * t75;
t16 = pkin(9) * t42 + t20;
t21 = -t28 * t67 + t71 * t34;
t18 = -pkin(3) * t39 - pkin(9) * t40 + t21;
t10 = t76 * t16 + t74 * t18;
t38 = qJD(4) - t39;
t8 = pkin(10) * t38 + t10;
t87 = cos(qJ(5));
