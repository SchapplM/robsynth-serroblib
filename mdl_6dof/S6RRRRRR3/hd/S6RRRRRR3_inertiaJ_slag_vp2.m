...
t170 = -t3 * t209 - t11 * t201 - t135 * t197 / 0.2e1 + t136 * t196 / 0.2e1 + t43 * t47 + t41 * t48 / 0.2e1 + t42 * t49 / 0.2e1 + t12 * t202 + t4 * t210 + t84 * t13 / 0.2e1 + t85 * t14 / 0.2e1 + t66 * t88 - t71 * t89 / 0.2e1 + t72 * t90 / 0.2e1 - t100 * mrSges(4,2) + t125 * t31 / 0.2e1 + t127 * t32 / 0.2e1 + Ifges(4,5) * t128 + t157 * t62 / 0.2e1 + t162 * t61 / 0.2e1 + (-mrSges(4,1) + t134) * t97 + t181 * mrSges(5,3) + (-Ifges(4,6) + t231 / 0.2e1) * t126;
...
t1 = [(mrSges(4,2) * t219 + mrSges(4,3) * t220 + Ifges(4,1) * t128 - t157 * t61 + t162 * t62) * t128 + m(4) * (t100 ^ 2 + t146 ^ 2 + t223) + m(5) * (t52 ^ 2 + t53 ^ 2 + t223) + m(3) * (t192 * pkin(7) ^ 2 + pkin(1) ^ 2) + 0.2e1 * t12 * t54 + 0.2e1 * t11 * t55 + 0.2e1 * t66 * t44 + t41 * t13 + t42 * t14 + 0.2e1 * t43 * t15 + 0.2e1 * t4 * t28 + 0.2e1 * t3 * t29 + 0.2e1 * t192 * pkin(7) * mrSges(3,3) + m(6) * (t11 ^ 2 + t12 ^ 2 + t66 ^ 2) + m(7) * (t3 ^ 2 + t4 ^ 2 + t43 ^ 2) + t80 * t220 + (mrSges(4,1) * t219 - 0.2e1 * t100 * mrSges(4,3) + Ifges(4,2) * t126 + (-Ifges(5,6) * t157 - (2 * Ifges(4,4))) * t128 + t187 + t224 + t225) * t126 - t71 * t31 + t72 * t32 + 0.2e1 * t53 * t86 + 0.2e1 * t52 * t87 + Ifges(2,3) + t159 * (Ifges(3,1) * t159 + Ifges(3,4) * t164) - 0.2e1 * pkin(1) * (-t164 * mrSges(3,1) + t159 * mrSges(3,2)) + t164 * (Ifges(3,4) * t159 + Ifges(3,2) * t164); t180 * t142 + m(6) * (t11 * t78 + t12 * t79 + t133 * t66) + m(7) * (t101 * t43 + t22 * t3 + t23 * t4) + t23 * t28 + t22 * t29 + t170 + (-mrSges(3,1) * t159 - mrSges(3,2) * t164) * pkin(7) + t78 * t55 + t79 * t54 + t101 * t15 + t133 * t44 + t144 * t80 + Ifges(3,5) * t159 + Ifges(3,6) * t164 + m(5) * (t181 * t142 + t144 * t97) + (m(4) * (t100 * t158 - t163 * t97) + (-t126 * t158 - t128 * t163) * mrSges(4,3)) * pkin(2); t173 + t142 * t177 + m(7) * (t101 ^ 2 + t22 ^ 2 + t23 ^ 2) + m(6) * (t133 ^ 2 + t78 ^ 2 + t79 ^ 2) + 0.2e1 * t175 + (t79 * t125 - t78 * t127) * t191 + (-t22 * t85 + t23 * t84) * t190 + m(4) * (t158 ^ 2 + t163 ^ 2) * pkin(2) ^ 2 + t101 * t222 + Ifges(3,3) + t133 * t221 + 0.2e1 * t144 * t134 + m(5) * (t193 * t142 ^ 2 + t144 ^ 2); t35 * t29 + t36 * t28 + t170 + t180 * pkin(9) + m(6) * (t11 * t96 + t12 * t99 + t145 * t66) + m(7) * (t103 * t43 + t3 * t35 + t36 * t4) - pkin(3) * t80 + t96 * t55 + t99 * t54 + t103 * t15 + t145 * t44 + m(5) * (-pkin(3) * t97 + t181 * pkin(9)); t173 + m(6) * (t133 * t145 + t78 * t96 + t79 * t99) + m(7) * (t101 * t103 + t22 * t35 + t23 * t36) + (t133 + t145) * t88 + (t101 + t103) * t47 + (-pkin(3) + t144) * t134 + t175 + (t193 * pkin(9) + t184) * mrSges(5,3) + ((-t78 - t96) * t127 + (t79 + t99) * t125) * mrSges(6,3) + ((-t22 - t35) * t85 + (t23 + t36) * t84) * mrSges(7,3) + m(5) * (-pkin(3) * t144 + pkin(9) * t184); -0.2e1 * pkin(3) * t134 + t103 * t222 + t145 * t221 + (-t35 * t85 + t36 * t84) * t190 + (t99 * t125 - t96 * t127) * t191 + pkin(9) * t177 + m(7) * (t103 ^ 2 + t35 ^ 2 + t36 ^ 2) + m(6) * (t145 ^ 2 + t96 ^ 2 + t99 ^ 2) + m(5) * (t193 * pkin(9) ^ 2 + pkin(3) ^ 2) + t173; t171 - Ifges(5,6) * t197 + t52 * mrSges(5,1) - t53 * mrSges(5,2) + m(7) * (t111 * t3 + t112 * t4) + t111 * t29 + t112 * t28 + (m(6) * (t11 * t161 + t12 * t156) + t156 * t54 + t161 * t55) * pkin(4) + t225; t172 - t182 * t142 + m(7) * (t111 * t22 + t112 * t23) + (m(6) * (t156 * t79 + t161 * t78) - t186) * pkin(4) + t227 + t229; t172 + (m(6) * (t156 * t99 + t161 * t96) - t186) * pkin(4) - t182 * pkin(9) + m(7) * (t111 * t35 + t112 * t36) + t226 + t228; -0.2e1 * t203 + Ifges(5,3) + 0.2e1 * t104 + 0.2e1 * t174 + m(7) * (t111 ^ 2 + t112 ^ 2) + m(6) * (t156 ^ 2 + t161 ^ 2) * pkin(4) ^ 2 + t207; (m(7) * (t155 * t4 + t160 * t3) + t155 * t28 + t160 * t29) * pkin(5) + t171; (m(7) * (t155 * t23 + t160 * t22) - t188) * pkin(5) + t179 + t227 + t230; (m(7) * (t155 * t36 + t160 * t35) - t188) * pkin(5) + t178 + t226 + t230; Ifges(6,3) + t147 + t174 + (m(7) * (t111 * t160 + t112 * t155) - t200) * pkin(5) + t183; -0.2e1 * t189 + 0.2e1 * t147 + m(7) * (t155 ^ 2 + t160 ^ 2) * pkin(5) ^ 2 + t207; t176; t179; t178; t183; Ifges(7,3) + t147 - t189; Ifges(7,3);];
