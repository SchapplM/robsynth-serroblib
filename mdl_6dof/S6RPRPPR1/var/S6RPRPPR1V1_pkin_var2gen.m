% Umwandlung der Kinematikparameter von S6RPRPPR1V1 zu S6RPRPPR1
% Eingabe:
...
%
% Siehe auch: S6RPRPPR1_structural_kinematic_parameters.m
function pkin_gen = S6RPRPPR1V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
