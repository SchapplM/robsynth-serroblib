...
t53 = -t71 * mrSges(6,1) + mrSges(6,2) * t68;
t89 = t53 - mrSges(5,1);
t88 = t68 ^ 2 + t71 ^ 2;
t87 = t75 ^ 2 + t103;
...
t2 = t3 * t74 + t4 * t76;
t1 = t3 * t76 - t4 * t74;
t15 = [0.2e1 * t62 * t81 + Ifges(4,2) * t103 + t39 * t100 + t28 * t101 + 0.2e1 * t8 * t29 + 0.2e1 * t7 * t30 - t21 * t5 + t22 * t6 + 0.2e1 * t2 * t10 + 0.2e1 * t1 * t11 + 0.2e1 * t12 * t9 + Ifges(2,3) + Ifges(3,3) + (mrSges(5,1) * t100 - 0.2e1 * t27 * mrSges(5,3) + (Ifges(6,3) + Ifges(5,2)) * t46 + t85) * t46 + (mrSges(5,3) * t101 + Ifges(5,1) * t49 - t68 * t13 + t71 * t14 + (Ifges(6,5) * t71 - Ifges(6,6) * t68 - (2 * Ifges(5,4))) * t46) * t49 + m(4) * (t60 ^ 2 * t87 + t62 ^ 2) + m(5) * (t27 ^ 2 + t52 ^ 2 + t102) + m(6) * (t7 ^ 2 + t8 ^ 2 + t102) + m(7) * (t1 ^ 2 + t12 ^ 2 + t2 ^ 2) + m(3) * (t70 ^ 2 + t73 ^ 2) * pkin(1) ^ 2 + (Ifges(4,1) * t75 + 0.2e1 * Ifges(4,4) * t77) * t75 + 0.2e1 * (mrSges(3,1) * t73 - mrSges(3,2) * t70) * pkin(1) + 0.2e1 * t87 * t60 * mrSges(4,3); t22 * t10 - t21 * t11 + t80 * t49 + t96 * t46 + m(6) * (t49 * t82 + t93) + m(7) * (-t1 * t21 + t12 * t46 + t2 * t22) + m(5) * (t27 * t49 + t93); m(3) + m(6) * (t45 * t88 + t44) + m(7) * (t21 ^ 2 + t22 ^ 2 + t44) + m(5) * (t45 + t44) + m(4) * t87; m(7) * (t1 * t23 + t12 * t51 + t2 * t24) + (-mrSges(4,1) * t75 - mrSges(4,2) * t77) * t60 + (Ifges(5,5) + t55 * t98 - t68 * t54 / 0.2e1) * t49 + (-t1 * t50 + t2 * t48) * mrSges(7,3) + t89 * t25 + t80 * t58 + t82 * mrSges(6,3) + m(6) * (t25 * t61 + t58 * t82) + (m(5) * (-t25 * t72 + t27 * t69) + (-t46 * t69 - t49 * t72) * mrSges(5,3)) * pkin(3) + (Ifges(6,5) * t68 + Ifges(6,6) * t71 + t90) * t46 / 0.2e1 + Ifges(4,5) * t75 + Ifges(4,6) * t77 + t68 * t14 / 0.2e1 + t51 * t9 + t61 * t28 - Ifges(5,6) * t46 + t48 * t5 / 0.2e1 + t50 * t6 / 0.2e1 + t24 * t10 - t27 * mrSges(5,2) + t12 * t31 - t21 * t32 / 0.2e1 + t22 * t33 / 0.2e1 + t23 * t11 + t13 * t98; -t39 + (t21 * t50 + t22 * t48) * mrSges(7,3) + t88 * t49 * mrSges(6,3) + (t31 + t89) * t46 + m(6) * (t46 * t61 + t49 * t84) + m(7) * (-t21 * t23 + t22 * t24 + t46 * t51) + m(5) * (-t46 * t72 + t49 * t69) * pkin(3) - t81; 0.2e1 * t51 * t31 + t48 * t32 + t50 * t33 + 0.2e1 * t61 * t53 + t71 * t54 + t68 * t55 + Ifges(4,3) + Ifges(5,3) + m(7) * (t23 ^ 2 + t24 ^ 2 + t51 ^ 2) + m(6) * (t58 ^ 2 * t88 + t61 ^ 2) + m(5) * (t69 ^ 2 + t72 ^ 2) * pkin(3) ^ 2 + 0.2e1 * (mrSges(5,1) * t72 - mrSges(5,2) * t69) * pkin(3) + 0.2e1 * (-t23 * t50 + t24 * t48) * mrSges(7,3) + 0.2e1 * mrSges(6,3) * t84; t46 * mrSges(5,1) + t50 * t10 + t48 * t11 + t68 * t29 + t71 * t30 + t39 + m(7) * (t1 * t48 + t2 * t50) + m(6) * (t68 * t8 + t7 * t71) + m(5) * t52; m(7) * (-t21 * t48 + t22 * t50); m(7) * (t23 * t48 + t24 * t50); m(5) + m(6) * t88 + m(7) * (t48 ^ 2 + t50 ^ 2); m(6) * t25 + m(7) * t12 + t96; 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * t46; m(6) * t61 + m(7) * t51 + t31 + t53; 0; m(6) + m(7); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t85; -t9; mrSges(7,1) * t23 - mrSges(7,2) * t24 + t90; -t31; 0; Ifges(7,3);];
