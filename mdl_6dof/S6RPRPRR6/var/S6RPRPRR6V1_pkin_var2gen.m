% Umwandlung der Kinematikparameter von S6RPRPRR6V1 zu S6RPRPRR6
% Eingabe:
...
%
% Siehe auch: S6RPRPRR6_structural_kinematic_parameters.m
function pkin_gen = S6RPRPRR6V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
