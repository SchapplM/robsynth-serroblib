...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:19:05
% EndTime: 2018-11-23 16:19:06
...
t1 = [0.2e1 * t34 * t56 + 0.2e1 * t33 * t57 + 0.2e1 * t39 * t29 - t45 * t16 + t46 * t17 + t27 * t9 + 0.2e1 * t28 * t10 + 0.2e1 * t7 * t35 + 0.2e1 * t6 * t36 + t26 * t8 + 0.2e1 * t3 * t13 + 0.2e1 * t2 * t14 + Ifges(3,2) * t102 + (mrSges(4,1) * t140 - 0.2e1 * t64 * mrSges(4,3) + Ifges(4,2) * t81 + (-Ifges(5,6) * t110 - (2 * Ifges(4,4))) * t83 + t117) * t81 + (mrSges(4,3) * t141 + Ifges(4,1) * t83 - t110 * t37 + t113 * t38) * t83 + m(4) * (t64 ^ 2 + t96 ^ 2 + t142) + m(5) * (t33 ^ 2 + t34 ^ 2 + t142) + m(3) * (qJ(2) ^ 2 * t124 + pkin(1) ^ 2) - 0.2e1 * pkin(1) * t121 + m(7) * (t2 ^ 2 + t28 ^ 2 + t3 ^ 2) + m(6) * (t39 ^ 2 + t6 ^ 2 + t7 ^ 2) + 0.2e1 * t124 * qJ(2) * mrSges(3,3) + t73 * t140 + t49 * t141 + Ifges(2,3) + (Ifges(3,1) * t106 + 0.2e1 * Ifges(3,4) * t108) * t106; -m(3) * pkin(1) + t81 * mrSges(4,1) + t110 * t56 + t113 * t57 + t55 * t13 + t54 * t14 + t82 * t35 + t80 * t36 + t73 + m(7) * (t2 * t54 + t3 * t55) + m(6) * (t6 * t80 + t7 * t82) + m(5) * (t110 * t34 + t113 * t33) + m(4) * t96 + t121; m(3) + m(4) + m(5) * t123 + m(6) * (t80 ^ 2 + t82 ^ 2) + m(7) * (t54 ^ 2 + t55 ^ 2); (t131 + t143) * t81 / 0.2e1 + (-t2 * t55 + t3 * t54) * mrSges(7,3) + (-t6 * t82 + t7 * t80) * mrSges(6,3) + t97 * t29 - Ifges(4,6) * t81 + t82 * t17 / 0.2e1 + Ifges(4,5) * t83 + t80 * t16 / 0.2e1 + t46 * t61 / 0.2e1 - t64 * mrSges(4,2) + t65 * t36 + t66 * t35 + t67 * t10 - pkin(3) * t49 + t54 * t8 / 0.2e1 + t55 * t9 / 0.2e1 + t39 * t59 - t45 * t60 / 0.2e1 + t28 * t30 + t26 * t31 / 0.2e1 + t27 * t32 / 0.2e1 + t20 * t14 + t21 * t13 + m(5) * (-pkin(3) * t62 + (-t33 * t110 + t34 * t113) * pkin(8)) + (t90 - mrSges(4,1)) * t62 + (t37 / 0.2e1 + t83 * t93 / 0.2e1 + pkin(8) * t56 + t34 * mrSges(5,3)) * t113 + (t38 / 0.2e1 - t83 * t92 / 0.2e1 - pkin(8) * t57 - t33 * mrSges(5,3)) * t110 + m(6) * (t39 * t97 + t6 * t65 + t66 * t7) + m(7) * (t2 * t20 + t21 * t3 + t28 * t67); m(6) * (t65 * t80 + t66 * t82) + m(7) * (t20 * t54 + t21 * t55); -0.2e1 * pkin(3) * t90 + t110 * t93 + t113 * t92 + 0.2e1 * t67 * t30 + t54 * t31 + t55 * t32 + 0.2e1 * t97 * t59 + t80 * t60 + t82 * t61 + Ifges(4,3) + m(7) * (t20 ^ 2 + t21 ^ 2 + t67 ^ 2) + m(6) * (t65 ^ 2 + t66 ^ 2 + t97 ^ 2) + m(5) * (pkin(8) ^ 2 * t123 + pkin(3) ^ 2) + 0.2e1 * (-t20 * t55 + t21 * t54) * mrSges(7,3) + 0.2e1 * (-t65 * t82 + t66 * t80) * mrSges(6,3) + 0.2e1 * t123 * pkin(8) * mrSges(5,3); (m(6) * (t105 * t7 + t107 * t6) + t107 * t36 + t105 * t35) * pkin(4) - Ifges(5,6) * t127 + t70 * t14 + t71 * t13 + t33 * mrSges(5,1) - t34 * mrSges(5,2) + t6 * mrSges(6,1) - t7 * mrSges(6,2) + t117 + m(7) * (t2 * t70 + t3 * t71) + t144; m(7) * (t54 * t70 + t55 * t71) + (t105 * t82 + t107 * t80) * t145 + t118 - t90; m(7) * (t20 * t70 + t21 * t71) + t65 * mrSges(6,1) - t66 * mrSges(6,2) - t120 * pkin(8) + (t54 * t71 - t55 * t70) * mrSges(7,3) + (m(6) * (t105 * t66 + t107 * t65) + (t105 * t80 - t107 * t82) * mrSges(6,3)) * pkin(4) + t119 + t143; 0.2e1 * t135 - 0.2e1 * t134 + Ifges(7,3) + m(7) * (t70 ^ 2 + t71 ^ 2) + (0.2e1 * mrSges(6,1) * t107 - 0.2e1 * mrSges(6,2) * t105 + (t105 ^ 2 + t107 ^ 2) * t145) * pkin(4) + t146; m(6) * t39 + m(7) * t28 + t10 + t29; 0; m(6) * t97 + m(7) * t67 - t118; 0; m(6) + m(7); t122 + t144; -t30; t119; Ifges(7,3) - t134 + t135; 0; Ifges(7,3);];
