...
function Tc_mdh = S6RRRRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6RRRRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [12x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:40:37
	% EndTime: 2020-11-04 22:40:37
...
elseif link_index == 5
	...
	t1 = [t168 * t172 + t185 * t173, t168 * t173 - t185 * t172, (-t176 * t191 + t188) * t178 - t180 * t195, t162 * t180 + t163 * t183 + 0; -t172 * t167 + t184 * t173, -t173 * t167 - t184 * t172, (t176 * t189 + t190) * t178 + t183 * t195, -t162 * t183 + t163 * t180 + 0; t165 * t173 - t172 * t194, -t165 * t172 - t173 * t194, -t176 * t181 + t179 * t193, t187 * t175 + t186 * t176 + pkin(7) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 6
	% From fkine_6_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:40:38
	% EndTime: 2020-11-04 22:40:38
	% DurationCPUTime: 0.07s
