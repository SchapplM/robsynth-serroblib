...
t198 = t78 ^ 2;
t197 = 0.2e1 * t78;
t99 = pkin(1) * t148 * t151 + pkin(8) * t177;
t87 = pkin(9) * t148 + t99;
...
t2 = -pkin(5) * t62 - t3;
t1 = qJ(6) * t62 + t4;
t6 = [((-0.2e1 * t98 * mrSges(3,3) + Ifges(3,5) * t148 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t151) * t146) * t151 + (0.2e1 * t99 * mrSges(3,3) + Ifges(3,6) * t148 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t151 + (Ifges(3,2) + t190) * t154) * t146 + t162) * t154) * t146 + (t167 - 0.2e1 * t191 + 0.2e1 * t192) * t148 + (-t25 + t201) * t62 + t96 * t55 + t97 * t56 + 0.2e1 * t54 * t81 + 0.2e1 * t53 * t82 + 0.2e1 * t86 * t68 + t63 * t26 + 0.2e1 * t65 * t29 + 0.2e1 * t16 * t51 + 0.2e1 * t15 * t52 + 0.2e1 * t5 * t19 + 0.2e1 * t13 * t20 + 0.2e1 * t1 * t21 + 0.2e1 * t4 * t22 + 0.2e1 * t3 * t23 + 0.2e1 * t2 * t24 + (t11 + t12) * t44 + (t7 - t10) * t43 + m(5) * (t15 ^ 2 + t16 ^ 2 + t65 ^ 2) + m(6) * (t13 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(4) * (t53 ^ 2 + t54 ^ 2 + t86 ^ 2) + m(3) * (pkin(1) ^ 2 * t146 ^ 2 + t98 ^ 2 + t99 ^ 2) + Ifges(2,3); -t191 + t192 + t167 + t168 * t44 + t169 * t43 + (t26 / 0.2e1 - t15 * mrSges(5,3) + t170 * t152 + t171 * t149) * t107 + t86 * t111 + t96 * t117 / 0.2e1 + t97 * t120 / 0.2e1 + t134 * t29 + t80 * t51 + t5 * t66 + t13 * t67 - pkin(2) * t68 + t4 * t70 + t3 * t71 + t2 * t72 + t1 * t73 + t65 * t74 + t63 * t76 / 0.2e1 + t37 * t19 + t27 * t21 + t28 * t24 + t32 * t23 + t33 * t22 - t199 * t177 / 0.2e1 + (-t75 / 0.2e1 + t46 / 0.2e1 + t47 / 0.2e1) * t62 + m(4) * (-pkin(2) * t86 + (-t150 * t53 + t153 * t54) * pkin(9)) + (t8 / 0.2e1 + t9 / 0.2e1 - t25 / 0.2e1 - t16 * mrSges(5,3)) * t106 + (-t52 + t20) * t78 + (t55 / 0.2e1 + t54 * mrSges(4,3) + pkin(9) * t81) * t153 + (t56 / 0.2e1 - t53 * mrSges(4,3) - pkin(9) * t82) * t150 + m(7) * (t1 * t27 + t2 * t28 + t37 * t5) + m(6) * (t13 * t78 + t3 * t32 + t33 * t4) + m(5) * (t134 * t65 - t15 * t78 + t16 * t80); -0.2e1 * pkin(2) * t111 + t153 * t117 + t150 * t120 + 0.2e1 * t134 * t74 + 0.2e1 * t27 * t73 + 0.2e1 * t28 * t72 + 0.2e1 * t32 * t71 + 0.2e1 * t33 * t70 + 0.2e1 * t37 * t66 + t67 * t197 + Ifges(3,3) + 0.2e1 * t172 * pkin(9) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t80 + t200 - t75) * t106 + m(7) * (t27 ^ 2 + t28 ^ 2 + t37 ^ 2) + m(6) * (t32 ^ 2 + t33 ^ 2 + t198) + m(5) * (t134 ^ 2 + t80 ^ 2 + t198) + m(4) * (pkin(9) ^ 2 * t172 + pkin(2) ^ 2) + (mrSges(5,3) * t197 + t76 + (t49 + t50) * t152 + (t45 - t48) * t149) * t107; -t162 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) - t132 * t187 + t170) * t149 + (t1 * mrSges(7,2) + t4 * mrSges(6,3) + t132 * t188 - t171) * t152 + t13 * t110 + t133 * t20 + t5 * t109 + t105 * t19 + t53 * mrSges(4,1) - t54 * mrSges(4,2) + t15 * mrSges(5,1) - t16 * mrSges(5,2) + (t145 * t51 + t147 * t52 + m(5) * (t145 * t16 + t147 * t15)) * pkin(3) - t190 * t177 + t165 * t62 + m(6) * (t13 * t133 + (-t149 * t3 + t152 * t4) * t132) + t164 * t44 + m(7) * (t105 * t5 + (t1 * t152 + t149 * t2) * t132) + t166 * t43; -t80 * mrSges(5,2) + t105 * t66 + t37 * t109 + t133 * t67 + (t110 - mrSges(5,1)) * t78 + (-mrSges(4,1) * t150 - mrSges(4,2) * t153) * pkin(9) + (-mrSges(5,3) * t194 + t165) * t106 + (t27 * mrSges(7,2) + t33 * mrSges(6,3) + t132 * t186 - t169) * t152 + (t28 * mrSges(7,2) - t32 * mrSges(6,3) - t132 * t185 + t168) * t149 + m(7) * (t105 * t37 + (t149 * t28 + t152 * t27) * t132) + m(6) * (t133 * t78 + (-t149 * t32 + t152 * t33) * t132) + (t145 * t80 - t147 * t78) * t202 + (-mrSges(5,3) * t193 + t149 * t166 + t152 * t164) * t107 + t199; 0.2e1 * t105 * t109 + 0.2e1 * t133 * t110 + (-t113 + t116) * t152 + (t119 + t118) * t149 + m(6) * (t133 ^ 2 + t175) + m(7) * (t105 ^ 2 + t175) + t190 + (mrSges(7,2) + mrSges(6,3)) * t132 * t203 + (0.2e1 * mrSges(5,1) * t147 - 0.2e1 * mrSges(5,2) * t145 + (t145 ^ 2 + t147 ^ 2) * t202) * pkin(3); t187 * t152 + t188 * t149 + m(7) * (t1 * t149 - t152 * t2) + m(6) * (t149 * t4 + t152 * t3) + m(5) * t65 + t29; t185 * t152 + t186 * t149 + m(7) * (t149 * t27 - t152 * t28) + m(6) * (t149 * t33 + t152 * t32) + m(5) * t134 + t74; 0; m(5) + (m(6) / 0.2e1 + m(7) / 0.2e1) * t203; -t4 * mrSges(6,2) - pkin(5) * t24 + t1 * mrSges(7,3) + qJ(6) * t21 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) - t2 * mrSges(7,1) + t3 * mrSges(6,1) + t201; -pkin(5) * t72 + m(7) * (-pkin(5) * t28 + qJ(6) * t27) + qJ(6) * t73 + t27 * mrSges(7,3) - t33 * mrSges(6,2) - t28 * mrSges(7,1) + t32 * mrSges(6,1) + t200; -t157 * mrSges(7,2) + (-m(7) * t157 - t159 - t160) * t132 + t115 + t114; m(7) * t158 - t109 - t110; Ifges(7,2) + Ifges(6,3) + 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2); m(7) * t2 + t24; m(7) * t28 + t72; (m(7) * t132 + mrSges(7,2)) * t149; -m(7) * t152; -m(7) * pkin(5) - mrSges(7,1); m(7);];
