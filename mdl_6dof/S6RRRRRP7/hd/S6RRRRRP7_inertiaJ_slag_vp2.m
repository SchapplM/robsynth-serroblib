...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:30:51
% EndTime: 2018-11-23 18:30:54
...
t250 = t109 ^ 2;
t249 = 0.2e1 * t109;
t146 = -t190 * mrSges(7,1) + t186 * mrSges(7,2);
t248 = 0.2e1 * t146;
t242 = t186 / 0.2e1;
t241 = t190 / 0.2e1;
t239 = pkin(1) * t193;
...
t29 = -t63 * mrSges(7,1) + t64 * mrSges(7,2);
...
t206 = -t5 * mrSges(6,3) - t1 * mrSges(7,3);
t15 = pkin(4) * t220 - t24;
t31 = pkin(5) * t141 - t142 * t172 + t46;
t205 = -t46 * mrSges(6,3) - t31 * mrSges(7,3);
t204 = -t186 * t5 + t236;
t203 = t254 * t186 + t255 * t190 + Ifges(5,3);
...
t2 = [((-0.2e1 * t129 * mrSges(3,3) + Ifges(3,5) * t185 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t189) * t184) * t189 + (0.2e1 * t130 * mrSges(3,3) + Ifges(3,6) * t185 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t189 + (Ifges(3,2) + t235) * t193) * t184 + t234 + t251) * t193) * t184 + (t211 - 0.2e1 * t228 + 0.2e1 * t229) * t185 + t258 * t64 + t259 * t63 + m(6) * (t15 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t3 ^ 2 + t8 ^ 2) + m(5) * (t24 ^ 2 + t25 ^ 2 + t88 ^ 2) + m(4) * (t117 ^ 2 + t75 ^ 2 + t76 ^ 2) + m(3) * (pkin(1) ^ 2 * t184 ^ 2 + t129 ^ 2 + t130 ^ 2) + (-t36 + t252) * t84 + Ifges(2,3) + 0.2e1 * t8 * t29 + 0.2e1 * t15 * t30 + 0.2e1 * t3 * t32 + 0.2e1 * t6 * t33 + 0.2e1 * t1 * t34 + 0.2e1 * t5 * t35 + 0.2e1 * t25 * t73 + 0.2e1 * t24 * t74 + t85 * t37 + 0.2e1 * t88 * t40 + 0.2e1 * t76 * t107 + 0.2e1 * t75 * t108 + 0.2e1 * t117 * t89 + t127 * t77 + t128 * t78; -t228 + t229 + t211 + (-t25 * mrSges(5,3) + t17 / 0.2e1 + t18 / 0.2e1 - t36 / 0.2e1) * t141 + (-t24 * mrSges(5,3) + t37 / 0.2e1 + (t21 / 0.2e1 + t22 / 0.2e1) * t190 + (-t19 / 0.2e1 - t20 / 0.2e1) * t186) * t142 + m(4) * (-pkin(2) * t117 + (-t75 * t188 + t76 * t192) * pkin(9)) - (t216 + t217) * t220 / 0.2e1 + (t77 / 0.2e1 + t76 * mrSges(4,3) + pkin(9) * t107) * t192 + (t78 / 0.2e1 - t75 * mrSges(4,3) - pkin(9) * t108) * t188 + (t30 - t74) * t109 + t117 * t148 + t127 * t154 / 0.2e1 + t128 * t157 / 0.2e1 + t170 * t40 + t31 * t34 + t39 * t32 + t46 * t35 + t47 * t33 + t79 * t29 - pkin(2) * t89 + t8 * t91 + t15 * t92 + t3 * t94 + t6 * t95 + t1 * t96 + t5 * t97 + t88 * t98 + t85 * t100 / 0.2e1 + t111 * t73 + (t69 / 0.2e1 + t70 / 0.2e1) * t63 + (t71 / 0.2e1 + t72 / 0.2e1) * t64 + (t67 / 0.2e1 + t68 / 0.2e1 - t99 / 0.2e1) * t84 + m(7) * (t1 * t31 + t3 * t39 + t79 * t8) + m(6) * (t109 * t15 + t46 * t5 + t47 * t6) + m(5) * (-t109 * t24 + t111 * t25 + t170 * t88); -0.2e1 * pkin(2) * t148 + t92 * t249 + t192 * t154 + t188 * t157 + 0.2e1 * t170 * t98 + 0.2e1 * t31 * t96 + 0.2e1 * t39 * t94 + 0.2e1 * t46 * t97 + 0.2e1 * t47 * t95 + 0.2e1 * t79 * t91 + Ifges(3,3) + 0.2e1 * t214 * pkin(9) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t111 + t67 + t68 - t99) * t141 + m(7) * (t31 ^ 2 + t39 ^ 2 + t79 ^ 2) + m(6) * (t46 ^ 2 + t47 ^ 2 + t250) + m(5) * (t111 ^ 2 + t170 ^ 2 + t250) + m(4) * (t214 * pkin(9) ^ 2 + pkin(2) ^ 2) + (mrSges(5,3) * t249 - t257 * t186 + t256 * t190 + t100) * t142; t198 - t235 * t220 + (t187 * t73 + t191 * t74 + m(5) * (t187 * t25 + t191 * t24)) * pkin(3) + (-t167 * t35 + t206) * t186 + m(6) * (t15 * t168 + t204 * t167) + m(7) * (t1 * t131 + t132 * t3 + t144 * t8) + t168 * t30 + t33 * t222 + t75 * mrSges(4,1) - t76 * mrSges(4,2) + t131 * t34 + t132 * t32 + t144 * t29 - t251; t197 + (-mrSges(4,1) * t188 - mrSges(4,2) * t192) * pkin(9) + (m(5) * (-t109 * t191 + t111 * t187) + (-t141 * t187 - t142 * t191) * mrSges(5,3)) * pkin(3) + m(6) * (t109 * t168 + t201 * t167) + (-t167 * t97 + t205) * t186 + m(7) * (t131 * t31 + t132 * t39 + t144 * t79) + t168 * t92 + t95 * t222 + t131 * t96 + t132 * t94 + t144 * t91 + t216; t144 * t248 + 0.2e1 * t168 * t147 + Ifges(4,3) + 0.2e1 * t199 + (-t131 * t186 + t132 * t190) * t213 + t167 * t200 + m(7) * (t131 ^ 2 + t132 ^ 2 + t144 ^ 2) + m(6) * (t215 * t167 ^ 2 + t168 ^ 2) + m(5) * (t187 ^ 2 + t191 ^ 2) * pkin(3) ^ 2 + t203; t198 + (-pkin(11) * t35 + t206) * t186 + m(7) * (t1 * t145 + t149 * t3 + t169 * t8) + m(6) * (-pkin(4) * t15 + t204 * pkin(11)) + t145 * t34 + t149 * t32 + t169 * t29 + t33 * t237 - Ifges(5,3) * t220 - pkin(4) * t30; t197 + (-pkin(11) * t97 + t205) * t186 + m(7) * (t145 * t31 + t149 * t39 + t169 * t79) + m(6) * (-pkin(4) * t109 + t201 * pkin(11)) + t145 * t96 + t149 * t94 + t169 * t91 + t95 * t237 - pkin(4) * t92; (t168 - pkin(4)) * t147 + (t144 + t169) * t146 + t199 + m(7) * (t131 * t145 + t132 * t149 + t144 * t169) + m(6) * (-pkin(4) * t168 + pkin(11) * t208) + ((t132 + t149) * t190 + (-t131 - t145) * t186) * mrSges(7,3) + (t215 * pkin(11) + t208) * mrSges(6,3) + t203; -0.2e1 * pkin(4) * t147 + t169 * t248 + (-t145 * t186 + t149 * t190) * t213 + pkin(11) * t200 + m(7) * (t145 ^ 2 + t149 ^ 2 + t169 ^ 2) + m(6) * (t215 * pkin(11) ^ 2 + pkin(4) ^ 2) + t203; mrSges(6,1) * t5 + mrSges(7,1) * t1 - mrSges(6,2) * t6 - mrSges(7,2) * t3 + (m(7) * t1 + t34) * pkin(5) + t252; mrSges(6,1) * t46 + mrSges(7,1) * t31 - mrSges(6,2) * t47 - mrSges(7,2) * t39 + (-Ifges(6,6) - Ifges(7,6)) * t224 + (m(7) * t31 + t96) * pkin(5) + t218 + t219; mrSges(7,1) * t131 - mrSges(7,2) * t132 - t202 * t167 + (m(7) * t131 - t227) * pkin(5) + t207; mrSges(7,1) * t145 - mrSges(7,2) * t149 - t202 * pkin(11) + (m(7) * t145 - t227) * pkin(5) + t207; Ifges(6,3) + Ifges(7,3) + (m(7) * pkin(5) + 0.2e1 * mrSges(7,1)) * pkin(5); m(7) * t8 + t29; m(7) * t79 + t91; m(7) * t144 + t146; m(7) * t169 + t146; 0; m(7);];
