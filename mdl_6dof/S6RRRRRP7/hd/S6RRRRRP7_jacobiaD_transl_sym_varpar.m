...
function JaD_transl = S6RRRRRP7_jacobiaD_transl_sym_varpar(qJ, qJD, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRRP7_jacobiaD_transl_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRRRP7_jacobiaD_transl_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S6RRRRRP7_jacobiaD_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRRRP7_jacobiaD_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRRRRP7_jacobiaD_transl_sym_varpar: pkin has to be [11x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	% OptimizationMode: 2
	% StartTime: 2019-10-10 13:05:49
	% EndTime: 2019-10-10 13:05:50
...
elseif link_index == 6
	...
	t444 = sin(qJ(5));
	t448 = cos(qJ(5));
	t506 = pkin(5) + r_i_i_C(1);
	t466 = t448 * r_i_i_C(2) + t506 * t444;
	t459 = t466 * qJD(5);
	t436 = t448 * pkin(5) + pkin(4);
	t504 = t444 * r_i_i_C(2);
	t468 = t448 * r_i_i_C(1) + t436 - t504;
	t501 = r_i_i_C(3) + qJ(6) + pkin(11);
	t452 = -(t501 * t440 - t459) * t439 + qJD(3) * t445 * pkin(3) + (t468 * t440 - qJD(6)) * t438;
	t451 = -pkin(10) - pkin(9);
	t514 = t451 - t466;
	t446 = sin(qJ(2));
	t447 = sin(qJ(1));
	...
	t492 = t446 * t447;
	t422 = -t469 + t492;
	t512 = t416 * t444 - t422 * t448;
	t511 = t416 * t448 + t422 * t444;
	t479 = t447 * t500;
	t475 = t446 * t479;
	t480 = t505 * qJD(1);
	t491 = qJD(2) * t446;
	t414 = -qJD(1) * t475 - t447 * t491 + (qJD(2) * t474 + t480) * t450;
	t477 = t439 * t485;
	t495 = t442 * t447;
	t483 = qJD(1) * t495;
	t402 = (-t423 * t440 + t483) * t438 + t414 * t439 - t440 * t477;
	t449 = cos(qJ(3));
	t437 = pkin(3) * t449 + pkin(2);
	t507 = t501 * t438 + t468 * t439 + t437;
	t497 = t439 * t440;
	t496 = t442 * t446;
	t494 = t442 * t449;
	t493 = t442 * t450;
	...
	t481 = qJD(2) * t493;
	t476 = t442 * t480;
	t424 = t505 * t446 + t450 * t479;
	t412 = t423 * qJD(1) + t424 * qJD(2);
	t473 = t440 * t495 - t412;
	t413 = t424 * qJD(1) + t423 * qJD(2);
	t472 = -t402 * t444 + t413 * t448;
	t421 = t500 * t438 + t486;
	t465 = -t421 * t448 + t444 * t493;
	t461 = t423 * t438 + t477;
	t458 = t500 * t440 + t481;
	t410 = t458 * t439 - t440 * t487;
	t460 = -t410 * t444 + t448 * t482;
	t401 = t414 * t438 + t423 * t497 - t440 * t430 - t439 * t483;
	t411 = -qJD(1) * t469 - qJD(2) * t484 + (qJD(2) * t500 + qJD(1)) * t492;
	t425 = t484 - t475;
	t419 = t425 * t439 + t438 * t495;
	t457 = -t411 * t444 + (-t419 * t444 + t424 * t448) * qJD(5);
	t400 = t473 * t439 + (-t425 * t440 + t476) * t438;
	t389 = -t400 * t444 - t411 * t448 + (-t419 * t448 - t424 * t444) * qJD(5);
	t399 = t425 * t497 + t473 * t438 - t439 * t476;
	t418 = -t425 * t438 + t439 * t495;
	t455 = t419 * qJD(6) - t468 * t399 + t501 * t400 - t418 * t459;
	t454 = t416 * qJD(6) - t468 * t401 + t501 * t402 + t459 * t461;
	t409 = t458 * t438 + t440 * t486;
	t453 = t421 * qJD(6) - (t500 * t439 - t487) * t459 + t501 * t410 - t468 * t409;
	t390 = t400 * t448 + t457;
	t1 = [-t461 * qJD(6) - t414 * t437 - t468 * t402 + t514 * t413 - t501 * t401 + (-t505 * pkin(1) - pkin(8) * t495) * qJD(1) + (-t445 * t483 + (t423 * t445 + t449 * t485) * qJD(3)) * pkin(3) + (t511 * r_i_i_C(2) + t506 * t512) * qJD(5), (-t412 * t448 - t425 * t490) * r_i_i_C(2) + t412 * t451 + t507 * t411 + t452 * t424 + t506 * (-t412 * t444 + t425 * t489), (t449 * t476 + t412 * t445 + (-t425 * t449 - t445 * t495) * qJD(3)) * pkin(3) + t455, t455, -r_i_i_C(2) * t390 + t506 * t389, t399; t390 * r_i_i_C(1) + t389 * r_i_i_C(2) - t418 * qJD(6) + t400 * t436 + t411 * t451 - t412 * t437 + t501 * t399 + (-t447 * pkin(1) + pkin(8) * t485) * qJD(1) + t457 * pkin(5) + (t445 * t476 + (-t425 * t445 + t447 * t494) * qJD(3)) * pkin(3), (t414 * t448 - t423 * t490) * r_i_i_C(2) - t414 * t451 - t507 * t413 + t452 * t422 + t506 * (t414 * t444 + t423 * t489), (t449 * t483 - t414 * t445 + (-t423 * t449 + t445 * t485) * qJD(3)) * pkin(3) + t454, t454, t472 * r_i_i_C(1) + (-t402 * t448 - t413 * t444) * r_i_i_C(2) + (-r_i_i_C(1) * t511 + t512 * r_i_i_C(2)) * qJD(5) + (-qJD(5) * t511 + t472) * pkin(5), t401; 0, (((t506 * t448 - t504) * qJD(5) - t507 * qJD(2)) * t446 + (-t514 * qJD(2) - t452) * t450) * t442, (-t445 * t481 + (-t500 * t445 - t446 * t494) * qJD(3)) * pkin(3) + t453, t453, t460 * r_i_i_C(1) + (-t410 * t448 - t444 * t482) * r_i_i_C(2) + (t465 * r_i_i_C(1) + (t421 * t444 + t448 * t493) * r_i_i_C(2)) * qJD(5) + (t465 * qJD(5) + t460) * pkin(5), t409;];
	JaD_transl = t1;
else
	JaD_transl=NaN(3,6);
end