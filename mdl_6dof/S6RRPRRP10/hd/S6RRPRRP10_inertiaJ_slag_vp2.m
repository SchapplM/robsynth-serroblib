...
t2 = -pkin(5) * t62 - t3;
t1 = qJ(6) * t62 + t4;
t6 = [0.2e1 * t89 * t66 + t95 * t55 + t96 * t56 + 0.2e1 * t54 * t81 + 0.2e1 * t53 * t82 + t63 * t26 + 0.2e1 * t65 * t29 + 0.2e1 * t16 * t51 + 0.2e1 * t15 * t52 + 0.2e1 * t4 * t21 + 0.2e1 * t1 * t22 + 0.2e1 * t3 * t23 + 0.2e1 * t2 * t24 + 0.2e1 * t5 * t19 + 0.2e1 * t7 * t20 + (t13 + t14) * t44 + (t9 - t12) * t43 + (-t25 + t192) * t62 + m(3) * (pkin(1) ^ 2 * t141 ^ 2 + t97 ^ 2 + t98 ^ 2) + m(4) * (t53 ^ 2 + t54 ^ 2 + t89 ^ 2) + m(5) * (t15 ^ 2 + t16 ^ 2 + t65 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t7 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + Ifges(2,3) + (t161 - 0.2e1 * t184 + 0.2e1 * t185) * t143 + ((-0.2e1 * t97 * mrSges(3,3) + Ifges(3,5) * t143 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t146) * t141) * t146 + (0.2e1 * t98 * mrSges(3,3) - Ifges(4,5) * t96 + Ifges(3,6) * t143 - Ifges(4,6) * t95 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t146 + (Ifges(4,3) + Ifges(5,3) + Ifges(3,2)) * t148) * t141 + t180) * t148) * t141; t151 * mrSges(4,3) + m(4) * (-pkin(2) * t89 + qJ(3) * t151) + t185 - t184 + (t20 - t52) * t78 + m(5) * (t128 * t65 - t15 * t78 + t16 * t80) + m(6) * (t3 * t32 + t33 * t4 + t7 * t78) + m(7) * (t1 * t27 + t2 * t28 + t37 * t5) + (-t76 / 0.2e1 + t46 / 0.2e1 + t47 / 0.2e1) * t62 + t89 * t108 + t95 * t110 / 0.2e1 + t96 * t111 / 0.2e1 + t128 * t29 + t65 * t75 + t63 * t77 / 0.2e1 + t80 * t51 - pkin(2) * t66 + t5 * t67 + t7 * t68 + t4 * t70 + t3 * t71 + t2 * t72 + t1 * t73 + t32 * t23 + t33 * t21 + t37 * t19 + t27 * t22 + t28 * t24 + (-t140 * t82 + t142 * t81) * qJ(3) + (t10 / 0.2e1 + t11 / 0.2e1 - t25 / 0.2e1 - t16 * mrSges(5,3)) * t105 - (Ifges(4,5) * t140 + Ifges(4,6) * t142 + t169) * t170 / 0.2e1 + t161 + t140 * t56 / 0.2e1 + t142 * t55 / 0.2e1 + (t26 / 0.2e1 - t15 * mrSges(5,3) + t164 * t147 + t165 * t144) * t106 + t162 * t44 + t163 * t43; -0.2e1 * pkin(2) * t108 + t142 * t110 + t140 * t111 + 0.2e1 * t128 * t75 + 0.2e1 * t27 * t73 + 0.2e1 * t28 * t72 + 0.2e1 * t32 * t71 + 0.2e1 * t33 * t70 + 0.2e1 * t37 * t67 + t68 * t189 + Ifges(3,3) + 0.2e1 * t167 * qJ(3) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t80 + t191 - t76) * t105 + m(5) * (t128 ^ 2 + t80 ^ 2 + t190) + m(6) * (t32 ^ 2 + t33 ^ 2 + t190) + m(7) * (t27 ^ 2 + t28 ^ 2 + t37 ^ 2) + m(4) * (t167 * qJ(3) ^ 2 + pkin(2) ^ 2) + (mrSges(5,3) * t189 + t77 + (t49 + t50) * t147 + (t45 - t48) * t144) * t106; t181 * t147 + t182 * t144 + m(7) * (t1 * t144 - t147 * t2) + m(6) * (t144 * t4 + t147 * t3) + m(5) * t65 + m(4) * t89 + t29 + t66; -m(4) * pkin(2) + t178 * t147 + t179 * t144 + m(7) * (t144 * t27 - t147 * t28) + m(6) * (t144 * t33 + t147 * t32) + m(5) * t128 + t108 + t75; m(4) + m(5) + (m(6) / 0.2e1 + m(7) / 0.2e1) * t193; -Ifges(5,3) * t170 + t15 * mrSges(5,1) - t16 * mrSges(5,2) - pkin(4) * t20 + t107 * t19 + t5 * t112 + t7 * t113 + t159 * t62 + t158 * t44 + t160 * t43 + (t1 * mrSges(7,2) + t4 * mrSges(6,3) + t182 * pkin(10) - t165) * t147 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) - t181 * pkin(10) + t164) * t144 + m(7) * (t107 * t5 + (t1 * t147 + t144 * t2) * pkin(10)) + m(6) * (-pkin(4) * t7 + (-t144 * t3 + t147 * t4) * pkin(10)) - t180; -t80 * mrSges(5,2) - pkin(4) * t68 + t107 * t67 + t37 * t112 + (t113 - mrSges(5,1)) * t78 + t159 * t105 + (t27 * mrSges(7,2) + t33 * mrSges(6,3) + t179 * pkin(10) - t163) * t147 + (t28 * mrSges(7,2) - t32 * mrSges(6,3) - t178 * pkin(10) + t162) * t144 + m(7) * (t107 * t37 + (t144 * t28 + t147 * t27) * pkin(10)) + m(6) * (-pkin(4) * t78 + (-t144 * t32 + t147 * t33) * pkin(10)) + (t144 * t160 + t147 * t158) * t106 + t169; 0; -0.2e1 * pkin(4) * t113 + 0.2e1 * t107 * t112 + Ifges(5,3) + (t117 - t114) * t147 + (t118 + t119) * t144 + m(7) * (t107 ^ 2 + t168) + m(6) * (pkin(4) ^ 2 + t168) + (mrSges(7,2) + mrSges(6,3)) * pkin(10) * t193; -pkin(5) * t24 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + qJ(6) * t22 + t1 * mrSges(7,3) - t2 * mrSges(7,1) - t4 * mrSges(6,2) + t3 * mrSges(6,1) + t192; -pkin(5) * t72 + m(7) * (-pkin(5) * t28 + qJ(6) * t27) + qJ(6) * t73 + t27 * mrSges(7,3) - t33 * mrSges(6,2) + t32 * mrSges(6,1) - t28 * mrSges(7,1) + t191; m(7) * t153 - t112 - t113; -t152 * mrSges(7,2) + (-m(7) * t152 - t154 - t155) * pkin(10) + t116 + t115; Ifges(7,2) + Ifges(6,3) + 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2); m(7) * t2 + t24; m(7) * t28 + t72; -m(7) * t147; (m(7) * pkin(10) + mrSges(7,2)) * t144; -m(7) * pkin(5) - mrSges(7,1); m(7);];
