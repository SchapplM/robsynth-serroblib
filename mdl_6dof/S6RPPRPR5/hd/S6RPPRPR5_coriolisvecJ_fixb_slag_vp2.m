...
% OptimizationMode: 2
% StartTime: 2019-03-09 01:48:42
% EndTime: 2019-03-09 01:48:46
...
t10 = [((t142 * t123 - t150 - t201 / 0.2e1) * t147 + (t244 + (t203 + t245) * t142 + t237) * t145) * qJD(4) + m(4) * (qJD(2) * t136 + t185) + m(6) * (-t186 * t95 + t29 * t69 + t30 * t70 + t38 * t44 + t39 * t45 - t176) + qJD(3) * t116 + t109 * t9 + t69 * t94 + t70 * t93 + t45 * t77 + t44 * t78 + t79 * t18 + t57 * (-mrSges(7,1) * t43 + mrSges(7,2) * t41) + t43 * t13 / 0.2e1 + t3 * t36 + t4 * t37 + t41 * t14 / 0.2e1 + t15 * t19 + t16 * t20 + (-t140 * t64 / 0.2e1 + t65 * t221 - t142 * t82 + (mrSges(5,3) - t165) * t85 - t203 * qJD(2) + t161 * mrSges(6,3)) * t147 + (((2 * mrSges(4,3)) + t166) * qJD(3) + 0.2e1 * t168 * qJD(2) + m(5) * t184 + m(4) * (qJ(2) * qJD(2) + t184) + ((t143 * mrSges(5,1) + Ifges(7,5) * t228 + Ifges(7,6) * t229 + (-0.3e1 / 0.2e1 * Ifges(5,4) + t156) * t147) * t147 + (-t143 * mrSges(5,2) + (0.3e1 / 0.2e1 * Ifges(5,4) - 0.3e1 / 0.2e1 * t211 + 0.3e1 / 0.2e1 * t209) * t145 + (0.3e1 / 0.2e1 * Ifges(5,2) + 0.3e1 / 0.2e1 * Ifges(6,3) - 0.3e1 / 0.2e1 * Ifges(5,1) + Ifges(7,3) / 0.2e1 - Ifges(6,1) * t141 ^ 2 / 0.2e1 + (t212 - t210 / 0.2e1) * t140) * t147) * t145) * qJD(4)) * qJD(1) + t61 * (mrSges(7,1) * t89 - mrSges(7,2) * t91) + (-t1 * t89 + t2 * t91 - t7 * t41 + t8 * t43) * mrSges(7,3) + (-Ifges(7,4) * t91 - Ifges(7,2) * t89) * t234 + (-Ifges(7,1) * t91 - Ifges(7,4) * t89) * t235 + (-t30 * mrSges(6,2) + t29 * mrSges(6,1) + t130 / 0.2e1 + qJD(2) * t123 - t86 * mrSges(5,3) + t238) * t145 + m(5) * (qJD(2) * t236 + t192 * t86 - t176 + t185) + m(7) * (t1 * t16 + t109 * t61 + t15 * t2 + t3 * t8 + t4 * t7 + t57 * t79) + (Ifges(7,5) * t41 + Ifges(7,6) * t43) * t224 + t6 * t228 + t5 * t229 + (Ifges(7,1) * t41 + Ifges(7,4) * t43) * t230 + (Ifges(7,4) * t41 + Ifges(7,2) * t43) * t232; t112 * t19 - t113 * t20 - t140 * t93 - t141 * t94 + t204 * t37 + t214 * t36 - t168 * t148 - m(7) * (-t7 * t80 + t8 * t81) + m(6) * t161 + m(7) * (-t1 * t113 + t112 * t2 + t239 * t7 + t247 * t8) + ((-t136 - qJD(3)) * m(4) + (-t157 + t199) * t145 - m(6) * (t194 * t39 - t196 * t38) + (m(7) * t57 + t177 - t200 + t245) * t147 + (-qJD(3) - t236) * m(5)) * qJD(1); -t148 * mrSges(4,3) - t88 * t19 - t90 * t20 + t241 * t37 + t240 * t36 + t220 * t147 + (-t140 * t94 + t141 * t93) * t145 + (t177 * t145 + t157 * t147) * qJD(4) + m(6) * (-t205 + t160 * t145 + (t145 * t95 + t147 * t158) * qJD(4)) + m(5) * (t86 * t145 - t205) + (-m(6) * t159 - t141 * t78 - t140 * t77 - t116 - m(5) * t127 + (-t127 + qJD(2)) * m(4)) * qJD(1) + (-t1 * t90 - t147 * t61 + t57 * t183 - t2 * t88 + t240 * t8 + t241 * t7) * m(7); (-t1 * t112 - t113 * t2 - t204 * t8 + t214 * t7) * mrSges(7,3) + (mrSges(7,1) * t204 - mrSges(7,2) * t214) * t57 + (-pkin(4) * t85 + qJ(5) * t160 + qJD(5) * t158 - t117 * t95 - t38 * t58 - t39 * t59) * m(6) + t133 * t9 + t61 * (mrSges(7,1) * t112 + mrSges(7,2) * t113) - t85 * mrSges(5,1) - t86 * mrSges(5,2) - t59 * t77 - t58 * t78 - pkin(4) * t82 - t83 * t18 + t66 * t19 + t67 * t20 + (-t247 / 0.2e1 + t81 / 0.2e1) * t14 + (-Ifges(7,5) * t247 - Ifges(7,6) * t239) * t224 + (-Ifges(7,1) * t247 - Ifges(7,4) * t239) * t230 + (-Ifges(7,4) * t247 - Ifges(7,2) * t239) * t232 + t242 * t37 + (t1 * t67 + t133 * t61 + t2 * t66 + t242 * t7 + t243 * t8 - t57 * t83) * m(7) + t243 * t36 + (-t147 * t123 - t145 * t203) * t126 + (-t85 * mrSges(6,1) + t64 / 0.2e1 + qJ(5) * t93 + qJD(5) * t77 + t30 * mrSges(6,3)) * t141 + ((Ifges(5,4) * t189 / 0.2e1 + t150) * t147 + ((-Ifges(5,4) / 0.2e1 + t156) * t190 + (t246 - Ifges(5,2) / 0.2e1 + Ifges(5,1) / 0.2e1) * t189 - t237) * t145 + ((Ifges(6,5) * t223 + Ifges(6,6) * t221 + Ifges(7,5) * t226 + Ifges(7,6) * t227 - Ifges(5,6) / 0.2e1) * t147 + (t249 + (Ifges(6,2) * t141 + t213) * t223 + (Ifges(6,1) * t140 + t212) * t222) * t145) * qJD(4)) * qJD(1) + (t65 / 0.2e1 + t85 * mrSges(6,2) - qJ(5) * t94 - qJD(5) * t78 - t29 * mrSges(6,3)) * t140 + (-t239 / 0.2e1 - t80 / 0.2e1) * t13 + (-Ifges(7,5) * t81 + Ifges(7,6) * t80) * t225 + t6 * t226 + t5 * t227 + (-Ifges(7,1) * t81 + Ifges(7,4) * t80) * t231 + (-Ifges(7,4) * t81 + Ifges(7,2) * t80) * t233 + (Ifges(7,4) * t113 - Ifges(7,2) * t112) * t234 + (Ifges(7,1) * t113 - Ifges(7,4) * t112) * t235; -t110 * t77 + t111 * t78 - t170 * t36 + t55 * t37 - t220 + (-t170 * t8 + t55 * t7 + t61) * m(7) + (-t110 * t39 + t111 * t38 + t85) * m(6); t130 - t57 * (mrSges(7,1) * t55 + mrSges(7,2) * t170) + (Ifges(7,1) * t170 - t219) * t231 + t13 * t230 + (Ifges(7,5) * t170 - Ifges(7,6) * t55) * t225 - t7 * t36 + t8 * t37 + (t170 * t7 + t55 * t8) * mrSges(7,3) + (-Ifges(7,2) * t55 + t14 + t51) * t233 + t238;];
tauc  = t10(:);
