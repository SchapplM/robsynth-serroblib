...
t179 = -t50 * qJD(1) - t97 * qJD(6) - t82 * t119;
t130 = qJD(5) * t86;
t120 = t85 * t130;
t178 = -t97 * qJD(1) - t50 * qJD(6) + t81 * t120;
t48 = -t81 * t141 - t82 * t87;
t51 = t82 * t140 + t81 * t85;
t177 = -t48 * qJD(1) - t51 * qJD(6) + t82 * t120;
t176 = t51 * qJD(1) + t48 * qJD(6) - t81 * t119;
t36 = t71 * t82 - t81 * t72;
...
t90 = -t108 * mrSges(7,3) + t21 * t161 + t74 * (-t153 + t154) / 0.2e1 + t60 * t103 / 0.2e1 + t105 * t164 + t16 * t106 + t20 * t162;
...
t4 = t110 * t87 + t95 * t85;
t3 = t110 * t85 - t95 * t87;
t19 = [t58 * mrSges(5,1) - t59 * mrSges(5,2) + t14 * t24 + t15 * t25 + t3 * t40 + t4 * t41 + t55 * t54 - t67 * t62 + (t67 * mrSges(5,1) - t68 * mrSges(5,2) + 0.2e1 * qJD(3) * mrSges(4,3) + 0.2e1 * qJD(2) * t113) * qJD(1) + m(5) * (t58 * t114 + t59 * t137 + t36 * t67 + t37 * t68) + m(4) * (qJD(2) * t79 - qJD(3) * t72 + (qJ(2) * qJD(2) - qJD(3) * t84) * qJD(1)) + m(7) * (t1 * t15 + t14 * t2 + t3 * t6 + t4 * t5) + m(6) * (-t31 * t67 - t55 * t58) + (t58 * mrSges(6,1) + t68 * t70 + t9 * mrSges(6,3) - t73 / 0.2e1 + m(6) * (t23 * t68 + t56 * t9) + (0.3e1 / 0.2e1 * t78 + t116 + (-m(6) * t22 - t181) * t56 - t175) * qJD(5) + t172) * t88 + (t8 * t161 + t7 * t162 + t56 * t13 + t105 * t168 + t103 * t167 - t58 * mrSges(6,2) + t138 * t68 + (mrSges(6,3) + t106) * t10 + (-t1 * t85 - t2 * t87) * mrSges(7,3) + m(7) * (t16 * t68 + t152) + m(6) * (-t22 * t68 + t152) + (t101 * t163 + t102 * t166 + t104 * t165 + t16 * t107 - t87 * t20 / 0.2e1 + t21 * t162 + (t5 * t85 - t6 * t87) * mrSges(7,3)) * qJD(6) + (-t56 * t70 + t115 + (-m(6) * t56 - mrSges(6,3)) * t23 + ((-0.3e1 / 0.2e1 * Ifges(6,4) + t154 / 0.2e1 - t153 / 0.2e1) * t86 + (-0.3e1 / 0.2e1 * Ifges(6,2) - Ifges(7,3) / 0.2e1 + 0.3e1 / 0.2e1 * Ifges(6,1)) * t88) * qJD(1) + t92) * qJD(5)) * t86; -t97 * t24 + t51 * t25 + t81 * t54 + t177 * t41 + t179 * t40 + (mrSges(5,2) * t81 - t113) * t89 + t93 * t82 + m(6) * (t94 * t82 - t146) + m(5) * (t59 * t82 - t146) + ((-t79 - qJD(3)) * m(4) + t170 * t82 - t174 * t81) * qJD(1) + (t1 * t51 + t177 * t5 + t179 * t6 - t2 * t97 + t96 * t82) * m(7); -t89 * mrSges(4,3) + t48 * t24 + t50 * t25 + (-mrSges(5,2) * t89 - t54) * t82 + t178 * t41 + t176 * t40 + t93 * t81 + m(6) * (t94 * t81 + t145) + m(5) * (t59 * t81 + t145) + ((t72 + qJD(2)) * m(4) + t170 * t81 + t174 * t82) * qJD(1) + (t1 * t50 + t176 * t6 + t178 * t5 + t2 * t48 + t96 * t81) * m(7); (-t13 + (t40 * t87 - t41 * t85 - t121 + t70) * qJD(5) + m(6) * (-t10 + t132) + m(7) * (t6 * t129 - t5 * t131 - t10)) * t88 + (t99 * qJD(6) + (-t118 + t138) * qJD(5) + m(6) * (t9 - t133) + m(7) * (qJD(5) * t16 - t5 * t126 - t6 * t127 + t109) + t100) * t86; t7 * t161 + t104 * t168 + t102 * t167 + t85 * t8 / 0.2e1 - t22 * t70 - t11 * t41 - t12 * t40 - t9 * mrSges(6,2) - pkin(5) * t13 - t138 * t23 + (-mrSges(6,1) - t107) * t10 + t109 * mrSges(7,3) + t90 * qJD(6) + ((t23 * mrSges(6,3) + Ifges(6,4) * t180 + t101 * t182 + t115 - t92) * t86 + (t183 + t116 + (-Ifges(6,1) / 0.2e1 + Ifges(6,2) / 0.2e1) * t134 + t175) * t88) * qJD(1) + (-pkin(5) * t10 - t11 * t5 - t12 * t6 - t16 * t23) * m(7) + (t100 + m(7) * t109 + (-m(7) * t108 + t99) * qJD(6)) * pkin(8); t73 - t16 * (mrSges(7,1) * t61 + mrSges(7,2) * t60) + (Ifges(7,1) * t60 - t157) * t165 + t20 * t164 + (Ifges(7,5) * t60 - Ifges(7,6) * t61) * t163 - t5 * t40 + t6 * t41 + (t5 * t60 + t6 * t61) * mrSges(7,3) + (-Ifges(7,2) * t61 + t21 + t57) * t166 - t172;];
tauc  = t19(:);
