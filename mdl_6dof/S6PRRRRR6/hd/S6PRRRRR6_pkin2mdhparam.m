...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S6PRRRRR6_pkin2mdhparam(pkin)
...
t1 = [pkin(14); 0; 0; 0; 0; 0;];
theta_mdh = t1;

% Aus parameters_mdh_d_matlab.m
t1 = [0; pkin(9); pkin(10); pkin(11); pkin(12); pkin(13);];
d_mdh = t1;
