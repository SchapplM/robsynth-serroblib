...
t80 = t168 * t201 + (t172 * t196 + t173 * t177) * t165;
t34 = t176 * t80 + (t112 * t163 + t166 * t79) * t171;
t54 = t112 * t166 - t163 * t79;
t14 = t170 * t34 - t54 * t175;
t227 = t14 ^ 2;
t198 = t166 * t176;
t202 = t163 * t176;
t32 = -t112 * t202 + t171 * t80 - t79 * t198;
t226 = t32 ^ 2;
t111 = -t163 * t200 + t166 * t167;
t203 = t163 * t171;
t81 = t167 * t203 + (t171 * t197 + t172 * t176) * t164;
t55 = -t175 * t111 + t170 * t81;
t56 = t111 * t170 + t175 * t81;
...
t23 = pkin(4) * t78 - pkin(12) * t81 + t49;
t199 = t166 * t171;
...
t41 = Ifges(5,5) * t81 - Ifges(5,6) * t78 + Ifges(5,3) * t111;
...
t61 = mrSges(5,1) * t111 - mrSges(5,3) * t81;
t60 = -mrSges(5,2) * t111 - mrSges(5,3) * t78;
t58 = pkin(5) * t202 - t64;
t47 = mrSges(5,1) * t78 + mrSges(5,2) * t81;
t46 = Ifges(7,1) * t86 + Ifges(7,4) * t85 + Ifges(7,5) * t113;
t45 = Ifges(7,4) * t86 + Ifges(7,2) * t85 + Ifges(7,6) * t113;
t43 = Ifges(5,1) * t81 - Ifges(5,4) * t78 + Ifges(5,5) * t111;
t42 = Ifges(5,4) * t81 - Ifges(5,2) * t78 + Ifges(5,6) * t111;
...
t3 = -pkin(5) * t78 - t7;
t15 = [m(2) + m(7) * (t5 ^ 2 + t6 ^ 2 + t227) + m(6) * (t16 ^ 2 + t226 + t227) + m(5) * (t34 ^ 2 + t54 ^ 2 + t226) + m(4) * (t112 ^ 2 + t79 ^ 2 + t80 ^ 2) + m(3) * (t168 ^ 2 + (t173 ^ 2 + t178 ^ 2) * t165 ^ 2); t112 * t116 + t79 * t124 + t80 * t125 + t16 * t39 + t6 * t17 + t5 * t18 + t34 * t60 + t54 * t47 + (t29 - t61) * t32 + (mrSges(3,1) * t178 - mrSges(3,2) * t173) * t165 + t208 * t14 + m(7) * (t1 * t5 + t14 * t3 + t2 * t6) + m(6) * (-t14 * t7 + t16 * t8 + t25 * t32) + m(5) * (-t30 * t32 + t31 * t34 + t49 * t54) + m(4) * (-pkin(2) * t112 * t164 + t118 * t79 + t120 * t80); m(4) * (t118 ^ 2 + t120 ^ 2) + (t9 - t20) * t55 + t167 * t189 + (-0.2e1 * pkin(2) * t116 + (Ifges(4,5) * t172 + Ifges(4,6) * t177) * t167 + (Ifges(4,2) * t177 ^ 2 + (Ifges(4,1) * t172 + 0.2e1 * Ifges(4,4) * t177) * t172 + m(4) * pkin(2) ^ 2) * t164) * t164 + Ifges(3,3) + (t19 - t42) * t78 + m(7) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t25 ^ 2 + t7 ^ 2 + t8 ^ 2) + m(5) * (t30 ^ 2 + t31 ^ 2 + t49 ^ 2) + 0.2e1 * t3 * t13 + 0.2e1 * t2 * t17 + 0.2e1 * t1 * t18 + 0.2e1 * t25 * t29 + t37 * t10 + t38 * t11 + 0.2e1 * t8 * t39 + 0.2e1 * t7 * t40 + 0.2e1 * t49 * t47 + t56 * t21 + 0.2e1 * t31 * t60 + 0.2e1 * t30 * t61 + t81 * t43 + t111 * t41 + 0.2e1 * t118 * t124 + 0.2e1 * t120 * t125; t79 * mrSges(4,1) - t80 * mrSges(4,2) + t54 * t115 + t34 * t123 + t16 * t89 + t5 * t63 + t6 * t62 + (-t122 + t70) * t32 + t207 * t14 + m(7) * (t14 * t58 + t27 * t5 + t28 * t6) + m(6) * (t101 * t32 - t14 * t64 + t16 * t65) + m(5) * (-t117 * t32 + t119 * t34 - t54 * t213); m(5) * (t117 * t30 + t119 * t31 - t49 * t213) + t192 * t113 + t191 * t55 + (-pkin(3) * t47 + t171 * t43 / 0.2e1 + (-t19 / 0.2e1 + t42 / 0.2e1) * t176) * t163 + m(7) * (t1 * t27 + t2 * t28 + t3 * t58) + m(6) * (t101 * t25 + t64 * t7 + t65 * t8) + (t66 / 0.2e1 - t98 / 0.2e1) * t78 + t189 + t56 * t224 + t114 * t225 + t27 * t18 + t28 * t17 + t37 * t45 / 0.2e1 + t38 * t46 / 0.2e1 + t3 * t48 + t58 * t13 + t2 * t62 + t1 * t63 + t64 * t40 + t65 * t39 + t25 * t70 + t85 * t10 / 0.2e1 + t86 * t11 / 0.2e1 + t8 * t89 + t7 * t90 + t81 * t99 / 0.2e1 + t101 * t29 + t111 * t97 / 0.2e1 + t49 * t115 + t117 * t61 + t118 * mrSges(4,1) + t119 * t60 - t120 * mrSges(4,2) + t30 * t122 + t31 * t123 + t166 * t41 / 0.2e1; 0.2e1 * t101 * t70 + t114 * t68 + 0.2e1 * t117 * t122 + 0.2e1 * t119 * t123 + t166 * t97 + 0.2e1 * t27 * t63 + 0.2e1 * t28 * t62 + t85 * t45 + t86 * t46 + 0.2e1 * t58 * t48 + 0.2e1 * t64 * t90 + 0.2e1 * t65 * t89 + Ifges(4,3) + (t44 - t67) * t113 + (-0.2e1 * pkin(3) * t115 + t171 * t99 + (-t66 + t98) * t176) * t163 + m(7) * (t27 ^ 2 + t28 ^ 2 + t58 ^ 2) + m(6) * (t101 ^ 2 + t64 ^ 2 + t65 ^ 2) + m(5) * (pkin(3) ^ 2 * t163 ^ 2 + t117 ^ 2 + t119 ^ 2); -t34 * mrSges(5,2) + t14 * t121 + t6 * t126 + t5 * t127 + (-mrSges(5,1) + t131) * t32 + t184 * mrSges(6,3) + m(7) * (pkin(12) * t204 + t5 * t95 + t6 * t96) + m(6) * (-pkin(4) * t32 + t184 * pkin(12)); t188 * t55 + t41 + m(6) * (-pkin(4) * t25 + (-t7 * t170 + t8 * t175) * pkin(12)) + m(7) * (t1 * t95 + t2 * t96 + t3 * t212) + (t8 * mrSges(6,3) + pkin(12) * t39 - t192) * t175 - pkin(4) * t29 + t30 * mrSges(5,1) - t31 * mrSges(5,2) + (-t7 * mrSges(6,3) + t208 * pkin(12) + t10 * t217 + t11 * t215 + t225) * t170 + t95 * t18 + t96 * t17 + t37 * t223 + t38 * t222 + t3 * t121 + t2 * t126 + t1 * t127 + t25 * t131 + t78 * t133 / 0.2e1 + t56 * t218; (t65 * mrSges(6,3) + pkin(12) * t89 - t191) * t175 + (-t64 * mrSges(6,3) + t207 * pkin(12) + t46 * t215 + t45 * t217 + t224) * t170 + t188 * t113 + t97 + m(7) * (t58 * t212 + t27 * t95 + t28 * t96) - t133 * t202 / 0.2e1 + m(6) * (-pkin(4) * t101 + (-t64 * t170 + t65 * t175) * pkin(12)) - pkin(4) * t70 + t95 * t63 + t96 * t62 + t85 * t223 + t86 * t222 + t117 * mrSges(5,1) - t119 * mrSges(5,2) + t58 * t121 + t28 * t126 + t27 * t127 + t101 * t131 + t114 * t218; -0.2e1 * pkin(4) * t131 + 0.2e1 * t96 * t126 + 0.2e1 * t95 * t127 + Ifges(5,3) + (-t104 + t135) * t175 + (t160 + t162) * mrSges(6,3) * t229 + m(7) * (t95 ^ 2 + t96 ^ 2 + t157) + m(6) * (pkin(4) ^ 2 + t162 * t180 + t157) + (-t105 * t169 + t106 * t174 + t121 * t229 + t137) * t170; -t16 * mrSges(6,2) + (m(7) * pkin(13) + mrSges(7,3)) * (-t169 * t5 + t174 * t6) + t228 * t14; t10 * t215 - pkin(5) * t13 + m(7) * (-pkin(5) * t3 + t187 * pkin(13)) + t17 * t209 - t18 * t210 + t38 * t219 + t37 * t220 + t55 * t221 + t3 * t130 + t11 * t216 - t8 * mrSges(6,2) + t7 * mrSges(6,1) + t187 * mrSges(7,3) + t19; -pkin(5) * t48 + t85 * t220 + t113 * t221 + t86 * t219 + t58 * t130 + m(7) * (-pkin(5) * t58 + t182 * pkin(13)) - t63 * t210 + t62 * t209 + t46 * t216 + t45 * t215 + t64 * mrSges(6,1) - t65 * mrSges(6,2) + t182 * mrSges(7,3) + t66; -pkin(5) * t121 + t105 * t215 + t106 * t216 + (m(7) * t181 + t174 * t126 - t169 * t127) * pkin(13) + (pkin(12) * t228 + t134 * t217 + t136 * t215) * t170 + (-pkin(12) * mrSges(6,2) - t132 / 0.2e1) * t175 + t181 * mrSges(7,3) + t133; Ifges(6,3) + t169 * t136 + t174 * t134 - 0.2e1 * pkin(5) * t130 + m(7) * (t193 * pkin(13) ^ 2 + pkin(5) ^ 2) + 0.2e1 * t193 * pkin(13) * mrSges(7,3); mrSges(7,1) * t5 - mrSges(7,2) * t6; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t9; mrSges(7,1) * t27 - mrSges(7,2) * t28 + t44; mrSges(7,1) * t95 - mrSges(7,2) * t96 + t104; -t185 * pkin(13) + t132; Ifges(7,3);];
