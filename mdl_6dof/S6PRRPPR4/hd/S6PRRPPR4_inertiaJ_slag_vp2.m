...
t2 = t10 * t93 + t8 * t90;
t1 = -t10 * t90 + t8 * t93;
t9 = [m(2) + m(7) * (t3 ^ 2 + t4 ^ 2 + t129) + m(4) * (t41 ^ 2 + t129 + t72) + m(3) * (t82 * t92 ^ 2 + t89 ^ 2 + t72) + t132 * (t15 ^ 2 + t17 ^ 2 + t129); mrSges(4,3) * t117 + t4 * t24 + t3 * t25 + t110 * t17 + t109 * t15 + (-t92 * mrSges(3,2) + (mrSges(3,1) - t64) * t95) * t87 + (t91 * mrSges(4,3) + t131 + t43) * t39 + m(6) * (t15 * t23 + t17 * t22 + t34 * t39) + m(7) * (t1 * t3 + t2 * t4 + t20 * t39) + m(5) * (pkin(8) * t118 - t15 * t26 + t17 * t27) + m(4) * (pkin(2) * t113 + (t117 + t118) * pkin(8)); -0.2e1 * pkin(2) * t64 + 0.2e1 * t1 * t25 + 0.2e1 * t2 * t24 - 0.2e1 * t20 * t7 + 0.2e1 * t22 * t53 + 0.2e1 * t23 * t52 + 0.2e1 * t26 * t51 + 0.2e1 * t27 * t50 + 0.2e1 * t34 * t43 + t35 * t5 + t36 * t6 + Ifges(3,3) + (t84 + t85) * mrSges(4,3) * t133 + m(4) * (pkin(2) ^ 2 + t85 * t97 + t79) + m(5) * (t26 ^ 2 + t27 ^ 2 + t79) + m(6) * (t22 ^ 2 + t23 ^ 2 + t34 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t20 ^ 2) + ((Ifges(6,2) + Ifges(5,3) + Ifges(4,2)) * t94 + t106) * t94 + (Ifges(4,1) * t91 + t44 * t133 + (t32 + t33) * t88 + (t30 - t31) * t86 + ((2 * Ifges(4,4)) + (-Ifges(6,4) - Ifges(5,5)) * t88 + (Ifges(5,6) - Ifges(6,6)) * t86) * t94) * t91; -t41 * mrSges(4,2) + (-t3 * t49 - t4 * t98) * mrSges(7,3) + (-t11 + t57 + t108) * t39 + m(6) * (t39 * t54 + t102) + m(7) * (t18 * t3 + t19 * t4 - t39 * t42) + m(5) * (-pkin(3) * t39 + t102) + t130 * t134; t54 * t43 + t42 * t7 - pkin(3) * t44 - t98 * t5 / 0.2e1 + t49 * t6 / 0.2e1 + t35 * t12 / 0.2e1 + t36 * t13 / 0.2e1 - t20 * t11 + t19 * t24 + t18 * t25 + (-t30 / 0.2e1 + t31 / 0.2e1) * t88 + (t32 / 0.2e1 + t33 / 0.2e1) * t86 + (-pkin(8) * mrSges(4,2) + t46 / 0.2e1 - t45 / 0.2e1 + Ifges(4,6) + (Ifges(6,6) / 0.2e1 - Ifges(5,6) / 0.2e1) * t88 + (-Ifges(6,4) / 0.2e1 - Ifges(5,5) / 0.2e1) * t86) * t94 + (-t1 * t49 - t2 * t98) * mrSges(7,3) + t99 * mrSges(5,3) + t100 * mrSges(6,2) + m(7) * (t1 * t18 + t19 * t2 - t20 * t42) + (m(5) * t99 + m(6) * t100 + t109 * t86 + t110 * t88) * qJ(4) + (Ifges(4,5) + (t62 / 0.2e1 + t63 / 0.2e1) * t88 + (t60 / 0.2e1 - t61 / 0.2e1) * t86 + (t108 - t128) * pkin(8)) * t91 + (t57 + t126) * t34; -0.2e1 * pkin(3) * t58 + 0.2e1 * t42 * t11 - t98 * t12 + t49 * t13 + 0.2e1 * t54 * t57 + Ifges(4,3) + (-t60 + t61) * t88 + (t63 + t62) * t86 + 0.2e1 * (-t18 * t49 - t19 * t98) * mrSges(7,3) + m(7) * (t18 ^ 2 + t19 ^ 2 + t42 ^ 2) + m(5) * (pkin(3) ^ 2 + t107) + m(6) * (t54 ^ 2 + t107) + 0.2e1 * t130 * qJ(4) * t135; 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1 + m(5) / 0.2e1) * t39; t66 + (m(5) * pkin(8) - mrSges(6,3) * t88) * t91 + m(6) * t34 + m(7) * t20 + t131; -t128 - t116 + t76 + (-mrSges(6,1) - mrSges(5,1)) * t88 + t126 - m(7) * t42 - t11; m(7) + t132; m(6) * t15 + m(7) * (t3 * t93 + t4 * t90); t90 * t24 + t93 * t25 + m(7) * (t1 * t93 + t2 * t90) + m(6) * t23 + t52; m(7) * (t18 * t93 + t19 * t90) + (m(6) * qJ(4) + mrSges(6,2)) * t86 + (-t49 * t93 - t90 * t98) * mrSges(7,3); 0; m(6) + m(7) * (t90 ^ 2 + t93 ^ 2); mrSges(7,1) * t3 - mrSges(7,2) * t4; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t106; mrSges(7,1) * t18 - mrSges(7,2) * t19 - t45 + t46; 0; mrSges(7,1) * t93 - t90 * mrSges(7,2); Ifges(7,3);];
