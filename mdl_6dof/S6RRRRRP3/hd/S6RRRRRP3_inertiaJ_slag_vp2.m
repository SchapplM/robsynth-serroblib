...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:27:46
% EndTime: 2018-11-23 18:27:48
...
t60 = t115 * t116;
t61 = t113 * t116;
t216 = t218 * t114 - t219 * t60 + t221 * t61;
t215 = t220 * t114 - t221 * t60 + t222 * t61;
t214 = t219 * t113 + t221 * t115;
t213 = t221 * t113 + t222 * t115;
...
t138 = t148 * pkin(10);
t110 = t130 * t148 + t138;
t66 = t147 * t109 - t110 * t143;
t41 = t66 - t180;
t67 = t143 * t109 + t147 * t110;
t98 = t113 * qJ(6);
t42 = t98 + t67;
t210 = t66 * mrSges(6,1) + t41 * mrSges(7,1) - t67 * mrSges(6,2) - t42 * mrSges(7,2);
t125 = (-pkin(10) - pkin(9)) * t144;
t126 = pkin(9) * t148 + t138;
t83 = t147 * t125 - t126 * t143;
t53 = t83 - t180;
t86 = t143 * t125 + t147 * t126;
t54 = t98 + t86;
t209 = t83 * mrSges(6,1) + t53 * mrSges(7,1) - t86 * mrSges(6,2) - t54 * mrSges(7,2);
t84 = -t127 * t145 - t149 * t168;
t208 = t84 ^ 2;
t207 = 0.2e1 * mrSges(7,1);
t72 = -t113 * mrSges(7,1) + t115 * mrSges(7,2);
t206 = 0.2e1 * t72;
...
t24 = t60 * mrSges(7,1) + t61 * mrSges(7,2);
t166 = t174 * t130;
t51 = pkin(4) * t179 + t84;
...
t160 = t187 * t114 - t218 * t60 + t220 * t61;
t159 = (mrSges(4,1) * t149 - mrSges(4,2) * t145) * pkin(2);
t123 = Ifges(5,2) * t148 + t186;
t124 = Ifges(5,1) * t144 + t185;
t158 = t214 * t113 + t213 * t115 + t148 * t123 + t144 * t124 + Ifges(4,3);
t4 = -qJ(6) * t60 + t8;
t157 = t7 * mrSges(6,1) + t3 * mrSges(7,1) - t8 * mrSges(6,2) - t4 * mrSges(7,2) + t160;
t131 = pkin(5) + t192;
...
t155 = t124 * t178 / 0.2e1 - t123 * t179 / 0.2e1 + t148 * t43 / 0.2e1 + t144 * t44 / 0.2e1 + Ifges(4,5) * t116 + t23 * t72 + t51 * t73 - t87 * mrSges(4,2) + (t122 - mrSges(4,1)) * t84 - t214 * t60 / 0.2e1 + t213 * t61 / 0.2e1 + t163 * mrSges(5,3) + (-t7 * mrSges(6,3) - t3 * mrSges(7,3) + t215 / 0.2e1) * t115 + (t216 / 0.2e1 + mrSges(6,3) * t8 + mrSges(7,3) * t4) * t113 + (-Ifges(4,6) + t217 / 0.2e1) * t114;
t153 = pkin(4) ^ 2;
t137 = t143 ^ 2 * t153;
t132 = -pkin(3) - t194;
t121 = t133 - t194;
...
t1 = [t146 * (Ifges(3,1) * t146 + Ifges(3,4) * t150) - 0.2e1 * pkin(1) * (-mrSges(3,1) * t150 + mrSges(3,2) * t146) + t150 * (Ifges(3,4) * t146 + Ifges(3,2) * t150) + 0.2e1 * t33 * t70 + 0.2e1 * t32 * t71 + t68 * t204 + 0.2e1 * t51 * t25 + 0.2e1 * t4 * t34 + 0.2e1 * t8 * t35 + 0.2e1 * t3 * t36 + 0.2e1 * t7 * t37 + 0.2e1 * t23 * t24 + Ifges(2,3) + t215 * t61 - t216 * t60 + 0.2e1 * t173 * pkin(7) * mrSges(3,3) + (mrSges(4,2) * t203 + mrSges(4,3) * t204 + Ifges(4,1) * t116 - t144 * t43 + t148 * t44) * t116 + (mrSges(4,1) * t203 - 0.2e1 * t87 * mrSges(4,3) + Ifges(4,2) * t114 + (-Ifges(5,6) * t144 - (2 * Ifges(4,4))) * t116 + t160 + t212) * t114 + m(3) * (pkin(7) ^ 2 * t173 + pkin(1) ^ 2) + m(4) * (t134 ^ 2 + t87 ^ 2 + t208) + m(5) * (t32 ^ 2 + t33 ^ 2 + t208) + m(6) * (t51 ^ 2 + t7 ^ 2 + t8 ^ 2) + m(7) * (t23 ^ 2 + t3 ^ 2 + t4 ^ 2); t155 + (-t146 * mrSges(3,1) - t150 * mrSges(3,2)) * pkin(7) + Ifges(3,5) * t146 + Ifges(3,6) * t150 + t132 * t68 + t121 * t25 + t88 * t24 + t66 * t37 + t67 * t35 + t41 * t36 + t42 * t34 + m(5) * (t130 * t163 + t132 * t84) + t162 * t130 + m(6) * (t121 * t51 + t66 * t7 + t67 * t8) + m(7) * (t23 * t88 + t3 * t41 + t4 * t42) + (m(4) * (t145 * t87 - t149 * t84) + (-t114 * t145 - t116 * t149) * mrSges(4,3)) * pkin(2); t158 + 0.2e1 * t132 * t122 + t121 * t205 + t88 * t206 + m(4) * (t145 ^ 2 + t149 ^ 2) * pkin(2) ^ 2 + 0.2e1 * t159 + (t113 * t42 - t115 * t41) * t171 + (t113 * t67 - t115 * t66) * t172 + m(5) * (t130 ^ 2 * t174 + t132 ^ 2) + m(7) * (t41 ^ 2 + t42 ^ 2 + t88 ^ 2) + m(6) * (t121 ^ 2 + t66 ^ 2 + t67 ^ 2) + Ifges(3,3) + t130 * t161; t155 + t162 * pkin(9) + m(6) * (t133 * t51 + t7 * t83 + t8 * t86) + m(7) * (t23 * t90 + t3 * t53 + t4 * t54) + t133 * t25 + t90 * t24 + t83 * t37 + t86 * t35 - pkin(3) * t68 + t53 * t36 + t54 * t34 + m(5) * (-pkin(3) * t84 + pkin(9) * t163); ((-t41 - t53) * t115 + (t42 + t54) * t113) * mrSges(7,3) + t158 + m(5) * (-pkin(3) * t132 + pkin(9) * t166) + ((-t66 - t83) * t115 + (t67 + t86) * t113) * mrSges(6,3) + t159 + (pkin(9) * t174 + t166) * mrSges(5,3) + (t132 - pkin(3)) * t122 + (t88 + t90) * t72 + (t133 + t121) * t73 + m(6) * (t121 * t133 + t66 * t83 + t67 * t86) + m(7) * (t41 * t53 + t42 * t54 + t88 * t90); -0.2e1 * pkin(3) * t122 + t133 * t205 + t90 * t206 + (t54 * t113 - t53 * t115) * t171 + (t86 * t113 - t83 * t115) * t172 + pkin(9) * t161 + m(7) * (t53 ^ 2 + t54 ^ 2 + t90 ^ 2) + m(6) * (t133 ^ 2 + t83 ^ 2 + t86 ^ 2) + m(5) * (pkin(9) ^ 2 * t174 + pkin(3) ^ 2) + t158; t157 - Ifges(5,6) * t179 + t32 * mrSges(5,1) - t33 * mrSges(5,2) + t169 * t131 + ((m(6) * t7 + t37) * t147 + (m(6) * t8 + m(7) * t4 + t34 + t35) * t143) * pkin(4) + t212; t156 + m(7) * (t131 * t41 + t193 * t42) - t164 * t130 + (t143 * t67 + t147 * t66) * t202 + t210; t156 + m(7) * (t131 * t53 + t193 * t54) - t164 * pkin(9) + (t143 * t86 + t147 * t83) * t202 + t209; t131 * t207 + Ifges(5,3) + m(6) * (t147 ^ 2 * t153 + t137) + m(7) * (t131 ^ 2 + t137) + 0.2e1 * t211 + t187; pkin(5) * t169 + t157; (m(7) * t41 - t184) * pkin(5) + t165 + t210; (m(7) * t53 - t184) * pkin(5) + t165 + t209; t131 * t201 + (pkin(5) + t131) * mrSges(7,1) + t211 + t187; (t207 + t201) * pkin(5) + t187; m(7) * t23 + t24; m(7) * t88 + t72; m(7) * t90 + t72; 0; 0; m(7);];
