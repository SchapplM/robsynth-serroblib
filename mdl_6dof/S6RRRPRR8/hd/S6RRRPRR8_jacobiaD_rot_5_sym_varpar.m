...
function JaD_rot = S6RRRPRR8_jacobiaD_rot_5_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRPRR8_jacobiaD_rot_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRPRR8_jacobiaD_rot_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6RRRPRR8_jacobiaD_rot_5_sym_varpar: pkin has to be [12x1] (double)');

%% Symbolic Calculation
% From jacobiaD_rot_5_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 22:19:48
% EndTime: 2019-02-26 22:19:49
...
t286 = -t271 * t305 - t323;
t233 = qJD(1) * t288 + qJD(2) * t286;
t246 = t256 * t268 + t267 * t307;
t304 = qJD(1) * t326;
t211 = qJD(3) * t246 + t233 * t267 - t268 * t304;
t338 = t211 * t205;
t238 = t240 ^ 2;
t248 = 0.1e1 / t250 ^ 2;
...
t320 = qJD(2) * t275;
t303 = t270 * t320;
t236 = qJD(3) * t251 + t267 * t303;
t247 = 0.1e1 / t250;
t332 = t240 * t248;
t292 = -t213 * t247 + t236 * t332;
t195 = t292 * t222;
t293 = -t216 * t250 - t217 * t240;
t190 = t195 * t293 - t216 * t213 + t217 * t236;
t204 = 0.1e1 / t207;
t206 = t204 * t205;
t343 = t190 * t206;
...
t348 = t267 * t289;
t214 = t267 * (qJD(3) * t288 + t295) + t350 * t268;
t274 = cos(qJ(5));
t272 = sin(qJ(5));
t330 = t286 * t272;
t227 = t246 * t274 - t330;
...
t347 = -0.2e1 * t240;
t346 = -0.2e1 * t287;
t212 = qJD(3) * t287 + t233 * t268 + t267 * t304;
t232 = -qJD(1) * t308 - t276 * t320 + (t271 * t300 + t301) * t273;
t202 = qJD(5) * t227 + t212 * t272 + t232 * t274;
t329 = t286 * t274;
t226 = t246 * t272 + t329;
t218 = t226 ^ 2;
...
t237 = -qJD(3) * t250 + t268 * t303;
t234 = qJD(1) * t286 + qJD(2) * t288;
...
t191 = t196 * t293 - t216 * t242 + t217 * t251;
