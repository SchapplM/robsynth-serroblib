...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:55:53
% EndTime: 2018-11-23 17:55:55
...
t1 = [((-0.2e1 * t115 * mrSges(3,3) + Ifges(3,5) * t164 + (-0.2e1 * pkin(1) * mrSges(3,2) + Ifges(3,1) * t168) * t162) * t168 + (0.2e1 * t116 * mrSges(3,3) + Ifges(3,6) * t164 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t168 + (Ifges(3,2) + t199) * t172) * t162 + t181) * t172) * t162 + (t183 - 0.2e1 * t193 + 0.2e1 * t194) * t164 + Ifges(2,3) + 0.2e1 * t12 * t11 + 0.2e1 * t3 * t16 + 0.2e1 * t2 * t17 + t31 * t9 + t32 * t10 + 0.2e1 * t22 * t33 + 0.2e1 * t7 * t38 + 0.2e1 * t6 * t39 + t56 * t20 + t57 * t21 + 0.2e1 * t25 * t61 + 0.2e1 * t24 * t62 + t76 * t41 + 0.2e1 * t82 * t43 + (t8 + t19 - t40) * t75 + 0.2e1 * t64 * t101 + 0.2e1 * t63 * t102 + 0.2e1 * t106 * t86 + t113 * t66 + t114 * t67 + m(7) * (t12 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t22 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(5) * (t24 ^ 2 + t25 ^ 2 + t82 ^ 2) + m(4) * (t106 ^ 2 + t63 ^ 2 + t64 ^ 2) + m(3) * (pkin(1) ^ 2 * t162 ^ 2 + t115 ^ 2 + t116 ^ 2); t194 - t193 + (-t25 * mrSges(5,3) + t8 / 0.2e1 + t19 / 0.2e1 - t40 / 0.2e1) * t127 + m(4) * (-pkin(2) * t106 + (-t63 * t167 + t64 * t171) * pkin(9)) + t57 * t207 + t56 * t208 - t212 * t189 / 0.2e1 + (t33 - t62) * t98 + (t64 * mrSges(4,3) + pkin(9) * t101 + t66 / 0.2e1) * t171 + (-t63 * mrSges(4,3) - pkin(9) * t102 + t67 / 0.2e1) * t167 + m(7) * (t12 * t65 + t14 * t2 + t15 * t3) + m(6) * (t22 * t98 + t47 * t6 + t48 * t7) + m(5) * (t100 * t25 + t151 * t82 - t24 * t98) + (-t24 * mrSges(5,3) - t166 * t20 / 0.2e1 + t170 * t209 + t41 / 0.2e1) * t128 + (t35 / 0.2e1 + t58 / 0.2e1 - t91 / 0.2e1) * t75 + t183 + t15 * t16 + t14 * t17 + t31 * t36 / 0.2e1 + t32 * t37 / 0.2e1 + t12 * t44 + t47 * t39 + t48 * t38 + t3 * t52 + t2 * t53 + t65 * t11 - t77 * t9 / 0.2e1 + t78 * t10 / 0.2e1 + t22 * t83 - pkin(2) * t86 + t7 * t88 + t6 * t89 + t82 * t90 + t76 * t92 / 0.2e1 + t100 * t61 + t106 * t134 + t113 * t138 / 0.2e1 + t114 * t140 / 0.2e1 + t151 * t43; -0.2e1 * pkin(2) * t134 + t171 * t138 + 0.2e1 * t14 * t53 + t167 * t140 + 0.2e1 * t15 * t52 + 0.2e1 * t151 * t90 - t77 * t36 + t78 * t37 + 0.2e1 * t65 * t44 + 0.2e1 * t47 * t89 + 0.2e1 * t48 * t88 + t83 * t210 + Ifges(3,3) + 0.2e1 * t185 * pkin(9) * mrSges(4,3) + (mrSges(5,3) * t210 - t166 * t59 + t170 * t60 + t92) * t128 + (-0.2e1 * mrSges(5,3) * t100 + t35 + t58 - t91) * t127 + m(7) * (t14 ^ 2 + t15 ^ 2 + t65 ^ 2) + m(6) * (t47 ^ 2 + t48 ^ 2 + t211) + m(5) * (t100 ^ 2 + t151 ^ 2 + t211) + m(4) * (t185 * pkin(9) ^ 2 + pkin(2) ^ 2); m(7) * (t12 * t132 + t2 * t84 + t3 * t85) + (t7 * mrSges(6,3) + t149 * t38 + t20 / 0.2e1) * t170 + m(6) * (t150 * t22 + (-t6 * t166 + t7 * t170) * t149) - t181 + (t3 * t130 - t2 * t131) * mrSges(7,3) + t57 * t202 + t10 * t203 + t9 * t204 + t32 * t205 + t31 * t206 + t184 * t75 + (-t6 * mrSges(6,3) - t149 * t39 + t209) * t166 - t199 * t189 + (t161 * t61 + t163 * t62 + m(5) * (t161 * t25 + t163 * t24)) * pkin(3) + t24 * mrSges(5,1) - t25 * mrSges(5,2) + t63 * mrSges(4,1) - t64 * mrSges(4,2) + t84 * t17 + t85 * t16 + t12 * t94 + t132 * t11 + t22 * t133 + t56 * t137 / 0.2e1 + t150 * t33; (t130 * t15 - t131 * t14) * mrSges(7,3) + (-mrSges(5,1) + t133) * t98 + (t48 * mrSges(6,3) + t128 * t202 + t149 * t88 + t208) * t170 + (-t47 * mrSges(6,3) - t128 * t137 / 0.2e1 - t149 * t89 + t207) * t166 + m(6) * (t150 * t98 + (-t166 * t47 + t170 * t48) * t149) + t184 * t127 + m(7) * (t132 * t65 + t14 * t84 + t15 * t85) + (-mrSges(4,1) * t167 - mrSges(4,2) * t171) * pkin(9) + (m(5) * (t100 * t161 - t163 * t98) + (-t127 * t161 - t128 * t163) * mrSges(5,3)) * pkin(3) + t84 * t53 + t85 * t52 + t65 * t94 - t77 * t206 + t78 * t205 - t100 * mrSges(5,2) + t36 * t204 + t37 * t203 + t132 * t44 + t150 * t83 + t212; t130 * t96 + t131 * t97 + 0.2e1 * t132 * t94 + 0.2e1 * t150 * t133 + t170 * t137 + t166 * t139 + m(7) * (t132 ^ 2 + t84 ^ 2 + t85 ^ 2) + m(6) * (t186 * t149 ^ 2 + t150 ^ 2) + m(5) * (t161 ^ 2 + t163 ^ 2) * pkin(3) ^ 2 + t199 + 0.2e1 * (mrSges(5,1) * t163 - mrSges(5,2) * t161) * pkin(3) + 0.2e1 * (t130 * t85 - t131 * t84) * mrSges(7,3) + 0.2e1 * t186 * t149 * mrSges(6,3); t130 * t17 + t131 * t16 + t166 * t38 + t170 * t39 + m(7) * (t130 * t2 + t131 * t3) + m(6) * (t166 * t7 + t170 * t6) + m(5) * t82 + t43; t130 * t53 + t131 * t52 + t166 * t88 + t170 * t89 + m(7) * (t130 * t14 + t131 * t15) + m(6) * (t166 * t48 + t170 * t47) + m(5) * t151 + t90; m(7) * (t130 * t84 + t131 * t85); m(5) + m(6) * t186 + m(7) * (t130 ^ 2 + t131 ^ 2); t6 * mrSges(6,1) - t7 * mrSges(6,2) + (t169 * t17 + m(7) * (t165 * t3 + t169 * t2) + t165 * t16) * pkin(5) + t178 + t19; t47 * mrSges(6,1) - t48 * mrSges(6,2) + (m(7) * (t14 * t169 + t15 * t165) + t165 * t52 + t169 * t53) * pkin(5) + t177 + t58; -t180 * t149 + (m(7) * (t165 * t85 + t169 * t84) + (t130 * t165 - t131 * t169) * mrSges(7,3)) * pkin(5) + t179 + t136; m(7) * (t130 * t169 + t131 * t165) * pkin(5) - t133 - t94; Ifges(6,3) + Ifges(7,3) + m(7) * (t165 ^ 2 + t169 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t176; t178; t177; t179; -t94; Ifges(7,3) + t176; Ifges(7,3);];
