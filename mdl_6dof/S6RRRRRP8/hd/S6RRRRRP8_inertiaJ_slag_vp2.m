...
t1 = [(t216 - 0.2e1 * t234 + 0.2e1 * t235) * t185 + t127 * t79 + t128 * t80 + 0.2e1 * t78 * t107 + 0.2e1 * t77 * t108 + 0.2e1 * t117 * t89 + t86 * t36 + 0.2e1 * t88 * t39 + 0.2e1 * t26 * t75 + 0.2e1 * t25 * t76 + 0.2e1 * t9 * t29 + 0.2e1 * t16 * t30 + 0.2e1 * t7 * t31 + 0.2e1 * t3 * t32 + 0.2e1 * t6 * t33 + 0.2e1 * t4 * t34 + m(7) * (t3 ^ 2 + t4 ^ 2 + t9 ^ 2) + m(6) * (t16 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(5) * (t25 ^ 2 + t26 ^ 2 + t88 ^ 2) + m(4) * (t117 ^ 2 + t77 ^ 2 + t78 ^ 2) + m(3) * (pkin(1) ^ 2 * t184 ^ 2 + t129 ^ 2 + t130 ^ 2) + (-t35 + t265) * t85 + ((-0.2e1 * t129 * mrSges(3,3) + Ifges(3,5) * t185 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t189) * t184) * t189 + (0.2e1 * t130 * mrSges(3,3) + Ifges(3,6) * t185 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t189 + (Ifges(3,2) + t241) * t193) * t184 + t240 + t263) * t193) * t184 + (-t21 + t18) * t65 + t271 * t66 + Ifges(2,3); -t234 + t235 + t216 + t111 * t75 - pkin(2) * t89 + t9 * t91 + t16 * t92 + t7 * t94 + t6 * t95 + t4 * t96 + t3 * t97 + t88 * t98 + t86 * t100 / 0.2e1 + t55 * t29 + t40 * t32 + t41 * t34 + t48 * t33 + t49 * t31 + (t19 / 0.2e1 + t20 / 0.2e1 - t35 / 0.2e1 - t26 * mrSges(5,3)) * t139 + (t78 * mrSges(4,3) + pkin(9) * t107 + t79 / 0.2e1) * t192 + (t80 / 0.2e1 - t77 * mrSges(4,3) - pkin(9) * t108) * t188 + (t36 / 0.2e1 - t25 * mrSges(5,3) + (t22 / 0.2e1 + t23 / 0.2e1) * t190 + (t18 / 0.2e1 - t21 / 0.2e1) * t186) * t140 + (t30 - t76) * t109 - (t221 + t224) * t225 / 0.2e1 + m(4) * (-pkin(2) * t117 + (-t77 * t188 + t78 * t192) * pkin(9)) + t117 * t147 + t127 * t152 / 0.2e1 + t128 * t155 / 0.2e1 + t169 * t39 + (t69 / 0.2e1 - t72 / 0.2e1) * t65 + (t73 / 0.2e1 + t74 / 0.2e1) * t66 + (-t99 / 0.2e1 + t70 / 0.2e1 + t71 / 0.2e1) * t85 + m(7) * (t3 * t40 + t4 * t41 + t55 * t9) + m(6) * (t109 * t16 + t48 * t6 + t49 * t7) + m(5) * (-t109 * t25 + t111 * t26 + t169 * t88); -0.2e1 * pkin(2) * t147 + t92 * t260 + t192 * t152 + t188 * t155 + 0.2e1 * t169 * t98 + 0.2e1 * t40 * t97 + 0.2e1 * t41 * t96 + 0.2e1 * t48 * t95 + 0.2e1 * t49 * t94 + 0.2e1 * t55 * t91 + Ifges(3,3) + 0.2e1 * t218 * pkin(9) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t111 + t264 - t99) * t139 + m(7) * (t40 ^ 2 + t41 ^ 2 + t55 ^ 2) + m(6) * (t48 ^ 2 + t49 ^ 2 + t261) + m(5) * (t111 ^ 2 + t169 ^ 2 + t261) + m(4) * (t218 * pkin(9) ^ 2 + pkin(2) ^ 2) + (mrSges(5,3) * t260 + t100 + t270 * t190 + (t69 - t72) * t186) * t140; t198 + t131 * t29 + t77 * mrSges(4,1) - t78 * mrSges(4,2) + (t187 * t75 + t191 * t76 + m(5) * (t187 * t26 + t191 * t25)) * pkin(3) + t204 * t167 + m(6) * (t16 * t168 + t212 * t167) + m(7) * (t131 * t9 + t213 * t167) - t241 * t225 + t168 * t30 - t263; t197 + t131 * t91 + (m(5) * (-t109 * t191 + t111 * t187) + (-t139 * t187 - t140 * t191) * mrSges(5,3)) * pkin(3) + m(7) * (t131 * t55 + t208 * t167) + m(6) * (t109 * t168 + t207 * t167) + t203 * t167 + (-mrSges(4,1) * t188 - mrSges(4,2) * t192) * pkin(9) + t168 * t92 + t221; t131 * t259 + 0.2e1 * t168 * t146 + Ifges(4,3) + 0.2e1 * t206 + m(7) * (t131 ^ 2 + t222) + m(6) * (t168 ^ 2 + t222) + m(5) * (t187 ^ 2 + t191 ^ 2) * pkin(3) ^ 2 + t200 * t167 + t205; t198 - pkin(4) * t30 + t204 * pkin(11) + m(7) * (t213 * pkin(11) + t142 * t9) + m(6) * (-pkin(4) * t16 + t212 * pkin(11)) + t142 * t29 - Ifges(5,3) * t225; t197 - pkin(4) * t92 + t203 * pkin(11) + m(7) * (t208 * pkin(11) + t142 * t55) + m(6) * (-pkin(4) * t109 + t207 * pkin(11)) + t142 * t91; (t168 - pkin(4)) * t146 + (t131 + t142) * t145 + t206 + m(7) * (t131 * t142 + t223) + m(6) * (-pkin(4) * t168 + t223) + t205 + (pkin(11) + t167) * t262; -0.2e1 * pkin(4) * t146 + t142 * t259 + m(7) * (t142 ^ 2 + t220) + m(6) * (pkin(4) ^ 2 + t220) + t200 * pkin(11) + t205; -pkin(5) * t34 + m(7) * (-pkin(5) * t4 + qJ(6) * t3) + qJ(6) * t32 + t3 * mrSges(7,3) - t4 * mrSges(7,1) - t7 * mrSges(6,2) + t6 * mrSges(6,1) + t265; m(7) * (-pkin(5) * t41 + qJ(6) * t40) + t40 * mrSges(7,3) + qJ(6) * t97 - t49 * mrSges(6,2) - t41 * mrSges(7,1) + t48 * mrSges(6,1) - pkin(5) * t96 + t264; t199 * t167 + t201; t199 * pkin(11) + t201; Ifges(7,2) + Ifges(6,3) + 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2); m(7) * t4 + t34; m(7) * t41 + t96; t167 * t248 + t172; pkin(11) * t248 + t172; -m(7) * pkin(5) - mrSges(7,1); m(7);];
