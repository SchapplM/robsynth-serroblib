...
t1 = [-0.2e1 * pkin(1) * (-mrSges(3,1) * t144 + mrSges(3,2) * t140) + t140 * (Ifges(3,1) * t140 + Ifges(3,4) * t144) + t144 * (Ifges(3,4) * t140 + Ifges(3,2) * t144) + t66 * t201 + 0.2e1 * t32 * t69 + 0.2e1 * t31 * t70 + 0.2e1 * t3 * t37 + 0.2e1 * t48 * t24 + 0.2e1 * t8 * t34 + 0.2e1 * t7 * t35 + 0.2e1 * t5 * t36 + 0.2e1 * t10 * t23 + Ifges(2,3) - t211 * t56 + (t17 - t18) * t55 + 0.2e1 * t173 * pkin(7) * mrSges(3,3) + (mrSges(4,2) * t200 + mrSges(4,3) * t201 + Ifges(4,1) * t112 - t138 * t40 + t142 * t41) * t112 + (mrSges(4,1) * t200 - 0.2e1 * t89 * mrSges(4,3) + Ifges(4,2) * t110 + (-Ifges(5,6) * t138 - (2 * Ifges(4,4))) * t112 + t159 + t208) * t110 + m(3) * (pkin(7) ^ 2 * t173 + pkin(1) ^ 2) + m(4) * (t129 ^ 2 + t89 ^ 2 + t205) + m(5) * (t31 ^ 2 + t32 ^ 2 + t205) + m(6) * (t48 ^ 2 + t7 ^ 2 + t8 ^ 2) + m(7) * (t10 ^ 2 + t3 ^ 2 + t5 ^ 2); (-t140 * mrSges(3,1) - t144 * mrSges(3,2)) * pkin(7) + t149 + Ifges(3,6) * t144 + Ifges(3,5) * t140 + t127 * t66 + t115 * t24 + t54 * t23 + m(5) * (t162 * t125 + t127 * t86) + t187 * t65 + t188 * t63 + t161 * t125 + m(6) * (t115 * t48 - t63 * t7 + t65 * t8) + m(7) * (t10 * t54 + t3 * t65 + t5 * t63) + (m(4) * (t139 * t89 - t143 * t86) + (-t110 * t139 - t112 * t143) * mrSges(4,3)) * pkin(2); t125 * t160 + 0.2e1 * t127 * t116 + t115 * t202 + t54 * t203 + m(4) * (t139 ^ 2 + t143 ^ 2) * pkin(2) ^ 2 + m(5) * (t125 ^ 2 * t174 + t127 ^ 2) + 0.2e1 * t158 + t156 + Ifges(3,3) + m(7) * (t54 ^ 2 + t172) + m(6) * (t115 ^ 2 + t172) + (-t65 * t109 + t63 * t111) * t212; t187 * t88 + t188 * t84 + t161 * pkin(9) + m(6) * (t128 * t48 - t7 * t84 + t8 * t88) + m(7) * (t10 * t67 + t3 * t88 + t5 * t84) + t149 + t128 * t24 - pkin(3) * t66 + t67 * t23 + m(5) * (-pkin(3) * t86 + pkin(9) * t162); m(6) * (t115 * t128 + t167) + m(7) * (t54 * t67 + t167) + (t128 + t115) * t72 + (t67 + t54) * t71 + m(5) * (-pkin(3) * t127 + pkin(9) * t165) + (pkin(9) * t174 + t165) * mrSges(5,3) + t156 + t158 + (t127 - pkin(3)) * t116 + t209 * ((t63 + t84) * t111 + (-t65 - t88) * t109); -0.2e1 * pkin(3) * t116 + t128 * t202 + t67 * t203 + pkin(9) * t160 + m(7) * (t67 ^ 2 + t171) + m(6) * (t128 ^ 2 + t171) + m(5) * (pkin(9) ^ 2 * t174 + pkin(3) ^ 2) + t156 + (-t88 * t109 + t84 * t111) * t212; t150 + t126 * t36 + t122 * t37 + t31 * mrSges(5,1) - t32 * mrSges(5,2) + (m(6) * (t137 * t8 + t141 * t7) + t137 * t34 + t141 * t35) * pkin(4) - Ifges(5,6) * t178 + m(7) * (t122 * t3 + t126 * t5) + t208; m(7) * (t122 * t65 + t126 * t63) - t163 * t125 + t151 + (m(6) * (t137 * t65 - t141 * t63) - t170) * pkin(4) + t207; m(7) * (t122 * t88 + t126 * t84) - t163 * pkin(9) + t151 + (m(6) * (t137 * t88 - t141 * t84) - t170) * pkin(4) + t206; -0.2e1 * t126 * mrSges(7,1) + t122 * t204 + Ifges(5,3) + 0.2e1 * t157 + m(7) * (t122 ^ 2 + t126 ^ 2) + m(6) * (t137 ^ 2 + t141 ^ 2) * pkin(4) ^ 2 + t189; m(7) * (-pkin(5) * t5 + qJ(6) * t3) + qJ(6) * t37 - pkin(5) * t36 + t150; m(7) * (-pkin(5) * t63 + qJ(6) * t65) + t152 + t207; m(7) * (-pkin(5) * t84 + qJ(6) * t88) + t152 + t206; m(7) * (-pkin(5) * t126 + qJ(6) * t122) + t157 + (t122 + qJ(6)) * mrSges(7,3) + (-t126 + pkin(5)) * mrSges(7,1) + t189; 0.2e1 * pkin(5) * mrSges(7,1) + qJ(6) * t204 + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t189; m(7) * t5 + t36; m(7) * t63 + t96; m(7) * t84 + t96; m(7) * t126 - mrSges(7,1); -m(7) * pkin(5) - mrSges(7,1); m(7);];
