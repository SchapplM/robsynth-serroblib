...
function JRD_rot = S6RRRRRP4_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),uint8(0),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRRP4_jacobiRD_rot_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRRRP4_jacobiRD_rot_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRRRP4_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRRRRP4_jacobiRD_rot_sym_varpar: pkin has to be [10x1] (double)');
if link_index == 0
...
elseif link_index == 6
	...
	% OptimizationMode: 2
	% StartTime: 2019-10-10 13:02:10
	% EndTime: 2019-10-10 13:02:10
	% DurationCPUTime: 0.16s
	% Computational Cost: add. (344->29), mult. (286->50), div. (0->0), fcn. (286->6), ass. (0->47)
	t460 = sin(qJ(1));
	t459 = qJ(2) + qJ(3);
	t455 = cos(t459);
	t456 = qJD(4) + qJD(5);
	t466 = qJD(1) * t455 - t456;
	t453 = sin(t459);
	t457 = qJD(2) + qJD(3);
	t461 = cos(qJ(1));
	t475 = t457 * t461;
	...
	t450 = t455 * t473 - t471;
	t449 = -t455 * t474 - t469;
	t448 = t454 * t451 - t452 * t479;
	t447 = -t452 * t451 - t472;
	t446 = -t452 * t477 - t454 * t478;
	t445 = -t452 * t478 + t454 * t477;
	t444 = -t454 * t470 + (-t454 * t473 + t460 * t480) * t453;
	t443 = t463 * t452 - t460 * t472;
	t442 = -t454 * t468 + (t454 * t474 + t461 * t480) * t453;
	t441 = t462 * t452 - t461 * t472;
	t440 = t452 * t465 + t481 * t454;
	t439 = -t481 * t452 + t454 * t465;
	t438 = t452 * t464 - t482 * t454;
	t437 = t482 * t452 + t454 * t464;
	t1 = [-t440, t442, t442, t437, t437, 0; t438, t444, t444, t439, t439, 0; 0, t446, t446, t447, t447, 0; t463, t449, t449, 0, 0, 0; -t462, t450, t450, 0, 0, 0; 0, t451, t451, 0, 0, 0; t439, t441, t441, t438, t438, 0; -t437, t443, t443, t440, t440, 0; 0, t445, t445, t448, t448, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,6);
end