% Umwandlung der Kinematikparameter von S6RRPPRR9V2 zu S6RRPPRR9
% Eingabe:
% pkin_var (8x1) double
...
%
% Siehe auch: S6RRPPRR9_structural_kinematic_parameters.m
function pkin_gen = S6RRPPRR9V2_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
