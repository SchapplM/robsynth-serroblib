...
function Tc_mdh = S6RPRRPR8_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RPRRPR8_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RPRRPR8_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RPRRPR8_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [10x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 21:49:01
	% EndTime: 2020-11-04 21:49:01
...
elseif link_index == 5
	...
	t76 = sin(qJ(3));
	t78 = cos(qJ(3));
	t80 = t71 * t76 + t75 * t78 + qJ(2);
	t70 = sin(qJ(4)) * pkin(4) + pkin(1) + pkin(7);
	t1 = [t76 * t83 + t82, -t76 * t84 + t81, -t77 * t78, t70 * t79 + t80 * t77 + 0; -t76 * t81 + t84, t76 * t82 + t83, t79 * t78, t70 * t77 - t80 * t79 + 0; t78 * t73, -t78 * t72, t76, t78 * t71 - t75 * t76 + pkin(2) + pkin(6) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 6
	...
	% Computational Cost: add. (61->24), mult. (42->26), div. (0->0), fcn. (55->10), ass. (0->15)
	t92 = sin(qJ(3));
	t93 = sin(qJ(1));
	t100 = t92 * t93;
	t95 = cos(qJ(1));
	...
	t90 = -pkin(9) - qJ(5) - pkin(8);
	t94 = cos(qJ(3));
	t97 = t85 * t92 + t90 * t94 + qJ(2);
	t89 = qJ(6) + t91;
	t88 = cos(t89);
	t87 = sin(t89);
	t1 = [t88 * t100 + t87 * t95, -t87 * t100 + t88 * t95, -t93 * t94, t97 * t93 + t98 * t95 + 0; t87 * t93 - t88 * t99, t87 * t99 + t88 * t93, t95 * t94, t98 * t93 - t97 * t95 + 0; t94 * t88, -t94 * t87, t92, t85 * t94 - t90 * t92 + pkin(2) + pkin(6) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
end