...
t52 = t139 - t57;
t175 = t146 * t148;
t91 = mrSges(6,1) * t149 + mrSges(6,2) * t175;
t196 = m(6) * t52 + t91;
t144 = sin(pkin(6));
t150 = cos(qJ(2));
t177 = t144 * t150;
...
t59 = -pkin(2) * t180 - t80;
t24 = pkin(3) * t78 - pkin(10) * t79 + t59;
...
t97 = mrSges(7,1) * t148 + mrSges(7,2) * t145;
...
t32 = -t78 * mrSges(6,1) + mrSges(6,2) * t47;
t19 = -mrSges(7,1) * t46 + mrSges(7,2) * t47;
t30 = -mrSges(7,1) * t78 - t47 * mrSges(7,3);
...
t21 = [(t15 + t16 + t17) * t47 + (t10 + t12 - t14) * t46 + t79 * t36 + 0.2e1 * t34 * t49 + 0.2e1 * t33 * t50 + 0.2e1 * t59 * t38 + 0.2e1 * t25 * t20 + 0.2e1 * t4 * t27 + 0.2e1 * t2 * t28 + 0.2e1 * t7 * t29 + 0.2e1 * t1 * t30 + 0.2e1 * t6 * t31 + 0.2e1 * t5 * t32 + 0.2e1 * t8 * t18 + 0.2e1 * t3 * t19 + (-t35 + t195) * t78 - 0.2e1 * t193 * pkin(1) * (-mrSges(3,1) * t150 + mrSges(3,2) * t147) + m(4) * (t33 ^ 2 + t34 ^ 2 + t59 ^ 2) + m(5) * (t25 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(6) * (t4 ^ 2 + t5 ^ 2 + t8 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) + Ifges(2,3) - t156 * t177 + (Ifges(3,6) * t180 + (Ifges(3,4) * t147 + Ifges(3,2) * t150) * t144) * t177 + (Ifges(3,5) * t180 + (Ifges(3,1) * t147 + Ifges(3,4) * t150) * t144) * t178 + t180 * t170 + 0.2e1 * t81 * (-mrSges(3,2) * t180 + mrSges(3,3) * t177) + 0.2e1 * t80 * (mrSges(3,1) * t180 - mrSges(3,3) * t178) + m(3) * (pkin(1) ^ 2 * t193 + t80 ^ 2 + t81 ^ 2); t170 + (pkin(9) * t49 + t34 * mrSges(4,3) + t35 / 0.2e1 - t11 / 0.2e1 - t13 / 0.2e1 + t9 / 0.2e1) * t149 + t59 * t99 + t79 * t111 / 0.2e1 + t25 * t84 + t2 * t87 + t7 * t88 + t1 * t89 + t6 * t90 + t5 * t91 + t4 * t92 + t80 * mrSges(3,1) - t81 * mrSges(3,2) + t8 * t82 + t3 * t83 + t71 * t18 + t48 * t19 + t51 * t27 + t52 * t32 + t57 * t31 + t58 * t29 + t37 * t30 - pkin(2) * t38 + t39 * t28 + m(5) * (pkin(9) * t146 * t25 + t57 * t6 + t58 * t7) + m(6) * (t4 * t51 + t5 * t52 + t71 * t8) + m(7) * (t1 * t37 + t2 * t39 + t3 * t48) + (-t107 / 0.2e1 + t64 / 0.2e1 + t66 / 0.2e1 - t62 / 0.2e1) * t78 + m(4) * (-pkin(2) * t59 + (-t146 * t33 + t149 * t34) * pkin(9)) + t163 * t47 + t164 * t46 + (t36 / 0.2e1 - t33 * mrSges(4,3) + (-t50 + t20) * pkin(9) + t165 * t148 + t166 * t145) * t146 - t173 * t177 / 0.2e1; -0.2e1 * pkin(2) * t99 + 0.2e1 * t37 * t89 + 0.2e1 * t39 * t87 + 0.2e1 * t48 * t83 + 0.2e1 * t51 * t92 + 0.2e1 * t52 * t91 + 0.2e1 * t57 * t90 + 0.2e1 * t58 * t88 + 0.2e1 * t71 * t82 + Ifges(3,3) + (t141 + t143) * mrSges(4,3) * t197 + (t107 + t62 - t64 - t66) * t149 + m(4) * (pkin(2) ^ 2 + t143 * t154 + t137) + m(5) * (t57 ^ 2 + t58 ^ 2 + t137) + m(6) * (t51 ^ 2 + t52 ^ 2 + t71 ^ 2) + m(7) * (t37 ^ 2 + t39 ^ 2 + t48 ^ 2) + (t84 * t197 + t111 + (t68 + t69 + t70) * t148 + (t63 + t65 - t67) * t145) * t146; m(7) * (t1 * t95 + t100 * t2 + t3 * t85) - t162 * t78 + t160 * t47 + t161 * t46 + t8 * t96 + t3 * t97 + t25 * t98 + t100 * t28 + t85 * t19 + t93 * t18 + t95 * t30 + t33 * mrSges(4,1) - t34 * mrSges(4,2) - pkin(3) * t20 + m(6) * (t8 * t93 + (t145 * t5 + t148 * t4) * pkin(10)) + m(5) * (-pkin(3) * t25 + (-t145 * t6 + t148 * t7) * pkin(10)) + (-t1 * mrSges(7,3) + t5 * mrSges(6,2) - t6 * mrSges(5,3) + (-t31 + t32) * pkin(10) + t165) * t145 + (t7 * mrSges(5,3) - t2 * mrSges(7,3) + t4 * mrSges(6,2) + (t27 + t29) * pkin(10) - t166) * t148 + t156; -pkin(3) * t84 + t100 * t87 + t48 * t97 + t93 * t82 + t85 * t83 + t95 * t89 + m(7) * (t100 * t39 + t37 * t95 + t48 * t85) + t162 * t149 + (-t149 * mrSges(4,2) + (-m(5) * pkin(3) - mrSges(4,1) + t98) * t146) * pkin(9) + (t51 * mrSges(6,2) + t58 * mrSges(5,3) - t39 * mrSges(7,3) + t160 * t146 + (m(5) * t58 + m(6) * t51 + t88 + t92) * pkin(10) - t164) * t148 + (t52 * mrSges(6,2) - t57 * mrSges(5,3) - t37 * mrSges(7,3) + t161 * t146 + (-m(5) * t57 + t196 - t90) * pkin(10) + t163) * t145 + t173 + (m(6) * t93 + t96) * t71; -0.2e1 * pkin(3) * t98 + 0.2e1 * t85 * t97 + 0.2e1 * t93 * t96 + Ifges(4,3) + m(6) * (t93 ^ 2 + t172) + m(7) * (t100 ^ 2 + t85 ^ 2 + t95 ^ 2) + m(5) * (pkin(3) ^ 2 + t172) + (t100 * t194 - t102 - t104 + t106) * t148 + (t194 * t95 + t108 + t109 + t110) * t145 + 0.2e1 * (mrSges(6,2) + mrSges(5,3)) * pkin(10) * t198; t6 * mrSges(5,1) - t5 * mrSges(6,1) - t1 * mrSges(7,1) - t7 * mrSges(5,2) + t2 * mrSges(7,2) + t4 * mrSges(6,3) - pkin(4) * t32 - t192 * t30 + (t27 + t28) * qJ(5) + m(7) * (qJ(5) * t2 - t1 * t192) + m(6) * (-pkin(4) * t5 + qJ(5) * t4) + t195; t57 * mrSges(5,1) - t52 * mrSges(6,1) - t37 * mrSges(7,1) - t58 * mrSges(5,2) + t39 * mrSges(7,2) + t51 * mrSges(6,3) - pkin(4) * t91 - t192 * t89 + t121 + (t87 + t92) * qJ(5) + m(6) * (-pkin(4) * t52 + qJ(5) * t51) + m(7) * (qJ(5) * t39 - t192 * t37) + t171 * t149 + (-t181 + (-Ifges(5,6) - Ifges(7,6)) * t145) * t146 + t174; m(7) * (qJ(5) * t100 - t192 * t95) - t95 * mrSges(7,1) + t100 * mrSges(7,2) + t135 + (-pkin(4) * mrSges(6,2) + mrSges(7,3) * t192 - Ifges(7,5)) * t145 + (qJ(5) * t189 - Ifges(6,6) + Ifges(7,6)) * t148 + (m(6) * t157 - t158 - t159) * pkin(10) + t103; 0.2e1 * pkin(4) * mrSges(6,1) + 0.2e1 * t192 * mrSges(7,1) + 0.2e1 * (mrSges(6,3) + mrSges(7,2)) * qJ(5) + m(6) * (pkin(4) ^ 2 + t152) + m(7) * (t192 ^ 2 + t152) - t171; m(6) * t5 + m(7) * t1 + t30 + t32; m(7) * t37 + t196 + t89; m(7) * t95 + (m(6) * pkin(10) + t189) * t145; -m(6) * pkin(4) - m(7) * t192 - mrSges(6,1) - mrSges(7,1); m(6) + m(7); m(7) * t3 + t19; m(7) * t48 + t83; m(7) * t85 + t97; 0; 0; m(7);];
