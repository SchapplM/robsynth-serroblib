...
function JaD_rot = S6PRRPRR1_jacobiaD_rot_6_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PRRPRR1_jacobiaD_rot_6_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6PRRPRR1_jacobiaD_rot_6_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6PRRPRR1_jacobiaD_rot_6_sym_varpar: pkin has to be [12x1] (double)');

%% Symbolic Calculation
% From jacobiaD_rot_6_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 20:04:06
% EndTime: 2019-02-26 20:04:07
...
t194 = t198 * t282 - t218 * t214 + t219 * t232;
...
t284 = t262 * t302 - t249;
t304 = t259 * t262;
t217 = -t254 * t304 + t260 * t284;
t250 = -qJD(2) * t289 + t265 * t295;
t209 = qJD(6) * t229 + t217 * t267 - t250 * t269;
t305 = t253 * t269;
t228 = t240 * t267 - t305;
t224 = t228 ^ 2;
...
t195 = t199 * t282 - t218 * t238 + t219 * t245;
