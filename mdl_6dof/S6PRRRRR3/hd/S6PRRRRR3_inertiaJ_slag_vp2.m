...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:33:34
% EndTime: 2018-11-23 15:33:36
...
t1 = [m(2) + m(7) * (t5 ^ 2 + t6 ^ 2 + t67) + m(6) * (t22 ^ 2 + t23 ^ 2 + t67) + m(5) * (t47 ^ 2 + t48 ^ 2 + t67) + m(4) * (t70 ^ 2 + t67 + t94) + m(3) * (t103 * t114 ^ 2 + t109 ^ 2 + t94); mrSges(4,3) * t141 + t22 * t54 + t23 * t53 + t6 * t24 + t5 * t25 + t47 * t82 + t48 * t81 + (-t114 * mrSges(3,2) + (mrSges(3,1) - t86) * t119) * t108 + (t113 * mrSges(4,3) + t10 + t32 + t71) * t68 + m(7) * (t2 * t5 + t3 * t6 + t42 * t68) + m(6) * (t19 * t22 + t20 * t23 + t68 * t83) + m(5) * (pkin(8) * t142 + t47 * t55 + t48 * t56) + m(4) * (pkin(2) * t139 + (t141 + t142) * pkin(8)); -0.2e1 * pkin(2) * t86 + 0.2e1 * t42 * t10 + 0.2e1 * t19 * t54 + 0.2e1 * t2 * t25 + 0.2e1 * t20 * t53 + 0.2e1 * t3 * t24 - t63 * t28 + t64 * t29 + t30 * t7 + t31 * t8 + 0.2e1 * t83 * t32 + 0.2e1 * t55 * t82 + 0.2e1 * t56 * t81 + Ifges(3,3) + (t105 + t107) * mrSges(4,3) * t154 + (Ifges(4,1) * t113 - t112 * t60 + t117 * t61 + t71 * t154) * t113 + m(4) * (pkin(2) ^ 2 + t107 * t121 + t101) + m(5) * (t55 ^ 2 + t56 ^ 2 + t101) + m(6) * (t19 ^ 2 + t20 ^ 2 + t83 ^ 2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t42 ^ 2) + (-t91 + (Ifges(4,2) - t134) * t118 + (Ifges(5,6) * t112 + (2 * Ifges(4,4))) * t113 + t147 + t153) * t118; -t70 * mrSges(4,2) + (t39 * t6 - t40 * t5) * mrSges(7,3) + (-t22 * t77 + t23 * t76) * mrSges(6,3) + t129 * mrSges(5,3) + (t15 + t44 + t146) * t68 + m(7) * (t12 * t5 + t13 * t6 + t57 * t68) + m(6) * (t22 * t51 + t23 * t52 + t68 * t97) + m(5) * (-pkin(3) * t68 + t129 * pkin(9)); (pkin(9) * t81 + t56 * mrSges(5,3) + t60 / 0.2e1) * t117 + (-pkin(9) * t82 - t55 * mrSges(5,3) + t61 / 0.2e1) * t112 + m(6) * (t19 * t51 + t20 * t52 + t83 * t97) + m(7) * (t12 * t2 + t13 * t3 + t42 * t57) + (-pkin(8) * mrSges(4,2) - t100 / 0.2e1 - t99 / 0.2e1 - t73 / 0.2e1 - t72 / 0.2e1 - t38 / 0.2e1 - t37 / 0.2e1 + Ifges(4,6)) * t118 + m(5) * (-pkin(3) * t102 + (-t55 * t112 + t56 * t117) * pkin(9)) + (t117 * t88 / 0.2e1 - t112 * t87 / 0.2e1 + Ifges(4,5) + t146 * pkin(8)) * t113 + t97 * t32 + t76 * t28 / 0.2e1 + t77 * t29 / 0.2e1 + t83 * t44 - t63 * t45 / 0.2e1 + t64 * t46 / 0.2e1 - pkin(3) * t71 + t52 * t53 + t51 * t54 + t57 * t10 + t39 * t7 / 0.2e1 + t40 * t8 / 0.2e1 + t42 * t15 + t30 * t16 / 0.2e1 + t31 * t17 / 0.2e1 + t13 * t24 + t12 * t25 + (-t2 * t40 + t3 * t39) * mrSges(7,3) + (-t19 * t77 + t20 * t76) * mrSges(6,3); -0.2e1 * pkin(3) * t85 + t112 * t88 + t117 * t87 + 0.2e1 * t57 * t15 + t39 * t16 + t40 * t17 + 0.2e1 * t97 * t44 + t76 * t45 + t77 * t46 + Ifges(4,3) + m(7) * (t12 ^ 2 + t13 ^ 2 + t57 ^ 2) + m(6) * (t51 ^ 2 + t52 ^ 2 + t97 ^ 2) + m(5) * (t136 * pkin(9) ^ 2 + pkin(3) ^ 2) + 0.2e1 * (-t12 * t40 + t13 * t39) * mrSges(7,3) + 0.2e1 * (-t51 * t77 + t52 * t76) * mrSges(6,3) + 0.2e1 * t136 * pkin(9) * mrSges(5,3); t47 * mrSges(5,1) - t48 * mrSges(5,2) + m(7) * (t5 * t65 + t6 * t66) + m(6) * (t111 * t23 + t116 * t22) * pkin(4) + t127; t134 * t118 - Ifges(5,6) * t138 + t91 + t125 + t65 * t25 + t66 * t24 + t55 * mrSges(5,1) - t56 * mrSges(5,2) + (m(6) * (t111 * t20 + t116 * t19) + t111 * t53 + t116 * t54) * pkin(4) + m(7) * (t2 * t65 + t3 * t66); m(7) * (t12 * t65 + t13 * t66) + t100 + t99 - t130 * pkin(9) + (t39 * t66 - t40 * t65) * mrSges(7,3) + (m(6) * (t111 * t52 + t116 * t51) + (t111 * t76 - t116 * t77) * mrSges(6,3)) * pkin(4) + t124; -0.2e1 * t149 + 0.2e1 * t62 + 0.2e1 * t126 + m(7) * (t65 ^ 2 + t66 ^ 2) + m(6) * (t111 ^ 2 + t116 ^ 2) * pkin(4) ^ 2 - t134; m(7) * (t110 * t6 + t115 * t5) * pkin(5) + t127; t148 * t118 + (t115 * t25 + m(7) * (t110 * t3 + t115 * t2) + t110 * t24) * pkin(5) + t125; (m(7) * (t110 * t13 + t115 * t12) + (t110 * t39 - t115 * t40) * mrSges(7,3)) * pkin(5) + t124; Ifges(6,3) + t98 + t126 + (m(7) * (t110 * t66 + t115 * t65) - t143) * pkin(5) + t132; -0.2e1 * t135 + 0.2e1 * t98 + m(7) * (t110 ^ 2 + t115 ^ 2) * pkin(5) ^ 2 - t148; t133; -Ifges(7,3) * t118 + t131; t128; t132; Ifges(7,3) + t98 - t135; Ifges(7,3);];
