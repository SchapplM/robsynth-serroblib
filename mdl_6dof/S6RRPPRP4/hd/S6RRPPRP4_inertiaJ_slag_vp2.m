...
t36 = -t101 * mrSges(7,1) + t50 * mrSges(7,2);
t115 = t35 - t36;
t64 = t101 * mrSges(5,1) + mrSges(5,2) * t121;
...
t2 = -pkin(5) * t101 - t3;
t1 = qJ(6) * t101 + t4;
t6 = [0.2e1 * t1 * t33 - 0.2e1 * t5 * t12 - 0.2e1 * t29 * t13 + 0.2e1 * t2 * t36 + 0.2e1 * t3 * t35 + 0.2e1 * t31 * t65 + 0.2e1 * t32 * t64 + 0.2e1 * t4 * t34 + 0.2e1 * t37 * t63 + 0.2e1 * t38 * t62 + 0.2e1 * t48 * t52 + Ifges(2,3) + (t10 + t11) * t50 + (t8 - t9) * t49 + (t94 + t95) * mrSges(3,3) * t134 + m(3) * (pkin(1) ^ 2 + t103 * t95 + t90) + m(4) * (t37 ^ 2 + t38 ^ 2 + t90) + m(5) * (t31 ^ 2 + t32 ^ 2 + t48 ^ 2) + m(6) * (t29 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(5,2) + Ifges(4,3) + Ifges(3,2)) * t101 + t104) * t101 + (-0.2e1 * pkin(1) * mrSges(3,2) + Ifges(3,1) * t99 + t53 * t134 + (t46 + t47) * t97 + (t44 - t45) * t96 + ((2 * Ifges(3,4)) + (-Ifges(5,4) - Ifges(4,5)) * t97 + (Ifges(4,6) - Ifges(5,6)) * t96) * t101) * t99; -pkin(2) * t53 + t7 * t12 + t51 * t13 - t5 * t19 - t29 * t20 + t48 * t68 + t66 * t52 + (-t44 / 0.2e1 + t45 / 0.2e1) * t97 + (t46 / 0.2e1 + t47 / 0.2e1) * t96 + (t23 / 0.2e1 + t24 / 0.2e1) * t50 + (t21 / 0.2e1 - t22 / 0.2e1) * t49 + t116 * t28 - t115 * t26 + (t56 / 0.2e1 - t55 / 0.2e1 + t57 / 0.2e1 + t54 / 0.2e1 + Ifges(3,6) - pkin(7) * mrSges(3,2) + (Ifges(5,6) / 0.2e1 - Ifges(4,6) / 0.2e1) * t97 + (-Ifges(5,4) / 0.2e1 - Ifges(4,5) / 0.2e1) * t96) * t101 + t106 * mrSges(4,3) + t107 * mrSges(5,2) + (t10 / 0.2e1 + t11 / 0.2e1 + t2 * mrSges(7,2) - t3 * mrSges(6,3)) * t61 + (t8 / 0.2e1 - t9 / 0.2e1 - t1 * mrSges(7,2) - t4 * mrSges(6,3)) * t60 + ((t62 + t65) * t97 + (-t63 + t64) * t96) * qJ(3) + (Ifges(3,5) + (t73 / 0.2e1 + t74 / 0.2e1) * t97 + (t71 / 0.2e1 - t72 / 0.2e1) * t96 + (t69 - mrSges(3,1)) * pkin(7)) * t99 + m(4) * (-pkin(2) * pkin(7) * t99 + qJ(3) * t106) + m(5) * (qJ(3) * t107 + t48 * t66) + m(6) * (-t26 * t3 + t28 * t4 - t29 * t51) + m(7) * (t1 * t28 + t2 * t26 - t5 * t7); -0.2e1 * pkin(2) * t69 + 0.2e1 * t7 * t19 + 0.2e1 * t51 * t20 + 0.2e1 * t66 * t68 + Ifges(3,3) + (-t71 + t72) * t97 + (t73 + t74) * t96 + (0.2e1 * t118 * t26 + t23 + t24) * t61 + (-0.2e1 * t118 * t28 + t21 - t22) * t60 + m(5) * (t66 ^ 2 + t114) + m(4) * (pkin(2) ^ 2 + t114) + m(6) * (t51 ^ 2 + t112) + m(7) * (t7 ^ 2 + t112) + 0.2e1 * (mrSges(5,2) + mrSges(4,3)) * qJ(3) * t135; t78 + (m(4) * pkin(7) - mrSges(5,3) * t97) * t99 + t119 * t50 + t120 * t49 + m(5) * t48 + m(6) * t29 + m(7) * t5 + t53; -m(4) * pkin(2) - t123 + t86 + (-mrSges(5,1) - mrSges(4,1)) * t97 + t119 * t61 + t120 * t60 + m(5) * t66 - m(6) * t51 - m(7) * t7; m(4) + m(5) + t133; t116 * t98 + t115 * t100 + m(7) * (t1 * t98 - t100 * t2) + m(6) * (t100 * t3 + t4 * t98) + m(5) * t32 + t64; (m(5) * qJ(3) + mrSges(5,2)) * t96 + t133 * (-t100 * t26 + t98 * t28) + t118 * (-t100 * t61 - t60 * t98); 0; m(5) + 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * (t100 ^ 2 + t98 ^ 2); -pkin(5) * t36 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + qJ(6) * t33 + t1 * mrSges(7,3) - t2 * mrSges(7,1) - t4 * mrSges(6,2) + t3 * mrSges(6,1) + t104; t57 + t54 + t56 - t55 + (-pkin(5) * t61 - qJ(6) * t60) * mrSges(7,2) + t130 * t28 - t131 * t26; 0; t131 * t100 + t130 * t98; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t136; m(7) * t2 + t36; m(7) * t26 + t61 * mrSges(7,2); 0; -m(7) * t100; t132; m(7);];
