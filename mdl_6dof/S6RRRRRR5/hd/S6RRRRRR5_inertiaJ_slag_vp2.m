...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:40:23
% EndTime: 2018-11-23 18:40:26
...
t1 = [m(6) * (t60 ^ 2 + t8 ^ 2 + t9 ^ 2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t5 ^ 2) + m(5) * (t30 ^ 2 + t31 ^ 2 + t88 ^ 2) + m(4) * (t111 ^ 2 + t76 ^ 2 + t77 ^ 2) + m(3) * (pkin(1) ^ 2 * t169 ^ 2 + t126 ^ 2 + t127 ^ 2) + (t12 - t24) * t57 + ((-0.2e1 * t126 * mrSges(3,3) + Ifges(3,5) * t170 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t175) * t169) * t175 + (0.2e1 * t127 * mrSges(3,3) + Ifges(3,6) * t170 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t175 + (Ifges(3,2) + t201) * t180) * t169 + t228 + t249 + t250) * t180) * t169 + Ifges(2,3) + (t197 - 0.2e1 * t220 + 0.2e1 * t221) * t170 + 0.2e1 * t5 * t16 + 0.2e1 * t3 * t19 + 0.2e1 * t2 * t20 + t41 * t13 + t42 * t14 + 0.2e1 * t9 * t45 + 0.2e1 * t8 * t46 + t58 * t25 + 0.2e1 * t60 * t28 + 0.2e1 * t31 * t72 + 0.2e1 * t30 * t73 + t86 * t47 + t87 * t48 + 0.2e1 * t88 * t59 + 0.2e1 * t77 * t101 + 0.2e1 * t76 * t102 + 0.2e1 * t111 * t90 + t122 * t79 + t123 * t80; t197 + (t16 - t46) * t54 + (t77 * mrSges(4,3) + pkin(9) * t101 + t79 / 0.2e1) * t179 + (-t76 * mrSges(4,3) - pkin(9) * t102 + t80 / 0.2e1) * t174 - t220 + t221 + m(7) * (t2 * t26 + t27 * t3 + t5 * t54) + m(6) * (t110 * t60 - t54 * t8 + t56 * t9) + m(5) * (t103 * t30 + t104 * t31 + t156 * t88) + (-t9 * mrSges(6,3) + t12 / 0.2e1 - t24 / 0.2e1) * t94 + (t36 / 0.2e1 - t68 / 0.2e1) * t57 - (t205 + t206 + t227) * t207 / 0.2e1 + m(4) * (-pkin(2) * t111 + (-t174 * t76 + t179 * t77) * pkin(9)) + (t132 * t31 - t133 * t30) * mrSges(5,3) + (-t8 * mrSges(6,3) - t171 * t13 / 0.2e1 + t14 * t237 + t25 / 0.2e1) * t95 + t37 * t242 + t26 * t20 + t27 * t19 + t42 * t38 / 0.2e1 + t56 * t45 + t5 * t61 + t3 * t64 + t2 * t65 + t60 * t67 + t58 * t69 / 0.2e1 - pkin(2) * t90 + t88 * t96 + t86 * t97 / 0.2e1 + t87 * t98 / 0.2e1 + t103 * t73 + t104 * t72 + t110 * t28 + t132 * t47 / 0.2e1 + t133 * t48 / 0.2e1 + t111 * t139 + t122 * t142 / 0.2e1 + t123 * t144 / 0.2e1 + t156 * t59; -0.2e1 * pkin(2) * t139 + 0.2e1 * t110 * t67 + t132 * t97 + t133 * t98 + t179 * t142 + t174 * t144 + 0.2e1 * t156 * t96 + 0.2e1 * t26 * t65 + 0.2e1 * t27 * t64 + t61 * t243 + Ifges(3,3) + (-0.2e1 * mrSges(6,3) * t56 + t36 - t68) * t94 + (mrSges(6,3) * t243 - t171 * t37 + t176 * t38 + t69) * t95 + m(7) * (t26 ^ 2 + t27 ^ 2 + t244) + m(6) * (t110 ^ 2 + t56 ^ 2 + t244) + m(5) * (t103 ^ 2 + t104 ^ 2 + t156 ^ 2) + m(4) * (pkin(9) ^ 2 * t203 + pkin(2) ^ 2) + 0.2e1 * (-t103 * t133 + t104 * t132) * mrSges(5,3) + 0.2e1 * t203 * pkin(9) * mrSges(4,3); t247 * t119 + (t173 * t72 + t178 * t73 + m(5) * (t173 * t31 + t178 * t30)) * pkin(3) + m(6) * (t120 * t8 + t121 * t9) + t186 + m(7) * (t118 * t5 + t119 * t194) + t76 * mrSges(4,1) - t77 * mrSges(4,2) + t118 * t16 + t120 * t46 + t121 * t45 - t201 * t207 - t249; t248 * t119 + m(6) * (-t120 * t54 + t121 * t56) + (m(5) * (t103 * t178 + t104 * t173) + (t132 * t173 - t133 * t178) * mrSges(5,3)) * pkin(3) + t185 + m(7) * (t118 * t54 + t119 * t192) + t118 * t61 + (-t120 * t95 - t121 * t94) * mrSges(6,3) + (-mrSges(4,1) * t174 - mrSges(4,2) * t179) * pkin(9) + t205; -0.2e1 * t222 + Ifges(4,3) + 0.2e1 * t108 + 0.2e1 * t109 + 0.2e1 * t114 + 0.2e1 * t99 + 0.2e1 * t191 + m(7) * (t119 ^ 2 * t204 + t118 ^ 2) + m(6) * (t120 ^ 2 + t121 ^ 2) + m(5) * (t173 ^ 2 + t178 ^ 2) * pkin(3) ^ 2 + t195; m(7) * (t153 * t194 + t154 * t5) + (t172 * t45 + t177 * t46 + m(6) * (t172 * t9 + t177 * t8)) * pkin(4) - t229 * t207 + t186 - t20 * t210 + t19 * t209 + t154 * t16; m(7) * (t153 * t192 + t154 * t54) + (m(6) * (t172 * t56 - t177 * t54) + (-t172 * t94 - t177 * t95) * mrSges(6,3)) * pkin(4) + t185 - t65 * t210 + t64 * t209 + t154 * t61; t191 + t190 + m(7) * (t118 * t154 + t119 * t196) + (m(6) * (t120 * t177 + t121 * t172) - t215) * pkin(4) + Ifges(5,3) + t245; -0.2e1 * t202 + 0.2e1 * t125 + 0.2e1 * t136 + 0.2e1 * t137 + 0.2e1 * t159 + m(7) * (t153 ^ 2 * t204 + t154 ^ 2) + m(6) * (t172 ^ 2 + t177 ^ 2) * pkin(4) ^ 2 + t195; -Ifges(6,3) * t207 + t188 + (-m(7) * t5 - t16) * pkin(5) + (m(7) * t194 + t247) * pkin(12); t187 + (-m(7) * t54 - t61) * pkin(5) + (m(7) * t192 + t248) * pkin(12); m(7) * (pkin(12) * t119 * t204 - pkin(5) * t118) + t190 + t246; -t202 + m(7) * (-pkin(5) * t154 + pkin(12) * t196) + t200 + t245 + t246; 0.2e1 * t157 + 0.2e1 * t158 - 0.2e1 * t232 + m(7) * (pkin(12) ^ 2 * t204 + pkin(5) ^ 2) + t200; mrSges(7,1) * t2 - mrSges(7,2) * t3 + t12; mrSges(7,1) * t26 - mrSges(7,2) * t27 + t36; -t119 * t193 + t140; -t153 * t193 + t140; -pkin(12) * t193 + t140; Ifges(7,3);];
