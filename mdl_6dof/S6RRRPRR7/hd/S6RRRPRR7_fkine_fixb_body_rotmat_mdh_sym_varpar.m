...
function Tc_mdh = S6RRRPRR7_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRPRR7_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRPRR7_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6RRRPRR7_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [12x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:31:47
	% EndTime: 2020-11-04 22:31:47
...
elseif link_index == 4
	...
	t126 = t132 * t142 + t143;
	t125 = t132 * t144 - t141;
	t124 = t127 * t137 + t133 * t135 + pkin(1);
	t123 = t131 * t140 - t139 * t132;
	t1 = [-t125 * t129 + t128 * t146, t125 * t128 + t129 * t146, t132 * t143 + t142, t123 * t136 + t124 * t138 + 0; t126 * t129 - t128 * t145, -t126 * t128 - t129 * t145, -t132 * t141 + t144, -t123 * t138 + t124 * t136 + 0; t132 * t128 + t129 * t147, -t128 * t147 + t132 * t129, -t131 * t137, t139 * t131 + t140 * t132 + pkin(7) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 5
...
elseif link_index == 6
	...
	t1 = [t176 * t195 + t181 * t192, -t176 * t192 + t181 * t195, t175, t197 * pkin(1) + t176 * pkin(5) + t175 * pkin(11) - t181 * t188 + t182 * t183 + t206 * t204 + 0; t174 * t195 + t179 * t192, -t174 * t192 + t179 * t195, t173, t194 * pkin(1) + t174 * pkin(5) + t173 * pkin(11) - t179 * t188 + t180 * t183 - t206 * t202 + 0; t178 * t195 - t192 * t203, -t178 * t192 - t195 * t203, t177, t178 * pkin(5) + t177 * pkin(11) + pkin(7) + 0 + t206 * t191 + (t183 * t193 + t188 * t196) * t190; 0, 0, 0, 1;];
	Tc_mdh = t1;
end