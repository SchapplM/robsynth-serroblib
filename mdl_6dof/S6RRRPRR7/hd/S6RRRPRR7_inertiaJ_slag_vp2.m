...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:54:55
% EndTime: 2018-11-23 17:54:57
...
t1 = [((-0.2e1 * t122 * mrSges(3,3) + Ifges(3,5) * t161 + (-0.2e1 * pkin(1) * mrSges(3,2) + Ifges(3,1) * t165) * t159) * t165 + (0.2e1 * t123 * mrSges(3,3) + Ifges(3,6) * t161 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t165 + (Ifges(3,2) + t184) * t168) * t159 + t206 + t221) * t168) * t159 + (t12 - t25) * t57 + m(7) * (t2 ^ 2 + t3 ^ 2 + t5 ^ 2) + m(6) * (t60 ^ 2 + t8 ^ 2 + t9 ^ 2) + m(5) * (t29 ^ 2 + t30 ^ 2 + t90 ^ 2) + m(4) * (t109 ^ 2 + t76 ^ 2 + t77 ^ 2) + m(3) * (pkin(1) ^ 2 * t159 ^ 2 + t122 ^ 2 + t123 ^ 2) + (t182 - 0.2e1 * t199 + 0.2e1 * t200) * t161 + Ifges(2,3) + 0.2e1 * t5 * t16 + 0.2e1 * t3 * t20 + 0.2e1 * t2 * t21 + t41 * t13 + t42 * t14 + 0.2e1 * t9 * t44 + 0.2e1 * t8 * t45 + t58 * t26 + 0.2e1 * t60 * t28 + 0.2e1 * t30 * t72 + 0.2e1 * t29 * t73 + t87 * t48 + t88 * t49 + 0.2e1 * t90 * t59 + 0.2e1 * t77 * t103 + 0.2e1 * t76 * t104 + 0.2e1 * t109 * t91 + t120 * t80 + t121 * t81; t182 + (t77 * mrSges(4,3) + pkin(9) * t103 + t80 / 0.2e1) * t167 + (-t76 * mrSges(4,3) - pkin(9) * t104 + t81 / 0.2e1) * t164 + m(7) * (t2 * t22 + t23 * t3 + t5 * t50) + m(6) * (t108 * t60 - t50 * t8 + t52 * t9) + m(5) * (t101 * t29 + t102 * t30 + t148 * t90) + (-t9 * mrSges(6,3) + t12 / 0.2e1 - t25 / 0.2e1) * t96 + (t33 / 0.2e1 - t67 / 0.2e1) * t57 + (t30 * t127 - t29 * t128) * mrSges(5,3) + m(4) * (-pkin(2) * t109 + (-t76 * t164 + t77 * t167) * pkin(9)) - t199 + t200 + (-t8 * mrSges(6,3) - t162 * t13 / 0.2e1 + t14 * t214 + t26 / 0.2e1) * t97 + (t16 - t45) * t50 + t34 * t218 + t22 * t21 + t23 * t20 + t42 * t35 / 0.2e1 + t52 * t44 - (t205 + t224) * t189 / 0.2e1 + t5 * t61 + t3 * t64 + t2 * t65 + t60 * t66 + t58 * t68 / 0.2e1 - pkin(2) * t91 + t90 * t98 + t87 * t99 / 0.2e1 + t88 * t100 / 0.2e1 + t101 * t73 + t102 * t72 + t108 * t28 + t127 * t48 / 0.2e1 + t128 * t49 / 0.2e1 + t109 * t134 + t120 * t137 / 0.2e1 + t121 * t139 / 0.2e1 + t148 * t59; -0.2e1 * pkin(2) * t134 + t128 * t100 + 0.2e1 * t108 * t66 + t127 * t99 + t167 * t137 + t164 * t139 + 0.2e1 * t148 * t98 + 0.2e1 * t22 * t65 + 0.2e1 * t23 * t64 + t61 * t219 + Ifges(3,3) + (-0.2e1 * mrSges(6,3) * t52 + t33 - t67) * t96 + (mrSges(6,3) * t219 - t162 * t34 + t166 * t35 + t68) * t97 + m(7) * (t22 ^ 2 + t23 ^ 2 + t220) + m(6) * (t108 ^ 2 + t52 ^ 2 + t220) + m(5) * (t101 ^ 2 + t102 ^ 2 + t148 ^ 2) + m(4) * (t185 * pkin(9) ^ 2 + pkin(2) ^ 2) + 0.2e1 * (-t101 * t128 + t102 * t127) * mrSges(5,3) + 0.2e1 * t185 * pkin(9) * mrSges(4,3); m(6) * (t117 * t8 + t118 * t9) - t184 * t189 + (t158 * t72 + t160 * t73 + m(5) * (t158 * t30 + t160 * t29)) * pkin(3) + m(7) * (t113 * t5 + t178 * t114) + t222 * t114 + t173 + t29 * mrSges(5,1) - t30 * mrSges(5,2) + t76 * mrSges(4,1) - t77 * mrSges(4,2) + t113 * t16 + t117 * t45 + t118 * t44 - t221; t223 * t114 + m(6) * (-t117 * t50 + t118 * t52) + (m(5) * (t101 * t160 + t102 * t158) + (t127 * t158 - t128 * t160) * mrSges(5,3)) * pkin(3) + m(7) * (t113 * t50 + t176 * t114) + (-mrSges(4,1) * t164 - mrSges(4,2) * t167) * pkin(9) + (-t117 * t97 - t118 * t96) * mrSges(6,3) + t172 + t101 * mrSges(5,1) - t102 * mrSges(5,2) + t113 * t61 + t224; 0.2e1 * t202 - 0.2e1 * t201 + 0.2e1 * t113 * t133 + t114 * t175 + m(7) * (t186 * t114 ^ 2 + t113 ^ 2) + m(6) * (t117 ^ 2 + t118 ^ 2) + t183 + (0.2e1 * mrSges(5,1) * t160 - 0.2e1 * mrSges(5,2) * t158 + m(5) * (t158 ^ 2 + t160 ^ 2) * pkin(3)) * pkin(3) + t225; t162 * t20 + t166 * t21 + m(7) * (t162 * t3 + t166 * t2) + m(6) * t60 + m(5) * t90 + t28 + t59; t162 * t64 + t166 * t65 + m(7) * (t162 * t23 + t166 * t22) + m(6) * t108 + m(5) * t148 + t98 + t66; 0; m(7) * t186 + m(5) + m(6); -Ifges(6,3) * t189 + t173 + (-m(7) * t5 - t16) * pkin(5) + (m(7) * t178 + t222) * pkin(11); t172 + (-m(7) * t50 - t61) * pkin(5) + (m(7) * t176 + t223) * pkin(11); m(7) * (-pkin(5) * t113 + pkin(11) * t179) - t201 + t202 + (t113 - pkin(5)) * t133 + (t186 * pkin(11) + t179) * mrSges(7,3) + t183; 0; -0.2e1 * pkin(5) * t133 + m(7) * (t186 * pkin(11) ^ 2 + pkin(5) ^ 2) + pkin(11) * t175 + t183; mrSges(7,1) * t2 - mrSges(7,2) * t3 + t12; mrSges(7,1) * t22 - mrSges(7,2) * t23 + t33; -t177 * t114 + t135; -t133; -t177 * pkin(11) + t135; Ifges(7,3);];
