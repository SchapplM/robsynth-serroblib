% Umwandlung der Kinematikparameter von S6RRRRPP4V1 zu S6RRRRPP4
% Eingabe:
% pkin_var (6x1) double
...
%
% Siehe auch: S6RRRRPP4_structural_kinematic_parameters.m
function pkin_gen = S6RRRRPP4V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
