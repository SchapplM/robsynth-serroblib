...
t1 = [0.2e1 * t100 * t51 + 0.2e1 * t7 * t13 + 0.2e1 * t63 * t14 + 0.2e1 * t2 * t34 + 0.2e1 * t3 * t37 + 0.2e1 * t32 * t73 + 0.2e1 * t33 * t72 + 0.2e1 * t6 * t35 + 0.2e1 * t5 * t36 - t84 * t45 + t85 * t46 + 0.2e1 * t75 * t99 + 0.2e1 * t76 * t98 + Ifges(2,3) + (t10 + t11) * t48 + (t8 - t9) * t47 + (t120 + t122) * mrSges(3,3) * t160 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t127 - t126 * t80 + t129 * t81 + t89 * t160) * t127 + m(3) * (pkin(1) ^ 2 + t122 * t132 + t117) + m(4) * (t75 ^ 2 + t76 ^ 2 + t117) + m(5) * (t100 ^ 2 + t32 ^ 2 + t33 ^ 2) + m(6) * (t5 ^ 2 + t6 ^ 2 + t63 ^ 2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t7 ^ 2) + (0.2e1 * pkin(1) * mrSges(3,1) - t107 + (Ifges(3,2) + t142) * t130 + (Ifges(4,6) * t126 + (2 * Ifges(3,4))) * t127 + t139) * t130; (t34 + t35) * t23 + (-t36 + t37) * t21 + m(5) * (t100 * t113 + t32 * t70 + t33 * t71) + m(6) * (-t21 * t5 + t23 * t6 + t63 * t77) + m(7) * (t17 * t7 + t2 * t23 + t21 * t3) + m(4) * (-pkin(2) * t118 + (-t126 * t75 + t129 * t76) * pkin(8)) + t100 * t65 + t113 * t51 - pkin(2) * t89 + t94 * t45 / 0.2e1 + t95 * t46 / 0.2e1 - t84 * t66 / 0.2e1 + t85 * t67 / 0.2e1 + t71 * t72 + t70 * t73 + t77 * t14 + t63 * t26 + (Ifges(3,5) + t129 * t104 / 0.2e1 - t126 * t103 / 0.2e1 + (t102 - mrSges(3,1)) * pkin(7)) * t127 + (t10 / 0.2e1 + t11 / 0.2e1 + t3 * mrSges(7,2) - t5 * mrSges(6,3)) * t61 + (t8 / 0.2e1 - t9 / 0.2e1 - t2 * mrSges(7,2) - t6 * mrSges(6,3)) * t60 + (t29 / 0.2e1 + t30 / 0.2e1) * t48 + (t27 / 0.2e1 - t28 / 0.2e1) * t47 + t7 * t25 + t17 * t13 + (-t116 / 0.2e1 - t115 / 0.2e1 - t91 / 0.2e1 - t90 / 0.2e1 - t58 / 0.2e1 + t57 / 0.2e1 - t59 / 0.2e1 - t56 / 0.2e1 + Ifges(3,6) - pkin(7) * mrSges(3,2)) * t130 + (-t32 * t95 + t33 * t94) * mrSges(5,3) + (t80 / 0.2e1 + pkin(8) * t98 + t76 * mrSges(4,3)) * t129 + (t81 / 0.2e1 - pkin(8) * t99 - t75 * mrSges(4,3)) * t126; -0.2e1 * pkin(2) * t102 + t129 * t103 + t126 * t104 + 0.2e1 * t113 * t65 + 0.2e1 * t17 * t25 + 0.2e1 * t77 * t26 + t94 * t66 + t95 * t67 + Ifges(3,3) + (t29 + t30) * t61 + (t27 - t28) * t60 + m(4) * (pkin(8) ^ 2 * t147 + pkin(2) ^ 2) + m(5) * (t113 ^ 2 + t70 ^ 2 + t71 ^ 2) + m(6) * (t77 ^ 2 + t146) + m(7) * (t17 ^ 2 + t146) + 0.2e1 * (-t70 * t95 + t71 * t94) * mrSges(5,3) + 0.2e1 * t147 * pkin(8) * mrSges(4,3) + 0.2e1 * (t21 * t61 - t23 * t60) * (mrSges(7,2) + mrSges(6,3)); t136 + m(7) * (t2 * t82 + t3 * t83) + m(6) * (t5 * t86 + t6 * t87) + t107 - t142 * t130 + t82 * t34 + t83 * t37 + t86 * t36 + t87 * t35 + t75 * mrSges(4,1) - t76 * mrSges(4,2) - Ifges(4,6) * t149 + (m(5) * (t125 * t33 + t128 * t32) + t128 * t73 + t125 * t72) * pkin(3); -t141 * pkin(8) + (-t60 * t87 - t61 * t86) * mrSges(6,3) + (-t60 * t82 + t61 * t83) * mrSges(7,2) + t135 + t115 + t116 + (m(5) * (t125 * t71 + t128 * t70) + (t125 * t94 - t128 * t95) * mrSges(5,3)) * pkin(3) + m(7) * (t21 * t83 + t23 * t82) + m(6) * (-t21 * t86 + t23 * t87); 0.2e1 * t154 + t83 * t159 - 0.2e1 * t153 + t82 * t158 + 0.2e1 * t138 + m(6) * (t86 ^ 2 + t87 ^ 2) + m(7) * (t82 ^ 2 + t83 ^ 2) + m(5) * (t125 ^ 2 + t128 ^ 2) * pkin(3) ^ 2 + t142; m(7) * (t110 * t2 + t111 * t3) - t145 * t130 + t136 + t110 * t34 + t111 * t37 + (t123 * t35 + t124 * t36 + m(6) * (t123 * t6 + t124 * t5)) * pkin(4); t135 + (-t110 * t60 + t111 * t61) * mrSges(7,2) + m(7) * (t110 * t23 + t111 * t21) + (m(6) * (t123 * t23 - t124 * t21) + (-t123 * t60 - t124 * t61) * mrSges(6,3)) * pkin(4); m(7) * (t110 * t82 + t111 * t83) - t153 + t154 + t138 + (t110 + t82) * mrSges(7,3) + (-t111 - t83) * mrSges(7,1) + (m(6) * (t123 * t87 + t124 * t86) + t140) * pkin(4) + t145; t111 * t159 + t110 * t158 + m(7) * (t110 ^ 2 + t111 ^ 2) + t145 + (0.2e1 * t140 + m(6) * (t123 ^ 2 + t124 ^ 2) * pkin(4)) * pkin(4); m(6) * t63 + m(7) * t7 + t13 + t14; m(6) * t77 + m(7) * t17 + t25 + t26; 0; 0; m(6) + m(7); m(7) * t3 + t37; m(7) * t21 + t61 * mrSges(7,2); m(7) * t83 - mrSges(7,1); m(7) * t111 - mrSges(7,1); 0; m(7);];
