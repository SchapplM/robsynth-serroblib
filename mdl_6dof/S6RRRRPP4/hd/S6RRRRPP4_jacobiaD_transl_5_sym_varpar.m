...
function JaD_transl = S6RRRRPP4_jacobiaD_transl_5_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(3,1),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRPP4_jacobiaD_transl_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRRPP4_jacobiaD_transl_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S6RRRRPP4_jacobiaD_transl_5_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRRRPP4_jacobiaD_transl_5_sym_varpar: pkin has to be [10x1] (double)');

%% Symbolic Calculation
% From jacobiaD_transl_5_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 22:27:00
...
t233 = t280 * t285;
t1 = [t230 * r_i_i_C(1) + t229 * r_i_i_C(2) - t295 * t249 + t255 * t252, t253 * t252 - t254 * t277, t249 * t263 + t252 * t258 + t279 (t241 * t256 - t242 * t262) * pkin(4) + t279, -t248 * t277 + t251 * t272, 0; -t228 * r_i_i_C(1) + t227 * r_i_i_C(2) + t255 * t249 + t295 * t252, t249 * t253 + t254 * t275, t249 * t258 - t252 * t263 + t278 (-t241 * t290 - t242 * t261) * pkin(4) + t278, t248 * t275 + t249 * t273, 0; 0, t254 * qJD(2) - t291 * t251 + t271, t233 + (-t245 * t286 - t232) * t248 + (-t235 - t264) * t273, t233 + (-t286 - t239) * t280 + (-t264 - t288) * t273, t274, 0;];
JaD_transl  = t1;
