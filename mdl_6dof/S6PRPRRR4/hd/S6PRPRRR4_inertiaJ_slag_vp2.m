...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:05:23
% EndTime: 2018-11-23 15:05:24
...
t58 = t116 * t80 + t86 * t82;
t36 = t57 * mrSges(5,1) + t58 * mrSges(5,2);
t61 = -t82 * mrSges(4,1) + t80 * mrSges(4,2);
t124 = -t36 - t61;
t89 = cos(qJ(5));
t111 = t58 * t89;
...
t110 = t81 * t87;
t83 = cos(pkin(6));
t48 = -t80 * t110 + t82 * t83;
t49 = t82 * t110 + t80 * t83;
t24 = -t116 * t48 + t49 * t86;
t21 = t24 ^ 2;
t108 = pkin(8) + qJ(3);
t100 = t108 * t80;
t62 = t108 * t82;
t40 = t116 * t100 + t62 * t86;
t122 = t40 ^ 2;
t77 = t82 ^ 2;
t121 = 0.2e1 * t40;
t120 = m(7) * pkin(5);
...
t26 = t116 * t49 + t86 * t48;
t16 = -t89 * t109 - t26 * t85;
t17 = -t85 * t109 + t26 * t89;
t5 = t16 * t88 - t17 * t84;
t6 = t16 * t84 + t17 * t88;
t101 = t5 * mrSges(7,1) - t6 * mrSges(7,2);
t37 = -t59 * mrSges(7,1) + t60 * mrSges(7,2);
t12 = t89 * t32 - t42 * t85;
...
t44 = t66 * t88 + t67 * t84;
t45 = t66 * t84 - t67 * t88;
t96 = t44 * mrSges(7,1) - t45 * mrSges(7,2) + t107;
t10 = -pkin(10) * t112 + t13;
t7 = pkin(5) * t57 - pkin(10) * t111 + t12;
t2 = -t10 * t84 + t7 * t88;
t3 = t10 * t88 + t7 * t84;
t95 = t2 * mrSges(7,1) - t3 * mrSges(7,2) + t102;
...
t1 = [m(2) + m(7) * (t5 ^ 2 + t6 ^ 2 + t21) + m(6) * (t16 ^ 2 + t17 ^ 2 + t21) + m(5) * (t26 ^ 2 + t21 + t68) + m(4) * (t48 ^ 2 + t49 ^ 2 + t68) + m(3) * (t76 * t87 ^ 2 + t83 ^ 2 + t68); -t26 * t57 * mrSges(5,3) + t6 * t14 + t5 * t15 + t16 * t34 + t17 * t33 + t97 * mrSges(4,3) + (t58 * mrSges(5,3) + t11 + t31) * t24 + (-t87 * mrSges(3,2) + (mrSges(3,1) + t124) * t90) * t81 + m(7) * (t2 * t5 + t20 * t24 + t3 * t6) + m(6) * (t12 * t16 + t13 * t17 + t113) + m(5) * (-t70 * t109 + t26 * t42 + t113) + m(4) * (pkin(2) * t109 + t97 * qJ(3)); Ifges(4,2) * t77 - 0.2e1 * pkin(2) * t61 + 0.2e1 * t20 * t11 + 0.2e1 * t12 * t34 + 0.2e1 * t13 * t33 + 0.2e1 * t3 * t14 + 0.2e1 * t2 * t15 - t27 * t8 + t28 * t9 + t31 * t121 + 0.2e1 * t70 * t36 + Ifges(3,3) + (Ifges(4,1) * t80 + 0.2e1 * Ifges(4,4) * t82) * t80 + 0.2e1 * t104 * qJ(3) * mrSges(4,3) + (mrSges(5,3) * t121 + Ifges(5,1) * t58 - t18 * t85 + t19 * t89) * t58 + (-0.2e1 * t42 * mrSges(5,3) + Ifges(5,2) * t57 + (-Ifges(6,6) * t85 - (2 * Ifges(5,4))) * t58 + t102 + t123) * t57 + m(4) * (t104 * qJ(3) ^ 2 + pkin(2) ^ 2) + m(5) * (t42 ^ 2 + t70 ^ 2 + t122) + m(6) * (t12 ^ 2 + t13 ^ 2 + t122) + m(7) * (t2 ^ 2 + t20 ^ 2 + t3 ^ 2); t118 * t109 + m(7) * (t5 * t59 + t6 * t60) + m(6) * (t16 * t89 + t17 * t85); -m(4) * pkin(2) + t60 * t14 + t59 * t15 + t85 * t33 + t89 * t34 + m(7) * (t2 * t59 + t3 * t60) + m(6) * (t12 * t89 + t13 * t85) + m(5) * t70 - t124; m(6) * t103 + m(7) * (t59 ^ 2 + t60 ^ 2) - t118; -t26 * mrSges(5,2) + (-t5 * t60 + t59 * t6) * mrSges(7,3) + t98 * mrSges(6,3) + (t37 + t106) * t24 + m(7) * (t24 * t71 + t44 * t5 + t45 * t6) + m(6) * (-pkin(4) * t24 + t98 * pkin(9)); t71 * t11 - Ifges(5,6) * t57 + t59 * t8 / 0.2e1 + t60 * t9 / 0.2e1 + t45 * t14 - pkin(4) * t31 + t20 * t37 - t27 * t38 / 0.2e1 + t28 * t39 / 0.2e1 - t42 * mrSges(5,2) + t44 * t15 + t106 * t40 + (-t2 * t60 + t3 * t59) * mrSges(7,3) + (pkin(9) * t33 + t13 * mrSges(6,3) + t18 / 0.2e1) * t89 + (-pkin(9) * t34 - t12 * mrSges(6,3) + t19 / 0.2e1) * t85 + m(6) * (-pkin(4) * t40 + (-t12 * t85 + t13 * t89) * pkin(9)) + m(7) * (t2 * t44 + t20 * t71 + t3 * t45) + (-t85 * t64 / 0.2e1 + t89 * t65 / 0.2e1 + Ifges(5,5)) * t58 + (t105 + t107) * t57 / 0.2e1; m(7) * (t44 * t59 + t45 * t60); -0.2e1 * pkin(4) * t63 + 0.2e1 * t71 * t37 + t59 * t38 + t60 * t39 + t89 * t64 + t85 * t65 + Ifges(5,3) + m(7) * (t44 ^ 2 + t45 ^ 2 + t71 ^ 2) + m(6) * (t103 * pkin(9) ^ 2 + pkin(4) ^ 2) + 0.2e1 * (-t44 * t60 + t45 * t59) * mrSges(7,3) + 0.2e1 * t103 * pkin(9) * mrSges(6,3); t16 * mrSges(6,1) - t17 * mrSges(6,2) + (t5 * t88 + t6 * t84) * t120 + t101; -Ifges(6,6) * t112 + t12 * mrSges(6,1) - t13 * mrSges(6,2) + (m(7) * (t2 * t88 + t3 * t84) + t84 * t14 + t88 * t15) * pkin(5) + t95 + t123; (t59 * t88 + t60 * t84) * t120 - t63 - t37; -t99 * pkin(9) + (m(7) * (t44 * t88 + t45 * t84) + (t59 * t84 - t60 * t88) * mrSges(7,3)) * pkin(5) + t96 + t105; Ifges(6,3) + Ifges(7,3) + m(7) * (t84 ^ 2 + t88 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t94; t101; t95; -t37; t96; Ifges(7,3) + t94; Ifges(7,3);];
