...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:29:10
% EndTime: 2018-11-23 18:29:12
...
t1 = [0.2e1 * t76 * t101 + 0.2e1 * t75 * t102 + 0.2e1 * t103 * t51 + 0.2e1 * t24 * t17 + 0.2e1 * t64 * t18 + 0.2e1 * t2 * t37 + 0.2e1 * t3 * t35 + 0.2e1 * t32 * t74 + 0.2e1 * t33 * t73 + 0.2e1 * t6 * t36 + 0.2e1 * t5 * t38 - t85 * t44 + t86 * t45 + Ifges(2,3) + (t12 + t13) * t47 + (t10 + t11) * t46 + (t125 + t127) * mrSges(3,3) * t176 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t131 - t130 * t82 + t134 * t83 + t91 * t176) * t131 + m(3) * (pkin(1) ^ 2 + t127 * t138 + t122) + m(4) * (t75 ^ 2 + t76 ^ 2 + t122) + m(5) * (t103 ^ 2 + t32 ^ 2 + t33 ^ 2) + m(6) * (t5 ^ 2 + t6 ^ 2 + t64 ^ 2) + m(7) * (t2 ^ 2 + t24 ^ 2 + t3 ^ 2) + (0.2e1 * pkin(1) * mrSges(3,1) - t112 + (Ifges(3,2) + t151) * t135 + (Ifges(4,6) * t130 + (2 * Ifges(3,4))) * t131 + t150 + t174) * t135; m(6) * (t21 * t5 + t22 * t6 + t64 * t78) + m(7) * (t2 * t8 + t24 * t34 + t3 * t9) + m(5) * (t103 * t117 + t32 * t71 + t33 * t72) + t117 * t51 + t103 * t66 - pkin(2) * t91 + t96 * t44 / 0.2e1 + t97 * t45 / 0.2e1 - t85 * t67 / 0.2e1 + t86 * t68 / 0.2e1 + t64 * t26 + t72 * t73 + t71 * t74 + t78 * t18 + (t12 / 0.2e1 + t13 / 0.2e1 - t2 * mrSges(7,3) - t5 * mrSges(6,3)) * t62 + (t10 / 0.2e1 + t11 / 0.2e1 + t3 * mrSges(7,3) + t6 * mrSges(6,3)) * t61 + (Ifges(3,5) + t134 * t107 / 0.2e1 - t130 * t106 / 0.2e1 + (t105 - mrSges(3,1)) * pkin(7)) * t131 + (t29 / 0.2e1 + t30 / 0.2e1) * t47 + (t27 / 0.2e1 + t28 / 0.2e1) * t46 + m(4) * (-pkin(2) * t123 + (-t130 * t75 + t134 * t76) * pkin(8)) + t34 * t17 + t9 * t35 + t22 * t36 + t8 * t37 + t21 * t38 + t24 * t25 + (-t120 / 0.2e1 - t119 / 0.2e1 - t93 / 0.2e1 - t92 / 0.2e1 - t59 / 0.2e1 - t57 / 0.2e1 - t60 / 0.2e1 - t58 / 0.2e1 + Ifges(3,6) - pkin(7) * mrSges(3,2)) * t135 + (-t32 * t97 + t33 * t96) * mrSges(5,3) + (t82 / 0.2e1 + pkin(8) * t101 + t76 * mrSges(4,3)) * t134 + (t83 / 0.2e1 - pkin(8) * t102 - t75 * mrSges(4,3)) * t130; -0.2e1 * pkin(2) * t105 + t134 * t106 + t130 * t107 + 0.2e1 * t117 * t66 + 0.2e1 * t34 * t25 + 0.2e1 * t78 * t26 + t96 * t67 + t97 * t68 + Ifges(3,3) + (-0.2e1 * mrSges(6,3) * t21 - 0.2e1 * mrSges(7,3) * t8 + t29 + t30) * t62 + (0.2e1 * mrSges(6,3) * t22 + 0.2e1 * mrSges(7,3) * t9 + t27 + t28) * t61 + m(4) * (t156 * pkin(8) ^ 2 + pkin(2) ^ 2) + m(5) * (t117 ^ 2 + t71 ^ 2 + t72 ^ 2) + m(6) * (t21 ^ 2 + t22 ^ 2 + t78 ^ 2) + m(7) * (t34 ^ 2 + t8 ^ 2 + t9 ^ 2) + 0.2e1 * (-t71 * t97 + t72 * t96) * mrSges(5,3) + 0.2e1 * t156 * pkin(8) * mrSges(4,3); t162 * t90 + m(7) * (t2 * t87 + t3 * t90) + m(6) * (t5 * t89 + t6 * t90) + t142 - t151 * t135 + t112 + t87 * t37 + t89 * t38 + t75 * mrSges(4,1) - t76 * mrSges(4,2) - Ifges(4,6) * t158 + (m(5) * (t129 * t33 + t133 * t32) + t133 * t74 + t129 * t73) * pkin(3); (-t62 * t87 + t165) * mrSges(7,3) + (-t62 * t89 + t165) * mrSges(6,3) + t141 + t119 + t120 - t146 * pkin(8) + m(7) * (t8 * t87 + t9 * t90) + m(6) * (t21 * t89 + t22 * t90) + (m(5) * (t129 * t72 + t133 * t71) + (t129 * t96 - t133 * t97) * mrSges(5,3)) * pkin(3); 0.2e1 * t81 + 0.2e1 * t84 + m(6) * (t89 ^ 2 + t88) + m(7) * (t87 ^ 2 + t88) + m(5) * (t129 ^ 2 + t133 ^ 2) * pkin(3) ^ 2 + t151 - 0.2e1 * t153 + 0.2e1 * t145; t155 * t135 + t142 + t154 * t115 + (t132 * t38 + t162 * t128 + t3 * t170 + m(6) * (t128 * t6 + t132 * t5)) * pkin(4); t141 + t147 * t115 + (mrSges(7,3) * t159 + (-t132 * t62 + t159) * mrSges(6,3) + t9 * t170 + m(6) * (t128 * t22 + t132 * t21)) * pkin(4); Ifges(5,3) + t145 + m(6) * (t89 * t167 + t77) + m(7) * (t115 * t87 + t77) + t149 + t175 * (-t90 - t168) + t173; 0.2e1 * t111 + 0.2e1 * t118 - 0.2e1 * t148 + m(7) * (t115 ^ 2 + t121) + m(6) * (t132 ^ 2 * t139 + t121) - t155; t154 * pkin(5) - t163 * t135 + t144; pkin(5) * t147 + t143; t87 * t172 + t136 - t153 + t163 + t173; t115 * t172 + t136 - t148 + t149; m(7) * pkin(5) ^ 2 + 0.2e1 * t136 + t163; m(7) * t24 + t17; m(7) * t34 + t25; 0; 0; 0; m(7);];
