...
t2 = -pkin(5) * t72 - t3;
t1 = qJ(6) * t72 + t4;
t6 = [Ifges(3,2) * t92 - 0.2e1 * pkin(1) * t110 + t60 * t130 + 0.2e1 * t17 * t40 + 0.2e1 * t16 * t41 + t37 * t131 + 0.2e1 * t4 * t18 + 0.2e1 * t3 * t19 + 0.2e1 * t2 * t20 + 0.2e1 * t1 * t21 + 0.2e1 * t24 * t15 + 0.2e1 * t5 * t14 + Ifges(2,3) + (Ifges(3,1) * t96 + 0.2e1 * Ifges(3,4) * t98) * t96 + (t10 + t11) * t34 + (t8 - t9) * t33 + 0.2e1 * t117 * qJ(2) * mrSges(3,3) + (mrSges(4,3) * t131 + Ifges(4,1) * t74 + t101 * t23 - t22 * t99) * t74 + (mrSges(4,1) * t130 - 0.2e1 * mrSges(4,3) * t51 + Ifges(4,2) * t72 + (-Ifges(5,6) * t99 - (2 * Ifges(4,4))) * t74 + t105) * t72 + m(3) * (t117 * qJ(2) ^ 2 + pkin(1) ^ 2) + m(4) * (t51 ^ 2 + t86 ^ 2 + t132) + m(5) * (t16 ^ 2 + t17 ^ 2 + t132) + m(6) * (t24 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2); -m(3) * pkin(1) + t72 * mrSges(4,1) + t101 * t41 + t99 * t40 + t60 + t122 * t73 - t121 * t107 + m(7) * (t1 * t73 - t107 * t2) + m(6) * (t107 * t3 + t4 * t73) + m(5) * (t101 * t16 + t17 * t99) + m(4) * t86 + t110; m(5) * t116 + m(3) + m(4) + t134 * (t107 ^ 2 + t73 ^ 2); t87 * t15 + Ifges(4,5) * t74 + t5 * t43 + t24 * t44 - t51 * mrSges(4,2) - pkin(3) * t37 + t38 * t14 + t122 * t55 + t121 * t53 + (t78 - mrSges(4,1)) * t49 + (t47 / 0.2e1 + t48 / 0.2e1) * t34 + (t45 / 0.2e1 - t46 / 0.2e1) * t33 + (t23 / 0.2e1 - t74 * t80 / 0.2e1 - pkin(8) * t41 - t16 * mrSges(5,3)) * t99 + (t22 / 0.2e1 + t74 * t81 / 0.2e1 + pkin(8) * t40 + t17 * mrSges(5,3)) * t101 + m(5) * (-pkin(3) * t49 + (t17 * t101 - t16 * t99) * pkin(8)) + m(6) * (t24 * t87 - t3 * t53 + t4 * t55) + m(7) * (t1 * t55 + t2 * t53 + t38 * t5) + (-t3 * mrSges(6,3) + t10 / 0.2e1 + t11 / 0.2e1 + t2 * mrSges(7,2)) * t73 - (t8 / 0.2e1 - t9 / 0.2e1 - t1 * mrSges(7,2) - t4 * mrSges(6,3)) * t107 + (-Ifges(4,6) + t133 / 0.2e1) * t72; t134 * (-t107 * t53 + t55 * t73); -0.2e1 * pkin(3) * t78 + t101 * t80 + 0.2e1 * t38 * t43 + 0.2e1 * t87 * t44 + t99 * t81 + Ifges(4,3) + m(7) * (t38 ^ 2 + t113) + m(6) * (t87 ^ 2 + t113) + m(5) * (t116 * pkin(8) ^ 2 + pkin(3) ^ 2) + (t47 + t48) * t73 - (t45 - t46) * t107 + 0.2e1 * t116 * pkin(8) * mrSges(5,3) + 0.2e1 * (t107 * t55 + t53 * t73) * (mrSges(7,2) + mrSges(6,3)); t105 + m(7) * (t1 * t82 + t2 * t85) - Ifges(5,6) * t126 + t82 * t21 + t85 * t20 + t16 * mrSges(5,1) - t17 * mrSges(5,2) - t2 * mrSges(7,1) + t3 * mrSges(6,1) - t4 * mrSges(6,2) + t1 * mrSges(7,3) + (m(6) * (t3 * t97 + t4 * t95) + t95 * t18 + t97 * t19) * pkin(4); m(7) * (-t107 * t85 + t73 * t82) + (t107 * t97 + t73 * t95) * t135 + t106 - t78; m(7) * (t53 * t85 + t55 * t82) + t55 * mrSges(7,3) - t55 * mrSges(6,2) - t53 * mrSges(6,1) - t53 * mrSges(7,1) - t108 * pkin(8) + (t107 * t82 + t73 * t85) * mrSges(7,2) + (m(6) * (-t53 * t97 + t55 * t95) + (t107 * t95 - t73 * t97) * mrSges(6,3)) * pkin(4) + t133; -0.2e1 * t85 * mrSges(7,1) + 0.2e1 * t82 * mrSges(7,3) + m(7) * (t82 ^ 2 + t85 ^ 2) + (0.2e1 * mrSges(6,1) * t97 - 0.2e1 * mrSges(6,2) * t95 + (t95 ^ 2 + t97 ^ 2) * t135) * pkin(4) + t136; m(6) * t24 + m(7) * t5 + t14 + t15; 0; m(6) * t87 + m(7) * t38 - t106; 0; t134; m(7) * t2 + t20; -m(7) * t107; m(7) * t53 + t73 * mrSges(7,2); m(7) * t85 - mrSges(7,1); 0; m(7);];
