...
t4 = -pkin(5) * t55 - t6;
t25 = [0.2e1 * t81 * t58 + t85 * t44 + t86 * t45 + 0.2e1 * t43 * t73 + 0.2e1 * t42 * t74 + 0.2e1 * t57 * t23 + t32 * t9 + t33 * t10 + 0.2e1 * t6 * t38 + 0.2e1 * t7 * t39 + 0.2e1 * t12 * t40 + 0.2e1 * t11 * t41 + 0.2e1 * t13 * t24 + 0.2e1 * t4 * t14 + 0.2e1 * t2 * t17 + 0.2e1 * t1 * t18 + m(3) * (pkin(1) ^ 2 * t125 ^ 2 + t87 ^ 2 + t88 ^ 2) + m(4) * (t42 ^ 2 + t43 ^ 2 + t81 ^ 2) + m(5) * (t11 ^ 2 + t12 ^ 2 + t57 ^ 2) + m(6) * (t13 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t4 ^ 2) + (t22 + t8 - t20) * t56 + (t19 - t21) * t55 + (t144 - 0.2e1 * t161 + 0.2e1 * t162) * t127 + ((-0.2e1 * t87 * mrSges(3,3) + Ifges(3,5) * t127 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t130) * t125) * t130 + (0.2e1 * t88 * mrSges(3,3) - Ifges(4,5) * t86 + Ifges(3,6) * t127 - Ifges(4,6) * t85 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t130 + (Ifges(3,2) + Ifges(4,3) + t158) * t132) * t125 + t141) * t132) * t125 + Ifges(2,3); m(5) * (-t11 * t69 + t115 * t57 + t12 * t71) + m(6) * (t13 * t59 - t6 * t71 + t69 * t7) + m(7) * (t1 * t15 + t16 * t2 + t4 * t47) + (t22 / 0.2e1 + t8 / 0.2e1 - t20 / 0.2e1 - t11 * mrSges(5,3) + t7 * mrSges(6,1)) * t98 + m(4) * (-pkin(2) * t81 + (-t124 * t42 + t126 * t43) * qJ(3)) + t81 * t100 + t85 * t102 / 0.2e1 + t86 * t103 / 0.2e1 + t115 * t23 - pkin(2) * t58 + t59 * t24 - t4 * t60 + t1 * t61 + t2 * t62 + t57 * t63 + t13 * t64 + t47 * t14 - (Ifges(4,5) * t124 + Ifges(4,6) * t126 + t173) * t148 / 0.2e1 + (t68 / 0.2e1 + t35 / 0.2e1 - t66 / 0.2e1) * t56 + (-t67 / 0.2e1 + t65 / 0.2e1) * t55 + (t44 / 0.2e1 + qJ(3) * t73 + t43 * mrSges(4,3)) * t126 + (t45 / 0.2e1 - qJ(3) * t74 - t42 * mrSges(4,3)) * t124 + t16 * t17 + t15 * t18 + (t40 - t38) * t71 + (t39 - t41) * t69 + t144 + t162 - t161 + t33 * t171 + t36 * t172 + (t19 / 0.2e1 - t21 / 0.2e1 + t10 * t168 + t9 * t167 - t12 * mrSges(5,3) + t6 * mrSges(6,1)) * t97; -0.2e1 * pkin(2) * t100 + t126 * t102 + t124 * t103 + 0.2e1 * t115 * t63 + 0.2e1 * t15 * t61 + 0.2e1 * t16 * t62 - 0.2e1 * t47 * t60 + 0.2e1 * t59 * t64 + Ifges(3,3) + (t35 - t66 + t68) * t98 + m(4) * (t147 * qJ(3) ^ 2 + pkin(2) ^ 2) + m(5) * (t115 ^ 2 + t145) + m(6) * (t59 ^ 2 + t145) + m(7) * (t15 ^ 2 + t16 ^ 2 + t47 ^ 2) + (t128 * t37 + t131 * t36 + t65 - t67) * t97 + 0.2e1 * t147 * qJ(3) * mrSges(4,3) + 0.2e1 * (t69 * t98 - t71 * t97) * (mrSges(6,1) + mrSges(5,3)); -t128 * t18 + t131 * t17 + t48 - t49 + t159 * t55 + m(7) * (-t1 * t128 + t131 * t2) + m(6) * t13 + m(5) * t57 + m(4) * t81 + t58; -m(4) * pkin(2) - t128 * t61 + t131 * t62 + t89 - t90 + t159 * t97 + m(7) * (-t128 * t15 + t131 * t16) + m(6) * t59 + m(5) * t115 + t100; m(4) + m(5) + t165; t4 * t104 + t56 * t169 + t106 * t172 + t33 * t107 / 0.2e1 - pkin(4) * t39 - t6 * mrSges(6,3) + t7 * mrSges(6,2) + t11 * mrSges(5,1) - t12 * mrSges(5,2) - t158 * t148 + (-t38 + t14) * qJ(5) + (t10 / 0.2e1 - t170 * t18 - t1 * mrSges(7,3)) * t131 + (-t9 / 0.2e1 - t170 * t17 - t2 * mrSges(7,3)) * t128 + m(7) * (qJ(5) * t4 - t140 * t170) + m(6) * (-pkin(4) * t7 - qJ(5) * t6) - t141; -qJ(5) * t60 + t47 * t104 + (-pkin(4) * mrSges(6,1) + t169) * t98 + (-mrSges(5,2) + mrSges(6,3)) * t71 - t159 * t69 + (-t15 * mrSges(7,3) - t170 * t61 + t171) * t131 + (-t36 / 0.2e1 - t16 * mrSges(7,3) - t170 * t62) * t128 + m(7) * (qJ(5) * t47 - t138 * t170) + m(6) * (-pkin(4) * t69 + qJ(5) * t71) + (-qJ(5) * mrSges(6,1) + t106 * t167 + t107 * t168) * t97 + t173; 0; -0.2e1 * pkin(4) * mrSges(6,2) - t128 * t106 + t131 * t107 + m(7) * (t146 * t170 ^ 2 + t134) + m(6) * (pkin(4) ^ 2 + t134) + t158 + 0.2e1 * (t104 + mrSges(6,3)) * qJ(5) + 0.2e1 * t170 * t142; m(6) * t7 + m(7) * t140 + t128 * t17 + t131 * t18 + t39; m(6) * t69 + m(7) * t138 + t98 * mrSges(6,1) + t128 * t62 + t131 * t61; 0; -m(6) * pkin(4) - t170 * t99 + mrSges(6,2) - t142; t165; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t8; mrSges(7,1) * t15 - mrSges(7,2) * t16 + t35; -t104; -t170 * t154 + t118 + (mrSges(7,2) * t170 - Ifges(7,6)) * t128; t139; Ifges(7,3);];
