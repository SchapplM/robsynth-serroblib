...
% Datum: 2019-04-09 16:49
% Revision: 6c14de6f4c9ff4dbe46db99908a97716657f1d1c (2019-04-09)
% Moritz Schappler, moritz.schappler@imes.uni-hannover.de
% (C) Institut für Mechatronische Systeme, Universität Hannover

function [v_mdh, sigma_mdh, mu_mdh, NL, NKP, NQJ, pkin_names] = S6RRPRPR10_structural_kinematic_parameters()
...
pkin_names = {'a2', 'a3', 'a4', 'a5', 'a6', 'alpha2', 'd1', 'd2', 'd4', 'd6', 'theta3'};
