...
t179 = t65 * Ifges(7,5);
t178 = t81 * Ifges(7,3);
t174 = -Ifges(5,4) - Ifges(6,6);
t68 = -qJD(4) * mrSges(5,2) - t83 * mrSges(5,3);
t70 = t83 * mrSges(6,1) - qJD(4) * mrSges(6,3);
t172 = t68 - t70;
...
t37 = [0.2e1 * qJD(3) * mrSges(4,3) * t148 + (t208 * t86 + t209 * t85) * qJD(4) / 0.2e1 + m(7) * (t1 * t12 + t11 * t2 + t14 * t50 + t25 * t29 + t3 * t6 + t4 * t5) + (t139 - t140) * mrSges(5,3) + (t139 - t141) * mrSges(6,1) + (((2 * mrSges(3,3)) + t137 + 0.2e1 * t186) * qJD(1) + t169 + m(4) * (t103 + t108) + m(5) * (qJD(1) * t100 + t93)) * qJD(2) - (t56 + t17) * t85 / 0.2e1 + (-t111 * t148 - t157 * t96) * t168 + t93 * (mrSges(5,1) * t86 - mrSges(5,2) * t85) - t83 * (-Ifges(5,4) * t85 - Ifges(5,2) * t86) / 0.2e1 + t84 * (-Ifges(5,1) * t85 - Ifges(5,4) * t86) / 0.2e1 - t86 * t55 / 0.2e1 + t85 * t54 / 0.2e1 - t84 * (Ifges(6,2) * t85 + Ifges(6,6) * t86) / 0.2e1 + t83 * (Ifges(6,6) * t85 + Ifges(6,3) * t86) / 0.2e1 + t46 * (-mrSges(6,2) * t86 + mrSges(6,3) * t85) + t86 * t53 / 0.2e1 + t57 * (-t76 * mrSges(6,2) + t72) + t36 * t60 + t3 * t47 + t4 * t48 + t50 * t13 + t25 * t35 + t11 * t20 + t12 * t21 + t100 * (t76 * mrSges(5,1) - t73) + (t133 * t200 + t131 * t199 - t14 * t136 - t31 * mrSges(6,2) + t7 * t188 + t112 * t8 / 0.2e1 + t24 * mrSges(6,1) - t27 * mrSges(5,3) + mrSges(5,1) * t107 + (Ifges(6,3) + Ifges(5,2)) * t76 + (-t165 / 0.2e1 - t162 / 0.2e1 - t174) * t75 + t145 * mrSges(7,3) + ((-t163 + t164) * t193 + t132 * t197 + t134 * t195 + t29 * t135 + t19 * t188 + t18 * t189 - t143 * mrSges(7,3)) * qJD(6)) * t88 + m(6) * (-t24 * t62 + t31 * t57 + t36 * t46 + t42 * t44 + t43 * t45 + t182) + m(5) * (t27 * t62 - t43 * t52 + t44 * t51 + t182) - t171 * t44 - t172 * t43 + t5 * (-mrSges(7,1) * t85 - mrSges(7,3) * t160) + t29 * (-mrSges(7,1) * t159 + mrSges(7,2) * t160) + t18 * t159 / 0.2e1 + t6 * (mrSges(7,2) * t85 + mrSges(7,3) * t159) + t19 * t160 / 0.2e1 + (Ifges(7,5) * t160 + Ifges(7,6) * t159 - Ifges(7,3) * t85) * t193 + (Ifges(7,1) * t160 + Ifges(7,4) * t159 - Ifges(7,5) * t85) * t195 + (Ifges(7,4) * t160 + Ifges(7,2) * t159 - Ifges(7,6) * t85) * t197 + (-t74 / 0.2e1 - t31 * mrSges(6,3) + mrSges(5,2) * t107 + t174 * t76 + t176 * t28 + (-Ifges(7,3) / 0.2e1 - Ifges(5,1) - Ifges(6,2)) * t75 + t202) * t89; (-mrSges(3,3) - t186) * t116 + (-t176 * t76 + t13) * t88 + t155 * t86 + t122 * t85 + (t128 * qJD(6) + t176 * t75 - t129) * t89 + m(7) * (t14 * t88 + t29 * t86 + t143 * t85 + (qJD(6) * t142 - t206) * t89) + m(6) * (-t24 * t88 + t141 - t181) + m(5) * (t27 * t88 + t140 - t181) + (-m(4) * t103 - m(5) * t93 - m(6) * t46 - t157 * t168 - t118 - t169 - t60) * qJD(1); -t112 * t20 + t113 * t21 + t72 - t73 - t175 * t76 + t127 * qJD(6) + (m(4) + m(5)) * t107 - t157 * t116 * mrSges(4,3) + t155 * t83 - t122 * t84 - m(5) * (t51 * t84 - t52 * t83) + m(4) * t96 * t148 + (-t81 * t143 + t29 * t83 + t145) * m(7) + (-t42 * t84 - t45 * t83 + t31) * m(6); -t206 * mrSges(7,3) + (-mrSges(6,1) * qJ(5) + t208) * t76 + (-t164 / 0.2e1 + t163 / 0.2e1 + pkin(4) * mrSges(6,1) + t209) * t75 + t14 * t135 - t129 * t191 + (-t118 * t191 + t201) * qJD(6) + (qJ(5) * t14 - t10 * t6 - t191 * t206 + t205 * t29 - t5 * t9) * m(7) - t58 * t60 - t10 * t47 - t9 * t48 - t32 * t35 - t24 * mrSges(6,3) - t27 * mrSges(5,2) + qJ(5) * t13 + (-t93 * mrSges(5,1) + t55 / 0.2e1 + t46 * mrSges(6,2) - t53 / 0.2e1 + t52 * mrSges(5,3) - t45 * mrSges(6,1) + (Ifges(5,4) / 0.2e1 + Ifges(6,6) / 0.2e1) * t84 + (-Ifges(6,5) / 0.2e1 + Ifges(5,6) / 0.2e1) * qJD(4) + (-Ifges(6,3) / 0.2e1 + Ifges(5,1) / 0.2e1 + Ifges(6,2) / 0.2e1 - Ifges(5,2) / 0.2e1) * t83 + t201) * t84 + (-t79 / 0.2e1 - t80 / 0.2e1 + t179 / 0.2e1 + t178 / 0.2e1 + t180 / 0.2e1 - t54 / 0.2e1 + t56 / 0.2e1 + t17 / 0.2e1 - t6 * mrSges(7,2) + t5 * mrSges(7,1) + t42 * mrSges(6,1) + t51 * mrSges(5,3) - t46 * mrSges(6,3) + t93 * mrSges(5,2) + (-Ifges(6,4) / 0.2e1 + Ifges(5,5) / 0.2e1) * qJD(4)) * t83 + t170 * qJD(5) + t171 * t52 + t172 * t51 + t175 * t28 + t8 * t188 + t7 * t189 + t132 * t199 + t134 * t200 + (-pkin(4) * t28 - qJ(5) * t24 + t204 * t45 - t42 * t52 - t46 * t58) * m(6); -t75 * mrSges(6,1) + t84 * t60 - t170 * qJD(4) + (t47 * t81 + t20) * t113 + (-t48 * t81 + t21) * t112 + (-qJD(4) * t29 - t81 * t142 + t206) * m(7) + (qJD(4) * t45 + t46 * t84 + t28) * m(6); -t74 - t29 * (mrSges(7,1) * t65 + mrSges(7,2) * t64) + (Ifges(7,1) * t64 - t185) * t196 + t18 * t195 + (Ifges(7,5) * t64 - Ifges(7,6) * t65) * t194 - t5 * t47 + t6 * t48 + (t5 * t64 + t6 * t65) * mrSges(7,3) + (-Ifges(7,2) * t65 + t19 + t63) * t198 + t202;];
tauc  = t37(:);
