% Umwandlung der Kinematikparameter von S6PRRRPP3V1 zu S6PRRRPP3
% Eingabe:
% pkin_var (6x1) double
...
%
% Siehe auch: S6PRRRPP3_structural_kinematic_parameters.m
function pkin_gen = S6PRRRPP3V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
