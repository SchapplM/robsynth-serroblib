...
t2 = -pkin(5) * t91 - t3;
t1 = qJ(6) * t91 + t4;
t6 = [-(2 * pkin(1) * mrSges(3,2)) + (mrSges(3,3) * t123) + 0.2e1 * t1 * t28 + 0.2e1 * t5 * t11 + 0.2e1 * t60 * t12 + 0.2e1 * t2 * t31 + 0.2e1 * t4 * t29 + 0.2e1 * t3 * t30 + 0.2e1 * t32 * t63 + 0.2e1 * t33 * t62 + Ifges(3,1) + Ifges(2,3) - (t9 + t10) * t48 + (t7 - t8) * t46 + t103 * t128 + ((mrSges(4,2) * t123) + Ifges(4,1) * t93 + t55 * t128 - t42 * t90 + t43 * t92) * t93 + (mrSges(4,1) * t123 + Ifges(4,2) * t91 + (-Ifges(5,6) * t90 - (2 * Ifges(4,4))) * t93 + t98) * t91 + m(4) * (t84 * t87 + t76 + t95) + (m(3) * (pkin(1) ^ 2 + t95)) + m(5) * (t32 ^ 2 + t33 ^ 2 + t76) + m(6) * (t3 ^ 2 + t4 ^ 2 + t60 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2); -(m(3) * pkin(1)) + mrSges(3,2) + (t92 * t62 - t90 * t63) * t91 - t113 * t47 + t112 * t44 - t103 + (-t55 + t125) * t93 + m(7) * (-t1 * t47 + t2 * t44 - t5 * t93) + m(6) * (-t3 * t44 - t4 * t47 - t60 * t93) + m(5) * (t100 * t91 + t77) + m(4) * (t84 * t94 + t77); m(3) + m(5) * (t110 * t84 + t86) + m(4) * t109 + t122 * (t44 ^ 2 + t47 ^ 2 + t86); -pkin(3) * t55 + t14 * t11 + t75 * t12 + t5 * t17 + t60 * t18 + (-(t94 * mrSges(4,2)) + t82 / 0.2e1 + t80 / 0.2e1 + t53 / 0.2e1 - t52 / 0.2e1 + t54 / 0.2e1 + t51 / 0.2e1 - Ifges(4,6)) * t91 - (t21 / 0.2e1 + t22 / 0.2e1) * t48 + (t19 / 0.2e1 - t20 / 0.2e1) * t46 + t113 * t27 + t112 * t25 + (pkin(8) * t62 + t33 * mrSges(5,3) + t42 / 0.2e1) * t92 + (-pkin(8) * t63 - t32 * mrSges(5,3) + t43 / 0.2e1) * t90 + (-t90 * t67 / 0.2e1 + t92 * t68 / 0.2e1 + Ifges(4,5) + t111 * t94) * t93 + m(5) * (pkin(3) * t116 + t100 * pkin(8)) + m(6) * (-t25 * t3 + t27 * t4 + t60 * t75) + m(7) * (t1 * t27 + t14 * t5 + t2 * t25) + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + t9 / 0.2e1 + t10 / 0.2e1) * t59 + (-t1 * mrSges(7,2) - t4 * mrSges(6,3) - t8 / 0.2e1 + t7 / 0.2e1) * t58; (-mrSges(4,2) + t104) * t91 + (t111 + t124) * t93 + m(7) * (-t14 * t93 + t106) + m(5) * (pkin(8) * t110 * t91 + pkin(3) * t93) + m(6) * (-t75 * t93 + t106) + t126 * (t44 * t59 + t47 * t58); -0.2e1 * pkin(3) * t65 + 0.2e1 * t14 * t17 + 0.2e1 * t75 * t18 + t92 * t67 + t90 * t68 + Ifges(4,3) + m(7) * (t14 ^ 2 + t107) + m(6) * (t75 ^ 2 + t107) + m(5) * (pkin(8) ^ 2 * t110 + pkin(3) ^ 2) + (t21 + t22) * t59 + (t19 - t20) * t58 + 0.2e1 * pkin(8) * t104 + 0.2e1 * (t25 * t59 - t27 * t58) * t126; m(7) * (t1 * t72 + t2 * t74) + t98 + (t88 * t29 + t89 * t30 + m(6) * (t3 * t89 + t4 * t88)) * pkin(4) - Ifges(5,6) * t119 + t72 * t28 + t74 * t31 + t32 * mrSges(5,1) - t33 * mrSges(5,2) + t1 * mrSges(7,3) - t2 * mrSges(7,1) + t3 * mrSges(6,1) - t4 * mrSges(6,2); -t101 * t91 - (-mrSges(6,2) + mrSges(7,3)) * t47 + (-mrSges(6,1) - mrSges(7,1)) * t44 + m(7) * (t44 * t74 - t47 * t72) + (-t44 * t89 - t47 * t88) * t127; m(7) * (t25 * t74 + t27 * t72) - t27 * mrSges(6,2) - t25 * mrSges(6,1) - t25 * mrSges(7,1) + t27 * mrSges(7,3) + t53 - t52 + t82 + t80 + t54 + t51 - t101 * pkin(8) + (-t58 * t72 + t59 * t74) * mrSges(7,2) + (m(6) * (-t25 * t89 + t27 * t88) + (-t58 * t88 - t59 * t89) * mrSges(6,3)) * pkin(4); -0.2e1 * t74 * mrSges(7,1) + 0.2e1 * t72 * mrSges(7,3) + m(7) * (t72 ^ 2 + t74 ^ 2) + (0.2e1 * mrSges(6,1) * t89 - 0.2e1 * mrSges(6,2) * t88 + (t88 ^ 2 + t89 ^ 2) * t127) * pkin(4) + t129; m(6) * t60 + m(7) * t5 - t125; -t122 * t93; m(6) * t75 + m(7) * t14 - t124; 0; t122; m(7) * t2 + t31; m(7) * t44; m(7) * t25 + t59 * mrSges(7,2); m(7) * t74 - mrSges(7,1); 0; m(7);];
