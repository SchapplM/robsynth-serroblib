...
function JaD_rot = S6RPRRPP6_jacobiaD_rot_4_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RPRRPP6_jacobiaD_rot_4_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RPRRPP6_jacobiaD_rot_4_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S6RPRRPP6_jacobiaD_rot_4_sym_varpar: pkin has to be [9x1] (double)');
...
t144 = t151 * t127;
t168 = qJD(3) * t131;
t92 = t130 * t143 + (t130 * t168 - t144) * t129;
t188 = t106 * t107 * t92;
t145 = t130 * t151;
t91 = t129 * t145 + (t129 * t168 + t143) * t127;
