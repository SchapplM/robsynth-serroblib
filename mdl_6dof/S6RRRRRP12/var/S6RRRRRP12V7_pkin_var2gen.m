% Umwandlung der Kinematikparameter von S6RRRRRP12V7 zu S6RRRRRP12
% Eingabe:
% pkin_var (4x1) double
%   Kinematikparameter (pkin) von S6RRRRRP12V7
...
function pkin_gen = S6RRRRRP12V7_pkin_var2gen(pkin_var)
pkin_gen = zeros(12,1);
