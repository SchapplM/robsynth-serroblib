...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:35:58
% EndTime: 2018-11-23 18:36:01
...
t47 = t205 * t71 - t209 * t95;
t48 = t205 * t95 + t209 * t71;
t70 = -t210 * t136 + t206 * t96;
...
t40 = -t207 * t91 + t211 * (t102 * t203 + t114 * t201);
...
t22 = -mrSges(7,2) * t47 + mrSges(7,3) * t70;
t21 = -mrSges(6,2) * t70 - mrSges(6,3) * t47;
t20 = mrSges(6,1) * t47 + mrSges(6,2) * t48;
t19 = mrSges(7,1) * t47 - mrSges(7,3) * t48;
t5 = pkin(5) * t47 - qJ(6) * t48 + t7;
t2 = -pkin(5) * t70 - t3;
t1 = qJ(6) * t70 + t4;
t6 = [(t15 + t16) * t48 + (t11 - t14) * t47 + ((Ifges(3,5) * t208 + Ifges(3,6) * t212) * t204 + 0.2e1 * (-t141 * t208 + t143 * t212) * mrSges(3,3) + (-0.2e1 * pkin(1) * (-mrSges(3,1) * t212 + mrSges(3,2) * t208) + t208 * (Ifges(3,1) * t208 + Ifges(3,4) * t212) + t212 * (Ifges(3,4) * t208 + Ifges(3,2) * t212) + m(3) * pkin(1) ^ 2) * t202) * t202 + m(3) * (t141 ^ 2 + t143 ^ 2) + t136 * t51 + t96 * t53 + t71 * t27 + 0.2e1 * t41 * t75 + 0.2e1 * t40 * t76 + 0.2e1 * t63 * t60 + 0.2e1 * t9 * t50 + 0.2e1 * t10 * t49 + 0.2e1 * t34 * t39 + 0.2e1 * t1 * t22 + 0.2e1 * t3 * t23 + 0.2e1 * t2 * t24 + 0.2e1 * t5 * t19 + 0.2e1 * t7 * t20 + 0.2e1 * t4 * t21 + Ifges(2,3) + (-t26 + t261) * t70 + (t229 - 0.2e1 * t246 + 0.2e1 * t247) * t204 + (t25 - t52) * t95 + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t7 ^ 2) + m(5) * (t10 ^ 2 + t34 ^ 2 + t9 ^ 2) + m(4) * (t40 ^ 2 + t41 ^ 2 + t63 ^ 2); t203 * t51 / 0.2e1 + t247 - t246 + (-pkin(2) * t60 + t207 * t53 / 0.2e1 + (-t25 / 0.2e1 + t52 / 0.2e1) * t211) * t201 + m(7) * (t1 * t28 + t2 * t29 + t38 * t5) + m(6) * (t3 * t36 + t37 * t4 + t7 * t73) + m(5) * (t10 * t82 + t121 * t34 + t81 * t9) + m(4) * (-pkin(2) * t201 * t63 + t140 * t40 + t142 * t41) + (-t118 / 0.2e1 + t83 / 0.2e1) * t95 + t229 + t71 * t258 + t138 * t259 + t140 * t76 + t142 * t75 + t40 * t147 + t41 * t148 + t136 * t117 / 0.2e1 + t63 * t139 + t96 * t119 / 0.2e1 + t121 * t39 + t10 * t107 + t9 * t108 + t1 * t77 + t4 * t78 + t3 * t79 + t2 * t80 + t81 * t50 + t82 * t49 + t34 * t86 + t73 * t20 + t5 * t61 + t7 * t62 + t37 * t21 + t38 * t19 + t36 * t23 + t28 * t22 + t29 * t24 + t221 * t70 + t222 * t137 + t231 * t48 + t232 * t47 + t233 * t104 + t234 * t103; 0.2e1 * t82 * t107 + 0.2e1 * t81 * t108 + t203 * t117 + 0.2e1 * t121 * t86 + t138 * t85 + 0.2e1 * t140 * t147 + 0.2e1 * t142 * t148 + 0.2e1 * t28 * t77 + 0.2e1 * t29 * t80 + 0.2e1 * t36 * t79 + 0.2e1 * t37 * t78 + 0.2e1 * t38 * t61 + 0.2e1 * t73 * t62 + Ifges(3,3) + (t58 + t59) * t104 + (t54 - t57) * t103 + (-t84 + t260) * t137 + (-0.2e1 * pkin(2) * t139 + t207 * t119 + (t118 - t83) * t211) * t201 + m(7) * (t28 ^ 2 + t29 ^ 2 + t38 ^ 2) + m(6) * (t36 ^ 2 + t37 ^ 2 + t73 ^ 2) + m(5) * (t121 ^ 2 + t81 ^ 2 + t82 ^ 2) + m(4) * (pkin(2) ^ 2 * t201 ^ 2 + t140 ^ 2 + t142 ^ 2); t51 + m(5) * (-pkin(3) * t34 + (t10 * t210 - t206 * t9) * pkin(11)) + t71 * t257 + t34 * t158 + t95 * t161 / 0.2e1 + t5 * t144 + t7 * t145 + t4 * t149 + t3 * t150 + t2 * t151 + t1 * t152 + t130 * t19 + t109 * t22 + t110 * t24 + t115 * t23 + t116 * t21 - pkin(3) * t39 + t40 * mrSges(4,1) - t41 * mrSges(4,2) + m(7) * (t1 * t109 + t110 * t2 + t130 * t5) + t219 * t70 + (t10 * mrSges(5,3) + pkin(11) * t49 - t222) * t210 + t227 * t48 + t228 * t47 + m(6) * (t115 * t3 + t116 * t4 + t254 * t7) + (t259 - t9 * mrSges(5,3) + t233 * t209 + t234 * t205 + (t20 - t50) * pkin(11)) * t206; t117 + m(5) * (-pkin(3) * t121 + (-t206 * t81 + t210 * t82) * pkin(11)) + t138 * t257 + t121 * t158 - t142 * mrSges(4,2) + t38 * t144 + t73 * t145 + t37 * t149 + t36 * t150 + t29 * t151 + t28 * t152 + t140 * mrSges(4,1) + t130 * t61 + t109 * t77 + t110 * t80 + t115 * t79 + t116 * t78 - pkin(3) * t86 + m(7) * (t109 * t28 + t110 * t29 + t130 * t38) + t219 * t137 + (t82 * mrSges(5,3) + pkin(11) * t107 - t221) * t210 + t227 * t104 + t228 * t103 - t161 * t243 / 0.2e1 + m(6) * (t115 * t36 + t116 * t37 + t254 * t73) + (t258 - t81 * mrSges(5,3) + t231 * t209 + t232 * t205 + (t62 - t108) * pkin(11)) * t206; -0.2e1 * pkin(3) * t158 + 0.2e1 * t109 * t152 + 0.2e1 * t110 * t151 + 0.2e1 * t115 * t150 + 0.2e1 * t116 * t149 + 0.2e1 * t130 * t144 + Ifges(4,3) + (t198 + t200) * mrSges(5,3) * t262 + (-t125 - t126 + t164) * t210 + m(7) * (t109 ^ 2 + t110 ^ 2 + t130 ^ 2) + m(6) * (t115 ^ 2 + t116 ^ 2 + t195) + m(5) * (pkin(3) ^ 2 + t200 * t214 + t195) + (t145 * t262 + t167 + (t128 + t129) * t209 + (t124 - t127) * t205) * t206; t9 * mrSges(5,1) - t10 * mrSges(5,2) - pkin(4) * t20 + t154 * t19 + t5 * t156 + t7 * t157 + t225 * t70 + t224 * t48 + t226 * t47 + (t1 * mrSges(7,2) + t4 * mrSges(6,3) + (t21 + t22) * pkin(12) - t234) * t209 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + (-t23 + t24) * pkin(12) + t233) * t205 + m(6) * (-pkin(4) * t7 + (-t205 * t3 + t209 * t4) * pkin(12)) + m(7) * (t154 * t5 + (t1 * t209 + t2 * t205) * pkin(12)) + t25; t81 * mrSges(5,1) - t82 * mrSges(5,2) - pkin(4) * t62 + t154 * t61 + t38 * t156 + t73 * t157 + t225 * t137 + t224 * t104 + t226 * t103 + (t28 * mrSges(7,2) + t37 * mrSges(6,3) + (t77 + t78) * pkin(12) - t232) * t209 + (t29 * mrSges(7,2) - t36 * mrSges(6,3) + (-t79 + t80) * pkin(12) + t231) * t205 + m(6) * (-pkin(4) * t73 + (-t205 * t36 + t209 * t37) * pkin(12)) + m(7) * (t154 * t38 + (t205 * t29 + t209 * t28) * pkin(12)) + t83; -pkin(4) * t145 + t154 * t144 + (m(7) * t154 + t156) * t130 + (-pkin(11) * mrSges(5,2) - t225) * t210 + (t109 * mrSges(7,2) + t116 * mrSges(6,3) - t228) * t209 + (t110 * mrSges(7,2) - t115 * mrSges(6,3) + t227) * t205 + ((t149 + t152) * t209 + (-t150 + t151) * t205 + m(7) * (t109 * t209 + t110 * t205) + m(6) * (-t115 * t205 + t116 * t209)) * pkin(12) + (t224 * t209 + t226 * t205 + (-m(6) * pkin(4) - mrSges(5,1) + t157) * pkin(11)) * t206 + t161; -0.2e1 * pkin(4) * t157 + 0.2e1 * t154 * t156 + Ifges(5,3) + (-t159 + t163) * t209 + (t166 + t165) * t205 + m(7) * (t154 ^ 2 + t235) + m(6) * (pkin(4) ^ 2 + t235) + 0.2e1 * (mrSges(7,2) + mrSges(6,3)) * pkin(12) * t263; m(7) * (-pkin(5) * t2 + qJ(6) * t1) + t1 * mrSges(7,3) + qJ(6) * t22 - t2 * mrSges(7,1) + t3 * mrSges(6,1) - t4 * mrSges(6,2) - pkin(5) * t24 + t261; m(7) * (-pkin(5) * t29 + qJ(6) * t28) + t28 * mrSges(7,3) + qJ(6) * t77 + t36 * mrSges(6,1) - t37 * mrSges(6,2) - t29 * mrSges(7,1) - pkin(5) * t80 + t260; m(7) * (-pkin(5) * t110 + qJ(6) * t109) - t116 * mrSges(6,2) + t115 * mrSges(6,1) - t110 * mrSges(7,1) - pkin(5) * t151 + t109 * mrSges(7,3) + qJ(6) * t152 + t252 * t210 + t220 + t236; t216 * mrSges(7,2) + (m(7) * t216 - t217 - t218) * pkin(12) + t162 + t160; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) - t252; m(7) * t2 + t24; m(7) * t29 + t80; m(7) * t110 + t151; (m(7) * pkin(12) + mrSges(7,2)) * t205; -m(7) * pkin(5) - mrSges(7,1); m(7);];
