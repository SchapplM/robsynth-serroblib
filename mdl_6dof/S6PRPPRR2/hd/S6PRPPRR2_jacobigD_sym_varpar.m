...
%% Function calls
if link_index == 0
	JgD=S6PRPPRR2_jacobigD_0_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 1
	JgD=S6PRPPRR2_jacobigD_1_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 2
	JgD=S6PRPPRR2_jacobigD_2_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 3
	JgD=S6PRPPRR2_jacobigD_3_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 4
	JgD=S6PRPPRR2_jacobigD_4_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 5
	JgD=S6PRPPRR2_jacobigD_5_sym_varpar(qJ, qJD, r_i_i_C, pkin);
elseif link_index == 6
	JgD=S6PRPPRR2_jacobigD_6_sym_varpar(qJ, qJD, r_i_i_C, pkin);
else
	JgD=NaN(6,6);
end