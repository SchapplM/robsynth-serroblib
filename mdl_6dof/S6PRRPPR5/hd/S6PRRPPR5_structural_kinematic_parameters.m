...
function [v_mdh, sigma_mdh, mu_mdh, NL, NKP, NQJ, pkin_names] = S6PRRPPR5_structural_kinematic_parameters()
...
pkin_names = {'a2', 'a3', 'a4', 'a5', 'a6', 'alpha2', 'd2', 'd3', 'd6', 'theta1', 'theta5'};
