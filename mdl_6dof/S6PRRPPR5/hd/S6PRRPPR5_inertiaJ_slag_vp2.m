...
t21 = [m(2) + m(6) * (t17 ^ 2 + t18 ^ 2 + t29) + m(7) * (t3 ^ 2 + t4 ^ 2 + t29) + m(3) * (t72 * t84 ^ 2 + t80 ^ 2 + t61) + (m(5) + m(4)) * (t31 ^ 2 + t29 + t61); t17 * t46 + t18 * t47 + t4 * t19 + t3 * t20 + t108 * t113 + (-t84 * mrSges(3,2) + (mrSges(3,1) - t54 - t55) * t87) * t78 + (t108 * t86 + t120) * t33 + m(6) * (t10 * t17 + t11 * t18 + t33 * t57) + m(7) * (t1 * t3 + t2 * t4 + t30 * t33) + m(5) * (-t50 * t110 + t90) + m(4) * (pkin(2) * t110 + t90); -0.2e1 * pkin(2) * t55 + 0.2e1 * t1 * t20 + 0.2e1 * t10 * t46 + 0.2e1 * t11 * t47 + 0.2e1 * t2 * t19 + t26 * t5 + t27 * t6 + 0.2e1 * t30 * t8 + 0.2e1 * t57 * t35 + 0.2e1 * t50 * t54 + Ifges(3,3) + (-t79 * t24 - t77 * t25 + (Ifges(5,3) + Ifges(4,2)) * t86) * t86 + m(6) * (t10 ^ 2 + t11 ^ 2 + t57 ^ 2) + m(5) * (t50 ^ 2 + t106) + m(4) * (pkin(2) ^ 2 + t106) + m(7) * (t1 ^ 2 + t2 ^ 2 + t30 ^ 2) + ((Ifges(6,3) + Ifges(5,2) + Ifges(4,1)) * t83 + (-Ifges(6,5) * t77 - Ifges(6,6) * t79 + (2 * Ifges(4,4)) + (2 * Ifges(5,6))) * t86 + t101) * t83 + 0.2e1 * t108 * pkin(8) * t121; (-mrSges(4,1) + mrSges(5,2)) * t31 - t95 * mrSges(7,3) - t92 * mrSges(6,3) + (-mrSges(4,2) + t14 + t107) * t33 + m(6) * (t92 * t81 + t104) + m(7) * (t12 * t3 + t13 * t4 + t33 * t59) + m(5) * (-pkin(3) * t31 + t104); t57 * t51 + t59 * t8 + t41 * t5 / 0.2e1 - t91 * t6 / 0.2e1 + t30 * t14 + qJ(4) * t35 + t13 * t19 + t12 * t20 + t26 * t15 / 0.2e1 + t27 * t16 / 0.2e1 - t96 * mrSges(7,3) + (t25 / 0.2e1 - t10 * mrSges(6,3) + t81 * t46) * t79 + (-t24 / 0.2e1 + t81 * t47 - t11 * mrSges(6,3)) * t77 + m(6) * (qJ(4) * t57 + t94 * t81) + m(7) * (t1 * t12 + t13 * t2 + t30 * t59) + (Ifges(6,5) * t79 / 0.2e1 + Ifges(6,6) * t117 - t38 / 0.2e1 + t37 / 0.2e1 - Ifges(5,4) + Ifges(4,5) - pkin(3) * mrSges(5,1)) * t83 + (-Ifges(5,5) + Ifges(4,6) - t79 * t52 / 0.2e1 + t53 * t117 + qJ(4) * mrSges(5,1)) * t86 + ((m(5) * qJ(4) - mrSges(4,2) + mrSges(5,3)) * t86 + (-mrSges(4,1) + t118) * t83) * pkin(8); -0.2e1 * pkin(3) * mrSges(5,2) + 0.2e1 * t59 * t14 + t41 * t15 - t91 * t16 - t77 * t52 + t79 * t53 + Ifges(5,1) + Ifges(4,3) + m(7) * (t12 ^ 2 + t13 ^ 2 + t59 ^ 2) + m(6) * (t105 * t81 ^ 2 + t88) + m(5) * (pkin(3) ^ 2 + t88) - 0.2e1 * t93 * mrSges(7,3) + 0.2e1 * t107 * qJ(4) - 0.2e1 * t81 * t99; m(5) * t31 + m(6) * t92 + m(7) * t95; -t41 * t19 - t91 * t20 + t79 * t46 + t77 * t47 + (m(5) * pkin(8) + mrSges(5,1)) * t83 + m(7) * t96 + m(6) * t94; m(7) * t93 - t102 * mrSges(7,3) + t81 * t100 + t118 - t99; m(7) * t102 + m(5) + t100; 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * t33; m(6) * t57 + m(7) * t30 + t120; m(6) * qJ(4) + m(7) * t59 + t14 + t51; 0; m(6) + m(7); mrSges(7,1) * t3 - mrSges(7,2) * t4; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t101; mrSges(7,1) * t12 - mrSges(7,2) * t13 + t37 - t38; -mrSges(7,1) * t91 + mrSges(7,2) * t41; 0; Ifges(7,3);];
