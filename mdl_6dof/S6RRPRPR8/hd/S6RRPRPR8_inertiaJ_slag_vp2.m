...
t13 = [0.2e1 * t1 * t21 + 0.2e1 * t10 * t55 + 0.2e1 * t11 * t58 - 0.2e1 * t12 * t7 + 0.2e1 * t17 * t57 + 0.2e1 * t18 * t56 + 0.2e1 * t19 * t33 + 0.2e1 * t2 * t20 + t29 * t4 + t30 * t5 + 0.2e1 * t90 * t34 + 0.2e1 * t59 * t89 + 0.2e1 * t60 * t88 + Ifges(2,3) + (t27 + t28) * t73 + (t25 - t26) * t72 + (t110 + t111) * mrSges(3,3) * t149 + (-0.2e1 * pkin(1) * mrSges(3,2) + Ifges(3,1) * t116 - t112 * t70 + t113 * t71 + t74 * t149) * t116 + m(3) * (pkin(1) ^ 2 + t111 * t121 + t106) + m(4) * (t59 ^ 2 + t60 ^ 2 + t106) + m(5) * (t17 ^ 2 + t18 ^ 2 + t90 ^ 2) + m(7) * (t1 ^ 2 + t12 ^ 2 + t2 ^ 2) + m(6) * (t10 ^ 2 + t11 ^ 2 + t19 ^ 2) + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(4,3) + Ifges(3,2) + t139) * t118 + (-Ifges(4,5) * t113 + Ifges(4,6) * t112 + (2 * Ifges(3,4))) * t116 + t130 + t148) * t118; -(t25 / 0.2e1 - t26 / 0.2e1 - t18 * mrSges(5,3) - t10 * mrSges(6,2)) * t123 + (-pkin(7) * mrSges(3,2) + Ifges(4,5) * t147 - Ifges(4,6) * t113 / 0.2e1 - t80 / 0.2e1 + t77 / 0.2e1 - t79 / 0.2e1 - t78 / 0.2e1 + t38 / 0.2e1 + t37 / 0.2e1 + Ifges(3,6)) * t118 + t70 * t146 + (t55 + t56) * t54 + (-t57 + t58) * t52 + (-t112 * t89 + t113 * t88) * qJ(3) + m(5) * (t102 * t90 - t17 * t52 + t18 * t54) + m(6) * (t10 * t54 + t11 * t52 + t19 * t36) + m(7) * (t1 * t8 - t12 * t22 + t2 * t9) + (t27 / 0.2e1 + t28 / 0.2e1 + t11 * mrSges(6,2) - t17 * mrSges(5,3)) * t87 + (t48 / 0.2e1 + t49 / 0.2e1) * t73 + t112 * t71 / 0.2e1 + t90 * t45 + t102 * t34 - pkin(2) * t74 + (t46 / 0.2e1 - t47 / 0.2e1) * t72 + t39 * t4 / 0.2e1 + t40 * t5 / 0.2e1 + t19 * t44 + t29 * t15 / 0.2e1 + t30 * t16 / 0.2e1 + t36 * t33 + t9 * t20 + t8 * t21 + t22 * t7 + t126 * mrSges(4,3) + m(4) * (-pkin(2) * t144 + qJ(3) * t126) + (t96 * t147 + t97 * t146 + Ifges(3,5) + (t94 - mrSges(3,1)) * pkin(7)) * t116 - t12 * t14 + (-t1 * t40 + t2 * t39) * mrSges(7,3); -0.2e1 * pkin(2) * t94 + 0.2e1 * t102 * t45 + t112 * t97 + t113 * t96 + 0.2e1 * t22 * t14 + t39 * t15 + t40 * t16 + 0.2e1 * t36 * t44 + Ifges(3,3) + (t48 + t49) * t87 - (t46 - t47) * t123 + m(4) * (qJ(3) ^ 2 * t132 + pkin(2) ^ 2) + m(5) * (t102 ^ 2 + t131) + m(6) * (t36 ^ 2 + t131) + m(7) * (t22 ^ 2 + t8 ^ 2 + t9 ^ 2) + 0.2e1 * (t39 * t9 - t40 * t8) * mrSges(7,3) + 0.2e1 * t132 * qJ(3) * mrSges(4,3) + 0.2e1 * (t123 * t54 + t52 * t87) * (mrSges(6,2) + mrSges(5,3)); m(4) * t144 + m(5) * t90 + m(6) * t19 + m(7) * t12 + t33 + t34 - t7 + t74; -m(4) * pkin(2) + m(5) * t102 + m(6) * t36 - m(7) * t22 - t14 + t44 + t45 + t94; m(4) + m(5) + m(6) + m(7); m(7) * (t1 * t91 + t2 * t92) + m(6) * (-pkin(4) * t11 + qJ(5) * t10) - t139 * t118 + t91 * t21 + t92 * t20 + qJ(5) * t55 - pkin(4) * t58 - t122 + t10 * mrSges(6,3) - t11 * mrSges(6,1) + t17 * mrSges(5,1) - t18 * mrSges(5,2) - t148; -t77 + t78 + t79 + t80 + (-mrSges(5,2) + mrSges(6,3)) * t54 + (-mrSges(5,1) - mrSges(6,1)) * t52 + (t39 * t92 - t40 * t91) * mrSges(7,3) + (-pkin(4) * t87 + qJ(5) * t123) * mrSges(6,2) + m(7) * (t8 * t91 + t9 * t92) + m(6) * (-pkin(4) * t52 + qJ(5) * t54) - t124; 0; 0.2e1 * pkin(4) * mrSges(6,1) - 0.2e1 * t142 + 0.2e1 * t141 + 0.2e1 * qJ(5) * mrSges(6,3) + Ifges(7,3) + m(6) * (pkin(4) ^ 2 + qJ(5) ^ 2) + m(7) * (t91 ^ 2 + t92 ^ 2) + t139; t114 * t20 + t117 * t21 + m(7) * (t1 * t117 + t114 * t2) + m(6) * t11 + t58; t87 * mrSges(6,2) + (t114 * t39 - t117 * t40) * mrSges(7,3) + m(7) * (t114 * t9 + t117 * t8) + m(6) * t52; 0; -mrSges(6,1) - m(6) * pkin(4) + m(7) * (t114 * t92 + t117 * t91) - t127; m(6) + m(7) * (t114 ^ 2 + t117 ^ 2); t122; t124; 0; -Ifges(7,3) - t141 + t142; t127; Ifges(7,3);];
