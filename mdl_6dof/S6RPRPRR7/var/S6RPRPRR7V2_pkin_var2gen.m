% Umwandlung der Kinematikparameter von S6RPRPRR7V2 zu S6RPRPRR7
% Eingabe:
% pkin_var (8x1) double
...
%
% Siehe auch: S6RPRPRR7_structural_kinematic_parameters.m
function pkin_gen = S6RPRPRR7V2_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
