% Umwandlung der Kinematikparameter von S6RRPRPR2V1 zu S6RRPRPR2
% Eingabe:
% pkin_var (9x1) double
...
%
% Siehe auch: S6RRPRPR2_structural_kinematic_parameters.m
function pkin_gen = S6RRPRPR2V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
