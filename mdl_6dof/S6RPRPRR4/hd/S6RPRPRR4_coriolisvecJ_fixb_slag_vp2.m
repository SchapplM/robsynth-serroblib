...
t1 = [m(7) * (t10 * t4 + t105 * t47 + t2 * t21 + t20 * t3 + t5 * t9 + t56 * t67) + (t10 * t44 + t118 * t2 + t119 * t3 - t43 * t9) * mrSges(7,3) + (-Ifges(7,4) * t119 + Ifges(7,2) * t118) * t291 + (-Ifges(7,1) * t119 + Ifges(7,4) * t118) * t292 + t47 * (-mrSges(7,1) * t118 - mrSges(7,2) * t119) + m(6) * (-t122 * t85 + t133 * t73 + t15 * t58 + t16 * t57 + t29 * t39 + t30 * t38) + m(5) * (t103 * t124 + t104 * t130) + (t45 * t273 + t104 * mrSges(5,2) + t73 * t213 - t93 * t210 / 0.2e1 - t94 * t208 / 0.2e1 - t92 * mrSges(5,1) + t106 * mrSges(4,3) + t46 * t274 + (-t15 * t185 + t16 * t182) * mrSges(6,3) + (t106 * t293 - m(5) * t92 / 0.2e1) * t294 + (-t85 * t212 + t209 * t281 + t211 * t280 + t161 * (t262 - t263) / 0.2e1 + t61 * t273 + t182 * t290 + (t182 * t39 + t252) * mrSges(6,3)) * qJD(5) + (t189 + ((-t264 / 0.2e1 - t261 / 0.2e1 - t225) * t186 + Ifges(7,5) * t282 + Ifges(7,6) * t283 - t130 * mrSges(5,3) + t224 * mrSges(4,2) + (Ifges(7,3) / 0.2e1 - 0.3e1 / 0.2e1 * Ifges(4,2) + 0.3e1 / 0.2e1 * Ifges(4,1) + 0.3e1 / 0.2e1 * Ifges(5,2) + Ifges(6,3) / 0.2e1 - 0.3e1 / 0.2e1 * Ifges(5,3)) * t183) * qJD(1) + t227 * qJD(3) + t296 * t162) * qJD(3)) * t186 + (t159 / 0.2e1 + t158 / 0.2e1 - t104 * mrSges(5,3) + ((t293 + m(5) / 0.2e1) * t294 + t312) * t107 + ((mrSges(4,1) * t224 - t130 * mrSges(5,2) + t183 * t225) * qJD(1) + t226 * qJD(3) + (-t242 + t298) * t162 - t323) * qJD(3) + t297) * t183 + (Ifges(7,1) * t43 + Ifges(7,4) * t44) * t286 + (Ifges(7,4) * t43 + Ifges(7,2) * t44) * t288 + t20 * t23 + t21 * t24 + t44 * t318 + (Ifges(7,5) * t43 + Ifges(7,6) * t44) * t276 + t7 * t282 + t6 * t283 + t43 * t34 / 0.2e1 + t4 * t54 + t5 * t55 + t56 * (-mrSges(7,1) * t44 + mrSges(7,2) * t43) + t57 * t65 + t58 * t66 + t67 * t37 + t29 * t97 + t30 * t98 + t105 * t8 - t122 * t80 + t133 * t49 + t124 * t141; t118 * t23 - t119 * t24 + t43 * t54 + t44 * t55 + (t49 + t8) * t183 + t300 * t186 + m(5) * (-t183 * t92 - t248) + m(4) * (t106 * t183 - t248) + m(7) * (t10 * t43 + t118 * t3 - t119 * t2 + t183 * t47 + t44 * t9) + m(6) * (-t16 * t243 + t183 * t73 - t186 * t258 - t39 * t220 + t38 * t221) + (m(6) * t39 * t245 + t312 * qJD(1) * (-t183 ^ 2 - t186 ^ 2) + (m(6) * t252 + t182 * t97 + t185 * t98 + t296) * t183 + (m(6) * t85 + t149 - t228 + t285 - t298) * t186) * qJD(3); t324 * t107 + t326 * qJD(5) + (t73 * qJ(4) - t38 * t51 - t39 * t52 + (qJD(4) - t95) * t85) * m(6) - t303 * mrSges(6,3) + t310 * t54 + (t10 * t310 + t163 * t47 + t2 * t82 + t3 * t81 + t305 * t56 + t311 * t9) * m(7) + t311 * t55 + (-t78 / 0.2e1 - t109 / 0.2e1) * t33 + t47 * (mrSges(7,1) * t200 - mrSges(7,2) * t199) + (-Ifges(7,4) * t199 - Ifges(7,2) * t200) * t291 + (-Ifges(7,1) * t199 - Ifges(7,4) * t200) * t292 + (-t79 / 0.2e1 - t110 / 0.2e1) * t34 + (-Ifges(7,4) * t79 - Ifges(7,2) * t78) * t288 + t305 * t37 + (-Ifges(7,5) * t79 - Ifges(7,6) * t78) * t276 + (-Ifges(7,1) * t79 - Ifges(7,4) * t78) * t286 + (((-qJ(4) * mrSges(5,1) + t226) * qJD(3) + (Ifges(4,4) / 0.2e1 + Ifges(5,6) / 0.2e1) * t172 + t323) * t183 + (-Ifges(5,6) * t239 / 0.2e1 + (-pkin(3) * mrSges(5,1) + Ifges(7,5) * t278 + Ifges(7,6) * t279 + t263 / 0.2e1 - t262 / 0.2e1 + t227) * qJD(3) - t189 - t167 / 0.2e1 + (-Ifges(4,1) / 0.2e1 - Ifges(5,2) / 0.2e1 + Ifges(5,3) / 0.2e1 + Ifges(4,2) / 0.2e1) * t172) * t186) * qJD(1) + (-pkin(3) * t107 - qJ(4) * t92 + t102 * t302 - t103 * t142 - t116 * t99) * m(5) + (t203 + m(6) * t303 + (-m(6) * t204 - t202) * qJD(5)) * t187 + (Ifges(7,1) * t110 + Ifges(7,4) * t109) * t287 + (Ifges(7,4) * t110 + Ifges(7,2) * t109) * t289 + t320 * mrSges(7,3) + t94 * t209 / 0.2e1 + t93 * t211 / 0.2e1 + t45 * t274 + (Ifges(7,5) * t110 + Ifges(7,6) * t109) * t277 + t7 * t278 + t6 * t279 + t73 * t212 + qJ(4) * t49 + t81 * t23 + t82 * t24 - t92 * mrSges(5,3) - t95 * t80 - t52 * t97 - t51 * t98 - t106 * mrSges(4,2) - t142 * t141 + t163 * t8 + t185 * t46 / 0.2e1 - t241 * t116 + t242 * t115 + t249 * qJD(4) + (mrSges(7,1) * t251 + mrSges(7,2) * t250) * t56; t200 * t24 - t199 * t23 + t250 * t55 + t251 * t54 + t228 * qJD(3) + (mrSges(5,1) * t236 + (t141 - t202) * t183) * qJD(1) + (-qJD(3) * t56 - t320) * m(7) + (-qJD(3) * t85 - t161 * t204 + t303) * m(6) + (qJD(3) * t102 + t103 * t172 + t107) * m(5) - t300; (-Ifges(6,2) * t138 + t131 + t61) * t281 + t297 + (t137 * t38 + t138 * t39) * mrSges(6,3) + (-m(7) * t9 * t231 + (m(7) * t2 - qJD(6) * t55 + t24) * t181 + (t23 + t54 * qJD(6) + m(7) * (t3 + t304)) * t184 + (-t37 - t285) * t138) * pkin(5) + t71 * t318 + t159 + t138 * t290 + (Ifges(6,5) * t137 - Ifges(6,6) * t138) * t275 + (Ifges(6,1) * t137 - t267) * t280 - t12 * t54 - t11 * t55 - m(7) * (t10 * t12 + t11 * t9) - t38 * t97 + t39 * t98 - t85 * (mrSges(6,1) * t138 + mrSges(6,2) * t137) + t325; t10 * t55 + t33 * t286 - t9 * t54 + t322 + t325;];
tauc  = t1(:);
