...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:59:17
% EndTime: 2018-11-23 15:59:18
...
t2 = -t73 * pkin(5) - t3;
t1 = qJ(6) * t73 + t4;
t6 = [-0.2e1 * pkin(1) * t106 + Ifges(3,2) * t91 + t61 * t127 + t37 * t128 + 0.2e1 * t17 * t40 + 0.2e1 * t16 * t41 + 0.2e1 * t24 * t15 + 0.2e1 * t5 * t14 + 0.2e1 * t4 * t18 + 0.2e1 * t3 * t19 + 0.2e1 * t2 * t20 + 0.2e1 * t1 * t21 + Ifges(2,3) + (Ifges(3,1) * t93 + 0.2e1 * Ifges(3,4) * t95) * t93 + (t10 + t11) * t34 + (-t9 + t8) * t33 + 0.2e1 * t110 * qJ(2) * mrSges(3,3) + (mrSges(4,3) * t128 + Ifges(4,1) * t75 - t92 * t22 + t94 * t23) * t75 + (mrSges(4,1) * t127 - 0.2e1 * t55 * mrSges(4,3) + (Ifges(5,3) + Ifges(4,2)) * t73 + (Ifges(5,5) * t94 - Ifges(5,6) * t92 - (2 * Ifges(4,4))) * t75 + t102) * t73 + m(3) * (qJ(2) ^ 2 * t110 + pkin(1) ^ 2) + m(4) * (t55 ^ 2 + t85 ^ 2 + t129) + m(5) * (t16 ^ 2 + t17 ^ 2 + t129) + m(6) * (t24 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2); -m(3) * pkin(1) + t73 * mrSges(4,1) + t92 * t40 + t94 * t41 + t61 + t115 * t74 - t114 * t101 + m(7) * (t1 * t74 - t101 * t2) + m(6) * (t101 * t3 + t4 * t74) + m(5) * (t16 * t94 + t17 * t92) + m(4) * t85 + t106; m(5) * t111 + m(3) + m(4) + t132 * (t101 ^ 2 + t74 ^ 2); (t48 / 0.2e1 + t47 / 0.2e1) * t34 + (t45 / 0.2e1 - t46 / 0.2e1) * t33 + (Ifges(4,5) - t92 * t80 / 0.2e1 + t81 * t125) * t75 + t114 * t50 + t115 * t54 + m(5) * (-pkin(3) * t52 + qJ(4) * t103) + t103 * mrSges(5,3) + (t76 - mrSges(4,1)) * t52 + (t94 * t40 - t92 * t41) * qJ(4) + t92 * t23 / 0.2e1 + t84 * t15 - Ifges(4,6) * t73 - t55 * mrSges(4,2) - pkin(3) * t37 + t38 * t14 + t5 * t43 + t24 * t44 + t22 * t125 + m(6) * (t24 * t84 - t3 * t50 + t4 * t54) + m(7) * (t1 * t54 + t2 * t50 + t38 * t5) - (-t9 / 0.2e1 + t8 / 0.2e1 - t4 * mrSges(6,3) - t1 * mrSges(7,2)) * t101 + (t10 / 0.2e1 + t11 / 0.2e1 + t2 * mrSges(7,2) - t3 * mrSges(6,3)) * t74 + (Ifges(5,5) * t92 + Ifges(5,6) * t94 + t131) * t73 / 0.2e1; t132 * (-t101 * t50 + t54 * t74); -0.2e1 * pkin(3) * t76 + 0.2e1 * t38 * t43 + 0.2e1 * t84 * t44 + t94 * t80 + t92 * t81 + Ifges(4,3) + m(7) * (t38 ^ 2 + t109) + m(6) * (t84 ^ 2 + t109) + m(5) * (qJ(4) ^ 2 * t111 + pkin(3) ^ 2) + (t47 + t48) * t74 - (t45 - t46) * t101 + 0.2e1 * mrSges(5,3) * qJ(4) * t111 + 0.2e1 * (t101 * t54 + t50 * t74) * (mrSges(7,2) + mrSges(6,3)); m(5) * t52 + m(6) * t24 + m(7) * t5 + t14 + t15 + t37; 0; -m(5) * pkin(3) + m(6) * t84 + m(7) * t38 - t100 + t76; m(5) + t132; qJ(6) * t21 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) - t4 * mrSges(6,2) + t3 * mrSges(6,1) - t2 * mrSges(7,1) - pkin(5) * t20 + t1 * mrSges(7,3) + t102; m(7) * t104 + t100; (-pkin(5) * t74 + qJ(6) * t101) * mrSges(7,2) + (m(7) * qJ(6) - mrSges(6,2) + mrSges(7,3)) * t54 + (-mrSges(6,1) + t130) * t50 + t131; 0; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t133; m(7) * t2 + t20; -m(7) * t101; m(7) * t50 + t74 * mrSges(7,2); 0; t130; m(7);];
