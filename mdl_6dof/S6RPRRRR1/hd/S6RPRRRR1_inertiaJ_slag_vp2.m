...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:32:25
% EndTime: 2018-11-23 16:32:26
...
t33 = t36 ^ 2;
t1 = [-0.2e1 * t27 * t57 * mrSges(5,3) + 0.2e1 * t69 * t105 + Ifges(4,2) * t147 + Ifges(5,1) * t140 + 0.2e1 * t58 * t108 + t29 * t138 + t14 * t139 + 0.2e1 * t3 * t15 + 0.2e1 * t2 * t16 + Ifges(2,3) + Ifges(3,3) + (0.2e1 * t28 * mrSges(5,3) + 0.2e1 * Ifges(5,4) * t57 + Ifges(5,2) * t56) * t56 + (mrSges(6,2) * t138 + mrSges(6,3) * t139 + Ifges(6,1) * t36 - t84 * t8 + t88 * t9) * t36 + (-0.2e1 * t12 * mrSges(6,3) + Ifges(6,2) * t34 + (-Ifges(7,6) * t84 - (2 * Ifges(6,4))) * t36 + t118) * t34 + m(4) * (t115 * t68 ^ 2 + t69 ^ 2) + m(5) * (t27 ^ 2 + t28 ^ 2 + t58 ^ 2) + m(6) * (t12 ^ 2 + t38 ^ 2 + t142) + m(7) * (t2 ^ 2 + t3 ^ 2 + t142) + m(3) * (t82 ^ 2 + t83 ^ 2) * pkin(1) ^ 2 + (Ifges(4,1) * t87 + 0.2e1 * Ifges(4,4) * t91) * t87 + 0.2e1 * (t83 * mrSges(3,1) - t82 * mrSges(3,2)) * pkin(1) + 0.2e1 * t115 * t68 * mrSges(4,3); t34 * t14 + t103 * t36 + m(7) * (t106 * t36 + t126) + m(6) * (t12 * t36 + t126) + m(5) * (t27 * t56 + t28 * t57); m(3) + m(7) * (t116 * t33 + t141) + m(6) * (t33 + t141) + m(5) * (t56 ^ 2 + t140) + m(4) * t115; t103 * t46 + m(6) * (-t10 * t47 + t12 * t48) + (-mrSges(4,1) * t87 - mrSges(4,2) * t91) * t68 + (-t34 * t48 - t36 * t47) * mrSges(6,3) + (m(5) * (t27 * t90 + t28 * t86) + (t56 * t86 - t57 * t90) * mrSges(5,3)) * pkin(3) + t96 + m(7) * (t10 * t45 + t106 * t46) + Ifges(4,6) * t91 + Ifges(4,5) * t87 + t45 * t14; m(7) * (t110 * t36 + t34 * t45) + m(6) * (-t34 * t47 + t36 * t48) + m(5) * (t56 * t90 + t57 * t86) * pkin(3) + t99 - t105; -0.2e1 * t123 + Ifges(4,3) + 0.2e1 * t37 + 0.2e1 * t39 + 0.2e1 * t40 + 0.2e1 * t41 + 0.2e1 * t101 + m(7) * (t116 * t46 ^ 2 + t45 ^ 2) + m(6) * (t47 ^ 2 + t48 ^ 2) + m(5) * (t86 ^ 2 + t90 ^ 2) * pkin(3) ^ 2 + t107; (m(6) * (-t10 * t89 + t12 * t85) + (-t34 * t85 - t36 * t89) * mrSges(6,3)) * pkin(4) + t96 + t145 * t71 + t143 * t70; m(7) * (t109 * t36 + t71 * t34) + m(6) * (-t34 * t89 + t36 * t85) * pkin(4) + t99; t101 + m(7) * (t109 * t46 + t45 * t71) + (m(6) * (t47 * t89 + t48 * t85) - t120) * pkin(4) + t100 + Ifges(5,3) + t144; -0.2e1 * t114 + 0.2e1 * t50 + 0.2e1 * t59 + 0.2e1 * t60 + 0.2e1 * t75 + m(7) * (t116 * t70 ^ 2 + t71 ^ 2) + m(6) * (t85 ^ 2 + t89 ^ 2) * pkin(4) ^ 2 + t107; -t145 * pkin(5) + t143 * pkin(10) + t97; m(7) * (t116 * t133 - t135) + t102; m(7) * (-pkin(5) * t45 + pkin(10) * t110) + t100 + t146; -t114 + m(7) * (-pkin(5) * t71 + pkin(10) * t109) + t113 + t144 + t146; 0.2e1 * t74 + 0.2e1 * t73 - 0.2e1 * t134 + m(7) * (pkin(10) ^ 2 * t116 + pkin(5) ^ 2) + t113; mrSges(7,1) * t2 - mrSges(7,2) * t3 - Ifges(7,6) * t125 + t118; -t14; -t104 * t46 + t117; -t104 * t70 + t117; -pkin(10) * t104 + t117; Ifges(7,3);];
