% Umwandlung der Kinematikparameter von S6RRRRPR9 zu S6RRRRPR9V2
% Eingabe:
...
%   Kinematikparameter (pkin) von S6RRRRPR9V2
%   pkin_var=[a2 a4 a5 a6 alpha2 d1 d2 d4 d6 theta5]
% I_gv (10x1)
%   Vektor mit Indizes zur Selektion von Kinematikparametern
function [pkin_var, I_gv] = S6RRRRPR9V2_pkin_gen2var(pkin_gen)
