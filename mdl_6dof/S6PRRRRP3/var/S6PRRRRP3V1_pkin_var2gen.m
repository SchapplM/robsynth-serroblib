% Umwandlung der Kinematikparameter von S6PRRRRP3V1 zu S6PRRRRP3
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S6PRRRRP3_structural_kinematic_parameters.m
function pkin_gen = S6PRRRRP3V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
