...
t15 = [Ifges(3,2) * t72 - 0.2e1 * pkin(1) * t89 + t38 * t114 + 0.2e1 * t2 * t20 + 0.2e1 * t7 * t21 + 0.2e1 * t1 * t22 + 0.2e1 * t6 * t23 + 0.2e1 * t4 * t24 + 0.2e1 * t3 * t25 + t18 * t115 + 0.2e1 * t8 * t16 + 0.2e1 * t5 * t17 + Ifges(2,3) + (Ifges(3,1) * t75 + 0.2e1 * Ifges(3,4) * t76) * t75 + 0.2e1 * t94 * qJ(2) * mrSges(3,3) + (mrSges(4,1) * t114 - 0.2e1 * t30 * mrSges(4,3) + (Ifges(7,3) + Ifges(4,2)) * t43 + t87) * t43 + m(3) * (t94 * qJ(2) ^ 2 + pkin(1) ^ 2) + m(4) * (t30 ^ 2 + t60 ^ 2 + t117) + m(5) * (t6 ^ 2 + t7 ^ 2 + t117) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t8 ^ 2) + (mrSges(4,3) * t115 + Ifges(4,1) * t44 - 0.2e1 * Ifges(4,4) * t43 + (t12 + t13 + t14 - t105) * t79 + (t101 * t43 + t10 - t11 + t9) * t77) * t44; -m(3) * pkin(1) + t43 * mrSges(4,1) + t38 + (-t22 - t97) * t79 + (t20 + t98) * t77 + m(7) * (-t1 * t79 + t2 * t77) + m(6) * (t3 * t77 - t4 * t79) + m(5) * (t6 * t79 + t7 * t77) + m(4) * t60 + t89; m(3) + m(4) + (m(5) / 0.2e1 + m(6) / 0.2e1 + m(7) / 0.2e1) * t118; -t30 * mrSges(4,2) - pkin(3) * t18 + t45 * t16 + t41 * t17 + t51 * t20 + t47 * t22 + t8 * t48 + t5 * t49 + (t67 / 0.2e1 + t66 / 0.2e1 + t65 / 0.2e1 - Ifges(4,6)) * t43 + (t50 - mrSges(4,1)) * t28 + (-t10 / 0.2e1 + t11 / 0.2e1 - t9 / 0.2e1 + t7 * mrSges(5,3) - t2 * mrSges(7,3) + t3 * mrSges(6,2) + (Ifges(7,6) / 0.2e1 - Ifges(6,6) / 0.2e1) * t43 + t98 * pkin(8)) * t79 + (t12 / 0.2e1 + t13 / 0.2e1 + t14 / 0.2e1 - t105 / 0.2e1 + t4 * mrSges(6,2) - t6 * mrSges(5,3) - t1 * mrSges(7,3) + t97 * pkin(8)) * t77 + m(6) * (t45 * t8 + (t3 * t79 + t4 * t77) * pkin(8)) + m(5) * (-pkin(3) * t28 + (-t6 * t77 + t7 * t79) * pkin(8)) + m(7) * (t1 * t47 + t2 * t51 + t41 * t5) + (Ifges(4,5) + (t55 / 0.2e1 + t56 / 0.2e1 + t57 / 0.2e1) * t79 + (t52 / 0.2e1 + t53 / 0.2e1 - t54 / 0.2e1) * t77) * t44; m(7) * (-t47 * t79 + t51 * t77); -0.2e1 * pkin(3) * t50 + 0.2e1 * t41 * t49 + 0.2e1 * t45 * t48 + Ifges(4,3) + m(6) * (t45 ^ 2 + t95) + m(7) * (t41 ^ 2 + t47 ^ 2 + t51 ^ 2) + m(5) * (pkin(3) ^ 2 + t95) + (t51 * t116 - t52 - t53 + t54) * t79 + (t47 * t116 + t55 + t56 + t57) * t77 + (mrSges(6,2) + mrSges(5,3)) * pkin(8) * t118; t6 * mrSges(5,1) - t4 * mrSges(6,1) - t1 * mrSges(7,1) - t7 * mrSges(5,2) + t2 * mrSges(7,2) + t3 * mrSges(6,3) + Ifges(7,3) * t43 - pkin(4) * t24 + t80 * t22 + (t20 + t25) * qJ(5) + m(7) * (qJ(5) * t2 + t1 * t80) + m(6) * (-pkin(4) * t4 + qJ(5) * t3) + (-Ifges(7,5) * t79 + t101 * t77) * t44 + t87; (mrSges(5,1) + mrSges(6,1)) * t79 + (-mrSges(5,2) + mrSges(6,3)) * t77 + m(6) * t96 + m(7) * (-t79 * t80 + t62) + t49; m(7) * (qJ(5) * t51 + t47 * t80) - t47 * mrSges(7,1) + t51 * mrSges(7,2) + t66 + t65 + t67 + (-pkin(4) * mrSges(6,2) - t80 * mrSges(7,3) - Ifges(7,5)) * t77 + (qJ(5) * t102 - Ifges(6,6) + Ifges(7,6)) * t79 + (-m(6) * t84 - t85 - t86) * pkin(8); 0.2e1 * pkin(4) * mrSges(6,1) - 0.2e1 * t80 * mrSges(7,1) + Ifges(7,3) + 0.2e1 * (mrSges(6,3) + mrSges(7,2)) * qJ(5) + m(7) * (t80 ^ 2 + t81) + m(6) * (pkin(4) ^ 2 + t81) + t120; m(6) * t4 + m(7) * t1 + t22 + t24; -t113 * t79; m(7) * t47 + (m(6) * pkin(8) + t102) * t77; -m(6) * pkin(4) + m(7) * t80 - mrSges(6,1) - mrSges(7,1); t113; m(7) * t5 + t17; 0; m(7) * t41 + t49; 0; 0; m(7);];
