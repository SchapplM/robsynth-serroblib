% Umwandlung der Kinematikparameter von S6RPRRPP5V1 zu S6RPRRPP5
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S6RPRRPP5_structural_kinematic_parameters.m
function pkin_gen = S6RPRRPP5V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
