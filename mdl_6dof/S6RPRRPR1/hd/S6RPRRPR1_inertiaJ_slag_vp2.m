...
t34 = t37 ^ 2;
t14 = t92 * t37;
t1 = [-0.2e1 * t27 * t53 * mrSges(5,3) + Ifges(4,2) * t127 + 0.2e1 * t65 * t94 + Ifges(5,1) * t123 + 0.2e1 * t54 * t97 + 0.2e1 * t38 * t105 + t14 * t122 + 0.2e1 * t3 * t15 + 0.2e1 * t2 * t16 + Ifges(2,3) + Ifges(3,3) + (0.2e1 * t28 * mrSges(5,3) + 0.2e1 * Ifges(5,4) * t53 + Ifges(5,2) * t52) * t52 + (-0.2e1 * t12 * mrSges(6,3) + Ifges(6,2) * t35 + t106) * t35 + (mrSges(6,3) * t122 + Ifges(6,1) * t37 - t77 * t7 + t80 * t8 + (-Ifges(7,6) * t77 - (2 * Ifges(6,4))) * t35) * t37 + m(4) * (t102 * t63 ^ 2 + t65 ^ 2) + m(5) * (t27 ^ 2 + t28 ^ 2 + t54 ^ 2) + m(6) * (t12 ^ 2 + t38 ^ 2 + t125) + m(7) * (t2 ^ 2 + t3 ^ 2 + t125) + m(3) * (t74 ^ 2 + t76 ^ 2) * pkin(1) ^ 2 + (Ifges(4,1) * t79 + 0.2e1 * Ifges(4,4) * t82) * t79 + 0.2e1 * (t76 * mrSges(3,1) - t74 * mrSges(3,2)) * pkin(1) + 0.2e1 * t102 * t63 * mrSges(4,3); t35 * t14 + t91 * t37 + m(7) * (t95 * t37 + t114) + m(5) * (t27 * t52 + t28 * t53) + m(6) * (t12 * t37 + t114); m(3) + m(7) * (t103 * t34 + t124) + m(5) * (t52 ^ 2 + t123) + m(6) * (t34 + t124) + m(4) * t102; t91 * t41 + m(6) * (-t10 * t44 + t12 * t45) + (-mrSges(4,1) * t79 - mrSges(4,2) * t82) * t63 + (-t35 * t45 - t37 * t44) * mrSges(6,3) + (m(5) * (t27 * t81 + t28 * t78) + (t52 * t78 - t53 * t81) * mrSges(5,3)) * pkin(3) + m(7) * (t10 * t40 + t95 * t41) + Ifges(4,6) * t82 + Ifges(4,5) * t79 + t40 * t14 + t86; m(7) * (t35 * t40 + t37 * t99) + m(6) * (-t35 * t44 + t37 * t45) + m(5) * (t52 * t81 + t53 * t78) * pkin(3) + t88 - t94; 0.2e1 * t111 - 0.2e1 * t110 + t40 * t121 + Ifges(4,3) + 0.2e1 * t89 + t41 * t90 + m(6) * (t44 ^ 2 + t45 ^ 2) + m(7) * (t103 * t41 ^ 2 + t40 ^ 2) + m(5) * (t78 ^ 2 + t81 ^ 2) * pkin(3) ^ 2 + t96; (m(6) * (-t10 * t75 + t12 * t73) + (-t35 * t73 - t37 * t75) * mrSges(6,3)) * pkin(4) + t86 + (m(7) * t10 + t14) * t64 + (m(7) * t95 + t91) * t62; m(7) * (t64 * t35 + t37 * t98) + (-t35 * t75 + t37 * t73) * t126 + t88; m(7) * (t40 * t64 + t41 * t98) - t110 + t111 + (t40 + t64) * t55 + t89 + (m(6) * (t44 * t75 + t45 * t73) + t93) * pkin(4) + (t98 + t99) * mrSges(7,3) + t96; t64 * t121 + t62 * t90 + m(7) * (t103 * t62 ^ 2 + t64 ^ 2) + t96 + (0.2e1 * t93 + (t73 ^ 2 + t75 ^ 2) * t126) * pkin(4); t77 * t15 + t80 * t16 + m(7) * (t2 * t80 + t3 * t77) + m(6) * t38 + t105; 0; 0; 0; m(7) * t103 + m(6); mrSges(7,1) * t2 - mrSges(7,2) * t3 - Ifges(7,6) * t113 + t106; -t14; -t92 * t41 + t104; -t92 * t62 + t104; -t55; Ifges(7,3);];
