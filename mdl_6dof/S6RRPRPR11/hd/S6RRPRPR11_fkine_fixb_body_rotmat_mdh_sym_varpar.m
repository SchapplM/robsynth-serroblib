...
function Tc_mdh = S6RRPRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRPRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRPRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRPRPR11_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [10x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:11:40
	% EndTime: 2020-11-04 22:11:40
...
elseif link_index == 6
	...
	% EndTime: 2020-11-04 22:11:40
	% DurationCPUTime: 0.04s
	% Computational Cost: add. (63->26), mult. (45->30), div. (0->0), fcn. (58->11), ass. (0->18)
	t109 = sin(pkin(10)) * pkin(5);
	t100 = sin(qJ(2));
	t101 = sin(qJ(1));
	t108 = t100 * t101;
	t104 = cos(qJ(1));
	...
	t99 = sin(qJ(4));
	t105 = -t102 * t95 + t99 * t109 - pkin(3) - pkin(7);
	t103 = cos(qJ(2));
	t97 = qJ(5) + pkin(2) + pkin(8) + pkin(9);
	t96 = qJ(6) + t106;
	t94 = cos(t96);
	t93 = sin(t96);
	t92 = t97 * t103 + (t102 * t109 + t99 * t95 + qJ(3)) * t100 + pkin(1);
	t1 = [t101 * t94 + t93 * t107, -t101 * t93 + t94 * t107, t104 * t103, -t105 * t101 + t92 * t104 + 0; -t104 * t94 + t93 * t108, t104 * t93 + t94 * t108, t101 * t103, t92 * t101 + t105 * t104 + 0; -t103 * t93, -t103 * t94, t100, t97 * t100 + pkin(6) + 0 + (-sin(t106) * pkin(5) - t99 * pkin(4) - qJ(3)) * t103; 0, 0, 0, 1;];
	Tc_mdh = t1;
end