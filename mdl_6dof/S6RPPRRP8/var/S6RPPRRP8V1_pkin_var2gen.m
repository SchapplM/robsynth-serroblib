% Umwandlung der Kinematikparameter von S6RPPRRP8V1 zu S6RPPRRP8
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S6RPPRRP8_structural_kinematic_parameters.m
function pkin_gen = S6RPPRRP8V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
