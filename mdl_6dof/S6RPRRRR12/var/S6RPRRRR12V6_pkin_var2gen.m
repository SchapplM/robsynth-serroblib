% Umwandlung der Kinematikparameter von S6RPRRRR12V6 zu S6RPRRRR12
% Eingabe:
% pkin_var (6x1) double
%   Kinematikparameter (pkin) von S6RPRRRR12V6
...
function pkin_gen = S6RPRRRR12V6_pkin_var2gen(pkin_var)
pkin_gen = zeros(14,1);
pkin_gen([5, 6, 7, 9, 13, 14]) = pkin_var;
