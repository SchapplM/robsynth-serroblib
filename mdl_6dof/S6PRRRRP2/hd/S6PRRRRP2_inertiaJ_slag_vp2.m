...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:28:16
% EndTime: 2018-11-23 15:28:17
...
t37 = t129 * t71;
t36 = t128 * t71;
t1 = [m(2) + m(5) * (t33 ^ 2 + t30 + t87) + m(4) * (t60 ^ 2 + t61 ^ 2 + t87) + m(3) * (t109 ^ 2 * t99 + t105 ^ 2 + t87) + (m(7) + m(6)) * (t20 ^ 2 + t22 ^ 2 + t30); -t33 * t70 * mrSges(5,3) + t159 * t22 + t158 * t20 + t126 * mrSges(4,3) + (t71 * mrSges(5,3) + t36 + t37) * t31 + (-t109 * mrSges(3,2) + (mrSges(3,1) - t43 - t78) * t113) * t104 + m(7) * (t10 * t31 + t20 * t4 + t22 * t3) + m(6) * (-t20 * t7 + t22 * t8 + t160) + m(5) * (-t142 * t91 + t33 * t52 + t160) + m(4) * (pkin(2) * t142 + pkin(8) * t126); Ifges(4,2) * t103 - 0.2e1 * pkin(2) * t78 + 0.2e1 * t10 * t36 + 0.2e1 * t3 * t42 + t37 * t171 + 0.2e1 * t8 * t39 + 0.2e1 * t4 * t41 + 0.2e1 * t7 * t40 + 0.2e1 * t91 * t43 + Ifges(3,3) + (Ifges(4,1) * t108 + 0.2e1 * Ifges(4,4) * t112) * t108 + 0.2e1 * t140 * pkin(8) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t52 + Ifges(5,2) * t70 + t132) * t70 + m(4) * (pkin(8) ^ 2 * t140 + pkin(2) ^ 2) + m(5) * (t52 ^ 2 + t91 ^ 2 + t172) + m(6) * (t7 ^ 2 + t8 ^ 2 + t172) + m(7) * (t10 ^ 2 + t3 ^ 2 + t4 ^ 2) + (mrSges(5,3) * t171 + Ifges(5,1) * t71 - 0.2e1 * Ifges(5,4) * t70 + t180 * t110 + (t25 - t26 - t165) * t106) * t71; t60 * mrSges(4,1) - t61 * mrSges(4,2) + m(7) * (t31 * t62 + t134) + m(6) * (t31 * t90 + t134) + m(5) * (t107 * t33 - t111 * t31) * pkin(3) + t120; (-t108 * mrSges(4,1) - t112 * mrSges(4,2)) * pkin(8) + t117 + Ifges(4,5) * t108 + Ifges(4,6) * t112 + t90 * t37 + t62 * t36 + t123 * t89 + m(7) * (t10 * t62 + t131 * t89) + m(6) * (t130 * t89 + t50 * t90) + (m(5) * (t107 * t52 - t111 * t50) + (-t107 * t70 - t111 * t71) * mrSges(5,3)) * pkin(3); t62 * t170 + 0.2e1 * t90 * t77 + Ifges(4,3) + 0.2e1 * t124 + m(6) * (t90 ^ 2 + t156) + m(7) * (t62 ^ 2 + t156) + m(5) * (t107 ^ 2 + t111 ^ 2) * pkin(3) ^ 2 + t119 * t89 + t125; m(7) * (t31 * t73 + t135) + m(6) * (-pkin(4) * t31 + t135) + t120; t123 * pkin(10) + t117 + t73 * t36 - pkin(4) * t37 + m(6) * (-pkin(4) * t50 + pkin(10) * t130) + m(7) * (pkin(10) * t131 + t10 * t73); (t90 - pkin(4)) * t77 + (t62 + t73) * t76 + t124 + m(6) * (-pkin(4) * t90 + t157) + m(7) * (t62 * t73 + t157) + t125 + (pkin(10) + t89) * t173; -0.2e1 * pkin(4) * t77 + t73 * t170 + m(7) * (t73 ^ 2 + t154) + m(6) * (pkin(4) ^ 2 + t154) + t119 * pkin(10) + t125; (m(7) * qJ(6) - mrSges(6,2) + mrSges(7,3)) * t22 + (-mrSges(6,1) + t174) * t20; -Ifges(6,6) * t148 - pkin(5) * t41 + m(7) * (-pkin(5) * t4 + qJ(6) * t3) + qJ(6) * t42 + t3 * mrSges(7,3) + t7 * mrSges(6,1) - t4 * mrSges(7,1) - t8 * mrSges(6,2) + t132; t118 * t89 + t121; pkin(10) * t118 + t121; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t181; m(7) * t20; m(7) * t4 + t41; m(7) * t147 + t93; m(7) * t106 * pkin(10) + t93; t174; m(7);];
