...
t44 = qJD(1) * t214 + t290;
t196 = t204 * qJ(3);
t163 = pkin(4) * t204 + t196;
t147 = pkin(8) * t204 + t163;
t197 = t205 * qJ(3);
t164 = pkin(4) * t205 + t197;
...
t347 = t150 * t315;
t346 = t205 * t315;
t262 = -t150 * t206 + t151 * t208;
t295 = t205 * t207;
t345 = pkin(4) * t295 + qJ(5) * t209;
t281 = qJD(4) * t209;
t283 = qJD(2) * t207;
t344 = qJ(4) * t283 - t281;
...
t264 = t209 * t278;
t257 = t205 * t264;
t135 = qJD(2) * t237 - qJD(3) * t207;
t119 = t135 * qJD(1);
t191 = pkin(7) * t285;
t157 = (qJD(3) - t191) * qJD(2);
t60 = t119 * t205 - t157 * t204;
t228 = pkin(4) * t257 + qJD(1) * t198 - t60;
t17 = (-t207 * t315 + t277) * t278 + t228;
t265 = t207 * t278;
t61 = t119 * t204 + t157 * t205;
t274 = qJ(4) * t265 + t61;
t18 = (-t281 + (pkin(5) * t207 - t260) * qJD(2)) * qJD(1) + t274;
t193 = pkin(3) * t284;
t161 = -pkin(2) * t209 - qJ(3) * t207 - pkin(1);
t144 = t161 * qJD(1);
t192 = pkin(7) * t284;
t171 = qJD(2) * qJ(3) + t192;
t85 = t144 * t205 - t171 * t204;
t62 = qJD(4) + t193 - t85;
t220 = qJ(5) * t284 + t62;
t20 = t151 * t332 + t220;
t314 = -pkin(5) - qJ(4);
t266 = t314 * t209;
t86 = t144 * t204 + t171 * t205;
...
t298 = t204 * t209;
t297 = t205 * t135;
t112 = mrSges(5,1) * t150 + mrSges(5,3) * t284;
t114 = -mrSges(6,1) * t284 + mrSges(6,2) * t150;
t293 = t114 - t112;
t117 = qJD(1) * t221;
t138 = t153 * qJD(6);
t292 = -t117 + t138;
t118 = qJD(1) * t223;
t291 = t118 - t137;
t289 = -qJ(4) * t257 - qJD(4) * t151;
t258 = t204 * t264;
t130 = mrSges(6,1) * t265 + mrSges(6,2) * t258;
t122 = mrSges(4,1) * t258 + mrSges(4,2) * t257;
t288 = t193 * t204 + t192;
t134 = mrSges(5,1) * t257 + mrSges(5,2) * t265;
t286 = pkin(3) * t299 + pkin(7) * t207;
t110 = pkin(7) * t294 + t161 * t204;
t276 = pkin(7) * t283;
t111 = -mrSges(6,2) * t151 + mrSges(6,3) * t284;
t113 = mrSges(5,1) * t151 - mrSges(5,2) * t284;
t116 = -mrSges(4,1) * t284 - mrSges(4,3) * t151;
t273 = t111 + t113 - t116;
t115 = mrSges(4,2) * t284 - mrSges(4,3) * t150;
t272 = t115 + t293;
t9 = -t36 * mrSges(7,1) + mrSges(7,2) * t35;
...
t103 = qJ(4) * t209 - t110;
t248 = pkin(4) * t209 * t279 + t198 - t297;
t104 = -t109 + t203;
t123 = t204 * t135;
t247 = t123 + t344;
...
t213 = (Ifges(5,4) * t207 + t209 * t239) * t351 - t27 * mrSges(6,1) - t54 * mrSges(5,3) + t48 * mrSges(5,1) - t24 * mrSges(6,2) - t60 * mrSges(4,3) + (t207 * t361 + t209 * t356) * t350;
...
t8 = Ifges(7,1) * t35 + Ifges(7,4) * t36 + Ifges(7,5) * t265;
t7 = Ifges(7,4) * t35 + Ifges(7,2) * t36 + Ifges(7,6) * t265;
t4 = -qJD(6) * t13 - t206 * t29 + t208 * t30;
t3 = qJD(6) * t12 + t206 * t30 + t208 * t29;
t10 = [m(4) * (t109 * t60 + t110 * t61 + t85 * t94 + t86 * t95) + t37 * t22 + t12 * t25 + t13 * t26 + (((-0.2e1 * t331 + Ifges(7,5) * t328 + Ifges(7,6) * t329 - 0.3e1 / 0.2e1 * t312 + t343 * t207) * qJD(1) - pkin(7) * t172 + t267 + t340) * t207 + (t348 + (-0.2e1 * t330 + 0.3e1 / 0.2e1 * Ifges(3,4) * t209 + (0.3e1 / 0.2e1 * Ifges(6,6) + 0.3e1 / 0.2e1 * Ifges(5,4) - 0.3e1 / 0.2e1 * Ifges(4,5)) * t294 + (0.3e1 / 0.2e1 * Ifges(6,4) - 0.3e1 / 0.2e1 * Ifges(5,5) + 0.3e1 / 0.2e1 * Ifges(4,6)) * t298 + (-Ifges(7,3) / 0.2e1 + 0.3e1 / 0.2e1 * Ifges(3,1) + m(4) * pkin(7) ^ 2 - 0.3e1 / 0.2e1 * Ifges(4,3) - 0.3e1 / 0.2e1 * Ifges(6,2) - 0.3e1 / 0.2e1 * Ifges(5,1) - 0.3e1 / 0.2e1 * Ifges(3,2) + (pkin(7) * mrSges(4,2) + (Ifges(5,2) / 0.2e1 + Ifges(4,1) / 0.2e1 + Ifges(6,3) / 0.2e1) * t205) * t205 + (pkin(7) * mrSges(4,1) + (Ifges(5,3) / 0.2e1 + Ifges(6,1) / 0.2e1 + Ifges(4,2) / 0.2e1) * t204 + (-Ifges(4,4) + t360) * t205) * t204) * t207) * qJD(1) + t339) * t209) * qJD(2) + (-t1 * t127 - t128 * t2 - t5 * t56 + t55 * t6) * mrSges(7,3) + t19 * (mrSges(7,1) * t127 + mrSges(7,2) * t128) + (Ifges(7,4) * t128 - Ifges(7,2) * t127) * t337 + (Ifges(7,1) * t128 - Ifges(7,4) * t127) * t338 + (pkin(7) * t122 + t204 * t212 + t205 * t213) * t207 + (-t180 / 0.2e1 + t45 * mrSges(5,3) - t28 * mrSges(6,1) + t61 * mrSges(4,2) - t48 * mrSges(5,2) + t24 * mrSges(6,3) - t60 * mrSges(4,1) + t342) * t209 + t3 * t50 + t4 * t51 + t55 * t15 / 0.2e1 + t56 * t16 / 0.2e1 + t23 * (-mrSges(7,1) * t55 + mrSges(7,2) * t56) + t79 * t9 + t47 * t90 + t88 * t92 + t42 * t111 + t59 * t112 + t78 * t113 + t46 * t114 + t95 * t115 + t94 * t116 + t102 * t120 + t125 * t121 + t110 * t129 + t84 * t130 + t109 * t131 + t65 * t132 + t103 * t133 + t104 * t134 + (Ifges(7,5) * t56 + Ifges(7,6) * t55) * t324 + t8 * t328 + t7 * t329 + (Ifges(7,1) * t56 + Ifges(7,4) * t55) * t333 + (Ifges(7,4) * t56 + Ifges(7,2) * t55) * t335 + m(7) * (t1 * t13 + t12 * t2 + t19 * t79 + t23 * t37 + t3 * t6 + t4 * t5) + m(6) * (-t102 * t27 + t24 * t65 + t28 * t84 + t34 * t42 + t38 * t47 + t39 * t46) + m(5) * (t103 * t45 + t104 * t48 + t125 * t54 + t58 * t88 + t59 * t64 + t62 * t78); (-t118 / 0.2e1 + t137 / 0.2e1) * t16 + m(4) * (-t196 * t60 + t197 * t61 + (-t204 * t85 + t205 * t86) * qJD(3)) - m(4) * (t85 * t105 + t86 * t106) + t358 * t51 + (t1 * t76 + t124 * t19 + t2 * t75 + t359 * t6 + t358 * t5 + (-t159 - t57) * t23) * m(7) + t359 * t50 + (Ifges(7,5) * t137 - Ifges(7,6) * t138) * t324 + (Ifges(7,1) * t137 - Ifges(7,4) * t138) * t333 + (Ifges(7,4) * t137 - Ifges(7,2) * t138) * t335 + (-t108 * t58 - t62 * t93 - t64 * t89 + t158 * t54 + (-qJ(3) * t45 - qJD(3) * t64) * t205 + (qJ(3) * t48 + qJD(3) * t62 - qJD(4) * t58) * t204) * m(5) - t57 * t22 + t75 * t25 + t76 * t26 + (((-Ifges(6,4) * t205 + Ifges(6,6) * t204) * t365 + (t331 + t312 / 0.2e1) * qJD(1) + (t172 + t301) * pkin(7) + t267 - t340) * t207 + ((t209 * t343 + t330) * qJD(1) + (-Ifges(3,1) / 0.2e1 + Ifges(4,3) / 0.2e1 + Ifges(6,2) / 0.2e1 + Ifges(5,1) / 0.2e1 + Ifges(3,2) / 0.2e1) * t285 + ((Ifges(4,2) * t205 + t311) * t323 + (-Ifges(5,2) * t204 - t306) * t321 + t366 + (-m(4) * pkin(2) - mrSges(4,1) * t205 + mrSges(4,2) * t204 - mrSges(3,1)) * pkin(7) + (-t205 * t363 - t307 + t309) * t322 + (t204 * t364 - t308 + t310) * t320) * qJD(2) - t190 / 0.2e1 - t339) * t209 + (Ifges(7,5) * t153 + Ifges(7,6) * t152 + (-Ifges(5,5) + Ifges(4,6)) * t205 + (-Ifges(5,4) + Ifges(4,5)) * t204) * t283 / 0.2e1) * qJD(1) + (-t34 * t49 - t39 * t63 - t139 * t27 + t163 * t24 + t164 * t28 + (t204 * t34 + t205 * t39) * qJD(3) + (-t87 + t159) * t38) * m(6) - t87 * t90 - t108 * t92 - t49 * t111 - t89 * t112 - t93 * t113 - t63 * t114 - t106 * t115 - t105 * t116 - pkin(2) * t122 + t124 * t9 + t139 * t120 + t152 * t7 / 0.2e1 + t153 * t8 / 0.2e1 + t19 * (-mrSges(7,1) * t152 + mrSges(7,2) * t153) + t158 * t121 + (Ifges(7,4) * t153 + Ifges(7,2) * t152) * t337 + (Ifges(7,1) * t153 + Ifges(7,4) * t152) * t338 + t163 * t132 + t164 * t130 + (t117 / 0.2e1 - t138 / 0.2e1) * t15 + (Ifges(7,5) * t118 - Ifges(7,6) * t117) * t325 + (Ifges(7,1) * t118 - Ifges(7,4) * t117) * t334 + (Ifges(7,4) * t118 - Ifges(7,2) * t117) * t336 + ((t129 - t133) * qJ(3) + t272 * qJD(3) - t212) * t205 + (-qJD(4) * t92 + (-t131 + t134) * qJ(3) + t273 * qJD(3) + t213) * t204 + (mrSges(7,1) * t292 - mrSges(7,2) * t291) * t23 + (t1 * t152 - t153 * t2 + t291 * t5 - t292 * t6) * mrSges(7,3) + t313 * t159; -t262 * t50 + t82 * t51 - t273 * t151 + t272 * t150 + (m(4) * pkin(7) + (-mrSges(6,1) - mrSges(5,3)) * t205 + (-mrSges(5,2) + mrSges(6,3)) * t204) * t264 - m(4) * (-t150 * t86 - t151 * t85) + t9 + t122 + (-t262 * t6 + t5 * t82 + t19) * m(7) + (t150 * t39 - t151 * t34 + t27) * m(6) + (-t150 * t64 - t151 * t62 + t54) * m(5); -t206 * t25 + t208 * t26 + t232 * qJD(6) + (t92 - t313) * t151 + (-mrSges(6,3) * t283 + (-mrSges(6,2) * t279 - t232 + t293) * t209) * qJD(1) + t134 + (t1 * t208 + t23 * t151 - t2 * t206 + t185 * (-t206 * t6 - t208 * t5)) * m(7) + (-t151 * t38 + t284 * t39 + t24) * m(6) + (t151 * t58 - t284 * t64 + t48) * m(5); t206 * t26 + t208 * t25 + t313 * t150 + t233 * qJD(6) + (-t111 - t233) * t284 + t130 + (t1 * t206 - t23 * t150 + t2 * t208 + t185 * (-t206 * t5 + t208 * t6)) * m(7) + (t150 * t38 - t284 * t34 + t28) * m(6); t180 - t23 * (mrSges(7,1) * t82 + mrSges(7,2) * t262) + (Ifges(7,1) * t262 - t319) * t334 + t15 * t333 + (Ifges(7,5) * t262 - Ifges(7,6) * t82) * t325 - t5 * t50 + t6 * t51 + (t262 * t5 + t6 * t82) * mrSges(7,3) + (-Ifges(7,2) * t82 + t16 + t77) * t336 - t342;];
tauc  = t10(:);
