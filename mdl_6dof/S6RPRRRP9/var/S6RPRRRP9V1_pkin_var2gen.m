% Umwandlung der Kinematikparameter von S6RPRRRP9V1 zu S6RPRRRP9
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S6RPRRRP9_structural_kinematic_parameters.m
function pkin_gen = S6RPRRRP9V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
