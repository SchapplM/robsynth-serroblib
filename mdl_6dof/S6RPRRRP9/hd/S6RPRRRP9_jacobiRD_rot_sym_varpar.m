...
function JRD_rot = S6RPRRRP9_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RPRRRP9_jacobiRD_rot_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RPRRRP9_jacobiRD_rot_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RPRRRP9_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S6RPRRRP9_jacobiRD_rot_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 6
	...
	t323 = t316 * t311 * t310;
	t320 = -qJD(1) - t333;
	t318 = -t314 * t329 + t315 * t330;
	t317 = t313 * t327 + t315 * t331;
	t303 = t310 * t329 + t325;
	t302 = t309 * t329 - t324;
	t301 = -t309 * t331 + t334 * t310 - t314 * t326;
	t300 = t320 * t314 * t310 - t334 * t309;
	t299 = t320 * t316 * t309 - t335 * t310;
	t298 = t335 * t309 - t310 * t330 - t313 * t323;
	t1 = [t299, 0, t318 * t310 - t314 * t325, t300, t300, 0; t301, 0, t317 * t310 + t316 * t325, -t298, -t298, 0; 0, 0, -t310 * t328 + t326, t302, t302, 0; t298, 0, -t318 * t309 - t314 * t324, -t301, -t301, 0; t300, 0, -t317 * t309 + t315 * t323, t299, t299, 0; 0, 0, t309 * t328 + t310 * t333, t303, t303, 0; t317, 0, t313 * t330 + t322, 0, 0, 0; -t318, 0, t313 * t331 - t321, 0, 0, 0; 0, 0, -t329, 0, 0, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,6);
end