...
function JaD_transl = S6RRPRRR8_jacobiaD_transl_5_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(3,1),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRPRRR8_jacobiaD_transl_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRPRRR8_jacobiaD_transl_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S6RRPRRR8_jacobiaD_transl_5_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRPRRR8_jacobiaD_transl_5_sym_varpar: pkin has to be [11x1] (double)');

%% Symbolic Calculation
% From jacobiaD_transl_5_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 21:58:14
% EndTime: 2019-02-26 21:58:14
% DurationCPUTime: 0.28s
% Computational Cost: add. (402->59), mult. (449->88), div. (0->0), fcn. (361->10), ass. (0->55)
t237 = pkin(11) + qJ(4);
t234 = cos(t237);
t229 = pkin(4) * t234 + cos(pkin(11)) * pkin(3) + pkin(2);
t239 = sin(qJ(2));
t241 = cos(qJ(2));
t233 = sin(t237);
t273 = pkin(4) * qJD(4);
...
t283 = t274 * t241;
t287 = (-t229 * t239 + t283) * qJD(2) + (pkin(7) + t279 + sin(pkin(11)) * pkin(3)) * qJD(1) - t241 * t261 + t262;
t235 = qJ(5) + t237;
t231 = sin(t235);
t277 = r_i_i_C(2) * t231;
t232 = cos(t235);
