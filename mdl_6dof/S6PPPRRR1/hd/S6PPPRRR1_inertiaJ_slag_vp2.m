...
t31 = -t61 * t62 * t64 + t67 * t66;
t60 = sin(pkin(8));
t65 = cos(pkin(8));
t12 = -t60 * t17 + t65 * t31;
t69 = sin(qJ(5));
t72 = cos(qJ(5));
t18 = t63 * t62 * t59 + (t62 * t89 + t90) * t58;
t70 = sin(qJ(4));
t73 = cos(qJ(4));
t8 = t73 * t18 + (t17 * t65 + t31 * t60) * t70;
t3 = -t72 * t12 + t69 * t8;
t110 = t3 ^ 2;
t88 = t65 * t73;
t92 = t60 * t73;
t6 = -t17 * t88 + t70 * t18 - t31 * t92;
t109 = t6 ^ 2;
t93 = t60 * t70;
...
t2 = t71 * t5 + t68 * t6;
t1 = -t68 * t5 + t71 * t6;
t4 = [m(2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t110) + m(6) * (t5 ^ 2 + t109 + t110) + m(5) * (t12 ^ 2 + t8 ^ 2 + t109) + m(4) * (t17 ^ 2 + t18 ^ 2 + t31 ^ 2) + m(3) * (t67 ^ 2 + (t59 ^ 2 + t64 ^ 2) * t62 ^ 2); m(3) * t67 + m(7) * (t9 * t1 + t10 * t2 + t103) + m(6) * (t15 * t5 + t102 + t103) + m(5) * (t30 * t12 + t21 * t8 + t102) + m(4) * (t66 * t31 + (t17 * t63 + t18 * t58) * t61); m(3) + m(7) * (t10 ^ 2 + t9 ^ 2 + t108) + m(6) * (t15 ^ 2 + t107 + t108) + m(5) * (t21 ^ 2 + t30 ^ 2 + t107) + m(4) * (t66 ^ 2 + (t58 ^ 2 + t63 ^ 2) * t61 ^ 2); m(7) * (t22 * t1 + t23 * t2 + t100) + m(6) * (t34 * t5 - t6 * t92 + t100) + m(5) * (t65 * t12 + (-t6 * t73 + t70 * t8) * t60) + m(4) * t31; m(4) * t66 + m(7) * (t23 * t10 + t22 * t9 + t95) + m(6) * (t34 * t15 - t19 * t92 + t95) + m(5) * (t65 * t30 + (-t19 * t73 + t21 * t70) * t60); m(4) + m(6) * (t34 ^ 2 + t106 + t46) + m(7) * (t22 ^ 2 + t23 ^ 2 + t106) + m(5) * (t51 * t70 ^ 2 + t65 ^ 2 + t46); -t8 * mrSges(5,2) + t1 * t38 + t2 * t37 + t3 * t35 - t85 * t6 + t82 * mrSges(6,3) + m(7) * (pkin(10) * t101 + t25 * t1 + t26 * t2) + m(6) * (-pkin(4) * t6 + t82 * pkin(10)); -t21 * mrSges(5,2) + t10 * t37 + t13 * t35 + t9 * t38 - t85 * t19 + t79 * mrSges(6,3) + m(7) * (pkin(10) * t96 + t26 * t10 + t25 * t9) + m(6) * (-pkin(4) * t19 + t79 * pkin(10)); t22 * t38 + t23 * t37 + t32 * t35 + t76 * mrSges(6,3) + (-t70 * mrSges(5,2) + t85 * t73) * t60 + m(6) * (pkin(4) * t92 + t76 * pkin(10)) + m(7) * (pkin(10) * t94 + t25 * t22 + t26 * t23); -0.2e1 * pkin(4) * t41 + 0.2e1 * t25 * t38 + 0.2e1 * t26 * t37 + Ifges(5,3) + (t55 + t57) * mrSges(6,3) * t113 + m(6) * (pkin(4) ^ 2 + t57 * t75 + t50) + m(7) * (t25 ^ 2 + t26 ^ 2 + t50) + (-t45 + (Ifges(6,2) + Ifges(7,3)) * t72) * t72 + (Ifges(6,1) * t69 + 0.2e1 * Ifges(6,4) * t72 + t35 * t113 + t71 * t29 + (-t28 + t97) * t68) * t69; -t5 * mrSges(6,2) + t112 * (-t1 * t68 + t2 * t71) + t111 * t3; -t15 * mrSges(6,2) + t112 * (t10 * t71 - t9 * t68) + t111 * t13; -t34 * mrSges(6,2) + t112 * (-t22 * t68 + t23 * t71) + t111 * t32; -pkin(5) * t35 + t68 * t29 / 0.2e1 + t28 * t105 + (-t49 / 0.2e1 - t48 / 0.2e1 + Ifges(6,6) - pkin(10) * mrSges(6,2)) * t72 + t77 * mrSges(7,3) + (m(7) * t77 + t71 * t37 - t68 * t38) * pkin(11) + (Ifges(6,5) + t43 * t105 - t68 * t42 / 0.2e1 + t111 * pkin(10)) * t69; Ifges(6,3) + m(7) * (t84 * pkin(11) ^ 2 + pkin(5) ^ 2) + t71 * t42 - 0.2e1 * pkin(5) * t40 + t68 * t43 + 0.2e1 * t84 * pkin(11) * mrSges(7,3); t1 * mrSges(7,1) - t2 * mrSges(7,2); t9 * mrSges(7,1) - t10 * mrSges(7,2); t22 * mrSges(7,1) - t23 * mrSges(7,2); t25 * mrSges(7,1) - t26 * mrSges(7,2) - Ifges(7,6) * t87 - Ifges(7,3) * t72 + t45; -t80 * pkin(11) + t48 + t49; Ifges(7,3);];
