...
% OptimizationMode: 2
% StartTime: 2018-11-23 14:48:40
% EndTime: 2018-11-23 14:48:42
...
t10 = qJD(5) * t24 + t114 * t33;
t9 = -qJD(5) * t23 + t117 * t33;
t4 = -qJD(6) * t12 - t113 * t9 + t116 * t34;
t3 = qJD(6) * t11 + t113 * t34 + t116 * t9;
t35 = [t11 * t61 + t12 * t62 + t23 * t50 + t3 * t77 + t34 * t92 - t203 * t88 + t4 * t78 + t9 * t97 + t179 * t10 + m(7) * (t1 * t12 + t10 * t19 + t11 * t2 + t3 * t6 + t4 * t5 + t194) + m(5) * (t27 * t36 - t31 * t34 + t32 * t33 - t184) + m(6) * (-t10 * t21 + t22 * t9 + t24 * t7 + t29 * t34 - t184 + t194) + (-t34 * mrSges(5,1) - t33 * mrSges(5,2) + (-t114 * t24 + t117 * t23) * t169) * qJD(4); t15 * t77 + t16 * t78 + t37 * t97 + t39 * t61 + t40 * t62 + t48 * t50 + t60 * t92 - t204 * t88 + t179 * t38 + m(7) * (t1 * t40 + t15 * t6 + t16 * t5 + t19 * t38 + t2 * t39 + t193) + m(5) * (t27 * t66 - t31 * t60 + t32 * t59 - t183) + m(6) * (-t21 * t38 + t22 * t37 + t29 * t60 + t49 * t7 - t183 + t193) + (-t60 * mrSges(5,1) - t59 * mrSges(5,2) + (-t114 * t49 + t117 * t48) * t169) * qJD(4); t41 * t77 + t42 * t78 + t84 * t50 + t70 * t61 - t127 * t62 + t68 * t97 + t179 * t69 + (-t114 * t85 + t117 * t84) * mrSges(6,3) * t149 + m(7) * (-t1 * t127 + t19 * t69 + t2 * t70 + t41 * t6 + t42 * t5 + t192) + m(6) * (-t21 * t69 + t22 * t68 + t7 * t85 + t192) + ((-t119 * mrSges(5,2) - t88) * t118 + (-t119 * mrSges(5,1) + qJD(4) * t92) * t115 + m(5) * (t115 * t27 + t156 * t32 - t158 * t31 - t172) + m(6) * (t158 * t29 - t172)) * t105; -pkin(4) * t88 - t32 * t92 + t79 * t61 + t80 * t62 + (-t13 + t52) * t78 + (-t14 + t51) * t77 - m(7) * (t13 * t5 + t14 * t6) + m(7) * (t1 * t80 + t2 * t79 + t5 * t52 + t51 * t6) + (-pkin(4) * t28 / 0.2e1 - t29 * t32 / 0.2e1) * t202 + (-t99 / 0.2e1 - t31 * t97 - t28 * mrSges(6,1) + t7 * mrSges(6,3) + (t200 * t22 + t201 * t7) * t202 + (0.3e1 / 0.2e1 * t102 + t142 + (-m(6) * t21 + m(7) * t19 + t179) * pkin(10) + t208) * qJD(5) + t206) * t117 + (t134 * t199 + t132 * t198 + pkin(10) * t50 + t45 * t190 + t46 * t189 + t28 * mrSges(6,2) + (mrSges(6,3) + t135) * t8 - t179 * t31 + (-t1 * t113 - t2 * t116) * mrSges(7,3) + 0.2e1 * (t19 * t200 + t147) * m(7) + (t21 * t31 / 0.2e1 + t147) * t202 + (t19 * t136 + t131 * t197 + t133 * t196 + t130 * t191 - t116 * t57 / 0.2e1 + t58 * t190 + (t5 * t113 - t6 * t116) * mrSges(7,3)) * qJD(6) + (t141 + (-m(6) * t22 - t97) * pkin(10) + ((t176 / 0.2e1 - t175 / 0.2e1 - 0.3e1 / 0.2e1 * Ifges(6,4)) * t114 + (-Ifges(7,3) / 0.2e1 - 0.3e1 / 0.2e1 * Ifges(6,2) + 0.3e1 / 0.2e1 * Ifges(6,1)) * t117) * qJD(4) - t122) * qJD(5)) * t114; -t7 * mrSges(6,2) - pkin(5) * t50 - t18 * t77 - t17 * t78 - t21 * t97 + t113 * t46 / 0.2e1 + t45 * t189 + t133 * t199 + t131 * t198 + (-mrSges(6,1) - t136) * t8 - t179 * t22 + t207 * mrSges(7,3) + t120 * qJD(6) + ((Ifges(6,4) * t209 + t130 * t210 + t122 + t141) * t114 + (t142 - t102 / 0.2e1 + (-Ifges(6,1) / 0.2e1 + Ifges(6,2) / 0.2e1) * t159 - t208) * t117) * qJD(4) + (-pkin(5) * t8 - t17 * t5 - t18 * t6 - t19 * t22) * m(7) + (-t113 * t61 + t116 * t62 + m(7) * t207 + (-m(7) * t137 - t113 * t77 - t116 * t78) * qJD(6)) * pkin(11); t99 + (Ifges(7,5) * t90 - Ifges(7,6) * t91) * t191 + (Ifges(7,1) * t90 - t188) * t196 - t5 * t77 + t6 * t78 + t57 * t195 - t19 * (mrSges(7,1) * t91 + mrSges(7,2) * t90) + (t5 * t90 + t6 * t91) * mrSges(7,3) + (-Ifges(7,2) * t91 + t58 + t89) * t197 - t206;];
tauc  = t35(:);
