...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:04:04
% EndTime: 2018-11-23 16:04:05
% DurationCPUTime: 0.96s
% Computational Cost: add. (1678->261), mult. (3319->374), div. (0->0), fcn. (3420->10), ass. (0->105)
t100 = cos(qJ(5));
t92 = sin(pkin(11));
t94 = cos(pkin(11));
t97 = sin(qJ(5));
...
t42 = -t68 * mrSges(6,1) + t69 * mrSges(6,2);
t129 = -t14 - t42;
...
t113 = t101 * t84;
t41 = t94 * t113 + t92 * t64;
t33 = -pkin(8) * t122 + t41;
t13 = t100 * t33 + t97 * t28;
t73 = t118 * t92;
t75 = t118 * t94;
t46 = t100 * t75 - t97 * t73;
t74 = -t94 * mrSges(5,1) + t92 * mrSges(5,2);
t116 = t74 - mrSges(4,1);
t59 = pkin(4) * t122 + t79;
t115 = t92 ^ 2 + t94 ^ 2;
t90 = t98 ^ 2;
...
t2 = t4 * t99 - t5 * t96;
t3 = t4 * t96 + t5 * t99;
t108 = t2 * mrSges(7,1) - t3 * mrSges(7,2) - t117;
t29 = -pkin(9) * t69 + t45;
t30 = pkin(9) * t68 + t46;
t10 = t29 * t99 - t30 * t96;
t11 = t29 * t96 + t30 * t99;
t36 = Ifges(7,6) * t38;
t37 = Ifges(7,5) * t39;
t107 = t10 * mrSges(7,1) - t11 * mrSges(7,2) + t36 + t37;
