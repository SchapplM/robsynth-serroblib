...
%% Function calls
if link_index == 0
	Ja=S6RPRRRP12_jacobia_0_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 1
	Ja=S6RPRRRP12_jacobia_1_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 2
	Ja=S6RPRRRP12_jacobia_2_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 3
	Ja=S6RPRRRP12_jacobia_3_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 4
	Ja=S6RPRRRP12_jacobia_4_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 5
	Ja=S6RPRRRP12_jacobia_5_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 6
	Ja=S6RPRRRP12_jacobia_6_sym_varpar(qJ, r_i_i_C, pkin);
else
	Ja=NaN(6,6);
end