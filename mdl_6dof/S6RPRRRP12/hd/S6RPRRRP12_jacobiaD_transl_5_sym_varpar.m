...
function JaD_transl = S6RPRRRP12_jacobiaD_transl_5_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(3,1),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RPRRRP12_jacobiaD_transl_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RPRRRP12_jacobiaD_transl_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S6RPRRRP12_jacobiaD_transl_5_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6RPRRRP12_jacobiaD_transl_5_sym_varpar: pkin has to be [12x1] (double)');
...
t639 = sin(pkin(12));
t645 = sin(qJ(1));
t596 = t584 * t639 + t617 * t645;
t559 = t596 * qJD(1);
t615 = t643 * t639;
t564 = t584 * t641 - t615 * t645;
t560 = t564 * qJD(1);
t581 = sin(qJ(3));
...
t625 = t642 * t595;
t631 = t594 * t646;
t541 = t581 * (t621 - t625) + t631;
t635 = t578 * t584;
t650 = t595 * t640 + t635 * t642;
...
t606 = qJD(5) * (r_i_i_C(1) * t579 + r_i_i_C(2) * t582);
t648 = -t564 * t581 - t590 * t646 + t601;
t614 = t642 * t641;
t616 = t643 * t640;
...
t561 = -t624 * t641 + t642 * t643;
t537 = t550 * t583 + t561 * t580;
t612 = -t550 * t580 + t561 * t583;
t611 = r_i_i_C(1) * t582 - r_i_i_C(2) * t579 + pkin(4);
t593 = -t580 * t647 - t583 * t611 - pkin(3);
t588 = qJD(1) * t625;
t586 = t583 * t606 + (t580 * t611 - t583 * t647) * qJD(4);
t558 = t594 * qJD(1);
t546 = t550 * qJD(3);
t545 = t549 * qJD(3);
...
t1 = [t666 * r_i_i_C(1) - t667 * r_i_i_C(2) + t522 * pkin(4) - t526 * pkin(3) + t527 * pkin(10) - t560 * pkin(2) - pkin(9) * t628 + t584 * t632 + t647 * t663 + (r_i_i_C(1) * t665 - r_i_i_C(2) * t664) * qJD(5) + (-t584 * pkin(1) + (-pkin(9) * t619 - qJ(2) * t645) * t578) * qJD(1), t630 (t524 * t579 + t543 * t633) * r_i_i_C(1) + (t524 * t582 - t543 * t634) * r_i_i_C(2) + t524 * pkin(10) + t593 * t523 - t586 * t648, -t517 * t611 + t518 * t647 - t606 * t649, r_i_i_C(1) * t515 - r_i_i_C(2) * t516, 0; -pkin(1) * t629 + t558 * pkin(2) + t524 * pkin(3) + t518 * pkin(4) + pkin(9) * t585 + t523 * pkin(10) + t516 * r_i_i_C(1) + t515 * r_i_i_C(2) + qJ(2) * t630 + t517 * t647 + t645 * t632, t578 * t629 (t526 * t579 - t541 * t633) * r_i_i_C(1) + (t526 * t582 + t541 * t634) * r_i_i_C(2) + t526 * pkin(10) - t593 * t527 + t586 * t538, -t522 * t647 - t606 * t613 + t611 * t663, t667 * r_i_i_C(1) + t666 * r_i_i_C(2) + (r_i_i_C(1) * t664 + r_i_i_C(2) * t665) * qJD(5), 0; 0, 0 (-t545 * t579 + t550 * t633) * r_i_i_C(1) + (-t545 * t582 - t550 * t634) * r_i_i_C(2) - t545 * pkin(10) + t593 * t546 + t586 * t549, t647 * t530 - t612 * t606 + t611 * (-qJD(4) * t537 + t545 * t580) (-t530 * t579 + t546 * t582) * r_i_i_C(1) + (-t530 * t582 - t546 * t579) * r_i_i_C(2) + ((-t537 * t582 - t549 * t579) * r_i_i_C(1) + (t537 * t579 - t549 * t582) * r_i_i_C(2)) * qJD(5), 0;];
JaD_transl  = t1;
