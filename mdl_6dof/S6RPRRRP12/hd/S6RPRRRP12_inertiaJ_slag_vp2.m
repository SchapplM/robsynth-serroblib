...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:31:24
% EndTime: 2018-11-23 16:31:26
...
t41 = t147 * t52 - t150 * t64;
t42 = t147 * t64 + t150 * t52;
t51 = t148 * t65 - t151 * t87;
...
t4 = t147 * t18 + t150 * t8;
t200 = pkin(10) * t151;
t199 = -Ifges(7,2) - Ifges(6,3);
t21 = -mrSges(6,2) * t51 - mrSges(6,3) * t41;
t22 = -mrSges(7,2) * t41 + mrSges(7,3) * t51;
t198 = t21 + t22;
...
t2 = -pkin(5) * t51 - t3;
t1 = qJ(6) * t51 + t4;
t6 = [t65 * (Ifges(4,1) * t65 + Ifges(4,5) * t87) + t87 * t172 + (-0.2e1 * Ifges(4,4) * t65 + Ifges(4,2) * t64 - Ifges(4,6) * t87 + t173) * t64 + m(4) * (t34 ^ 2 + t35 ^ 2 + t46 ^ 2) + m(5) * (t10 ^ 2 + t31 ^ 2 + t9 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t7 ^ 2) + m(3) * (pkin(1) ^ 2 * t143 ^ 2 + t89 ^ 2 + t90 ^ 2) + (-0.2e1 * t90 * mrSges(3,2) + Ifges(3,3) * t146 + t203 * t89) * t146 + (-0.2e1 * pkin(1) * t117 + (-0.2e1 * t89 * mrSges(3,3) + Ifges(3,1) * t181 + Ifges(3,5) * t202) * t141 + (0.2e1 * t90 * mrSges(3,3) + Ifges(3,6) * t202 + (0.2e1 * Ifges(3,4) * t141 + Ifges(3,2) * t144 + pkin(1) * t203) * t143) * t144) * t143 + (-t25 + t205) * t51 + Ifges(2,3) + 0.2e1 * t5 * t19 + 0.2e1 * t7 * t20 + 0.2e1 * t4 * t21 + 0.2e1 * t1 * t22 + 0.2e1 * t3 * t23 + 0.2e1 * t2 * t24 + 0.2e1 * t31 * t33 + 0.2e1 * t10 * t43 + 0.2e1 * t9 * t44 + 0.2e1 * t46 * t45 + t52 * t26 + 0.2e1 * t35 * t53 + 0.2e1 * t34 * t54 + (t11 - t14) * t41 + (t15 + t16) * t42; t145 * t45 + t93 * t43 + t117 + t198 * t71 + t197 * t69 + (-m(3) * pkin(1) - mrSges(3,1) * t144) * t143 + (t19 + t196) * t91 + (t149 * t53 + (-t33 + t54) * t152) * t142 + m(7) * (t1 * t71 + t2 * t69 + t5 * t91) + m(6) * (-t3 * t69 + t4 * t71 + t7 * t91) + m(5) * (t10 * t93 - t182 * t31 - t9 * t91) + m(4) * (t145 * t46 + (t149 * t35 + t152 * t34) * t142); m(3) + m(5) * (t93 ^ 2 + t125 + t88) + m(4) * (t136 * t149 ^ 2 + t145 ^ 2 + t125) + (m(6) + m(7)) * (t69 ^ 2 + t71 ^ 2 + t88); t64 * t175 / 0.2e1 + (pkin(10) * t43 + t10 * mrSges(5,3) - t12 / 0.2e1 - t13 / 0.2e1 + t25 / 0.2e1) * t151 + t168 * t42 + t169 * t41 + m(7) * (t1 * t73 + t2 * t74 + t5 * t85) + m(6) * (pkin(10) * t148 * t7 + t3 * t76 + t4 * t77) + (t80 / 0.2e1 + t81 / 0.2e1 - t111 / 0.2e1) * t51 + t172 + m(5) * (-pkin(3) * t31 + (t10 * t151 - t9 * t148) * pkin(10)) + (-t9 * mrSges(5,3) + t26 / 0.2e1 + t170 * t150 + t171 * t147 + t196 * pkin(10)) * t148 - pkin(3) * t33 + t34 * mrSges(4,1) - t35 * mrSges(4,2) + t73 * t22 + t74 * t24 + t76 * t23 + t77 * t21 + t85 * t19 + t5 * t94 + t7 * t95 + t4 * t98 + t3 * t99 + t2 * t100 + t1 * t101 + t31 * t106 + t52 * t114 / 0.2e1; mrSges(5,3) * t188 + t186 * t71 + t187 * t69 + (t148 * mrSges(5,3) + t94 + t95) * t91 + (-t149 * mrSges(4,2) + (mrSges(4,1) - t106) * t152) * t142 + m(6) * (pkin(10) * t190 - t69 * t76 + t71 * t77) + m(7) * (t69 * t74 + t71 * t73 + t85 * t91) + m(5) * (pkin(3) * t182 + (t188 + t190) * pkin(10)); -0.2e1 * pkin(3) * t106 + 0.2e1 * t74 * t100 + 0.2e1 * t73 * t101 + 0.2e1 * t76 * t99 + 0.2e1 * t77 * t98 + 0.2e1 * t85 * t94 + Ifges(4,3) + (t138 + t140) * mrSges(5,3) * t207 + (-t81 - t80 + t111) * t151 + m(6) * (t76 ^ 2 + t77 ^ 2 + t134) + m(7) * (t73 ^ 2 + t74 ^ 2 + t85 ^ 2) + m(5) * (pkin(3) ^ 2 + t140 * t154 + t134) + (t95 * t207 + t114 + (t83 + t84) * t150 + (t79 - t82) * t147) * t148; t9 * mrSges(5,1) - t10 * mrSges(5,2) - pkin(4) * t20 + t102 * t19 + t5 * t104 + t7 * t105 + t165 * t51 + t164 * t42 + t166 * t41 + (t1 * mrSges(7,2) + t4 * mrSges(6,3) + pkin(11) * t198 - t171) * t150 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + pkin(11) * t197 + t170) * t147 + m(6) * (-pkin(4) * t7 + (-t147 * t3 + t150 * t4) * pkin(11)) + m(7) * (t102 * t5 + (t1 * t150 + t147 * t2) * pkin(11)) + t173; -t93 * mrSges(5,2) + (t104 + t185) * t91 + m(6) * (-pkin(4) * t91 + t162) + m(7) * (t102 * t91 + t162) + t206 * t208; -pkin(4) * t95 + t85 * t104 + (m(7) * t85 + t94) * t102 + (-pkin(10) * mrSges(5,2) - t165) * t151 + (t73 * mrSges(7,2) + t77 * mrSges(6,3) - t169) * t150 + (t74 * mrSges(7,2) - t76 * mrSges(6,3) + t168) * t147 + (t186 * t150 + t187 * t147 + m(7) * (t147 * t74 + t150 * t73) + m(6) * (-t147 * t76 + t150 * t77)) * pkin(11) + (t164 * t150 + t166 * t147 + (-m(6) * pkin(4) + t185) * pkin(10)) * t148 + t175; -0.2e1 * pkin(4) * t105 + 0.2e1 * t102 * t104 + Ifges(5,3) + (-t107 + t110) * t150 + (t112 + t113) * t147 + m(7) * (t102 ^ 2 + t174) + m(6) * (pkin(4) ^ 2 + t174) + 0.2e1 * t206 * pkin(11) * t209; -pkin(5) * t24 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + qJ(6) * t22 + t1 * mrSges(7,3) - t4 * mrSges(6,2) + t3 * mrSges(6,1) - t2 * mrSges(7,1) + t205; (m(7) * qJ(6) - mrSges(6,2) + mrSges(7,3)) * t71 + (-mrSges(6,1) + t204) * t69; t73 * mrSges(7,3) - pkin(5) * t100 + m(7) * (-pkin(5) * t74 + qJ(6) * t73) + qJ(6) * t101 - t77 * mrSges(6,2) + t76 * mrSges(6,1) - t74 * mrSges(7,1) + t199 * t151 + t160 + t176; t157 * mrSges(7,2) + (m(7) * t157 - t158 - t159) * pkin(11) + t109 + t108; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) - t199; m(7) * t2 + t24; m(7) * t69; m(7) * t74 + t100; (m(7) * pkin(11) + mrSges(7,2)) * t147; t204; m(7);];
