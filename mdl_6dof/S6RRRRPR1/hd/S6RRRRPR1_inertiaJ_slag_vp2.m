...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:11:44
% EndTime: 2018-11-23 18:11:45
...
t26 = t31 * mrSges(6,2);
t14 = t117 * t31;
t1 = [0.2e1 * t88 * (-mrSges(4,1) * t73 + mrSges(4,2) * t74) + t74 * (Ifges(4,1) * t74 + Ifges(4,4) * t73) + t73 * (Ifges(4,4) * t74 + Ifges(4,2) * t73) + t48 * (Ifges(5,1) * t48 + Ifges(5,4) * t47) + t47 * (Ifges(5,4) * t48 + Ifges(5,2) * t47) + 0.2e1 * t57 * (-t47 * mrSges(5,1) + mrSges(5,2) * t48) + t26 * t149 + t14 * t150 + 0.2e1 * t3 * t15 + 0.2e1 * t2 * t16 - 0.2e1 * pkin(1) * (-t106 * mrSges(3,1) + t102 * mrSges(3,2)) + t102 * (Ifges(3,1) * t102 + Ifges(3,4) * t106) + t106 * (Ifges(3,4) * t102 + Ifges(3,2) * t106) + Ifges(2,3) + (mrSges(6,1) * t149 - 0.2e1 * t8 * mrSges(6,3) + Ifges(6,2) * t30 + t133) * t30 + (mrSges(6,3) * t150 + Ifges(6,1) * t31 + t103 * t12 - t99 * t11 + (-Ifges(7,6) * t99 - (2 * Ifges(6,4))) * t30) * t31 + m(3) * (pkin(7) ^ 2 * t130 + pkin(1) ^ 2) + m(4) * (t51 ^ 2 + t52 ^ 2 + t88 ^ 2) + m(5) * (t22 ^ 2 + t23 ^ 2 + t57 ^ 2) + m(6) * (t32 ^ 2 + t8 ^ 2 + t151) + m(7) * (t2 ^ 2 + t3 ^ 2 + t151) + 0.2e1 * (-t22 * t48 + t23 * t47) * mrSges(5,3) + 0.2e1 * (-t51 * t74 + t52 * t73) * mrSges(4,3) + 0.2e1 * t130 * pkin(7) * mrSges(3,3); t116 * t39 + m(5) * (t22 * t66 + t23 * t67) + m(6) * (-t42 * t6 + t43 * t8) + (-t102 * mrSges(3,1) - t106 * mrSges(3,2)) * pkin(7) + (-t43 * t30 - t42 * t31) * mrSges(6,3) + (t67 * t47 - t66 * t48) * mrSges(5,3) + t38 * t14 + t112 + Ifges(3,5) * t102 + Ifges(3,6) * t106 + m(7) * (t118 * t39 + t38 * t6) + (m(4) * (t101 * t52 + t105 * t51) + (t101 * t73 - t105 * t74) * mrSges(4,3)) * pkin(2); -0.2e1 * t137 - 0.2e1 * t139 + Ifges(3,3) + 0.2e1 * t33 + 0.2e1 * t34 + 0.2e1 * t35 + 0.2e1 * t36 + 0.2e1 * t60 + 0.2e1 * t115 + m(7) * (t131 * t39 ^ 2 + t38 ^ 2) + m(6) * (t42 ^ 2 + t43 ^ 2) + m(5) * (t66 ^ 2 + t67 ^ 2) + m(4) * (t101 ^ 2 + t105 ^ 2) * pkin(2) ^ 2 + t119; t61 * t14 + t112 + t116 * t62 + m(6) * (-t64 * t6 + t65 * t8) + (-t65 * t30 - t64 * t31) * mrSges(6,3) + m(7) * (t118 * t62 + t61 * t6) + (m(5) * (t100 * t23 + t104 * t22) + (t100 * t47 - t104 * t48) * mrSges(5,3)) * pkin(3); m(7) * (t131 * t39 * t62 + t61 * t38) + t114 + m(5) * (t100 * t67 + t104 * t66) * pkin(3) + m(6) * (t64 * t42 + t43 * t65) + t115 + (-t43 - t65) * mrSges(6,2) + (-t67 - t143) * mrSges(5,2) + Ifges(4,3) + t152; -0.2e1 * t124 - 0.2e1 * t138 + 0.2e1 * t49 + 0.2e1 * t53 + 0.2e1 * t54 + 0.2e1 * t58 + 0.2e1 * t90 + m(7) * (t131 * t62 ^ 2 + t61 ^ 2) + m(6) * (t64 ^ 2 + t65 ^ 2) + m(5) * (t100 ^ 2 + t104 ^ 2) * pkin(3) ^ 2 + t119; t113 + (m(6) * (-t6 * t98 + t8 * t97) + (-t97 * t30 - t98 * t31) * mrSges(6,3)) * pkin(4) + (m(7) * t6 + t14) * t85 + (m(7) * t118 + t116) * t84; m(7) * (t121 * t39 + t38 * t85) - t137 - t139 + (m(6) * (t42 * t98 + t43 * t97) - t136) * pkin(4) + t120 + t152 + t153; -t124 + t114 - t138 + m(7) * (t121 * t62 + t61 * t85) + (-t136 + m(6) * (t64 * t98 + t65 * t97)) * pkin(4) + t153; 0.2e1 * t68 + 0.2e1 * t75 + 0.2e1 * t76 + 0.2e1 * t89 + m(7) * (t131 * t84 ^ 2 + t85 ^ 2) + t120 + (-0.2e1 * t136 + m(6) * (t97 ^ 2 + t98 ^ 2) * pkin(4)) * pkin(4); t30 * mrSges(6,1) + t103 * t16 + t99 * t15 + t26 + m(7) * (t103 * t2 + t99 * t3) + m(6) * t32; 0; 0; 0; m(7) * t131 + m(6); t2 * mrSges(7,1) - t3 * mrSges(7,2) - Ifges(7,6) * t140 + t133; -t117 * t39 + t132; -t117 * t62 + t132; -t117 * t84 + t132; -t77; Ifges(7,3);];
