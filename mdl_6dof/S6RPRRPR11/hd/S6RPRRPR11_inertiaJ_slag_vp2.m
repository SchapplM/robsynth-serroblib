...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:22:07
% EndTime: 2018-11-23 16:22:09
...
t2 = t160 * t3 + t163 * t4;
t1 = -t160 * t4 + t163 * t3;
t12 = [(t7 + t19 - t33) * t58 + (-0.2e1 * pkin(1) * t134 + (-0.2e1 * mrSges(3,3) * t105 + Ifges(3,1) * t181 + Ifges(3,5) * t203) * t153 + (0.2e1 * t106 * mrSges(3,3) + Ifges(3,6) * t203 + (0.2e1 * Ifges(3,4) * t153 + Ifges(3,2) * t157 + pkin(1) * t204) * t155) * t157) * t155 + (-0.2e1 * mrSges(3,2) * t106 + Ifges(3,3) * t159 + t105 * t204) * t159 + t103 * t172 + (-0.2e1 * Ifges(4,4) * t75 + Ifges(4,2) * t74 - Ifges(4,6) * t103 + t173) * t74 + m(7) * (t1 ^ 2 + t11 ^ 2 + t2 ^ 2) + m(6) * (t14 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(5) * (t15 ^ 2 + t16 ^ 2 + t39 ^ 2) + m(4) * (t42 ^ 2 + t43 ^ 2 + t54 ^ 2) + m(3) * (pkin(1) ^ 2 * t155 ^ 2 + t105 ^ 2 + t106 ^ 2) + t75 * (Ifges(4,1) * t75 + Ifges(4,5) * t103) + Ifges(2,3) + 0.2e1 * t11 * t10 + 0.2e1 * t2 * t17 + 0.2e1 * t1 * t18 + t28 * t8 + t29 * t9 + 0.2e1 * t14 * t30 + 0.2e1 * t6 * t31 + 0.2e1 * t5 * t32 + 0.2e1 * t39 * t41 + t45 * t20 + t46 * t21 + 0.2e1 * t16 * t47 + 0.2e1 * t15 * t48 + 0.2e1 * t54 * t51 + t59 * t34 + 0.2e1 * t43 * t60 + 0.2e1 * t42 * t61; t109 * t47 + t158 * t51 + t53 * t17 + t52 * t18 + t82 * t31 + t81 * t32 + t134 + (-m(3) * pkin(1) - mrSges(3,1) * t157) * t155 + (t162 * t60 + (-t41 + t61) * t165) * t154 + (t10 + t188) * t107 + m(7) * (t1 * t52 + t107 * t11 + t2 * t53) + m(6) * (t107 * t14 + t5 * t81 + t6 * t82) + m(5) * (-t107 * t15 + t109 * t16 - t179 * t39) + m(4) * (t158 * t54 + (t162 * t43 + t165 * t42) * t154); m(3) + m(6) * (t81 ^ 2 + t82 ^ 2 + t104) + m(7) * (t52 ^ 2 + t53 ^ 2 + t104) + m(5) * (t109 ^ 2 + t104 + t140) + m(4) * (t148 * t162 ^ 2 + t158 ^ 2 + t140); (t16 * mrSges(5,3) + pkin(10) * t47 - t7 / 0.2e1 - t19 / 0.2e1 + t33 / 0.2e1) * t164 + m(7) * (t1 * t49 + t11 * t121 + t2 * t50) + (t62 / 0.2e1 + t97 / 0.2e1 - t130 / 0.2e1) * t58 + t172 + (-t15 * mrSges(5,3) - t152 * t20 / 0.2e1 + t156 * t202 + t34 / 0.2e1 + t188 * pkin(10)) * t161 + m(6) * (t14 * t191 + t5 * t91 + t6 * t92) + t74 * t175 / 0.2e1 + m(5) * (-pkin(3) * t39 + (-t15 * t161 + t16 * t164) * pkin(10)) + t9 * t196 + t8 * t197 + t46 * t198 + t45 * t199 + t64 * t200 + t63 * t201 - pkin(3) * t41 + t42 * mrSges(4,1) - t43 * mrSges(4,2) + t49 * t18 + t50 * t17 + t11 * t65 + t2 * t88 + t1 * t89 + t91 * t32 + t92 * t31 + t14 * t110 + t6 * t118 + t5 * t119 + t121 * t10 + t39 * t129 + t59 * t131 / 0.2e1; mrSges(5,3) * t183 + t82 * t118 + t81 * t119 + t52 * t89 + t53 * t88 + (-t162 * mrSges(4,2) + (mrSges(4,1) - t129) * t165) * t154 + (mrSges(5,3) * t161 + t205) * t107 + m(6) * (pkin(10) * t184 + t81 * t91 + t82 * t92) + m(7) * (t107 * t121 + t49 * t52 + t50 * t53) + m(5) * (pkin(3) * t179 + (t183 + t184) * pkin(10)); -0.2e1 * pkin(3) * t129 - t101 * t63 + t102 * t64 + 0.2e1 * t92 * t118 + 0.2e1 * t91 * t119 + 0.2e1 * t121 * t65 + 0.2e1 * t49 * t89 + 0.2e1 * t50 * t88 + Ifges(4,3) + (t150 + t151) * mrSges(5,3) * t206 + (-t62 - t97 + t130) * t164 + m(7) * (t121 ^ 2 + t49 ^ 2 + t50 ^ 2) + m(6) * (t91 ^ 2 + t92 ^ 2 + t146) + m(5) * (pkin(3) ^ 2 + t151 * t167 + t146) + (t110 * t206 - t152 * t98 + t156 * t99 + t131) * t161; (-t1 * t117 + t116 * t2) * mrSges(7,3) + t173 + (t6 * mrSges(6,3) + qJ(5) * t31 + t20 / 0.2e1) * t156 + (-t5 * mrSges(6,3) - qJ(5) * t32 + t202) * t152 + m(7) * (t1 * t85 + t11 * t142 + t2 * t86) + t170 * t58 + m(6) * (-pkin(4) * t14 + (-t152 * t5 + t156 * t6) * qJ(5)) + t15 * mrSges(5,1) - t16 * mrSges(5,2) - pkin(4) * t30 + t11 * t77 + t79 * t201 + t80 * t200 + t85 * t18 + t86 * t17 + t8 * t195 + t9 * t194 + t14 * t124 + t45 * t127 / 0.2e1 + t46 * t193 + t142 * t10; -t109 * mrSges(5,2) + (t116 * t53 - t117 * t52) * mrSges(7,3) + t169 * mrSges(6,3) + (t77 + t185) * t107 + m(6) * (-pkin(4) * t107 + qJ(5) * t169) + m(7) * (t107 * t142 + t52 * t85 + t53 * t86); t86 * t88 + t85 * t89 + t79 * t197 + t80 * t196 - pkin(4) * t110 + t63 * t195 + t64 * t194 + t121 * t77 + t142 * t65 + t185 * t191 + (t116 * t50 - t117 * t49) * mrSges(7,3) + (t92 * mrSges(6,3) + qJ(5) * t118 + t161 * t193 + t199) * t156 + (-t91 * mrSges(6,3) - qJ(5) * t119 - t161 * t127 / 0.2e1 + t198) * t152 + m(7) * (t121 * t142 + t49 * t85 + t50 * t86) + m(6) * (-pkin(4) * t191 + (-t152 * t91 + t156 * t92) * qJ(5)) + (-pkin(10) * mrSges(5,2) - t170) * t164 + t175; -0.2e1 * pkin(4) * t124 + t116 * t79 + t117 * t80 + t156 * t127 + t152 * t128 + 0.2e1 * t142 * t77 + Ifges(5,3) + m(7) * (t142 ^ 2 + t85 ^ 2 + t86 ^ 2) + m(6) * (qJ(5) ^ 2 * t174 + pkin(4) ^ 2) + 0.2e1 * (t116 * t86 - t117 * t85) * mrSges(7,3) + 0.2e1 * t174 * qJ(5) * mrSges(6,3); m(6) * t14 + m(7) * t11 + t10 + t30; 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * t107; m(6) * t191 + m(7) * t121 + t205; -m(6) * pkin(4) + m(7) * t142 + t124 + t77; m(6) + m(7); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t52 - mrSges(7,2) * t53; mrSges(7,1) * t49 - mrSges(7,2) * t50 + t62; mrSges(7,1) * t85 - mrSges(7,2) * t86 + t78; 0; Ifges(7,3);];
