...
t2 = t157 * t3 + t160 * t4;
t1 = -t157 * t4 + t160 * t3;
t9 = [t97 * t48 - 0.2e1 * t201 * pkin(1) * (-mrSges(3,1) * t162 + mrSges(3,2) * t159) + 0.2e1 * t87 * t51 + 0.2e1 * t43 * t70 + 0.2e1 * t42 * t71 + 0.2e1 * t37 * t31 + 0.2e1 * t11 * t38 + 0.2e1 * t14 * t39 + 0.2e1 * t13 * t40 + 0.2e1 * t12 * t41 + t28 * t6 + t29 * t7 + 0.2e1 * t15 * t30 + 0.2e1 * t2 * t16 + 0.2e1 * t1 * t17 - 0.2e1 * t8 * t10 + (t19 + t20 - t47 - t5) * t96 + (t22 + t23) * t63 + (t18 - t21) * t62 + Ifges(2,3) - t166 * t182 + (Ifges(3,6) * t185 + (Ifges(3,4) * t159 + Ifges(3,2) * t162) * t155) * t182 + (Ifges(3,5) * t185 + (Ifges(3,1) * t159 + Ifges(3,4) * t162) * t155) * t183 + t185 * t174 + 0.2e1 * t102 * (-t185 * mrSges(3,2) + mrSges(3,3) * t182) + 0.2e1 * t101 * (t185 * mrSges(3,1) - mrSges(3,3) * t183) + m(3) * (pkin(1) ^ 2 * t201 + t101 ^ 2 + t102 ^ 2) + m(4) * (t42 ^ 2 + t43 ^ 2 + t87 ^ 2) + m(5) * (t13 ^ 2 + t14 ^ 2 + t37 ^ 2) + m(6) * (t11 ^ 2 + t12 ^ 2 + t15 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t8 ^ 2); t87 * t124 + t97 * t126 / 0.2e1 + t15 * t99 + t37 * t100 + t101 * mrSges(3,1) - t102 * mrSges(3,2) + t14 * t108 + t13 * t109 + t12 * t110 + t11 * t111 + t174 + t89 * t30 - t66 * t10 + t68 * t38 + t69 * t41 + t2 * t72 + t1 * t73 + t77 * t40 + t78 * t39 - t8 * t49 - pkin(2) * t51 + t24 * t17 + t25 * t16 + (t47 / 0.2e1 - t19 / 0.2e1 - t20 / 0.2e1 + t5 / 0.2e1 + pkin(9) * t70 + t43 * mrSges(4,3)) * t161 + m(6) * (t11 * t68 + t12 * t69 + t15 * t89) + m(7) * (t1 * t24 + t2 * t25 + t66 * t8) + (-t125 / 0.2e1 + t82 / 0.2e1 + t83 / 0.2e1 - t44 / 0.2e1) * t96 + t7 * t197 + t6 * t198 + t46 * t199 + t45 * t200 + t175 * t63 + t176 * t62 + (t48 / 0.2e1 - t42 * mrSges(4,3) + t177 * t156 + t178 * t154 + (t31 - t71) * pkin(9)) * t158 + m(4) * (-pkin(2) * t87 + (-t158 * t42 + t161 * t43) * pkin(9)) - t179 * t182 / 0.2e1 + m(5) * (t13 * t77 + t14 * t78 + t37 * t193); -0.2e1 * pkin(2) * t124 + 0.2e1 * t78 * t108 + 0.2e1 * t77 * t109 + 0.2e1 * t69 * t110 + 0.2e1 * t68 * t111 + 0.2e1 * t24 * t73 + 0.2e1 * t25 * t72 + t90 * t45 + t91 * t46 - 0.2e1 * t66 * t49 + 0.2e1 * t89 * t99 + Ifges(3,3) + (t152 + t153) * mrSges(4,3) * t203 + (t125 - t82 - t83 + t44) * t161 + m(4) * (pkin(2) ^ 2 + t153 * t164 + t148) + m(5) * (t77 ^ 2 + t78 ^ 2 + t148) + m(6) * (t68 ^ 2 + t69 ^ 2 + t89 ^ 2) + m(7) * (t24 ^ 2 + t25 ^ 2 + t66 ^ 2) + (t100 * t203 + t126 + (t85 + t86) * t156 + (t81 - t84) * t154) * t158; (-t1 * t107 - t167 * t2) * mrSges(7,3) + t112 * t30 + t15 * t115 + t37 * t116 + t6 * t195 + t7 * t194 + t98 * t10 + t65 * t16 + t61 * t199 + t64 * t17 - t8 * t58 + t60 * t200 + t42 * mrSges(4,1) - t43 * mrSges(4,2) - pkin(3) * t31 + (t12 * mrSges(6,2) - t13 * mrSges(5,3) + (-t40 + t41) * qJ(4) + t177) * t154 + (t14 * mrSges(5,3) + t11 * mrSges(6,2) + (t38 + t39) * qJ(4) - t178) * t156 + m(7) * (t1 * t64 + t2 * t65 - t8 * t98) + t168 * t96 + t171 * t63 + t172 * t62 + t166 + m(5) * (-pkin(3) * t37 + (-t13 * t154 + t14 * t156) * qJ(4)) + m(6) * (t112 * t15 + (t11 * t156 + t12 * t154) * qJ(4)); t112 * t99 + t89 * t115 - pkin(3) * t100 + t45 * t195 + t46 * t194 + t98 * t49 + t60 * t198 + t61 * t197 - t66 * t58 + t65 * t72 + t64 * t73 + (-mrSges(4,1) + t116) * t193 + (-t107 * t24 - t167 * t25) * mrSges(7,3) + (t78 * mrSges(5,3) + t68 * mrSges(6,2) + t171 * t158 + (t108 + t111) * qJ(4) - t176) * t156 + (-t77 * mrSges(5,3) + t69 * mrSges(6,2) + t172 * t158 + (-t109 + t110) * qJ(4) + t175) * t154 + m(5) * (-pkin(3) * t193 + (-t154 * t77 + t156 * t78) * qJ(4)) + m(6) * (t112 * t89 + (t154 * t69 + t156 * t68) * qJ(4)) + m(7) * (t24 * t64 + t25 * t65 - t66 * t98) + (-pkin(9) * mrSges(4,2) - t168) * t161 + t179; -0.2e1 * pkin(3) * t116 - t167 * t60 + t107 * t61 + 0.2e1 * t112 * t115 + 0.2e1 * t98 * t58 + Ifges(4,3) + (-t118 + t121) * t156 + (t122 + t123) * t154 + 0.2e1 * (-t107 * t64 - t167 * t65) * mrSges(7,3) + m(7) * (t64 ^ 2 + t65 ^ 2 + t98 ^ 2) + m(5) * (pkin(3) ^ 2 + t180) + m(6) * (t112 ^ 2 + t180) + 0.2e1 * (mrSges(6,2) + mrSges(5,3)) * qJ(4) * t204; m(5) * t37 + m(6) * t15 + m(7) * t8 - t10 + t30 + t31; t128 + (m(5) * pkin(9) - mrSges(6,3) * t156) * t158 + m(6) * t89 + m(7) * t66 - t49 + t100; -m(5) * pkin(3) - t186 + t142 + (-mrSges(6,1) - mrSges(5,1)) * t156 + m(6) * t112 - m(7) * t98 - t58; m(5) + m(6) + m(7); t157 * t16 + t160 * t17 + m(7) * (t1 * t160 + t157 * t2) + m(6) * t12 + t41; t157 * t72 + t160 * t73 + m(7) * (t157 * t25 + t160 * t24) + m(6) * t69 + t110; m(7) * (t157 * t65 + t160 * t64) + (m(6) * qJ(4) + mrSges(6,2)) * t154 + (-t107 * t160 - t157 * t167) * mrSges(7,3); 0; m(6) + m(7) * (t157 ^ 2 + t160 ^ 2); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t5; mrSges(7,1) * t24 - mrSges(7,2) * t25 + t44; mrSges(7,1) * t64 - mrSges(7,2) * t65 + t59; 0; mrSges(7,1) * t160 - t157 * mrSges(7,2); Ifges(7,3);];
