...
t1 = [m(2) + m(7) * (t7 ^ 2 + t8 ^ 2 + t38) + m(6) * (t28 ^ 2 + t29 ^ 2 + t38) + m(5) * (t43 ^ 2 + t100 + t38) + m(4) * (t74 ^ 2 + t75 ^ 2 + t100) + m(3) * (t109 * t120 ^ 2 + t115 ^ 2 + t100); -t43 * t87 * mrSges(5,3) + t8 * t24 + t7 * t25 + t28 * t55 + t29 * t54 + t138 * mrSges(4,3) + (t89 * mrSges(5,3) + t15 + t52) * t41 + (-t120 * mrSges(3,2) + (mrSges(3,1) - t57 - t93) * t125) * t114 + m(7) * (t3 * t7 + t36 * t41 + t4 * t8) + m(6) * (t21 * t28 + t22 * t29 + t166) + m(5) * (-t105 * t153 + t43 * t69 + t166) + m(4) * (pkin(2) * t153 + pkin(8) * t138); Ifges(4,2) * t113 - 0.2e1 * pkin(2) * t93 + 0.2e1 * t105 * t57 - t44 * t12 + t45 * t13 + 0.2e1 * t36 * t15 + 0.2e1 * t21 * t55 + 0.2e1 * t22 * t54 + 0.2e1 * t4 * t24 + 0.2e1 * t3 * t25 + t52 * t170 + Ifges(3,3) + (Ifges(4,1) * t119 + 0.2e1 * Ifges(4,4) * t124) * t119 + 0.2e1 * t150 * pkin(8) * mrSges(4,3) + (mrSges(5,3) * t170 + Ifges(5,1) * t89 - t117 * t31 + t122 * t32) * t89 + (-0.2e1 * t69 * mrSges(5,3) + Ifges(5,2) * t87 + (-Ifges(6,6) * t117 - (2 * Ifges(5,4))) * t89 + t148 + t174) * t87 + m(4) * (pkin(8) ^ 2 * t150 + pkin(2) ^ 2) + m(5) * (t105 ^ 2 + t69 ^ 2 + t172) + m(6) * (t21 ^ 2 + t22 ^ 2 + t172) + m(7) * (t3 ^ 2 + t36 ^ 2 + t4 ^ 2); t74 * mrSges(4,1) - t75 * mrSges(4,2) + m(7) * (t41 * t91 + t50 * t7 + t51 * t8) + m(6) * (t102 * t140 + t103 * t41) + m(5) * (t118 * t43 - t123 * t41) * pkin(3) + t131; (m(5) * (t118 * t69 - t123 * t66) + (-t118 * t87 - t123 * t89) * mrSges(5,3)) * pkin(3) + m(6) * (t102 * t141 + t103 * t66) + t139 * t102 + m(7) * (t3 * t50 + t36 * t91 + t4 * t51) + (-t119 * mrSges(4,1) - t124 * mrSges(4,2)) * pkin(8) + Ifges(4,6) * t124 + Ifges(4,5) * t119 + t103 * t52 + t91 * t15 + t51 * t24 + t50 * t25 + t130; 0.2e1 * t103 * t92 + t91 * t171 + Ifges(4,3) + 0.2e1 * t133 + (-t50 * t88 + t51 * t86) * t149 + t102 * t135 + m(7) * (t50 ^ 2 + t51 ^ 2 + t91 ^ 2) + m(6) * (t102 ^ 2 * t151 + t103 ^ 2) + m(5) * (t118 ^ 2 + t123 ^ 2) * pkin(3) ^ 2 + t143; m(7) * (t104 * t41 + t65 * t7 + t68 * t8) + m(6) * (-pkin(4) * t41 + pkin(10) * t140) + t131; m(6) * (-pkin(4) * t66 + pkin(10) * t141) + t139 * pkin(10) + m(7) * (t104 * t36 + t3 * t65 + t4 * t68) + t104 * t15 + t68 * t24 - pkin(4) * t52 + t65 * t25 + t130; (t103 - pkin(4)) * t92 + (t91 + t104) * t56 + t133 + m(7) * (t104 * t91 + t50 * t65 + t51 * t68) + m(6) * (-pkin(4) * t103 + pkin(10) * t144) + ((-t50 - t65) * t88 + (t51 + t68) * t86) * mrSges(7,3) + (pkin(10) * t151 + t144) * mrSges(6,3) + t143; -0.2e1 * pkin(4) * t92 + t104 * t171 + (-t65 * t88 + t68 * t86) * t149 + pkin(10) * t135 + m(7) * (t104 ^ 2 + t65 ^ 2 + t68 ^ 2) + m(6) * (pkin(10) ^ 2 * t151 + pkin(4) ^ 2) + t143; t28 * mrSges(6,1) - t29 * mrSges(6,2) + m(7) * (t116 * t8 + t121 * t7) * pkin(5) + t146; -Ifges(6,6) * t158 + t21 * mrSges(6,1) - t22 * mrSges(6,2) + (t121 * t25 + m(7) * (t116 * t4 + t121 * t3) + t116 * t24) * pkin(5) + t134 + t174; -t142 * t102 + (m(7) * (t116 * t51 + t121 * t50) - t147) * pkin(5) + t137 + t173; -t142 * pkin(10) + (m(7) * (t116 * t68 + t121 * t65) - t147) * pkin(5) + t136 + t173; Ifges(6,3) + Ifges(7,3) + m(7) * (t116 ^ 2 + t121 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t132; t146; t134; t137; t136; Ifges(7,3) + t132; Ifges(7,3);];
