...
t91 = mrSges(5,1) * t151;
t58 = t64 * mrSges(5,1);
t1 = [-0.2e1 * pkin(1) * (-t107 * mrSges(3,1) + t102 * mrSges(3,2)) + t102 * (Ifges(3,1) * t102 + Ifges(3,4) * t107) + t107 * (Ifges(3,4) * t102 + Ifges(3,2) * t107) + 0.2e1 * t87 * (-t72 * mrSges(4,1) + t73 * mrSges(4,2)) + t72 * (Ifges(4,4) * t73 + Ifges(4,2) * t72) + t73 * (Ifges(4,1) * t73 + Ifges(4,4) * t72) + t46 * (Ifges(5,4) * t47 + Ifges(5,2) * t46) + t47 * (Ifges(5,1) * t47 + Ifges(5,4) * t46) + 0.2e1 * t55 * (-t46 * mrSges(5,1) + t47 * mrSges(5,2)) + t14 * t159 + 0.2e1 * t3 * t15 + 0.2e1 * t2 * t16 + Ifges(2,3) + (mrSges(6,1) * t158 - 0.2e1 * mrSges(6,3) * t8 + Ifges(6,2) * t29 + t141) * t29 + (mrSges(6,2) * t158 + mrSges(6,3) * t159 + Ifges(6,1) * t30 + t103 * t12 - t98 * t11 + (-Ifges(7,6) * t98 - (2 * Ifges(6,4))) * t29) * t30 + m(7) * (t2 ^ 2 + t3 ^ 2 + t160) + m(6) * (t31 ^ 2 + t8 ^ 2 + t160) + m(5) * (t20 ^ 2 + t21 ^ 2 + t55 ^ 2) + m(4) * (t50 ^ 2 + t51 ^ 2 + t87 ^ 2) + m(3) * (pkin(7) ^ 2 * t138 + pkin(1) ^ 2) + 0.2e1 * (-t20 * t47 + t21 * t46) * mrSges(5,3) + 0.2e1 * (-t50 * t73 + t51 * t72) * mrSges(4,3) + 0.2e1 * t138 * pkin(7) * mrSges(3,3); m(7) * (t123 * t40 + t39 * t6) + (-mrSges(3,1) * t102 - mrSges(3,2) * t107) * pkin(7) + (-t29 * t42 - t30 * t41) * mrSges(6,3) + (t46 * t66 - t47 * t64) * mrSges(5,3) + Ifges(3,6) * t107 + Ifges(3,5) * t102 + t39 * t14 + t121 * t40 + m(6) * (-t41 * t6 + t42 * t8) + m(5) * (t20 * t64 + t21 * t66) + t114 + (m(4) * (t101 * t51 + t106 * t50) + (t101 * t72 - t106 * t73) * mrSges(4,3)) * pkin(2); -0.2e1 * t145 - 0.2e1 * t147 + Ifges(3,3) + 0.2e1 * t32 + 0.2e1 * t33 + 0.2e1 * t34 + 0.2e1 * t35 + 0.2e1 * t58 + 0.2e1 * t119 + m(7) * (t139 * t40 ^ 2 + t39 ^ 2) + m(6) * (t41 ^ 2 + t42 ^ 2) + m(5) * (t64 ^ 2 + t66 ^ 2) + m(4) * (t101 ^ 2 + t106 ^ 2) * pkin(2) ^ 2 + t124; (m(5) * (t100 * t21 + t105 * t20) + (t100 * t46 - t105 * t47) * mrSges(5,3)) * pkin(3) + m(7) * (t123 * t62 + t60 * t6) + t60 * t14 + t121 * t62 + m(6) * (-t6 * t63 + t65 * t8) + (-t29 * t65 - t30 * t63) * mrSges(6,3) + t114; m(7) * (t127 * t40 + t60 * t39) + t120 + t119 + m(6) * (t41 * t63 + t42 * t65) + (-t42 - t65) * mrSges(6,2) + (-t66 - t152) * mrSges(5,2) + t91 + m(5) * (t100 * t66 + t105 * t64) * pkin(3) + t58 + Ifges(4,3) + Ifges(5,3) + t164; -0.2e1 * t131 - 0.2e1 * t146 + 0.2e1 * t48 + 0.2e1 * t52 + 0.2e1 * t53 + 0.2e1 * t57 + 0.2e1 * t91 + m(7) * (t139 * t62 ^ 2 + t60 ^ 2) + m(6) * (t63 ^ 2 + t65 ^ 2) + m(5) * (t100 ^ 2 + t105 ^ 2) * pkin(3) ^ 2 + t124; (m(6) * (-t104 * t6 + t8 * t99) + (-t104 * t30 - t29 * t99) * mrSges(6,3)) * pkin(4) + t115 + t165 * t84 + t161 * t83; m(7) * (t126 * t40 + t84 * t39) + (m(6) * (t104 * t41 + t42 * t99) - t142) * pkin(4) - t145 + t118 + t58 + t162; m(7) * (t126 * t62 + t84 * t60) + (-t142 + m(6) * (t104 * t63 + t65 * t99)) * pkin(4) + t91 + t117 - t131 + t162; -0.2e1 * t132 + 0.2e1 * t67 + 0.2e1 * t74 + 0.2e1 * t75 + 0.2e1 * t90 + m(7) * (t139 * t83 ^ 2 + t84 ^ 2) + m(6) * (t104 ^ 2 + t99 ^ 2) * pkin(4) ^ 2 + t125; -t165 * pkin(5) + t161 * pkin(11) + t116; m(7) * (pkin(11) * t139 * t40 - pkin(5) * t39) + t118 + t166; m(7) * (-pkin(5) * t60 + pkin(11) * t127) + t117 + t166; m(7) * (-pkin(5) * t84 + pkin(11) * t126) - t132 + t130 + t163 + t166; -0.2e1 * t156 + m(7) * (pkin(11) ^ 2 * t139 + pkin(5) ^ 2) + 0.2e1 * t88 + 0.2e1 * t89 + t130; mrSges(7,1) * t2 - mrSges(7,2) * t3 - Ifges(7,6) * t148 + t141; -t122 * t40 + t140; -t122 * t62 + t140; -t122 * t83 + t140; -pkin(11) * t122 + t140; Ifges(7,3);];
