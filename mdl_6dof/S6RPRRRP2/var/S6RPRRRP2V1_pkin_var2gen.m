% Umwandlung der Kinematikparameter von S6RPRRRP2V1 zu S6RPRRRP2
% Eingabe:
% pkin_var (8x1) double
...
%
% Siehe auch: S6RPRRRP2_structural_kinematic_parameters.m
function pkin_gen = S6RPRRRP2V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
