...
%% Function calls
if link_index == 0
	JaD_rot=S6RPRRRP2_jacobiaD_rot_0_sym_varpar(qJ, qJD, pkin);
elseif link_index == 1
	JaD_rot=S6RPRRRP2_jacobiaD_rot_1_sym_varpar(qJ, qJD, pkin);
elseif link_index == 2
	JaD_rot=S6RPRRRP2_jacobiaD_rot_2_sym_varpar(qJ, qJD, pkin);
elseif link_index == 3
	JaD_rot=S6RPRRRP2_jacobiaD_rot_3_sym_varpar(qJ, qJD, pkin);
elseif link_index == 4
	JaD_rot=S6RPRRRP2_jacobiaD_rot_4_sym_varpar(qJ, qJD, pkin);
elseif link_index == 5
	JaD_rot=S6RPRRRP2_jacobiaD_rot_5_sym_varpar(qJ, qJD, pkin);
elseif link_index == 6
	JaD_rot=S6RPRRRP2_jacobiaD_rot_6_sym_varpar(qJ, qJD, pkin);
else
	JaD_rot=NaN(3,6);
end