...
% OptimizationMode: 2
% StartTime: 2019-03-08 19:07:29
% EndTime: 2019-03-08 19:07:32
...
t2 = t108 * t8 + t112 * t5;
t1 = -t108 * t5 + t112 * t8;
t4 = [m(2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t157) + m(6) * (t5 ^ 2 + t156 + t157) + m(5) * (t10 ^ 2 + t18 ^ 2 + t156) + m(4) * (t33 ^ 2 + t34 ^ 2 + t59 ^ 2) + m(3) * (t107 ^ 2 + (t100 ^ 2 + t104 ^ 2) * t103 ^ 2); m(3) * t107 + m(7) * (t1 * t11 + t12 * t2 + t151) + m(6) * (t21 * t5 + t150 + t151) + m(5) * (t10 * t37 + t18 * t60 + t150) + m(4) * (t106 * t59 + (t111 * t34 + t115 * t33) * t102); m(3) + m(7) * (t11 ^ 2 + t12 ^ 2 + t155) + m(6) * (t21 ^ 2 + t154 + t155) + m(5) * (t37 ^ 2 + t60 ^ 2 + t154) + m(4) * (t106 ^ 2 + (t111 ^ 2 + t115 ^ 2) * t102 ^ 2); t33 * mrSges(4,1) - t34 * mrSges(4,2) + t1 * t26 + t10 * t68 + t18 * t63 + t2 * t25 + t5 * t42 + t141 * t8 + t142 * t3 + m(7) * (t1 * t6 + t2 * t7 + t23 * t3) + m(6) * (-t27 * t3 + t28 * t5 + t50 * t8) + m(5) * (t10 * t65 - t18 * t146 - t64 * t8); t11 * t26 + t12 * t25 + t21 * t42 + t37 * t68 + t60 * t63 + t141 * t35 + t142 * t19 + (mrSges(4,1) * t115 - mrSges(4,2) * t111) * t102 + m(7) * (t11 * t6 + t12 * t7 + t19 * t23) + m(6) * (-t19 * t27 + t21 * t28 + t35 * t50) + m(5) * (-t60 * t146 - t35 * t64 + t37 * t65); Ifges(4,3) + 0.2e1 * t23 * t16 + t40 * t14 + 0.2e1 * t7 * t25 + 0.2e1 * t6 * t26 + t41 * t15 + 0.2e1 * t28 * t42 + 0.2e1 * t27 * t43 + 0.2e1 * t50 * t32 + t62 * t30 + t105 * t125 + 0.2e1 * t64 * t67 + 0.2e1 * t65 * t68 + (t13 - t29) * t61 + (-0.2e1 * pkin(3) * t63 + (Ifges(5,1) * t134 + Ifges(5,5) * t105) * t110 + (Ifges(5,6) * t105 + (0.2e1 * Ifges(5,4) * t110 + (Ifges(6,3) + Ifges(5,2)) * t114) * t101 + t140) * t114) * t101 + m(7) * (t23 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(6) * (t27 ^ 2 + t28 ^ 2 + t50 ^ 2) + m(5) * (pkin(3) ^ 2 * t101 ^ 2 + t64 ^ 2 + t65 ^ 2); -t10 * mrSges(5,2) + t1 * t70 + t2 * t69 + t3 * t66 + t143 * t8 + t122 * mrSges(6,3) + m(7) * (pkin(11) * t144 + t1 * t47 + t2 * t48) + m(6) * (-pkin(4) * t8 + t122 * pkin(11)); -t37 * mrSges(5,2) + t11 * t70 + t12 * t69 + t19 * t66 + t143 * t35 + t118 * mrSges(6,3) + m(7) * (pkin(11) * t135 + t11 * t47 + t12 * t48) + m(6) * (-pkin(4) * t35 + t118 * pkin(11)); m(6) * (-pkin(4) * t50 + (-t27 * t109 + t28 * t113) * pkin(11)) + t50 * t74 + t62 * t79 / 0.2e1 + t64 * mrSges(5,1) - t65 * mrSges(5,2) + t23 * t66 + t7 * t69 + t6 * t70 - t139 * t133 / 0.2e1 + t125 + t47 * t26 + t48 * t25 + t54 * t153 + t55 * t152 + (t30 / 0.2e1 + t15 * t147 - t27 * mrSges(6,3) + t14 * t149 + t142 * pkin(11)) * t109 - pkin(4) * t32 + (t29 / 0.2e1 - t13 / 0.2e1 + pkin(11) * t42 + t28 * mrSges(6,3)) * t113 + (-t77 / 0.2e1 + t53 / 0.2e1) * t61 + m(7) * (pkin(11) * t109 * t23 + t47 * t6 + t48 * t7); -0.2e1 * pkin(4) * t74 + 0.2e1 * t47 * t70 + 0.2e1 * t48 * t69 + Ifges(5,3) + (-t53 + t77) * t113 + (t97 + t99) * mrSges(6,3) * t160 + m(7) * (t47 ^ 2 + t48 ^ 2 + t93) + m(6) * (pkin(4) ^ 2 + t117 * t99 + t93) + (-t108 * t54 + t112 * t55 + t160 * t66 + t79) * t109; -t5 * mrSges(6,2) + t159 * (-t1 * t108 + t112 * t2) + t158 * t3; -t21 * mrSges(6,2) + t159 * (-t108 * t11 + t112 * t12) + t158 * t19; t76 * t153 + t61 * t75 / 0.2e1 + t15 * t148 + t14 * t147 + t23 * t73 - Ifges(6,3) * t133 + t78 * t152 + t27 * mrSges(6,1) - t28 * mrSges(6,2) + t123 * mrSges(7,3) - t140 + (-m(7) * t23 - t16) * pkin(5) + (m(7) * t123 - t108 * t26 + t112 * t25) * pkin(12); t55 * t148 + t54 * t147 - pkin(5) * t66 + (m(7) * t119 - t108 * t70 + t112 * t69) * pkin(12) + (pkin(11) * t158 + t78 * t147 + t76 * t149) * t109 + (-t75 / 0.2e1 - pkin(11) * mrSges(6,2)) * t113 + t119 * mrSges(7,3) + t139; Ifges(6,3) + m(7) * (t138 * pkin(12) ^ 2 + pkin(5) ^ 2) + t112 * t76 + t108 * t78 - 0.2e1 * pkin(5) * t73 + 0.2e1 * t138 * pkin(12) * mrSges(7,3); mrSges(7,1) * t1 - mrSges(7,2) * t2; mrSges(7,1) * t11 - mrSges(7,2) * t12; mrSges(7,1) * t6 - mrSges(7,2) * t7 + t13; mrSges(7,1) * t47 - mrSges(7,2) * t48 + t53; -t121 * pkin(12) + t75; Ifges(7,3);];
