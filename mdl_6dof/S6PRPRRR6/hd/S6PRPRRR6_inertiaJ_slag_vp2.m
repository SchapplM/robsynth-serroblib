...
% EndTime: 2019-03-08 20:45:16
% DurationCPUTime: 0.75s
% Computational Cost: add. (883->243), mult. (1900->350), div. (0->0), fcn. (1836->10), ass. (0->102)
t82 = (-pkin(2) - pkin(8));
t119 = -2 * t82;
t79 = cos(qJ(5));
t80 = cos(qJ(4));
...
t15 = t79 * t110 - t37 * t75;
t16 = t75 * t110 + t37 * t79;
t5 = t78 * t15 - t74 * t16;
t6 = t74 * t15 + t78 * t16;
...
t1 = [m(2) + m(6) * (t15 ^ 2 + t16 ^ 2 + t34) + m(7) * (t5 ^ 2 + t6 ^ 2 + t34) + m(5) * (t37 ^ 2 + t34 + t58) + 0.2e1 * (m(4) / 0.2e1 + m(3) / 0.2e1) * (t66 * t81 ^ 2 + t73 ^ 2 + t58); -mrSges(5,3) * t107 + t15 * t47 + t16 * t46 + t6 * t20 + t5 * t21 + (t80 * mrSges(5,3) - t114) * t35 + ((mrSges(3,1) - mrSges(4,2)) * t81 + (-mrSges(3,2) + t102) * t77) * t72 + m(6) * (-t82 * t104 + t22 * t15 + t23 * t16) + m(7) * (t2 * t5 + t3 * t6 + t43 * t35) + m(5) * (t90 * t82 + t56) + m(4) * (pkin(2) * t109 + t56); -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t2 * t21 + 0.2e1 * t3 * t20 + 0.2e1 * t22 * t47 + 0.2e1 * t23 * t46 - t30 * t7 + t32 * t8 + 0.2e1 * t43 * t9 + Ifges(4,1) + Ifges(3,3) + (Ifges(5,2) * t76 + t118 + t98) * t76 + (Ifges(5,1) * t80 - 0.2e1 * Ifges(5,4) * t76 + t79 * t28 + t38 * t119 + (-t27 - t111) * t75) * t80 + m(5) * (t68 * t71 + t60 + t83) + m(4) * (pkin(2) ^ 2 + t83) + m(6) * (t22 ^ 2 + t23 ^ 2 + t60) + m(7) * (t2 ^ 2 + t3 ^ 2 + t43 ^ 2) + 0.2e1 * t102 * qJ(3) + t95 * t119; -m(4) * t109 + m(6) * (t92 * t76 - t104) + m(7) * (-t29 * t5 + t31 * t6 - t104) + m(5) * t90; -m(4) * pkin(2) + t31 * t20 - t29 * t21 + mrSges(4,2) + t114 * t80 + t89 * t76 - t95 + m(7) * (-t29 * t2 + t31 * t3 - t80 * t43) + m(6) * (t91 * t76 + t61) + m(5) * (t68 * t82 + t61); m(4) + m(5) * t100 + m(6) * (t101 * t68 + t70) + m(7) * (t29 ^ 2 + t31 ^ 2 + t70); -t37 * mrSges(5,2) + (t6 * t44 - t5 * t45) * mrSges(7,3) + t92 * mrSges(6,3) - t99 * t35 + m(6) * (-pkin(4) * t35 + t92 * pkin(9)) + m(7) * (t18 * t5 + t19 * t6 + t59 * t35); m(7) * (t18 * t2 + t19 * t3 + t59 * t43) + t27 * t116 + t75 * t28 / 0.2e1 + t59 * t9 + t43 * t12 + t44 * t7 / 0.2e1 + t45 * t8 / 0.2e1 - t30 * t13 / 0.2e1 + t32 * t14 / 0.2e1 - pkin(4) * t38 + t19 * t20 + t18 * t21 + (-t82 * mrSges(5,2) + t65 / 0.2e1 + t64 / 0.2e1 + t40 / 0.2e1 + t39 / 0.2e1 - Ifges(5,6)) * t76 + (-t2 * t45 + t3 * t44) * mrSges(7,3) + t91 * mrSges(6,3) + (m(6) * t91 + t89) * pkin(9) + (t52 * t116 - t75 * t51 / 0.2e1 + Ifges(5,5) + (m(6) * pkin(4) - t103) * t82) * t80; (t29 * t45 + t31 * t44) * mrSges(7,3) + t99 * t80 + (-mrSges(5,2) + t96) * t76 + m(6) * (t101 * t76 * pkin(9) + pkin(4) * t80) + m(7) * (-t18 * t29 + t19 * t31 - t59 * t80); -0.2e1 * pkin(4) * t49 + 0.2e1 * t59 * t12 + t44 * t13 + t45 * t14 + t79 * t51 + t75 * t52 + Ifges(5,3) + m(7) * (t18 ^ 2 + t19 ^ 2 + t59 ^ 2) + m(6) * (t101 * pkin(9) ^ 2 + pkin(4) ^ 2) + 0.2e1 * (-t18 * t45 + t19 * t44) * mrSges(7,3) + 0.2e1 * pkin(9) * t96; t15 * mrSges(6,1) - t16 * mrSges(6,2) + (t5 * t78 + t6 * t74) * t117 + t97; -Ifges(6,6) * t108 + t22 * mrSges(6,1) - t23 * mrSges(6,2) + (m(7) * (t2 * t78 + t3 * t74) + t74 * t20 + t78 * t21) * pkin(5) + t87 + t118; -t93 * t76 + (-t29 * t78 + t31 * t74) * t117 + t94; t64 + t65 - t93 * pkin(9) + (m(7) * (t18 * t78 + t19 * t74) + (t74 * t44 - t78 * t45) * mrSges(7,3)) * pkin(5) + t88; Ifges(6,3) + Ifges(7,3) + m(7) * (t74 ^ 2 + t78 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t86; t97; t87; t94; t88; Ifges(7,3) + t86; Ifges(7,3);];
