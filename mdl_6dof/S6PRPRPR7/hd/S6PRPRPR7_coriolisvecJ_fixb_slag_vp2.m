...
t160 = qJD(5) * t106;
t154 = t34 - t185;
t153 = -Ifges(5,5) / 0.2e1 + Ifges(6,4) / 0.2e1;
t152 = -Ifges(5,6) / 0.2e1 + Ifges(6,5) / 0.2e1;
t151 = -0.3e1 / 0.2e1 * Ifges(6,6) - 0.3e1 / 0.2e1 * Ifges(5,4);
t150 = t103 * t172;
t149 = -t109 * t18 / 0.2e1;
t143 = t100 * t166;
t141 = qJD(4) * t190;
...
t39 = t102 * t56 + t105 * t173;
t38 = -t102 * t173 + t105 * t56;
t113 = -m(7) * t134 - t123;
...
t55 = pkin(9) * t157 + t73;
t54 = qJD(3) - t160 + t217;
t48 = (-t102 * t171 + t105 * t107) * t170;
t47 = (-t102 * t107 - t105 * t171) * t170;
t46 = t116 + t217;
...
t8 = qJD(6) * t38 + t102 * t36 + t105 * t143;
t7 = -qJD(6) * t39 - t102 * t143 + t105 * t36;
t4 = -qJD(6) * t31 - t102 * t46 - t105 * t67;
t3 = qJD(6) * t30 - t102 * t67 + t105 * t46;
t21 = [t57 * t13 + t38 * t25 + t39 * t26 + t8 * t49 + t7 * t50 - t187 * t36 - t154 * t35 + m(5) * (t17 * t57 - t35 * t41 + t36 * t40 + t194) + m(6) * (-t16 * t57 + t32 * t36 + t33 * t35 + t194) + m(7) * (t1 * t39 + t14 * t57 + t2 * t38 - t24 * t35 + t5 * t7 + t6 * t8) + t218 * t156 * (-t103 * t56 - t106 * t57) + (((-mrSges(3,2) + mrSges(4,3)) * t110 + t188 * qJD(2)) * t107 + (t63 + t64 + (-mrSges(3,1) + mrSges(4,2)) * t110) * t104 + m(5) * t117 + m(6) * (t104 * t27 + t166 * t51) + (-t107 * t139 + t167 * t70 + t117) * m(4)) * t100; qJ(3) * t64 + qJD(3) * t75 - t80 * t13 + t30 * t25 + t31 * t26 - t68 * t34 + t54 * t74 + t79 * t63 + (-t47 + t4) * t50 + (-t48 + t3) * t49 - t188 * t147 + (qJD(2) * t126 + t69) * mrSges(4,3) + m(6) * (t27 * t79 + t51 * t54) - m(7) * (t47 * t5 + t48 * t6) + m(7) * (t1 * t31 - t14 * t80 + t2 * t30 - t24 * t68 + t3 * t6 + t4 * t5) + 0.2e1 * (-t107 * t200 / 0.2e1 - m(5) * t177 / 0.2e1 - (pkin(2) * t167 + t104 * t70 + t177) * m(4) / 0.2e1) * t170 + (-t27 * mrSges(6,3) + t69 * mrSges(5,2) + t218 * t18 - t187 * t148 + 0.2e1 * (t138 * t32 + t149) * m(6) + 0.2e1 * (t138 * t40 + t149) * m(5) + (t151 * t157 + t152 * qJD(4) + (-t185 + t213) * t109 + t223) * qJD(4) + t212) * t106 + (t69 * mrSges(5,1) + t9 * t198 + t102 * t10 / 0.2e1 + t16 * mrSges(6,1) - t17 * mrSges(5,3) - t27 * mrSges(6,2) - t14 * t133 + t130 * t208 + t128 * t207 + (t1 * t105 - t2 * t102) * mrSges(7,3) + (t92 * (-t179 + t180) / 0.2e1 + t71 * t129 / 0.2e1 + t131 * t204 + t24 * t132 + t23 * t198 + t22 * t199 + (-t6 * t102 - t5 * t105) * mrSges(7,3)) * qJD(6) + (t153 * qJD(4) + t112 + ((-t181 / 0.2e1 - t178 / 0.2e1 - t151) * t103 + (0.3e1 / 0.2e1 * Ifges(6,3) + 0.3e1 / 0.2e1 * Ifges(5,2) - 0.3e1 / 0.2e1 * Ifges(6,2) - 0.3e1 / 0.2e1 * Ifges(5,1) - Ifges(7,3)) * t106) * qJD(2)) * qJD(4) + (m(5) * t17 - m(6) * t16 + (m(5) * t40 + m(6) * t32 - t187) * qJD(4)) * t109 + (-m(7) * t24 - t154 - t213) * t148) * t103 + (m(5) + m(4)) * (qJ(3) * t69 + qJD(3) * t76); -t110 * mrSges(4,3) + (t13 + (t102 * t49 + t105 * t50 - t187) * qJD(4) + m(7) * (t162 * t5 + t164 * t6 + t14) + m(6) * (t32 * qJD(4) - t16) + m(5) * (t40 * qJD(4) + t17)) * t103 + (t154 * qJD(4) + m(7) * (-t158 * t6 + t159 * t5 - t214) + m(6) * t216 + m(5) * (-t18 + t174) - t211) * t106 + (-m(5) * t76 - t200 + (-t76 + t148) * m(4) - t113 - t188) * qJD(2); t131 * t208 + t129 * t207 + t14 * t132 + t10 * t198 + t9 * t199 - t73 * t74 - t12 * t49 - t11 * t50 + t114 * t34 - t16 * mrSges(6,3) - t17 * mrSges(5,2) + qJ(5) * t13 + t187 * t41 - t185 * t40 + t224 * t18 + t124 * t108 + t186 * qJD(5) - t135 * mrSges(7,3) + (t108 * t113 - t225) * qJD(6) + ((-t95 / 0.2e1 + (-t180 / 0.2e1 + t179 / 0.2e1 + pkin(4) * mrSges(6,1) + t153) * qJD(4) - Ifges(5,4) * t168 / 0.2e1 - t112) * t103 + ((-qJ(5) * mrSges(6,1) + t152) * qJD(4) + (Ifges(5,4) / 0.2e1 + Ifges(6,6) / 0.2e1) * t157 + (-Ifges(6,3) / 0.2e1 + Ifges(5,1) / 0.2e1 - Ifges(5,2) / 0.2e1 + Ifges(6,2) / 0.2e1) * t168 - t223) * t106) * qJD(2) + (qJ(5) * t14 + t135 * t108 - t11 * t5 - t12 * t6 + t222 * t24) * m(7) + (-pkin(4) * t18 - qJ(5) * t16 + t215 * t33 - t32 * t41 - t51 * t73) * m(6); -t186 * qJD(4) + (-mrSges(6,1) * t163 + (-t123 + t74) * t106) * qJD(2) + (-t134 * t92 + t214) * m(7) + (t157 * t51 - t216) * m(6) + t211; -Ifges(7,3) * t142 - t24 * (mrSges(7,1) * t72 + mrSges(7,2) * t71) + (Ifges(7,1) * t71 - t197) * t205 + t22 * t204 + (Ifges(7,5) * t71 - Ifges(7,6) * t72) * t203 - t5 * t49 + t6 * t50 + (t5 * t71 + t6 * t72) * mrSges(7,3) + (-Ifges(7,2) * t72 + t23 + t66) * t206 + t212;];
tauc  = t21(:);
