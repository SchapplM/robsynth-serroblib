...
t8 = [m(2) + m(7) * (t3 ^ 2 + t4 ^ 2 + t9) + 0.2e1 * (m(4) / 0.2e1 + m(3) / 0.2e1) * (t39 * t53 ^ 2 + t47 ^ 2 + t32) + t98 * (t10 ^ 2 + t32 + t9); t3 * t17 + t4 * t18 - t77 * t79 + (t77 * t49 - t15) * t12 + ((mrSges(3,1) - mrSges(4,2)) * t53 + (-mrSges(3,2) + t23 + t75) * t50) * t46 + m(7) * (t1 * t3 - t20 * t12 + t2 * t4) + m(5) * (t28 + t59) + m(6) * (t19 * t85 + t59) + m(4) * (pkin(2) * t84 + t28); -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t1 * t17 + 0.2e1 * t20 * t15 + 0.2e1 * t2 * t18 + 0.2e1 * t19 * t23 + Ifges(4,1) + Ifges(3,3) + ((Ifges(6,2) + Ifges(5,1)) * t52 + t68) * t52 + m(7) * (t1 ^ 2 + t2 ^ 2 + t20 ^ 2) + m(6) * (t19 ^ 2 - t74) + m(5) * (t57 - t74) + m(4) * (pkin(2) ^ 2 + t57) + 0.2e1 * t75 * qJ(3) - 0.2e1 * t55 * t92 + (t48 * t7 + t51 * t6 + 0.2e1 * (-Ifges(5,4) - Ifges(6,6)) * t52 + (Ifges(6,3) + Ifges(5,2)) * t49) * t49; -m(4) * t84 + m(7) * (-t52 * t63 + t5) + t98 * t61; -m(4) * pkin(2) - t49 * t15 + mrSges(4,2) + t60 * t52 + m(7) * (-t49 * t20 - t52 * t64) + t55 * t58 - t92; m(4) + m(7) * (t43 * t73 + t41) + t58; -t94 * t10 - t63 * mrSges(7,3) + t69 * t12 + m(7) * (t54 * t63 + t71) + m(6) * (-pkin(4) * t10 + t71); t54 * t83 + t17 * t80 + m(7) * (-qJ(5) * t20 + t54 * t64) + t7 * t90 + t6 * t91 - t20 * t22 - qJ(5) * t15 - t64 * mrSges(7,3) + (-pkin(4) * mrSges(6,1) + Ifges(7,6) * t91 + t37 / 0.2e1 + Ifges(5,5) - Ifges(6,4)) * t52 + (t48 * t26 / 0.2e1 + t25 * t90 - qJ(5) * mrSges(6,1) - Ifges(5,6) + Ifges(6,5)) * t49 + (t93 + t94 * t52 + (-mrSges(5,2) + mrSges(6,3)) * t49) * t55; (t94 + t95) * t52 + t93 + m(7) * (-t52 * t66 + t35) + t69 * t49; -0.2e1 * pkin(4) * mrSges(6,2) - t48 * t25 + t51 * t26 + Ifges(6,1) + Ifges(5,3) + m(7) * (t54 ^ 2 * t73 + t56) + m(6) * (pkin(4) ^ 2 + t56) - 0.2e1 * mrSges(7,3) * t66 + 0.2e1 * t76 * qJ(5); m(6) * t10 + m(7) * t63; m(7) * t64 + (-m(6) * t55 + mrSges(6,1)) * t52 - t60; -t97 * t52; -m(6) * pkin(4) + t54 * t67 + mrSges(6,2) - t95; t97; t3 * mrSges(7,1) - t4 * mrSges(7,2); t1 * mrSges(7,1) - t2 * mrSges(7,2) + t68; -t62 * t52; mrSges(7,1) * t80 + t37 + (-mrSges(7,2) * t54 - Ifges(7,6)) * t48; t62; Ifges(7,3);];
