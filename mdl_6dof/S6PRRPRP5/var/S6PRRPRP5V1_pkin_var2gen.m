% Umwandlung der Kinematikparameter von S6PRRPRP5V1 zu S6PRRPRP5
% Eingabe:
% pkin_var (8x1) double
...
%
% Siehe auch: S6PRRPRP5_structural_kinematic_parameters.m
function pkin_gen = S6PRRPRP5V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
