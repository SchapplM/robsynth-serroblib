...
t2 = -pkin(5) * t44 - t3;
t1 = qJ(6) * t44 + t4;
t6 = [m(2) + m(5) * (t19 ^ 2 + t16 + t59) + m(4) * (t38 ^ 2 + t39 ^ 2 + t59) + m(3) * (t67 * t78 ^ 2 + t75 ^ 2 + t59) + t123 * (t11 ^ 2 + t9 ^ 2 + t16); -t19 * t44 * mrSges(5,3) - t100 * t9 + t101 * t11 + t84 * mrSges(4,3) + (t45 * mrSges(5,3) + t21 + t22) * t17 + (-t78 * mrSges(3,2) + (mrSges(3,1) - t28 - t49) * t81) * t73 + m(6) * (t11 * t4 - t3 * t9 + t107) + m(7) * (t1 * t11 + t17 * t5 + t2 * t9) + m(5) * (-t63 * t103 + t19 * t32 + t107) + m(4) * (pkin(2) * t103 + t84 * pkin(8)); Ifges(4,2) * t71 - 0.2e1 * pkin(2) * t49 + 0.2e1 * t1 * t27 + 0.2e1 * t2 * t26 + 0.2e1 * t5 * t21 + t22 * t119 + 0.2e1 * t4 * t24 + 0.2e1 * t3 * t25 + 0.2e1 * t63 * t28 + Ifges(3,3) + (Ifges(4,1) * t77 + 0.2e1 * Ifges(4,4) * t80) * t77 + 0.2e1 * t96 * pkin(8) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t32 + Ifges(5,2) * t44 + t90) * t44 + m(4) * (t96 * pkin(8) ^ 2 + pkin(2) ^ 2) + m(5) * (t32 ^ 2 + t63 ^ 2 + t120) + m(6) * (t3 ^ 2 + t4 ^ 2 + t120) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + (mrSges(5,3) * t119 + Ifges(5,1) * t45 - 0.2e1 * Ifges(5,4) * t44 + (t14 + t15) * t79 + (t12 - t13 - t110) * t76) * t45; t38 * mrSges(4,1) - t39 * mrSges(4,2) - t19 * mrSges(5,2) + (t47 + t99) * t17 + m(6) * (t17 * t62 + t92) + m(7) * (t17 * t43 + t92) + (-t17 * t74 + t19 * t72) * t118 + t122 * t125; -t32 * mrSges(5,2) + Ifges(4,5) * t77 + Ifges(4,6) * t80 + t43 * t21 + t62 * t22 + t5 * t47 + t99 * t30 + (-t77 * mrSges(4,1) - t80 * mrSges(4,2)) * pkin(8) + (t66 / 0.2e1 + t65 / 0.2e1 + t64 / 0.2e1 - Ifges(5,6) - mrSges(5,3) * t117) * t44 + (-t109 / 0.2e1 - t12 / 0.2e1 + t13 / 0.2e1 + t1 * mrSges(7,2) + t4 * mrSges(6,3) + t101 * t61) * t79 + (t14 / 0.2e1 + t15 / 0.2e1 + t2 * mrSges(7,2) - t3 * mrSges(6,3) - t100 * t61) * t76 + m(7) * (t43 * t5 + (t1 * t79 + t2 * t76) * t61) + m(6) * (t30 * t62 + (-t3 * t76 + t4 * t79) * t61) + (-t30 * t74 + t32 * t72) * t118 + (-mrSges(5,3) * t116 + Ifges(5,5) + (t54 / 0.2e1 + t53 / 0.2e1) * t79 + (-t52 / 0.2e1 + t51 / 0.2e1) * t76) * t45; 0.2e1 * t43 * t47 + 0.2e1 * t62 * t48 + Ifges(4,3) + Ifges(5,3) + (t52 - t51) * t79 + (t54 + t53) * t76 + m(7) * (t43 ^ 2 + t98) + m(6) * (t62 ^ 2 + t98) + t122 * t61 * t124 + (0.2e1 * mrSges(5,1) * t74 - 0.2e1 * mrSges(5,2) * t72 + (t72 ^ 2 + t74 ^ 2) * t118) * pkin(3); -m(5) * t103 + t123 * (t76 * t11 - t79 * t9); t100 * t79 + t101 * t76 + m(7) * (t1 * t76 - t2 * t79) + m(6) * (t3 * t79 + t4 * t76) + m(5) * t63 + t28; 0; m(5) + (m(6) / 0.2e1 + m(7) / 0.2e1) * t124; (-mrSges(6,1) + t121) * t9 + (m(7) * qJ(6) - mrSges(6,2) + mrSges(7,3)) * t11; -Ifges(6,6) * t106 + t1 * mrSges(7,3) + qJ(6) * t27 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) - t4 * mrSges(6,2) + t3 * mrSges(6,1) - t2 * mrSges(7,1) - pkin(5) * t26 + t90; -Ifges(7,6) * t79 + t64 + t65 + t66 - t85 * mrSges(7,2) + (-m(7) * t85 - t87 - t88) * t61; m(7) * t86 - t47 - t48; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t127; m(7) * t9; m(7) * t2 + t26; (m(7) * t61 + mrSges(7,2)) * t76; -m(7) * t79; t121; m(7);];
