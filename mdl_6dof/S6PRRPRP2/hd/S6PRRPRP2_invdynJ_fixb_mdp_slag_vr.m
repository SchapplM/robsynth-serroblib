...
assert(isreal(MDP) && all(size(MDP) == [26 1]), ...
  'S6PRRPRP2_invdynJ_fixb_mdp_slag_vr: MDP has to be [26x1] (double)'); 

%% Symbolic Calculation
% From invdyn_joint_fixb_mdp_mult_matlab.m
% OptimizationMode: 2
% StartTime: 2021-01-16 02:55:28
% EndTime: 2021-01-16 02:55:28
% DurationCPUTime: 0.04s
% Computational Cost: add. (80->80), mult. (86->86), div. (0->0), fcn. (86->86), ass. (0->1)
