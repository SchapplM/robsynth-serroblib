% Umwandlung der Kinematikparameter von S6PRRPRP2V1 zu S6PRRPRP2
% Eingabe:
% pkin_var (9x1) double
...
%
% Siehe auch: S6PRRPRP2_structural_kinematic_parameters.m
function pkin_gen = S6PRRPRP2V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(11,1);
