...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:17:52
% EndTime: 2018-11-23 15:17:53
...
t14 = [m(2) + m(7) * (t3 ^ 2 + t4 ^ 2 + t168) + m(6) * (t15 ^ 2 + t168 + t56) + m(5) * (t29 ^ 2 + t30 ^ 2 + t56) + m(4) * (t59 ^ 2 + t78 ^ 2 + t56) + m(3) * (t123 ^ 2 + (t127 ^ 2 + t130 ^ 2) * t120 ^ 2); t15 * t38 + t4 * t17 + t3 * t18 + t29 * t67 + t30 * t66 + t59 * t91 + t78 * t80 + t152 * t13 + (mrSges(3,1) * t130 - mrSges(3,2) * t127) * t120 + (-t90 + t172) * t57 + m(7) * (t1 * t3 + t13 * t5 + t2 * t4) + m(6) * (-t10 * t13 + t11 * t15 + t50 * t57) + m(5) * (t29 * t40 + t30 * t41 + t57 * t74) + m(4) * (-pkin(2) * t119 * t78 - t57 * t81 + t59 * t82); t122 * t140 + 0.2e1 * t81 * t90 + 0.2e1 * t82 * t91 + 0.2e1 * t74 * t51 + t77 * t42 + t79 * t43 + 0.2e1 * t41 * t66 + 0.2e1 * t40 * t67 + t49 * t20 + 0.2e1 * t50 * t21 + t33 * t8 + t34 * t9 + 0.2e1 * t11 * t38 + 0.2e1 * t10 * t39 + 0.2e1 * t5 * t16 + 0.2e1 * t2 * t17 + 0.2e1 * t1 * t18 + Ifges(3,3) + (t7 - t19) * t48 + (-0.2e1 * pkin(2) * t80 + (Ifges(4,1) * t145 + Ifges(4,5) * t122) * t126 + (-Ifges(5,5) * t79 + Ifges(4,6) * t122 - Ifges(5,6) * t77 + (0.2e1 * Ifges(4,4) * t126 + (Ifges(4,2) + Ifges(5,3) + Ifges(6,3)) * t129) * t119 + t151) * t129) * t119 + m(4) * (pkin(2) ^ 2 * t119 ^ 2 + t81 ^ 2 + t82 ^ 2) + m(5) * (t40 ^ 2 + t41 ^ 2 + t74 ^ 2) + m(6) * (t10 ^ 2 + t11 ^ 2 + t50 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2); -t59 * mrSges(4,2) + t13 * t52 + t3 * t55 + t4 * t54 + (t13 * t89 - t15 * t88) * mrSges(6,3) + t135 * mrSges(5,3) + (-mrSges(4,1) + t171) * t57 + m(7) * (t24 * t3 + t25 * t4 + t154) + m(6) * (t108 * t57 + t15 * t65 + t154) + m(5) * (-pkin(3) * t57 + t135 * qJ(4)); -(Ifges(5,5) * t118 + Ifges(5,6) * t121 + t150) * t144 / 0.2e1 + (t9 * t160 + t8 * t162 - t10 * mrSges(6,3) + t20 / 0.2e1) * t89 + t152 * t63 + t118 * t43 / 0.2e1 + t134 * mrSges(5,3) + t121 * t42 / 0.2e1 + m(5) * (-pkin(3) * t74 + t134 * qJ(4)) + t79 * t96 / 0.2e1 + t108 * t21 + t74 * t93 + t77 * t95 / 0.2e1 + t81 * mrSges(4,1) - t82 * mrSges(4,2) + t50 * t60 + t49 * t62 / 0.2e1 + t65 * t38 - pkin(3) * t51 + t5 * t52 + t2 * t54 + t1 * t55 + t24 * t18 + t25 * t17 + t140 + (-t118 * t67 + t121 * t66) * qJ(4) + m(6) * (-t10 * t63 + t108 * t50 + t11 * t65) + m(7) * (t1 * t24 + t2 * t25 + t5 * t63) + (-t11 * mrSges(6,3) + t7 / 0.2e1 - t19 / 0.2e1) * t88 + (-t61 / 0.2e1 + t35 / 0.2e1) * t48 + t37 * t164 + t36 * t165; -0.2e1 * pkin(3) * t93 + 0.2e1 * t108 * t60 + t118 * t96 + t121 * t95 + 0.2e1 * t24 * t55 + 0.2e1 * t25 * t54 + t52 * t166 + Ifges(4,3) + 0.2e1 * t142 * qJ(4) * mrSges(5,3) + (-0.2e1 * t65 * mrSges(6,3) + t35 - t61) * t88 + m(7) * (t24 ^ 2 + t25 ^ 2 + t167) + m(6) * (t108 ^ 2 + t65 ^ 2 + t167) + m(5) * (t142 * qJ(4) ^ 2 + pkin(3) ^ 2) + (mrSges(6,3) * t166 - t124 * t36 + t128 * t37 + t62) * t89; m(7) * (t124 * t4 + t128 * t3) + 0.2e1 * (m(6) / 0.2e1 + m(5) / 0.2e1) * t57; t124 * t17 + t128 * t18 + m(7) * (t1 * t128 + t124 * t2) + m(6) * t50 + m(5) * t74 + t172; -m(5) * pkin(3) + t124 * t54 + t128 * t55 + m(7) * (t124 * t25 + t128 * t24) + m(6) * t108 + t171; m(7) * t141 + m(5) + m(6); -t15 * mrSges(6,2) + t170 * (-t124 * t3 + t128 * t4) + t169 * t13; -Ifges(6,3) * t144 + t5 * t97 + m(7) * (-pkin(5) * t5 + t138 * pkin(11)) + t17 * t155 - t18 * t156 + t9 * t161 + t8 * t160 - pkin(5) * t16 + t48 * t163 + t100 * t164 + t99 * t165 + t10 * mrSges(6,1) - t11 * mrSges(6,2) + t138 * mrSges(7,3) - t151; -pkin(5) * t52 + t54 * t155 - t55 * t156 + t88 * t163 + t37 * t161 + t36 * t160 - t65 * mrSges(6,2) + (t100 * t160 + t99 * t162) * t89 + t150 + t170 * (-t124 * t24 + t128 * t25) + t169 * t63; 0; Ifges(6,3) + t128 * t99 - 0.2e1 * pkin(5) * t97 + m(7) * (t141 * pkin(11) ^ 2 + pkin(5) ^ 2) + t124 * t100 + 0.2e1 * t141 * pkin(11) * mrSges(7,3); mrSges(7,1) * t3 - mrSges(7,2) * t4; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t24 - mrSges(7,2) * t25 + t35; -t97; -t136 * pkin(11) + t98; Ifges(7,3);];
