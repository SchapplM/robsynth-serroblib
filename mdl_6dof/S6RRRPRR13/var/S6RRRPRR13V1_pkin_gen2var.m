% Umwandlung der Kinematikparameter von S6RRRPRR13 zu S6RRRPRR13V1
% Eingabe:
...
%   Kinematikparameter (pkin) von S6RRRPRR13V1
%   pkin_var=[a2 a3 a4 a5 a6 alpha2 alpha3 d1 d2 d3 d5 theta4]
% I_gv (12x1)
%   Vektor mit Indizes zur Selektion von Kinematikparametern
function [pkin_var, I_gv] = S6RRRPRR13V1_pkin_gen2var(pkin_gen)
