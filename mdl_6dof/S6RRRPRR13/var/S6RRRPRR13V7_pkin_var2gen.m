% Umwandlung der Kinematikparameter von S6RRRPRR13V7 zu S6RRRPRR13
% Eingabe:
% pkin_var (5x1) double
%   Kinematikparameter (pkin) von S6RRRPRR13V7
...
function pkin_gen = S6RRRPRR13V7_pkin_var2gen(pkin_var)
pkin_gen = zeros(13,1);
pkin_gen([1, 6, 8, 9, 13]) = pkin_var;
