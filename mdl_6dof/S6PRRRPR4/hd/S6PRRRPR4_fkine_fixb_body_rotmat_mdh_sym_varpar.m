...
function Tc_mdh = S6PRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6PRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6PRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [12x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 21:15:48
	% EndTime: 2020-11-04 21:15:48
...
elseif link_index == 5
	...
	t166 = t174 * t177 + t178 * t185;
	t165 = -t174 * t179 + t178 * t186;
	t164 = -t171 * t182 + t173 * t180;
	t163 = t171 * t181 + t173 * t178;
	t162 = t171 * t180 + t173 * t182;
	t161 = t171 * t178 - t173 * t181;
	t160 = -t164 * t177 + t171 * t185;
	t159 = t164 * t179 + t171 * t186;
	t158 = t162 * t179 - t173 * t186;
	t157 = t162 * t177 + t173 * t185;
	t1 = [t159 * t169 + t163 * t168, -t159 * t168 + t163 * t169, -t160, t159 * t167 + t160 * t175 + t163 * t189 + (t173 * pkin(2) + pkin(8) * t187) * t180 + (-pkin(2) * t187 + t173 * pkin(8)) * t178 + t171 * t188 + t173 * pkin(1) + 0; t158 * t169 + t161 * t168, -t158 * t168 + t161 * t169, t157, t158 * t167 - t157 * t175 + t161 * t189 + (t171 * pkin(2) - pkin(8) * t183) * t180 + (pkin(2) * t183 + t171 * pkin(8)) * t178 - t173 * t188 + t171 * pkin(1) + 0; t166 * t169 - t168 * t184, -t166 * t168 - t169 * t184, t165, t174 * pkin(7) - t165 * t175 + t166 * t167 + qJ(1) + 0 + (pkin(2) * t178 + (-pkin(8) - t189) * t180) * t172; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 6
