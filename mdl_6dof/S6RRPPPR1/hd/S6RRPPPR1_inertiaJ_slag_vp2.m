...
t2 = t3 * t87 + t4 * t89;
t1 = t3 * t89 - t4 * t87;
t11 = [-0.2e1 * pkin(1) * (-t90 * mrSges(3,1) + t88 * mrSges(3,2)) + t88 * (Ifges(3,1) * t88 + Ifges(3,4) * t90) + t90 * (Ifges(3,4) * t88 + Ifges(3,2) * t90) + t54 * t118 + t29 * t119 + t23 * t5 + t24 * t6 + 0.2e1 * t14 * t28 + 0.2e1 * t13 * t31 + 0.2e1 * t12 * t32 + 0.2e1 * t8 * t33 + 0.2e1 * t7 * t34 + 0.2e1 * t2 * t15 + 0.2e1 * t1 * t16 - 0.2e1 * t10 * t9 + Ifges(2,3) + 0.2e1 * t101 * pkin(7) * mrSges(3,3) + (mrSges(4,1) * t118 - 0.2e1 * t42 * mrSges(4,3) + (Ifges(6,2) + Ifges(5,3) + Ifges(4,2)) * t58 + t100) * t58 + m(3) * (pkin(7) ^ 2 * t101 + pkin(1) ^ 2) + m(4) * (t42 ^ 2 + t77 ^ 2 + t120) + m(5) * (t12 ^ 2 + t13 ^ 2 + t120) + m(6) * (t14 ^ 2 + t7 ^ 2 + t8 ^ 2) + m(7) * (t1 ^ 2 + t10 ^ 2 + t2 ^ 2) + (mrSges(4,3) * t119 + Ifges(4,1) * t60 + (t19 + t20) * t85 + (t17 - t18) * t83 + (-(2 * Ifges(4,4)) + (Ifges(6,4) + Ifges(5,5)) * t85 + (-Ifges(5,6) + Ifges(6,6)) * t83) * t58) * t60; (-t17 / 0.2e1 + t18 / 0.2e1) * t85 + (t19 / 0.2e1 + t20 / 0.2e1) * t83 + (-t88 * mrSges(3,1) - t90 * mrSges(3,2)) * pkin(7) + (-mrSges(4,3) * t115 + Ifges(4,5) + (t67 / 0.2e1 + t68 / 0.2e1) * t85 + (t65 / 0.2e1 - t66 / 0.2e1) * t83) * t60 + (-t104 * t83 + t105 * t85) * t74 + t95 * mrSges(5,3) + m(5) * (t40 * t76 + t74 * t95) + t96 * mrSges(6,2) + m(6) * (t14 * t49 + t74 * t96) + (-t1 * t61 - t2 * t94) * mrSges(7,3) - t94 * t5 / 0.2e1 + (-t57 / 0.2e1 + t56 / 0.2e1 - Ifges(4,6) - mrSges(4,3) * t116 + (-Ifges(6,6) / 0.2e1 + Ifges(5,6) / 0.2e1) * t85 + (Ifges(6,4) / 0.2e1 + Ifges(5,5) / 0.2e1) * t83) * t58 + Ifges(3,6) * t90 + Ifges(3,5) * t88 + t14 * t63 + t76 * t29 + (t64 - mrSges(4,1)) * t40 + t61 * t6 / 0.2e1 - t10 * t35 + t23 * t36 / 0.2e1 + t24 * t37 / 0.2e1 - t42 * mrSges(4,2) + t43 * t9 + t49 * t28 + t26 * t16 + t27 * t15 + m(7) * (t1 * t26 - t10 * t43 + t2 * t27) + m(4) * (-t40 * t86 + t42 * t84) * pkin(2); 0.2e1 * t43 * t35 - t94 * t36 + t61 * t37 + 0.2e1 * t49 * t63 + 0.2e1 * t76 * t64 + Ifges(3,3) + Ifges(4,3) + (t66 - t65) * t85 + (t67 + t68) * t83 + m(7) * (t26 ^ 2 + t27 ^ 2 + t43 ^ 2) + m(5) * (t76 ^ 2 + t103) + m(6) * (t49 ^ 2 + t103) + m(4) * (t84 ^ 2 + t86 ^ 2) * pkin(2) ^ 2 + (mrSges(6,2) + mrSges(5,3)) * t74 * t121 + 0.2e1 * (mrSges(4,1) * t86 - mrSges(4,2) * t84) * pkin(2) + 0.2e1 * (-t26 * t61 - t27 * t94) * mrSges(7,3); t58 * mrSges(4,1) + t61 * t15 - t94 * t16 + t54 + t104 * t85 + t105 * t83 + m(7) * (-t1 * t94 + t2 * t61) + m(6) * (t7 * t83 - t8 * t85) + m(5) * (t12 * t85 + t13 * t83) + m(4) * t77; m(7) * (-t26 * t94 + t27 * t61); m(4) + m(7) * (t61 ^ 2 + t94 ^ 2) + (m(5) / 0.2e1 + m(6) / 0.2e1) * t121; m(5) * t40 + m(6) * t14 + m(7) * t10 + t28 + t29 - t9; -t107 + t78 + (-mrSges(6,1) - mrSges(5,1)) * t85 + m(5) * t76 + m(6) * t49 - m(7) * t43 - t35; 0; m(5) + m(6) + m(7); t87 * t15 + t89 * t16 + m(7) * (t1 * t89 + t2 * t87) + m(6) * t8 + t33; m(7) * (t26 * t89 + t27 * t87) + (m(6) * t74 + mrSges(6,2)) * t83 + (-t61 * t89 - t87 * t94) * mrSges(7,3); -m(6) * t85 + m(7) * (t61 * t87 - t89 * t94); 0; m(6) + m(7) * (t87 ^ 2 + t89 ^ 2); mrSges(7,1) * t1 - mrSges(7,2) * t2 - t100; mrSges(7,1) * t26 - mrSges(7,2) * t27 - t56 + t57; -t35; 0; mrSges(7,1) * t89 - mrSges(7,2) * t87; Ifges(7,3);];
