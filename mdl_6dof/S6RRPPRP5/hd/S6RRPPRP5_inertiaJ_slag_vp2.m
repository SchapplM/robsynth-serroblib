...
t2 = -t95 * pkin(5) - t3;
t1 = qJ(6) * t95 + t4;
t6 = [0.2e1 * t1 * t30 + 0.2e1 * t5 * t14 + 0.2e1 * t46 * t15 + 0.2e1 * t18 * t63 + 0.2e1 * t19 * t64 + 0.2e1 * t2 * t33 + 0.2e1 * t3 * t32 + 0.2e1 * t4 * t31 + 0.2e1 * t71 * t47 + Ifges(2,3) + (t9 + t10) * t44 + (t8 - t7) * t43 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * t66 * mrSges(4,2) - t92 * t41 - t91 * t42 + (Ifges(3,2) + Ifges(4,3)) * t96) * t96 + (-0.2e1 * pkin(1) * mrSges(3,2) - 0.2e1 * t66 * mrSges(4,3) + (Ifges(5,3) + Ifges(4,2) + Ifges(3,1)) * t95 + (-Ifges(5,5) * t91 - Ifges(5,6) * t92 + (2 * Ifges(3,4)) + (2 * Ifges(4,6))) * t96 + t100) * t95 + m(4) * (t66 ^ 2 + t113) + m(3) * (pkin(1) ^ 2 + t113) + m(5) * (t18 ^ 2 + t19 ^ 2 + t71 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t46 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + 0.2e1 * (mrSges(4,1) + mrSges(3,3)) * pkin(7) * t128; qJ(3) * t47 + t17 * t14 + t75 * t15 + t5 * t24 + t46 * t25 + t71 * t67 + (t28 / 0.2e1 + t29 / 0.2e1) * t44 + (t27 / 0.2e1 - t26 / 0.2e1) * t43 + t115 * t23 + t114 * t21 + (t42 / 0.2e1 - t18 * mrSges(5,3) + t93 * t63) * t92 + (-t41 / 0.2e1 - t19 * mrSges(5,3) + t93 * t64) * t91 + (Ifges(5,5) * t92 / 0.2e1 + Ifges(5,6) * t123 - t53 / 0.2e1 + t52 / 0.2e1 - t54 / 0.2e1 - t51 / 0.2e1 - Ifges(4,4) + Ifges(3,5) - pkin(2) * mrSges(4,1)) * t95 + m(5) * (qJ(3) * t71 + t101 * t93) + m(6) * (-t21 * t3 + t23 * t4 + t46 * t75) + m(7) * (t1 * t23 + t17 * t5 + t21 * t2) - (t7 / 0.2e1 - t8 / 0.2e1 - t1 * mrSges(7,2) - t4 * mrSges(6,3)) * t99 + (-t9 / 0.2e1 - t10 / 0.2e1 - t2 * mrSges(7,2) + t3 * mrSges(6,3)) * t58 + (-Ifges(4,5) + Ifges(3,6) + t69 * t123 - t92 * t68 / 0.2e1 + qJ(3) * mrSges(4,1)) * t96 + ((m(4) * qJ(3) - mrSges(3,2) + mrSges(4,3)) * t96 + (-mrSges(3,1) + t125) * t95) * pkin(7); -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t17 * t24 + 0.2e1 * t75 * t25 - t91 * t68 + t92 * t69 + Ifges(4,1) + Ifges(3,3) - (t104 * t23 + t26 - t27) * t99 + (t104 * t21 - t28 - t29) * t58 + m(7) * (t17 ^ 2 + t111) + m(6) * (t75 ^ 2 + t111) + m(5) * (t112 * t93 ^ 2 + t97) + m(4) * (pkin(2) ^ 2 + t97) + 0.2e1 * (mrSges(4,3) + t67) * qJ(3) - 0.2e1 * t93 * t107; t92 * t63 + t91 * t64 + (m(4) * pkin(7) + mrSges(4,1)) * t95 - t115 * t99 + t114 * t58 + m(7) * (-t1 * t99 + t2 * t58) + m(6) * (-t3 * t58 - t4 * t99) + m(5) * t101; -t107 + t93 * t109 + t127 * (t21 * t58 - t23 * t99) + t125 + t130 * t110; t127 * t110 + m(4) + t109; m(5) * t71 + m(6) * t46 + m(7) * t5 + t14 + t15 + t47; m(5) * qJ(3) + m(6) * t75 + m(7) * t17 + t24 + t25 + t67; 0; m(5) + t127; -t2 * mrSges(7,1) - pkin(5) * t33 + t1 * mrSges(7,3) + qJ(6) * t30 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) - t4 * mrSges(6,2) + t3 * mrSges(6,1) + t100; t102 * mrSges(7,2) - t51 + t52 - t53 - t54 + (m(7) * qJ(6) + t126) * t23 + (-mrSges(6,1) + t124) * t21; -m(7) * t102 - t126 * t99 + (-mrSges(6,1) - mrSges(7,1)) * t58; 0; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t129; m(7) * t2 + t33; m(7) * t21 - t58 * mrSges(7,2); m(7) * t58; 0; t124; m(7);];
