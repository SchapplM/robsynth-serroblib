...
function JaD = S6RRPRRR14_jacobiaD_4_floatb_twist_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)

JaD_transl = S6RRPRRR14_jacobiaD_transl_4_floatb_twist_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin);
JaD_rot = S6RRPRRR14_jacobiaD_rot_4_floatb_twist_sym_varpar(qJ, qJD, ...
  pkin);
