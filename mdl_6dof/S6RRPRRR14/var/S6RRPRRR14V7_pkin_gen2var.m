% Umwandlung der Kinematikparameter von S6RRPRRR14 zu S6RRPRRR14V7
% Eingabe:
...
function [pkin_var, I_gv] = S6RRPRRR14V7_pkin_gen2var(pkin_gen)
I_gv = [1, 4, 5, 6, 7, 8, 9, 10, 12, 13, 14];
