...
t6 = [m(2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t4) + m(4) * (t12 ^ 2 + t20 ^ 2 + t9) + m(3) * (t58 ^ 2 + (t53 ^ 2 + t56 ^ 2) * t55 ^ 2) + t108 * (t5 ^ 2 + t4 + t9); m(3) * t58 + m(7) * (t15 * t1 + t16 * t2 + t3) + m(4) * (t57 * t20 + (-t10 * t64 + t12 * t61) * t54) + t108 * (-t10 * t96 + t22 * t5 + t3); m(3) + m(7) * (t15 ^ 2 + t16 ^ 2 + t21) + m(4) * (t46 * t61 ^ 2 + t57 ^ 2 + t40) + t108 * (t22 ^ 2 + t21 + t40); -t12 * mrSges(4,2) + t1 * t29 + t2 * t30 + t5 * t80 + t75 * t7 - t83 * t10 + m(6) * (t31 * t10 + t69) + m(7) * (t13 * t1 + t14 * t2 + t39 * t7) + m(5) * (-pkin(3) * t10 + t69); t15 * t29 + t16 * t30 + t22 * t80 + t75 * t24 + (-t61 * mrSges(4,2) + t83 * t64) * t54 + m(7) * (t13 * t15 + t14 * t16 + t39 * t24) + m(5) * (pkin(3) * t96 + t68) + m(6) * (-t31 * t96 + t68); -0.2e1 * pkin(3) * t33 + 0.2e1 * t13 * t29 + 0.2e1 * t14 * t30 + 0.2e1 * t39 * t26 + 0.2e1 * t31 * t32 + Ifges(4,3) + m(7) * (t13 ^ 2 + t14 ^ 2 + t39 ^ 2) + m(6) * (t31 ^ 2 + t88) + m(5) * (pkin(3) ^ 2 + t88) + (t42 + (Ifges(5,1) + Ifges(6,2)) * t60) * t60 + (-t59 * t19 - t62 * t18 + (Ifges(5,2) + Ifges(6,3)) * t63 + ((2 * Ifges(5,4)) + (2 * Ifges(6,6)) + t73) * t60) * t63 + 0.2e1 * t90 * pkin(9) * t107; t91 * t5 - t76 * mrSges(7,3) + t82 * t7 + m(6) * (-pkin(4) * t5 + t92) + m(7) * (t76 * t65 + t92); t91 * t22 - t71 * mrSges(7,3) + t82 * t24 + m(7) * (t71 * t65 + t86) + m(6) * (-pkin(4) * t22 + t86); t65 * t94 + t29 * t93 + m(7) * (qJ(5) * t39 + t72 * t65) + t62 * t19 / 0.2e1 + t18 * t102 + t39 * t34 + qJ(5) * t26 - t72 * mrSges(7,3) + (-pkin(4) * mrSges(6,1) + Ifges(5,5) - Ifges(6,4) + Ifges(7,6) * t102 + t43 / 0.2e1) * t60 + (t36 * t102 - t62 * t35 / 0.2e1 + qJ(5) * mrSges(6,1) + Ifges(5,6) - Ifges(6,5)) * t63 + ((m(6) * qJ(5) - mrSges(5,2) + mrSges(6,3)) * t63 + (-mrSges(5,1) + t103) * t60) * pkin(9); -0.2e1 * pkin(4) * mrSges(6,2) - t59 * t35 + t62 * t36 + Ifges(6,1) + Ifges(5,3) + m(7) * (t87 * t65 ^ 2 + t66) + m(6) * (pkin(4) ^ 2 + t66) + 0.2e1 * t89 * qJ(5) - 0.2e1 * t65 * t79; m(6) * t5 + m(7) * t76; m(6) * t22 + m(7) * t71; t94 + t62 * t29 + m(7) * t72 + (m(6) * pkin(9) + mrSges(6,1)) * t60; t65 * t81 + t103 - t79; m(6) + t81; t1 * mrSges(7,1) - t2 * mrSges(7,2); t15 * mrSges(7,1) - t16 * mrSges(7,2); t13 * mrSges(7,1) - t14 * mrSges(7,2) + t73 * t63 + t42; mrSges(7,1) * t93 + t43 + (-mrSges(7,2) * t65 - Ifges(7,6)) * t59; t74; Ifges(7,3);];
