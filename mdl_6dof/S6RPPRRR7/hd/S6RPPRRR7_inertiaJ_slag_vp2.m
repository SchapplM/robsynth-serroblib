...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:51:15
% EndTime: 2018-11-23 15:51:16
...
t97 = t73 ^ 2 + t75 ^ 2;
t128 = mrSges(7,3) * t97;
t51 = -mrSges(7,1) * t75 + mrSges(7,2) * t73;
t127 = t51 - mrSges(6,1);
t112 = sin(qJ(4));
t113 = cos(qJ(4));
t70 = sin(pkin(10));
...
t100 = mrSges(4,1) * t70 + mrSges(4,2) * t71;
t99 = Ifges(7,5) * t73 + Ifges(7,6) * t75;
t98 = t70 ^ 2 + t66;
t96 = t48 ^ 2 + t119;
t52 = Ifges(7,2) * t75 + t110;
t53 = Ifges(7,1) * t73 + t109;
t95 = t52 * t75 + t53 * t73 + Ifges(6,3);
t94 = m(4) * t98;
t93 = t97 * pkin(9);
t92 = t98 * mrSges(4,3);
t58 = pkin(4) * t74 + pkin(9);
t91 = t97 * t58;
t90 = -t46 * mrSges(5,1) + mrSges(5,2) * t48;
t84 = 0.2e1 * t128;
...
t77 = qJ(2) ^ 2;
t59 = -pkin(4) * t76 - pkin(5);
t31 = t85 ^ 2;
t27 = t36 * mrSges(6,2);
t1 = [Ifges(4,1) * t66 + 0.2e1 * mrSges(5,3) * t105 + 0.2e1 * t54 * t90 + Ifges(5,2) * t119 + t27 * t117 + 0.2e1 * t2 * t16 + t14 * t118 + 0.2e1 * t3 * t15 - (2 * pkin(1) * mrSges(3,2)) + Ifges(3,1) + Ifges(2,3) + (-0.2e1 * Ifges(4,4) * t71 + Ifges(4,2) * t70) * t70 + (mrSges(6,1) * t117 - 0.2e1 * mrSges(6,3) * t12 + Ifges(6,2) * t85 + t101) * t85 - 0.2e1 * t72 * t92 + (-0.2e1 * mrSges(5,3) * t37 + Ifges(5,1) * t48 + 0.2e1 * Ifges(5,4) * t46) * t48 + (mrSges(6,3) * t118 + Ifges(6,1) * t36 - t73 * t6 + t75 * t7 + (-Ifges(7,6) * t73 - (2 * Ifges(6,4))) * t85) * t36 + m(4) * (t98 * t72 ^ 2 + t77) + m(3) * ((pkin(1) ^ 2) + t77) + m(5) * (t37 ^ 2 + t38 ^ 2 + t54 ^ 2) + m(6) * (t12 ^ 2 + t39 ^ 2 + t121) + m(7) * (t2 ^ 2 + t3 ^ 2 + t121) + 0.2e1 * (t100 + mrSges(3,3)) * qJ(2); -m(3) * pkin(1) + mrSges(3,2) - (t36 * mrSges(6,3) + t14) * t36 - t96 * mrSges(5,3) - t92 + (-mrSges(6,3) * t85 + t124) * t85 + m(7) * (t85 * t87 - t108) + m(6) * (t12 * t85 - t108) + m(5) * (t37 * t48 - t105) + t72 * t94; m(3) + m(7) * (t31 * t97 + t120) + m(6) * (t31 + t120) + m(5) * t96 + t94; m(4) * qJ(2) + t85 * mrSges(6,1) + t73 * t15 + t75 * t16 + t27 + m(7) * (t2 * t75 + t3 * t73) + m(6) * t39 + m(5) * t54 + t90 + t100; 0; m(7) * t97 + m(4) + m(5) + m(6); (m(6) * (-t10 * t76 + t12 * t74) - t126 * mrSges(6,3)) * pkin(4) + Ifges(5,6) * t46 + Ifges(5,5) * t48 + t37 * mrSges(5,1) - t38 * mrSges(5,2) + t81 + t123 * t59 + t122 * t58; t48 * mrSges(5,1) + t46 * mrSges(5,2) + m(7) * (-t36 * t59 + t85 * t91) + m(6) * t126 * pkin(4) + t83; 0; 0.2e1 * t59 * t51 + Ifges(5,3) + 0.2e1 * t82 + t58 * t84 + m(7) * (t58 ^ 2 * t97 + t59 ^ 2) + m(6) * (t74 ^ 2 + t76 ^ 2) * pkin(4) ^ 2 + t95; -pkin(5) * t123 + pkin(9) * t122 + t81; m(7) * (pkin(5) * t36 + t85 * t93) + t83; 0; m(7) * (-pkin(5) * t59 + pkin(9) * t91) + (t59 - pkin(5)) * t51 + t82 + (t91 + t93) * mrSges(7,3) + t95; -0.2e1 * pkin(5) * t51 + m(7) * (pkin(9) ^ 2 * t97 + pkin(5) ^ 2) + pkin(9) * t84 + t95; mrSges(7,1) * t2 - mrSges(7,2) * t3 - Ifges(7,6) * t107 + t101; -t86 * t85; -t51; -t58 * t86 + t99; -pkin(9) * t86 + t99; Ifges(7,3);];
