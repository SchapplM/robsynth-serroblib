...
t3 = -t78 * pkin(5) - t5;
t11 = [t93 * t154 + (-0.2e1 * Ifges(4,4) * t79 + Ifges(5,5) * t56 - Ifges(4,6) * t93 + Ifges(5,6) * t55 + (Ifges(5,3) + Ifges(4,2)) * t78 + t155) * t78 + m(7) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t23 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(5) * (t20 ^ 2 + t21 ^ 2 + t37 ^ 2) + m(4) * (t45 ^ 2 + t46 ^ 2 + t52 ^ 2) + m(3) * (pkin(1) ^ 2 * t133 ^ 2 + t96 ^ 2 + t97 ^ 2) + (t7 - t18) * t42 + (-0.2e1 * t97 * mrSges(3,2) + Ifges(3,3) * t137 + t185 * t96) * t137 + (-0.2e1 * pkin(1) * t116 + (-0.2e1 * t96 * mrSges(3,3) + Ifges(3,1) * t163 + Ifges(3,5) * t183) * t131 + (0.2e1 * t97 * mrSges(3,3) + Ifges(3,6) * t183 + (0.2e1 * Ifges(3,4) * t131 + Ifges(3,2) * t135 + pkin(1) * t185) * t133) * t135) * t133 + Ifges(2,3) + t79 * (Ifges(4,1) * t79 + Ifges(4,5) * t93) + 0.2e1 * t3 * t13 + 0.2e1 * t2 * t16 + 0.2e1 * t1 * t17 + 0.2e1 * t23 * t22 + t26 * t8 + t27 * t9 + 0.2e1 * t6 * t28 + 0.2e1 * t5 * t29 + t43 * t19 + 0.2e1 * t37 * t44 + 0.2e1 * t21 * t47 + 0.2e1 * t20 * t48 + 0.2e1 * t52 * t51 + t55 * t30 + t56 * t31 + 0.2e1 * t46 * t59 + 0.2e1 * t45 * t60; t136 * t51 + t58 * t16 + t57 * t17 + t66 * t28 + t95 * t47 + t94 * t48 + t116 + t168 * t64 + (-m(3) * pkin(1) - mrSges(3,1) * t135) * t133 + (t140 * t59 + (t60 + t191) * t142) * t132 + m(7) * (t1 * t57 + t2 * t58 + t3 * t64) + m(6) * (-t161 * t23 - t5 * t64 + t6 * t66) + m(5) * (-t161 * t37 + t20 * t94 + t21 * t95) + m(4) * (t136 * t52 + (t140 * t46 + t142 * t45) * t132); m(3) + m(7) * (t57 ^ 2 + t58 ^ 2 + t187) + m(6) * (t66 ^ 2 + t119 + t187) + m(5) * (t94 ^ 2 + t95 ^ 2 + t119) + m(4) * (t126 * t140 ^ 2 + t136 ^ 2 + t119); t149 * mrSges(5,3) + m(5) * (-pkin(3) * t37 + qJ(4) * t149) + m(7) * (t1 * t49 + t2 * t50 + t3 * t85) + m(6) * (t121 * t23 - t5 * t85 + t6 * t87) + t63 * t181 + t62 * t182 + (t61 / 0.2e1 - t82 / 0.2e1) * t42 + (Ifges(5,5) * t130 + Ifges(5,6) * t134 + t158) * t78 / 0.2e1 + t154 + (-t6 * mrSges(6,3) + t7 / 0.2e1 - t18 / 0.2e1) * t103 + (-t130 * t48 + t134 * t47) * qJ(4) + (-t5 * mrSges(6,3) + t8 * t177 + t9 * t175 + t19 / 0.2e1) * t104 + t168 * t85 - pkin(3) * t44 + t45 * mrSges(4,1) - t46 * mrSges(4,2) + t49 * t17 + t50 * t16 + t3 * t70 + t2 * t73 + t1 * t74 + t23 * t81 + t43 * t83 / 0.2e1 + t87 * t28 + t37 * t106 + t55 * t108 / 0.2e1 + t56 * t109 / 0.2e1 + t121 * t22 + t130 * t31 / 0.2e1 + t134 * t30 / 0.2e1; t57 * t74 + t58 * t73 + t64 * t70 + (-t103 * t66 + t104 * t64) * mrSges(6,3) + t148 * mrSges(5,3) + (-t140 * mrSges(4,2) + (mrSges(4,1) + t190) * t142) * t132 + m(7) * (t49 * t57 + t50 * t58 + t170) + m(6) * (-t121 * t161 + t66 * t87 + t170) + m(5) * (pkin(3) * t161 + qJ(4) * t148); -0.2e1 * pkin(3) * t106 + t134 * t108 + t130 * t109 + 0.2e1 * t121 * t81 + 0.2e1 * t49 * t74 + 0.2e1 * t50 * t73 + t70 * t184 + Ifges(4,3) + 0.2e1 * t157 * qJ(4) * mrSges(5,3) + (-0.2e1 * t87 * mrSges(6,3) + t61 - t82) * t103 + m(7) * (t49 ^ 2 + t50 ^ 2 + t186) + m(6) * (t121 ^ 2 + t87 ^ 2 + t186) + m(5) * (qJ(4) ^ 2 * t157 + pkin(3) ^ 2) + (mrSges(6,3) * t184 - t138 * t62 + t141 * t63 + t83) * t104; t138 * t16 + t141 * t17 + m(7) * (t1 * t141 + t138 * t2) + m(6) * t23 + m(5) * t37 - t191; m(7) * (t138 * t58 + t141 * t57) + t179 * t161; -m(5) * pkin(3) + t138 * t73 + t141 * t74 + m(7) * (t138 * t50 + t141 * t49) + m(6) * t121 - t190; m(7) * t156 - t179; -pkin(5) * t13 + m(7) * (-pkin(5) * t3 + pkin(11) * t151) + t16 * t171 - t17 * t172 + t3 * t110 + t9 * t176 + t8 * t175 + t112 * t182 + t42 * t178 + t113 * t181 + t5 * mrSges(6,1) - t6 * mrSges(6,2) + t151 * mrSges(7,3) + t155; -t66 * mrSges(6,2) + t189 * (-t138 * t57 + t141 * t58) + t188 * t64; t103 * t178 + t73 * t171 - t74 * t172 + t63 * t176 + t62 * t175 - pkin(5) * t70 - t87 * mrSges(6,2) + (t112 * t177 + t113 * t175) * t104 + t158 + t189 * (-t138 * t49 + t141 * t50) + t188 * t85; 0; Ifges(6,3) - 0.2e1 * pkin(5) * t110 + m(7) * (pkin(11) ^ 2 * t156 + pkin(5) ^ 2) + t138 * t113 + t141 * t112 + 0.2e1 * t156 * pkin(11) * mrSges(7,3); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t57 - mrSges(7,2) * t58; mrSges(7,1) * t49 - mrSges(7,2) * t50 + t61; -t110; -pkin(11) * t150 + t111; Ifges(7,3);];
