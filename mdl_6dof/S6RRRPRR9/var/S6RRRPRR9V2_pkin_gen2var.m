% Umwandlung der Kinematikparameter von S6RRRPRR9 zu S6RRRPRR9V2
% Eingabe:
...
%   Kinematikparameter (pkin) von S6RRRPRR9V2
%   pkin_var=[a2 a3 a4 a5 alpha2 alpha3 d1 d2 d3 d5 theta4]
% I_gv (11x1)
%   Vektor mit Indizes zur Selektion von Kinematikparametern
function [pkin_var, I_gv] = S6RRRPRR9V2_pkin_gen2var(pkin_gen)
