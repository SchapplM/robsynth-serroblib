% Umwandlung der Kinematikparameter von S6RRRPRR9 zu S6RRRPRR9V3
% Eingabe:
...
% Ausgabe:
% pkin_var (8x1) double
%   Kinematikparameter (pkin) von S6RRRPRR9V3
%   pkin_var=[a2 a4 a5 alpha2 d1 d2 d5 theta4]
% I_gv (8x1)
%   Vektor mit Indizes zur Selektion von Kinematikparametern
function [pkin_var, I_gv] = S6RRRPRR9V3_pkin_gen2var(pkin_gen)
