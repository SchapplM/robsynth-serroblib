...
t103 = t67 * t70;
t102 = t69 * t70;
t101 = mrSges(6,1) + mrSges(7,1);
t100 = -mrSges(6,2) + mrSges(7,3);
t99 = mrSges(6,3) + mrSges(7,2);
...
t15 = [0.2e1 * t1 * t24 + 0.2e1 * t8 * t18 + 0.2e1 * t7 * t19 + 0.2e1 * t2 * t27 + 0.2e1 * t44 * t20 + 0.2e1 * t5 * t25 + 0.2e1 * t4 * t26 + 0.2e1 * t6 * t28 + 0.2e1 * t3 * t29 + Ifges(2,3) + m(4) * (t33 ^ 2 + t94) + m(3) * (pkin(1) ^ 2 + t94) + m(5) * (t44 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t7 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t8 ^ 2) + (-0.2e1 * pkin(1) * mrSges(3,2) - 0.2e1 * t33 * mrSges(4,3) + (Ifges(4,2) + Ifges(3,1) + Ifges(7,3)) * t68 + t87) * t68 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * t33 * mrSges(4,2) + (Ifges(4,3) + Ifges(3,2)) * t70 + (t9 + t10 - t11) * t69 + (-t12 - t13 - t14) * t67 + ((2 * Ifges(3,4)) + (2 * Ifges(4,6)) + t76) * t68) * t70 + 0.2e1 * (mrSges(4,1) + mrSges(3,3)) * pkin(7) * t116; qJ(3) * t20 + t17 * t19 + t32 * t18 - t31 * t24 + t30 * t27 + t8 * t34 + t7 * t35 + t44 * t36 + (t12 / 0.2e1 + t13 / 0.2e1 + t14 / 0.2e1 - t5 * mrSges(5,3) - t1 * mrSges(7,3) + t4 * mrSges(6,2) + t97 * t72) * t69 + (-t6 * mrSges(5,3) + t2 * mrSges(7,3) - t3 * mrSges(6,2) + t9 / 0.2e1 + t10 / 0.2e1 - t11 / 0.2e1 + t96 * t72) * t67 + m(5) * (qJ(3) * t44 + t80 * t72) + m(6) * (t32 * t8 + t81 * t72) + m(7) * (-t1 * t31 + t17 * t7 + t2 * t30) + (-Ifges(7,5) * t69 / 0.2e1 - pkin(2) * mrSges(4,1) + t56 / 0.2e1 + t57 / 0.2e1 + t54 / 0.2e1 - Ifges(4,4) + Ifges(3,5) + (-Ifges(7,6) / 0.2e1 - Ifges(5,6) / 0.2e1) * t67 + (-mrSges(3,1) + t86) * pkin(7)) * t68 + (qJ(3) * mrSges(4,1) - Ifges(4,5) + Ifges(3,6) + (t37 / 0.2e1 + t38 / 0.2e1 - t39 / 0.2e1) * t69 + (-t41 / 0.2e1 - t42 / 0.2e1 - t40 / 0.2e1) * t67 + (m(4) * qJ(3) - mrSges(3,2) + mrSges(4,3)) * pkin(7)) * t70; -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t17 * t35 + 0.2e1 * t32 * t34 + Ifges(4,1) + Ifges(3,3) + 0.2e1 * (t36 + mrSges(4,3)) * qJ(3) + (t31 * t115 + t40 + t41 + t42) * t69 + (t30 * t115 + t37 + t38 - t39) * t67 + m(6) * (t32 ^ 2 - t95) + m(7) * (t17 ^ 2 + t30 ^ 2 + t31 ^ 2) + m(5) * (t74 - t95) + m(4) * (pkin(2) ^ 2 + t74) + 0.2e1 * (mrSges(6,2) + mrSges(5,3)) * t113; (m(4) * pkin(7) + mrSges(4,1)) * t68 + (-t24 + t97) * t69 + (t27 + t96) * t67 + m(6) * t81 + m(7) * (-t1 * t69 + t2 * t67) + m(5) * t80; m(7) * (t30 * t67 + t31 * t69) - 0.2e1 * t89 * t113 + t86 - t93 * (-mrSges(5,3) + t100); m(4) - 0.2e1 * (m(7) / 0.2e1 + t89) * t93; t5 * mrSges(5,1) - t4 * mrSges(6,1) - t1 * mrSges(7,1) - t6 * mrSges(5,2) + t2 * mrSges(7,2) + t3 * mrSges(6,3) + Ifges(7,3) * t68 - pkin(4) * t26 + t71 * t24 + (t27 + t29) * qJ(5) + m(6) * (-pkin(4) * t4 + qJ(5) * t3) + m(7) * (qJ(5) * t2 + t1 * t71) + t76 * t70 + t87; m(7) * (qJ(5) * t30 - t31 * t71) + t30 * mrSges(7,2) + t31 * mrSges(7,1) + t57 + t54 + t56 + (-pkin(4) * mrSges(6,2) - t71 * mrSges(7,3) - Ifges(7,5)) * t69 + (t100 * qJ(5) + t98) * t67 + (t78 + t79 + t114) * t72; (mrSges(5,1) + t101) * t69 + t114 - m(7) * t112 + (-mrSges(5,2) + t99) * t67; 0.2e1 * pkin(4) * mrSges(6,1) - 0.2e1 * t71 * mrSges(7,1) + Ifges(7,3) + 0.2e1 * t99 * qJ(5) + m(7) * (t71 ^ 2 + t73) + m(6) * (pkin(4) ^ 2 + t73) + t117; m(6) * t4 + m(7) * t1 - t101 * t68 + t46 - t90; -m(7) * t31 + (-m(6) * t72 - t100) * t69; -t111 * t69; -m(6) * pkin(4) + m(7) * t71 - t101; t111; m(7) * t7 + t19; m(7) * t17 + t35; 0; 0; 0; m(7);];
