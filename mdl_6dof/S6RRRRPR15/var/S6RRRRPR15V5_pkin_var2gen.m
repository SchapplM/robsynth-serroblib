% Umwandlung der Kinematikparameter von S6RRRRPR15V5 zu S6RRRRPR15
% Eingabe:
% pkin_var (6x1) double
%   Kinematikparameter (pkin) von S6RRRRPR15V5
...
function pkin_gen = S6RRRRPR15V5_pkin_var2gen(pkin_var)
pkin_gen = zeros(12,1);
pkin_gen([3, 4, 5, 8, 11, 12]) = pkin_var;
