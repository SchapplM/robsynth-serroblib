% Umwandlung der Kinematikparameter von S6RRRRPR15V8 zu S6RRRRPR15
% Eingabe:
% pkin_var (4x1) double
%   Kinematikparameter (pkin) von S6RRRRPR15V8
...
function pkin_gen = S6RRRRPR15V8_pkin_var2gen(pkin_var)
pkin_gen = zeros(12,1);
