...
% OptimizationMode: 2
% StartTime: 2018-11-23 18:25:07
% EndTime: 2018-11-23 18:25:10
...
t7 = -pkin(4) * t90 - t8;
t4 = -pkin(5) * t61 - t6;
t25 = [(t210 - 0.2e1 * t226 + 0.2e1 * t227) * t182 + m(5) * (t29 ^ 2 + t8 ^ 2 + t9 ^ 2) + m(6) * (t13 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t4 ^ 2) + m(4) * (t33 ^ 2 + t34 ^ 2 + t54 ^ 2) + (-t44 + t246) * t90 + (t10 + t24 - t21) * t62 + (t19 - t22) * t61 + ((Ifges(3,5) * t186 + Ifges(3,6) * t190) * t182 + 0.2e1 * (-t128 * t186 + t130 * t190) * mrSges(3,3) + (m(3) * pkin(1) ^ 2 - 0.2e1 * pkin(1) * (-mrSges(3,1) * t190 + mrSges(3,2) * t186) + t186 * (Ifges(3,1) * t186 + Ifges(3,4) * t190) + t190 * (Ifges(3,4) * t186 + Ifges(3,2) * t190)) * t180) * t180 + Ifges(2,3) + 0.2e1 * t4 * t14 + 0.2e1 * t2 * t17 + 0.2e1 * t1 * t18 + 0.2e1 * t29 * t31 + 0.2e1 * t13 * t32 + t37 * t11 + t38 * t12 + 0.2e1 * t6 * t39 + 0.2e1 * t7 * t40 + 0.2e1 * t9 * t41 + 0.2e1 * t8 * t42 + 0.2e1 * t54 * t52 + m(3) * (t128 ^ 2 + t130 ^ 2) + 0.2e1 * t34 * t65 + 0.2e1 * t33 * t66 + t91 * t45 + t123 * t43; t212 * t61 + t213 * t124 + (-pkin(2) * t52 + t185 * t45 / 0.2e1 + (-t20 / 0.2e1 - t23 / 0.2e1 + t44 / 0.2e1) * t189) * t179 + t202 * t62 + t203 * t125 + t210 + m(7) * (t1 * t15 + t16 * t2 + t4 * t51) + m(6) * (t13 * t60 + t6 * t63 + t64 * t7) + m(5) * (t111 * t29 + t69 * t8 + t70 * t9) + m(4) * (-pkin(2) * t179 * t54 + t127 * t33 + t129 * t34) + (t73 / 0.2e1 + t74 / 0.2e1 - t108 / 0.2e1) * t90 - t226 + t227 + t38 * t243 + t96 * t244 + t16 * t17 + t15 * t18 + t37 * t47 / 0.2e1 + t51 * t14 + t4 * t53 + t60 * t32 + t63 * t39 + t64 * t40 + t2 * t67 + t1 * t68 + t69 * t42 + t70 * t41 + t29 * t77 + t13 * t78 + t95 * t11 / 0.2e1 + t6 * t99 + t7 * t100 + t9 * t101 + t8 * t102 + t91 * t109 / 0.2e1 + t111 * t31 + t123 * t107 / 0.2e1 + t54 * t126 + t127 * t66 + t129 * t65 + t33 * t133 + t34 * t134 + t181 * t43 / 0.2e1; 0.2e1 * t64 * t100 + 0.2e1 * t70 * t101 + 0.2e1 * t69 * t102 + t181 * t107 + 0.2e1 * t111 * t77 + 0.2e1 * t127 * t133 + 0.2e1 * t129 * t134 + 0.2e1 * t15 * t68 + 0.2e1 * t16 * t67 + t95 * t47 + t96 * t48 + 0.2e1 * t51 * t53 + 0.2e1 * t60 * t78 + 0.2e1 * t63 * t99 + Ifges(3,3) + (t71 - t75) * t124 + (t46 + t76 - t72) * t125 + (-0.2e1 * pkin(2) * t126 + t185 * t109 + (t108 - t73 - t74) * t189) * t179 + m(7) * (t15 ^ 2 + t16 ^ 2 + t51 ^ 2) + m(6) * (t60 ^ 2 + t63 ^ 2 + t64 ^ 2) + m(5) * (t111 ^ 2 + t69 ^ 2 + t70 ^ 2) + m(4) * (pkin(2) ^ 2 * t179 ^ 2 + t127 ^ 2 + t129 ^ 2); (t9 * mrSges(5,3) - t6 * mrSges(6,1) + t12 * t235 + t11 * t234 + (-t39 + t41) * pkin(11) - t213) * t188 + t208 * t90 + t209 * t61 + m(7) * (t1 * t88 + t153 * t4 + t2 * t89) + (t7 * mrSges(6,1) - t8 * mrSges(5,3) + (t40 - t42) * pkin(11) + t203) * t184 + t200 * t62 + t43 + m(6) * (t13 * t138 + (t184 * t7 - t188 * t6) * pkin(11)) + m(5) * (-pkin(3) * t29 + (-t184 * t8 + t188 * t9) * pkin(11)) - pkin(3) * t31 + t33 * mrSges(4,1) - t34 * mrSges(4,2) + t88 * t18 + t89 * t17 + t37 * t240 + t38 * t239 + t4 * t131 + t1 * t135 + t2 * t136 + t138 * t32 + t13 * t139 + t29 * t140 + t153 * t14; m(7) * (t15 * t88 + t153 * t51 + t16 * t89) + t209 * t124 + (t64 * mrSges(6,1) - t69 * mrSges(5,3) + (t100 - t102) * pkin(11) + t202) * t184 + t200 * t125 + t107 + (-t63 * mrSges(6,1) + t70 * mrSges(5,3) + t48 * t235 + t47 * t234 + (-t99 + t101) * pkin(11) - t212) * t188 - t208 * t224 + m(6) * (t138 * t60 + (t184 * t64 - t188 * t63) * pkin(11)) + m(5) * (-pkin(3) * t111 + (-t184 * t69 + t188 * t70) * pkin(11)) - pkin(3) * t77 + t88 * t68 + t89 * t67 + t95 * t240 + t96 * t239 + t127 * mrSges(4,1) - t129 * mrSges(4,2) + t51 * t131 + t15 * t135 + t16 * t136 + t138 * t78 + t60 * t139 + t111 * t140 + t153 * t53; -0.2e1 * pkin(3) * t140 + 0.2e1 * t153 * t131 + 0.2e1 * t88 * t135 + 0.2e1 * t89 * t136 + 0.2e1 * t138 * t139 + Ifges(4,3) + (t114 + t150 - t143) * t184 + m(7) * (t153 ^ 2 + t88 ^ 2 + t89 ^ 2) + m(6) * (t138 ^ 2 + t215) + m(5) * (pkin(3) ^ 2 + t215) + (-t115 * t187 - t116 * t183 - t142 + t148) * t188 + 0.2e1 * (mrSges(6,1) + mrSges(5,3)) * pkin(11) * t247; -t6 * mrSges(6,3) + t7 * mrSges(6,2) + t8 * mrSges(5,1) - t9 * mrSges(5,2) - pkin(4) * t40 + t4 * t141 + t62 * t238 + t37 * t237 + t38 * t236 + (t14 - t39) * qJ(5) + (-t1 * mrSges(7,3) - t18 * t242 + t244) * t187 + (-t2 * mrSges(7,3) - t242 * t17 - t11 / 0.2e1) * t183 + m(6) * (-pkin(4) * t7 - qJ(5) * t6) + m(7) * (qJ(5) * t4 - t201 * t242) + t246; -t63 * mrSges(6,3) + t64 * mrSges(6,2) + t69 * mrSges(5,1) - t70 * mrSges(5,2) - pkin(4) * t100 + t51 * t141 + t125 * t238 + t95 * t237 + t96 * t236 + t231 * t224 + (t53 - t99) * qJ(5) + (-t15 * mrSges(7,3) - t242 * t68 + t243) * t187 + (-t16 * mrSges(7,3) - t242 * t67 - t47 / 0.2e1) * t183 + m(6) * (-pkin(4) * t64 - qJ(5) * t63) + m(7) * (qJ(5) * t51 - t198 * t242) + t216 + t217; -t242 * t219 - t135 * t218 + m(7) * (qJ(5) * t153 - t197 * t242) + t187 * t239 + t153 * t141 + t115 * t235 + qJ(5) * t131 - t197 * mrSges(7,3) + (-pkin(4) * mrSges(6,1) - Ifges(6,4) + t238) * t184 + (qJ(5) * mrSges(6,1) + t146 * t234 + t149 * t235 - Ifges(6,5)) * t188 + ((m(6) * qJ(5) - mrSges(5,2) + mrSges(6,3)) * t188 + (-mrSges(5,1) + t245) * t184) * pkin(11) + t145; -0.2e1 * pkin(4) * mrSges(6,2) - t183 * t146 + t187 * t149 + m(7) * (-t214 * t242 ^ 2 + t192) + m(6) * (pkin(4) ^ 2 + t192) - t231 + 0.2e1 * (t141 + mrSges(6,3)) * qJ(5) - 0.2e1 * t242 * t205; m(6) * t7 + m(7) * t201 + t183 * t17 + t187 * t18 + t40; m(6) * t64 + m(7) * t198 + t183 * t67 + t187 * t68 + t100; t219 + t187 * t135 + m(7) * t197 + (m(6) * pkin(11) + mrSges(6,1)) * t184; t207 * t242 + t205 + t245; m(6) - t207; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t10; mrSges(7,1) * t15 - mrSges(7,2) * t16 + t46; mrSges(7,1) * t88 - mrSges(7,2) * t89 + t114; -mrSges(7,1) * t218 + t170 + (mrSges(7,2) * t242 - Ifges(7,6)) * t183; t199; Ifges(7,3);];
