...
% EndTime: 2019-03-09 12:55:41
% DurationCPUTime: 1.66s
% Computational Cost: add. (1872->385), mult. (4080->507), div. (0->0), fcn. (4014->8), ass. (0->133)
...
t137 = Ifges(3,5) * t159 + Ifges(3,6) * t158 + t175 * t125;
...
t12 = [0.2e1 * t1 * t24 + 0.2e1 * t13 * t21 + 0.2e1 * t15 * t45 + 0.2e1 * t16 * t44 + 0.2e1 * t2 * t22 + 0.2e1 * t5 * t20 + 0.2e1 * t4 * t23 + 0.2e1 * t3 * t25 + t63 * t27 + 0.2e1 * t42 * t28 + 0.2e1 * t48 * t71 + 0.2e1 * t50 * t72 + Ifges(2,3) + (t10 + t11) * t41 + (t8 + t9) * t40 + (-t26 + t172) * t62 + (t137 - 0.2e1 * t167 + 0.2e1 * t168) * t125 + m(4) * (t48 ^ 2 + t49 ^ 2 + t50 ^ 2) + m(5) * (t15 ^ 2 + t16 ^ 2 + t42 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t13 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(3) * (t64 ^ 2 + t65 ^ 2) + (t128 * t148 + 0.2e1 * t49 * (mrSges(4,2) * t131 - mrSges(4,3) * t128) + (m(3) * pkin(1) ^ 2 + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(3,2) + Ifges(4,3)) * t131) * t131 + (-0.2e1 * pkin(1) * mrSges(3,2) + (Ifges(3,1) + Ifges(4,2)) * t128 + 0.2e1 * (Ifges(3,4) + Ifges(4,6)) * t131) * t128) * t124 + 0.2e1 * (-t64 * t128 + t65 * t131) * mrSges(3,3) + ((-(2 * Ifges(4,5)) + Ifges(3,6)) * t131 + (-(2 * Ifges(4,4)) + Ifges(3,5)) * t128) * t125) * t124; t145 * t41 + t146 * t40 + m(5) * (qJ(3) * t42 + t135 * t132) + t137 + (t132 * t44 - t16 * mrSges(5,3) - t26 / 0.2e1 + t6 / 0.2e1 + t7 / 0.2e1) * t127 + (-t71 + t28) * qJ(3) + m(7) * (t1 * t30 + t2 * t39 + t5 * t70) + m(4) * (-pkin(2) * t50 - qJ(3) * t48) + (-t87 / 0.2e1 + t51 / 0.2e1 + t52 / 0.2e1) * t62 + t63 * t90 / 0.2e1 + t70 * t20 - pkin(2) * t72 + t2 * t73 + t4 * t74 + t1 * t75 + t3 * t76 + t42 * t82 + t5 * t66 + t13 * t67 + t46 * t25 + t47 * t23 - t48 * mrSges(4,3) + t50 * mrSges(4,2) + t30 * t24 + t39 * t22 - t167 + t168 + (-Ifges(4,5) * t131 + t128 * (-Ifges(5,6) * t127 + t118) / 0.2e1 - Ifges(4,4) * t128) * t124 + (-t15 * mrSges(5,3) + t27 / 0.2e1 + t164 * t132 + t147 * t129 + t149 * t126) * t130 + m(6) * (-t13 * t154 + t3 * t46 + t4 * t47); -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t30 * t75 + 0.2e1 * t39 * t73 + 0.2e1 * t46 * t76 + 0.2e1 * t47 * t74 + 0.2e1 * t70 * t66 + (-t87 + t51 + t52) * t127 + m(5) * (t120 * t123 + t105 + t133) + m(4) * (pkin(2) ^ 2 + t133) + m(6) * (t46 ^ 2 + t47 ^ 2 + t105) + m(7) * (t30 ^ 2 + t39 ^ 2 + t70 ^ 2) + (t67 * t173 + t90 + (t55 + t56) * t129 + (-t53 - t54) * t126) * t130 + 0.2e1 * (t82 + mrSges(4,3)) * qJ(3) + t138 * t173 + t175; (-t20 + t164) * t130 + (t44 + (t22 + t23) * t129 + (-t24 - t25) * t126) * t127 + m(7) * (-t130 * t5 + (-t1 * t126 + t129 * t2) * t127) + m(6) * (-t13 * t130 + (-t126 * t3 + t129 * t4) * t127) + m(5) * t135 + m(4) * t50 + t72; -m(4) * pkin(2) + mrSges(4,2) + (-t66 - t67) * t130 - t138 + ((t73 + t74) * t129 + (-t75 - t76) * t126) * t127 + m(6) * (t106 + (-t126 * t46 + t129 * t47) * t127) + m(7) * (-t130 * t70 + (-t126 * t30 + t129 * t39) * t127) + m(5) * (t120 * t132 + t106); m(4) + m(5) * t150 + 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * (t151 * t120 + t122); t15 * mrSges(5,1) - t16 * mrSges(5,2) - pkin(4) * t21 + t104 * t20 - t81 * t22 + t78 * t24 + t5 * t79 + t144 * t62 + t142 * t41 + t143 * t40 + m(7) * (t1 * t78 + t104 * t5 - t2 * t81) + (t2 * mrSges(7,3) + t4 * mrSges(6,3) + (m(6) * t4 + t23) * pkin(10) - t149) * t129 + (-t1 * mrSges(7,3) - t3 * mrSges(6,3) + (-m(6) * t3 - t25) * pkin(10) + t147) * t126 + t148 + (t80 - t171) * t13; t118 + t104 * t66 + t78 * t75 + t70 * t79 - t81 * t73 - pkin(4) * t67 + m(7) * (t104 * t70 + t30 * t78 - t39 * t81) + (t166 + t171) * t154 + (-t132 * mrSges(5,2) - Ifges(5,6) + t144) * t127 + (t47 * mrSges(6,3) + t39 * mrSges(7,3) + t142 * t130 + (m(6) * t47 + t74) * pkin(10) + t146) * t129 + (-t46 * mrSges(6,3) - t30 * mrSges(7,3) - t143 * t130 + (-m(6) * t46 - t76) * pkin(10) + t145) * t126; (-t79 + t166) * t130 + (t151 * mrSges(7,3) - mrSges(5,2) + t139) * t127 + m(6) * (t151 * t127 * pkin(10) + pkin(4) * t130) + m(7) * (-t104 * t130 + (-t126 * t78 - t129 * t81) * t127); -0.2e1 * pkin(4) * t80 + 0.2e1 * t104 * t79 + Ifges(5,3) + 0.2e1 * pkin(10) * t139 + m(6) * (t151 * pkin(10) ^ 2 + pkin(4) ^ 2) + m(7) * (t104 ^ 2 + t78 ^ 2 + t81 ^ 2) + (t81 * t174 + t85 + t86) * t129 + (t78 * t174 + t88 + t89) * t126; mrSges(6,1) * t3 + mrSges(7,1) * t1 - mrSges(6,2) * t4 - mrSges(7,2) * t2 + (m(7) * t1 + t24) * pkin(5) + t172; mrSges(6,1) * t46 + mrSges(7,1) * t30 - mrSges(6,2) * t47 - mrSges(7,2) * t39 + (-Ifges(6,6) - Ifges(7,6)) * t157 + (m(7) * t30 + t75) * pkin(5) + t152 + t153; ((-mrSges(6,2) - mrSges(7,2)) * t129 + (-mrSges(6,1) - mrSges(7,1) - t170) * t126) * t127; mrSges(7,1) * t78 + mrSges(7,2) * t81 - t136 * pkin(10) + (m(7) * t78 - t126 * mrSges(7,3)) * pkin(5) + t84 + t83; Ifges(6,3) + Ifges(7,3) + (0.2e1 * mrSges(7,1) + t170) * pkin(5); m(7) * t5 + t20; m(7) * t70 + t66; -m(7) * t130; m(7) * t104 + t79; 0; m(7);];
