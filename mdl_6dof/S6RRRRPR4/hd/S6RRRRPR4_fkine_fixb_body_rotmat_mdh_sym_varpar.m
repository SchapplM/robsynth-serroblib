...
function Tc_mdh = S6RRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [11x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:38:19
	% EndTime: 2020-11-04 22:38:19
...
elseif link_index == 5
	...
	t88 = cos(t90);
	t91 = -qJ(5) - pkin(9);
	t96 = t83 * t88 - t87 * t91 + cos(qJ(2)) * pkin(2) + pkin(1);
	t1 = [t88 * t98 + t101, -t88 * t99 + t100, t94 * t87, t97 * t93 + t96 * t94 + 0; t88 * t100 - t99, -t88 * t101 - t98, t93 * t87, t96 * t93 - t97 * t94 + 0; t87 * t86, -t87 * t85, -t88, t87 * t83 + t88 * t91 + sin(qJ(2)) * pkin(2) + pkin(6) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 6
