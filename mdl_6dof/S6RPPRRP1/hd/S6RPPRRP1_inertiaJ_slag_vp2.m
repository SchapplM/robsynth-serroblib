...
t10 = [Ifges(4,2) * t59 + 0.2e1 * t50 * t73 + t30 * t105 + 0.2e1 * t5 * t18 + t19 * t106 + 0.2e1 * t2 * t20 + 0.2e1 * t4 * t21 + 0.2e1 * t1 * t22 + 0.2e1 * t3 * t23 + Ifges(2,3) + Ifges(3,3) + (Ifges(4,1) * t62 + 0.2e1 * Ifges(4,4) * t64) * t62 + (mrSges(5,1) * t105 - 0.2e1 * t17 * mrSges(5,3) + Ifges(5,2) * t34 + t72) * t34 + (mrSges(5,3) * t106 + Ifges(5,1) * t36 - 0.2e1 * Ifges(5,4) * t34 + (t8 + t9) * t68 + (-t113 * t34 - t6 - t7) * t66) * t36 + m(5) * (t17 ^ 2 + t37 ^ 2 + t108) + m(4) * (t80 * t48 ^ 2 + t50 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t108) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(3) * (t63 ^ 2 + t65 ^ 2) * pkin(1) ^ 2 + 0.2e1 * (t65 * mrSges(3,1) - t63 * mrSges(3,2)) * pkin(1) + 0.2e1 * t80 * t48 * mrSges(4,3); (t18 + t19) * t34 + (-t84 * t66 + t85 * t68) * t36 + m(7) * (t5 * t34 + (-t1 * t66 + t2 * t68) * t36) + m(6) * (t93 + (-t3 * t66 + t4 * t68) * t36) + m(5) * (t17 * t36 + t93); m(3) + m(5) * (t33 + t107) + m(4) * t80 + (t79 * t33 + t107) * t110; t34 * mrSges(5,1) + t30 + t84 * t68 + t85 * t66 + m(7) * (t68 * t1 + t66 * t2) + m(6) * (t68 * t3 + t66 * t4) + m(5) * t37 + m(4) * t50 + t73; 0; t110 * t79 + m(4) + m(5); m(7) * (t38 * t1 - t41 * t2 + t51 * t5) + t51 * t18 + t38 * t22 + t5 * t39 - t41 * t20 - t17 * mrSges(5,2) - pkin(4) * t19 + (-m(6) * pkin(4) + t83) * t15 + (t2 * mrSges(7,3) + t4 * mrSges(6,3) + t6 / 0.2e1 + t7 / 0.2e1 + (m(6) * t4 + t21) * pkin(8)) * t68 + (-t3 * mrSges(6,3) - t1 * mrSges(7,3) + t8 / 0.2e1 + t9 / 0.2e1 + (-m(6) * t3 - t23) * pkin(8)) * t66 + (Ifges(5,5) + (t44 / 0.2e1 + t45 / 0.2e1) * t68 + (-t42 / 0.2e1 - t43 / 0.2e1) * t66) * t36 + (-Ifges(5,6) + t109 / 0.2e1) * t34; -t30 + (t39 + t83) * t34 + (t79 * mrSges(7,3) + t74) * t36 + m(7) * (t51 * t34 + (-t38 * t66 - t41 * t68) * t36) + m(6) * (t79 * t101 - t102); m(7) * (t38 * t68 - t41 * t66); -0.2e1 * pkin(4) * t40 + 0.2e1 * t51 * t39 + Ifges(5,3) + 0.2e1 * pkin(8) * t74 + m(7) * (t38 ^ 2 + t41 ^ 2 + t51 ^ 2) + m(6) * (t79 * pkin(8) ^ 2 + pkin(4) ^ 2) + (t111 * t41 + t42 + t43) * t68 + (t111 * t38 + t44 + t45) * t66; t3 * mrSges(6,1) + t1 * mrSges(7,1) - t4 * mrSges(6,2) - t2 * mrSges(7,2) - t113 * t92 + (m(7) * t1 + t22) * pkin(5) + t72; (t76 * t66 - t98) * t36 - t18; -t90 - t53 + (mrSges(7,1) - t76) * t68; t38 * mrSges(7,1) + t41 * mrSges(7,2) - t71 * pkin(8) + (m(7) * t38 - t89) * pkin(5) + t109; (0.2e1 * mrSges(7,1) + t104) * pkin(5) + t112; m(7) * t5 + t18; m(7) * t34; 0; m(7) * t51 + t39; 0; m(7);];
