% Umwandlung der Kinematikparameter von S6RRRPRP4V1 zu S6RRRPRP4
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S6RRRPRP4_structural_kinematic_parameters.m
function pkin_gen = S6RRRPRP4V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
