...
function Phi_dq = S6RRRPRP5_constr2grad(q, xE, pkin, T_N_E, phiconv_W_E, I_EElink, reci)
...
%% Translatorisch
% Bein-Jacobi
J0_i_trans = S6RRRPRP5_jacobia_transl_sym_varpar(q, I_EElink, T_N_E(1:3,4), pkin);
...
Tc_ges = S6RRRPRP5_fkine_fixb_rotmat_mdh_sym_varpar(q, pkin);
...
dRb_0N_dq = S6RRRPRP5_jacobiR_rot_sym_varpar(q, I_EElink, pkin);
