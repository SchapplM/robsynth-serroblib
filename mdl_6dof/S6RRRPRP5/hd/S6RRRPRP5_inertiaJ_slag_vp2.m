...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:43:34
% EndTime: 2018-11-23 17:43:35
...
t1 = [0.2e1 * t100 * t50 + 0.2e1 * t7 * t13 + 0.2e1 * t62 * t14 + 0.2e1 * t2 * t33 + 0.2e1 * t3 * t36 + 0.2e1 * t31 * t71 + 0.2e1 * t32 * t70 + 0.2e1 * t6 * t34 + 0.2e1 * t5 * t35 - t82 * t44 + t83 * t45 + 0.2e1 * t73 * t99 + 0.2e1 * t74 * t98 + Ifges(2,3) + (t10 + t11) * t48 + (t8 - t9) * t47 + (t118 + t120) * mrSges(3,3) * t155 + (-0.2e1 * pkin(1) * mrSges(3,2) + Ifges(3,1) * t125 - t124 * t79 + t126 * t80 + t91 * t155) * t125 + m(3) * (pkin(1) ^ 2 + t120 * t129 + t115) + m(4) * (t73 ^ 2 + t74 ^ 2 + t115) + m(5) * (t100 ^ 2 + t31 ^ 2 + t32 ^ 2) + m(6) * (t5 ^ 2 + t6 ^ 2 + t62 ^ 2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t7 ^ 2) + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(3,2) + t136) * t127 + (Ifges(4,6) * t124 + (2 * Ifges(3,4))) * t125 + t135 + t154) * t127; (t79 / 0.2e1 + pkin(8) * t98 + t74 * mrSges(4,3)) * t126 + (t80 / 0.2e1 - pkin(8) * t99 - t73 * mrSges(4,3)) * t124 + (t34 + t33) * t23 + (-t35 + t36) * t21 + t100 * t64 + t111 * t50 - pkin(2) * t91 + t92 * t44 / 0.2e1 + t93 * t45 / 0.2e1 - t82 * t65 / 0.2e1 + t83 * t66 / 0.2e1 + (-t114 / 0.2e1 - t113 / 0.2e1 - t90 / 0.2e1 - t89 / 0.2e1 - t57 / 0.2e1 + t56 / 0.2e1 - t58 / 0.2e1 - t55 / 0.2e1 + Ifges(3,6) - pkin(7) * mrSges(3,2)) * t127 + t69 * t70 + t68 * t71 + t75 * t14 + t62 * t26 + t7 * t25 + t18 * t13 + m(5) * (t100 * t111 + t31 * t68 + t32 * t69) + m(6) * (-t21 * t5 + t23 * t6 + t62 * t75) + m(7) * (t18 * t7 + t2 * t23 + t21 * t3) + m(4) * (-pkin(2) * t116 + (-t73 * t124 + t74 * t126) * pkin(8)) + (Ifges(3,5) - t124 * t103 / 0.2e1 + t126 * t104 / 0.2e1 + (t102 - mrSges(3,1)) * pkin(7)) * t125 + (t3 * mrSges(7,2) - t5 * mrSges(6,3) + t10 / 0.2e1 + t11 / 0.2e1) * t60 + (-t2 * mrSges(7,2) - t6 * mrSges(6,3) + t8 / 0.2e1 - t9 / 0.2e1) * t59 + (t29 / 0.2e1 + t30 / 0.2e1) * t48 + (t27 / 0.2e1 - t28 / 0.2e1) * t47 + (-t31 * t93 + t32 * t92) * mrSges(5,3); -0.2e1 * pkin(2) * t102 + t126 * t103 + t124 * t104 + 0.2e1 * t111 * t64 + 0.2e1 * t18 * t25 + 0.2e1 * t75 * t26 + t92 * t65 + t93 * t66 + Ifges(3,3) + (t29 + t30) * t60 + (t27 - t28) * t59 + m(4) * (pkin(8) ^ 2 * t140 + pkin(2) ^ 2) + m(5) * (t111 ^ 2 + t68 ^ 2 + t69 ^ 2) + m(6) * (t75 ^ 2 + t139) + m(7) * (t18 ^ 2 + t139) + 0.2e1 * (-t68 * t93 + t69 * t92) * mrSges(5,3) + 0.2e1 * t140 * pkin(8) * mrSges(4,3) + 0.2e1 * (t21 * t60 - t23 * t59) * (mrSges(7,2) + mrSges(6,3)); t81 * t33 + t84 * t36 + t85 * t35 + t86 * t34 - Ifges(4,6) * t142 + t133 + (t121 * t70 + m(5) * (t121 * t32 + t122 * t31) + t122 * t71) * pkin(3) + t73 * mrSges(4,1) - t74 * mrSges(4,2) + t31 * mrSges(5,1) - t32 * mrSges(5,2) - t136 * t127 + m(7) * (t2 * t81 + t3 * t84) + m(6) * (t5 * t85 + t6 * t86) - t154; m(7) * (t21 * t84 + t23 * t81) + m(6) * (-t21 * t85 + t23 * t86) - t134 * pkin(8) + (-t59 * t86 - t60 * t85) * mrSges(6,3) + (-t59 * t81 + t60 * t84) * mrSges(7,2) + t113 + t114 + t89 + t90 + t132 + (m(5) * (t121 * t69 + t122 * t68) + (t121 * t92 - t122 * t93) * mrSges(5,3)) * pkin(3) + t68 * mrSges(5,1) - t69 * mrSges(5,2); 0.2e1 * t149 - 0.2e1 * t84 * mrSges(7,1) - 0.2e1 * t148 + t81 * t153 + m(6) * (t85 ^ 2 + t86 ^ 2) + m(7) * (t81 ^ 2 + t84 ^ 2) + t136 + (0.2e1 * mrSges(5,1) * t122 - 0.2e1 * mrSges(5,2) * t121 + m(5) * (t121 ^ 2 + t122 ^ 2) * pkin(3)) * pkin(3); m(5) * t100 + m(6) * t62 + m(7) * t7 + t13 + t14 + t50; m(5) * t111 + m(6) * t75 + m(7) * t18 + t25 + t26 + t64; 0; m(5) + m(6) + m(7); -pkin(5) * t36 + m(7) * (-pkin(5) * t3 + qJ(6) * t2) + qJ(6) * t33 - t146 * t127 + t133; m(7) * (-pkin(5) * t21 + qJ(6) * t23) + (-pkin(5) * t60 - qJ(6) * t59) * mrSges(7,2) + t132; t149 - t148 + m(7) * (-pkin(5) * t84 + qJ(6) * t81) + (t81 + qJ(6)) * mrSges(7,3) + (-t84 + pkin(5)) * mrSges(7,1) + t146; 0; 0.2e1 * pkin(5) * mrSges(7,1) + qJ(6) * t153 + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t146; m(7) * t3 + t36; m(7) * t21 + t60 * mrSges(7,2); m(7) * t84 - mrSges(7,1); 0; -m(7) * pkin(5) - mrSges(7,1); m(7);];
