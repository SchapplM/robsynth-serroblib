...
% OptimizationMode: 2
% StartTime: 2019-03-09 05:48:11
% EndTime: 2019-03-09 05:48:14
...
t7 = -pkin(4) * t59 - t8;
t4 = -pkin(5) * t46 - t6;
t21 = [t74 * t147 + (-0.2e1 * Ifges(4,4) * t60 + Ifges(4,2) * t59 - Ifges(4,6) * t74 + t136) * t59 + t60 * (Ifges(4,1) * t60 + Ifges(4,5) * t74) + m(3) * (pkin(1) ^ 2 * t121 ^ 2 + t76 ^ 2 + t77 ^ 2) + m(4) * (t29 ^ 2 + t30 ^ 2 + t40 ^ 2) + m(6) * (t13 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(5) * (t25 ^ 2 + t8 ^ 2 + t9 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t4 ^ 2) + (t10 + t20 - t18) * t47 + (t17 - t19) * t46 + (-0.2e1 * mrSges(3,2) * t77 + Ifges(3,3) * t124 + t76 * t179) * t124 + (-0.2e1 * pkin(1) * t102 + (-0.2e1 * mrSges(3,3) * t76 + Ifges(3,1) * t157 + Ifges(3,5) * t178) * t119 + (0.2e1 * t77 * mrSges(3,3) + Ifges(3,6) * t178 + (0.2e1 * Ifges(3,4) * t119 + Ifges(3,2) * t122 + pkin(1) * t179) * t121) * t122) * t121 + 0.2e1 * t4 * t14 + 0.2e1 * t2 * t15 + 0.2e1 * t1 * t16 + Ifges(2,3) + 0.2e1 * t25 * t27 + 0.2e1 * t13 * t28 + t33 * t11 + t34 * t12 + 0.2e1 * t6 * t35 + 0.2e1 * t7 * t36 + 0.2e1 * t9 * t37 + 0.2e1 * t8 * t38 + 0.2e1 * t40 * t39 + 0.2e1 * t30 * t48 + 0.2e1 * t29 * t49; t123 * t39 + t66 * t15 + t65 * t16 + t102 + t165 * t78 + (-m(3) * pkin(1) - mrSges(3,1) * t122) * t121 + (t14 + t166) * t80 + (t127 * t48 + (-t27 - t28 + t49) * t130) * t120 + m(7) * (t1 * t65 + t2 * t66 + t4 * t80) + m(6) * (-t13 * t155 - t6 * t80 + t7 * t78) + m(5) * (-t25 * t155 - t78 * t8 + t80 * t9) + m(4) * (t123 * t40 + (t127 * t30 + t130 * t29) * t120); m(3) + m(7) * (t65 ^ 2 + t66 ^ 2 + t75) + m(4) * (t113 * t127 ^ 2 + t123 ^ 2 + t105) + (m(6) + m(5)) * (t78 ^ 2 + t105 + t75); m(7) * (t1 * t62 + t100 * t4 + t2 * t63) + (t70 / 0.2e1 - t92 / 0.2e1 + t97 / 0.2e1) * t47 + (t91 / 0.2e1 - t95 / 0.2e1) * t46 + t147 + (-t8 * mrSges(5,3) + t7 * mrSges(6,1) + t10 / 0.2e1 - t18 / 0.2e1 + t20 / 0.2e1 - t170 / 0.2e1 + t165 * pkin(10)) * t126 - pkin(3) * t27 + t29 * mrSges(4,1) - t30 * mrSges(4,2) + (t11 * t171 + t12 * t172 + t9 * mrSges(5,3) - t6 * mrSges(6,1) - t17 / 0.2e1 + t19 / 0.2e1 - t169 / 0.2e1 + t166 * pkin(10)) * t129 + t62 * t16 + t63 * t15 + t71 * t177 + t34 * t176 + t4 * t82 + t1 * t85 + t2 * t86 + t87 * t28 + t13 * t88 + t25 * t89 + t100 * t14 + t59 * t151 / 0.2e1 + m(5) * (-pkin(3) * t25 + (-t126 * t8 + t129 * t9) * pkin(10)) + m(6) * (t13 * t87 + (t126 * t7 - t129 * t6) * pkin(10)); t65 * t85 + t66 * t86 + t167 * t158 + (t167 * t129 + t82) * t80 + (-t127 * mrSges(4,2) + (mrSges(4,1) - t88 - t89) * t130) * t120 + m(6) * (-t87 * t155 + t135) + m(7) * (t100 * t80 + t62 * t65 + t63 * t66) + m(5) * (pkin(3) * t155 + t135); -0.2e1 * pkin(3) * t89 + 0.2e1 * t100 * t82 + 0.2e1 * t62 * t85 + 0.2e1 * t63 * t86 + 0.2e1 * t87 * t88 + Ifges(4,3) + (t70 + t97 - t92) * t126 + m(7) * (t100 ^ 2 + t62 ^ 2 + t63 ^ 2) + m(6) * (t87 ^ 2 + t150) + m(5) * (pkin(3) ^ 2 + t150) + (-t125 * t72 - t128 * t71 - t91 + t95) * t129 + 0.2e1 * t167 * pkin(10) * t182; (-t1 * mrSges(7,3) - t174 * t16 + t12 / 0.2e1) * t128 + (-t2 * mrSges(7,3) - t174 * t15 - t11 / 0.2e1) * t125 + (t14 - t35) * qJ(5) + m(6) * (-pkin(4) * t7 - qJ(5) * t6) + t136 - t6 * mrSges(6,3) + t7 * mrSges(6,2) + t8 * mrSges(5,1) - t9 * mrSges(5,2) - pkin(4) * t36 + t4 * t90 + t47 * t175 + t94 * t177 + t34 * t96 / 0.2e1 + m(7) * (qJ(5) * t4 - t141 * t174); (-mrSges(5,1) + mrSges(6,2)) * t78 - t137 * mrSges(7,3) + (-mrSges(5,2) + t164) * t80 + m(6) * (-pkin(4) * t78 + t160) + m(7) * (-t137 * t174 + t160); -t85 * t152 - t174 * t159 + qJ(5) * t82 + m(7) * (qJ(5) * t100 - t138 * t174) + t71 * t172 + t100 * t90 + t128 * t176 - t138 * mrSges(7,3) + (-pkin(4) * mrSges(6,1) - Ifges(6,4) + t175) * t126 + (qJ(5) * mrSges(6,1) + t94 * t171 + t96 * t172 - Ifges(6,5)) * t129 + ((m(6) * qJ(5) - mrSges(5,2) + mrSges(6,3)) * t129 + (-mrSges(5,1) + t180) * t126) * pkin(10) + t151; -0.2e1 * pkin(4) * mrSges(6,2) - t125 * t94 + t128 * t96 + m(7) * (t149 * t174 ^ 2 + t132) + m(6) * (pkin(4) ^ 2 + t132) + 0.2e1 * t164 * qJ(5) + 0.2e1 * t174 * t143 + t183; m(6) * t7 + m(7) * t141 + t125 * t15 + t128 * t16 + t36; m(6) * t78 + m(7) * t137; t128 * t85 + m(7) * t138 + t159 + (m(6) * pkin(10) + mrSges(6,1)) * t126; -t145 * t174 - t143 + t180; m(6) + t145; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t10; mrSges(7,1) * t65 - mrSges(7,2) * t66; mrSges(7,1) * t62 - mrSges(7,2) * t63 + t70; -mrSges(7,1) * t152 + t109 + (mrSges(7,2) * t174 - Ifges(7,6)) * t125; t140; Ifges(7,3);];
