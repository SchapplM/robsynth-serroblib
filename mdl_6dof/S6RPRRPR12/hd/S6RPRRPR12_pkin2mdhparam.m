...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S6RPRRPR12_pkin2mdhparam(pkin)
...
t1 = [0; pkin(12); 0; 0; pi / 0.2e1; 0;];
theta_mdh = t1;

% Aus parameters_mdh_d_matlab.m
t1 = [pkin(8); 0; pkin(9); pkin(10); 0; pkin(11);];
d_mdh = t1;
