...
function [v_mdh, sigma_mdh, mu_mdh, NL, NKP, NQJ, pkin_names] = S6RPRRPR12_structural_kinematic_parameters()
...
pkin_names = {'a2', 'a3', 'a4', 'a5', 'a6', 'alpha2', 'alpha3', 'd1', 'd3', 'd4', 'd6', 'theta2'};
