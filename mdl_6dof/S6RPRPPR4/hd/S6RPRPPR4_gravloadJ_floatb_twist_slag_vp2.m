...
t43 = t24 * t29 + t26 * t31;
t44 = t24 * t31 - t26 * t29;
t88 = t43 * mrSges(7,1) + t44 * mrSges(7,2) - t24 * t81 + t26 * t91;
t27 = cos(pkin(9));
...
t2 = t29 * t7 + t31 * t8;
t1 = -t29 * t8 + t31 * t7;
t3 = [(-m(4) * t53 - m(5) * t42 - t2 * mrSges(7,1) - t1 * mrSges(7,2) - t82 * (pkin(4) * t8 + qJ(5) * t7 + t42) - t74 * t8 + t81 * t7 + t79 * t30 + (t21 * t89 - t48 + t85) * t32) * g(2) + (m(5) * t63 - t49 * mrSges(7,1) - t50 * mrSges(7,2) - t82 * (-pkin(4) * t6 - t5 * qJ(5) - t63) + t74 * t6 - t81 * t5 + (m(4) * t28 + t79) * t32 + (m(4) * t20 - m(7) * t55 - (m(7) * (pkin(8) - qJ(4)) + mrSges(7,3)) * t21 + (-m(5) - m(6)) * (t55 - t16) - t77 - t85) * t30) * g(1) (-g(1) * t30 + g(2) * t32) * (m(3) + m(4) + t56) (-m(5) * t59 - m(6) * t52 - m(7) * (-pkin(8) * t21 + t52) + t21 * mrSges(7,3) + (-m(7) * t71 - t88) * t22 + t77) * g(3) + ((mrSges(4,1) - m(7) * (t41 - t71) - m(6) * t41 + m(5) * pkin(3) + t88) * t21 + (-qJ(4) * t56 + mrSges(4,2) + t89) * t22) * t80 (t22 * g(3) - t21 * t80) * t56, t82 * (-g(1) * t7 - g(2) * t5 - t24 * t68) -g(1) * (mrSges(7,1) * t1 - mrSges(7,2) * t2) - g(2) * (-mrSges(7,1) * t50 + mrSges(7,2) * t49) - (mrSges(7,1) * t44 - mrSges(7,2) * t43) * t68];
taug  = t3(:);
