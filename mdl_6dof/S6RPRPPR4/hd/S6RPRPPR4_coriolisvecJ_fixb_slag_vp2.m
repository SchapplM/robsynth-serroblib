...
t312 = -Ifges(5,4) + Ifges(6,5);
t311 = Ifges(6,4) + Ifges(5,5);
t191 = sin(pkin(10));
t264 = -pkin(8) + qJ(4);
t181 = t264 * t191;
t183 = t264 * t193;
...
t247 = qJ(5) * t193;
t307 = t231 - t247;
t306 = Ifges(4,2) + Ifges(5,3) + Ifges(6,2);
...
t257 = Ifges(6,5) * t193;
t214 = Ifges(6,3) * t191 + t257;
t261 = Ifges(5,4) * t193;
t215 = -Ifges(5,2) * t191 + t261;
...
t292 = -t137 * t232 - t179 * mrSges(4,1) - t53 * mrSges(5,1) + t43 * mrSges(6,1) + t5 * mrSges(7,1) + t54 * mrSges(5,2) - t6 * mrSges(7,2) + t129 * mrSges(4,3) - t44 * mrSges(6,3) + t164 * Ifges(4,4) + t305 * Ifges(7,5) + Ifges(4,6) * qJD(3) + Ifges(5,6) * t280 + Ifges(6,6) * t281 + t83 * Ifges(7,6) + t160 * Ifges(7,3) - t306 * t163 / 0.2e1 + (-t233 - t311 / 0.2e1) * t209;
...
t291 = t179 * mrSges(4,2) + (-t44 * t191 + t43 * t193) * mrSges(6,2) + (-t54 * t191 - t53 * t193) * mrSges(5,3) - Ifges(4,4) * t163 + Ifges(4,5) * qJD(3) + t300 - t128 * mrSges(4,3) + (Ifges(6,5) * t209 + Ifges(6,6) * t163 + t137 * Ifges(6,3)) * t272 + (Ifges(5,4) * t209 - t137 * Ifges(5,2) + Ifges(5,6) * t163) * t273 + (t137 * t312 + t163 * t311 + t209 * t313) * t271 + t214 * t280 + t215 * t281 + t52 * (mrSges(6,1) * t191 - mrSges(6,3) * t193) + t308 * t209 / 0.2e1 - t208 * (mrSges(5,1) * t191 + mrSges(5,2) * t193);
...
t117 = t175 * t176;
t21 = -pkin(4) * t153 - t32;
t202 = t92 * mrSges(5,2) + t21 * mrSges(6,2) - t32 * mrSges(5,3) - t30 * mrSges(6,3) + t233 * t153 + t303 * t311 + t304 * t308;
...
t7 = [m(7) * (t1 * t12 + t11 * t2 - t20 * t59 + t3 * t6 + t31 * t37 + t4 * t5) + m(6) * (t16 * t57 + t21 * t58 + t25 * t44 + t30 * t78 + t34 * t43 + t45 * t52) + m(5) * (-t103 * t208 + t32 * t71 + t33 * t72 + t46 * t53 + t47 * t54 - t254) + m(4) * (t102 * t129 - t103 * t128 + t135 * t91 - t254) + (-t135 * t153 - t152 * t297) * mrSges(4,3) - t297 * t98 + (t300 + (t255 + t260 - t256 + t259) * t163 / 0.2e1 + t291) * t167 + t230 * t225 - (-t91 * mrSges(4,3) + t32 * mrSges(5,1) - t21 * mrSges(6,1) - t33 * mrSges(5,2) + t16 * mrSges(6,3) + t150 / 0.2e1 + (Ifges(7,3) / 0.2e1 + t306) * t153 + (-Ifges(4,4) + t311 * t193 + (-Ifges(5,6) + Ifges(6,6)) * t191) * t152 + t295) * t206 + (t92 * mrSges(4,3) + Ifges(4,1) * t152 - Ifges(4,4) * t153 + ((Ifges(5,1) / 0.2e1 + Ifges(6,1) / 0.2e1) * t245 + t202) * t193 + (((Ifges(5,2) / 0.2e1 + Ifges(6,3) / 0.2e1) * t191 + t312 * t193) * t152 + t293) * t191) * t176 - t250 * t103 + (t163 * t223 - t292) * t168 + (t1 * t117 - t118 * t2 - t5 * t55 + t56 * t6) * mrSges(7,3) + t102 * t146 + t57 * t113 - t20 * (-mrSges(7,1) * t117 + mrSges(7,2) * t118) + t25 * t104 + t47 * t105 + t46 * t106 + t34 * t107 + t72 * t110 + t71 * t111 + t58 * t112 + t78 * t97 + t45 * t89 + t3 * t60 + t4 * t61 + t55 * t24 / 0.2e1 + t37 * (-mrSges(7,1) * t56 + mrSges(7,2) * t55) + t56 * t23 / 0.2e1 + t59 * t13 + t31 * t35 + t11 * t27 + t12 * t28 + 0.2e1 * t294 * t234 + (Ifges(7,5) * t55 + Ifges(7,6) * t56) * t275 + (Ifges(7,5) * t118 + Ifges(7,6) * t117) * t278 + (Ifges(7,1) * t55 + Ifges(7,4) * t56) * t283 + (Ifges(7,4) * t55 + Ifges(7,2) * t56) * t285 + (Ifges(7,4) * t118 + Ifges(7,2) * t117) * t287 + (Ifges(7,1) * t118 + Ifges(7,4) * t117) * t288 + t118 * t289 + t117 * t290; -t210 * t27 + t175 * t28 + t236 * t61 + t237 * t60 + t239 * t193 + t240 * t191 + (t250 + t263) * t164 + (-t241 * t191 + t242 * t193 + t146) * t163 - m(4) * (-t128 * t164 - t129 * t163) + t225 - t294 * qJD(1) ^ 2 + (t1 * t175 + t164 * t37 - t2 * t210 + t236 * t5 + t237 * t6) * m(7) + (t16 * t191 - t193 * t21 - t164 * t52 - (-t191 * t43 - t193 * t44) * t163) * m(6) + (-t163 * t212 + t164 * t208 + t191 * t33 + t193 * t32) * m(5); (t208 * t129 - t53 * t62 - t54 * t63 - pkin(3) * t92 - t212 * qJD(4) + (-t191 * t32 + t193 * t33) * qJ(4)) * m(5) + (-t1 * t210 - t175 * t2 + t236 * t6 - t237 * t5) * mrSges(7,3) - t20 * (mrSges(7,1) * t210 + mrSges(7,2) * t175) + (Ifges(7,5) * t175 - Ifges(7,6) * t210) * t278 + (Ifges(7,4) * t175 - Ifges(7,2) * t210) * t287 + (Ifges(7,1) * t175 - Ifges(7,4) * t210) * t288 - t210 * t290 + (-qJ(4) * t239 - qJD(4) * t241 + qJD(5) * t263 + t202) * t191 + (-mrSges(7,1) * t236 + mrSges(7,2) * t237) * t37 + t309 * t61 + (t1 * t134 + t132 * t2 - t169 * t20 + t310 * t6 + t309 * t5 + (qJD(5) * t191 - t50) * t37) * m(7) + t310 * t60 + (Ifges(4,5) + (-Ifges(6,3) * t193 + t258) * t272 + (Ifges(5,2) * t193 + t262) * t273 + (t191 * t313 - t257 + t261) * t271) * t152 + t250 * t129 + t292 * t164 + (-t165 / 0.2e1 + t109 / 0.2e1) * t24 + (-Ifges(7,5) * t165 - Ifges(7,6) * t166) * t275 + (-Ifges(7,1) * t165 - Ifges(7,4) * t166) * t283 + (-Ifges(7,4) * t165 - Ifges(7,2) * t166) * t285 + (-t166 / 0.2e1 + t108 / 0.2e1) * t23 + (-Ifges(7,5) * t109 - Ifges(7,6) * t108) * t276 + (-Ifges(7,1) * t109 - Ifges(7,4) * t108) * t284 + (-Ifges(7,4) * t109 - Ifges(7,2) * t108) * t286 + ((t259 / 0.2e1 - t256 / 0.2e1 + t260 / 0.2e1 + t255 / 0.2e1) * t163 + (t314 - t223) * t164 + t291) * t163 + (-t43 * t51 - t44 * t49 - t52 * t64 + t180 * t30 + (qJ(4) * t16 + qJD(4) * t44) * t193 + (qJ(4) * t21 + qJD(4) * t43 - qJD(5) * t52) * t191) * m(6) + (qJ(4) * t240 + qJD(4) * t242 - t293) * t193 + t180 * t97 + t169 * t13 - Ifges(4,6) * t153 - t128 * t146 + t132 * t27 + t134 * t28 - t49 * t104 - t63 * t105 - t62 * t106 - t51 * t107 - pkin(3) * t98 - t64 * t89 - t91 * mrSges(4,2) - t92 * mrSges(4,1) - t50 * t35 + t175 * t289; t241 * t209 + t242 * t137 + t83 * t60 - t305 * t61 - t13 + t97 + t98 + (-t305 * t5 + t6 * t83 + t20) * m(7) + (t137 * t44 - t209 * t43 + t30) * m(6) + (t137 * t54 + t209 * t53 + t92) * m(5); t195 * t28 + t197 * t27 - t263 * t209 + t211 * qJD(6) + (-t104 - t211) * t163 + t112 + (t1 * t195 - t209 * t37 + t197 * t2 + t160 * (-t195 * t5 + t197 * t6)) * m(7) + (-t163 * t44 + t209 * t52 + t21) * m(6); -t150 - t37 * (mrSges(7,1) * t305 + mrSges(7,2) * t83) + (Ifges(7,1) * t83 - t269) * t284 + t23 * t283 + (Ifges(7,5) * t83 - Ifges(7,6) * t305) * t276 - t5 * t60 + t6 * t61 + (t305 * t6 + t5 * t83) * mrSges(7,3) + (-Ifges(7,2) * t305 + t24 + t82) * t286 - t295;];
tauc  = t7(:);
