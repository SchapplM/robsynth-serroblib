...
% Computational Cost: add. (1779->282), mult. (3513->405), div. (0->0), fcn. (3588->10), ass. (0->111)
t101 = sin(qJ(3));
t100 = sin(qJ(4));
t103 = cos(qJ(4));
t95 = sin(pkin(11));
...
t119 = Ifges(5,4) * t100;
t118 = Ifges(5,4) * t103;
t114 = -Ifges(7,3) - Ifges(6,3) - Ifges(5,3);
