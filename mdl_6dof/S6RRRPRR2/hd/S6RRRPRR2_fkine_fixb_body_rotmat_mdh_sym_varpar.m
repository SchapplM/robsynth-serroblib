...
function Tc_mdh = S6RRRPRR2_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRPRR2_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6RRRPRR2_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRRPRR2_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [11x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 22:30:20
	% EndTime: 2020-11-04 22:30:20
...
elseif link_index == 6
	...
	t110 = t106 * t100;
	t103 = qJ(2) + qJ(3);
	t109 = pkin(5) * sin(qJ(5)) + pkin(7) + pkin(8) + qJ(4);
	t107 = -pkin(10) - pkin(9);
	t98 = pkin(11) + t103;
	t95 = sin(t98);
	t96 = cos(t98);
	...
	t1 = [t96 * t110 + t113, -t96 * t112 + t111, t106 * t95, t109 * t105 + t108 * t106 + 0; t96 * t111 - t112, -t96 * t113 - t110, t105 * t95, t108 * t105 - t109 * t106 + 0; t95 * t100, -t95 * t99, -t96, t95 * t97 + t96 * t107 + pkin(3) * sin(t103) + sin(qJ(2)) * pkin(2) + pkin(6) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
end