...
t138 = mrSges(6,1) * t117 + mrSges(6,2) * t121;
t137 = t151 - t153;
...
t1 = [-0.2e1 * pkin(1) * (-mrSges(3,1) * t123 + mrSges(3,2) * t119) + t119 * (Ifges(3,1) * t119 + Ifges(3,4) * t123) + t123 * (Ifges(3,4) * t119 + Ifges(3,2) * t123) + 0.2e1 * t106 * (-mrSges(4,1) * t90 + mrSges(4,2) * t92) + t92 * (Ifges(4,1) * t92 + Ifges(4,4) * t90) + t90 * (Ifges(4,4) * t92 + Ifges(4,2) * t90) + (mrSges(5,1) * t167 - 0.2e1 * t33 * mrSges(5,3) + Ifges(5,2) * t61 + t144 + t172) * t61 + 0.2e1 * t146 * pkin(7) * mrSges(3,3) + 0.2e1 * (-t69 * t92 + t70 * t90) * mrSges(4,3) - t36 * t9 + t37 * t10 + 0.2e1 * t13 * t39 + 0.2e1 * t12 * t40 + 0.2e1 * t4 * t17 + 0.2e1 * t3 * t18 + 0.2e1 * t16 * t14 + m(4) * (t106 ^ 2 + t69 ^ 2 + t70 ^ 2) + m(7) * (t16 ^ 2 + t3 ^ 2 + t4 ^ 2) + (mrSges(5,3) * t169 + Ifges(5,1) * t62 - 0.2e1 * Ifges(5,4) * t61 + t121 * t22 + (-t21 - t163) * t117) * t62 + m(5) * (t33 ^ 2 + t72 ^ 2 + t170) + m(6) * (t12 ^ 2 + t13 ^ 2 + t170) + m(3) * (pkin(7) ^ 2 * t146 + pkin(1) ^ 2) + Ifges(2,3) + t56 * t167 + t38 * t169; t39 * t149 + Ifges(3,6) * t123 + Ifges(3,5) * t119 + t71 * t14 + t74 * t38 + m(6) * (t137 * t75 + t31 * t74) + (-t12 * mrSges(6,3) - t75 * t40) * t117 + m(5) * (-t31 * t77 + t33 * t78) + m(7) * (t16 * t71 + t3 * t43 + t4 * t44) + t43 * t18 + t44 * t17 + (-t119 * mrSges(3,1) - t123 * mrSges(3,2)) * pkin(7) + (-t78 * t61 - t77 * t62) * mrSges(5,3) + t128 + (m(4) * (t118 * t70 + t122 * t69) + (t118 * t90 - t122 * t92) * mrSges(4,3)) * pkin(2); m(4) * (t118 ^ 2 + t122 ^ 2) * pkin(2) ^ 2 + t74 * t166 + t71 * t168 + 0.2e1 * t160 - 0.2e1 * t159 + t133 + m(6) * (t147 * t75 ^ 2 + t74 ^ 2) + (-t43 * t91 + t44 * t89) * t145 + t75 * t134 + 0.2e1 * t131 + Ifges(3,3) + m(7) * (t43 ^ 2 + t44 ^ 2 + t71 ^ 2) + m(5) * (t77 ^ 2 + t78 ^ 2); -mrSges(6,3) * t153 + t95 * t14 + t104 * t38 + t54 * t18 + t55 * t17 + (m(5) * (t114 * t33 - t115 * t31) + (-t114 * t61 - t115 * t62) * mrSges(5,3)) * pkin(3) + m(6) * (t103 * t137 + t104 * t31) + t128 + (-t117 * t40 + t121 * t39) * t103 + m(7) * (t16 * t95 + t3 * t54 + t4 * t55); t160 - t159 + (t74 + t104) * t96 + (t95 + t71) * t63 + t131 + m(6) * (t104 * t74 + t140 * t75) + m(7) * (t43 * t54 + t44 * t55 + t71 * t95) + (m(5) * (t114 * t78 + t115 * t77) + t139) * pkin(3) + ((-t43 - t54) * t91 + (t44 + t55) * t89) * mrSges(7,3) + (t147 * t75 + t140) * mrSges(6,3) + t133; t104 * t166 + t95 * t168 + (-t54 * t91 + t55 * t89) * t145 + t103 * t134 + m(7) * (t54 ^ 2 + t55 ^ 2 + t95 ^ 2) + m(6) * (t103 ^ 2 * t147 + t104 ^ 2) + t133 + (0.2e1 * t139 + m(5) * (t114 ^ 2 + t115 ^ 2) * pkin(3)) * pkin(3); t61 * mrSges(5,1) + t117 * t39 + t121 * t40 + t91 * t17 + t89 * t18 + t56 + m(7) * (t3 * t89 + t4 * t91) + m(6) * (t117 * t13 + t12 * t121) + m(5) * t72; m(7) * (t43 * t89 + t44 * t91); m(7) * (t54 * t89 + t55 * t91); m(5) + m(6) * t147 + m(7) * (t89 ^ 2 + t91 ^ 2); -Ifges(6,6) * t152 + t12 * mrSges(6,1) - t13 * mrSges(6,2) + (m(7) * (t116 * t4 + t120 * t3) + t116 * t17 + t120 * t18) * pkin(5) + t132 + t172; -t138 * t75 + (m(7) * (t116 * t44 + t120 * t43) - t143) * pkin(5) + t136 + t171; -t138 * t103 + (m(7) * (t116 * t55 + t120 * t54) - t143) * pkin(5) + t135 + t171; m(7) * (t116 * t91 + t120 * t89) * pkin(5) - t96 - t63; Ifges(6,3) + Ifges(7,3) + m(7) * (t116 ^ 2 + t120 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t130; t132; t136; t135; -t63; Ifges(7,3) + t130; Ifges(7,3);];
