...
t6 = [0.2e1 * t91 * t68 + t97 * t56 + t98 * t57 + 0.2e1 * t54 * t83 + 0.2e1 * t53 * t84 + t64 * t28 + 0.2e1 * t67 * t30 + 0.2e1 * t16 * t51 + 0.2e1 * t15 * t52 + 0.2e1 * t2 * t23 + 0.2e1 * t4 * t24 + 0.2e1 * t1 * t25 + 0.2e1 * t3 * t26 + 0.2e1 * t5 * t20 + 0.2e1 * t7 * t21 + (t13 + t14) * t44 + (t11 + t12) * t43 + (t161 - 0.2e1 * t175 + 0.2e1 * t184) * t147 + ((-0.2e1 * t99 * mrSges(3,3) + Ifges(3,5) * t147 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t150) * t145) * t150 + (0.2e1 * t100 * mrSges(3,3) - Ifges(4,5) * t98 + Ifges(3,6) * t147 - Ifges(4,6) * t97 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t150 + (Ifges(3,2) + Ifges(4,3) + Ifges(5,3)) * t152) * t145 + t181) * t152) * t145 + (-t27 + t193) * t63 + m(3) * (pkin(1) ^ 2 * t145 ^ 2 + t100 ^ 2 + t99 ^ 2) + m(4) * (t53 ^ 2 + t54 ^ 2 + t91 ^ 2) + m(5) * (t15 ^ 2 + t16 ^ 2 + t67 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t7 ^ 2) + Ifges(2,3); t184 - t175 + (t28 / 0.2e1 - t15 * mrSges(5,3) + t164 * t151 + t165 * t148) * t108 + t162 * t44 + t163 * t43 + t144 * t57 / 0.2e1 + t146 * t56 / 0.2e1 + t131 * t30 + t91 * t109 + t97 * t111 / 0.2e1 + t98 * t112 / 0.2e1 + t4 * t73 + t1 * t74 + t3 * t75 + t67 * t77 + t64 * t79 / 0.2e1 + t82 * t51 - pkin(2) * t68 + t5 * t69 + t7 * t70 + t2 * t72 + t55 * t20 + t33 * t26 + t34 * t24 + t22 * t25 + t29 * t23 + m(5) * (t131 * t67 - t15 * t80 + t16 * t82) + m(6) * (t3 * t33 + t34 * t4 + t7 * t80) + m(7) * (t1 * t22 + t2 * t29 + t5 * t55) + (-t144 * t84 + t146 * t83) * qJ(3) + (-t78 / 0.2e1 + t45 / 0.2e1 + t46 / 0.2e1) * t63 + t155 * mrSges(4,3) + m(4) * (-pkin(2) * t91 + qJ(3) * t155) - (Ifges(4,5) * t144 + Ifges(4,6) * t146 + t168) * t169 / 0.2e1 + (t9 / 0.2e1 + t10 / 0.2e1 - t27 / 0.2e1 - t16 * mrSges(5,3)) * t107 + t161 + (t21 - t52) * t80; -0.2e1 * pkin(2) * t109 + t146 * t111 + t144 * t112 + 0.2e1 * t131 * t77 + 0.2e1 * t22 * t74 + 0.2e1 * t29 * t72 + 0.2e1 * t33 * t75 + 0.2e1 * t34 * t73 + 0.2e1 * t55 * t69 + t70 * t190 + Ifges(3,3) + 0.2e1 * t167 * qJ(3) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t82 + t45 + t46 - t78) * t107 + m(4) * (t167 * qJ(3) ^ 2 + pkin(2) ^ 2) + m(5) * (t131 ^ 2 + t82 ^ 2 + t191) + m(6) * (t33 ^ 2 + t34 ^ 2 + t191) + m(7) * (t22 ^ 2 + t29 ^ 2 + t55 ^ 2) + (mrSges(5,3) * t190 + t79 + (t49 + t50) * t151 + (-t47 - t48) * t148) * t108; (t25 + t26) * t151 + (t23 + t24) * t148 + m(7) * (t1 * t151 + t148 * t2) + m(6) * (t148 * t4 + t151 * t3) + m(5) * t67 + m(4) * t91 + t30 + t68; -m(4) * pkin(2) + (t74 + t75) * t151 + (t72 + t73) * t148 + m(7) * (t148 * t29 + t151 * t22) + m(6) * (t148 * t34 + t151 * t33) + m(5) * t131 + t77 + t109; m(4) + m(5) + (m(6) / 0.2e1 + m(7) / 0.2e1) * t194; -Ifges(5,3) * t169 + t15 * mrSges(5,1) - t16 * mrSges(5,2) - pkin(4) * t21 + t113 * t25 + t5 * t114 - t116 * t23 + t132 * t20 + t160 * t63 + t158 * t44 + t159 * t43 + m(7) * (t1 * t113 - t116 * t2 + t132 * t5) + (t4 * mrSges(6,3) + t2 * mrSges(7,3) + (m(6) * t4 + t24) * pkin(10) - t165) * t151 + (-t1 * mrSges(7,3) - t3 * mrSges(6,3) + (-m(6) * t3 - t26) * pkin(10) + t164) * t148 - t181 + t192 * t7; t132 * t69 + t113 * t74 + t55 * t114 - t116 * t72 - t82 * mrSges(5,2) - pkin(4) * t70 + m(7) * (t113 * t22 - t116 * t29 + t132 * t55) + t160 * t107 + (-mrSges(5,1) + t192) * t80 + (t34 * mrSges(6,3) + t29 * mrSges(7,3) + t158 * t108 + (m(6) * t34 + t73) * pkin(10) + t163) * t151 + (-t33 * mrSges(6,3) - t22 * mrSges(7,3) - t159 * t108 + (-m(6) * t33 - t75) * pkin(10) + t162) * t148 + t168; m(7) * (t113 * t151 - t116 * t148); -0.2e1 * pkin(4) * t115 + 0.2e1 * t132 * t114 + Ifges(5,3) + pkin(10) * mrSges(6,3) * t194 + m(7) * (t113 ^ 2 + t116 ^ 2 + t132 ^ 2) + m(6) * (t166 * pkin(10) ^ 2 + pkin(4) ^ 2) + (t116 * t195 + t119 + t120) * t151 + (t113 * t195 + t121 + t122) * t148; mrSges(6,1) * t3 + mrSges(7,1) * t1 - mrSges(6,2) * t4 - mrSges(7,2) * t2 + (m(7) * t1 + t25) * pkin(5) + t193; mrSges(6,1) * t33 + mrSges(7,1) * t22 - mrSges(6,2) * t34 - mrSges(7,2) * t29 + (-Ifges(6,6) - Ifges(7,6)) * t172 + (m(7) * t22 + t74) * pkin(5) + t173 + t174; -t180 - t135 + (mrSges(6,1) + mrSges(7,1) + t188) * t151; mrSges(7,1) * t113 + mrSges(7,2) * t116 - t156 * pkin(10) + (m(7) * t113 - t148 * mrSges(7,3)) * pkin(5) + t118 + t117; Ifges(6,3) + Ifges(7,3) + (0.2e1 * mrSges(7,1) + t188) * pkin(5); m(7) * t5 + t20; m(7) * t55 + t69; 0; m(7) * t132 + t114; 0; m(7);];
