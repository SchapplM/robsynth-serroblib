% Umwandlung der Kinematikparameter von S6RPRPRR9V2 zu S6RPRPRR9
% Eingabe:
...
%
% Siehe auch: S6RPRPRR9_structural_kinematic_parameters.m
function pkin_gen = S6RPRPRR9V2_pkin_var2gen(pkin_var)
pkin_gen = zeros(13,1);
