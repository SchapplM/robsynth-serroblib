...
t3 = -pkin(5) * t50 - t5;
t12 = [m(4) * (t36 ^ 2 + t37 ^ 2 + t53 ^ 2) + m(5) * (t15 ^ 2 + t16 ^ 2 + t41 ^ 2) + m(6) * (t13 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(3) * (pkin(1) ^ 2 * t124 ^ 2 + t87 ^ 2 + t88 ^ 2) + Ifges(5,1) * t51 ^ 2 + (t8 - t19) * t42 + (0.2e1 * Ifges(4,4) * t66 + Ifges(4,2) * t65) * t65 + (t137 + t177) * t86 + Ifges(4,1) * t66 ^ 2 + (-0.2e1 * t88 * mrSges(3,2) + Ifges(3,3) * t128 + t173 * t87) * t128 + (-0.2e1 * pkin(1) * t103 + (-0.2e1 * t87 * mrSges(3,3) + Ifges(3,1) * t156 + Ifges(3,5) * t172) * t122 + (0.2e1 * t88 * mrSges(3,3) + Ifges(3,6) * t172 + (0.2e1 * Ifges(3,4) * t122 + Ifges(3,2) * t126 + pkin(1) * t173) * t124) * t126) * t124 + (-0.2e1 * Ifges(5,4) * t51 + Ifges(5,2) * t50 - Ifges(5,6) * t86 + t145) * t50 + Ifges(2,3) + 0.2e1 * t3 * t11 + 0.2e1 * t2 * t17 + 0.2e1 * t1 * t18 + 0.2e1 * t13 * t23 + t26 * t9 + t27 * t10 + 0.2e1 * t6 * t28 + 0.2e1 * t5 * t29 + 0.2e1 * t41 * t32 + t43 * t20 + 0.2e1 * t16 * t44 + 0.2e1 * t15 * t45 + 0.2e1 * t53 * t52 + 0.2e1 * t37 * t56 + 0.2e1 * t36 * t57; t55 * t17 + t54 * t18 + t72 * t28 + t80 * t44 + t103 + (t23 - t45) * t78 + t164 * t70 + (t32 + t52) * t127 + (-m(3) * pkin(1) - t126 * mrSges(3,1)) * t124 + (t131 * t56 + t134 * t57) * t123 + m(7) * (t1 * t54 + t2 * t55 + t3 * t70) + m(6) * (t13 * t78 - t5 * t70 + t6 * t72) + m(5) * (t127 * t41 - t15 * t78 + t16 * t80) + m(4) * (t127 * t53 + (t131 * t37 + t134 * t36) * t123); m(3) + m(7) * (t54 ^ 2 + t55 ^ 2 + t175) + m(6) * (t72 ^ 2 + t174 + t175) + m(5) * (t80 ^ 2 + t116 + t174) + m(4) * (t116 + (t131 ^ 2 + t134 ^ 2) * t123 ^ 2); m(7) * (t1 * t68 + t158 * t3 + t2 * t69) + (t81 / 0.2e1 - t97 / 0.2e1) * t42 + t137 + (t121 * t44 + t125 * t45 + m(5) * (t121 * t16 + t125 * t15)) * pkin(3) + m(6) * (t110 * t13 + (-t5 * t130 + t6 * t133) * t109) + (t6 * mrSges(6,3) + t109 * t28 - t8 / 0.2e1 + t19 / 0.2e1) * t133 + (-t5 * mrSges(6,3) + t9 * t169 + t10 * t167 + t20 / 0.2e1 + t164 * t109) * t130 + t15 * mrSges(5,1) - t16 * mrSges(5,2) + t36 * mrSges(4,1) - t37 * mrSges(4,2) + t68 * t18 + t69 * t17 + t82 * t171 + t83 * t170 + t3 * t89 + t2 * t91 + t1 * t92 + t13 * t94 + t43 * t99 / 0.2e1 + t110 * t23 + t50 * t148 / 0.2e1; -t80 * mrSges(5,2) + t54 * t92 + t55 * t91 + t70 * t89 + (-mrSges(5,1) + t94) * t78 + (mrSges(4,1) * t134 - mrSges(4,2) * t131) * t123 + t138 * mrSges(6,3) + m(7) * (t158 * t70 + t54 * t68 + t55 * t69) + m(6) * (t109 * t138 + t110 * t78) + m(5) * (t121 * t80 - t125 * t78) * pkin(3); 0.2e1 * t110 * t94 + 0.2e1 * t68 * t92 + 0.2e1 * t69 * t91 + (-t81 + t97) * t133 + m(7) * (t68 ^ 2 + t69 ^ 2 + t100) + m(6) * (t107 * t120 + t110 ^ 2 + t100) + m(5) * (t121 ^ 2 + t125 ^ 2) * pkin(3) ^ 2 + (-t129 * t82 + t132 * t83 + t179 * t89 + t99) * t130 + 0.2e1 * (mrSges(5,1) * t125 - mrSges(5,2) * t121) * pkin(3) + t146 * mrSges(6,3) * t179 + t180; -t164 * t133 + (t28 + t178) * t130 + m(7) * (t130 * t143 - t133 * t3) + m(6) * (t130 * t6 + t133 * t5) + m(5) * t41 + t32; m(5) * t127 + m(7) * (t130 * t141 - t159) + m(6) * (t130 * t72 - t159); -t133 * t89 + (m(7) * (t140 - t157) + t139) * t130; m(5) + m(7) * (t118 * t147 + t120) + m(6) * t146; t9 * t167 + t10 * t168 + t3 * t93 + t42 * t95 / 0.2e1 + t98 * t170 + t96 * t171 + t5 * mrSges(6,1) - t6 * mrSges(6,2) + t143 * mrSges(7,3) + t145 + (-m(7) * t3 - t11) * pkin(5) + (m(7) * t143 + t178) * pkin(11); -t72 * mrSges(6,2) + (m(7) * pkin(11) + mrSges(7,3)) * t141 + t176 * t70; t82 * t167 - pkin(5) * t89 + t83 * t168 + (m(7) * t140 + t139) * pkin(11) + (t109 * t176 + t98 * t167 + t96 * t169) * t130 + (-t95 / 0.2e1 - t109 * mrSges(6,2)) * t133 + t140 * mrSges(7,3) + t148; -t133 * t93 + m(7) * (pkin(11) * t144 + t165) + mrSges(7,3) * t144 - t94; Ifges(6,3) + m(7) * (pkin(11) ^ 2 * t147 + pkin(5) ^ 2) + t132 * t96 + t129 * t98 - 0.2e1 * pkin(5) * t93 + 0.2e1 * t147 * pkin(11) * mrSges(7,3); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t8; mrSges(7,1) * t54 - mrSges(7,2) * t55; mrSges(7,1) * t68 - mrSges(7,2) * t69 + t81; -t89; -pkin(11) * t142 + t95; Ifges(7,3);];
