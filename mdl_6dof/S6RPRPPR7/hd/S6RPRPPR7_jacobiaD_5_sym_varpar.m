...
function JaD = S6RPRPPR7_jacobiaD_5_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)

JaD_transl = S6RPRPPR7_jacobiaD_transl_5_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin);
JaD_rot = S6RPRPPR7_jacobiaD_rot_5_sym_varpar(qJ, qJD, ...
  pkin);
