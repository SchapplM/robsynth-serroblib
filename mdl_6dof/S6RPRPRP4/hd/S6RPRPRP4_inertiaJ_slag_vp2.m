...
t5 = t68 * t60 + t18;
t6 = [0.2e1 * t1 * t24 + 0.2e1 * t5 * t15 + 0.2e1 * t18 * t16 + 0.2e1 * t2 * t22 + 0.2e1 * t3 * t21 + 0.2e1 * t4 * t23 + Ifges(2,3) + Ifges(3,3) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t18 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(5) * (t14 ^ 2 + t84) + m(4) * (t40 ^ 2 + t84) + (0.2e1 * t40 * mrSges(4,2) - 0.2e1 * t14 * mrSges(5,3) + (Ifges(5,2) + Ifges(4,1)) * t58 + t79) * t58 + (-0.2e1 * t40 * mrSges(4,1) + 0.2e1 * t14 * mrSges(5,2) + (Ifges(5,3) + Ifges(4,2)) * t60 + (t8 - t9) * t59 + (-t10 - t11) * t57 + ((2 * Ifges(4,4)) + (2 * Ifges(5,6)) + t66) * t58) * t60 + (mrSges(5,1) + mrSges(4,3)) * t39 * t100 + (0.2e1 * t56 * mrSges(3,1) - 0.2e1 * t55 * mrSges(3,2) + m(3) * (t55 ^ 2 + t56 ^ 2) * pkin(1)) * pkin(1); (t15 + t16) * t58 + t97 * t60 + m(7) * (t5 * t58 - t72 * t60) + m(6) * (t18 * t58 - t71 * t60); m(3) + (m(5) / 0.2e1 + m(4) / 0.2e1) * t100 + (-t81 * t53 + t51) * t101; qJ(4) * t16 + t25 * t15 + t18 * t27 + t5 * t26 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + t10 / 0.2e1 + t11 / 0.2e1 + t87 * t61) * t59 + (t8 / 0.2e1 - t9 / 0.2e1 - t1 * mrSges(7,2) - t4 * mrSges(6,3) + t86 * t61) * t57 + m(6) * (qJ(4) * t18 + t71 * t61) + m(7) * (t25 * t5 + t72 * t61) + (-t91 / 0.2e1 + t47 / 0.2e1 + t48 / 0.2e1 + t45 / 0.2e1 - Ifges(5,4) + Ifges(4,5) - pkin(3) * mrSges(5,1) + (-mrSges(4,1) + t78) * t39) * t58 + (qJ(4) * mrSges(5,1) - Ifges(5,5) + Ifges(4,6) + (t28 / 0.2e1 - t29 / 0.2e1) * t59 + (-t30 / 0.2e1 - t31 / 0.2e1) * t57 + (m(5) * qJ(4) - mrSges(4,2) + mrSges(5,3)) * t39) * t60; (-mrSges(4,2) + t26 + t85) * t58 + (mrSges(4,1) - mrSges(5,2) + t98) * t60 + m(7) * (t25 * t58 + t73) + m(5) * (t43 + t96) + m(6) * (t43 + t73); -0.2e1 * pkin(3) * mrSges(5,2) + 0.2e1 * t25 * t26 + Ifges(5,1) + Ifges(4,3) + (t30 + t31) * t59 + (t28 - t29) * t57 + 0.2e1 * t85 * qJ(4) + m(6) * (t62 - t83) + m(7) * (t25 ^ 2 - t83) + m(5) * (pkin(3) ^ 2 + t62) - 0.2e1 * t61 * t98; (m(5) * t39 + mrSges(5,1)) * t58 + m(7) * t72 + m(6) * t71 - t97; -m(5) * t60 + t77 * t101; t61 * t67 + t78 - t98; m(5) + t67; -pkin(5) * t22 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + qJ(6) * t24 + t1 * mrSges(7,3) + t3 * mrSges(6,1) - t2 * mrSges(7,1) - t4 * mrSges(6,2) + t66 * t60 + t79; -t64 * t60; -t68 * mrSges(7,2) + t64 * t61 + t45 + t47 + t48 - t91; t64; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t103; m(7) * t2 + t22; m(7) * t90; (-m(7) * t61 + mrSges(7,2)) * t59; -m(7) * t59; -m(7) * pkin(5) - mrSges(7,1); m(7);];
