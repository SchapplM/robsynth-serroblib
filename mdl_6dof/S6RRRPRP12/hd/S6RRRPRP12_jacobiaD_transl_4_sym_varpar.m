...
function JaD_transl = S6RRRPRP12_jacobiaD_transl_4_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(3,1),zeros(10,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRPRP12_jacobiaD_transl_4_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRPRP12_jacobiaD_transl_4_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S6RRRPRP12_jacobiaD_transl_4_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S6RRRPRP12_jacobiaD_transl_4_sym_varpar: pkin has to be [10x1] (double)');

%% Symbolic Calculation
% From jacobiaD_transl_4_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 22:15:28
% EndTime: 2019-02-26 22:15:28
...
t314 = t284 * t289;
t304 = qJD(1) * t314;
t321 = qJD(3) * t301 - t273 * t286 + t288 * t304;
t317 = r_i_i_C(3) + qJ(4);
...
t274 = qJD(3) * t299 + t286 * t303;
t272 = qJD(1) * t297 + qJD(2) * t278;
t271 = qJD(1) * t278 + qJD(2) * t297;
t270 = -qJD(1) * t298 + t296 * qJD(2);
t265 = -t271 * t289 + qJD(3) * t316 + (qJD(1) * t312 + qJD(3) * t310) * t284;
t264 = qJD(3) * t300 - t271 * t286 - t291 * t304;
