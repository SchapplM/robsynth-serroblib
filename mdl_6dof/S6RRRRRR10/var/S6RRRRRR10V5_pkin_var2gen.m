% Umwandlung der Kinematikparameter von S6RRRRRR10V5 zu S6RRRRRR10
% Eingabe:
% pkin_var (9x1) double
...
function pkin_gen = S6RRRRRR10V5_pkin_var2gen(pkin_var)
pkin_gen = zeros(14,1);
pkin_gen([1, 2, 5, 6, 7, 9, 10, 11, 14]) = pkin_var;
