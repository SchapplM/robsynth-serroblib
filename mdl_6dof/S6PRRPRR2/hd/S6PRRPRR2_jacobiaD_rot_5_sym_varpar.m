...
function JaD_rot = S6PRRPRR2_jacobiaD_rot_5_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PRRPRR2_jacobiaD_rot_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6PRRPRR2_jacobiaD_rot_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6PRRPRR2_jacobiaD_rot_5_sym_varpar: pkin has to be [12x1] (double)');
...
t196 = t198 ^ 2;
t260 = t225 * t229;
t206 = t221 * t260 - t222 * t227;
t204 = 0.1e1 / t206 ^ 2;
t190 = t196 * t204 + 0.1e1;
t188 = 0.1e1 / t190;
t207 = t221 * t227 + t222 * t260;
t255 = qJD(2) * t231;
t246 = t225 * t255;
t194 = qJD(3) * t207 + t221 * t246;
t203 = 0.1e1 / t206;
t266 = t198 * t204;
...
t156 = t160 * t243 - t184 * t176 + t185 * t194;
...
t182 = 0.1e1 / t187 ^ 2;
t211 = t215 * qJD(2);
t179 = qJD(3) * t240 - t211 * t222;
t212 = -qJD(2) * t248 + t226 * t255;
t171 = qJD(5) * t187 + t179 * t228 - t212 * t230;
t263 = t215 * t230;
t186 = t202 * t228 - t263;
t180 = t186 ^ 2;
