...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:48:14
% EndTime: 2018-11-23 15:48:15
% DurationCPUTime: 0.48s
% Computational Cost: add. (413->91), mult. (339->103), div. (0->0), fcn. (297->12), ass. (0->54)
t74 = mrSges(6,3) + mrSges(7,3);
t31 = cos(qJ(5));
t15 = t31 * pkin(5) + pkin(4);
t25 = qJ(5) + qJ(6);
t20 = sin(t25);
t21 = cos(t25);
t29 = sin(qJ(5));
t73 = -m(6) * pkin(4) - m(7) * t15 - t31 * mrSges(6,1) - t21 * mrSges(7,1) + t29 * mrSges(6,2) + t20 * mrSges(7,2);
t33 = -pkin(9) - pkin(8);
...
t55 = t17 * t21;
t6 = -t18 * t55 + t52;
t64 = -t5 * mrSges(7,1) + t6 * mrSges(7,2);
t7 = -t18 * t52 + t55;
t8 = t18 * t51 + t56;
t63 = t7 * mrSges(7,1) - t8 * mrSges(7,2);
t60 = g(3) * t16;
t30 = sin(qJ(1));
t59 = t30 * pkin(1);
t32 = cos(qJ(1));
...
t12 = t18 * t49 + t54;
t10 = -t18 * t53 + t50;
t1 = [(-t54 * t65 - t32 * mrSges(2,1) - t12 * mrSges(6,1) - t8 * mrSges(7,1) + t30 * mrSges(2,2) - t11 * mrSges(6,2) - t7 * mrSges(7,2) + t69 * (t19 * t14 - t17 * t28 + t22) - t71 * t22 + t66 * t17 + (-m(6) * t44 - m(7) * t39 - t67) * t19) * g(2) + (-t50 * t65 + t30 * mrSges(2,1) - t10 * mrSges(6,1) - t6 * mrSges(7,1) + t32 * mrSges(2,2) - t9 * mrSges(6,2) - t5 * mrSges(7,2) + t71 * t59 + t69 * (-t19 * t28 - t59) + t66 * t19 + (m(5) * t14 - m(6) * (-t14 - t44) - m(7) * (-t14 - t39) + t67) * t17) * g(1) (-m(3) - t48) * g(3) (-g(1) * t17 + g(2) * t19) * t48 (t72 * t16 + t73 * t18 - t42) * g(3) + (g(1) * t19 + g(2) * t17) * ((mrSges(5,2) + t72) * t18 + (mrSges(5,1) - t73) * t16) (mrSges(6,2) * t31 + t70 * t29 - t40) * t60 + (-t10 * mrSges(6,2) + t70 * t9 - t64) * g(2) + (t12 * mrSges(6,2) - t70 * t11 - t63) * g(1), -g(1) * t63 - g(2) * t64 - t40 * t60];
taug  = t1(:);
