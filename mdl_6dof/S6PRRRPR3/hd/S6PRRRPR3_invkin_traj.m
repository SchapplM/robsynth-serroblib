...
%   von `S6PRRRPR3_invkin_eulangresidual`
%
% Ausgabe:
% Q
...
for k = 1:nt
  ...
  Jg = S6PRRRPR3_jacobig_sym_varpar(q_k, link_index, r_i_i_C, pkin);
  ...
  JgD = S6PRRRPR3_jacobigD_sym_varpar(q_k, qD_k, link_index, r_i_i_C, pkin);
