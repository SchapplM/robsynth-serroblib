...
elseif link_index == 5
	...
	t157 = sin(qJ(2));
	t158 = cos(qJ(2));
	t160 = qJD(2) * (t151 * t158 + t154 * t157);
	t155 = cos(pkin(10));
	t152 = sin(pkin(10));
	t150 = (t151 * t157 - t154 * t158) * qJD(2);
	t149 = cos(pkin(6)) * t160;
	t1 = [0, 0, 0, -t152 * t149 - t155 * t150, 0, 0; 0, 0, 0, t155 * t149 - t152 * t150, 0, 0; 0, 0, 0, sin(pkin(6)) * t160, 0, 0;];
	JgD_rot = t1;
elseif link_index == 6
	%% Symbolic Calculation
