% Umwandlung der Kinematikparameter von S6PRPRPR2V1 zu S6PRPRPR2
% Eingabe:
...
%
% Siehe auch: S6PRPRPR2_structural_kinematic_parameters.m
function pkin_gen = S6PRPRPR2V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(12,1);
