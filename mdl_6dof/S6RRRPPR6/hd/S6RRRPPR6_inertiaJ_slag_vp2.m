...
t4 = -pkin(5) * t55 - t6;
t25 = [m(3) * (pkin(1) ^ 2 * t131 ^ 2 + t88 ^ 2 + t89 ^ 2) + m(4) * (t42 ^ 2 + t43 ^ 2 + t78 ^ 2) + m(5) * (t11 ^ 2 + t12 ^ 2 + t57 ^ 2) + m(6) * (t10 ^ 2 + t13 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t4 ^ 2) + t86 * t44 + t87 * t45 + 0.2e1 * t43 * t73 + 0.2e1 * t42 * t74 + 0.2e1 * t78 * t59 + 0.2e1 * t57 * t23 + 0.2e1 * t10 * t39 + 0.2e1 * t12 * t40 + 0.2e1 * t11 * t41 + t32 * t8 + t33 * t9 + 0.2e1 * t6 * t38 + 0.2e1 * t2 * t17 + 0.2e1 * t1 * t18 + 0.2e1 * t13 * t24 + 0.2e1 * t4 * t14 + (t22 + t7 - t20) * t56 + (t19 - t21) * t55 + (t150 - 0.2e1 * t168 + 0.2e1 * t169) * t133 + ((-0.2e1 * t88 * mrSges(3,3) + Ifges(3,5) * t133 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t136) * t131) * t136 + (0.2e1 * t89 * mrSges(3,3) + Ifges(3,6) * t133 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t136 + (Ifges(3,2) + t152) * t139) * t131 + t144) * t139) * t131 + Ifges(2,3); (t40 - t38) * t71 + (-t41 + t39) * t69 + t78 * t101 + t86 * t106 / 0.2e1 + t87 * t108 / 0.2e1 + t121 * t23 + (pkin(9) * t73 + t43 * mrSges(4,3) + t44 / 0.2e1) * t138 + (-pkin(9) * t74 - t42 * mrSges(4,3) + t45 / 0.2e1) * t135 + t150 - t179 * t156 / 0.2e1 - t4 * t58 - pkin(2) * t59 + t60 * t24 + t1 * t61 + t2 * t62 + t57 * t63 + t13 * t64 + t47 * t14 + t16 * t17 + t15 * t18 + m(5) * (-t11 * t69 + t12 * t71 + t121 * t57) + m(6) * (t10 * t69 + t13 * t60 - t6 * t71) + m(7) * (t1 * t15 + t16 * t2 + t4 * t47) + (t22 / 0.2e1 + t7 / 0.2e1 - t20 / 0.2e1 - t11 * mrSges(5,3) + t10 * mrSges(6,1)) * t98 + (t8 * t172 + t9 * t173 + t19 / 0.2e1 - t21 / 0.2e1 - t12 * mrSges(5,3) + t6 * mrSges(6,1)) * t97 + (-t66 / 0.2e1 + t68 / 0.2e1 + t34 / 0.2e1) * t56 + (t65 / 0.2e1 - t67 / 0.2e1) * t55 + t33 * t176 + t35 * t177 - t168 + t169 + m(4) * (-pkin(2) * t78 + (-t135 * t42 + t138 * t43) * pkin(9)); -0.2e1 * pkin(2) * t101 + t138 * t106 + t135 * t108 + 0.2e1 * t121 * t63 + 0.2e1 * t15 * t61 + 0.2e1 * t16 * t62 - 0.2e1 * t47 * t58 + 0.2e1 * t60 * t64 + Ifges(3,3) + (t34 - t66 + t68) * t98 + m(4) * (t154 * pkin(9) ^ 2 + pkin(2) ^ 2) + m(5) * (t121 ^ 2 + t151) + m(6) * (t60 ^ 2 + t151) + m(7) * (t15 ^ 2 + t16 ^ 2 + t47 ^ 2) + (t134 * t36 + t137 * t35 + t65 - t67) * t97 + 0.2e1 * t154 * pkin(9) * mrSges(4,3) + 0.2e1 * (t69 * t98 - t71 * t97) * (mrSges(6,1) + mrSges(5,3)); t4 * t102 + t56 * t174 + t105 * t177 + t33 * t107 / 0.2e1 + t120 * t39 + t42 * mrSges(4,1) - t43 * mrSges(4,2) + t11 * mrSges(5,1) - t12 * mrSges(5,2) - t6 * mrSges(6,3) + t10 * mrSges(6,2) - t144 + (t116 * t18 - t1 * mrSges(7,3) + t9 / 0.2e1) * t137 + (t116 * t17 - t2 * mrSges(7,3) - t8 / 0.2e1) * t134 + (t14 - t38) * t117 + m(6) * (t10 * t120 - t117 * t6) + m(7) * (t147 * t116 + t117 * t4) + (m(5) * (t11 * t132 + t12 * t130) + t132 * t41 + t130 * t40) * pkin(3) - t152 * t156; t47 * t102 - t117 * t58 + (t120 * mrSges(6,1) + t174) * t98 + (-mrSges(5,2) + mrSges(6,3)) * t71 - t165 * t69 + (-mrSges(4,1) * t135 - mrSges(4,2) * t138) * pkin(9) + (-t15 * mrSges(7,3) + t116 * t61 + t176) * t137 + (t116 * t62 - t16 * mrSges(7,3) - t35 / 0.2e1) * t134 + m(7) * (t145 * t116 + t117 * t47) + m(6) * (t117 * t71 + t120 * t69) + (-t117 * mrSges(6,1) + t105 * t172 + t107 * t173) * t97 + (m(5) * (t130 * t71 - t132 * t69) + (-t130 * t97 - t132 * t98) * mrSges(5,3)) * pkin(3) + t179; 0.2e1 * t120 * mrSges(6,2) - t134 * t105 + t137 * t107 + m(6) * (t120 ^ 2 + t178) + m(7) * (t153 * t116 ^ 2 + t178) + m(5) * (t130 ^ 2 + t132 ^ 2) * pkin(3) ^ 2 + t152 + 0.2e1 * (t102 + mrSges(6,3)) * t117 + 0.2e1 * (mrSges(5,1) * t132 - mrSges(5,2) * t130) * pkin(3) - 0.2e1 * t116 * t148; -t134 * t18 + t137 * t17 + t48 - t49 + t165 * t55 + m(7) * (-t1 * t134 + t137 * t2) + m(6) * t13 + m(5) * t57; -t134 * t61 + t137 * t62 + t90 - t91 + t165 * t97 + m(7) * (-t134 * t15 + t137 * t16) + m(5) * t121 + m(6) * t60; 0; m(5) + t167; m(6) * t10 + m(7) * t147 + t134 * t17 + t137 * t18 + t39; m(6) * t69 + m(7) * t145 + t98 * mrSges(6,1) + t134 * t62 + t137 * t61; m(6) * t120 + t116 * t100 + mrSges(6,2) - t148; 0; t167; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t15 - mrSges(7,2) * t16 + t34; t146 * t116 + t104; -t102; t146; Ifges(7,3);];
