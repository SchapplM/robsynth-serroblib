...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:04:33
% EndTime: 2018-11-23 17:04:43
% DurationCPUTime: 9.64s
% Computational Cost: add. (9692->554), mult. (23345->726), div. (0->0), fcn. (15897->8), ass. (0->266)
t355 = qJD(2) - qJD(4);
t330 = t355 / 0.2e1;
t222 = sin(qJ(4));
t225 = cos(qJ(4));
...
t341 = -t363 / 0.2e1;
t405 = Ifges(6,4) * t340 + Ifges(6,2) * t341 + Ifges(6,6) * t330;
t221 = sin(qJ(6));
t224 = cos(qJ(6));
...
t399 = Ifges(7,3) * t404 + Ifges(7,5) * t343 + t75 * Ifges(7,6) / 0.2e1 + t405;
t402 = t90 * mrSges(6,1) + t10 * mrSges(7,1) - t11 * mrSges(7,2) + t399;
t294 = t219 * t69;
t35 = t288 * t65 - t294;
t316 = t76 * Ifges(7,4);
t25 = t75 * Ifges(7,2) + Ifges(7,6) * t385 + t316;
t74 = Ifges(7,4) * t75;
t26 = Ifges(7,1) * t76 + Ifges(7,5) * t385 + t74;
t359 = t25 * t328 + t26 * t403;
...
t398 = Ifges(6,5) * t329 + t362 * Ifges(6,1) / 0.2e1 + t363 * Ifges(6,4) / 0.2e1;
t401 = -t35 * mrSges(6,3) - Ifges(6,1) * t340 - Ifges(6,4) * t341 - Ifges(6,5) * t330 + t359 - t384 + t398;
t135 = Ifges(5,4) * t148;
t136 = Ifges(5,4) * t149;
...
t5 = t33 * Ifges(7,4) + t34 * Ifges(7,2) + t59 * Ifges(7,6);
t339 = pkin(7) - pkin(8);
t194 = t339 * t226;
t178 = qJD(2) * t194;
t153 = t222 * t178;
...
t6 = Ifges(7,1) * t33 + Ifges(7,4) * t34 + Ifges(7,5) * t59;
...
t400 = -(-t36 * mrSges(6,3) - Ifges(7,5) * t344 - Ifges(7,6) * t345 - Ifges(7,3) * t342 + t402 + t405) * t362 - t126 * (mrSges(5,1) * t149 + mrSges(5,2) * t148) - t54 * mrSges(5,2) - t8 * mrSges(6,2) + Ifges(5,5) * t97 + Ifges(6,5) * t60 - Ifges(5,6) * t98 - t6 * t328 - t5 * t327 + t192 * t392 + t34 * t191 / 0.2e1 + t55 * mrSges(5,1) + (Ifges(5,2) * t149 - t135 - t87) * t334 - (Ifges(5,1) * t148 - t136 - t86) * t149 / 0.2e1 + (t396 - t384) * qJD(6);
t397 = -mrSges(3,1) - mrSges(4,1);
t249 = -t10 * t224 - t11 * t221;
t353 = t90 * mrSges(6,2) + t396;
t395 = t249 * mrSges(7,3) + t353;
t391 = -t278 / 0.2e1;
...
t383 = (m(4) * t182 + (mrSges(4,2) + mrSges(3,3)) * t279 + t397 * qJD(2)) * pkin(7) - t151 * mrSges(4,3) - (Ifges(4,1) * t223 - t303) * t370 - t279 * t376 - t374 + t182 * mrSges(4,2) - (Ifges(4,4) + Ifges(3,5)) * t369;
t186 = t210 + t218;
t188 = mrSges(4,2) * t278 + qJD(2) * mrSges(4,3);
t206 = Ifges(4,5) * t279;
t306 = Ifges(3,4) * t223;
t375 = Ifges(4,6) / 0.2e1;
t382 = -(m(4) * t186 - qJD(2) * mrSges(3,2) + mrSges(3,3) * t278 + t188) * pkin(7) + t151 * mrSges(4,1) + qJD(2) * t375 + Ifges(4,3) * t391 + t206 / 0.2e1 + Ifges(3,6) * t369 + (t226 * Ifges(3,2) + t306) * t370 - t186 * mrSges(4,2);
...
t272 = t223 * t301;
t271 = 0.3e1 / 0.2e1 * Ifges(3,4) - 0.3e1 / 0.2e1 * Ifges(4,5);
t270 = Ifges(4,4) / 0.2e1 + Ifges(3,5) / 0.2e1;
t269 = -Ifges(3,6) / 0.2e1 + t375;
...
t24 = [(t399 + t402) * t61 + (-t35 * t62 - t36 * t61 + t50 * t60 - t51 * t59) * mrSges(6,3) + (-t125 * mrSges(4,3) + (t269 * qJD(2) + (t183 * mrSges(4,1) - t223 * t271 - 0.2e1 * t338) * qJD(1) + t382) * qJD(2)) * t223 + (-t125 * mrSges(4,1) + t268 * t179 + (t270 * qJD(2) + (-0.2e1 * t337 - t183 * mrSges(4,3) + t271 * t226 + (-0.3e1 / 0.2e1 * Ifges(3,2) - 0.3e1 / 0.2e1 * Ifges(4,3) + 0.3e1 / 0.2e1 * Ifges(3,1) + 0.3e1 / 0.2e1 * Ifges(4,1) + t268 * pkin(7)) * t223) * qJD(1) + t383) * qJD(2)) * t226 + (t111 * t332 - t243 * t97) * Ifges(5,1) + m(5) * (t113 * t159 + t116 * t55 + t117 * t54 + t121 * t126 + t70 * t84 + t71 * t83) + t113 * (mrSges(5,1) * t242 - mrSges(5,2) * t243) + (Ifges(5,5) * t111 - Ifges(5,6) * t110) * t329 + t126 * (mrSges(5,1) * t110 + mrSges(5,2) * t111) + (-t110 * t334 + t242 * t98) * Ifges(5,2) + (-t110 * t84 - t111 * t83 - t116 * t97 - t117 * t98 - t242 * t54 + t243 * t55) * mrSges(5,3) + (-t110 * t332 + t111 * t334 - t242 * t97 + t243 * t98) * Ifges(5,4) + t159 * (mrSges(5,1) * t98 + mrSges(5,2) * t97) + m(7) * (t1 * t23 + t10 * t4 + t11 * t3 + t17 * t31 + t2 * t22 + t336) + m(6) * (t112 * t64 - t17 * t35 + t18 * t36 + t51 * t8 + t72 * t90 + t336) + t309 * t17 + (t5 * t328 + t6 * t403 + Ifges(6,1) * t60 - Ifges(6,4) * t59 + t64 * mrSges(6,2) + t253 * t392 + t34 * t373 + t250 * t346 + (mrSges(6,3) + t254) * t7 + t257 * mrSges(7,3) + (-mrSges(7,3) * t357 + t191 * t345 + t192 * t344 + t25 * t327 + t255 * t31 + t26 * t328 + t331 * t385) * qJD(6)) * t103 + m(4) * (t125 * t183 + t137 * t151) + (t250 * t404 + t253 * t343 + t75 * t373 + t359 + t395 + 0.2e1 * t398) * t62 + t22 * t19 + t23 * t20 + t3 * t48 + t4 * t49 + t50 * t9 + t72 * t56 + t18 * t78 - t110 * t86 / 0.2e1 + t111 * t87 / 0.2e1 + t70 * t119 + t71 * t120 + t121 * t99 + (-t8 * mrSges(6,3) + t58 / 0.2e1 - Ifges(6,4) * t60 + t64 * mrSges(6,1) + (Ifges(6,2) + Ifges(7,3) / 0.2e1) * t59 + t354) * t102 + t137 * t168 + t112 * t260; (t395 + t401) * t363 + (-t100 * t90 - t108 * t7 + t109 * t8 + (-t44 + t81) * t36 + t390 * t35) * m(6) + (-t10 * t14 + t104 * t7 - t11 * t15 - t31 * t390 + t357 * t81) * m(7) - t390 * t309 - t400 + t251 * t329 + t380 * mrSges(7,3) + (-t108 * t60 - t109 * t59) * mrSges(6,3) + (-m(4) * t151 - t168) * (pkin(2) * t279 - t204) + (-t180 * t97 - t181 * t98 - t358) * mrSges(5,3) + t105 * t372 + t387 * t119 + t388 * t120 + (-t126 * t134 + t180 * t55 + t181 * t54 + t387 * t84 + t388 * t83) * m(5) + m(4) * (qJ(3) * t179 + qJD(3) * t186) + (Ifges(6,6) + t331) * t59 + ((t322 - t105 * t49 - t26 / 0.2e1) * t224 + (t320 - t105 * t48 + t25 / 0.2e1) * t221) * qJD(6) + t240 * t81 + t247 * t105 - t15 * t48 - t14 * t49 - t44 * t78 - t100 * t56 + t104 * t9 - t134 * t99 + t179 * mrSges(4,3) + ((t374 + (t337 + t303 / 0.2e1) * qJD(1) + (-pkin(2) * mrSges(4,2) + (-m(4) * pkin(2) + t397) * pkin(7) + t270) * qJD(2) - t383) * t226 + (-t206 / 0.2e1 + (t338 + t306 / 0.2e1) * qJD(1) + (t376 + Ifges(4,3) / 0.2e1 - Ifges(4,1) / 0.2e1 + Ifges(3,2) / 0.2e1) * t278 + (pkin(7) * mrSges(3,2) - qJ(3) * mrSges(4,2) + t269) * qJD(2) - t382) * t223) * qJD(1) + qJD(3) * t188 + t368 * t7; -t114 * t49 - t115 * t48 - t141 * t78 - (t9 + t326) * t236 + t244 * qJD(4) + (-t222 * t98 - t225 * t97) * mrSges(5,3) + t240 * t142 + (-t188 - t244) * qJD(2) + (-t318 + (-t221 * t48 - t224 * t49) * qJD(6) + t247) * t162 + (t268 * t277 + (t168 - t56 - t99) * t223) * qJD(1) - m(4) * (qJD(2) * t186 - t151 * t279) - t360 * t309 + (-t10 * t114 - t11 * t115 + t142 * t357 + t231 * t162 - t31 * t360 - t319) * m(7) + (t162 * t8 - t90 * t279 - t319 + (-t141 + t142) * t36 + t360 * t35) * m(6) + (-t126 * t279 + t222 * t54 + t225 * t55 - t355 * (-t222 * t83 + t225 * t84)) * m(5); (t10 * t308 + t11 * t293 - t353 - t401) * t363 + (-t325 * t90 + t35 * t37 - t36 * t38 + (t219 * t8 - t288 * t7) * pkin(4)) * m(6) + t400 + t190 * t346 + t251 * t330 - m(7) * (t10 * t12 + t11 * t13) - t261 * t326 - t273 * t322 - t318 * t324 - t56 * t325 - t274 * t320 - t2 * t293 + t1 * t308 - t13 * t48 - t12 * t49 - Ifges(6,6) * t59 - t38 * t78 - t83 * t119 + t84 * t120 + t358 * mrSges(5,3) + t359 * qJD(6) + (m(7) * t201 - t368) * t7 + t201 * t9 + (-m(7) * t31 - t309) * t37 + (-t273 * t49 - t274 * t48 + t247 + t372) * (pkin(9) + t324); -t363 * t78 - t309 * t362 + (t385 * t48 + t19) * t224 + (-t385 * t49 + t20) * t221 + t260 + (-t31 * t362 + t357 * t385 - t257) * m(7) + (t35 * t362 - t36 * t363 + t64) * m(6); t58 - t31 * (mrSges(7,1) * t76 + mrSges(7,2) * t75) + (Ifges(7,1) * t75 - t316) * t344 + t25 * t343 + (Ifges(7,5) * t75 - Ifges(7,6) * t76) * t342 - t10 * t48 + t11 * t49 + (t10 * t75 + t11 * t76) * mrSges(7,3) + (-Ifges(7,2) * t76 + t26 + t74) * t345 + t354;];
tauc  = t24(:);
