...
t2 = t146 * t3 + t149 * t4;
t1 = -t146 * t4 + t149 * t3;
t17 = [t46 * t15 + t47 * t16 + 0.2e1 * t24 * t49 + 0.2e1 * t23 * t50 + 0.2e1 * t40 * t39 + t28 * t8 + t29 * t9 + 0.2e1 * t19 * t30 + 0.2e1 * t6 * t31 + 0.2e1 * t5 * t32 + 0.2e1 * t11 * t10 + 0.2e1 * t2 * t12 + 0.2e1 * t1 * t13 + (t154 - 0.2e1 * t174 + 0.2e1 * t175 + t191) * t145 + Ifges(4,1) * t89 ^ 2 + m(7) * (t1 ^ 2 + t11 ^ 2 + t2 ^ 2) + m(6) * (t19 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(5) * (t23 ^ 2 + t24 ^ 2 + t40 ^ 2) + m(4) * (t106 ^ 2 + t43 ^ 2 + t44 ^ 2) + (t14 + t7 - t35) * t67 + m(3) * (t96 ^ 2 + t97 ^ 2) + ((Ifges(3,5) * t148 + Ifges(3,6) * t151) * t145 + 0.2e1 * (-t148 * t96 + t151 * t97) * mrSges(3,3) + (m(3) * pkin(1) ^ 2 - 0.2e1 * pkin(1) * (-mrSges(3,1) * t151 + mrSges(3,2) * t148) + t151 * (Ifges(3,4) * t148 + Ifges(3,2) * t151) + t148 * (Ifges(3,1) * t148 + Ifges(3,4) * t151)) * t142) * t142 + t68 * t36 + 0.2e1 * t44 * t72 + 0.2e1 * t43 * t73 + (mrSges(4,1) * t189 - 0.2e1 * Ifges(4,4) * t89 + Ifges(4,2) * t88 + t159) * t88 + Ifges(2,3) + t79 * t189; t11 * t55 + t57 * t32 + t58 * t31 + t43 * mrSges(4,1) - t44 * mrSges(4,2) + t33 * t13 + t34 * t12 + (t24 * mrSges(5,3) + t128 * t49 + t35 / 0.2e1 - t14 / 0.2e1 - t7 / 0.2e1) * t150 + m(7) * (t1 * t33 + t11 * t94 + t2 * t34) + (t51 / 0.2e1 + t85 / 0.2e1 - t115 / 0.2e1) * t67 + m(6) * (t19 * t168 + t5 * t57 + t58 * t6) + t88 * t162 / 0.2e1 + t154 + t175 - t174 + t9 * t182 + t8 * t183 + t47 * t184 + t46 * t185 + t53 * t186 + t52 * t187 + t2 * t76 + t1 * t77 + t94 * t10 + t19 * t95 + t6 * t104 + t5 * t105 + (-t23 * mrSges(5,3) - t140 * t15 / 0.2e1 + t143 * t188 + t36 / 0.2e1 + t172 * t128) * t147 + t40 * t114 + t68 * t116 / 0.2e1 + t129 * t39 + (t141 * t72 + t144 * t73 + m(4) * (t141 * t44 + t144 * t43)) * pkin(2) + m(5) * (t129 * t40 + (-t147 * t23 + t150 * t24) * t128); 0.2e1 * t58 * t104 + 0.2e1 * t57 * t105 + 0.2e1 * t129 * t114 + 0.2e1 * t33 * t77 + 0.2e1 * t34 * t76 - t90 * t52 + t91 * t53 + 0.2e1 * t94 * t55 + (-t51 - t85 + t115) * t150 + (-t140 * t86 + t143 * t87 + t95 * t192 + t116) * t147 + m(7) * (t33 ^ 2 + t34 ^ 2 + t94 ^ 2) + m(6) * (t57 ^ 2 + t58 ^ 2 + t117) + m(5) * (t126 * t139 + t129 ^ 2 + t117) + m(4) * (t141 ^ 2 + t144 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t144 - mrSges(4,2) * t141) * pkin(2) + t160 * mrSges(5,3) * t192 + t193; t88 * mrSges(4,1) + t91 * t12 - t90 * t13 + t79 + (-t10 - t172) * t150 + (-t140 * t32 + t143 * t31 + t49) * t147 + m(7) * (-t1 * t90 - t11 * t150 + t2 * t91) + m(6) * (t156 * t147 - t150 * t19) + m(5) * (t147 * t24 + t150 * t23) + m(4) * t106; m(7) * (-t33 * t90 + t34 * t91) + t91 * t76 - t90 * t77 + (m(6) * (t155 - t167) + t143 * t104 - t140 * t105) * t147 + t190 * t150; m(4) + m(5) * t160 + m(6) * (t161 * t138 + t139) + m(7) * (t90 ^ 2 + t91 ^ 2 + t139); (t6 * mrSges(6,3) + qJ(5) * t31 + t15 / 0.2e1) * t143 + (-t5 * mrSges(6,3) - qJ(5) * t32 + t188) * t140 + m(7) * (t1 * t69 + t11 * t130 + t2 * t70) + t11 * t62 + t64 * t187 + t65 * t186 - t24 * mrSges(5,2) - pkin(4) * t30 + t23 * mrSges(5,1) + (-t1 * t103 + t102 * t2) * mrSges(7,3) + t158 * t67 + m(6) * (-pkin(4) * t19 + t156 * qJ(5)) + t159 + t69 * t13 + t70 * t12 + t8 * t180 + t9 * t179 + t19 * t109 + t46 * t112 / 0.2e1 + t47 * t178 + t130 * t10; t70 * t76 + t69 * t77 + t64 * t183 + t65 * t182 + t94 * t62 - pkin(4) * t95 + t52 * t180 + t53 * t179 + t130 * t55 + t169 * t168 + (t102 * t34 - t103 * t33) * mrSges(7,3) + (t58 * mrSges(6,3) + qJ(5) * t104 + t147 * t178 + t185) * t143 + (-t57 * mrSges(6,3) - qJ(5) * t105 - t147 * t112 / 0.2e1 + t184) * t140 + m(7) * (t130 * t94 + t33 * t69 + t34 * t70) + m(6) * (-pkin(4) * t168 + qJ(5) * t155) + (-t128 * mrSges(5,2) - t158) * t150 + t162; (t102 * t91 + t103 * t90) * mrSges(7,3) + (-t62 - t169) * t150 + (mrSges(6,3) * t161 - mrSges(5,2)) * t147 + m(6) * (t147 * t157 + t176) + m(7) * (-t130 * t150 - t69 * t90 + t70 * t91); -0.2e1 * pkin(4) * t109 + t102 * t64 + t103 * t65 + t143 * t112 + t140 * t113 + 0.2e1 * t130 * t62 + Ifges(5,3) + m(7) * (t130 ^ 2 + t69 ^ 2 + t70 ^ 2) + m(6) * (qJ(5) ^ 2 * t161 + pkin(4) ^ 2) + 0.2e1 * (t102 * t70 - t103 * t69) * mrSges(7,3) + 0.2e1 * mrSges(6,3) * t157; m(6) * t19 + m(7) * t11 + t10 + t30; m(6) * t168 - t190; -t181 * t150; -m(6) * pkin(4) + m(7) * t130 + t109 + t62; t181; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t33 - mrSges(7,2) * t34 + t51; -t55; mrSges(7,1) * t69 - t70 * mrSges(7,2) + t63; 0; Ifges(7,3);];
