...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:27:31
% EndTime: 2018-11-23 17:27:33
...
t1 = [m(3) * (pkin(1) ^ 2 * t157 ^ 2 + t114 ^ 2 + t115 ^ 2) + m(7) * (t12 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t19 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(5) * (t24 ^ 2 + t25 ^ 2 + t81 ^ 2) + m(4) * (t109 ^ 2 + t63 ^ 2 + t64 ^ 2) + (t8 + t21 - t40) * t75 + ((-0.2e1 * t114 * mrSges(3,3) + Ifges(3,5) * t159 + (-0.2e1 * pkin(1) * mrSges(3,2) + Ifges(3,1) * t163) * t157) * t163 + (0.2e1 * t115 * mrSges(3,3) - Ifges(4,5) * t113 + Ifges(3,6) * t159 - Ifges(4,6) * t112 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t163 + (Ifges(4,3) + Ifges(5,3) + Ifges(3,2)) * t166) * t157 + t190) * t166) * t157 + (t177 - 0.2e1 * t186 + 0.2e1 * t187) * t159 + Ifges(2,3) + 0.2e1 * t12 * t11 + 0.2e1 * t3 * t16 + 0.2e1 * t2 * t17 + t31 * t9 + t32 * t10 + 0.2e1 * t19 * t33 + 0.2e1 * t7 * t35 + 0.2e1 * t6 * t36 + t56 * t22 + t57 * t23 + 0.2e1 * t25 * t61 + 0.2e1 * t24 * t62 + t76 * t41 + 0.2e1 * t81 * t43 + 0.2e1 * t64 * t99 + 0.2e1 * t63 * t100 + 0.2e1 * t109 * t82 + t112 * t66 + t113 * t67; (-t156 * t100 + t158 * t99) * qJ(3) + m(5) * (t146 * t81 - t24 * t95 + t25 * t97) + m(7) * (t12 * t65 + t14 * t2 + t15 * t3) + m(6) * (t19 * t95 + t47 * t6 + t48 * t7) + t177 + (-t24 * mrSges(5,3) - t161 * t22 / 0.2e1 + t165 * t203 + t41 / 0.2e1) * t126 - (Ifges(4,5) * t156 + Ifges(4,6) * t158 + t181) * t182 / 0.2e1 + (t37 / 0.2e1 + t58 / 0.2e1 - t89 / 0.2e1) * t75 + (t33 - t62) * t95 - t186 + t187 + t57 * t201 + t56 * t202 + m(4) * (-pkin(2) * t109 + qJ(3) * t174) + t174 * mrSges(4,3) + t15 * t16 + t14 * t17 + t31 * t38 / 0.2e1 + t32 * t39 / 0.2e1 + t12 * t44 + t47 * t36 + t48 * t35 + t3 * t52 + t2 * t53 + t65 * t11 - t77 * t9 / 0.2e1 + t78 * t10 / 0.2e1 - pkin(2) * t82 + t19 * t83 + t7 * t85 + t6 * t86 + t81 * t88 + t76 * t90 / 0.2e1 + t97 * t61 + t109 * t129 + t112 * t131 / 0.2e1 + t113 * t132 / 0.2e1 + t146 * t43 + t156 * t67 / 0.2e1 + t158 * t66 / 0.2e1 + (-t25 * mrSges(5,3) + t8 / 0.2e1 + t21 / 0.2e1 - t40 / 0.2e1) * t125; -0.2e1 * pkin(2) * t129 + t158 * t131 + t156 * t132 + 0.2e1 * t14 * t53 + 0.2e1 * t146 * t88 + 0.2e1 * t15 * t52 - t77 * t38 + t78 * t39 + 0.2e1 * t65 * t44 + 0.2e1 * t47 * t86 + 0.2e1 * t48 * t85 + t83 * t204 + Ifges(3,3) + 0.2e1 * t180 * qJ(3) * mrSges(4,3) + (mrSges(5,3) * t204 - t161 * t59 + t165 * t60 + t90) * t126 + (-0.2e1 * mrSges(5,3) * t97 + t37 + t58 - t89) * t125 + m(5) * (t146 ^ 2 + t97 ^ 2 + t205) + m(4) * (qJ(3) ^ 2 * t180 + pkin(2) ^ 2) + m(7) * (t14 ^ 2 + t15 ^ 2 + t65 ^ 2) + m(6) * (t47 ^ 2 + t48 ^ 2 + t205); t127 * t17 + t128 * t16 + t161 * t35 + t165 * t36 + m(7) * (t127 * t2 + t128 * t3) + m(6) * (t161 * t7 + t165 * t6) + m(5) * t81 + m(4) * t109 + t82 + t43; -m(4) * pkin(2) + t127 * t53 + t128 * t52 + t161 * t85 + t165 * t86 + m(7) * (t127 * t14 + t128 * t15) + m(6) * (t161 * t48 + t165 * t47) + m(5) * t146 + t88 + t129; m(4) + m(5) + m(6) * t179 + m(7) * (t127 ^ 2 + t128 ^ 2); (t7 * mrSges(6,3) + pkin(10) * t35 + t22 / 0.2e1) * t165 + (-t6 * mrSges(6,3) - pkin(10) * t36 + t203) * t161 - Ifges(5,3) * t182 + m(7) * (t101 * t2 + t102 * t3 + t12 * t147) + (t127 * t3 - t128 * t2) * mrSges(7,3) - t190 + m(6) * (-pkin(4) * t19 + (-t161 * t6 + t165 * t7) * pkin(10)) + t178 * t75 + t24 * mrSges(5,1) - t25 * mrSges(5,2) - pkin(4) * t33 + t12 * t91 + t31 * t200 + t32 * t199 + t101 * t17 + t102 * t16 + t9 * t197 + t10 * t196 + t19 * t133 + t56 * t135 / 0.2e1 + t57 * t195 + t147 * t11; -pkin(4) * t83 + t65 * t91 - t77 * t200 + t78 * t199 - t97 * mrSges(5,2) + t101 * t53 + t102 * t52 + t38 * t197 + t39 * t196 + t147 * t44 + (-mrSges(5,1) + t133) * t95 + t178 * t125 + (t127 * t15 - t128 * t14) * mrSges(7,3) + (t48 * mrSges(6,3) + pkin(10) * t85 + t126 * t195 + t202) * t165 + (-t126 * t135 / 0.2e1 - t47 * mrSges(6,3) - pkin(10) * t86 + t201) * t161 + m(7) * (t101 * t14 + t102 * t15 + t147 * t65) + m(6) * (-pkin(4) * t95 + (-t161 * t47 + t165 * t48) * pkin(10)) + t181; m(7) * (t101 * t127 + t102 * t128); -0.2e1 * pkin(4) * t133 + t127 * t93 + t128 * t94 + t165 * t135 + t161 * t136 + 0.2e1 * t147 * t91 + Ifges(5,3) + m(7) * (t101 ^ 2 + t102 ^ 2 + t147 ^ 2) + m(6) * (pkin(10) ^ 2 * t179 + pkin(4) ^ 2) + 0.2e1 * (-t101 * t128 + t102 * t127) * mrSges(7,3) + 0.2e1 * t179 * pkin(10) * mrSges(6,3); t6 * mrSges(6,1) - t7 * mrSges(6,2) + (m(7) * (t160 * t3 + t164 * t2) + t160 * t16 + t164 * t17) * pkin(5) + t172 + t21; t47 * mrSges(6,1) - t48 * mrSges(6,2) + (m(7) * (t14 * t164 + t15 * t160) + t160 * t52 + t164 * t53) * pkin(5) + t171 + t58; m(7) * (t127 * t164 + t128 * t160) * pkin(5) - t133 - t91; -t175 * pkin(10) + (m(7) * (t101 * t164 + t102 * t160) + (t127 * t160 - t128 * t164) * mrSges(7,3)) * pkin(5) + t173 + t134; Ifges(6,3) + Ifges(7,3) + m(7) * (t160 ^ 2 + t164 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t170; t172; t171; -t91; t173; Ifges(7,3) + t170; Ifges(7,3);];
