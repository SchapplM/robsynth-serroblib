...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:39:48
% EndTime: 2018-11-23 16:39:50
...
t1 = [0.2e1 * t39 * t41 + 0.2e1 * t14 * t30 + 0.2e1 * t7 * t31 + 0.2e1 * t6 * t32 + t28 * t9 + t29 * t10 + 0.2e1 * t3 * t18 + 0.2e1 * t2 * t19 + 0.2e1 * t12 * t11 + t63 * t34 + 0.2e1 * t43 * t64 + 0.2e1 * t42 * t65 + 0.2e1 * t57 * t51 + t46 * t21 + t47 * t22 + 0.2e1 * t17 * t48 + 0.2e1 * t16 * t49 + t79 * (Ifges(4,1) * t79 + Ifges(4,5) * t107) + m(7) * (t12 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(6) * (t14 ^ 2 + t6 ^ 2 + t7 ^ 2) + m(5) * (t16 ^ 2 + t17 ^ 2 + t39 ^ 2) + m(4) * (t42 ^ 2 + t43 ^ 2 + t57 ^ 2) + m(3) * (pkin(1) ^ 2 * t157 ^ 2 + t109 ^ 2 + t110 ^ 2) + (t20 + t8 - t33) * t62 + t107 * t183 + (-0.2e1 * Ifges(4,4) * t79 + Ifges(4,2) * t78 - Ifges(4,6) * t107 + t184) * t78 + Ifges(2,3) + (-0.2e1 * mrSges(3,2) * t110 + Ifges(3,3) * t160 + t109 * t218) * t160 + (-0.2e1 * pkin(1) * t137 + (-0.2e1 * mrSges(3,3) * t109 + Ifges(3,1) * t193 + Ifges(3,5) * t217) * t155 + (0.2e1 * t110 * mrSges(3,3) + Ifges(3,6) * t217 + (0.2e1 * Ifges(3,4) * t155 + Ifges(3,2) * t158 + pkin(1) * t218) * t157) * t158) * t157; t113 * t48 + t159 * t51 + t56 * t18 + t55 * t19 + t87 * t31 + t86 * t32 + t137 + (-m(3) * pkin(1) - mrSges(3,1) * t158) * t157 + (t164 * t64 + (-t41 + t65) * t168) * t156 + (t11 + t201) * t111 + m(7) * (t111 * t12 + t2 * t55 + t3 * t56) + m(6) * (t111 * t14 + t6 * t86 + t7 * t87) + m(5) * (-t111 * t16 + t113 * t17 - t191 * t39) + m(4) * (t159 * t57 + (t164 * t43 + t168 * t42) * t156); m(3) + m(7) * (t55 ^ 2 + t56 ^ 2 + t108) + m(6) * (t86 ^ 2 + t87 ^ 2 + t108) + m(5) * (t113 ^ 2 + t108 + t142) + m(4) * (t150 * t164 ^ 2 + t159 ^ 2 + t142); -pkin(3) * t41 + t42 * mrSges(4,1) - t43 * mrSges(4,2) + (t33 / 0.2e1 - t20 / 0.2e1 - t8 / 0.2e1 + t17 * mrSges(5,3) + pkin(10) * t48) * t167 + t7 * t122 + t6 * t123 + t124 * t11 + t39 * t127 + t63 * t132 / 0.2e1 + t14 * t114 + t3 * t93 + t2 * t94 + t96 * t32 + t97 * t31 + t12 * t69 + t52 * t19 + t53 * t18 + m(7) * (t12 * t124 + t2 * t52 + t3 * t53) + (-t130 / 0.2e1 + t101 / 0.2e1 + t66 / 0.2e1) * t62 + t183 + m(5) * (-pkin(3) * t39 + (-t16 * t163 + t167 * t17) * pkin(10)) + t78 * t186 / 0.2e1 + m(6) * (t14 * t204 + t6 * t96 + t7 * t97) + (t34 / 0.2e1 - t16 * mrSges(5,3) - t162 * t21 / 0.2e1 + t166 * t216 + t201 * pkin(10)) * t163 + t10 * t209 + t9 * t210 + t47 * t211 + t46 * t212 + t68 * t214 + t67 * t215; mrSges(5,3) * t194 + t87 * t122 + t86 * t123 + t55 * t94 + t56 * t93 + (-t164 * mrSges(4,2) + (mrSges(4,1) - t127) * t168) * t156 + (t163 * mrSges(5,3) + t114 + t69) * t111 + m(7) * (t111 * t124 + t52 * t55 + t53 * t56) + m(6) * (pkin(10) * t195 + t86 * t96 + t87 * t97) + m(5) * (pkin(3) * t191 + (t194 + t195) * pkin(10)); -0.2e1 * pkin(3) * t127 - t105 * t67 + t106 * t68 + 0.2e1 * t97 * t122 + 0.2e1 * t96 * t123 + 0.2e1 * t124 * t69 + 0.2e1 * t52 * t94 + 0.2e1 * t53 * t93 + Ifges(4,3) + (t152 + t154) * mrSges(5,3) * t219 + (-t66 - t101 + t130) * t167 + m(7) * (t124 ^ 2 + t52 ^ 2 + t53 ^ 2) + m(6) * (t96 ^ 2 + t97 ^ 2 + t149) + m(5) * (pkin(3) ^ 2 + t154 * t170 + t149) + (-t102 * t162 + t103 * t166 + t114 * t219 + t132) * t163; -pkin(4) * t30 + t16 * mrSges(5,1) - t17 * mrSges(5,2) + t144 * t11 + t9 * t208 + t10 * t207 + t14 * t126 + t46 * t129 / 0.2e1 + t47 * t206 + t91 * t19 + t92 * t18 + t12 * t82 + t84 * t215 + t85 * t214 + t184 + (t21 / 0.2e1 + t7 * mrSges(6,3) + pkin(11) * t31) * t166 + (-t6 * mrSges(6,3) - pkin(11) * t32 + t216) * t162 + m(6) * (-pkin(4) * t14 + (-t162 * t6 + t166 * t7) * pkin(11)) + m(7) * (t12 * t144 + t2 * t91 + t3 * t92) + (t119 * t3 - t120 * t2) * mrSges(7,3) + t181 * t62; -t113 * mrSges(5,2) + (t119 * t56 - t120 * t55) * mrSges(7,3) + t176 * mrSges(6,3) + (t82 + t197) * t111 + m(7) * (t111 * t144 + t55 * t91 + t56 * t92) + m(6) * (-pkin(4) * t111 + pkin(11) * t176); t144 * t69 + t67 * t208 + t68 * t207 + t124 * t82 - pkin(4) * t114 + t84 * t210 + t85 * t209 + t92 * t93 + t91 * t94 + t197 * t204 + (t119 * t53 - t120 * t52) * mrSges(7,3) + (t97 * mrSges(6,3) + pkin(11) * t122 + t163 * t206 + t212) * t166 + (t211 - t96 * mrSges(6,3) - pkin(11) * t123 - t163 * t129 / 0.2e1) * t162 + m(7) * (t124 * t144 + t52 * t91 + t53 * t92) + m(6) * (-pkin(4) * t204 + (-t162 * t96 + t166 * t97) * pkin(11)) + (-pkin(10) * mrSges(5,2) - t181) * t167 + t186; -0.2e1 * pkin(4) * t126 + t119 * t84 + t120 * t85 + t166 * t129 + t162 * t131 + 0.2e1 * t144 * t82 + Ifges(5,3) + m(7) * (t144 ^ 2 + t91 ^ 2 + t92 ^ 2) + m(6) * (pkin(11) ^ 2 * t185 + pkin(4) ^ 2) + 0.2e1 * (t119 * t92 - t120 * t91) * mrSges(7,3) + 0.2e1 * t185 * pkin(11) * mrSges(6,3); t6 * mrSges(6,1) - t7 * mrSges(6,2) + (t161 * t18 + t165 * t19 + m(7) * (t161 * t3 + t165 * t2)) * pkin(5) + t173 + t20; t86 * mrSges(6,1) - t87 * mrSges(6,2) + m(7) * (t161 * t56 + t165 * t55) * pkin(5) + t180; t96 * mrSges(6,1) - t97 * mrSges(6,2) + t202 * t167 + (t165 * t94 + t161 * t93 + m(7) * (t161 * t53 + t165 * t52)) * pkin(5) + t175 + t179; -t178 * pkin(11) + (m(7) * (t161 * t92 + t165 * t91) + (t119 * t161 - t120 * t165) * mrSges(7,3)) * pkin(5) + t174 + t128; m(7) * (t161 ^ 2 + t165 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t172 - t202; t173; t180; t175 - t198; t174; Ifges(7,3) + t172; Ifges(7,3);];
