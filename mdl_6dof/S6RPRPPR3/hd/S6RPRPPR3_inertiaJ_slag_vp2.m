...
t11 = [0.2e1 * t1 * t14 + t8 * t69 + 0.2e1 * t2 * t13 + 0.2e1 * t4 * t28 + Ifges(2,3) + Ifges(3,3) + (-0.2e1 * t24 * mrSges(4,1) + mrSges(5,1) * t71 - 0.2e1 * t4 * mrSges(6,2) + mrSges(6,3) * t69 + t41 * t5 - t43 * t6 + (Ifges(5,3) + Ifges(4,2) + Ifges(6,1)) * t44) * t44 + (0.2e1 * t24 * mrSges(4,2) + mrSges(5,3) * t71 - 0.2e1 * t9 * mrSges(6,3) + (Ifges(6,2) + Ifges(5,1) + Ifges(4,1)) * t42 + ((2 * Ifges(4,4)) + (2 * Ifges(6,4)) - (2 * Ifges(5,5)) - t64) * t44 + t58) * t42 + m(7) * (t1 ^ 2 + t2 ^ 2 + t70) + m(6) * (t4 ^ 2 + t9 ^ 2 + t70) + m(5) * (t7 ^ 2 + t59) + m(4) * (t24 ^ 2 + t59) + (mrSges(5,2) + mrSges(4,3)) * t23 * t73 + (0.2e1 * t39 * mrSges(3,1) - 0.2e1 * t38 * mrSges(3,2) + m(3) * (t38 ^ 2 + t39 ^ 2) * pkin(1)) * pkin(1); -t42 * t8 + t48 * t44 + m(7) * (t44 * t50 + t62) + m(6) * (-t9 * t44 + t62); m(3) + m(7) * (t37 * t55 + t35) + (m(5) / 0.2e1 + m(6) / 0.2e1 + m(4) / 0.2e1) * t73; t9 * mrSges(6,2) - t40 * t8 + (t15 + mrSges(6,1)) * t10 + (-t5 / 0.2e1 - t2 * mrSges(7,3) + t33 * t13) * t43 + (-t6 / 0.2e1 + t1 * mrSges(7,3) - t33 * t14) * t41 + m(7) * (t40 * t10 - t33 * t50) + m(6) * (qJ(4) * t10 + t45 * t9) + (-t65 / 0.2e1 - t63 / 0.2e1 + Ifges(6,6) + Ifges(5,4) + Ifges(4,5) - pkin(3) * mrSges(5,2) - t45 * mrSges(6,3) + (-mrSges(4,1) + t54) * t23) * t42 + (Ifges(6,5) - Ifges(5,6) + Ifges(4,6) + t41 * t16 / 0.2e1 - t43 * t17 / 0.2e1 + t60 * t23 + t51 * qJ(4)) * t44; t28 + (t15 + t60) * t42 + (mrSges(4,1) + mrSges(5,1) + t74) * t44 + m(7) * (-t33 * t44 * t55 + t40 * t42) + m(5) * t57 + m(6) * (-t45 * t44 + t25); 0.2e1 * pkin(3) * mrSges(5,1) + 0.2e1 * t45 * mrSges(6,2) + 0.2e1 * t40 * t15 - t43 * t16 - t41 * t17 + Ifges(5,2) + Ifges(4,3) + Ifges(6,3) + m(7) * (t33 ^ 2 * t55 + t40 ^ 2) + m(5) * (pkin(3) ^ 2 + t46) + m(6) * (t45 ^ 2 + t46) + 0.2e1 * (mrSges(5,3) + mrSges(6,1)) * qJ(4) - 0.2e1 * t33 * t53; m(6) * t9 - m(7) * t50 + t42 * t51 - t48; -t76 * t44; m(6) * t45 + t12 * t33 + t54 - t74; t76; -t44 * mrSges(6,2) + t41 * t13 + t43 * t14 + t28 + m(7) * (t43 * t1 + t41 * t2) + m(6) * t4; 0; 0; 0; t68; t1 * mrSges(7,1) - t2 * mrSges(7,2) - t44 * t64 + t58; t8; -t33 * t49 - t63 - t65; -t49; t15; Ifges(7,3);];
