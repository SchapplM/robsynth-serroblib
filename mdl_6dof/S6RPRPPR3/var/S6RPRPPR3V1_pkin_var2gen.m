% Umwandlung der Kinematikparameter von S6RPRPPR3V1 zu S6RPRPPR3
% Eingabe:
% pkin_var (8x1) double
...
%
% Siehe auch: S6RPRPPR3_structural_kinematic_parameters.m
function pkin_gen = S6RPRPPR3V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
