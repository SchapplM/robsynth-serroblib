...
t6 = [(-t27 + t200) * t63 + ((-0.2e1 * t100 * mrSges(3,3) + Ifges(3,5) * t152 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t155) * t150) * t155 + (0.2e1 * t101 * mrSges(3,3) + Ifges(3,6) * t152 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t155 + (Ifges(3,2) + t191) * t158) * t150 + t162) * t158) * t150 + (t167 - 0.2e1 * t183 + 0.2e1 * t184) * t152 + t98 * t56 + t99 * t57 + 0.2e1 * t54 * t83 + 0.2e1 * t53 * t84 + 0.2e1 * t88 * t70 + t64 * t28 + 0.2e1 * t67 * t30 + 0.2e1 * t16 * t51 + 0.2e1 * t15 * t52 + 0.2e1 * t3 * t26 + 0.2e1 * t5 * t20 + 0.2e1 * t13 * t21 + 0.2e1 * t2 * t23 + 0.2e1 * t4 * t24 + 0.2e1 * t1 * t25 + m(4) * (t53 ^ 2 + t54 ^ 2 + t88 ^ 2) + m(5) * (t15 ^ 2 + t16 ^ 2 + t67 ^ 2) + m(6) * (t13 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(3) * (pkin(1) ^ 2 * t150 ^ 2 + t100 ^ 2 + t101 ^ 2) + (t11 + t12) * t44 + (t9 + t10) * t43 + Ifges(2,3); -t199 * t177 / 0.2e1 - t183 + t184 + t167 + (t28 / 0.2e1 - t15 * mrSges(5,3) + t170 * t156 + t171 * t153) * t110 + t168 * t44 + t169 * t43 + m(4) * (-pkin(2) * t88 + (-t53 * t154 + t54 * t157) * pkin(9)) + t136 * t30 + t88 * t115 + t98 * t121 / 0.2e1 + t99 * t124 / 0.2e1 + t82 * t51 + t5 * t68 + t13 * t69 - pkin(2) * t70 + t2 * t72 + t4 * t73 + t1 * t74 + t3 * t75 + t67 * t76 + t64 * t78 / 0.2e1 + t55 * t20 + t29 * t23 + t33 * t26 + t34 * t24 + t22 * t25 + (t8 / 0.2e1 + t7 / 0.2e1 - t27 / 0.2e1 - t16 * mrSges(5,3)) * t109 + (t21 - t52) * t80 + (t56 / 0.2e1 + pkin(9) * t83 + t54 * mrSges(4,3)) * t157 + (-pkin(9) * t84 - t53 * mrSges(4,3) + t57 / 0.2e1) * t154 + m(6) * (t13 * t80 + t3 * t33 + t34 * t4) + m(7) * (t1 * t22 + t2 * t29 + t5 * t55) + m(5) * (t136 * t67 - t15 * t80 + t16 * t82) + (-t77 / 0.2e1 + t45 / 0.2e1 + t46 / 0.2e1) * t63; -0.2e1 * pkin(2) * t115 + t157 * t121 + t154 * t124 + 0.2e1 * t136 * t76 + 0.2e1 * t22 * t74 + 0.2e1 * t29 * t72 + 0.2e1 * t33 * t75 + 0.2e1 * t34 * t73 + 0.2e1 * t55 * t68 + t69 * t197 + Ifges(3,3) + 0.2e1 * t172 * pkin(9) * mrSges(4,3) + (-0.2e1 * mrSges(5,3) * t82 + t45 + t46 - t77) * t109 + m(6) * (t33 ^ 2 + t34 ^ 2 + t198) + m(7) * (t22 ^ 2 + t29 ^ 2 + t55 ^ 2) + m(4) * (pkin(9) ^ 2 * t172 + pkin(2) ^ 2) + m(5) * (t136 ^ 2 + t82 ^ 2 + t198) + (mrSges(5,3) * t197 + t78 + (t49 + t50) * t156 + (-t47 - t48) * t153) * t110; -t162 + t135 * t21 + t112 * t20 + t5 * t113 - t107 * t25 + t108 * t23 + t53 * mrSges(4,1) - t54 * mrSges(4,2) + t15 * mrSges(5,1) - t16 * mrSges(5,2) - t191 * t177 + (t4 * mrSges(6,3) + t2 * mrSges(7,3) + (m(6) * t4 + t24) * t134 - t171) * t156 + (-t3 * mrSges(6,3) - t1 * mrSges(7,3) + (-m(6) * t3 - t26) * t134 + t170) * t153 + (t149 * t51 + t151 * t52 + m(5) * (t149 * t16 + t15 * t151)) * pkin(3) + m(7) * (-t1 * t107 + t108 * t2 + t112 * t5) + t166 * t63 + t164 * t44 + t165 * t43 + (m(6) * t135 + t114) * t13; -t82 * mrSges(5,2) - t107 * t74 + t108 * t72 + t112 * t68 + t55 * t113 + t135 * t69 + (t114 - mrSges(5,1)) * t80 + (-mrSges(4,1) * t154 - mrSges(4,2) * t157) * pkin(9) + (-mrSges(5,3) * t193 + t166) * t109 + (t34 * mrSges(6,3) + t29 * mrSges(7,3) + t134 * t73 + t169) * t156 + (-t33 * mrSges(6,3) - t22 * mrSges(7,3) - t134 * t75 + t168) * t153 + m(6) * (t135 * t80 + (-t153 * t33 + t156 * t34) * t134) + m(7) * (-t107 * t22 + t108 * t29 + t112 * t55) + m(5) * (t149 * t82 - t151 * t80) * pkin(3) + (-mrSges(5,3) * t192 - t153 * t165 + t156 * t164) * t110 + t199; 0.2e1 * t112 * t113 + 0.2e1 * t135 * t114 + (t108 * t202 + t119 + t120) * t156 + (t107 * t202 + t122 + t123) * t153 + m(7) * (t107 ^ 2 + t108 ^ 2 + t112 ^ 2) + m(6) * (t134 ^ 2 * t173 + t135 ^ 2) + m(5) * (t149 ^ 2 + t151 ^ 2) * pkin(3) ^ 2 + t191 + 0.2e1 * (mrSges(5,1) * t151 - mrSges(5,2) * t149) * pkin(3) + t134 * mrSges(6,3) * t201; (t25 + t26) * t156 + (t23 + t24) * t153 + m(7) * (t1 * t156 + t153 * t2) + m(6) * (t153 * t4 + t156 * t3) + m(5) * t67 + t30; (t74 + t75) * t156 + (t72 + t73) * t153 + m(7) * (t153 * t29 + t156 * t22) + m(6) * (t153 * t34 + t156 * t33) + m(5) * t136 + t76; m(7) * (-t107 * t156 + t108 * t153); m(5) + (m(6) / 0.2e1 + m(7) / 0.2e1) * t201; mrSges(6,1) * t3 + mrSges(7,1) * t1 - mrSges(6,2) * t4 - mrSges(7,2) * t2 + (m(7) * t1 + t25) * pkin(5) + t200; mrSges(6,1) * t33 + mrSges(7,1) * t22 - mrSges(6,2) * t34 - mrSges(7,2) * t29 + (-Ifges(6,6) - Ifges(7,6)) * t180 + (m(7) * t22 + t74) * pkin(5) + t181 + t182; -mrSges(7,1) * t107 - mrSges(7,2) * t108 - t161 * t134 + (-m(7) * t107 - t153 * mrSges(7,3)) * pkin(5) + t118 + t117; -t189 - t138 + (mrSges(6,1) + mrSges(7,1) + t196) * t156; Ifges(6,3) + Ifges(7,3) + (0.2e1 * mrSges(7,1) + t196) * pkin(5); m(7) * t5 + t20; m(7) * t55 + t68; m(7) * t112 + t113; 0; 0; m(7);];
