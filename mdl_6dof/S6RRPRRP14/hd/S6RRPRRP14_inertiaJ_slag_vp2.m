...
% OptimizationMode: 2
% StartTime: 2019-03-09 13:03:48
% EndTime: 2019-03-09 13:03:51
...
t21 = -mrSges(7,2) * t37 + mrSges(7,3) * t62;
t22 = -mrSges(6,2) * t62 - mrSges(6,3) * t37;
t174 = t21 + t22;
t23 = mrSges(6,1) * t62 - mrSges(6,3) * t38;
t24 = -t62 * mrSges(7,1) + t38 * mrSges(7,2);
t173 = -t23 + t24;
...
t71 = -mrSges(6,2) * t126 - mrSges(6,3) * t163;
t72 = t126 * mrSges(6,1) - mrSges(6,3) * t161;
t74 = -mrSges(7,2) * t163 + mrSges(7,3) * t126;
...
t12 = [0.2e1 * t1 * t21 + 0.2e1 * t13 * t20 + 0.2e1 * t15 * t44 + 0.2e1 * t16 * t43 + 0.2e1 * t5 * t19 + 0.2e1 * t2 * t24 + 0.2e1 * t4 * t22 + 0.2e1 * t3 * t23 + t63 * t26 + 0.2e1 * t40 * t27 + 0.2e1 * t48 * t69 + 0.2e1 * t50 * t70 + Ifges(2,3) + (t10 + t11) * t38 + (t6 - t9) * t37 + (-t25 + t182) * t62 + (t145 - 0.2e1 * t176 + 0.2e1 * t177) * t124 + m(4) * (t48 ^ 2 + t49 ^ 2 + t50 ^ 2) + m(5) * (t15 ^ 2 + t16 ^ 2 + t40 ^ 2) + m(6) * (t13 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(3) * (t64 ^ 2 + t65 ^ 2) + (t127 * t155 + 0.2e1 * t49 * (mrSges(4,2) * t130 - mrSges(4,3) * t127) + (m(3) * pkin(1) ^ 2 + (0.2e1 * pkin(1) * mrSges(3,1) + (Ifges(3,2) + Ifges(4,3)) * t130) * t130 + (-0.2e1 * pkin(1) * mrSges(3,2) + (Ifges(4,2) + Ifges(3,1)) * t127 + 0.2e1 * (Ifges(3,4) + Ifges(4,6)) * t130) * t127) * t123 + 0.2e1 * (-t64 * t127 + t65 * t130) * mrSges(3,3) + ((-(2 * Ifges(4,5)) + Ifges(3,6)) * t130 + (-(2 * Ifges(4,4)) + Ifges(3,5)) * t127) * t124) * t123; t145 + (t131 * t43 - t16 * mrSges(5,3) - t25 / 0.2e1 + t7 / 0.2e1 + t8 / 0.2e1) * t126 + (-t15 * mrSges(5,3) + t26 / 0.2e1 + t172 * t131 + t154 * t128 + t156 * t125) * t129 + m(6) * (-t131 * t166 + t3 * t45 + t4 * t46) + (-t69 + t27) * qJ(3) + t153 * t37 + m(7) * (t1 * t39 + t2 * t42 + t47 * t5) + m(4) * (-pkin(2) * t50 - qJ(3) * t48) + (-t84 / 0.2e1 + t52 / 0.2e1 + t53 / 0.2e1) * t62 + t152 * t38 + m(5) * (qJ(3) * t40 + t131 * t136) + t3 * t72 + t2 * t73 + t1 * t74 + t40 * t79 + t63 * t87 / 0.2e1 + t5 * t66 + t13 * t67 - pkin(2) * t70 + t4 * t71 + t50 * mrSges(4,2) + t39 * t21 + t42 * t24 + t45 * t23 + t46 * t22 + t47 * t19 - t48 * mrSges(4,3) - t176 + t177 + (-Ifges(4,5) * t130 + t127 * (-Ifges(5,6) * t126 + t114) / 0.2e1 - Ifges(4,4) * t127) * t123; -0.2e1 * pkin(2) * mrSges(4,2) + 0.2e1 * t39 * t74 + 0.2e1 * t42 * t73 + 0.2e1 * t45 * t72 + 0.2e1 * t46 * t71 + 0.2e1 * t47 * t66 + (-t84 + t181) * t126 + m(5) * (t119 * t122 + t104 + t132) + m(4) * (pkin(2) ^ 2 + t132) + m(6) * (t45 ^ 2 + t46 ^ 2 + t104) + m(7) * (t39 ^ 2 + t42 ^ 2 + t47 ^ 2) + (-0.2e1 * t131 * t67 + t87 + (t55 + t56) * t128 + (t51 - t54) * t125) * t129 + 0.2e1 * (t79 + mrSges(4,3)) * qJ(3) + 0.2e1 * t131 * t146 + t183; (-t19 + t172) * t129 + (t173 * t125 + t174 * t128 + t43) * t126 + m(7) * (t126 * t143 - t129 * t5) + m(6) * (t126 * t142 - t166) + m(5) * t136 + m(4) * t50 + t70; -m(4) * pkin(2) + mrSges(4,2) + (-t66 - t67) * t129 + t146 + t135 * t126 + m(7) * (t126 * t138 - t129 * t47) + m(6) * (t126 * t137 + t105) + m(5) * (t119 * t131 + t105); m(4) - m(5) * t157 + 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * (t119 * t158 + t121); t15 * mrSges(5,1) - t16 * mrSges(5,2) - pkin(4) * t20 + t13 * t78 + t76 * t19 + t5 * t77 + t150 * t62 + t149 * t38 + t151 * t37 + (t1 * mrSges(7,2) + t4 * mrSges(6,3) + pkin(10) * t174 - t156) * t128 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + pkin(10) * t173 + t154) * t125 + m(7) * (pkin(10) * t143 + t5 * t76) + m(6) * (-pkin(4) * t13 + pkin(10) * t142) + t155; -pkin(4) * t67 + t76 * t66 + t114 + (m(7) * t76 + t77) * t47 + (t39 * mrSges(7,2) + t46 * mrSges(6,3) - t153) * t128 + (t42 * mrSges(7,2) - t45 * mrSges(6,3) + t152) * t125 + (m(6) * t137 + m(7) * t138 + t135) * pkin(10) + (t149 * t128 + t151 * t125 + (m(6) * pkin(4) + t175) * t131) * t129 + (-t131 * mrSges(5,2) - Ifges(5,6) + t150) * t126; (-t77 + t175) * t129 + m(6) * (pkin(4) * t129 + t160) + m(7) * (-t129 * t76 + t160) + (-mrSges(5,2) + t180) * t126; -0.2e1 * pkin(4) * t78 + 0.2e1 * t76 * t77 + Ifges(5,3) + (-t80 + t83) * t128 + (t85 + t86) * t125 + m(6) * (pkin(4) ^ 2 + t159) + m(7) * (t76 ^ 2 + t159) + 0.2e1 * pkin(10) * t180; -pkin(5) * t24 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + qJ(6) * t21 + t1 * mrSges(7,3) - t2 * mrSges(7,1) - t4 * mrSges(6,2) + t3 * mrSges(6,1) + t182; -pkin(5) * t73 + m(7) * (-pkin(5) * t42 + qJ(6) * t39) + qJ(6) * t74 + t39 * mrSges(7,3) - t46 * mrSges(6,2) + t45 * mrSges(6,1) - t42 * mrSges(7,1) + t181; t134 * t126; mrSges(7,2) * t139 + pkin(10) * t134 + t81 + t82; Ifges(7,2) + Ifges(6,3) + 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2); m(7) * t2 + t24; m(7) * t42 + t73; m(7) * t125 * t126; (m(7) * pkin(10) + mrSges(7,2)) * t125; -m(7) * pkin(5) - mrSges(7,1); m(7);];
