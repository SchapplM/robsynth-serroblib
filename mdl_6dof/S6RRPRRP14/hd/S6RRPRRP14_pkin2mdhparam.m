...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S6RRPRRP14_pkin2mdhparam(pkin)
...
t1 = [pkin(7); pkin(8); 0; pkin(9); pkin(10); 0;];
d_mdh = t1;
