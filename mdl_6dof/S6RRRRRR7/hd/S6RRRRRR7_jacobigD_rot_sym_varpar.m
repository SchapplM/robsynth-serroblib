...
elseif link_index == 6
	...
	% DurationCPUTime: 0.09s
	% Computational Cost: add. (54->16), mult. (182->40), div. (0->0), fcn. (188->8), ass. (0->24)
	t182 = sin(pkin(6));
	t187 = cos(qJ(3));
	t201 = t182 * t187;
	t189 = cos(qJ(1));
	...
	t191 = t183 * t198 + t197;
	t190 = -t183 * t199 + t196;
	t181 = t182 * t188 * t194 + (t183 * t184 + t185 * t201) * qJD(3);
	t180 = (-t184 * t200 + t191 * t187) * qJD(3) + t193 * t194 + (t190 * t184 - t186 * t201) * qJD(1);
	t179 = (t186 * t182 * t184 + t190 * t187) * qJD(3) - t192 * t194 + (-t191 * t184 - t187 * t200) * qJD(1);
	t1 = [0, t189 * t195, t193 * qJD(1) + t190 * qJD(2), t179, t179, t179; 0, t186 * t195, t192 * qJD(1) + t191 * qJD(2), t180, t180, t180; 0, 0, t182 * qJD(2) * t185, t181, t181, t181;];
	JgD_rot = t1;
else
	JgD_rot=NaN(3,6);
end