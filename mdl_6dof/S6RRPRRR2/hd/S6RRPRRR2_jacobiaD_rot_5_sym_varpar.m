...
function JaD_rot = S6RRPRRR2_jacobiaD_rot_5_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRPRRR2_jacobiaD_rot_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRPRRR2_jacobiaD_rot_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRPRRR2_jacobiaD_rot_5_sym_varpar: pkin has to be [11x1] (double)');
...
t216 = t172 * t178;
t200 = t168 * t216;
t137 = qJD(1) * t187 - t157 * qJD(5) + t175 * t200;
t212 = t176 * t177;
t215 = t175 * t178;
t156 = t169 * t215 - t212;
t149 = t156 ^ 2;
