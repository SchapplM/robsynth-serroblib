...
function JaD_rot = S6RRRRPP7_jacobiaD_rot_5_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRPP7_jacobiaD_rot_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRRPP7_jacobiaD_rot_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RRRRPP7_jacobiaD_rot_5_sym_varpar: pkin has to be [11x1] (double)');

%% Symbolic Calculation
% From jacobiaD_rot_5_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 22:28:55
% EndTime: 2019-02-26 22:28:57
...
t278 = -t263 * t297 - t315;
t225 = qJD(1) * t280 + qJD(2) * t278;
t238 = t248 * t266 + t264 * t299;
t296 = qJD(1) * t316;
t203 = qJD(3) * t238 + t225 * t264 - t266 * t296;
t329 = t203 * t197;
t228 = t232 ^ 2;
t241 = 0.1e1 / t243 ^ 2;
...
t339 = t264 * t281;
t206 = t264 * (qJD(3) * t280 + t287) + t341 * t266;
t261 = qJ(4) + pkin(11);
t259 = sin(t261);
t260 = cos(t261);
...
t338 = -0.2e1 * t232;
t337 = -0.2e1 * t279;
t204 = qJD(3) * t279 + t225 * t266 + t264 * t296;
...
t231 = -qJD(3) * t243 + t266 * t295;
t226 = qJD(1) * t278 + qJD(2) * t280;
