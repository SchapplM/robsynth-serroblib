...
t196 = t83 ^ 2 + t85 ^ 2;
t195 = -Ifges(7,2) - Ifges(6,3) - Ifges(5,3);
...
t2 = -pkin(5) * t117 - t3;
t1 = qJ(6) * t117 + t4;
t6 = [(t188 - 0.2e1 * t206 + 0.2e1 * t207) * t174 + ((-0.2e1 * t119 * mrSges(3,3) + Ifges(3,5) * t174 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t177) * t172) * t177 + (0.2e1 * t120 * mrSges(3,3) + Ifges(3,6) * t174 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t177 + (Ifges(3,2) + Ifges(4,3)) * t180) * t172 + t199) * t180) * t172 + 0.2e1 * t19 * t49 + 0.2e1 * t18 * t50 + 0.2e1 * t46 * t41 + 0.2e1 * t1 * t20 + 0.2e1 * t4 * t21 + 0.2e1 * t3 * t22 + 0.2e1 * t2 * t23 + 0.2e1 * t24 * t17 + 0.2e1 * t5 * t16 + m(3) * (pkin(1) ^ 2 * t172 ^ 2 + t119 ^ 2 + t120 ^ 2) + m(4) * (t104 ^ 2 + t51 ^ 2 + t52 ^ 2) + m(5) * (t18 ^ 2 + t19 ^ 2 + t46 ^ 2) + m(6) * (t24 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + (t12 + t13) * t40 + (-t11 + t8) * t39 + (-t59 + t218) * t117 + t79 * t26 + t80 * t27 + 0.2e1 * t52 * t86 + 0.2e1 * t51 * t87 + 0.2e1 * t104 * t63 + Ifges(2,3) + t118 * t60; -t198 * t204 / 0.2e1 + t191 * t40 + t192 * t39 - t193 * t111 + t194 * t110 + t5 * t61 + t24 * t62 - pkin(2) * t63 + t48 * t16 + t30 * t22 + t31 * t21 + t28 * t20 + t29 * t23 + (t54 / 0.2e1 + t55 / 0.2e1 + t107 / 0.2e1 - t142 / 0.2e1) * t117 + (pkin(9) * t86 + t52 * mrSges(4,3) + t59 / 0.2e1 - t25 / 0.2e1 - t9 / 0.2e1 - t10 / 0.2e1) * t179 + m(6) * (t135 * t24 + t3 * t30 + t31 * t4) + m(7) * (t1 * t28 + t2 * t29 + t48 * t5) + t188 - t206 + t207 + m(4) * (-pkin(2) * t104 + (-t51 * t176 + t52 * t179) * pkin(9)) + t1 * t88 + t4 * t89 + t3 * t90 + t2 * t91 + m(5) * (t46 * t166 + t18 * t95 + t19 * t96) + t95 * t50 + t96 * t49 + t46 * t127 + t19 * t133 + t18 * t134 + (-t175 * t26 / 0.2e1 - t51 * mrSges(4,3) + t178 * t217 + t60 / 0.2e1 + (-t87 + t41) * pkin(9)) * t176 + t135 * t17 + t104 * t138 + t118 * t144 / 0.2e1 + t80 * t215 + t79 * t216; -0.2e1 * pkin(2) * t138 + 0.2e1 * t96 * t133 + 0.2e1 * t95 * t134 + 0.2e1 * t135 * t62 + 0.2e1 * t28 * t88 + 0.2e1 * t29 * t91 + 0.2e1 * t30 * t90 + 0.2e1 * t31 * t89 + 0.2e1 * t48 * t61 + Ifges(3,3) - (t57 + t58) * t111 + (t53 - t56) * t110 + (t168 + t170) * mrSges(4,3) * t219 + (-t54 - t55 - t107 + t142) * t179 + (-t108 * t175 + t109 * t178 + t127 * t219 + t144) * t176 + m(5) * (t95 ^ 2 + t96 ^ 2 + t165) + m(6) * (t135 ^ 2 + t30 ^ 2 + t31 ^ 2) + m(7) * (t28 ^ 2 + t29 ^ 2 + t48 ^ 2) + m(4) * (pkin(2) ^ 2 + t170 * t182 + t165); t189 * t40 + t190 * t39 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + t193) * t129 + (-t1 * mrSges(7,2) - t4 * mrSges(6,3) + t194) * t128 + t186 * t117 + t64 * t16 + t5 * t69 + t24 * t70 + t51 * mrSges(4,1) - t52 * mrSges(4,2) - pkin(3) * t41 + (t20 + t21) * t85 + (t23 - t22) * t83 + (pkin(10) * t49 + t19 * mrSges(5,3) + t26 / 0.2e1) * t178 + (-t18 * mrSges(5,3) - pkin(10) * t50 + t217) * t175 + m(5) * (-pkin(3) * t46 + (-t18 * t175 + t19 * t178) * pkin(10)) - t199 - Ifges(4,3) * t204 + t46 * t137 + t79 * t141 / 0.2e1 + t80 * t214 + t158 * t17 + m(6) * (t158 * t24 - t3 * t83 + t4 * t85) + m(7) * (t1 * t85 + t2 * t83 + t5 * t64); -pkin(3) * t127 + t135 * t70 + t158 * t62 + t48 * t69 + t64 * t61 + (t88 + t89) * t85 + (-t90 + t91) * t83 - t189 * t111 + t190 * t110 + (-mrSges(4,1) + t137) * t166 + (t96 * mrSges(5,3) + pkin(10) * t133 + t176 * t214 + t216) * t178 + (-pkin(10) * t134 - t95 * mrSges(5,3) - t176 * t141 / 0.2e1 + t215) * t175 + m(5) * (-pkin(3) * t166 + (-t175 * t95 + t178 * t96) * pkin(10)) + m(6) * (t135 * t158 - t30 * t83 + t31 * t85) + m(7) * (t28 * t85 + t29 * t83 + t48 * t64) + (-pkin(9) * mrSges(4,2) - t186) * t179 + (t29 * mrSges(7,2) - t30 * mrSges(6,3) + t191) * t129 + (-t28 * mrSges(7,2) - t31 * mrSges(6,3) + t192) * t128 + t198; -0.2e1 * pkin(3) * t137 + t178 * t141 + t175 * t143 + 0.2e1 * t158 * t70 + 0.2e1 * t64 * t69 + Ifges(4,3) + m(6) * (t158 ^ 2 + t196) + m(7) * (t64 ^ 2 + t196) + m(5) * (t197 * pkin(10) ^ 2 + pkin(3) ^ 2) + (t75 + t76) * t129 + (t71 - t74) * t128 + 0.2e1 * t197 * pkin(10) * mrSges(5,3) + 0.2e1 * (-t128 * t85 + t129 * t83) * (mrSges(7,2) + mrSges(6,3)); -t4 * mrSges(6,2) + t3 * mrSges(6,1) - t2 * mrSges(7,1) + t157 * t23 + t1 * mrSges(7,3) + m(7) * (t1 * t154 + t157 * t2) + t154 * t20 + t18 * mrSges(5,1) - t19 * mrSges(5,2) + (m(6) * (t171 * t4 + t173 * t3) + t171 * t21 + t173 * t22) * pkin(4) + t218; -t29 * mrSges(7,1) - t31 * mrSges(6,2) + t30 * mrSges(6,1) + t157 * t91 + t28 * mrSges(7,3) + t154 * t88 + m(7) * (t154 * t28 + t157 * t29) - t96 * mrSges(5,2) + t95 * mrSges(5,1) + t195 * t179 + (m(6) * (t171 * t31 + t173 * t30) + t173 * t90 + t171 * t89) * pkin(4) + t185 + t200 + t201; -t83 * mrSges(7,1) + t85 * mrSges(7,3) - t85 * mrSges(6,2) - t83 * mrSges(6,1) + m(7) * (t154 * t85 + t157 * t83) - t184 * pkin(10) + (-t128 * t154 + t129 * t157) * mrSges(7,2) + (m(6) * (t171 * t85 - t173 * t83) + (-t128 * t171 - t129 * t173) * mrSges(6,3)) * pkin(4) + t140 + t73 + t72; -0.2e1 * t157 * mrSges(7,1) + 0.2e1 * t154 * mrSges(7,3) + m(7) * (t154 ^ 2 + t157 ^ 2) - t195 + (0.2e1 * mrSges(6,1) * t173 - 0.2e1 * mrSges(6,2) * t171 + m(6) * (t171 ^ 2 + t173 ^ 2) * pkin(4)) * pkin(4); m(6) * t24 + m(7) * t5 + t16 + t17; m(6) * t135 + m(7) * t48 + t61 + t62; m(6) * t158 + m(7) * t64 + t69 + t70; 0; m(6) + m(7); m(7) * t2 + t23; m(7) * t29 + t91; m(7) * t83 + t129 * mrSges(7,2); m(7) * t157 - mrSges(7,1); 0; m(7);];
