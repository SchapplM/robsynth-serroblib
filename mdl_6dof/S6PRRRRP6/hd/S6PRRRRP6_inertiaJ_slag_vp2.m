...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:31:11
% EndTime: 2018-11-23 15:31:13
...
t2 = -pkin(5) * t73 - t3;
t1 = qJ(6) * t73 + t4;
t6 = [m(2) + m(5) * (t24 ^ 2 + t186 + t21) + m(4) * (t40 ^ 2 + t72 ^ 2 + t186) + m(3) * (t132 ^ 2 + (t136 ^ 2 + t140 ^ 2) * t130 ^ 2) + (m(6) + m(7)) * (t10 ^ 2 + t8 ^ 2 + t21); t24 * t48 + t40 * t82 + t72 * t75 + t180 * t8 + (t36 - t81) * t38 + (mrSges(3,1) * t140 - mrSges(3,2) * t136) * t130 + t181 * t10 + (t17 + t179) * t22 + m(6) * (t10 * t4 + t22 * t26 - t3 * t8) + m(7) * (t1 * t10 + t2 * t8 + t22 * t5) + m(5) * (-t22 * t32 + t24 * t33 + t38 * t58) + m(4) * (-pkin(2) * t129 * t72 - t38 * t76 + t40 * t77); t131 * t150 + t74 * t35 + 0.2e1 * t76 * t81 + 0.2e1 * t77 * t82 + 0.2e1 * t32 * t49 + 0.2e1 * t58 * t36 + 0.2e1 * t33 * t48 + 0.2e1 * t26 * t18 + 0.2e1 * t1 * t28 + 0.2e1 * t4 * t29 + 0.2e1 * t3 * t30 + 0.2e1 * t2 * t31 + 0.2e1 * t5 * t17 + Ifges(3,3) + (t15 + t16) * t47 + (t11 - t14) * t46 + (-t34 + t188) * t73 + (-0.2e1 * pkin(2) * t75 + (Ifges(4,1) * t166 + Ifges(4,5) * t131) * t135 + (Ifges(4,6) * t131 + (0.2e1 * Ifges(4,4) * t135 + (Ifges(4,2) + Ifges(5,3)) * t139) * t129 + t178) * t139) * t129 + m(4) * (pkin(2) ^ 2 * t129 ^ 2 + t76 ^ 2 + t77 ^ 2) + m(5) * (t32 ^ 2 + t33 ^ 2 + t58 ^ 2) + m(6) * (t26 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2); mrSges(5,3) * t167 - t40 * mrSges(4,2) + t176 * t8 + (-mrSges(4,1) + t92) * t38 + t177 * t10 + (t134 * mrSges(5,3) + t78 + t79) * t22 + m(6) * (pkin(10) * t169 + t10 * t56 - t55 * t8) + m(7) * (t10 * t50 + t22 * t67 + t51 * t8) + m(5) * (-pkin(3) * t38 + (t167 + t169) * pkin(10)); t150 + (t35 / 0.2e1 - t32 * mrSges(5,3) + t157 * t137 + t158 * t133 + t179 * pkin(10)) * t134 - t160 * t165 / 0.2e1 + t155 * t47 + t156 * t46 + m(5) * (-pkin(3) * t58 + (-t32 * t134 + t33 * t138) * pkin(10)) + t58 * t92 + t74 * t100 / 0.2e1 + t76 * mrSges(4,1) - t77 * mrSges(4,2) + t5 * t78 + t26 * t79 + t4 * t83 + t3 * t84 + t2 * t85 + t1 * t86 + t67 * t17 + t50 * t28 + t51 * t31 + t55 * t30 + t56 * t29 - pkin(3) * t36 + (t34 / 0.2e1 - t12 / 0.2e1 - t13 / 0.2e1 + pkin(10) * t48 + t33 * mrSges(5,3)) * t138 + m(6) * (pkin(10) * t134 * t26 + t3 * t55 + t4 * t56) + m(7) * (t1 * t50 + t2 * t51 + t5 * t67) + (-t97 / 0.2e1 + t62 / 0.2e1 + t63 / 0.2e1) * t73; -0.2e1 * pkin(3) * t92 + 0.2e1 * t50 * t86 + 0.2e1 * t51 * t85 + 0.2e1 * t55 * t84 + 0.2e1 * t56 * t83 + 0.2e1 * t67 * t78 + Ifges(4,3) + (t126 + t128) * mrSges(5,3) * t190 + (-t63 - t62 + t97) * t138 + m(7) * (t50 ^ 2 + t51 ^ 2 + t67 ^ 2) + m(6) * (t55 ^ 2 + t56 ^ 2 + t122) + m(5) * (pkin(3) ^ 2 + t128 * t142 + t122) + (t79 * t190 + t100 + (t65 + t66) * t137 + (t61 - t64) * t133) * t134; -t24 * mrSges(5,2) + (t90 + t175) * t22 + m(6) * (-pkin(4) * t22 + t149) + m(7) * (t22 * t88 + t149) + t189 * t191; -Ifges(5,3) * t165 + t32 * mrSges(5,1) - t33 * mrSges(5,2) - pkin(4) * t18 + t88 * t17 + t26 * t91 + t5 * t90 + t153 * t73 + t152 * t47 + t154 * t46 + (t1 * mrSges(7,2) + t4 * mrSges(6,3) + pkin(11) * t181 - t158) * t137 + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + pkin(11) * t180 + t157) * t133 + m(7) * (t5 * t88 + (t1 * t137 + t2 * t133) * pkin(11)) + m(6) * (-pkin(4) * t26 + (-t3 * t133 + t4 * t137) * pkin(11)) - t178; -pkin(4) * t79 + t88 * t78 + (m(7) * t88 + t90) * t67 + (-pkin(10) * mrSges(5,2) - t153) * t138 + (t50 * mrSges(7,2) + t56 * mrSges(6,3) - t156) * t137 + (t51 * mrSges(7,2) - t55 * mrSges(6,3) + t155) * t133 + (t177 * t137 + t176 * t133 + m(6) * (-t133 * t55 + t137 * t56) + m(7) * (t133 * t51 + t137 * t50)) * pkin(11) + (t152 * t137 + t154 * t133 + (-m(6) * pkin(4) + t175) * pkin(10)) * t134 + t160; -0.2e1 * pkin(4) * t91 + 0.2e1 * t88 * t90 + Ifges(5,3) + (-t93 + t96) * t137 + (t98 + t99) * t133 + m(7) * (t88 ^ 2 + t159) + m(6) * (pkin(4) ^ 2 + t159) + 0.2e1 * t189 * pkin(11) * t192; (-mrSges(6,1) + t187) * t8 + (m(7) * qJ(6) - mrSges(6,2) + mrSges(7,3)) * t10; -pkin(5) * t31 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + qJ(6) * t28 + t1 * mrSges(7,3) - t4 * mrSges(6,2) + t3 * mrSges(6,1) - t2 * mrSges(7,1) + t188; qJ(6) * t86 + m(7) * (-pkin(5) * t51 + qJ(6) * t50) + t55 * mrSges(6,1) - t51 * mrSges(7,1) - t56 * mrSges(6,2) - pkin(5) * t85 + t50 * mrSges(7,3) + t182 * t138 + t147 + t161; t143 * mrSges(7,2) + (m(7) * t143 - t144 - t145) * pkin(11) + t95 + t94; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) - t182; m(7) * t8; m(7) * t2 + t31; m(7) * t51 + t85; (m(7) * pkin(11) + mrSges(7,2)) * t133; t187; m(7);];
