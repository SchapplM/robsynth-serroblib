...
function JaD_rot = S6PRRRRP6_jacobiaD_rot_4_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PRRRRP6_jacobiaD_rot_4_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6PRRRRP6_jacobiaD_rot_4_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6PRRRRP6_jacobiaD_rot_4_sym_varpar: pkin has to be [12x1] (double)');

%% Symbolic Calculation
% From jacobiaD_rot_4_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 20:18:07
...
t310 = t284 * t335 + t336;
t321 = qJD(3) * t327;
t245 = t286 * t321 + (qJD(2) * t310 + qJD(3) * t309) * t283;
t259 = 0.1e1 / t262;
t345 = t245 * t259 * t260;
...
t216 = 0.1e1 / t219;
t319 = t355 * t353;
t304 = t287 * t319 - t290 * t354;
t303 = t287 * t354 + t290 * t319;
t328 = t283 * t353;
t322 = t282 * t328;
t307 = -t284 * t303 + t322;
t253 = t286 * t307 - t289 * t304;
...
t205 = t209 * t318 - t237 * t225 + t238 * t245;
t352 = t205 * t216 * t217;
t272 = t303 * qJD(2);
t273 = t304 * qJD(2);
t339 = t284 * t286;
t342 = t304 * t286;
t228 = t273 * t339 - t272 * t289 + (t289 * t307 + t342) * qJD(3);
t340 = t282 * t288;
t220 = qJD(4) * t236 + t228 * t285 + t273 * t340;
...
t227 = qJD(3) * t253 - t272 * t286 - t273 * t338;
...
t308 = -t284 * t337 + t334;
t254 = (qJD(2) * t311 + qJD(3) * t308) * t283;
t246 = t289 * t321 + (qJD(2) * t308 + qJD(3) * t311) * t283;
t230 = -qJD(3) * t256 + t272 * t339 + t273 * t289;
...
t211 = t313 * t239;
t210 = t314 * t239;
t207 = t211 * t318 - t237 * t255 + t238 * t270;
t206 = t210 * t318 - t237 * t251 + t238 * t263;
