...
function Tc_mdh = S6PRRRPR2_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),uint8(0),zeros(12,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PRRRPR2_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S6PRRRPR2_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [12 1]), ...
  'S6PRRRPR2_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [12x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 21:15:01
	% EndTime: 2020-11-04 21:15:01
...
elseif link_index == 5
	...
	t144 = t151 * t161 + t154 * t157;
	t143 = t151 * t158 + t154 * t162;
	t142 = t151 * t157 - t154 * t161;
	t141 = t151 * t162 - t154 * t158;
	...
	t1 = [t138 * t153 + t144 * t150, -t138 * t150 + t144 * t153, -t135, t154 * pkin(1) + t138 * pkin(4) - t135 * qJ(5) - t141 * t146 + t144 * t159 + t160 * t166 + 0; t137 * t153 + t142 * t150, -t137 * t150 + t142 * t153, t136, t151 * pkin(1) + t137 * pkin(4) + t136 * qJ(5) + t142 * t159 + t143 * t146 - t160 * t165 + 0; t140 * t153 - t150 * t163, -t140 * t150 - t153 * t163, t139, t140 * pkin(4) + t139 * qJ(5) + qJ(1) + 0 + t160 * t155 + (t146 * t157 - t158 * t159) * t152; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 6
	...
	t196 = sin(pkin(12)) * pkin(5) + pkin(8) + pkin(9);
	t191 = -pkin(10) - qJ(5);
	t185 = qJ(3) + qJ(4);
	t184 = pkin(12) + qJ(6);
	t183 = cos(t185);
	...
	t176 = t187 * t198 + t189 * t193;
	t175 = t187 * t194 + t189 * t199;
	t174 = t187 * t193 - t189 * t198;
	t173 = t187 * t199 - t189 * t194;
	t172 = t190 * t182 + t183 * t201;
	t171 = t182 * t201 - t190 * t183;
	t170 = -t173 * t183 + t182 * t203;
	t169 = t175 * t183 - t182 * t202;
	t168 = t175 * t182 + t183 * t202;
	t167 = t173 * t182 + t183 * t203;
	t1 = [t170 * t181 + t176 * t180, -t170 * t180 + t176 * t181, -t167, t189 * pkin(1) + t167 * t191 + t170 * t178 - t173 * t179 + t196 * t176 + t197 * t203 + 0; t169 * t181 + t174 * t180, -t169 * t180 + t174 * t181, t168, t187 * pkin(1) - t168 * t191 + t169 * t178 + t196 * t174 + t175 * t179 - t197 * t202 + 0; t172 * t181 - t180 * t200, -t172 * t180 - t181 * t200, t171, -t171 * t191 + t172 * t178 + qJ(1) + 0 + t197 * t190 + (t179 * t193 - t196 * t194) * t188; 0, 0, 0, 1;];
	Tc_mdh = t1;
end