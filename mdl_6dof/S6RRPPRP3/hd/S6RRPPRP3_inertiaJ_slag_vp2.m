...
t81 = t57 * t60;
t80 = t59 * t60;
t79 = mrSges(4,2) - mrSges(5,3);
t78 = -mrSges(6,2) - mrSges(7,2);
...
t5 = [0.2e1 * t1 * t21 + 0.2e1 * t12 * t13 + 0.2e1 * t29 * t14 + 0.2e1 * t15 * t41 + 0.2e1 * t2 * t19 + 0.2e1 * t4 * t20 + 0.2e1 * t3 * t22 + Ifges(2,3) + m(4) * (t25 ^ 2 + t74) + m(3) * (pkin(1) ^ 2 + t74) + m(6) * (t3 ^ 2 + t4 ^ 2 + t90) + m(5) * (t15 ^ 2 + t28 ^ 2 + t90) + m(7) * (t1 ^ 2 + t12 ^ 2 + t2 ^ 2) + (-0.2e1 * pkin(1) * mrSges(3,2) + mrSges(4,3) * t88 + t28 * t89 + (Ifges(5,2) + Ifges(4,1) + Ifges(3,1)) * t58 + t66) * t58 + (0.2e1 * pkin(1) * mrSges(3,1) + mrSges(4,1) * t88 - 0.2e1 * t15 * mrSges(5,2) + t29 * t89 + (Ifges(5,1) + Ifges(4,3) + Ifges(3,2)) * t60 + (-t10 - t11) * t59 + (t8 + t9) * t57 + ((2 * Ifges(3,4)) + (2 * Ifges(5,4)) - (2 * Ifges(4,5)) + t68) * t58) * t60 + 0.2e1 * (mrSges(4,2) + mrSges(3,3)) * pkin(7) * t92; t28 * mrSges(5,2) + t12 * t26 + t36 * t13 + t56 * t14 - t24 * t19 + t23 * t21 + (t27 + mrSges(5,1)) * t29 + (t51 * t20 - t2 * mrSges(7,3) - t4 * mrSges(6,3) - t8 / 0.2e1 - t9 / 0.2e1) * t59 + (-t51 * t22 + t1 * mrSges(7,3) + t3 * mrSges(6,3) - t10 / 0.2e1 - t11 / 0.2e1) * t57 + m(5) * (qJ(3) * t29 + t61 * t28) + m(6) * (t56 * t29 + t64 * t51) + m(7) * (t23 * t1 + t36 * t12 - t24 * t2) + (-pkin(2) * mrSges(4,2) - t61 * mrSges(5,3) + Ifges(4,4) + Ifges(3,5) + Ifges(5,6) + (-Ifges(7,6) / 0.2e1 - Ifges(6,6) / 0.2e1) * t59 + (-Ifges(7,5) / 0.2e1 - Ifges(6,5) / 0.2e1) * t57 + (-mrSges(3,1) + t70) * pkin(7)) * t58 + (Ifges(5,5) - Ifges(4,6) + Ifges(3,6) + (-t33 / 0.2e1 - t34 / 0.2e1) * t59 + (t31 / 0.2e1 + t32 / 0.2e1) * t57 + t79 * qJ(3) + (m(4) * qJ(3) - mrSges(3,2) + mrSges(4,3)) * pkin(7)) * t60; 0.2e1 * pkin(2) * mrSges(4,1) + 0.2e1 * t61 * mrSges(5,2) + 0.2e1 * t36 * t26 + 0.2e1 * t56 * t27 + Ifges(4,2) + Ifges(3,3) + Ifges(5,3) + (t24 * t91 - t31 - t32) * t59 + (t23 * t91 - t33 - t34) * t57 + m(7) * (t23 ^ 2 + t24 ^ 2 + t36 ^ 2) + m(6) * (t35 * t51 ^ 2 + t56 ^ 2) + m(4) * (pkin(2) ^ 2 + t62) + m(5) * (t61 ^ 2 + t62) + 0.2e1 * (mrSges(4,3) + mrSges(5,1)) * qJ(3) - 0.2e1 * t51 * t67; t76 * t59 - t75 * t57 + (m(4) * pkin(7) + t79) * t58 + m(7) * (-t57 * t1 + t59 * t2) + m(6) * t64 + m(5) * t28; mrSges(5,2) - t35 * mrSges(7,3) - t67 + m(7) * (-t57 * t23 - t59 * t24) + m(5) * t61 + t51 * t18 + t70; m(4) + t71; -t60 * mrSges(5,2) + t41 + t75 * t59 + t76 * t57 + m(7) * (t59 * t1 + t57 * t2) + m(6) * (t59 * t3 + t57 * t4) + m(5) * t15; m(7) * (t59 * t23 - t57 * t24); 0; t71; t3 * mrSges(6,1) + t1 * mrSges(7,1) - t4 * mrSges(6,2) - t2 * mrSges(7,2) + t60 * t68 + (m(7) * t1 + t21) * pkin(5) + t66; t24 * mrSges(7,2) + t69 * t23 + (-mrSges(6,2) * t51 - t94) * t59 + (-mrSges(6,1) * t51 + mrSges(7,3) * pkin(5) + t77) * t57; t78 * t59 + (-mrSges(6,1) - t69) * t57; m(7) * t86 + t78 * t57 + t42 + t43; (0.2e1 * mrSges(7,1) + t87) * pkin(5) + t93; m(7) * t12 + t13; m(7) * t36 + t26; 0; 0; 0; m(7);];
