...
%% Function calls
if link_index == 0
	Ja_rot=S6RRPPRP3_jacobia_rot_0_sym_varpar(qJ, pkin);
elseif link_index == 1
	Ja_rot=S6RRPPRP3_jacobia_rot_1_sym_varpar(qJ, pkin);
elseif link_index == 2
	Ja_rot=S6RRPPRP3_jacobia_rot_2_sym_varpar(qJ, pkin);
elseif link_index == 3
	Ja_rot=S6RRPPRP3_jacobia_rot_3_sym_varpar(qJ, pkin);
elseif link_index == 4
	Ja_rot=S6RRPPRP3_jacobia_rot_4_sym_varpar(qJ, pkin);
elseif link_index == 5
	Ja_rot=S6RRPPRP3_jacobia_rot_5_sym_varpar(qJ, pkin);
elseif link_index == 6
	Ja_rot=S6RRPPRP3_jacobia_rot_6_sym_varpar(qJ, pkin);
else
	Ja_rot=NaN(3,6);
end