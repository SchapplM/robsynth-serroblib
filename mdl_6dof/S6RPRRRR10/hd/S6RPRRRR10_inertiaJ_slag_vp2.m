...
% OptimizationMode: 2
% StartTime: 2018-11-23 16:38:53
% EndTime: 2018-11-23 16:38:56
...
t5 = -pkin(5) * t94 - t8;
t173 = t8 * mrSges(6,1) - t9 * mrSges(6,2) + mrSges(7,3) * t182 + t5 * t127 + t13 * t215 + t130 * t221 + t14 * t216 + t34 * t217 + t49 * t218 + t188;
...
t1 = [0.2e1 * t28 * t27 + t33 * t13 + 0.2e1 * t2 * t22 + 0.2e1 * t5 * t19 + 0.2e1 * t3 * t21 + 0.2e1 * t53 * t69 + 0.2e1 * t52 * t70 + 0.2e1 * t60 * t57 + t65 * t37 + t66 * t38 + t50 * t24 + 0.2e1 * t44 * t51 + 0.2e1 * t26 * t54 + 0.2e1 * t25 * t55 + t34 * t14 + 0.2e1 * t9 * t35 + 0.2e1 * t8 * t36 + m(3) * (pkin(1) ^ 2 * t157 ^ 2 + t114 ^ 2 + t115 ^ 2) + m(7) * (t2 ^ 2 + t3 ^ 2 + t5 ^ 2) + m(6) * (t28 ^ 2 + t8 ^ 2 + t9 ^ 2) + m(5) * (t25 ^ 2 + t26 ^ 2 + t44 ^ 2) + m(4) * (t52 ^ 2 + t53 ^ 2 + t60 ^ 2) + (t12 - t23) * t49 + (-0.2e1 * Ifges(4,4) * t95 + Ifges(4,2) * t94 - Ifges(4,6) * t112 + t188 + t227) * t94 + t95 * (Ifges(4,1) * t95 + Ifges(4,5) * t112) + Ifges(2,3) + t112 * t187 + (-0.2e1 * mrSges(3,2) * t115 + Ifges(3,3) * t160 + t114 * t225) * t160 + (-0.2e1 * pkin(1) * t137 + (-0.2e1 * mrSges(3,3) * t114 + Ifges(3,1) * t197 + Ifges(3,5) * t222) * t155 + (0.2e1 * t115 * mrSges(3,3) + Ifges(3,6) * t222 + (0.2e1 * Ifges(3,4) * t155 + Ifges(3,2) * t158 + pkin(1) * t225) * t157) * t158) * t157; t116 * t55 + t117 * t54 + t159 * t57 + t72 * t21 + t71 * t22 + t80 * t35 + t137 + t209 * t78 + (-m(3) * pkin(1) - mrSges(3,1) * t158) * t157 + (t164 * t69 + (-t27 - t51 + t70) * t168) * t156 + m(7) * (t2 * t71 + t3 * t72 + t5 * t78) + m(6) * (-t195 * t28 - t78 * t8 + t80 * t9) + m(5) * (t116 * t25 + t117 * t26 - t195 * t44) + m(4) * (t159 * t60 + (t164 * t53 + t168 * t52) * t156); m(3) + m(7) * (t71 ^ 2 + t72 ^ 2 + t226) + m(6) * (t80 ^ 2 + t141 + t226) + m(5) * (t116 ^ 2 + t117 ^ 2 + t141) + m(4) * (t150 * t164 ^ 2 + t159 ^ 2 + t141); t145 * t27 + t44 * t128 + t65 * t131 / 0.2e1 + t66 * t133 / 0.2e1 + t107 * t35 + t3 * t92 + t2 * t93 + t28 * t98 + t50 * t100 / 0.2e1 + t5 * t85 + t34 * t76 / 0.2e1 + t59 * t21 - pkin(3) * t51 + t52 * mrSges(4,1) - t53 * mrSges(4,2) + t58 * t22 + (t192 + t191) * t94 / 0.2e1 + t187 + (-t99 / 0.2e1 + t74 / 0.2e1) * t49 + (t37 / 0.2e1 + t26 * mrSges(5,3) + pkin(10) * t54) * t167 + (t38 / 0.2e1 - t25 * mrSges(5,3) - pkin(10) * t55) * t163 + m(5) * (-pkin(3) * t44 + (-t163 * t25 + t167 * t26) * pkin(10)) + m(7) * (t105 * t5 + t2 * t58 + t3 * t59) + m(6) * (-t105 * t8 + t107 * t9 + t145 * t28) + (t12 / 0.2e1 - t23 / 0.2e1 - t9 * mrSges(6,3)) * t123 + t75 * t221 + t209 * t105 + (t24 / 0.2e1 + t14 * t215 - t161 * t13 / 0.2e1 - t8 * mrSges(6,3)) * t124; t71 * t93 + t72 * t92 + t78 * t85 + (-t123 * t80 + t124 * t78) * mrSges(6,3) + t176 * mrSges(5,3) + (-t164 * mrSges(4,2) + (mrSges(4,1) - t128 - t98) * t168) * t156 + m(7) * (t58 * t71 + t59 * t72 + t206) + m(6) * (t107 * t80 - t145 * t195 + t206) + m(5) * (pkin(3) * t195 + pkin(10) * t176); -0.2e1 * pkin(3) * t128 + t85 * t223 + t167 * t131 + t163 * t133 + 0.2e1 * t145 * t98 + 0.2e1 * t58 * t93 + 0.2e1 * t59 * t92 + Ifges(4,3) + 0.2e1 * t189 * pkin(10) * mrSges(5,3) + (-0.2e1 * mrSges(6,3) * t107 + t74 - t99) * t123 + m(7) * (t58 ^ 2 + t59 ^ 2 + t224) + m(6) * (t107 ^ 2 + t145 ^ 2 + t224) + m(5) * (pkin(10) ^ 2 * t189 + pkin(3) ^ 2) + (mrSges(6,3) * t223 - t161 * t75 + t165 * t76 + t100) * t124; t25 * mrSges(5,1) - t26 * mrSges(5,2) + t144 * t19 + t21 * t198 - t22 * t199 + t173 + m(7) * (t143 * t182 + t144 * t5) + (m(6) * (t162 * t9 + t166 * t8) + t166 * t36 + t162 * t35) * pkin(4) + t227; t116 * mrSges(5,1) - t117 * mrSges(5,2) + m(7) * (t143 * t179 + t144 * t78) + m(6) * (t162 * t80 - t166 * t78) * pkin(4) + t174; t144 * t85 + (-mrSges(5,1) * t163 - mrSges(5,2) * t167) * pkin(10) + t92 * t198 - t93 * t199 + t172 + m(7) * (t144 * t105 + t143 * t180) + (m(6) * (-t105 * t166 + t107 * t162) + (-t123 * t162 - t124 * t166) * mrSges(6,3)) * pkin(4) + t191; 0.2e1 * t144 * t127 + Ifges(5,3) + 0.2e1 * t175 + t143 * t178 + m(7) * (t143 ^ 2 * t190 + t144 ^ 2) + m(6) * (t162 ^ 2 + t166 ^ 2) * pkin(4) ^ 2 + t186; -pkin(5) * t19 + t21 * t212 - t22 * t213 + t173 + m(7) * (-pkin(5) * t5 + pkin(12) * t182); m(7) * (-pkin(5) * t78 + pkin(12) * t179) + t174; -pkin(5) * t85 + t92 * t212 - t93 * t213 + t172 + m(7) * (-pkin(5) * t105 + pkin(12) * t180); m(7) * (-pkin(5) * t144 + pkin(12) * t183) + (-pkin(5) + t144) * t127 + t175 + (pkin(12) * t190 + t183) * mrSges(7,3) + t186; -0.2e1 * pkin(5) * t127 + m(7) * (pkin(12) ^ 2 * t190 + pkin(5) ^ 2) + pkin(12) * t178 + t186; mrSges(7,1) * t2 - mrSges(7,2) * t3 + t12; mrSges(7,1) * t71 - mrSges(7,2) * t72; mrSges(7,1) * t58 - mrSges(7,2) * t59 + t74; -t143 * t181 + t129; -pkin(12) * t181 + t129; Ifges(7,3);];
