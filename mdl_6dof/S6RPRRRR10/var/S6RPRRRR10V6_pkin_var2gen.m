% Umwandlung der Kinematikparameter von S6RPRRRR10V6 zu S6RPRRRR10
% Eingabe:
% pkin_var (8x1) double
...
function pkin_gen = S6RPRRRR10V6_pkin_var2gen(pkin_var)
pkin_gen = zeros(13,1);
pkin_gen([3, 4, 6, 7, 8, 10, 11, 13]) = pkin_var;
