...
t6 = [0.2e1 * t44 * mrSges(4,2) + mrSges(4,3) * t102 + 0.2e1 * t1 * t22 + 0.2e1 * t5 * t15 + 0.2e1 * t4 * t19 + 0.2e1 * t2 * t21 + 0.2e1 * t3 * t20 + Ifges(4,1) + Ifges(2,3) + Ifges(3,3) + (mrSges(5,1) * t102 + Ifges(5,2) * t59 + t73) * t59 + (mrSges(5,2) * t102 + Ifges(5,1) * t61 - 0.2e1 * Ifges(5,4) * t59 + t16 * t106 + (t10 + t9) * t60 + (t7 - t8 - t93) * t58) * t61 + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2) + m(6) * (t3 ^ 2 + t4 ^ 2 + t24) + m(4) * (t44 ^ 2 + t103) + m(5) * (t53 * t32 + t103 + t24) + m(3) * (t56 ^ 2 + t57 ^ 2) * pkin(1) ^ 2 + 0.2e1 * (t57 * mrSges(3,1) - t56 * mrSges(3,2)) * pkin(1) + t75 * t106; (t16 + t76) * t59 + (m(6) * (t71 - t91) + t65) * t61; m(3) + (t80 * t55 + t53) * t105 + t98; mrSges(4,2) + (-t15 - t16) * t61 - t75 + t67 * t59 + m(6) * (t71 * t59 + t25) + m(7) * (-t61 * t5 + t72 * t59) + m(5) * (t53 * t33 + t25) + m(4) * t44; (-0.1e1 + t80) * t61 * t59 * t105; (t80 * t53 + t55) * t105 + t98; -pkin(4) * t16 + t5 * t26 + t76 * t23 + (t49 / 0.2e1 + t48 / 0.2e1 + t46 / 0.2e1 - Ifges(5,6) - t33 * mrSges(5,2)) * t59 + (-t92 / 0.2e1 - t7 / 0.2e1 + t8 / 0.2e1 + t1 * mrSges(7,2) + t4 * mrSges(6,3)) * t60 + (t9 / 0.2e1 + t10 / 0.2e1 + t2 * mrSges(7,2) - t3 * mrSges(6,3)) * t58 + (m(6) * t71 + t65) * pkin(8) + (Ifges(5,5) + (t30 / 0.2e1 + t31 / 0.2e1) * t60 + (t28 / 0.2e1 - t29 / 0.2e1) * t58 + (m(6) * pkin(4) - t84) * t33) * t61; -t77 * t59 + m(7) * (t23 * t59 + t82) + m(6) * (t82 - t100) + t66 * t61; t77 * t61 + m(6) * (pkin(4) * t61 + t83) + m(7) * (-t23 * t61 + t83) + t66 * t59; -0.2e1 * pkin(4) * t27 + 0.2e1 * t23 * t26 + Ifges(5,3) + (t29 - t28) * t60 + (t30 + t31) * t58 + m(7) * (t23 ^ 2 + t81) + m(6) * (pkin(4) ^ 2 + t81) + 0.2e1 * pkin(8) * t104; -Ifges(6,6) * t89 - pkin(5) * t21 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + qJ(6) * t22 + t1 * mrSges(7,3) - t4 * mrSges(6,2) + t3 * mrSges(6,1) - t2 * mrSges(7,1) + t73; t64 * t61; t64 * t59; t68 * mrSges(7,2) - Ifges(7,6) * t60 + t64 * pkin(8) + t46 + t48 + t49; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t107; m(7) * t2 + t21; m(7) * t89; m(7) * t90; (m(7) * pkin(8) + mrSges(7,2)) * t58; -m(7) * pkin(5) - mrSges(7,1); m(7);];
