...
% OptimizationMode: 2
% StartTime: 2019-03-09 13:22:03
% EndTime: 2019-03-09 13:22:06
...
t1 = [0.2e1 * t133 * pkin(7) * mrSges(3,3) - 0.2e1 * pkin(1) * (-mrSges(3,1) * t117 + mrSges(3,2) * t113) + t117 * (Ifges(3,4) * t113 + Ifges(3,2) * t117) + t113 * (Ifges(3,1) * t113 + Ifges(3,4) * t117) + t76 * t149 + t49 * t150 + (mrSges(4,1) * t149 - 0.2e1 * t66 * mrSges(4,3) + Ifges(4,2) * t85 + (-Ifges(5,6) * t112 - (2 * Ifges(4,4))) * t86 + t131 + t152 + t153) * t85 + 0.2e1 * t31 * t56 + 0.2e1 * t30 * t57 - t44 * t20 + t45 * t21 + 0.2e1 * t8 * t35 + 0.2e1 * t7 * t36 + 0.2e1 * t41 * t29 + t26 * t9 + t27 * t10 + 0.2e1 * t28 * t11 + 0.2e1 * t3 * t17 + 0.2e1 * t2 * t18 + (mrSges(4,3) * t150 + Ifges(4,1) * t86 - t112 * t37 + t116 * t38) * t86 + m(4) * (t100 ^ 2 + t66 ^ 2 + t151) + m(5) * (t30 ^ 2 + t31 ^ 2 + t151) + m(3) * (pkin(7) ^ 2 * t133 + pkin(1) ^ 2) + m(6) * (t41 ^ 2 + t7 ^ 2 + t8 ^ 2) + m(7) * (t2 ^ 2 + t28 ^ 2 + t3 ^ 2) + Ifges(2,3); Ifges(3,6) * t117 + Ifges(3,5) * t113 + t98 * t49 + Ifges(4,5) * t86 + t88 * t20 / 0.2e1 + t89 * t21 / 0.2e1 + t90 * t29 - Ifges(4,6) * t85 + m(5) * (t64 * t98 + (-t30 * t112 + t31 * t116) * t97) + (t91 - mrSges(4,1)) * t64 + (t37 / 0.2e1 + t86 * t94 / 0.2e1 + t97 * t56 + t31 * mrSges(5,3)) * t116 + (t38 / 0.2e1 - t86 * t93 / 0.2e1 - t97 * t57 - t30 * mrSges(5,3)) * t112 + m(6) * (t41 * t90 + t50 * t7 + t51 * t8) + m(7) * (t13 * t2 + t14 * t3 + t28 * t67) - t66 * mrSges(4,2) + t67 * t11 + t58 * t9 / 0.2e1 + t59 * t10 / 0.2e1 + t41 * t61 - t44 * t62 / 0.2e1 + t45 * t63 / 0.2e1 + t50 * t36 + t51 * t35 + t28 * t32 + t26 * t33 / 0.2e1 + t27 * t34 / 0.2e1 + t14 * t17 + t13 * t18 + (-t113 * mrSges(3,1) - t117 * mrSges(3,2)) * pkin(7) + (-t2 * t59 + t3 * t58) * mrSges(7,3) + (-t7 * t89 + t8 * t88) * mrSges(6,3) + ((-t108 * t85 - t109 * t86) * mrSges(4,3) + m(4) * (t108 * t66 - t109 * t64)) * pkin(2) + (t142 + t141 + t135) * t85 / 0.2e1; t112 * t94 + t116 * t93 + 0.2e1 * t67 * t32 + t58 * t33 + t59 * t34 + 0.2e1 * t90 * t61 + t88 * t62 + t89 * t63 + 0.2e1 * t98 * t91 + Ifges(3,3) + Ifges(4,3) + m(7) * (t13 ^ 2 + t14 ^ 2 + t67 ^ 2) + m(6) * (t50 ^ 2 + t51 ^ 2 + t90 ^ 2) + m(5) * (t134 * t97 ^ 2 + t98 ^ 2) + m(4) * (t108 ^ 2 + t109 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (t109 * mrSges(4,1) - t108 * mrSges(4,2)) * pkin(2) + 0.2e1 * (-t13 * t59 + t14 * t58) * mrSges(7,3) + 0.2e1 * (-t50 * t89 + t51 * t88) * mrSges(6,3) + 0.2e1 * t134 * t97 * mrSges(5,3); t85 * mrSges(4,1) + t112 * t56 + t116 * t57 + t59 * t17 + t58 * t18 + t89 * t35 + t88 * t36 + t76 + m(7) * (t2 * t58 + t3 * t59) + m(6) * (t7 * t88 + t8 * t89) + m(5) * (t112 * t31 + t116 * t30) + m(4) * t100; m(7) * (t13 * t58 + t14 * t59) + m(6) * (t50 * t88 + t51 * t89); m(4) + m(5) * t134 + m(6) * (t88 ^ 2 + t89 ^ 2) + m(7) * (t58 ^ 2 + t59 ^ 2); -Ifges(5,6) * t137 + (m(6) * (t111 * t8 + t115 * t7) + t111 * t35 + t115 * t36) * pkin(4) + t122 + t74 * t18 + t75 * t17 + t30 * mrSges(5,1) - t31 * mrSges(5,2) + m(7) * (t2 * t74 + t3 * t75) + t153; m(7) * (t13 * t74 + t14 * t75) - t128 * t97 + (t75 * t58 - t74 * t59) * mrSges(7,3) + (m(6) * (t111 * t51 + t115 * t50) + (t111 * t88 - t115 * t89) * mrSges(6,3)) * pkin(4) + t123 + t135; m(7) * (t58 * t74 + t59 * t75) + m(6) * (t111 * t89 + t115 * t88) * pkin(4) + t124 - t91; -0.2e1 * t145 + Ifges(5,3) + 0.2e1 * t68 + 0.2e1 * t125 + m(7) * (t74 ^ 2 + t75 ^ 2) + m(6) * (t111 ^ 2 + t115 ^ 2) * pkin(4) ^ 2 + t144; (m(7) * (t110 * t3 + t114 * t2) + t110 * t17 + t114 * t18) * pkin(5) + t122; (m(7) * (t110 * t14 + t114 * t13) + (t110 * t58 - t114 * t59) * mrSges(7,3)) * pkin(5) + t123; m(7) * (t110 * t59 + t114 * t58) * pkin(5) + t124; Ifges(6,3) + t101 + t125 + (m(7) * (t110 * t75 + t114 * t74) - t138) * pkin(5) + t129; -0.2e1 * t132 + 0.2e1 * t101 + m(7) * (t110 ^ 2 + t114 ^ 2) * pkin(5) ^ 2 + t144; t126; t127; -t32; t129; Ifges(7,3) + t101 - t132; Ifges(7,3);];
