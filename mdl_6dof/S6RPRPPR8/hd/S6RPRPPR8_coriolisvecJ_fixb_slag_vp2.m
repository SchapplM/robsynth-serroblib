...
t135 = t75 * t149;
t146 = qJD(5) * t92;
t27 = t135 + (qJ(5) * t149 - t146) * qJD(1);
t1 = qJD(6) * t5 + t12 * t89 + t27 * t91;
t2 = -qJD(6) * t6 + t12 * t91 - t27 * t89;
t125 = -t1 * t91 + t2 * t89;
t137 = qJD(3) * qJD(6);
t145 = qJD(6) * t90;
t33 = -t91 * t137 + (-t145 * t89 + t148 * t92) * qJD(1);
t34 = t89 * t137 + (-t143 * t92 - t145 * t91) * qJD(1);
t197 = t2 * mrSges(7,1) - t1 * mrSges(7,2) + Ifges(7,5) * t33 + Ifges(7,6) * t34;
t151 = qJD(3) * mrSges(6,1);
t159 = mrSges(7,1) * t59 - mrSges(7,2) * t60 - mrSges(6,3) * t152 - t151;
...
t169 = Ifges(7,6) * t91;
t147 = qJD(5) * t90;
t23 = qJD(1) * t147 + (qJD(4) + t45) * qJD(3);
t153 = qJ(5) + t94;
t66 = t153 * t90;
t168 = t23 * t66;
t167 = t23 * t90;
...
t150 = qJD(3) * mrSges(4,2);
t70 = -mrSges(4,3) * t152 - t150;
t158 = t70 + t74;
t157 = (mrSges(5,2) + mrSges(4,3)) * t142 + t204;
...
t132 = -t48 + t164;
t131 = qJD(3) * t153;
t129 = -0.3e1 / 0.2e1 * Ifges(6,4) + 0.3e1 / 0.2e1 * Ifges(5,5) - 0.3e1 / 0.2e1 * Ifges(4,4);
...
t71 = qJD(3) * mrSges(6,2) - mrSges(6,3) * t142;
t108 = t111 + t71;
t105 = t92 * t93 - t154;
...
t30 = qJD(3) * t93 - t198;
t82 = Ifges(6,4) * t152;
t97 = t30 * mrSges(6,3) + t49 * mrSges(5,3) + t6 * mrSges(7,2) - t77 * Ifges(7,3) - t60 * Ifges(7,5) - t59 * Ifges(7,6) - Ifges(6,2) * t142 / 0.2e1 + t82 / 0.2e1 - t39 * mrSges(6,1) - t5 * mrSges(7,1) + ((Ifges(4,1) + Ifges(5,1)) * t92 + (-Ifges(4,4) + Ifges(5,5)) * t90) * t202 + (Ifges(6,6) + Ifges(5,4) + Ifges(4,5)) * t201;
t76 = t92 * mrSges(6,2) * t138;
t68 = t133 - t85;
t64 = qJD(1) * (mrSges(4,1) * t90 + mrSges(4,2) * t92);
t61 = t113 * qJD(1);
t57 = t85 + t121;
...
t15 = [t66 * t11 + t13 * t19 + t14 * t20 + t3 * t36 + t35 * t62 + t4 * t37 + t41 * t71 + t43 * t63 + t57 * t76 - t159 * t42 + m(7) * (t1 * t14 + t13 * t2 + t3 * t6 + t32 * t42 + t4 * t5 + t168) + m(6) * (t22 * t57 - t27 * t67 + t30 * t41 + t35 * t39 - t40 * t42 + t168) + m(5) * (t31 * t68 + t43 * t49) + (t64 + 0.2e1 * t205) * qJD(2) + (-t27 * mrSges(6,3) - t31 * mrSges(5,3) + t22 * mrSges(6,1) + mrSges(4,2) * t139 + ((t68 * mrSges(5,1) + t66 * mrSges(6,3) + t129 * t92 + 0.2e1 * t156) * qJD(1) + t128 * qJD(3) + (m(5) * t56 + t158) * t94 + t206) * qJD(3) + t197) * t92 + (t91 * t8 / 0.2e1 + t7 * t184 + t118 * t192 + t116 * t191 + t31 * mrSges(5,1) + t22 * mrSges(6,2) + mrSges(4,1) * t139 + (m(5) * t94 - mrSges(5,2)) * t47 + (mrSges(6,3) + t119) * t23 + t124 * mrSges(7,3) + ((-t169 - t172) * t185 + t115 * t189 + t117 * t187 + t32 * t120 + t16 * t183 + t17 * t184 - t199 * mrSges(7,3)) * qJD(6) + (((-t171 / 0.2e1 + t170 / 0.2e1 - t129) * t90 - t67 * mrSges(6,3) + t68 * mrSges(5,3) - t57 * mrSges(6,1) - 0.2e1 * t155 + (-Ifges(7,3) - 0.3e1 / 0.2e1 * Ifges(6,2) - 0.3e1 / 0.2e1 * Ifges(5,1) - 0.3e1 / 0.2e1 * Ifges(4,1) + 0.3e1 / 0.2e1 * Ifges(5,3) + 0.3e1 / 0.2e1 * Ifges(4,2) + 0.3e1 / 0.2e1 * Ifges(6,1)) * t92) * qJD(1) + (-m(5) * t132 + t157) * t94 + t132 * mrSges(5,2) + t127 * qJD(3) + t97) * qJD(3)) * t90; t193 * t92 + m(7) * (t123 * qJD(6) * t92 - t1 * t161 + t2 * t162 + t167) + m(6) * (-t27 * t92 + t167) + (m(5) * t109 + (-m(6) * t40 + m(7) * t32 - t196 + t70) * t92) * qJD(3) + (t11 + m(5) * t47 + (m(6) * t30 + m(7) * t199 + t108 + t157) * qJD(3)) * t90 + (-m(5) * t49 + m(6) * t39 - t200 - t205 - t64 - t99) * qJD(1); t88 * t11 - t44 * t71 - t46 * t62 - t61 * t63 + t47 * mrSges(5,3) + t27 * mrSges(6,2) - t10 * t36 - t9 * t37 + (t114 * t186 + t116 * t190 + t118 * t188 + t86 * t99 - t207) * qJD(6) + (((t172 / 0.2e1 + t169 / 0.2e1 + pkin(3) * mrSges(5,2) + t93 * mrSges(6,3) + t127) * qJD(3) + (t155 + (Ifges(5,5) / 0.2e1 - Ifges(4,4) / 0.2e1) * t90) * qJD(1) - t82 / 0.2e1 + t48 * mrSges(5,2) - t97) * t90 + ((qJ(4) * t160 + t128) * qJD(3) + (-t156 + (Ifges(6,4) / 0.2e1 + Ifges(4,4) / 0.2e1) * t92) * qJD(1) - t81 / 0.2e1 + (Ifges(5,1) / 0.2e1 - Ifges(6,1) / 0.2e1 + Ifges(6,2) / 0.2e1 - Ifges(5,3) / 0.2e1 + Ifges(4,1) / 0.2e1 - Ifges(4,2) / 0.2e1) * t152 - t206) * t92) * qJD(1) + ((-t150 - t158) * t92 + (t204 - t157) * t90) * t75 + t159 * t45 + t136 * qJD(4) + (mrSges(6,1) + t120) * t23 + t125 * mrSges(7,3) - t112 * t86 + t7 * t183 + t8 * t184 + t115 * t191 + t117 * t192 + (-t10 * t6 - t125 * t86 - t198 * t32 + t23 * t88 - t5 * t9) * m(7) + (qJ(4) * t23 + t198 * t40 + t27 * t93 - t30 * t44 - t39 * t46) * m(6) + (-pkin(3) * t135 + qJ(4) * t47 + qJD(4) * t56 - t109 * t75 - t49 * t61) * m(5); t196 * qJD(3) + (t160 * t149 + (-t110 + t200) * t92) * qJD(1) - m(5) * (qJD(3) * t56 - t142 * t49) + (-qJD(3) * t32 - t77 * t123 - t125) * m(7) + (t40 * qJD(3) - t142 * t39 + t27) * m(6) - t193; t91 * t19 + t89 * t20 + t76 + t111 * qJD(6) + m(6) * t22 + m(7) * (qJD(6) * t199 - t124) + (t108 * t92 + (-t151 + t159) * t90 - m(6) * (-t30 * t92 - t40 * t90) - m(7) * (-t161 * t6 + t162 * t5 + t32 * t90)) * qJD(1); -Ifges(7,3) * t134 - t32 * (mrSges(7,1) * t60 + mrSges(7,2) * t59) + (Ifges(7,1) * t59 - t175) * t188 + t16 * t187 + (Ifges(7,5) * t59 - Ifges(7,6) * t60) * t186 - t5 * t36 + t6 * t37 + (t5 * t59 + t6 * t60) * mrSges(7,3) + (-Ifges(7,2) * t60 + t17 + t58) * t190 + t197;];
tauc  = t15(:);
