...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:35:29
% EndTime: 2018-11-23 15:35:30
...
t1 = [m(2) + m(7) * (t5 ^ 2 + t6 ^ 2 + t34) + m(6) * (t15 ^ 2 + t16 ^ 2 + t34) + m(5) * (t37 ^ 2 + t201 + t34) + m(4) * (t55 ^ 2 + t92 ^ 2 + t201) + m(3) * (t146 ^ 2 + (t151 ^ 2 + t156 ^ 2) * t144 ^ 2); t55 * t104 + t15 * t42 + t16 * t41 + t6 * t17 + t5 * t18 + t37 * t66 + t92 * t95 + (-t103 + t51) * t53 + (mrSges(3,1) * t156 - mrSges(3,2) * t151) * t144 + (t12 + t185) * t35 + m(7) * (t19 * t35 + t2 * t5 + t3 * t6) + m(6) * (t13 * t15 + t14 * t16 + t35 * t39) + m(5) * (-t35 * t43 + t37 * t44 + t53 * t78) + m(4) * (-pkin(2) * t143 * t92 - t53 * t96 + t55 * t97); t145 * t167 + 0.2e1 * t96 * t103 + 0.2e1 * t97 * t104 + t94 * t49 + 0.2e1 * t78 * t51 + t63 * t22 + 0.2e1 * t44 * t66 + 0.2e1 * t43 * t67 + t62 * t21 + 0.2e1 * t39 * t30 + 0.2e1 * t14 * t41 + 0.2e1 * t13 * t42 + t28 * t9 + t29 * t10 + 0.2e1 * t3 * t17 + 0.2e1 * t2 * t18 + 0.2e1 * t19 * t12 + Ifges(3,3) + (t20 + t8 - t48) * t93 + (-0.2e1 * pkin(2) * t95 + (Ifges(4,1) * t176 + Ifges(4,5) * t145) * t150 + (Ifges(4,6) * t145 + (0.2e1 * Ifges(4,4) * t150 + (Ifges(4,2) + Ifges(5,3)) * t155) * t143 + t183) * t155) * t143 + m(4) * (pkin(2) ^ 2 * t143 ^ 2 + t96 ^ 2 + t97 ^ 2) + m(5) * (t43 ^ 2 + t44 ^ 2 + t78 ^ 2) + m(6) * (t13 ^ 2 + t14 ^ 2 + t39 ^ 2) + m(7) * (t19 ^ 2 + t2 ^ 2 + t3 ^ 2); mrSges(5,3) * t178 - t55 * mrSges(4,2) + t16 * t107 + t15 * t108 + t5 * t71 + t6 * t70 + (-mrSges(4,1) + t113) * t53 + (t149 * mrSges(5,3) + t50 + t98) * t35 + m(7) * (t110 * t35 + t24 * t5 + t25 * t6) + m(6) * (pkin(10) * t179 + t15 * t75 + t16 * t76) + m(5) * (-pkin(3) * t53 + (t178 + t179) * pkin(10)); t94 * t118 / 0.2e1 + t14 * t107 + t13 * t108 + t110 * t12 + t78 * t113 + t96 * mrSges(4,1) - t97 * mrSges(4,2) + t39 * t98 + t3 * t70 + t2 * t71 + t75 * t42 + t76 * t41 + t19 * t50 - pkin(3) * t51 + t25 * t17 + t24 * t18 + m(5) * (-pkin(3) * t78 + (-t149 * t43 + t154 * t44) * pkin(10)) + t167 + (pkin(10) * t66 + t44 * mrSges(5,3) + t48 / 0.2e1 - t20 / 0.2e1 - t8 / 0.2e1) * t154 + m(7) * (t110 * t19 + t2 * t24 + t25 * t3) + (-t116 / 0.2e1 + t83 / 0.2e1 + t45 / 0.2e1) * t93 - t171 * t175 / 0.2e1 + m(6) * (t13 * t75 + t14 * t76 + t188 * t39) + t10 * t194 + t9 * t195 + t63 * t196 + t62 * t197 + t47 * t198 + t46 * t199 + (t153 * t200 - t148 * t21 / 0.2e1 - t43 * mrSges(5,3) + t49 / 0.2e1 + t185 * pkin(10)) * t149; -0.2e1 * pkin(3) * t113 + 0.2e1 * t76 * t107 + 0.2e1 * t75 * t108 + 0.2e1 * t110 * t50 + 0.2e1 * t24 * t71 + 0.2e1 * t25 * t70 - t86 * t46 + t87 * t47 + Ifges(4,3) + (t140 + t142) * mrSges(5,3) * t202 + (-t45 - t83 + t116) * t154 + m(7) * (t110 ^ 2 + t24 ^ 2 + t25 ^ 2) + m(6) * (t75 ^ 2 + t76 ^ 2 + t137) + m(5) * (pkin(3) ^ 2 + t142 * t158 + t137) + (-t148 * t84 + t153 * t85 + t202 * t98 + t118) * t149; -t37 * mrSges(5,2) + (t105 * t6 - t106 * t5) * mrSges(7,3) + t164 * mrSges(6,3) + (t58 + t177) * t35 + m(7) * (t131 * t35 + t5 * t68 + t6 * t69) + m(6) * (-pkin(4) * t35 + pkin(11) * t164); -t183 + t62 * t115 / 0.2e1 + t63 * t190 + t131 * t12 + t9 * t192 + t10 * t191 + t39 * t112 + t68 * t18 + t69 * t17 + t19 * t58 + t60 * t199 + t61 * t198 - t44 * mrSges(5,2) + t43 * mrSges(5,1) - pkin(4) * t30 + m(6) * (-pkin(4) * t39 + (-t13 * t148 + t14 * t153) * pkin(11)) + (pkin(11) * t41 + t14 * mrSges(6,3) + t21 / 0.2e1) * t153 + (-t13 * mrSges(6,3) - pkin(11) * t42 + t200) * t148 + m(7) * (t131 * t19 + t2 * t68 + t3 * t69) + (t105 * t3 - t106 * t2) * mrSges(7,3) + t168 * t93 - Ifges(5,3) * t175; t131 * t50 + t46 * t192 + t47 * t191 + t110 * t58 - pkin(4) * t98 + t60 * t195 + t61 * t194 + t69 * t70 + t68 * t71 + t177 * t188 + (t105 * t25 - t106 * t24) * mrSges(7,3) + (t76 * mrSges(6,3) + pkin(11) * t107 + t149 * t190 + t197) * t153 + (-pkin(11) * t108 - t75 * mrSges(6,3) - t149 * t115 / 0.2e1 + t196) * t148 + m(6) * (-pkin(4) * t188 + (-t148 * t75 + t153 * t76) * pkin(11)) + m(7) * (t110 * t131 + t24 * t68 + t25 * t69) + (-pkin(10) * mrSges(5,2) - t168) * t154 + t171; -0.2e1 * pkin(4) * t112 + t105 * t60 + t106 * t61 + t153 * t115 + t148 * t117 + 0.2e1 * t131 * t58 + Ifges(5,3) + m(7) * (t131 ^ 2 + t68 ^ 2 + t69 ^ 2) + m(6) * (pkin(11) ^ 2 * t170 + pkin(4) ^ 2) + 0.2e1 * (t105 * t69 - t106 * t68) * mrSges(7,3) + 0.2e1 * t170 * pkin(11) * mrSges(6,3); t15 * mrSges(6,1) - t16 * mrSges(6,2) + m(7) * (t147 * t6 + t152 * t5) * pkin(5) + t169; t13 * mrSges(6,1) - t14 * mrSges(6,2) + (m(7) * (t147 * t3 + t152 * t2) + t147 * t17 + t152 * t18) * pkin(5) + t161 + t20; t75 * mrSges(6,1) - t76 * mrSges(6,2) + t186 * t154 + (m(7) * (t147 * t25 + t152 * t24) + t147 * t70 + t152 * t71) * pkin(5) + t163 + t166; -t165 * pkin(11) + (m(7) * (t147 * t69 + t152 * t68) + (t105 * t147 - t106 * t152) * mrSges(7,3)) * pkin(5) + t162 + t114; m(7) * (t147 ^ 2 + t152 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t160 - t186; t169; t161; t163 - t180; t162; Ifges(7,3) + t160; Ifges(7,3);];
