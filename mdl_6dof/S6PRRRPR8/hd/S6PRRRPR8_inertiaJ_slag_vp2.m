...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:26:50
% EndTime: 2018-11-23 15:26:51
...
t15 = [m(2) + m(7) * (t3 ^ 2 + t4 ^ 2 + t12) + m(4) * (t35 ^ 2 + t59 ^ 2 + t30) + m(3) * (t109 ^ 2 + (t113 ^ 2 + t117 ^ 2) * t107 ^ 2) + (m(6) + m(5)) * (t14 ^ 2 + t12 + t30); t4 * t20 + t3 * t21 + t35 * t68 + t59 * t62 + t149 * t14 + (mrSges(3,1) * t117 - mrSges(3,2) * t113) * t107 + (t28 + t29 - t67) * t33 + (t11 + t150) * t16 + m(7) * (t1 * t3 + t10 * t16 + t2 * t4) + m(6) * (t13 * t33 + t14 * t19 - t16 * t18) + m(5) * (-t14 * t22 + t16 * t23 + t33 * t48) + m(4) * (-pkin(2) * t106 * t59 - t33 * t63 + t35 * t64); t108 * t133 + 0.2e1 * t63 * t67 + 0.2e1 * t64 * t68 + 0.2e1 * t18 * t40 + 0.2e1 * t19 * t41 + 0.2e1 * t23 * t42 + 0.2e1 * t22 * t43 + 0.2e1 * t48 * t28 + t38 * t6 + t39 * t7 + 0.2e1 * t2 * t20 + 0.2e1 * t1 * t21 + 0.2e1 * t13 * t29 + 0.2e1 * t10 * t11 + Ifges(3,3) + (t24 - t26) * t60 + (t27 + t5 - t25) * t61 + (-0.2e1 * pkin(2) * t62 + (Ifges(4,1) * t139 + Ifges(4,5) * t108) * t112 + (Ifges(4,6) * t108 + (0.2e1 * Ifges(4,4) * t112 + (Ifges(4,2) + t151) * t116) * t106 + t128) * t116) * t106 + m(4) * (pkin(2) ^ 2 * t106 ^ 2 + t63 ^ 2 + t64 ^ 2) + m(5) * (t22 ^ 2 + t23 ^ 2 + t48 ^ 2) + m(6) * (t13 ^ 2 + t18 ^ 2 + t19 ^ 2) + m(7) * (t1 ^ 2 + t10 ^ 2 + t2 ^ 2); -t35 * mrSges(4,2) + t3 * t69 + t4 * t70 + t152 * t140 + (-mrSges(4,1) + t73 + t74) * t33 + (t115 * t152 + t65) * t16 + m(7) * (t16 * t85 + t3 * t31 + t32 * t4) + m(6) * (t33 * t72 + t122) + m(5) * (-pkin(3) * t33 + t122); m(6) * (t13 * t72 + (t111 * t19 - t115 * t18) * pkin(10)) + m(5) * (-pkin(3) * t48 + (-t111 * t22 + t115 * t23) * pkin(10)) + (Ifges(6,5) * t132 + t6 * t154 + t7 * t155 - t18 * mrSges(6,1) + t23 * mrSges(5,3) - t24 / 0.2e1 + t26 / 0.2e1 + t150 * pkin(10)) * t115 + (Ifges(6,4) * t132 + t19 * mrSges(6,1) - t22 * mrSges(5,3) - t25 / 0.2e1 + t27 / 0.2e1 + t5 / 0.2e1 + t149 * pkin(10)) * t111 + m(7) * (t1 * t31 + t10 * t85 + t2 * t32) + (-t77 / 0.2e1 + t82 / 0.2e1 + t51 / 0.2e1) * t61 + (t76 / 0.2e1 - t80 / 0.2e1) * t60 + t133 - t147 * t138 / 0.2e1 + t72 * t29 + t13 * t73 + t48 * t74 + t85 * t11 + t63 * mrSges(4,1) - t64 * mrSges(4,2) + t10 * t65 + t1 * t69 + t2 * t70 + t52 * t160 + t39 * t159 + t31 * t21 + t32 * t20 - pkin(3) * t28; -0.2e1 * pkin(3) * t74 + 0.2e1 * t31 * t69 + 0.2e1 * t32 * t70 + 0.2e1 * t85 * t65 + 0.2e1 * t72 * t73 + Ifges(4,3) + (t51 + t82 - t77) * t111 + m(7) * (t31 ^ 2 + t32 ^ 2 + t85 ^ 2) + m(6) * (t72 ^ 2 + t146) + m(5) * (pkin(3) ^ 2 + t146) + (-t110 * t53 - t114 * t52 - t76 + t80) * t115 + 0.2e1 * t152 * pkin(10) * t163; (-mrSges(5,1) + mrSges(6,2)) * t14 - t125 * mrSges(7,3) + (-mrSges(5,2) + t148) * t16 + m(7) * (-t125 * t157 + t142) + m(6) * (-pkin(4) * t14 + t142); t10 * t75 + t61 * t158 + t79 * t160 + t39 * t81 / 0.2e1 - pkin(4) * t41 + t22 * mrSges(5,1) - t23 * mrSges(5,2) - t18 * mrSges(6,3) + t19 * mrSges(6,2) - t151 * t138 + (-t40 + t11) * qJ(5) + (-t157 * t21 - t1 * mrSges(7,3) + t7 / 0.2e1) * t114 + (-t157 * t20 - t2 * mrSges(7,3) - t6 / 0.2e1) * t110 + m(7) * (qJ(5) * t10 - t126 * t157) + m(6) * (-pkin(4) * t19 - qJ(5) * t18) - t128; -t157 * t141 - t69 * t136 + m(7) * (qJ(5) * t85 - t123 * t157) + t85 * t75 + t114 * t159 + t52 * t155 + qJ(5) * t65 - t123 * mrSges(7,3) + (-pkin(4) * mrSges(6,1) - Ifges(6,4) + t158) * t111 + (qJ(5) * mrSges(6,1) + t79 * t154 + t81 * t155 - Ifges(6,5)) * t115 + ((m(6) * qJ(5) - mrSges(5,2) + mrSges(6,3)) * t115 + (-mrSges(5,1) + t161) * t111) * pkin(10) + t147; -0.2e1 * pkin(4) * mrSges(6,2) - t110 * t79 + t114 * t81 + m(6) * (pkin(4) ^ 2 + t119) + m(7) * (t135 * t157 ^ 2 + t119) + t151 + 0.2e1 * t148 * qJ(5) + 0.2e1 * t157 * t129; m(6) * t14 + m(7) * t125; m(6) * t19 + m(7) * t126 + t110 * t20 + t114 * t21 + t41; m(7) * t123 + t141 + t114 * t69 + (m(6) * pkin(10) + mrSges(6,1)) * t111; -t131 * t157 - t129 + t161; m(6) + t131; mrSges(7,1) * t3 - mrSges(7,2) * t4; mrSges(7,1) * t1 - mrSges(7,2) * t2 + t5; mrSges(7,1) * t31 - mrSges(7,2) * t32 + t51; -mrSges(7,1) * t136 + t96 + (mrSges(7,2) * t157 - Ifges(7,6)) * t110; t124; Ifges(7,3);];
