...
% OptimizationMode: 2
% StartTime: 2019-03-09 01:39:19
% EndTime: 2019-03-09 01:39:20
...
t2 = t72 * t3 + t74 * t4;
t1 = t74 * t3 - t72 * t4;
t15 = [Ifges(4,2) * t65 + 0.2e1 * t58 * t80 + t38 * t100 + t26 * t101 + 0.2e1 * t8 * t27 + 0.2e1 * t7 * t28 + 0.2e1 * t12 * t9 - t21 * t5 + t22 * t6 + 0.2e1 * t2 * t10 + 0.2e1 * t1 * t11 + Ifges(2,3) + Ifges(3,3) + (Ifges(4,1) * t67 + 0.2e1 * Ifges(4,4) * t70) * t67 + (mrSges(5,1) * t100 - 0.2e1 * t25 * mrSges(5,3) + (Ifges(6,3) + Ifges(5,2)) * t45 + t82) * t45 + (mrSges(5,3) * t101 + Ifges(5,1) * t48 - t66 * t13 + t69 * t14 + (Ifges(6,5) * t69 - Ifges(6,6) * t66 - (2 * Ifges(5,4))) * t45) * t48 + m(5) * (t25 ^ 2 + t49 ^ 2 + t102) + m(4) * (t83 * t56 ^ 2 + t58 ^ 2) + m(7) * (t1 ^ 2 + t12 ^ 2 + t2 ^ 2) + m(6) * (t7 ^ 2 + t8 ^ 2 + t102) + m(3) * (t68 ^ 2 + t71 ^ 2) * pkin(1) ^ 2 + 0.2e1 * (t71 * mrSges(3,1) - t68 * mrSges(3,2)) * pkin(1) + 0.2e1 * t83 * t56 * mrSges(4,3); t22 * t10 - t21 * t11 + t77 * t48 + t95 * t45 + m(7) * (-t1 * t21 + t12 * t45 + t2 * t22) + m(6) * (t78 * t48 + t91) + m(5) * (t25 * t48 + t91); m(3) + m(7) * (t21 ^ 2 + t22 ^ 2 + t42) + m(6) * (t84 * t43 + t42) + m(5) * (t43 + t42) + m(4) * t83; t45 * mrSges(5,1) + t47 * t10 + t44 * t11 + t66 * t27 + t69 * t28 + t38 + m(7) * (t44 * t1 + t47 * t2) + m(6) * (t66 * t8 + t69 * t7) + m(5) * t49 + m(4) * t58 + t80; m(7) * (-t44 * t21 + t47 * t22); m(4) + m(5) + m(6) * t84 + m(7) * (t44 ^ 2 + t47 ^ 2); t66 * t14 / 0.2e1 + t13 * t98 + t59 * t9 - Ifges(5,6) * t45 + t47 * t6 / 0.2e1 + t44 * t5 / 0.2e1 - t25 * mrSges(5,2) - pkin(4) * t26 + t12 * t29 - t21 * t30 / 0.2e1 + t22 * t31 / 0.2e1 + t32 * t11 + t33 * t10 + t85 * t23 + t77 * qJ(5) + (-t1 * t47 + t2 * t44) * mrSges(7,3) + t78 * mrSges(6,3) + m(6) * (-pkin(4) * t23 + t78 * qJ(5)) + m(7) * (t32 * t1 + t59 * t12 + t33 * t2) + (-t66 * t53 / 0.2e1 + t54 * t98 + Ifges(5,5)) * t48 + (Ifges(6,5) * t66 + Ifges(6,6) * t69 + t86) * t45 / 0.2e1; -t38 + (t21 * t47 + t22 * t44) * mrSges(7,3) + t84 * t48 * mrSges(6,3) + (t29 + t85) * t45 + m(7) * (-t32 * t21 + t33 * t22 + t59 * t45) + m(6) * (t48 * t79 - t97); m(7) * (t32 * t44 + t33 * t47); -0.2e1 * pkin(4) * t51 + 0.2e1 * t59 * t29 + t44 * t30 + t47 * t31 + t69 * t53 + t66 * t54 + Ifges(5,3) + m(7) * (t32 ^ 2 + t33 ^ 2 + t59 ^ 2) + m(6) * (t84 * qJ(5) ^ 2 + pkin(4) ^ 2) + 0.2e1 * (-t32 * t47 + t33 * t44) * mrSges(7,3) + 0.2e1 * mrSges(6,3) * t79; m(6) * t23 + m(7) * t12 + t95; 0.2e1 * (m(7) / 0.2e1 + m(6) / 0.2e1) * t45; 0; -m(6) * pkin(4) + m(7) * t59 + t29 + t51; m(6) + m(7); t1 * mrSges(7,1) - t2 * mrSges(7,2) + t82; -t9; -t29; t32 * mrSges(7,1) - t33 * mrSges(7,2) + t86; 0; Ifges(7,3);];
