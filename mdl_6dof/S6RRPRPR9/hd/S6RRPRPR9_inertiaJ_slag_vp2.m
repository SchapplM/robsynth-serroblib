...
% OptimizationMode: 2
% StartTime: 2018-11-23 17:05:58
% EndTime: 2018-11-23 17:05:59
...
t182 = pkin(1) * t161;
t180 = pkin(10) + qJ(5);
t113 = pkin(1) * t156 * t159 + pkin(8) * t171;
t103 = qJ(3) * t156 + t113;
t104 = (-pkin(2) * t161 - qJ(3) * t159 - pkin(1)) * t153;
t61 = -t103 * t152 + t104 * t155;
t45 = -pkin(3) * t171 - pkin(9) * t111 + t61;
t62 = t103 * t155 + t104 * t152;
t50 = pkin(9) * t110 + t62;
...
t42 = t73 * mrSges(5,1) + mrSges(5,2) * t74;
t32 = -t54 * mrSges(6,1) + mrSges(6,2) * t55;
t10 = -t30 * mrSges(7,1) + mrSges(7,2) * t31;
t43 = t75 * mrSges(7,1) + mrSges(7,2) * t76;
t5 = -t151 * t20 + t154 * t26;
t46 = -t151 * t97 + t154 * t82;
t80 = -t110 * mrSges(4,1) + mrSges(4,2) * t111;
t127 = -t155 * mrSges(4,1) + mrSges(4,2) * t152;
t87 = t122 * mrSges(5,1) + mrSges(5,2) * t124;
t126 = -mrSges(6,1) * t154 + mrSges(6,2) * t151;
t22 = -t158 * t50 + t183 * t45;
t86 = -mrSges(7,1) * t121 + mrSges(7,2) * t123;
t164 = -t152 * t61 + t155 * t62;
t21 = pkin(4) * t171 - t22;
...
t2 = t157 * t3 + t160 * t4;
t1 = -t157 * t4 + t160 * t3;
t16 = [0.2e1 * t11 * t10 + 0.2e1 * t2 * t14 + 0.2e1 * t1 * t15 + m(6) * (t21 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t11 ^ 2 + t2 ^ 2) + m(5) * (t22 ^ 2 + t23 ^ 2 + t79 ^ 2) + m(4) * (t106 ^ 2 + t61 ^ 2 + t62 ^ 2) + m(3) * (pkin(1) ^ 2 * t153 ^ 2 + t112 ^ 2 + t113 ^ 2) + (t7 + t17 - t39) * t73 + t30 * t8 + t31 * t9 + 0.2e1 * t21 * t32 + 0.2e1 * t6 * t37 + 0.2e1 * t5 * t38 + Ifges(2,3) + t54 * t18 + t55 * t19 + 0.2e1 * t23 * t59 + 0.2e1 * t22 * t60 + (t166 - 0.2e1 * t175 + 0.2e1 * t176) * t156 + t74 * t40 + 0.2e1 * t79 * t42 + ((-0.2e1 * t112 * mrSges(3,3) + Ifges(3,5) * t156 + (-0.2e1 * mrSges(3,2) * pkin(1) + Ifges(3,1) * t159) * t153) * t159 + (0.2e1 * t113 * mrSges(3,3) - Ifges(4,5) * t111 + Ifges(3,6) * t156 - Ifges(4,6) * t110 + (0.2e1 * pkin(1) * mrSges(3,1) + 0.2e1 * Ifges(3,4) * t159 + (Ifges(5,3) + Ifges(4,3) + Ifges(3,2)) * t161) * t153 + t179) * t161) * t153 + 0.2e1 * t62 * t98 + 0.2e1 * t61 * t99 + 0.2e1 * t106 * t80 + t110 * t64 + t111 * t65; t13 * t14 + t12 * t15 + (-t23 * mrSges(5,3) + t7 / 0.2e1 + t17 / 0.2e1 - t39 / 0.2e1) * t122 - t175 + t176 + t55 * t190 + t54 * t191 + t164 * mrSges(4,3) + m(4) * (-pkin(2) * t106 + qJ(3) * t164) + t166 + t30 * t35 / 0.2e1 + t31 * t36 / 0.2e1 + t11 * t43 + t46 * t38 + t47 * t37 + m(7) * (t1 * t12 + t11 * t63 + t13 * t2) + m(6) * (t21 * t94 + t46 * t5 + t47 * t6) + m(5) * (t143 * t79 - t22 * t94 + t23 * t97) + t2 * t51 + t1 * t52 + (t34 / 0.2e1 + t56 / 0.2e1 - t90 / 0.2e1) * t73 + t63 * t10 - t75 * t8 / 0.2e1 + t76 * t9 / 0.2e1 - pkin(2) * t80 + t21 * t81 + t6 * t83 + t5 * t84 + t79 * t87 + t74 * t92 / 0.2e1 + t97 * t59 - (Ifges(4,5) * t152 + Ifges(4,6) * t155 + t170) * t171 / 0.2e1 + t106 * t127 + t110 * t132 / 0.2e1 + t111 * t134 / 0.2e1 + t143 * t42 + (-t22 * mrSges(5,3) - t151 * t18 / 0.2e1 + t154 * t192 + t40 / 0.2e1) * t124 + t152 * t65 / 0.2e1 + t155 * t64 / 0.2e1 + (-t152 * t99 + t155 * t98) * qJ(3) + (t32 - t60) * t94; -0.2e1 * pkin(2) * t127 + 0.2e1 * t12 * t52 + 0.2e1 * t13 * t51 + t155 * t132 + t152 * t134 + 0.2e1 * t143 * t87 - t75 * t35 + t76 * t36 + 0.2e1 * t63 * t43 + 0.2e1 * t46 * t84 + 0.2e1 * t47 * t83 + t81 * t193 + Ifges(3,3) + 0.2e1 * t168 * qJ(3) * mrSges(4,3) + (mrSges(5,3) * t193 - t151 * t57 + t154 * t58 + t92) * t124 + (-0.2e1 * mrSges(5,3) * t97 + t34 + t56 - t90) * t122 + m(7) * (t12 ^ 2 + t13 ^ 2 + t63 ^ 2) + m(6) * (t46 ^ 2 + t47 ^ 2 + t194) + m(5) * (t143 ^ 2 + t97 ^ 2 + t194) + m(4) * (qJ(3) ^ 2 * t168 + pkin(2) ^ 2); t121 * t15 + t123 * t14 + t151 * t37 + t154 * t38 + m(7) * (t1 * t121 + t123 * t2) + m(6) * (t151 * t6 + t154 * t5) + m(5) * t79 + m(4) * t106 + t80 + t42; -m(4) * pkin(2) + t121 * t52 + t123 * t51 + t151 * t83 + t154 * t84 + m(7) * (t12 * t121 + t123 * t13) + m(6) * (t151 * t47 + t154 * t46) + m(5) * t143 + t87 + t127; m(4) + m(5) + m(6) * t169 + m(7) * (t121 ^ 2 + t123 ^ 2); m(7) * (t1 * t93 + t11 * t142 + t2 * t96) - t179 + (-t1 * t123 + t121 * t2) * mrSges(7,3) + m(6) * (-pkin(4) * t21 + (-t151 * t5 + t154 * t6) * qJ(5)) + t167 * t73 + (qJ(5) * t37 + t6 * mrSges(6,3) + t18 / 0.2e1) * t154 + (-t5 * mrSges(6,3) - qJ(5) * t38 + t192) * t151 + t22 * mrSges(5,1) - t23 * mrSges(5,2) - pkin(4) * t32 - Ifges(5,3) * t171 + t11 * t86 + t30 * t189 + t31 * t188 + t93 * t15 + t96 * t14 + t8 * t187 + t9 * t186 + t21 * t126 + t54 * t131 / 0.2e1 + t55 * t185 + t142 * t10; -pkin(4) * t81 + t63 * t86 - t75 * t189 + t76 * t188 + t93 * t52 + t96 * t51 - t97 * mrSges(5,2) + t35 * t187 + t36 * t186 + t142 * t43 + (-mrSges(5,1) + t126) * t94 + t167 * t122 + (-t12 * t123 + t121 * t13) * mrSges(7,3) + (t47 * mrSges(6,3) + qJ(5) * t83 + t124 * t185 + t191) * t154 + (-t46 * mrSges(6,3) - qJ(5) * t84 - t124 * t131 / 0.2e1 + t190) * t151 + m(7) * (t12 * t93 + t13 * t96 + t142 * t63) + m(6) * (-pkin(4) * t94 + (-t151 * t46 + t154 * t47) * qJ(5)) + t170; m(7) * (t121 * t93 + t123 * t96); -0.2e1 * pkin(4) * t126 + t121 * t89 + t123 * t91 + t154 * t131 + t151 * t133 + 0.2e1 * t142 * t86 + Ifges(5,3) + m(7) * (t142 ^ 2 + t93 ^ 2 + t96 ^ 2) + m(6) * (qJ(5) ^ 2 * t169 + pkin(4) ^ 2) + 0.2e1 * (t121 * t96 - t123 * t93) * mrSges(7,3) + 0.2e1 * t169 * qJ(5) * mrSges(6,3); m(6) * t21 + m(7) * t11 + t10 + t32; m(6) * t94 + m(7) * t63 + t43 + t81; 0; -m(6) * pkin(4) + m(7) * t142 + t126 + t86; m(6) + m(7); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t12 - mrSges(7,2) * t13 + t34; -t86; mrSges(7,1) * t93 - mrSges(7,2) * t96 + t88; 0; Ifges(7,3);];
