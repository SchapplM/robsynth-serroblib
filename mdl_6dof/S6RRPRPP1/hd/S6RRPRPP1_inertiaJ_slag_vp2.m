...
t20 = -t73 * mrSges(7,1) - t35 * mrSges(7,2);
t125 = -t19 + t20;
t121 = t100 ^ 2 + t102 ^ 2;
t120 = t101 ^ 2 + t103 ^ 2;
t119 = Ifges(5,4) * t100;
...
t47 = t71 * mrSges(6,1) + t74 * mrSges(6,2);
t14 = t34 * mrSges(7,1) + t35 * mrSges(7,3);
t46 = t71 * mrSges(7,1) - t74 * mrSges(7,3);
t25 = pkin(4) * t117 + t53;
t3 = -t13 * t96 + t7 * t98;
...
t2 = -pkin(5) * t73 - t3;
t1 = qJ(6) * t73 + t4;
t6 = [-0.2e1 * pkin(1) * (-t103 * mrSges(3,1) + t101 * mrSges(3,2)) + t103 * (Ifges(3,4) * t101 + Ifges(3,2) * t103) + t101 * (Ifges(3,1) * t101 + Ifges(3,4) * t103) + t61 * t130 + 0.2e1 * t17 * t44 + 0.2e1 * t16 * t45 + t42 * t131 + 0.2e1 * t25 * t15 + 0.2e1 * t5 * t14 + 0.2e1 * t4 * t18 + 0.2e1 * t3 * t19 + 0.2e1 * t2 * t20 + 0.2e1 * t1 * t21 + Ifges(2,3) - (t10 + t11) * t35 + (-t9 + t8) * t34 + 0.2e1 * t120 * pkin(7) * mrSges(3,3) + (mrSges(4,3) * t131 + Ifges(4,1) * t75 - t100 * t23 + t102 * t24) * t75 + (mrSges(4,1) * t130 - 0.2e1 * mrSges(4,3) * t55 + Ifges(4,2) * t73 + (-Ifges(5,6) * t100 - (2 * Ifges(4,4))) * t75 + t107) * t73 + m(3) * (t120 * pkin(7) ^ 2 + pkin(1) ^ 2) + m(4) * (t55 ^ 2 + t89 ^ 2 + t132) + m(5) * (t16 ^ 2 + t17 ^ 2 + t132) + m(6) * (t25 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2); t133 * t73 / 0.2e1 + (t78 - mrSges(4,1)) * t53 + (t23 / 0.2e1 + t75 * t81 / 0.2e1 + t86 * t44 + t17 * mrSges(5,3)) * t102 + m(5) * (t53 * t88 + (-t16 * t100 + t17 * t102) * t86) + ((-t73 * t97 - t75 * t99) * mrSges(4,3) + m(4) * (-t53 * t99 + t55 * t97)) * pkin(2) + (-t86 * t45 - t75 * t80 / 0.2e1 - t16 * mrSges(5,3) + t24 / 0.2e1) * t100 + m(6) * (t25 * t77 - t3 * t39 + t4 * t41) + m(7) * (t1 * t41 + t2 * t39 + t33 * t5) + (t2 * mrSges(7,2) - t3 * mrSges(6,3) + t10 / 0.2e1 + t11 / 0.2e1) * t74 + (-t1 * mrSges(7,2) - t4 * mrSges(6,3) - t9 / 0.2e1 + t8 / 0.2e1) * t71 - (t50 / 0.2e1 + t51 / 0.2e1) * t35 + (t48 / 0.2e1 - t49 / 0.2e1) * t34 + Ifges(3,6) * t103 + Ifges(3,5) * t101 + t88 * t42 + Ifges(4,5) * t75 + t77 * t15 - Ifges(4,6) * t73 + t5 * t46 + t25 * t47 - t55 * mrSges(4,2) + t33 * t14 + t125 * t39 + t126 * t41 + (-t101 * mrSges(3,1) - t103 * mrSges(3,2)) * pkin(7); t100 * t81 + t102 * t80 + 0.2e1 * t33 * t46 + 0.2e1 * t77 * t47 + 0.2e1 * t88 * t78 + Ifges(3,3) + Ifges(4,3) + (t50 + t51) * t74 + (t48 - t49) * t71 + m(6) * (t77 ^ 2 + t114) + m(7) * (t33 ^ 2 + t114) + m(5) * (t121 * t86 ^ 2 + t88 ^ 2) + m(4) * (t97 ^ 2 + t99 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t99 - mrSges(4,2) * t97) * pkin(2) + 0.2e1 * t121 * t86 * mrSges(5,3) + 0.2e1 * (t39 * t74 - t41 * t71) * (mrSges(7,2) + mrSges(6,3)); t73 * mrSges(4,1) + t100 * t44 + t102 * t45 + t61 + t126 * t74 + t125 * t71 + m(6) * (-t3 * t71 + t4 * t74) + m(7) * (t1 * t74 + t2 * t71) + m(5) * (t100 * t17 + t102 * t16) + m(4) * t89; t134 * (t39 * t71 + t74 * t41); m(5) * t121 + m(4) + t134 * (t71 ^ 2 + t74 ^ 2); (m(6) * (t3 * t98 + t4 * t96) + t96 * t18 + t98 * t19) * pkin(4) + m(7) * (t1 * t83 + t2 * t87) + t107 - Ifges(5,6) * t117 + t87 * t20 + t83 * t21 + t16 * mrSges(5,1) - t17 * mrSges(5,2) + t1 * mrSges(7,3) - t2 * mrSges(7,1) + t3 * mrSges(6,1) - t4 * mrSges(6,2); -t39 * mrSges(7,1) + t41 * mrSges(7,3) - t41 * mrSges(6,2) - t39 * mrSges(6,1) + m(7) * (t39 * t87 + t41 * t83) - t109 * t86 + (-t71 * t83 + t74 * t87) * mrSges(7,2) + (m(6) * (-t39 * t98 + t41 * t96) + (-t71 * t96 - t74 * t98) * mrSges(6,3)) * pkin(4) + t133; m(7) * (t71 * t87 + t74 * t83) + (-t71 * t98 + t74 * t96) * t135 + t108 - t78; -0.2e1 * t87 * mrSges(7,1) + 0.2e1 * t83 * mrSges(7,3) + m(7) * (t83 ^ 2 + t87 ^ 2) + (0.2e1 * mrSges(6,1) * t98 - 0.2e1 * mrSges(6,2) * t96 + (t96 ^ 2 + t98 ^ 2) * t135) * pkin(4) + t136; m(6) * t25 + m(7) * t5 + t14 + t15; m(6) * t77 + m(7) * t33 - t108; 0; 0; t134; m(7) * t2 + t20; m(7) * t39 + t74 * mrSges(7,2); m(7) * t71; m(7) * t87 - mrSges(7,1); 0; m(7);];
