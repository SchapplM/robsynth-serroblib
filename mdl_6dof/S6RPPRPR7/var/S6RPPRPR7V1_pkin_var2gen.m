% Umwandlung der Kinematikparameter von S6RPPRPR7V1 zu S6RPPRPR7
% Eingabe:
% pkin_var (9x1) double
...
%
% Siehe auch: S6RPPRPR7_structural_kinematic_parameters.m
function pkin_gen = S6RPPRPR7V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
