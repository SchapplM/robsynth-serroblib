...
% OptimizationMode: 2
% StartTime: 2018-11-23 15:42:56
% EndTime: 2018-11-23 15:42:56
...
t27 = -mrSges(6,2) * t49 + mrSges(6,3) * t96;
t28 = mrSges(6,1) * t49 + mrSges(6,3) * t95;
t81 = t72 * t27 - t70 * t28;
t79 = qJ(2) ^ 2;
...
t11 = mrSges(7,1) * t49 - mrSges(7,3) * t23;
t10 = -mrSges(7,2) * t49 + mrSges(7,3) * t21;
t6 = pkin(8) * t96 + t9;
t5 = Ifges(7,1) * t23 + Ifges(7,4) * t21 + Ifges(7,5) * t49;
t4 = Ifges(7,4) * t23 + Ifges(7,2) * t21 + Ifges(7,6) * t49;
t3 = pkin(5) * t49 + pkin(8) * t95 + t8;
t2 = t3 * t75 + t6 * t77;
t1 = t3 * t77 - t6 * t75;
t15 = [Ifges(4,1) * t68 - 0.2e1 * t58 * t40 + 0.2e1 * t29 * t24 + t21 * t4 + t23 * t5 + 0.2e1 * t9 * t27 + 0.2e1 * t8 * t28 + 0.2e1 * t2 * t10 + 0.2e1 * t1 * t11 + 0.2e1 * t14 * t7 + Ifges(3,1) + Ifges(2,3) - (2 * pkin(1) * mrSges(3,2)) + (-0.2e1 * Ifges(4,4) * t73 + Ifges(4,2) * t71) * t71 - 0.2e1 * t74 * t84 + (0.2e1 * t58 * mrSges(5,1) + t31 * t106 + (Ifges(6,3) + Ifges(5,2)) * t49 + t87) * t49 + (t29 * t106 + Ifges(5,1) * t48 + t70 * t12 - t72 * t13 + (-Ifges(6,5) * t72 + Ifges(6,6) * t70 + (2 * Ifges(5,4))) * t49) * t48 + m(4) * (t88 * t74 ^ 2 + t79) + m(3) * ((pkin(1) ^ 2) + t79) + m(5) * (t31 ^ 2 + t58 ^ 2 + t108) + m(6) * (t8 ^ 2 + t9 ^ 2 + t108) + m(7) * (t1 ^ 2 + t14 ^ 2 + t2 ^ 2) + 0.2e1 * (t90 + mrSges(3,3)) * qJ(2); -m(3) * pkin(1) - t107 * mrSges(5,3) - t22 * t10 - t20 * t11 + mrSges(3,2) + t101 * t48 - t84 + (-mrSges(5,3) * t49 + t81) * t49 + m(7) * (-t1 * t20 + t14 * t48 - t2 * t22) + m(6) * (t82 * t49 + t97) + m(5) * (t31 * t49 + t97) + t74 * t86; m(3) + m(6) * (t89 * t45 + t107) + m(7) * (t20 ^ 2 + t22 ^ 2 + t107) + m(5) * (t45 + t107) + t86; m(4) * qJ(2) + t49 * mrSges(5,1) + t50 * t10 - t80 * t11 + t70 * t27 + t72 * t28 - t40 + m(7) * (-t1 * t80 + t2 * t50) + m(6) * (t70 * t9 + t72 * t8) + m(5) * t58 + t90; m(7) * (t20 * t80 - t22 * t50); m(4) + m(5) + m(6) * t89 + m(7) * (t50 ^ 2 + t80 ^ 2); t13 * t103 + t72 * t12 / 0.2e1 + t60 * t7 - Ifges(5,6) * t49 + t50 * t5 / 0.2e1 - t80 * t4 / 0.2e1 - t31 * mrSges(5,2) + t14 * t32 + t21 * t33 / 0.2e1 + t23 * t34 / 0.2e1 + t35 * t11 + t36 * t10 - pkin(4) * t24 + t91 * t29 + t81 * qJ(5) + (-t1 * t50 - t2 * t80) * mrSges(7,3) + t82 * mrSges(6,3) + m(6) * (-pkin(4) * t29 + t82 * qJ(5)) + m(7) * (t1 * t35 + t14 * t60 + t2 * t36) + (t56 * t103 - t72 * t57 / 0.2e1 - Ifges(5,5)) * t48 + (Ifges(6,5) * t70 + Ifges(6,6) * t72 + t92) * t49 / 0.2e1; (t20 * t50 + t22 * t80) * mrSges(7,3) + (t89 * mrSges(6,3) - mrSges(5,2)) * t49 + (t32 + t91) * t48 + m(6) * (-pkin(4) * t48 + t49 * t83) + m(7) * (-t20 * t35 - t22 * t36 + t48 * t60); m(7) * (-t35 * t80 + t36 * t50); -0.2e1 * pkin(4) * t54 + 0.2e1 * t60 * t32 - t80 * t33 + t50 * t34 + t72 * t56 + t70 * t57 + Ifges(5,3) + m(7) * (t35 ^ 2 + t36 ^ 2 + t60 ^ 2) + m(6) * (t89 * qJ(5) ^ 2 + pkin(4) ^ 2) + 0.2e1 * (-t35 * t50 - t36 * t80) * mrSges(7,3) + 0.2e1 * mrSges(6,3) * t83; m(6) * t29 + m(7) * t14 + t101; 0.2e1 * (m(6) / 0.2e1 + m(7) / 0.2e1) * t48; 0; -m(6) * pkin(4) + m(7) * t60 + t32 + t54; m(6) + m(7); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t87; -mrSges(7,1) * t20 + mrSges(7,2) * t22; -t32; mrSges(7,1) * t35 - mrSges(7,2) * t36 + t92; 0; Ifges(7,3);];
