...
t109 = t39 * pkin(4) + t37 * pkin(9);
t32 = t48 * pkin(5) + pkin(4);
t51 = -pkin(10) - pkin(9);
t111 = t39 * t32 - t37 * t51;
...
t5 = t34 * t86 + t35 * t38;
t6 = -t34 * t83 + t35 * t36;
t98 = -t5 * mrSges(7,1) + t6 * mrSges(7,2);
t7 = t34 * t38 - t35 * t86;
t8 = t34 * t36 + t35 * t83;
t97 = t7 * mrSges(7,1) - t8 * mrSges(7,2);
t92 = g(3) * t37;
t47 = sin(qJ(1));
t91 = t47 * pkin(1);
t40 = t49 * pkin(3);
...
t12 = t35 * t81 + t89;
t10 = -t34 * t81 + t87;
t1 = [(-t89 * t99 - t50 * mrSges(2,1) - t12 * mrSges(6,1) - t8 * mrSges(7,1) + t47 * mrSges(2,2) - t11 * mrSges(6,2) - t7 * mrSges(7,2) + t106 * (t35 * t33 - t34 * t52 + t41) - t113 * t41 + t100 * t34 + (-t101 + t114) * t35) * g(2) + (-t87 * t99 + t47 * mrSges(2,1) - t10 * mrSges(6,1) - t6 * mrSges(7,1) + t50 * mrSges(2,2) - t9 * mrSges(6,2) - t5 * mrSges(7,2) + t113 * t91 + t106 * (-t35 * t52 - t91) + t100 * t35 + (m(5) * t33 - m(6) * (-t33 - t109) - m(7) * (-t33 - t111) + t101) * t34) * g(1) (t106 - t113) * g(3) (t108 * t34 + t104) * g(2) + (t108 * t35 + t103) * g(1) + (-t66 - m(5) * t40 - m(6) * (t40 + t109) - m(7) * (t40 + t111) + t105) * g(3) + (m(5) * t96 + mrSges(4,1) * t46 + mrSges(4,2) * t49 + t63) * t107, t107 * t63 + (t102 * t34 + t104) * g(2) + (t102 * t35 + t103) * g(1) + (t105 + t114) * g(3) (mrSges(6,2) * t48 + t112 * t45 - t62) * t92 + (-t10 * mrSges(6,2) + t112 * t9 - t98) * g(2) + (t12 * mrSges(6,2) - t112 * t11 - t97) * g(1), -g(1) * t97 - g(2) * t98 - t62 * t92];
taug  = t1(:);
