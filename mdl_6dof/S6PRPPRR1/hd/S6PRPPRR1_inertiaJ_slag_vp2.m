...
% OptimizationMode: 2
% StartTime: 2018-11-23 14:53:34
% EndTime: 2018-11-23 14:53:34
...
t6 = [m(2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t93) + m(6) * (t7 ^ 2 + t21 + t93) + m(5) * (t19 ^ 2 + t20 ^ 2 + t21) + m(4) * (t24 ^ 2 + t21 + t50) + m(3) * (t50 + (t61 ^ 2 + t63 ^ 2) * t55 ^ 2); -t24 * mrSges(4,2) + t1 * t17 + t5 * t14 + t2 * t16 + (t63 * mrSges(3,1) - t61 * mrSges(3,2)) * t55 + (-t7 * t31 + t5 * t33) * mrSges(6,3) + t66 * mrSges(5,3) + (-mrSges(4,1) + t96) * t22 + m(7) * (t3 * t1 + t4 * t2 + t87) + m(6) * (t13 * t7 + t34 * t22 + t87) + m(5) * (t43 * t22 + t41 * t66) + m(4) * (-t22 * t57 + t24 * t54) * pkin(2); Ifges(5,2) * t49 + t14 * t90 + 0.2e1 * t4 * t16 + 0.2e1 * t3 * t17 + 0.2e1 * t34 * t18 + 0.2e1 * t43 * t35 + Ifges(3,3) + Ifges(4,3) + (Ifges(5,1) * t53 + 0.2e1 * Ifges(5,4) * t56) * t53 + (-0.2e1 * t13 * mrSges(6,3) + Ifges(6,2) * t31 + t75) * t31 + (mrSges(6,3) * t90 + Ifges(6,1) * t33 - t59 * t8 + t62 * t9 + (-Ifges(7,6) * t59 - (2 * Ifges(6,4))) * t31) * t33 + m(7) * (t3 ^ 2 + t4 ^ 2 + t92) + m(6) * (t13 ^ 2 + t34 ^ 2 + t92) + m(5) * (t41 ^ 2 * t73 + t43 ^ 2) + m(4) * (t54 ^ 2 + t57 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (t57 * mrSges(4,1) - t54 * mrSges(4,2)) * pkin(2) + 0.2e1 * t73 * t41 * mrSges(5,3); m(4) * t58 + m(7) * (t33 * t69 + t86) + m(6) * (t33 * t7 + t86) + m(5) * (t56 * t19 + t53 * t20); t31 * t14 + t95 * t33 + m(7) * (t33 * t68 + t81) + m(6) * (t33 * t13 + t81); m(4) + m(5) * t73 + m(6) * (t30 + t91) + m(7) * (t30 * t72 + t91); m(7) * (t62 * t1 + t59 * t2) + 0.2e1 * (m(6) / 0.2e1 + m(5) / 0.2e1) * t22; t59 * t16 + t62 * t17 + m(7) * (t62 * t3 + t59 * t4) + m(6) * t34 + m(5) * t43 + t96; 0; m(7) * t72 + m(5) + m(6); -t7 * mrSges(6,2) + (m(7) * pkin(9) + mrSges(7,3)) * t69 + t94 * t5; t59 * t9 / 0.2e1 + t8 * t89 - pkin(5) * t14 - t13 * mrSges(6,2) + t68 * mrSges(7,3) + (-t59 * t37 / 0.2e1 + t38 * t89 + Ifges(6,5)) * t33 + (t74 / 0.2e1 - Ifges(6,6)) * t31 + t94 * t11 + (m(7) * t68 + t95) * pkin(9); t31 * t36 + m(7) * (pkin(9) * t70 - t88) + mrSges(7,3) * t70 - t18; 0; Ifges(6,3) - 0.2e1 * pkin(5) * t36 + t59 * t38 + t62 * t37 + m(7) * (pkin(9) ^ 2 * t72 + pkin(5) ^ 2) + 0.2e1 * t72 * pkin(9) * mrSges(7,3); t1 * mrSges(7,1) - t2 * mrSges(7,2); t3 * mrSges(7,1) - t4 * mrSges(7,2) - Ifges(7,6) * t80 + t75; -t14; -t36; -pkin(9) * t67 + t74; Ifges(7,3);];
