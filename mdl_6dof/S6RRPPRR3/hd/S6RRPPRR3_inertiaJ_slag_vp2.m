...
t3 = -t79 * pkin(5) - t5;
t12 = [Ifges(4,1) * t80 ^ 2 + ((Ifges(3,5) * t130 + Ifges(3,6) * t132) * t127 + 0.2e1 * (-t130 * t84 + t132 * t85) * mrSges(3,3) + (t130 * (Ifges(3,1) * t130 + Ifges(3,4) * t132) - 0.2e1 * pkin(1) * (-mrSges(3,1) * t132 + mrSges(3,2) * t130) + t132 * (Ifges(3,4) * t130 + Ifges(3,2) * t132) + m(3) * pkin(1) ^ 2) * t124) * t124 + (mrSges(4,1) * t171 - 0.2e1 * Ifges(4,4) * t80 + Ifges(5,5) * t68 + Ifges(5,6) * t67 + (Ifges(5,3) + Ifges(4,2)) * t79 + t142) * t79 + t39 * t17 + 0.2e1 * t43 * t41 + t25 * t8 + t26 * t9 + 0.2e1 * t27 * t20 + 0.2e1 * t6 * t28 + 0.2e1 * t5 * t29 + 0.2e1 * t3 * t11 + 0.2e1 * t2 * t14 + 0.2e1 * t1 * t15 + m(3) * (t84 ^ 2 + t85 ^ 2) + (t135 - 0.2e1 * t159 + 0.2e1 * t160 + t177) * t127 + m(4) * (t46 ^ 2 + t47 ^ 2 + t94 ^ 2) + m(5) * (t21 ^ 2 + t22 ^ 2 + t43 ^ 2) + m(6) * (t27 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) + (t7 - t16) * t38 + t75 * t171 + 0.2e1 * t22 * t49 + 0.2e1 * t21 * t50 + t67 * t32 + t68 * t33 + 0.2e1 * t47 * t70 + 0.2e1 * t46 * t71 + Ifges(2,3); (Ifges(5,5) * t122 + Ifges(5,6) * t125 + t155) * t79 / 0.2e1 + (t9 * t163 + t8 * t165 - t5 * mrSges(6,3) + t17 / 0.2e1) * t93 + t30 * t15 + t31 * t14 + (-t122 * t50 + t125 * t49) * t110 + m(6) * (t27 * t95 - t5 * t55 + t57 * t6) + m(7) * (t1 * t30 + t2 * t31 + t3 * t55) + (-t6 * mrSges(6,3) + t7 / 0.2e1 - t16 / 0.2e1) * t91 - t159 + t160 + t53 * t169 + t52 * t170 + (t51 / 0.2e1 - t64 / 0.2e1) * t38 + t135 + (t123 * t70 + t126 * t71 + m(4) * (t123 * t47 + t126 * t46)) * pkin(2) + t156 * t55 + m(5) * (t110 * t137 + t112 * t43) + t137 * mrSges(5,3) + t46 * mrSges(4,1) - t47 * mrSges(4,2) + t57 * t28 + t3 * t58 + t2 * t60 + t1 * t61 + t27 * t63 + t39 * t65 / 0.2e1 + t95 * t20 + t43 * t96 + t67 * t97 / 0.2e1 + t68 * t98 / 0.2e1 + t112 * t41 + t122 * t33 / 0.2e1 + t125 * t32 / 0.2e1; 0.2e1 * t112 * t96 + t122 * t98 + t125 * t97 + 0.2e1 * t30 * t61 + 0.2e1 * t31 * t60 + t58 * t172 + 0.2e1 * t95 * t63 + (-0.2e1 * mrSges(6,3) * t57 + t51 - t64) * t91 + (mrSges(6,3) * t172 - t128 * t52 + t131 * t53 + t65) * t93 + m(7) * (t30 ^ 2 + t31 ^ 2 + t174) + m(6) * (t57 ^ 2 + t95 ^ 2 + t174) + m(5) * (t110 ^ 2 * t144 + t112 ^ 2) + m(4) * (t123 ^ 2 + t126 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t126 - mrSges(4,2) * t123) * pkin(2) + 0.2e1 * t144 * t110 * mrSges(5,3) + t178; t79 * mrSges(4,1) + t122 * t49 + t125 * t50 + t75 + t156 * t91 + (t28 + t175) * t93 + m(7) * (t139 * t93 + t91 * t3) + m(6) * (-t5 * t91 + t6 * t93) + m(5) * (t122 * t22 + t125 * t21) + m(4) * t94; t91 * t58 + t176 * t93 + m(7) * (t136 * t93 + t158) + m(6) * (t57 * t93 + t158); m(4) + m(5) * t144 + m(6) * (t90 + t173) + m(7) * (t143 * t90 + t173); t128 * t14 + t131 * t15 + m(7) * (t1 * t131 + t128 * t2) + m(6) * t27 + m(5) * t43 + t20 + t41; t128 * t60 + t131 * t61 + m(7) * (t128 * t31 + t131 * t30) + m(6) * t95 + m(5) * t112 + t96 + t63; 0; m(7) * t143 + m(5) + m(6); t5 * mrSges(6,1) - t6 * mrSges(6,2) + t139 * mrSges(7,3) + t101 * t170 + t102 * t169 + t8 * t163 + t9 * t164 + t38 * t166 + t3 * t99 + t142 + (-m(7) * t3 - t11) * pkin(5) + (m(7) * t139 + t175) * pkin(10); t53 * t164 + t52 * t163 - pkin(5) * t58 + t91 * t166 - t57 * mrSges(6,2) + (t101 * t165 + t102 * t163) * t93 + t136 * mrSges(7,3) + t155 + (-m(7) * pkin(5) - mrSges(6,1) + t99) * t55 + (m(7) * t136 + t176) * pkin(10); t91 * t99 + m(7) * (pkin(10) * t140 - t167) + mrSges(7,3) * t140 - t63; 0; Ifges(6,3) - 0.2e1 * pkin(5) * t99 + t128 * t102 + t131 * t101 + m(7) * (pkin(10) ^ 2 * t143 + pkin(5) ^ 2) + 0.2e1 * t143 * pkin(10) * mrSges(7,3); mrSges(7,1) * t1 - mrSges(7,2) * t2 + t7; mrSges(7,1) * t30 - mrSges(7,2) * t31 + t51; -t58; -t99; -pkin(10) * t138 + t100; Ifges(7,3);];
