...
% OptimizationMode: 2
% StartTime: 2019-03-09 07:08:14
% EndTime: 2019-03-09 07:08:17
...
t1 = [Ifges(4,2) * t79 ^ 2 + Ifges(3,2) * t103 + (-0.2e1 * t63 * mrSges(4,3) + Ifges(4,1) * t80 + Ifges(4,4) * t154) * t80 + (mrSges(5,3) * t157 + Ifges(5,1) * t59 - 0.2e1 * Ifges(5,4) * t58 + t113 * t22 + (-t21 - t152) * t109) * t59 + m(5) * (t32 ^ 2 + t68 ^ 2 + t158) + m(6) * (t12 ^ 2 + t13 ^ 2 + t158) + m(3) * (t138 * qJ(2) ^ 2 + pkin(1) ^ 2) - 0.2e1 * pkin(1) * t132 + 0.2e1 * t94 * t133 - t36 * t9 + t37 * t10 + 0.2e1 * t13 * t39 + 0.2e1 * t12 * t40 + 0.2e1 * t16 * t14 + 0.2e1 * t4 * t17 + 0.2e1 * t3 * t18 + (mrSges(5,1) * t155 - 0.2e1 * t32 * mrSges(5,3) + Ifges(5,2) * t58 + t135 + t160) * t58 + 0.2e1 * t138 * qJ(2) * mrSges(3,3) + m(4) * (t63 ^ 2 + t64 ^ 2 + t94 ^ 2) + m(7) * (t16 ^ 2 + t3 ^ 2 + t4 ^ 2) + Ifges(2,3) + t64 * mrSges(4,3) * t154 + t51 * t155 + t38 * t157 + (Ifges(3,1) * t106 + 0.2e1 * Ifges(3,4) * t107) * t106; -m(3) * pkin(1) + t58 * mrSges(5,1) + t109 * t39 + t113 * t40 + t84 * t17 + t83 * t18 + t51 + m(7) * (t3 * t83 + t4 * t84) + m(6) * (t109 * t13 + t113 * t12) + m(5) * t68 + m(4) * t94 + t132 + t133; m(3) + m(4) + m(5) + m(6) * t137 + m(7) * (t83 ^ 2 + t84 ^ 2); t96 * t38 + t87 * t14 + Ifges(4,6) * t79 + Ifges(4,5) * t80 + t63 * mrSges(4,1) - t64 * mrSges(4,2) + t56 * t18 + t57 * t17 + (m(5) * (t110 * t32 - t114 * t30) + (-t110 * t58 - t114 * t59) * mrSges(5,3)) * pkin(3) + t39 * t140 + m(6) * (t128 * t95 + t30 * t96) + (-t12 * mrSges(6,3) - t95 * t40) * t109 + m(7) * (t16 * t87 + t3 * t56 + t4 * t57) + t120; m(7) * (t56 * t83 + t57 * t84); t87 * t156 + 0.2e1 * t96 * t88 + Ifges(4,3) + 0.2e1 * t123 + (-t56 * t84 + t57 * t83) * t136 + t95 * t125 + m(7) * (t56 ^ 2 + t57 ^ 2 + t87 ^ 2) + m(6) * (t137 * t95 ^ 2 + t96 ^ 2) + m(5) * (t110 ^ 2 + t114 ^ 2) * pkin(3) ^ 2 + t130; (-t109 * t40 + t113 * t39) * pkin(9) + m(7) * (t16 * t97 + t3 * t66 + t4 * t67) + t97 * t14 + t66 * t18 + t67 * t17 - pkin(4) * t38 - mrSges(6,3) * t144 + m(6) * (-pkin(4) * t30 + t128 * pkin(9)) + t120; m(7) * (t66 * t83 + t67 * t84); (t96 - pkin(4)) * t88 + (t87 + t97) * t60 + t123 + m(7) * (t56 * t66 + t57 * t67 + t87 * t97) + m(6) * (-pkin(4) * t96 + pkin(9) * t131) + ((-t56 - t66) * t84 + (t57 + t67) * t83) * mrSges(7,3) + (t137 * pkin(9) + t131) * mrSges(6,3) + t130; -0.2e1 * pkin(4) * t88 + t97 * t156 + (-t66 * t84 + t67 * t83) * t136 + pkin(9) * t125 + m(7) * (t66 ^ 2 + t67 ^ 2 + t97 ^ 2) + m(6) * (t137 * pkin(9) ^ 2 + pkin(4) ^ 2) + t130; -Ifges(6,6) * t143 + t12 * mrSges(6,1) - t13 * mrSges(6,2) + (m(7) * (t108 * t4 + t112 * t3) + t108 * t17 + t112 * t18) * pkin(5) + t124 + t160; m(7) * (t108 * t84 + t112 * t83) * pkin(5) - t88 - t60; -t129 * t95 + (m(7) * (t108 * t57 + t112 * t56) - t134) * pkin(5) + t127 + t159; -t129 * pkin(9) + (m(7) * (t108 * t67 + t112 * t66) - t134) * pkin(5) + t126 + t159; Ifges(6,3) + Ifges(7,3) + m(7) * (t108 ^ 2 + t112 ^ 2) * pkin(5) ^ 2 + 0.2e1 * t122; t124; -t60; t127; t126; Ifges(7,3) + t122; Ifges(7,3);];
