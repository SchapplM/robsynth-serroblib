...
t2 = -t71 * pkin(5) - t3;
t1 = qJ(6) * t71 + t4;
t6 = [-0.2e1 * pkin(1) * (-t99 * mrSges(3,1) + t98 * mrSges(3,2)) + t98 * (Ifges(3,1) * t98 + Ifges(3,4) * t99) + t99 * (Ifges(3,4) * t98 + Ifges(3,2) * t99) + t62 * t129 + t42 * t130 + 0.2e1 * t17 * t44 + 0.2e1 * t16 * t45 + 0.2e1 * t25 * t15 + 0.2e1 * t5 * t14 + 0.2e1 * t4 * t18 + 0.2e1 * t3 * t19 + 0.2e1 * t2 * t20 + 0.2e1 * t1 * t21 + Ifges(2,3) + (t10 + t11) * t35 + (-t9 + t8) * t34 + 0.2e1 * t112 * pkin(7) * mrSges(3,3) + (mrSges(4,3) * t130 + Ifges(4,1) * t74 - t93 * t23 + t95 * t24) * t74 + (mrSges(4,1) * t129 - 0.2e1 * t55 * mrSges(4,3) + (Ifges(5,3) + Ifges(4,2)) * t71 + (Ifges(5,5) * t95 - Ifges(5,6) * t93 - (2 * Ifges(4,4))) * t74 + t104) * t71 + m(3) * (t112 * pkin(7) ^ 2 + pkin(1) ^ 2) + m(4) * (t55 ^ 2 + t87 ^ 2 + t131) + m(5) * (t16 ^ 2 + t17 ^ 2 + t131) + m(6) * (t25 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(7) * (t1 ^ 2 + t2 ^ 2 + t5 ^ 2); (t95 * t44 - t93 * t45) * t83 + (t78 - mrSges(4,1)) * t53 + Ifges(3,5) * t98 + Ifges(3,6) * t99 + t86 * t42 + t77 * t15 + t5 * t46 + t25 * t47 - t55 * mrSges(4,2) + t33 * t14 + m(6) * (t25 * t77 - t3 * t39 + t4 * t41) + m(7) * (t1 * t41 + t2 * t39 + t33 * t5) + t23 * t127 + t24 * t128 + (t80 * t127 - t93 * t79 / 0.2e1 - mrSges(4,3) * t125 + Ifges(4,5)) * t74 + t114 * t39 + t115 * t41 + t105 * mrSges(5,3) + m(5) * (t105 * t83 + t53 * t86) - (t8 / 0.2e1 - t9 / 0.2e1 - t4 * mrSges(6,3) - t1 * mrSges(7,2)) * t103 + (-mrSges(4,3) * t126 + Ifges(5,5) * t128 + Ifges(5,6) * t127 - Ifges(4,6) + t68 / 0.2e1 + t66 / 0.2e1 + t69 / 0.2e1 - t65 / 0.2e1) * t71 + (t48 / 0.2e1 - t49 / 0.2e1) * t34 + (t50 / 0.2e1 + t51 / 0.2e1) * t35 + (-t98 * mrSges(3,1) - t99 * mrSges(3,2)) * pkin(7) + m(4) * (-t53 * t96 + t55 * t94) * pkin(2) + (t10 / 0.2e1 + t11 / 0.2e1 + t2 * mrSges(7,2) - t3 * mrSges(6,3)) * t75; 0.2e1 * t33 * t46 + 0.2e1 * t77 * t47 + 0.2e1 * t86 * t78 + t95 * t79 + t93 * t80 + Ifges(3,3) + Ifges(4,3) + (t50 + t51) * t75 - (t48 - t49) * t103 + m(7) * (t33 ^ 2 + t111) + m(6) * (t77 ^ 2 + t111) + m(5) * (t113 * t83 ^ 2 + t86 ^ 2) + m(4) * (t94 ^ 2 + t96 ^ 2) * pkin(2) ^ 2 + 0.2e1 * (mrSges(4,1) * t96 - mrSges(4,2) * t94) * pkin(2) + 0.2e1 * t113 * t83 * mrSges(5,3) + 0.2e1 * (t103 * t41 + t39 * t75) * (mrSges(7,2) + mrSges(6,3)); t71 * mrSges(4,1) + t93 * t44 + t95 * t45 + t62 + t115 * t75 - t114 * t103 + m(7) * (t1 * t75 - t103 * t2) + m(6) * (t103 * t3 + t4 * t75) + m(5) * (t16 * t95 + t17 * t93) + m(4) * t87; t133 * (-t103 * t39 + t75 * t41); m(5) * t113 + m(4) + t133 * (t103 ^ 2 + t75 ^ 2); m(5) * t53 + m(6) * t25 + m(7) * t5 + t14 + t15 + t42; m(5) * t86 + m(6) * t77 + m(7) * t33 - t102 + t78; 0; m(5) + t133; qJ(6) * t21 + m(7) * (-pkin(5) * t2 + qJ(6) * t1) + t1 * mrSges(7,3) - t2 * mrSges(7,1) + t3 * mrSges(6,1) - t4 * mrSges(6,2) - pkin(5) * t20 + t104; t69 + t66 - t65 + t68 + (-pkin(5) * t75 + qJ(6) * t103) * mrSges(7,2) + (m(7) * qJ(6) - mrSges(6,2) + mrSges(7,3)) * t41 + (-mrSges(6,1) + t132) * t39; m(7) * t106 + t102; 0; 0.2e1 * pkin(5) * mrSges(7,1) + 0.2e1 * qJ(6) * mrSges(7,3) + m(7) * (pkin(5) ^ 2 + qJ(6) ^ 2) + t134; m(7) * t2 + t20; m(7) * t39 + t75 * mrSges(7,2); -m(7) * t103; 0; t132; m(7);];
