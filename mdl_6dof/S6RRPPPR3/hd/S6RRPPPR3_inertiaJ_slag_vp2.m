...
% OptimizationMode: 2
% StartTime: 2019-03-09 08:13:58
% EndTime: 2019-03-09 08:14:00
...
t15 = [0.2e1 * t1 * t18 + 0.2e1 * t2 * t17 + t25 * t5 + t26 * t6 + 0.2e1 * t27 * t7 + 0.2e1 * t50 * t28 + 0.2e1 * t32 * t57 + 0.2e1 * t9 * t43 + 0.2e1 * t8 * t44 + Ifges(2,3) + m(4) * (t45 ^ 2 + t86) + m(3) * (pkin(1) ^ 2 + t86) + m(6) * (t8 ^ 2 + t9 ^ 2 + t99) + m(5) * (t32 ^ 2 + t49 ^ 2 + t99) + m(7) * (t1 ^ 2 + t2 ^ 2 + t27 ^ 2) + (0.2e1 * pkin(1) * mrSges(3,1) + mrSges(4,1) * t97 - 0.2e1 * t32 * mrSges(5,2) + t50 * t98 + t69 * t23 - t70 * t24 + (Ifges(5,1) + Ifges(4,3) + Ifges(3,2)) * t74) * t74 + (-0.2e1 * pkin(1) * mrSges(3,2) + mrSges(4,3) * t97 + t49 * t98 + (Ifges(6,3) + Ifges(5,2) + Ifges(4,1) + Ifges(3,1)) * t73 + (-Ifges(6,5) * t70 + Ifges(6,6) * t69 + (2 * Ifges(3,4)) + (2 * Ifges(5,4)) - (2 * Ifges(4,5))) * t74 + t84) * t73 + 0.2e1 * (mrSges(4,2) + mrSges(3,3)) * pkin(7) * t102; t71 * t28 + t49 * mrSges(5,2) + t52 * t7 + t35 * t5 / 0.2e1 - t36 * t6 / 0.2e1 + t25 * t13 / 0.2e1 + t26 * t14 / 0.2e1 + t27 * t12 + t11 * t17 + t10 * t18 + (t46 + mrSges(5,1)) * t50 + t80 * mrSges(7,3) + (-t23 / 0.2e1 + t64 * t43 - t9 * mrSges(6,3)) * t70 + (-t24 / 0.2e1 - t64 * t44 + t8 * mrSges(6,3)) * t69 + m(5) * (qJ(3) * t50 + t75 * t49) + m(6) * (t71 * t50 + t79 * t64) + m(7) * (t10 * t1 + t11 * t2 + t52 * t27) + (-Ifges(6,5) * t69 / 0.2e1 + Ifges(6,6) * t96 - t31 / 0.2e1 + t30 / 0.2e1 + Ifges(5,6) + Ifges(4,4) + Ifges(3,5) - t75 * mrSges(5,3) - pkin(2) * mrSges(4,2) + (-mrSges(3,1) + t83) * pkin(7)) * t73 + (Ifges(5,5) - Ifges(4,6) + Ifges(3,6) + t48 * t96 + t69 * t47 / 0.2e1 + t87 * qJ(3) + (m(4) * qJ(3) - mrSges(3,2) + mrSges(4,3)) * pkin(7)) * t74; 0.2e1 * pkin(2) * mrSges(4,1) + 0.2e1 * t75 * mrSges(5,2) + 0.2e1 * t52 * t12 + t35 * t13 - t36 * t14 + 0.2e1 * t71 * t46 - t70 * t47 - t69 * t48 + Ifges(4,2) + Ifges(3,3) + Ifges(5,3) + m(7) * (t10 ^ 2 + t11 ^ 2 + t52 ^ 2) + m(6) * (t85 * t64 ^ 2 + t71 ^ 2) + m(5) * (t75 ^ 2 + t76) + m(4) * (pkin(2) ^ 2 + t76) + 0.2e1 * (mrSges(5,1) + mrSges(4,3)) * qJ(3) + 0.2e1 * t78 * mrSges(7,3) - 0.2e1 * t64 * t82; -t35 * t17 - t36 * t18 + t70 * t43 - t69 * t44 + (m(4) * pkin(7) + t87) * t73 - m(7) * t80 + m(6) * t79 + m(5) * t49; m(5) * t75 - m(7) * t78 - t101 * mrSges(7,3) + t64 * t40 + mrSges(5,2) - t82 + t83; m(4) + t100; -t74 * mrSges(5,2) + t36 * t17 - t35 * t18 + t69 * t43 + t70 * t44 + t57 + m(7) * (-t35 * t1 + t36 * t2) + m(6) * (t69 * t9 + t70 * t8) + m(5) * t32; m(7) * (-t35 * t10 + t36 * t11); 0; t100; m(6) * t50 + m(7) * t27 + t28 + t7; m(6) * t71 + m(7) * t52 + t12 + t46; 0; 0; m(6) + m(7); t1 * mrSges(7,1) - t2 * mrSges(7,2) + t84; t10 * mrSges(7,1) - t11 * mrSges(7,2) + t30 - t31; -t36 * mrSges(7,1) + t35 * mrSges(7,2); t12; 0; Ifges(7,3);];
