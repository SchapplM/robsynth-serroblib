...
t286 = -t205 * mrSges(6,3) - (m(4) * t144 - qJD(2) * mrSges(3,2) + mrSges(3,3) * t240 + t147) * pkin(7) + t121 * mrSges(4,1) + t89 * mrSges(5,2) + t99 * t211 + Ifges(4,6) * t291 - Ifges(4,3) * t240 / 0.2e1 + t169 / 0.2e1 + (Ifges(3,4) * t190 + t192 * Ifges(3,2)) * t294 + (-t192 * Ifges(5,1) - Ifges(5,4) * t190) * t293 - t114 * mrSges(5,3) + t123 * t209 / 0.2e1 + t124 * t210 / 0.2e1 - t144 * mrSges(4,2) + (Ifges(6,4) * t124 + Ifges(6,2) * t123 + Ifges(6,6) * t241) * t271 + (Ifges(6,1) * t124 + Ifges(6,4) * t123 + Ifges(6,5) * t241) * t269 - (Ifges(3,6) + Ifges(5,5)) * qJD(2) / 0.2e1;
t285 = t36 / 0.2e1;
t284 = t37 / 0.2e1;
t283 = -t222 / 0.2e1;
t282 = t222 / 0.2e1;
...
t254 = t149 * t84;
t148 = t264 * t190;
t137 = -pkin(2) * t192 - qJ(3) * t190 - pkin(1);
t122 = pkin(3) * t192 - t137;
t86 = t208 + t122;
t55 = t148 * t185 + t184 * t86;
...
t8 = Ifges(7,1) * t36 + Ifges(7,4) * t37 + Ifges(7,5) * t223;
t7 = Ifges(7,4) * t36 + Ifges(7,2) * t37 + Ifges(7,6) * t223;
t4 = -qJD(6) * t13 - t189 * t25 + t191 * t23;
t3 = qJD(6) * t12 + t189 * t23 + t191 * t25;
t9 = [t88 * t134 + t108 * t141 + t149 * t96 + t107 * t131 + t54 * t104 + t110 * t11 + t64 * (-mrSges(7,1) * t101 + mrSges(7,2) * t102) + t55 * t103 + t31 * t91 + t83 * t24 + t32 * t90 + t63 * (-mrSges(7,1) * t53 + mrSges(7,2) * t52) + t52 * t19 / 0.2e1 + t53 * t18 / 0.2e1 + t3 * t48 + t4 * t49 + t12 * t26 + t13 * t27 + m(7) * (t1 * t13 + t110 * t64 + t12 * t2 + t3 * t6 + t4 * t5 + t63 * t83) + (t1 * t101 - t102 * t2 - t5 * t52 + t53 * t6) * mrSges(7,3) + (-t21 * mrSges(6,2) + t20 * mrSges(6,1) - t95 * mrSges(5,3) - t94 * mrSges(4,3) + t77 * mrSges(5,1) + t159 / 0.2e1 + (t217 * qJD(2) + (t137 * mrSges(4,1) - 0.2e1 * t279 + t149 * mrSges(5,3) + (0.3e1 / 0.2e1 * t259 - 0.3e1 / 0.2e1 * t257 - t218) * t190 + (0.3e1 / 0.2e1 * Ifges(6,3) + 0.3e1 / 0.2e1 * Ifges(3,1) + 0.3e1 / 0.2e1 * Ifges(5,2) + 0.3e1 / 0.2e1 * Ifges(4,1) - t185 ^ 2 * Ifges(6,1) / 0.2e1 + Ifges(7,3) / 0.2e1 - 0.3e1 / 0.2e1 * Ifges(3,2) - 0.3e1 / 0.2e1 * Ifges(5,1) - 0.3e1 / 0.2e1 * Ifges(4,3) + t229 * pkin(7) + (t260 - t258 / 0.2e1) * t184) * t192) * qJD(1) + t286) * qJD(2) + t288) * t190 + (t184 * t78 / 0.2e1 + t79 * t270 - t94 * mrSges(4,1) - t77 * mrSges(5,2) + (mrSges(5,3) + t211) * t84 + t229 * t135 + t207 * mrSges(6,3) + (t216 * qJD(2) + ((t203 + t218) * t192 + Ifges(7,5) * t276 + Ifges(7,6) * t277 - 0.2e1 * t278 - t148 * mrSges(5,3) - t137 * mrSges(4,3)) * qJD(1) + t287) * qJD(2)) * t192 + m(4) * (t107 * t121 + t137 * t94) + m(6) * (-t106 * t99 + t20 * t54 + t21 * t55 + t28 * t31 + t29 * t32 - t254) + m(5) * (t100 * t108 + t106 * t114 + t122 * t77 + t148 * t95 + t88 * t89 - t254) + t250 * t106 + t122 * t243 + (Ifges(7,5) * t52 + Ifges(7,6) * t53) * t272 + t8 * t276 + t7 * t277 + (Ifges(7,1) * t52 + Ifges(7,4) * t53) * t280 + (Ifges(7,4) * t52 + Ifges(7,2) * t53) * t282 + (Ifges(7,4) * t102 + Ifges(7,2) * t101) * t284 + (Ifges(7,1) * t102 + Ifges(7,4) * t101) * t285; t154 * t11 - t105 * t134 + t135 * mrSges(4,3) - t133 * t141 + t64 * (-mrSges(7,1) * t125 - mrSges(7,2) * t126) - t44 * t91 + t95 * mrSges(5,2) - t97 * t24 - t84 * mrSges(5,1) - t45 * t90 + t72 * t26 + t73 * t27 + (-t112 / 0.2e1 + t92 / 0.2e1) * t18 + (t111 / 0.2e1 - t93 / 0.2e1) * t19 + (-t28 * t44 - t29 * t45 - t188 * t84 + t206 * t181 + (t184 * t28 - t185 * t29) * qJD(5) + t289 * t99) * m(6) + (-t84 * qJ(3) - t100 * t133 - t105 * t89 - t114 * t289 + t193 * t95) * m(5) + (-m(4) * t121 - t131) * (pkin(2) * t241 - t166) + m(4) * (qJ(3) * t135 + qJD(3) * t144) + (t1 * t73 + t154 * t64 + t2 * t72 + (qJD(3) - t97) * t63 + t290 * t6 + t297 * t5) * m(7) + t297 * t49 + t290 * t48 + t299 * mrSges(7,3) + (((pkin(7) * mrSges(3,2) + (-Ifges(6,1) * t184 - t260) * t269 + (-Ifges(6,2) * t185 - t261) * t271 + (-mrSges(4,2) + mrSges(5,3)) * qJ(3) + t217) * qJD(2) + (t279 + (Ifges(5,4) / 0.2e1 + Ifges(3,4) / 0.2e1 + t203) * t190) * qJD(1) - t169 / 0.2e1 - t286) * t190 + ((-Ifges(6,3) / 0.2e1 + Ifges(3,2) / 0.2e1 - Ifges(4,1) / 0.2e1 + Ifges(5,1) / 0.2e1 - Ifges(5,2) / 0.2e1 + Ifges(4,3) / 0.2e1 - Ifges(3,1) / 0.2e1) * t241 + (t278 + (-Ifges(5,4) / 0.2e1 + Ifges(4,5) / 0.2e1) * t192) * qJD(1) - t170 / 0.2e1 + (Ifges(7,5) * t274 + Ifges(7,6) * t275 + Ifges(6,5) * t271 + Ifges(6,6) * t270 - pkin(2) * mrSges(4,2) - t193 * mrSges(5,3) + (-m(4) * pkin(2) + t300) * pkin(7) + t216) * qJD(2) - t287) * t192) * qJD(1) + (t181 * t103 - qJD(5) * t90 - t21 * mrSges(6,3) - t78 / 0.2e1 - t84 * mrSges(6,1)) * t185 + (-t181 * t104 + qJD(5) * t91 + t20 * mrSges(6,3) - t79 / 0.2e1 + t84 * mrSges(6,2)) * t184 + (mrSges(7,1) * t251 + mrSges(7,2) * t252) * t63 - t250 * t130 + t188 * t96 + (Ifges(7,5) * t111 - Ifges(7,6) * t112) * t272 + (Ifges(7,5) * t93 - Ifges(7,6) * t92) * t273 + t8 * t274 + t7 * t275 + (Ifges(7,1) * t111 - Ifges(7,4) * t112) * t280 + (Ifges(7,1) * t93 - Ifges(7,4) * t92) * t281 + (Ifges(7,4) * t111 - Ifges(7,2) * t112) * t282 + (Ifges(7,4) * t93 - Ifges(7,2) * t92) * t283 + (-Ifges(7,4) * t126 + Ifges(7,2) * t125) * t284 + (-Ifges(7,1) * t126 + Ifges(7,4) * t125) * t285 - t221 * qJD(3); t185 * t103 - t184 * t104 - t125 * t27 - t126 * t26 + t252 * t49 + t251 * t48 + t221 * qJD(2) + ((-mrSges(5,3) + t229) * t238 + (-t184 * t90 - t185 * t91 + t131 - t134) * t190) * qJD(1) - m(4) * (qJD(2) * t144 - t121 * t241) + (-qJD(2) * t63 - t299) * m(7) + (-qJD(2) * t99 - t205 * t241 + t206) * m(6) + (qJD(2) * t114 - t241 * t89 + t95) * m(5); t184 * t103 + t185 * t104 - t125 * t26 + t126 * t27 + t251 * t49 - t252 * t48 + m(5) * t77 + m(6) * t207 + m(7) * (t1 * t126 - t111 * t6 + t112 * t5 - t125 * t2) - m(7) * (t5 * t92 - t6 * t93) + (-m(6) * (-t247 * t29 + t248 * t28) + (m(5) * t100 - t184 * t91 + t185 * t90 + t141) * t190 + (-m(5) * t114 + m(6) * t99 + m(7) * t63 + t230) * t192) * qJD(1) + t243; -t123 * t90 + t124 * t91 - t222 * t48 + t68 * t49 + t11 + t96 + (-t222 * t6 + t5 * t68 + t64) * m(7) + (-t123 * t29 + t124 * t28 - t84) * m(6); t159 - t63 * (mrSges(7,1) * t68 + mrSges(7,2) * t222) + (Ifges(7,1) * t222 - t268) * t281 + t18 * t280 + (Ifges(7,5) * t222 - Ifges(7,6) * t68) * t273 - t5 * t48 + t6 * t49 + (t222 * t5 + t6 * t68) * mrSges(7,3) + (-Ifges(7,2) * t68 + t19 + t62) * t283 + t288;];
tauc  = t9(:);
