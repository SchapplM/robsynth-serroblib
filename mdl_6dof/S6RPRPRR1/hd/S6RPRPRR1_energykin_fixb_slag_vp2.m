...
function T = S6RPRPRR1_energykin_fixb_slag_vp2(qJ, qJD, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(11,1),zeros(7,1),zeros(7,3),zeros(7,6)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RPRPRR1_energykin_fixb_slag_vp2: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RPRPRR1_energykin_fixb_slag_vp2: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6RPRPRR1_energykin_fixb_slag_vp2: pkin has to be [11x1] (double)');
assert(isreal(m) && all(size(m) == [7 1]), ...
  'S6RPRPRR1_energykin_fixb_slag_vp2: m has to be [7x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [7,3]), ...
  'S6RPRPRR1_energykin_fixb_slag_vp2: mrSges has to be [7x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [7 6]), ...
  'S6RPRPRR1_energykin_fixb_slag_vp2: Ifges has to be [7x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_fixb_linkframe_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2019-03-09 03:33:48
% EndTime: 2019-03-09 03:33:49
% DurationCPUTime: 0.53s
% Computational Cost: add. (562->98), mult. (1263->155), div. (0->0), fcn. (870->10), ass. (0->42)
t123 = m(3) / 0.2e1;
t114 = sin(qJ(5));
t117 = cos(qJ(5));
t109 = sin(pkin(11));
...
t97 = t118 * t122 + t99;
t85 = -t109 * t97 + t111 * t96;
t83 = qJD(3) * pkin(4) - pkin(8) * t102 + t85;
t101 = (-t109 * t115 + t111 * t118) * qJD(1);
t86 = t109 * t96 + t111 * t97;
t84 = pkin(8) * t101 + t86;
...
t100 = qJD(4) + (-pkin(3) * t118 + t121) * qJD(1);
