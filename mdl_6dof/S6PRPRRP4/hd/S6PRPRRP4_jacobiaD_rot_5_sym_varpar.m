...
function JaD_rot = S6PRPRRP4_jacobiaD_rot_5_sym_varpar(qJ, qJD, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(11,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6PRPRRP4_jacobiaD_rot_5_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6PRPRRP4_jacobiaD_rot_5_sym_varpar: qJD has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S6PRPRRP4_jacobiaD_rot_5_sym_varpar: pkin has to be [11x1] (double)');
...
t152 = t156 * t239 - t172 * t180 + t181 * t190;
...
t178 = 0.1e1 / t183 ^ 2;
t207 = t211 * qJD(2);
t175 = qJD(4) * t236 - t207 * t218;
t208 = -qJD(2) * t244 + t222 * t251;
t167 = qJD(5) * t183 + t175 * t224 - t208 * t226;
t259 = t211 * t226;
t182 = t198 * t224 - t259;
t176 = t182 ^ 2;
