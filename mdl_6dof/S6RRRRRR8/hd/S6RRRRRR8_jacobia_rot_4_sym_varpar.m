...
function Ja_rot = S6RRRRRR8_jacobia_rot_4_sym_varpar(qJ, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(13,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRRR8_jacobia_rot_4_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [13 1]), ...
  'S6RRRRRR8_jacobia_rot_4_sym_varpar: pkin has to be [13x1] (double)');
...
t105 = sin(qJ(4));
t108 = cos(qJ(4));
t83 = t97 * t109 + (-t103 * t113 + t115) * t106;
t91 = t101 * t113 + t103 * t118;
