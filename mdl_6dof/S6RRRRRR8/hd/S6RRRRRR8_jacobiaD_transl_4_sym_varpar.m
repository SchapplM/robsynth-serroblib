...
function JaD_transl = S6RRRRRR8_jacobiaD_transl_4_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(6,1),zeros(3,1),zeros(13,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RRRRRR8_jacobiaD_transl_4_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [6 1]), ...
  'S6RRRRRR8_jacobiaD_transl_4_sym_varpar: qJD has to be [6x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S6RRRRRR8_jacobiaD_transl_4_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isreal(pkin) && all(size(pkin) == [13 1]), ...
  'S6RRRRRR8_jacobiaD_transl_4_sym_varpar: pkin has to be [13x1] (double)');

%% Symbolic Calculation
% From jacobiaD_transl_4_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-26 22:51:25
% EndTime: 2019-02-26 22:51:26
...
t453 = (-qJD(3) * t487 + t512) * t500 + (-qJD(3) * t519 + t478) * t504;
t550 = t477 * t496;
t469 = t498 * t530 + t550;
t499 = sin(qJ(4));
t503 = cos(qJ(4));
...
t450 = qJD(3) * t466 - t475 * t543 - t476 * t500 - t504 * t525;
t449 = t451 * t503 + t467 * t499 + (-t466 * t499 + t483 * t503) * qJD(4);
t448 = -t451 * t499 + t467 * t503 + (-t466 * t503 - t483 * t499) * qJD(4);
t1 = [t560 * r_i_i_C(1) + t561 * r_i_i_C(2) - t453 * pkin(3) - t478 * pkin(2) - pkin(10) * t550 + t553 * t507 + (r_i_i_C(1) * t559 - r_i_i_C(2) * t558) * qJD(4) + (-t506 * pkin(1) - t531 * t546) * qJD(1) (t457 * t503 - t474 * t534) * r_i_i_C(1) + (-t457 * t499 - t474 * t533) * r_i_i_C(2) + t457 * pkin(3) + t475 * pkin(2) + t553 * (t474 * qJD(3) + t475 * t500 - t476 * t543) + ((-t476 * t499 - t511 * t533) * r_i_i_C(1) + (-t476 * t503 + t511 * t534) * r_i_i_C(2) - t476 * pkin(10)) * t496, -t520 * t450 + t553 * t451 + t508 * t513, t448 * r_i_i_C(1) - t449 * r_i_i_C(2), 0, 0; -pkin(10) * t551 - t476 * pkin(2) + t451 * pkin(3) + t449 * r_i_i_C(1) + t448 * r_i_i_C(2) + t553 * t450 + (-pkin(1) * t502 + t531 * t545) * qJD(1) (t459 * t503 - t473 * t534) * r_i_i_C(1) + (-t459 * t499 - t473 * t533) * r_i_i_C(2) + t459 * pkin(3) - t477 * pkin(2) + t553 * (t473 * qJD(3) - t477 * t500 + t478 * t543) + ((t478 * t499 + t487 * t533) * r_i_i_C(1) + (t478 * t503 - t487 * t534) * r_i_i_C(2) + t478 * pkin(10)) * t496, t553 * t453 + (-t487 * t500 - t519 * t504) * t513 + t520 * t507, -t561 * r_i_i_C(1) + t560 * r_i_i_C(2) + (r_i_i_C(1) * t558 + r_i_i_C(2) * t559) * qJD(4), 0, 0; 0 (t471 * t503 + t484 * t534) * r_i_i_C(1) + (-t471 * t499 + t484 * t533) * r_i_i_C(2) + t471 * pkin(3) + (-t553 * (-t517 * qJD(2) + t514 * qJD(3)) - pkin(2) * t536 + ((t499 * t535 + t501 * t533) * r_i_i_C(1) + (-t501 * t534 + t503 * t535) * r_i_i_C(2) + pkin(10) * t535) * t496) * t497, t553 * t461 + (t517 * t497 + t504 * t526) * t513 + t520 * (-t500 * t522 + (t516 * qJD(2) - t515 * qJD(3)) * t497) (-t461 * t499 + t503 * t524) * r_i_i_C(1) + (-t461 * t503 - t499 * t524) * r_i_i_C(2) + ((-t480 * t503 - t485 * t499) * r_i_i_C(1) + (t480 * t499 - t485 * t503) * r_i_i_C(2)) * qJD(4), 0, 0;];
JaD_transl  = t1;
