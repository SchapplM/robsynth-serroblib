...
% EndTime: 2018-11-23 17:28:43
% DurationCPUTime: 13.66s
% Computational Cost: add. (14525->688), mult. (32473->951), div. (0->0), fcn. (21062->8), ass. (0->324)
t291 = sin(qJ(4));
t295 = cos(qJ(4));
t296 = cos(qJ(2));
t359 = qJD(1) * t296;
...
t47 = Ifges(7,2) * t473 + Ifges(7,6) * t253 + t393;
t98 = Ifges(7,4) * t473;
t48 = Ifges(7,1) * t105 + Ifges(7,5) * t253 + t98;
t501 = (Ifges(7,1) * t473 - t393) * t424 + (Ifges(7,5) * t473 - Ifges(7,6) * t105) * t407 + (t105 * t15 + t14 * t473) * mrSges(7,3) - t113 * (mrSges(7,1) * t105 + mrSges(7,2) * t473) + t47 * t423 + t266 + t441 + (-Ifges(7,2) * t105 + t48 + t98) * t426;
t278 = pkin(2) * t283;
...
t498 = t267 + t440 + (Ifges(6,5) * t330 - Ifges(6,6) * t164) * t405 + (t164 * t51 + t330 * t50) * mrSges(6,3) + (-Ifges(6,2) * t164 + t157 + t94) * t419 - t175 * (mrSges(6,1) * t164 + mrSges(6,2) * t330) + (Ifges(6,1) * t330 - t394) * t417 + t501;
t364 = t294 * t295;
...
t382 = t236 * Ifges(5,4);
t148 = t235 * Ifges(5,2) + t270 * Ifges(5,6) + t382;
t228 = Ifges(5,4) * t235;
t149 = t236 * Ifges(5,1) + t270 * Ifges(5,5) + t228;
t316 = t130 * t291 - t131 * t295;
t396 = Ifges(5,4) * t291;
t321 = Ifges(5,2) * t295 + t396;
t395 = Ifges(5,4) * t295;
t323 = Ifges(5,1) * t291 + t395;
...
t410 = -t236 / 0.2e1;
t411 = -t235 / 0.2e1;
t484 = t316 * mrSges(5,3) + t148 * t401 + t149 * t402 + t220 * t326 + (t388 + t392) * t403 + t321 * t411 + t323 * t410;
t483 = qJD(3) + t277;
...
t464 = qJD(2) / 0.2e1;
t465 = -qJD(2) / 0.2e1;
t476 = t255 * mrSges(4,1) - t221 * mrSges(4,2) - Ifges(4,5) * t465 - Ifges(3,6) * t464 - t484 + ((Ifges(3,2) + Ifges(4,3)) * t296 + (Ifges(3,4) + Ifges(4,6)) * t292) * t466;
t475 = -t12 * t311 + t13 * t310 - t362 * t51 + t496 * t50;
t93 = Ifges(6,2) * t330 + Ifges(6,6) * t261 + t394;
t469 = t93 / 0.2e1;
t176 = t249 * t290 - t294 * t250;
t141 = pkin(10) * t310 + t176;
t142 = -pkin(10) * t311 + t177;
t80 = t141 * t293 - t142 * t289;
t463 = qJD(6) * t80 + t289 * t490 - t293 * t489;
t81 = t141 * t289 + t142 * t293;
t462 = -qJD(6) * t81 + t289 * t489 + t293 * t490;
...
t360 = -t257 + t174;
t260 = t430 * t296;
t344 = -Ifges(4,4) / 0.2e1 + Ifges(3,5) / 0.2e1;
t343 = Ifges(4,5) / 0.2e1 - Ifges(3,6) / 0.2e1;
...
t324 = Ifges(5,1) * t295 - t396;
t322 = -Ifges(5,2) * t291 + t395;
...
t276 = Ifges(3,4) * t359;
t298 = t130 * mrSges(5,1) + t14 * mrSges(7,1) + t248 * mrSges(4,1) + t50 * mrSges(6,1) + t270 * Ifges(5,3) + t236 * Ifges(5,5) + t235 * Ifges(5,6) + Ifges(3,1) * t283 / 0.2e1 + Ifges(3,5) * t464 + t276 / 0.2e1 + Ifges(4,4) * t465 + (-t292 * Ifges(4,2) - t390) * t466 + t253 * Ifges(7,3) + t105 * Ifges(7,5) + t473 * Ifges(7,6) + t261 * Ifges(6,3) + t164 * Ifges(6,5) + t330 * Ifges(6,6) - t131 * mrSges(5,2) - t15 * mrSges(7,2) - t221 * mrSges(4,3) - t51 * mrSges(6,2);
t268 = Ifges(5,3) * t336;
...
t1 = [(t327 * pkin(7) + t343 * qJD(2) + (-t251 * mrSges(4,2) + t292 * t342 - 0.2e1 * t429) * qJD(1) + t476) * t358 + (-t116 * t50 + t117 * t51 + t12 * t203 + t13 * t204) * mrSges(6,3) + t138 * (-mrSges(6,1) * t203 - mrSges(6,2) * t204) + (-Ifges(6,1) * t204 + Ifges(6,4) * t203) * t432 + (-Ifges(6,4) * t204 + Ifges(6,2) * t203) * t431 + m(5) * (t130 * t96 + t131 * t95 + t170 * t75 + t171 * t74 + t199 * t260 - t220 * t245) + m(7) * (t113 * t87 + t14 * t5 + t15 * t4 + t156 * t52 + t2 * t35 + t3 * t34) + m(6) * (t12 * t89 + t13 * t88 + t138 * t213 + t175 * t178 + t24 * t51 + t25 * t50) + (-t191 * mrSges(4,3) + t266 / 0.2e1 + t267 / 0.2e1 + t268 / 0.2e1 + t438 + t440 + t441) * t292 + m(4) * (t191 * t251 + t206 * t221) + (t139 * t2 - t14 * t42 - t140 * t3 + t15 * t43) * mrSges(7,3) + t260 * t122 + t206 * t241 - t245 * t174 + t213 * t38 + t96 * t188 + t95 * t187 + t178 * t107 + (-t183 * t323 / 0.2e1 - t184 * t321 / 0.2e1 + t199 * t326 + t119 * t402 + t118 * t401 + t191 * mrSges(4,2) - t341 * t247 + (t291 * t75 - t295 * t74) * mrSges(5,3) + (t291 * t420 + t149 * t401 + t270 * (t389 - t391) / 0.2e1 + t324 * t410 + t322 * t411 - t220 * t325 + (t130 * t295 + t131 * t291) * mrSges(5,3)) * qJD(4) + (t298 + t344 * qJD(2) + (Ifges(6,5) * t412 + Ifges(6,6) * t413 + Ifges(7,5) * t421 + Ifges(7,6) * t422 + (-t392 / 0.2e1 - t388 / 0.2e1 - t342) * t296 - 0.2e1 * t428 - t251 * mrSges(4,3) + (Ifges(6,3) / 0.2e1 + Ifges(7,3) / 0.2e1 + Ifges(5,3) / 0.2e1 + 0.3e1 / 0.2e1 * Ifges(3,1) + 0.3e1 / 0.2e1 * Ifges(4,2) - 0.3e1 / 0.2e1 * Ifges(4,3) - 0.3e1 / 0.2e1 * Ifges(3,2) + t341 * pkin(7)) * t292) * qJD(1) + t328 * pkin(7)) * qJD(2)) * t296 + t175 * (-mrSges(6,1) * t117 + mrSges(6,2) * t116) + t170 * t158 + t171 * t159 + (Ifges(7,4) * t140 + Ifges(7,2) * t139) * t435 + (Ifges(7,1) * t140 + Ifges(7,4) * t139) * t436 + t7 * t421 + t6 * t422 + (Ifges(7,1) * t42 + Ifges(7,4) * t43) * t423 + (Ifges(7,4) * t42 + Ifges(7,2) * t43) * t425 + t117 * t469 + (Ifges(6,5) * t116 + Ifges(6,6) * t117) * t404 + (Ifges(7,5) * t42 + Ifges(7,6) * t43) * t406 + t37 * t412 + t36 * t413 + (Ifges(6,1) * t116 + Ifges(6,4) * t117) * t416 + (Ifges(6,4) * t116 + Ifges(6,2) * t117) * t418 + t34 * t26 + t35 * t27 + t43 * t47 / 0.2e1 + t42 * t48 / 0.2e1 + t87 * t49 + t88 * t70 + t89 * t71 + t4 * t90 + t5 * t91 + t113 * (-mrSges(7,1) * t43 + mrSges(7,2) * t42) + t116 * t94 / 0.2e1 + t24 * t134 + t25 * t135 + t52 * (-mrSges(7,1) * t139 + mrSges(7,2) * t140) + t156 * t8; (mrSges(7,1) * t485 - mrSges(7,2) * t372) * t113 + t475 * mrSges(6,3) + t484 * qJD(4) + (((t429 + (Ifges(4,6) / 0.2e1 + Ifges(3,4) / 0.2e1) * t292) * qJD(1) + (-t327 + t371) * pkin(7) + (-qJ(3) * mrSges(4,1) + t343) * qJD(2) - t476) * t292 + ((-Ifges(4,2) / 0.2e1 + Ifges(4,3) / 0.2e1 - Ifges(3,1) / 0.2e1 + Ifges(3,2) / 0.2e1) * t283 - t298 + (Ifges(6,5) * t408 + Ifges(6,6) * t409 + Ifges(7,5) * t414 + Ifges(7,6) * t415 + t391 / 0.2e1 - t389 / 0.2e1 - pkin(2) * mrSges(4,1) + t344) * qJD(2) + (-t390 / 0.2e1 + t428) * qJD(1) + ((-m(4) * pkin(2) + t479) * qJD(2) - t328) * pkin(7) - t276 / 0.2e1) * t296) * qJD(1) - t443 * mrSges(5,3) + (-t66 / 0.2e1 - t125 / 0.2e1) * t47 + (Ifges(7,1) * t301 - Ifges(7,4) * t66) * t423 + (Ifges(7,4) * t301 - Ifges(7,2) * t66) * t425 + (Ifges(7,5) * t301 - Ifges(7,6) * t66) * t406 + t138 * (mrSges(6,1) * t311 - mrSges(6,2) * t310) + (-Ifges(6,4) * t310 - Ifges(6,2) * t311) * t431 + (-Ifges(6,1) * t310 - Ifges(6,4) * t311) * t432 + t52 * (-mrSges(7,1) * t166 + mrSges(7,2) * t445) + (Ifges(7,4) * t445 + Ifges(7,2) * t166) * t435 + (Ifges(7,1) * t445 + Ifges(7,4) * t166) * t436 + (-t195 / 0.2e1 - t173 / 0.2e1) * t94 + (-Ifges(6,5) * t173 - Ifges(6,6) * t172) * t404 + (-Ifges(6,1) * t173 - Ifges(6,4) * t172) * t416 + (-Ifges(6,4) * t173 - Ifges(6,2) * t172) * t418 + (mrSges(6,1) * t362 - mrSges(6,2) * t496) * t175 + t446 * t49 + (t301 / 0.2e1 - t332 / 0.2e1) * t48 + (Ifges(7,1) * t332 + Ifges(7,4) * t125) * t424 + (Ifges(7,4) * t332 + Ifges(7,2) * t125) * t426 + (Ifges(7,5) * t332 + Ifges(7,6) * t125) * t407 + (-m(4) * t221 - t241) * (-qJ(3) * t359 + t278) + ((-m(5) * t316 + t313) * qJD(4) + t315 + m(5) * t443) * t297 + t444 * t107 + t493 * mrSges(7,3) + (-t194 / 0.2e1 - t172 / 0.2e1) * t93 + t295 * t119 / 0.2e1 + t272 * t38 - t243 * t174 - t247 * mrSges(4,3) + t196 * t8 - t151 * t188 - t152 * t187 + t176 * t70 + t177 * t71 + (t199 * qJ(3) - t130 * t151 - t131 * t152 + t220 * t442) * m(5) + t449 * t134 + t450 * t135 + (t12 * t177 + t13 * t176 + t138 * t272 + t175 * t444 + t449 * t51 + t450 * t50) * m(6) + t184 * t322 / 0.2e1 + t183 * t324 / 0.2e1 + t462 * t91 + t463 * t90 + (t113 * t446 + t14 * t462 + t15 * t463 + t196 * t52 + t2 * t81 + t3 * t80) * m(7) + t199 * t325 + t118 * t402 + (Ifges(6,5) * t195 + Ifges(6,6) * t194) * t405 + t37 * t408 + t36 * t409 + t7 * t414 + t6 * t415 + (Ifges(6,1) * t195 + Ifges(6,4) * t194) * t417 + (Ifges(6,4) * t195 + Ifges(6,2) * t194) * t419 + m(4) * (-qJ(3) * t247 - qJD(3) * t255) + t360 * qJD(3) + t80 * t26 + t81 * t27 + qJ(3) * t122; t445 * t26 - t166 * t27 + t311 * t71 - t310 * t70 - t372 * t91 + t485 * t90 - t496 * t135 + t362 * t134 + t313 * qJD(4) + (t241 + t313) * t283 + (t341 * t359 - t107 - t360 - t49) * qJD(2) - m(4) * (-qJD(2) * t255 - t221 * t283) + t315 + (-qJD(2) * t113 - t493) * m(7) + (-qJD(2) * t175 - t475) * m(6) + (-qJD(2) * t220 - t270 * t316 + t443) * m(5); t477 * t90 + (-t113 * t124 + t14 * t478 + t15 * t477 + t2 * t211 + t210 * t3) * m(7) + t478 * t91 + t164 * t469 + t498 - m(6) * (t50 * t57 + t51 * t58) + t438 + t268 + (-t236 * t107 + t290 * t71 + t294 * t70 + (t134 * t294 - t135 * t290) * qJD(5) + (t12 * t290 + t13 * t294 - t175 * t236 + t350 * t51 - t351 * t50) * m(6)) * pkin(4) + (t130 * t235 + t131 * t236) * mrSges(5,3) - t220 * (mrSges(5,1) * t236 + mrSges(5,2) * t235) + t210 * t26 + t211 * t27 - t130 * t187 + t131 * t188 + t236 * t420 + (Ifges(5,5) * t235 - Ifges(5,6) * t236) * t403 + (Ifges(5,1) * t235 - t382) * t410 + (-Ifges(5,2) * t236 + t149 + t228) * t411 - t124 * t49 - t58 * t134 - t57 * t135; -m(7) * (t14 * t16 + t15 * t17) + (-t164 * t49 + t293 * t26 + t289 * t27 + (-t289 * t91 + t293 * t90) * qJD(6) + (-t113 * t164 - t14 * t349 + t15 * t348 + t2 * t289 + t293 * t3) * m(7)) * pkin(5) + t93 * t416 - t17 * t90 - t16 * t91 - t50 * t134 + t51 * t135 + t498; -t14 * t90 + t15 * t91 + t501;];
tauc  = t1(:);
