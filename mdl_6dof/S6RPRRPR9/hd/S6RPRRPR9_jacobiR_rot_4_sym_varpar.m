...
function JR_rot = S6RPRRPR9_jacobiR_rot_4_sym_varpar(qJ, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(13,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'S6RPRRPR9_jacobiR_rot_4_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [13 1]), ...
  'S6RPRRPR9_jacobiR_rot_4_sym_varpar: pkin has to be [13x1] (double)');

%% Symbolic Calculation
% From jacobiR_rot_4_floatb_twist_matlab.m
% OptimizationMode: 2
% StartTime: 2019-02-22 10:48:20
% EndTime: 2019-02-22 10:48:20
...
t173 = t159 * t165;
t168 = t156 * t175;
t137 = -t150 * t162 - t165 * t167;
t152 = -t160 * t172 + t169;
t151 = -t160 * t171 - t170;
t148 = -t156 * t157 * t158 + t159 * t160;
