...
%% Function calls
if link_index == 0
	Jg=S7RRRRRRR1_jacobig_0_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 1
	Jg=S7RRRRRRR1_jacobig_1_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 2
	Jg=S7RRRRRRR1_jacobig_2_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 3
	Jg=S7RRRRRRR1_jacobig_3_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 4
	Jg=S7RRRRRRR1_jacobig_4_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 5
	Jg=S7RRRRRRR1_jacobig_5_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 6
	Jg=S7RRRRRRR1_jacobig_6_sym_varpar(qJ, r_i_i_C, pkin);
elseif link_index == 7
	Jg=S7RRRRRRR1_jacobig_7_sym_varpar(qJ, r_i_i_C, pkin);
else
	Jg=NaN(6,7);
end