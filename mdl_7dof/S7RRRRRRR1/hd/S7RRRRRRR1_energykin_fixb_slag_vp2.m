...
% OptimizationMode: 2
% StartTime: 2018-11-26 19:14:17
% EndTime: 2018-11-26 19:14:18
...
t1 = m(8) * (t77 ^ 2 + t78 ^ 2 + t83) / 0.2e1 + m(7) * (t85 ^ 2 + t130 + t83) / 0.2e1 + Ifges(5,3) * t109 ^ 2 / 0.2e1 + m(6) * (t90 ^ 2 + t104 + t130) / 0.2e1 + m(4) * (t106 + t105) / 0.2e1 + m(5) * (t106 * t123 ^ 2 + t104 + t105) / 0.2e1 + (t88 * mrSges(6,3) + Ifges(6,1) * t95 / 0.2e1) * t95 + (-t107 * mrSges(4,1) + Ifges(4,3) * t112 / 0.2e1) * t112 + (t107 * mrSges(4,3) + Ifges(4,5) * t112 + Ifges(4,1) * t111 / 0.2e1) * t111 + (t84 * mrSges(7,1) - t85 * mrSges(7,2) + Ifges(7,3) * t93 / 0.2e1) * t93 + (t77 * mrSges(8,1) - t78 * mrSges(8,2) + Ifges(8,3) * t87 / 0.2e1) * t87 + (t90 * mrSges(6,3) + Ifges(6,4) * t95 + Ifges(6,2) * t94 / 0.2e1) * t94 + (t88 * mrSges(7,2) - t84 * mrSges(7,3) + Ifges(7,5) * t93 + Ifges(7,1) * t92 / 0.2e1) * t92 + (t84 * mrSges(8,2) - t77 * mrSges(8,3) + Ifges(8,5) * t87 + Ifges(8,1) * t82 / 0.2e1) * t82 + (-t107 * mrSges(5,2) + Ifges(5,5) * t109 + Ifges(5,1) * t102 / 0.2e1) * t102 + (-t88 * mrSges(7,1) + t85 * mrSges(7,3) + Ifges(7,4) * t92 + Ifges(7,6) * t93 + Ifges(7,2) * t91 / 0.2e1) * t91 + (-t84 * mrSges(8,1) + t78 * mrSges(8,3) + Ifges(8,4) * t82 + Ifges(8,6) * t87 + Ifges(8,2) * t81 / 0.2e1) * t81 + (Ifges(4,4) * t111 + Ifges(4,6) * t112 + Ifges(4,2) * t110 / 0.2e1) * t110 + (t107 * mrSges(5,1) + Ifges(5,4) * t102 + Ifges(5,6) * t109 + Ifges(5,2) * t101 / 0.2e1) * t101 + (-mrSges(4,2) * t112 + mrSges(4,3) * t110 + t123 * (-mrSges(5,2) * t109 + mrSges(5,3) * t101) + (-mrSges(5,1) * t109 - mrSges(6,1) * t94 + mrSges(6,2) * t95 + mrSges(5,3) * t102) * t117) * t108 + (-t88 * mrSges(6,1) - t90 * mrSges(6,2) + Ifges(6,5) * t95 + Ifges(6,6) * t94 + Ifges(6,3) * t100 / 0.2e1) * t100 + (Ifges(3,2) * t125 ^ 2 / 0.2e1 + Ifges(2,3) / 0.2e1 + (Ifges(3,4) * t125 + Ifges(3,1) * t119 / 0.2e1) * t119) * qJD(1) ^ 2 + (Ifges(3,3) * qJD(2) / 0.2e1 + (Ifges(3,5) * t119 + Ifges(3,6) * t125) * qJD(1)) * qJD(2);
T  = t1;
