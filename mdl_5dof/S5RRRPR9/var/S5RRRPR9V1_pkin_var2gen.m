% Umwandlung der Kinematikparameter von S5RRRPR9V1 zu S5RRRPR9
% Eingabe:
% pkin_var (5x1) double
...
%
% Siehe auch: S5RRRPR9_structural_kinematic_parameters.m
function pkin_gen = S5RRRPR9V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
