...
function JR_rot = S5RPRRP5_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPRRP5_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPRRP5_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RPRRP5_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t58 = t60 * t63;
	t57 = t60 * t62;
	t1 = [-t64, 0, -t64, -t57, 0; t58, 0, t58, -t65, 0; 0, 0, 0, t63, 0; t60, 0, t60, 0, 0; t59, 0, t59, 0, 0; 0, 0, 0, 0, 0; -t65, 0, -t65, t58, 0; t57, 0, t57, t64, 0; 0, 0, 0, t62, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end