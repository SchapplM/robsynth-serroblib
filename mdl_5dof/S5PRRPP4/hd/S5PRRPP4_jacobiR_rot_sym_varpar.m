...
function JR_rot = S5PRRPP4_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(7,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5PRRPP4_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5PRRPP4_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [7 1]), ...
  'S5PRRPP4_jacobiR_rot_sym_varpar: pkin has to be [7x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t46 = t42 * t44;
	t40 = t42 * t45;
	t1 = [0, -t47, -t46, 0, 0; 0, t40, -t48, 0, 0; 0, 0, t45, 0, 0; 0, t42, 0, 0, 0; 0, t41, 0, 0, 0; 0, 0, 0, 0, 0; 0, -t48, t40, 0, 0; 0, t46, t47, 0, 0; 0, 0, t44, 0, 0;];
	JR_rot = t1;
elseif link_index == 5
	%% Symbolic Calculation
	...
	t19 = t15 * t17;
	t13 = t15 * t18;
	t1 = [0, -t20, -t19, 0, 0; 0, t13, -t21, 0, 0; 0, 0, t18, 0, 0; 0, -t21, t13, 0, 0; 0, t19, t20, 0, 0; 0, 0, t17, 0, 0; 0, -t15, 0, 0, 0; 0, -t14, 0, 0, 0; 0, 0, 0, 0, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end