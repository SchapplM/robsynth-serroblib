...
t50 = cos(t53);
t58 = cos(qJ(1));
t62 = t58 * pkin(1) + pkin(2) * t50;
t49 = sin(t53);
t56 = sin(qJ(1));
t61 = -t56 * pkin(1) - pkin(2) * t49;
t48 = pkin(8) + t53;
t44 = sin(t48);
t45 = cos(t48);
t60 = g(2) * t44 - g(3) * t45;
...
t42 = -g(1) * t57 - t60 * t55;
t41 = -g(1) * t55 + t60 * t57;
t1 = [0, 0, 0, 0, 0, 0, t59, g(2) * t58 + g(3) * t56, -g(1), -g(1) * pkin(5), 0, 0, 0, 0, 0, 0, g(2) * t49 - g(3) * t50, g(2) * t50 + g(3) * t49, -g(1), t59 * pkin(1) - g(1) * t64, 0, 0, 0, 0, 0, 0, t60, t43, -g(1), -g(2) * t61 - g(3) * t62 - t63, 0, 0, 0, 0, 0, 0, t41, t42, -t43, -t63 - g(2) * (-t44 * pkin(3) + t45 * pkin(7) + t61) - g(3) * (t45 * pkin(3) + t44 * pkin(7) + t62), 0, 0, 0, 0, 0, 0, t41, t42, -t43, -g(1) * (t55 * pkin(4) + t52) - g(2) * (-t44 * t47 - t45 * t54 + t61) - g(3) * (-t44 * t54 + t45 * t47 + t62);];
U_reg = t1;
