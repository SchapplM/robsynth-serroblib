...
t2 = cos(t6);
t1 = sin(t6);
t3 = (-m(3) * t22 - mrSges(2,1) * t15 - t8 * mrSges(3,1) + t13 * mrSges(2,2) + t7 * mrSges(3,2) - mrSges(1,3) + t27 * r_base(3) + t26 * (pkin(2) * t8 + t22) - t25 * t2 + t24 * t1) * g(3) + (-m(3) * t19 + t13 * mrSges(2,1) + t7 * mrSges(3,1) + mrSges(2,2) * t15 + t8 * mrSges(3,2) - mrSges(1,2) + t27 * r_base(2) + t26 * (-pkin(2) * t7 + t19) + t24 * t2 + t25 * t1) * g(2) + (-m(1) * r_base(1) - m(2) * t23 - m(3) * t21 - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) + t29 * t14 + t26 * (qJ(3) + t21) - t28 * t12) * g(1);
U = t3;
