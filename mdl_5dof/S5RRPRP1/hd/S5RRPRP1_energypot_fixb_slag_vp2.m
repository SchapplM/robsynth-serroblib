...
t32 = cos(t35);
t31 = sin(t35);
t1 = (-m(3) * t38 - t45 * mrSges(2,1) - t37 * mrSges(3,1) + t43 * mrSges(2,2) + t36 * mrSges(3,2) - mrSges(1,3) + t54 * (pkin(2) * t37 + t38) - t53 * t32 + t52 * t31) * g(3) + (m(3) * t50 + t43 * mrSges(2,1) + t36 * mrSges(3,1) + t45 * mrSges(2,2) + t37 * mrSges(3,2) - mrSges(1,2) + t54 * (-pkin(2) * t36 - t50) + t52 * t32 + t53 * t31) * g(2) + (-m(2) * pkin(5) - m(3) * t51 - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) + t56 * t44 - t55 * t42 + t54 * (qJ(3) + t51)) * g(1);
U = t1;
