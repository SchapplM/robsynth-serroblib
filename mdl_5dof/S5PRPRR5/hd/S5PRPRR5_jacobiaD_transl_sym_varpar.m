...
elseif link_index == 3
	...
	t118 = sin(qJ(2));
	t120 = qJD(3) * t119 + (-t118 * t123 + t119 * t121) * qJD(2);
	t117 = cos(pkin(8));
	t115 = sin(pkin(8));
	t1 = [0, t120 * t117, t117 * t122, 0, 0; 0, t120 * t115, t115 * t122, 0, 0; 0, t118 * qJD(3) + (t118 * t121 + t119 * t123) * qJD(2), qJD(2) * t118, 0, 0;];
	JaD_transl = t1;
elseif link_index == 4
	%% Symbolic Calculation
...
elseif link_index == 5
	...
	t183 = t177 * t179 + t188;
	t190 = t177 * t197;
	t195 = (t170 * t183 - t171 * t190) * r_i_i_C(1) + (t170 * t190 + t171 * t183) * r_i_i_C(2);
	t187 = t179 * t193;
	t184 = -t177 * t178 + t187;
	t189 = t177 * t196;
	t194 = (t170 * t184 - t171 * t189) * r_i_i_C(1) + (t170 * t189 + t171 * t184) * r_i_i_C(2);
	t192 = qJD(2) * t181;
	t173 = cos(t176);
	t185 = -pkin(4) * t173 - cos(pkin(9)) * pkin(3) - pkin(2) + t202 - t203;
	t182 = qJD(3) * t181 + t204 * t180 + (-t180 * t200 + t181 * t185) * qJD(2);
	t168 = t198 * t202;
