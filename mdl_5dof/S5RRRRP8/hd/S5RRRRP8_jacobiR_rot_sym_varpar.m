...
function JR_rot = S5RRRRP8_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP8_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP8_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRRRP8_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t76 = t85 * t79 - t83 * t88;
	t75 = t85 * t80 + t83 * t89;
	t1 = [t76, -t80 * t87, t77, t77, 0; t78, -t80 * t90, -t75, -t75, 0; 0, t88, -t92, -t92, 0; t75, t79 * t87, -t78, -t78, 0; t77, t79 * t90, t76, t76, 0; 0, -t89, -t91, -t91, 0; -t90, t86, 0, 0, 0; t87, t83 * t84, 0, 0, 0; 0, t82, 0, 0, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end