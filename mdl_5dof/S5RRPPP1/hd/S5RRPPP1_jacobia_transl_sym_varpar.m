...
elseif link_index == 4
	...
	% Computational Cost: add. (74->33), mult. (199->54), div. (0->0), fcn. (242->8), ass. (0->30)
	t13 = sin(pkin(8));
	t15 = cos(pkin(8));
	t17 = sin(qJ(2));
	t19 = cos(qJ(2));
	...
	t30 = r_i_i_C(3) + qJ(4);
	t39 = pkin(3) - r_i_i_C(2);
	t40 = -t30 * t27 - t39 * (t13 * t35 + t15 * t17) - pkin(2) * t17 + t19 * t29;
	t38 = pkin(2) * t19;
	t18 = sin(qJ(1));
	t37 = t14 * t18;
	t36 = t16 * t17;
	...
	t26 = t16 * t34 - t37;
	t25 = t14 * t20 + t17 * t33;
	t24 = qJ(3) * t14 * t17 + pkin(1) + t38;
	t12 = t14 * t34 + t33;
	t11 = -t16 * t20 + t17 * t37;
	t3 = t13 * t31 + t26 * t15;
	t1 = t13 * t32 + t25 * t15;
	t2 = [-t11 * r_i_i_C(1) + t28 * t20 - t39 * (-t25 * t13 + t15 * t32) - t30 * t1 - t24 * t18, t40 * t20, t12, t3, 0; t12 * r_i_i_C(1) + t39 * (-t26 * t13 + t15 * t31) + t30 * t3 + t28 * t18 + t24 * t20, t40 * t18, t11, t1, 0; 0, t38 + t30 * (t13 * t19 + t15 * t36) + t17 * t29 + t39 * (-t13 * t36 + t15 * t19), -t19 * t14, t27, 0;];
	Ja_transl = t2;
elseif link_index == 5
	%% Symbolic Calculation
