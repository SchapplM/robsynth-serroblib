...
function Ja_transl = S5RRRRP6_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP6_jacobia_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RRRRP6_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP6_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRRRP6_jacobia_transl_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	% Computational Cost: add. (130->34), mult. (147->44), div. (0->0), fcn. (158->8), ass. (0->31)
	t17 = qJ(2) + qJ(3);
	t14 = sin(t17);
	t15 = cos(t17);
	t19 = sin(qJ(4));
	t38 = r_i_i_C(2) * t19;
	t44 = r_i_i_C(3) * t15 + t14 * t38;
	t22 = cos(qJ(4));
	t12 = pkin(4) * t22 + pkin(3);
	t18 = -qJ(5) - pkin(8);
	t43 = t15 * t12 + (r_i_i_C(3) - t18) * t14;
	t42 = pkin(4) + r_i_i_C(1);
	t16 = cos(qJ(2)) * pkin(2);
	t41 = pkin(1) + t16 + t43;
	t21 = sin(qJ(1));
	t40 = t44 * t21;
	...
	t32 = t21 * t22;
	t31 = t22 * t23;
	t29 = pkin(4) * t19 + pkin(6) + pkin(7);
	t3 = -t15 * t33 + t32;
	t1 = t15 * t34 + t31;
	t27 = -t15 * t18 + (-t12 - t39) * t14;
	t26 = (-t38 + t39) * t15 + t43;
	t25 = -sin(qJ(2)) * pkin(2) + t27;
	t4 = t15 * t31 + t34;
	t2 = -t15 * t32 + t33;
	t5 = [t2 * r_i_i_C(1) + t1 * r_i_i_C(2) - t41 * t21 + t29 * t23, t25 * t23 + t35, t27 * t23 + t35, -r_i_i_C(2) * t4 + t42 * t3, t23 * t14; t4 * r_i_i_C(1) + t3 * r_i_i_C(2) + t29 * t21 + t41 * t23, t25 * t21 + t40, t27 * t21 + t40, r_i_i_C(2) * t2 - t42 * t1, t21 * t14; 0, t16 + t26, t26, (-r_i_i_C(2) * t22 - t42 * t19) * t14, -t15;];
	Ja_transl = t5;
else
	Ja_transl=NaN(3,5);
end