...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S5RRRRR10_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(10,1)}
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S5RRRRR10_pkin2mdhparam: Kinematic parameters pkin have to be [10x1] (double)');
