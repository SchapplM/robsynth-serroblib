...
function Tc_mdh = S5PRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5PRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5PRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S5PRRPR4_fkine_fixb_body_rotmat_mdh_sym_varpar: pkin has to be [9x1] (double)');
Tc_mdh=NaN(4,4);
%% Symbolic Calculation
if link_index == 0
	% From fkine_0_floatb_twist_rotmat_matlab.m
	% OptimizationMode: 2
	% StartTime: 2020-11-04 20:03:52
	% EndTime: 2020-11-04 20:03:52
...
elseif link_index == 2
	...
	t50 = cos(pkin(8));
	t49 = sin(pkin(8));
	t1 = [t50 * t52, -t50 * t51, t49, t50 * pkin(1) + t49 * pkin(5) + 0; t49 * t52, -t49 * t51, -t50, t49 * pkin(1) - t50 * pkin(5) + 0; t51, t52, 0, qJ(1) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 3
...
elseif link_index == 4
	...
	t68 = qJ(4) + pkin(6);
	t70 = sin(qJ(2));
	t72 = t62 * t71 + t68 * t70 + pkin(1);
	t65 = qJ(3) + pkin(9);
	t64 = cos(t65);
	t63 = sin(t65);
	t1 = [t66 * t63 + t64 * t74, -t63 * t74 + t66 * t64, t67 * t70, t73 * t66 + t72 * t67 + 0; -t67 * t63 + t64 * t75, -t63 * t75 - t67 * t64, t66 * t70, t72 * t66 - t73 * t67 + 0; t70 * t64, -t70 * t63, -t71, t70 * t62 - t71 * t68 + qJ(1) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 5
