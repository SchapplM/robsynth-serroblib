% Umwandlung der Kinematikparameter von S5PRRPR4V1 zu S5PRRPR4
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S5PRRPR4_structural_kinematic_parameters.m
function pkin_gen = S5PRRPR4V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
