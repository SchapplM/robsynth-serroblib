...
function JR_rot = S5RRRRP7_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP7_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP7_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRRRP7_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t105 = t113 * t125 - t124;
	t104 = -t113 * t126 - t123;
	t1 = [-t105, -t119, -t119, -t106, 0; t107, -t121, -t121, t104, 0; 0, t110, t110, -t112 * t115, 0; -t116 * t112, t111, t111, 0, 0; t118 * t112, t108, t108, 0, 0; 0, t112, t112, 0, 0; t104, -t120, -t120, t107, 0; t106, -t122, -t122, t105, 0; 0, t109, t109, t112 * t117, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end