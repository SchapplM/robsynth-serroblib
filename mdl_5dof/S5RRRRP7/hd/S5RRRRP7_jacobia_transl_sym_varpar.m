...
function Ja_transl = S5RRRRP7_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP7_jacobia_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RRRRP7_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP7_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRRRP7_jacobia_transl_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 2
	...
	% OptimizationMode: 2
	% StartTime: 2019-12-29 20:35:59
	% EndTime: 2019-12-29 20:35:59
...
elseif link_index == 5
	...
	t2 = t20 * t37 - t36;
	t1 = t20 * t38 + t35;
	t5 = [-t34 * t1 - t45 * t2 - t46 * t25 - t27 * t28, t29 * t27 + t33, t27 * t30 + t33, -t45 * t3 + t34 * t4, t3; -t25 * t28 + t46 * t27 + t34 * t3 + t45 * t4, t29 * t25 + t43, t25 * t30 + t43, -t45 * t1 + t34 * t2, t1; 0, t21 + t31, t31, (-t45 * t23 + t34 * t26) * t19, t19 * t23;];
	Ja_transl = t5;
else
	Ja_transl=NaN(3,5);
end