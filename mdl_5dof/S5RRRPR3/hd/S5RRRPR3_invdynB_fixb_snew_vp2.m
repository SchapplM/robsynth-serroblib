...
% OptimizationMode: 2
% StartTime: 2022-01-20 11:42:48
% EndTime: 2022-01-20 11:42:53
...
t515 = sin(qJ(1));
t519 = cos(qJ(1));
t501 = t515 * g(1) - t519 * g(2);
t496 = qJDD(1) * pkin(1) + t501;
t502 = -t519 * g(1) - t515 * g(2);
t520 = qJD(1) ^ 2;
t497 = -t520 * pkin(1) + t502;
t514 = sin(qJ(2));
t518 = cos(qJ(2));
...
t454 = qJDD(3) * pkin(3) - t491 * qJ(4) - t532 + (qJ(4) * t530 + t513 * t535 - g(3)) * t517;
t460 = -t513 * g(3) + t517 * t470;
...
t403 = m(2) * t501 + qJDD(1) * mrSges(2,1) - t520 * mrSges(2,2) + t405;
t528 = t518 * t408 - t514 * t427;
t404 = m(2) * t502 - t520 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t528;
t531 = t519 * t403 + t515 * t404;
t409 = t517 * t415 + t513 * t416;
t529 = -t515 * t403 + t519 * t404;
...
t397 = (-t513 * t485 + t517 * t486) * t508 + mrSges(3,1) * g(3) + (-Ifges(4,3) - Ifges(5,3)) * qJDD(3) + t504 * Ifges(3,5) - Ifges(6,3) * t505 + Ifges(3,6) * t506 - Ifges(4,5) * t491 - Ifges(4,6) * t492 + t482 * t463 - t483 * t462 - Ifges(5,6) * t472 - Ifges(5,5) * t473 + mrSges(3,3) * t475 - mrSges(4,1) * t459 + mrSges(4,2) * t460 + t464 * t447 - t465 * t446 - Ifges(6,5) * t444 - mrSges(5,1) * t437 + mrSges(5,2) * t438 - Ifges(6,6) * t443 - mrSges(6,1) * t433 + mrSges(6,2) * t434 - pkin(4) * t423 - pkin(3) * t417 - pkin(2) * t409;
t396 = -mrSges(3,2) * g(3) - mrSges(3,3) * t474 + Ifges(3,5) * t506 - t504 * Ifges(3,6) - pkin(7) * t409 - t513 * t398 + t517 * t399;
t395 = -mrSges(2,2) * g(3) - mrSges(2,3) * t501 + Ifges(2,5) * qJDD(1) - t520 * Ifges(2,6) - pkin(6) * t405 + t518 * t396 - t514 * t397;
t394 = Ifges(2,6) * qJDD(1) + t520 * Ifges(2,5) + mrSges(2,1) * g(3) + mrSges(2,3) * t502 + t514 * t396 + t518 * t397 - pkin(1) * (-m(3) * g(3) + t409) + pkin(6) * t528;
t1 = [-m(1) * g(1) + t529; -m(1) * g(2) + t531; (-m(1) - m(2) - m(3)) * g(3) + t409; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t531 - t515 * t394 + t519 * t395; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t529 + t519 * t394 + t515 * t395; -mrSges(1,1) * g(2) + mrSges(2,1) * t501 + mrSges(3,1) * t474 + mrSges(1,2) * g(1) - mrSges(2,2) * t502 - mrSges(3,2) * t475 + Ifges(2,3) * qJDD(1) + Ifges(3,3) * t506 + pkin(1) * t405 + pkin(2) * t521 + pkin(7) * t527 + t517 * t398 + t513 * t399;];
tauB = t1;
