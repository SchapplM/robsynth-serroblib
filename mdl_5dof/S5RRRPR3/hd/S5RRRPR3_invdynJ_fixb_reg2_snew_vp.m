...
t278 = sin(qJ(1));
t279 = cos(qJ(1));
t227 = g(1) * t279 + g(2) * t278;
t196 = -qJD(1) ^ 2 * pkin(1) - t227;
t218 = sin(qJ(2));
t221 = cos(qJ(2));
t226 = g(1) * t278 - g(2) * t279;
t224 = qJDD(1) * pkin(1) + t226;
t162 = t221 * t196 + t218 * t224;
t281 = t212 ^ 2;
t155 = -pkin(2) * t281 + pkin(7) * t210 + t162;
t264 = t155 * t217;
t118 = qJDD(3) * pkin(3) - qJ(4) * t190 - t264 + (-g(3) + (pkin(3) * t261 + qJ(4) * qJD(3)) * t212) * t220;
t246 = qJ(4) * t261;
