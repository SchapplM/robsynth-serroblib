...
function JR_rot = S5RPRRR3_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPRRR3_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPRRR3_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S5RPRRR3_jacobiR_rot_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t35 = t31 * t28;
	t34 = t31 * t29;
	t1 = [-t36, 0, -t35, -t35, -t35; t34, 0, -t37, -t37, -t37; 0, 0, t29, t29, t29; t37, 0, -t34, -t34, -t34; -t35, 0, -t36, -t36, -t36; 0, 0, -t28, -t28, -t28; t31, 0, 0, 0, 0; t30, 0, 0, 0, 0; 0, 0, 0, 0, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end