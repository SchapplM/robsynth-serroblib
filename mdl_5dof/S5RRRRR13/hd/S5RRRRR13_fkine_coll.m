...
function Tc_stack = S5RRRRR13_fkine_coll(q, pkin, T_N_E, I_EElink)

%% Init
%#codegen
%$cgargs {zeros(5,1),zeros(10,1),zeros(4,4),uint8(0)}

%% Berechnung, siehe S5RRRRR13_constr2.m
Tc_stack = NaN(3*(6+1),4);
[Tc_ges, Tc_stack(1:end-3,:)] = S5RRRRR13_fkine_fixb_rotmat_mdh_sym_varpar(q, pkin);
