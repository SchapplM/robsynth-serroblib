...
function Ja_transl = S5RRRRP11_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP11_jacobia_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RRRRP11_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP11_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S5RRRRP11_jacobia_transl_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t6 = t18 * t37 + t27 * t33;
	t5 = t18 * t33 - t27 * t37;
	t2 = [-t36 * pkin(1) - t26 * pkin(2) - t14 * pkin(3) + pkin(7) * t52 - t25 * pkin(8) - t48 * t1 + t58 * t43 - t59 * t61, t28 * pkin(8) + t48 * (-t27 * t51 - t28 * t37) + t59 * (-t27 * t50 + t28 * t33) - t60 * t27, -t41 * t17 + t58 * t18, t48 * t6 - t59 * t5, t5; t40 * pkin(1) + t28 * pkin(2) + t18 * pkin(3) + pkin(7) * t55 + t27 * pkin(8) + t58 * t17 + t48 * t5 + t59 * t6, t26 * pkin(8) + t59 * (-t25 * t50 + t26 * t33) + t48 * (-t25 * t51 - t26 * t37) - t60 * t25, t58 * t14 + t41 * t43, -t59 * t1 + t48 * t61, t1; 0, (t59 * (t33 * t35 + t37 * t49) + t48 * (t33 * t49 - t35 * t37) + pkin(8) * t35 + t60 * t39) * t32, t58 * t24 + t41 * (-t32 * t35 * t34 + t47 * t38), t48 * (t24 * t37 - t33 * t53) - t59 * t11, t11;];
	Ja_transl = t2;
else
	Ja_transl=NaN(3,5);
end