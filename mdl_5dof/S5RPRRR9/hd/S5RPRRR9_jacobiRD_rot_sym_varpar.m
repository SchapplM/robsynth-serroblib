...
function JRD_rot = S5RPRRR9_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),zeros(5,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPRRR9_jacobiRD_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'S5RPRRR9_jacobiRD_rot_sym_varpar: qJD has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPRRR9_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S5RPRRR9_jacobiRD_rot_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t1 = [t319, 0, t321, t321, t316; -t317, 0, t323, t323, -t318; 0, 0, t325, t325, -t329 * t347 - t330 * t355; t318, 0, t320, t320, t317; t316, 0, t322, t322, t319; 0, 0, t324, t324, t329 * t348 - t330 * t353; -t329 * t349 - t343, 0, t326, t326, 0; -t329 * t350 + t341, 0, t327, t327, 0; 0, 0, t328, t328, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,5);
end