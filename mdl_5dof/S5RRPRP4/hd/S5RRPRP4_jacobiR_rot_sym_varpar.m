...
function JR_rot = S5RRPRP4_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(7,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRP4_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRP4_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [7 1]), ...
  'S5RRPRP4_jacobiR_rot_sym_varpar: pkin has to be [7x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t60 = t62 * t64;
	t59 = t61 * t64;
	t1 = [t60, t60, 0, t67, 0; t59, t59, 0, -t66, 0; 0, 0, 0, -t64, 0; -t61, -t61, 0, 0, 0; t62, t62, 0, 0, 0; 0, 0, 0, 0, 0; -t66, -t66, 0, t59, 0; -t67, -t67, 0, -t60, 0; 0, 0, 0, t65, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end