...
function JR_rot = S5PRRRP1_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5PRRRP1_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5PRRRP1_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5PRRRP1_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t27 = t29 * t32;
	t26 = t28 * t31;
	t1 = [0, -t34, -t34, -t33, 0; 0, t27, t27, -t26, 0; 0, 0, 0, t32, 0; 0, t26, t26, -t27, 0; 0, -t33, -t33, -t34, 0; 0, 0, 0, -t31, 0; 0, t29, t29, 0, 0; 0, t28, t28, 0, 0; 0, 0, 0, 0, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end