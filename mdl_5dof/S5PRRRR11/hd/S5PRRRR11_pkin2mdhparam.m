...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S5PRRRR11_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(10,1)}
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S5PRRRR11_pkin2mdhparam: Kinematic parameters pkin have to be [10x1] (double)');
...
t1 = [0; pkin(6); pkin(7); pkin(8); pkin(9);];
d_mdh = t1;
