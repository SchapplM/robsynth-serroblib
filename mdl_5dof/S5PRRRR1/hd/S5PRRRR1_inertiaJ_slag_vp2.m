...
t53 = t31 * t63 / 0.2e1 - t30 * t64 / 0.2e1 + t43 * t4 / 0.2e1 + t47 * t3 / 0.2e1 + Ifges(5,5) * t27 + (-Ifges(5,6) + t29 / 0.2e1) * t26;
t11 = t43 * t19 - t50 * t47;
...
t5 = t54 * t27;
t1 = [m(2) + m(6) * (t11 ^ 2 + t12 ^ 2 + t70) + m(3) * (t42 + t39) + m(4) * (t58 * t39 + t42) + m(5) * (t19 ^ 2 + t42 + t70); t11 * t8 + t12 * t7 + t17 * t5 + m(6) * (-t11 * t47 - t12 * t43) * t69 + (t17 * t27 + t19 * t26) * mrSges(5,3) + (t58 * mrSges(4,3) - mrSges(3,2)) * t46 + (-t45 * mrSges(4,2) + mrSges(3,1) - t9 + (m(5) * pkin(2) + mrSges(4,1)) * t49) * t50; Ifges(4,1) * t38 + Ifges(3,3) + (Ifges(5,2) * t26 + t60) * t26 + (m(6) * t59 + m(5)) * t51 * t41 + (Ifges(5,1) * t27 - t43 * t3 + t47 * t4 + (-Ifges(6,6) * t43 - (2 * Ifges(5,4))) * t26) * t27 + (0.2e1 * Ifges(4,4) * t45 + Ifges(4,2) * t49 + (-t43 * t7 - t47 * t8 - t9) * t71) * t49; (-t45 * mrSges(4,1) - t49 * mrSges(4,2)) * t46 + (m(6) * (-t65 + (-t11 * t43 + t66) * t44) / 0.2e1 + m(5) * (-t19 * t44 - t65) / 0.2e1) * t71 + t52; Ifges(4,5) * t45 + Ifges(4,6) * t49 + ((-t27 * mrSges(5,3) - t5) * t48 + (-mrSges(5,3) * t26 - t43 * t8 + t47 * t7) * t44) * pkin(2) + t53; Ifges(4,3) + m(6) * (t59 * t62 + t35) + m(5) * (t35 + t62) + 0.2e1 * t72 + t57; t52; t53; t72 + t57; t57; t11 * mrSges(6,1) - t12 * mrSges(6,2); -Ifges(6,6) * t64 + t28 * t69 + t60; -t54 * t44 * pkin(2) + t29; t29; Ifges(6,3);];
