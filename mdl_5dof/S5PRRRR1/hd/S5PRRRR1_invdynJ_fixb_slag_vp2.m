...
t166 = t54 * t134 + t53 * t138;
t170 = Ifges(6,5) * t138 - Ifges(6,6) * t134;
t230 = Ifges(6,4) * t138;
t172 = -Ifges(6,2) * t134 + t230;
t231 = Ifges(6,4) * t134;
t174 = Ifges(6,1) * t138 - t231;
t251 = t138 / 0.2e1;
t252 = -t134 / 0.2e1;
...
t263 = -mrSges(5,1) * t128 - mrSges(3,1) + (mrSges(5,2) - mrSges(6,3)) * t127;
t262 = t23 / 0.2e1;
t261 = t24 / 0.2e1;
t260 = t48 / 0.2e1;
t259 = -t78 / 0.2e1;
...
t240 = t81 * t88;
t239 = t98 * Ifges(6,3);
t226 = t102 * mrSges(5,3);
t237 = -mrSges(5,1) * t130 - mrSges(6,1) * t78 + mrSges(6,2) * t79 + t226;
...
t37 = t201 * t210 + (t136 * t201 + t140 * t274) * t139 - t211 * t274;
t91 = t161 * t137;
...
t173 = Ifges(6,1) * t134 + t230;
t171 = Ifges(6,2) * t138 + t231;
...
t76 = t134 * t92 - t208;
t164 = t138 * t92 + t212;
t116 = qJD(3) * mrSges(4,1) - mrSges(4,3) * t204;
t117 = -qJD(3) * mrSges(4,2) + mrSges(4,3) * t202;
t162 = t116 * t140 + t117 * t136;
t159 = mrSges(5,3) + t175;
t85 = -mrSges(5,2) * t130 - t234;
t158 = -t168 + t85;
t156 = t136 * (Ifges(4,1) * t140 - t232);
t149 = -t127 * mrSges(5,2) + (t183 - t235) * t128;
t148 = mrSges(5,2) * t128 + t127 * t183;
t146 = t148 + t177;
t124 = Ifges(4,4) * t202;
t145 = -t136 * (Ifges(4,6) * qJD(3) + (t221 + t232) * qJD(2)) / 0.2e1 + (Ifges(4,1) * t204 + Ifges(4,5) * qJD(3) + t124) * t250 - t177 * t198;
t3 = t23 * Ifges(6,4) + t24 * Ifges(6,2) + t48 * Ifges(6,6);
t32 = t239 + t243 + t245;
t4 = t23 * Ifges(6,1) + t24 * Ifges(6,4) + t48 * Ifges(6,5);
t60 = t223 - t97 + t225;
t144 = t216 * t268 + t134 * t4 / 0.2e1 + Ifges(5,3) * t129 + Ifges(5,5) * t49 + Ifges(5,6) * t50 - t25 * mrSges(5,2) + t169 * t260 + t171 * t261 + t173 * t262 + t81 * t234 + t3 * t251 + t34 * t215 / 0.2e1 + (-mrSges(5,1) - t176) * t26 + (-t97 + t60) * t254 + (-t224 + t32) * t253 + (-Ifges(5,1) * t253 - t170 * t256 - t172 * t259 - t174 * t258 + t278) * t101 + (Ifges(6,5) * t258 - Ifges(5,2) * t254 + Ifges(6,6) * t259 + Ifges(6,3) * t256 + t269 + t279) * t102 + (-t53 * t215 - t54 * t216 + t247 + t272) * mrSges(6,3) + (t81 * t175 + t270) * qJD(5);
t142 = qJD(2) ^ 2;
t106 = t118 * qJD(2);
t96 = t128 * t208 + t213;
t95 = -t128 * t212 + t209;
...
t12 = qJD(5) * t164 - t134 * t36 + t138 * t203;
t11 = qJD(5) * t76 + t134 * t203 + t138 * t36;
t10 = -mrSges(6,2) * t48 + mrSges(6,3) * t24;
t9 = mrSges(6,1) * t48 - mrSges(6,3) * t23;
t1 = [m(2) * qJDD(1) - t164 * t10 + t11 * t51 + t12 * t52 + t36 * t85 - t92 * t42 + t76 * t9 + t249 * t91 + t237 * t37 + (-m(2) - m(3) - m(4) - t255) * g(3) + (qJDD(2) * mrSges(3,1) + t107 * mrSges(4,1) - t142 * mrSges(3,2) - t108 * mrSges(4,2) - t13 + (-t116 * t136 + t117 * t140) * qJD(2)) * t141 + (t140 * (-qJDD(3) * mrSges(4,2) + mrSges(4,3) * t107) - t142 * mrSges(3,1) - t136 * (qJDD(3) * mrSges(4,1) - mrSges(4,3) * t108) - qJDD(2) * mrSges(3,2) - t162 * qJD(3) + (t106 + t66) * qJD(2)) * t137 + m(4) * (-t214 + (-t136 * t84 + t140 * t83 + t194 * t186) * t137) + m(3) * (t110 * t137 - t214) + m(5) * (t113 * t203 - t141 * t80 - t25 * t92 + t36 * t82 + t178) + m(6) * (t11 * t54 + t12 * t53 - t164 * t7 + t76 * t8 + t178); -t110 * mrSges(3,2) + t90 * t85 - t69 * t52 - t70 * t51 - g(1) * (mrSges(6,1) * t94 + mrSges(6,2) * t93) - g(3) * (mrSges(6,1) * t96 + mrSges(6,2) * t95) + Ifges(3,3) * qJDD(2) - t237 * t88 + (t118 - mrSges(3,1)) * t109 - m(6) * (t53 * t69 + t54 * t70 + t240) - m(5) * (-t82 * t90 + t240) + (t239 / 0.2e1 + t245 / 0.2e1 + t243 / 0.2e1 - t82 * mrSges(5,3) + t32 / 0.2e1 - t269 - t277) * t271 + (-t97 / 0.2e1 + t225 / 0.2e1 + t60 / 0.2e1 + t159 * t81 + t270 + t278) * (-qJD(3) * t160 - t153) + (t195 * g(3) - t263 * g(1) + (qJD(2) * mrSges(3,1) - t106 - t187) * qJD(1)) * t137 + (-m(4) * t194 * qJD(1) ^ 2 * t137 + mrSges(3,2) * t197 + t195 * g(1) + t263 * g(3)) * t141 + (mrSges(4,1) * t180 + t83 * mrSges(4,3) + Ifges(4,4) * t108 + Ifges(4,2) * t107 + Ifges(4,6) * qJDD(3) - t117 * t198) * t140 + (-mrSges(4,2) * t180 - t84 * mrSges(4,3) + Ifges(4,1) * t108 + Ifges(4,4) * t107 + Ifges(4,5) * qJDD(3) + t116 * t198) * t136 + ((t229 / 0.2e1 - t228 / 0.2e1) * qJD(3) + (t156 / 0.2e1 + (Ifges(4,4) * t140 - Ifges(4,2) * t136) * t250) * qJD(2) + t145) * qJD(3) + (t80 * mrSges(5,1) - t25 * mrSges(5,3) - Ifges(5,4) * t49 - Ifges(5,2) * t50 - Ifges(5,6) * t129 + t264) * t160 + (t170 * t260 + t174 * t262 + t172 * t261 + t4 * t251 + t3 * t252 + Ifges(5,5) * t129 + Ifges(5,1) * t49 + Ifges(5,4) * t50 + t80 * mrSges(5,2) + t159 * t26 + t179 * mrSges(6,3) + (-mrSges(6,3) * t267 + t138 * t268 + t169 * t256 + t171 * t259 + t173 * t258 + t81 * t176 + t34 * t252) * qJD(5)) * t161 + ((m(6) * t166 - t167 + t187) * t136 * qJD(3) + (-t134 * t10 - t138 * t9 - t13 + t168 * qJD(5) + (-t199 * t54 + t200 * t53 + t179 + t180) * m(6) + (t180 - t80) * m(5)) * t140) * pkin(2); -m(6) * (t53 * t67 + t54 * t68 - t241) + (g(3) * t146 + qJD(1) * t162) * t137 + (-t118 + t149) * g(2) + t237 * t87 + t82 * t226 + (t255 * t140 * g(2) + (-qJD(2) * t66 + t181 * m(6) + (-qJD(2) * t113 + t181) * m(5)) * t136 + (-m(6) * t26 + m(5) * (-t26 + t217) - t249 + (m(6) * t267 + t158) * qJD(4)) * t139 + (t138 * t10 - t134 * t9 + t42 + t167 * qJD(5) + t237 * qJD(4) + m(6) * (-t199 * t53 - t200 * t54 + t218 + t272) + m(5) * (t25 + t218)) * t135) * pkin(2) + Ifges(4,6) * t107 + Ifges(4,5) * t108 - t83 * mrSges(4,2) + t84 * mrSges(4,1) + t89 * t85 + t81 * t61 - t67 * t52 - t68 * t51 - m(5) * (-t82 * t89 - t241) + (-qJD(3) * (-t228 + t229) / 0.2e1 - t140 * t124 / 0.2e1 + (t136 * t221 / 0.2e1 - t156 / 0.2e1) * qJD(2) - t145) * qJD(2) + t144 + t146 * t248 + Ifges(4,3) * qJDD(3) - g(1) * t206 - g(3) * t207; (t226 - t237) * t82 + (-m(6) * (-t267 + t82) + t61 + t158) * t81 + t144 + (t141 * t148 - t206) * g(1) + t149 * g(2) + (t137 * t148 - t207) * g(3); -t81 * (mrSges(6,1) * t79 + mrSges(6,2) * t78) + (Ifges(6,1) * t78 - t244) * t258 + t33 * t257 + (Ifges(6,5) * t78 - Ifges(6,6) * t79) * t256 - t53 * t51 + t54 * t52 - g(1) * (mrSges(6,1) * t95 - mrSges(6,2) * t96) - g(3) * (-mrSges(6,1) * t93 + mrSges(6,2) * t94) - t175 * t247 + (t53 * t78 + t54 * t79) * mrSges(6,3) + (-Ifges(6,2) * t79 + t34 + t75) * t259 + t264;];
tau = t1;
