...
t64 = Icges(5,6) * t109 + t112 * t117;
t140 = Icges(5,4) * t100;
t119 = Icges(5,1) * t101 - t140;
t66 = Icges(5,5) * t109 + t112 * t119;
t124 = -t100 * t64 + t101 * t66;
t63 = -Icges(5,6) * t112 + t109 * t117;
t65 = -Icges(5,5) * t112 + t109 * t119;
t125 = t100 * t63 - t101 * t65;
t115 = Icges(5,5) * t101 - Icges(5,6) * t100;
t61 = -Icges(5,3) * t112 + t109 * t115;
t62 = Icges(5,3) * t109 + t112 * t115;
t138 = t100 * t109;
t110 = cos(qJ(5));
t133 = t112 * t110;
t107 = sin(qJ(5));
...
t13 = t40 * t138 + t42 * t80 + t44 * t81;
t8 = t109 * t13 - t112 * t12;
t162 = -t105 * t61 - (t124 * t109 + (t125 - t62) * t112) * t109 - t8;
t108 = sin(qJ(3));
t111 = cos(qJ(3));
t161 = rSges(4,1) * t111 - rSges(4,2) * t108;
t104 = t109 ^ 2;
t93 = -rSges(4,1) * t108 - rSges(4,2) * t111;
t160 = m(4) * t93;
t88 = -rSges(5,1) * t100 - rSges(5,2) * t101;
t159 = m(5) * t88;
...
t155 = -t112 / 0.2e1;
t154 = t112 / 0.2e1;
t14 = t137 * t39 + t41 * t82 + t43 * t83;
t15 = t137 * t40 + t42 * t82 + t44 * t83;
t9 = t109 * t15 - t112 * t14;
...
t141 = Icges(4,4) * t111;
t132 = t104 + t105;
t46 = rSges(6,1) * t83 + rSges(6,2) * t82 + rSges(6,3) * t137;
t131 = t58 - t152;
t130 = t88 - t152;
t23 = t55 * t138 + t56 * t80 + t57 * t81;
t3 = t23 * t101 + (t109 * t12 + t112 * t13) * t100;
t24 = t137 * t55 + t56 * t82 + t57 * t83;
t4 = t24 * t101 + (t109 * t14 + t112 * t15) * t100;
t129 = t3 * t155 + t4 * t156 + t101 * (t143 - t144) / 0.2e1 + t8 * t138 / 0.2e1 + t9 * t137 / 0.2e1;
t128 = t132 * t151;
...
t68 = -rSges(5,2) * t137 + rSges(5,3) * t109 + t112 * t148;
t38 = -t109 * (t109 * t126 - t145) - t112 * t68;
...
t99 = t112 * t151;
t95 = rSges(3,1) * t112 - rSges(3,2) * t109;
t94 = -rSges(3,1) * t109 - rSges(3,2) * t112;
t77 = t109 * rSges(4,3) + t112 * t161;
t75 = -t112 * rSges(4,3) + t109 * t161;
t70 = Icges(4,3) * t109 + t112 * t116;
t69 = -Icges(4,3) * t112 + t109 * t116;
t60 = t130 * t112;
t59 = t130 * t109;
t53 = t68 + t99;
...
t29 = -t101 * t46 + t137 * t58;
t28 = t100 * t146 - t150;
t26 = (t109 * t46 - t112 * t45) * t100;
t25 = -t128 + t27;
t1 = [m(2) + m(3) + m(4) + m(5) + m(6); m(3) * t95 + m(4) * t77 + m(5) * t53 + m(6) * t37; -t101 * t86 - t108 * (-Icges(4,1) * t108 - t141) - t111 * (-Icges(4,2) * t111 - t142) + Icges(3,3) + (-t87 - t146) * t100 + m(6) * (t36 ^ 2 + t37 ^ 2) + m(5) * (t52 ^ 2 + t53 ^ 2) + m(4) * (t75 ^ 2 + t77 ^ 2) + m(3) * (t94 ^ 2 + t95 ^ 2) + t150; m(5) * t59 + m(6) * t48 + t109 * t160; (-t108 * (Icges(4,5) * t109 + t120 * t112) - t111 * (Icges(4,6) * t109 + t118 * t112)) * t157 + (-t108 * (-Icges(4,5) * t112 + t120 * t109) - t111 * (-Icges(4,6) * t112 + t118 * t109)) * t154 + m(6) * (t49 * t36 + t48 * t37) + m(5) * (t60 * t52 + t59 * t53) + (t109 * t77 - t112 * t75) * t160 + (-t104 / 0.2e1 - t105 / 0.2e1) * (-Icges(4,5) * t108 - Icges(4,6) * t111) + t113; m(6) * (t25 ^ 2 + t48 ^ 2 + t49 ^ 2) + m(5) * (t31 ^ 2 + t59 ^ 2 + t60 ^ 2) + m(4) * (t132 * t93 ^ 2 + t47 ^ 2) + t109 * t104 * t70 + t153 + (-t105 * t69 + (-t109 * t69 + t112 * t70) * t109 + t162) * t112; (t158 + t159) * t109; (t109 * t53 + t112 * t52) * t159 + (t109 * t37 + t112 * t36) * t158 + t113; m(6) * (t27 * t25 + (t109 * t48 + t112 * t49) * t58) + m(5) * (t38 * t31 + (t109 * t59 + t112 * t60) * t88) + t114; m(5) * (t132 * t88 ^ 2 + t38 ^ 2) + m(6) * (t132 * t58 ^ 2 + t27 ^ 2) + t114; m(6) * t29; t101 * t28 + m(6) * (t29 * t37 + t30 * t36) + ((-t20 / 0.2e1 - t24 / 0.2e1) * t112 + (-t19 / 0.2e1 - t23 / 0.2e1) * t109) * t100; m(6) * (t25 * t26 + t29 * t48 + t30 * t49) + t129; m(6) * (t26 * t27 + (t109 * t29 + t112 * t30) * t58) + t129; m(6) * (t26 ^ 2 + t29 ^ 2 + t30 ^ 2) - t101 ^ 2 * t28 + (t112 * t4 + t101 * (t109 * t19 + t112 * t20) + t109 * t3) * t100;];
