...
t44 = sin(t48);
t50 = sin(qJ(1));
t59 = t50 * pkin(1) + pkin(2) * t44;
t43 = pkin(9) + t48;
t39 = sin(t43);
t57 = pkin(3) * t39 + t59;
t45 = cos(t48);
t52 = cos(qJ(1));
t56 = -t52 * pkin(1) - pkin(2) * t45;
t42 = qJ(4) + t43;
t37 = sin(t42);
t38 = cos(t42);
t55 = g(2) * t37 - g(3) * t38;
...
t49 = sin(qJ(5));
t35 = g(2) * t38 + g(3) * t37;
t1 = [0, 0, 0, 0, 0, 0, t54, -g(2) * t52 - g(3) * t50, -g(1), -g(1) * pkin(5), 0, 0, 0, 0, 0, 0, -g(2) * t44 + g(3) * t45, -g(2) * t45 - g(3) * t44, -g(1), t54 * pkin(1) - g(1) * t61, 0, 0, 0, 0, 0, 0, -g(2) * t39 + g(3) * t40, -g(2) * t40 - g(3) * t39, -g(1), -g(1) * t58 - g(2) * t59 - g(3) * t56, 0, 0, 0, 0, 0, 0, -t55, -t35, -g(1), -g(2) * t57 - g(3) * t53 - t60, 0, 0, 0, 0, 0, 0, -g(1) * t49 - t55 * t51, -g(1) * t51 + t55 * t49, t35, -t60 - g(2) * (t37 * pkin(4) - t38 * pkin(8) + t57) - g(3) * (-t38 * pkin(4) - t37 * pkin(8) + t53);];
U_reg = t1;
