...
% OptimizationMode: 2
% StartTime: 2020-01-03 12:00:29
% EndTime: 2020-01-03 12:00:32
...
t373 = sin(qJ(1));
t377 = cos(qJ(1));
t356 = -t373 * g(2) + t377 * g(3);
t378 = qJD(1) ^ 2;
t357 = -t377 * g(2) - t373 * g(3);
t354 = qJDD(1) * pkin(1) + t357;
t355 = -t378 * pkin(1) + t356;
t372 = sin(qJ(2));
t376 = cos(qJ(2));
...
t290 = m(2) * t356 - t378 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t384;
t292 = t376 * t298 + t372 * t299;
t291 = m(2) * t357 + qJDD(1) * mrSges(2,1) - t378 * mrSges(2,2) + t292;
t388 = t373 * t290 + t377 * t291;
t312 = t374 * t320 + t370 * t321;
t386 = m(5) * t367 + t312;
t385 = -t377 * t290 + t373 * t291;
t380 = m(4) * t367 + t386;
...
t286 = -mrSges(3,2) * g(1) - mrSges(3,3) * t339 + Ifges(3,5) * t365 - t364 * Ifges(3,6) - qJ(3) * t300 - t368 * t293 + t369 * t294;
t285 = mrSges(3,1) * g(1) + mrSges(3,3) * t340 + t364 * Ifges(3,5) + Ifges(3,6) * t365 - pkin(2) * t380 + qJ(3) * t383 + t369 * t293 + t368 * t294;
t284 = -mrSges(2,2) * g(1) - mrSges(2,3) * t357 + Ifges(2,5) * qJDD(1) - t378 * Ifges(2,6) - pkin(6) * t292 - t372 * t285 + t376 * t286;
t283 = Ifges(2,6) * qJDD(1) + t378 * Ifges(2,5) + mrSges(2,1) * g(1) + mrSges(2,3) * t356 + t372 * t286 + t376 * t285 - pkin(1) * (-m(3) * g(1) + t380) + pkin(6) * t384;
t1 = [(-m(1) - m(2) - m(3)) * g(1) + t380; -m(1) * g(2) + t388; -m(1) * g(3) + t385; pkin(1) * t292 + pkin(2) * t300 - mrSges(3,2) * t340 + mrSges(3,1) * t339 + pkin(3) * t308 + mrSges(4,1) * t332 - mrSges(4,2) * t333 + pkin(4) * t379 + pkin(8) * t381 + mrSges(5,1) * t326 - mrSges(5,2) * t327 + t370 * t314 + t374 * t313 + mrSges(2,1) * t357 - mrSges(2,2) * t356 + Ifges(2,3) * qJDD(1) + Ifges(5,3) * t359 - mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + (Ifges(3,3) + Ifges(4,3)) * t365; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) - pkin(5) * t385 + t377 * t283 + t373 * t284; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + pkin(5) * t388 + t373 * t283 - t377 * t284;];
tauB = t1;
