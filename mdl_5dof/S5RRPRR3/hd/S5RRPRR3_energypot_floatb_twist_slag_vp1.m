...
t3 = cos(t7);
t2 = sin(t7);
t1 = -m(1) * (g(1) * (r_base(1) + rSges(1,1)) + g(2) * (r_base(2) + rSges(1,2)) + g(3) * (r_base(3) + rSges(1,3))) - m(2) * (g(1) * (rSges(2,3) + t27) + g(2) * (t14 * rSges(2,1) + rSges(2,2) * t16 + r_base(2)) + g(3) * (-rSges(2,1) * t16 + t14 * rSges(2,2) + r_base(3))) - m(3) * (g(1) * (rSges(3,3) + t25) + g(2) * (rSges(3,1) * t9 + rSges(3,2) * t10 + t26) + g(3) * (-t10 * rSges(3,1) + t9 * rSges(3,2) + t23)) - m(4) * (g(1) * (rSges(4,3) + t21) + g(2) * (rSges(4,1) * t4 + rSges(4,2) * t5 + t24) + g(3) * (-t5 * rSges(4,1) + t4 * rSges(4,2) + t18)) - m(5) * (g(1) * (rSges(5,3) + t20) + g(2) * (rSges(5,1) * t2 + rSges(5,2) * t3 + t22) + g(3) * (-t3 * rSges(5,1) + t2 * rSges(5,2) + t17)) - m(6) * (g(1) * (rSges(6,1) * t13 + rSges(6,2) * t15 + t20) + g(2) * t22 + g(3) * t17 + (g(2) * t28 - g(3) * t19) * t3 + (g(2) * t19 + g(3) * t28) * t2);
U = t1;
