...
t497 = sin(qJ(1));
t501 = cos(qJ(1));
t476 = t497 * g(1) - t501 * g(2);
t473 = qJDD(1) * pkin(1) + t476;
t477 = -t501 * g(1) - t497 * g(2);
t502 = qJD(1) ^ 2;
t474 = -t502 * pkin(1) + t477;
t496 = sin(qJ(2));
t500 = cos(qJ(2));
...
t398 = m(2) * t476 + qJDD(1) * mrSges(2,1) - t502 * mrSges(2,2) + t401;
t512 = -t496 * t407 + t500 * t408;
t399 = m(2) * t477 - t502 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t512;
t516 = t501 * t398 + t497 * t399;
t425 = t498 * t436 + t494 * t437;
t514 = m(5) * t491 + t425;
t513 = -t497 * t398 + t501 * t399;
t423 = m(4) * t491 + t514;
...
t503 = mrSges(2,1) * t476 - mrSges(2,2) * t477 + Ifges(2,3) * qJDD(1) + pkin(1) * t401 + t504;
...
t394 = -mrSges(3,2) * g(3) - mrSges(3,3) * t458 + Ifges(3,5) * t488 - t487 * Ifges(3,6) - qJ(3) * t410 - t492 * t402 + t493 * t403;
t393 = mrSges(3,1) * g(3) + mrSges(3,3) * t459 + t487 * Ifges(3,5) + Ifges(3,6) * t488 - pkin(2) * t423 + qJ(3) * t511 + t493 * t402 + t492 * t403;
t392 = -mrSges(2,2) * g(3) - mrSges(2,3) * t476 + Ifges(2,5) * qJDD(1) - t502 * Ifges(2,6) - pkin(6) * t401 - t496 * t393 + t500 * t394;
t391 = Ifges(2,6) * qJDD(1) + t502 * Ifges(2,5) + mrSges(2,1) * g(3) + mrSges(2,3) * t477 + t496 * t394 + t500 * t393 - pkin(1) * (-m(3) * g(3) + t423) + pkin(6) * t512;
t1 = [-m(1) * g(1) + t513; -m(1) * g(2) + t516; (-m(1) - m(2) - m(3)) * g(3) + t423; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t516 - t497 * t391 + t501 * t392; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t513 + t501 * t391 + t497 * t392; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t503; t503; t504; t423; t507; t519;];
tauJB = t1;
