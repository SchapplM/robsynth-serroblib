...
elseif link_index == 4
	...
	t50 = cos(t51);
	t49 = sin(t51);
	t1 = [t50, -t49, 0, pkin(3) * cos(t52) + pkin(2) * cos(t53) + cos(qJ(1)) * pkin(1) + 0; t49, t50, 0, pkin(3) * sin(t52) + pkin(2) * sin(t53) + sin(qJ(1)) * pkin(1) + 0; 0, 0, 1, pkin(7) + qJ(3) + pkin(6) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 5
	...
	t55 = cos(t56);
	t54 = sin(t56);
	t1 = [t55 * t60, -t55 * t59, t54, t55 * pkin(4) + t54 * pkin(8) + pkin(3) * cos(t57) + pkin(2) * cos(t58) + cos(qJ(1)) * pkin(1) + 0; t54 * t60, -t54 * t59, -t55, t54 * pkin(4) - t55 * pkin(8) + pkin(3) * sin(t57) + pkin(2) * sin(t58) + sin(qJ(1)) * pkin(1) + 0; t59, t60, 0, pkin(7) + qJ(3) + pkin(6) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
end