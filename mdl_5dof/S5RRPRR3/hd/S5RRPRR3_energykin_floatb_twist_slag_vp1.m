...
% Computational Cost: add. (1001->212), mult. (596->270), div. (0->0), fcn. (372->10), ass. (0->109)
t192 = -pkin(5) - pkin(6);
t153 = sin(qJ(1));
t189 = pkin(1) * t153;
t155 = cos(qJ(1));
...
t158 = V_base(5) * qJ(3) + t160;
t157 = V_base(5) * pkin(7) + (-t185 - t187) * t140 + t158;
...
t109 = rSges(3,1) * t145 - rSges(3,2) * t144;
t108 = rSges(3,1) * t144 + rSges(3,2) * t145;
t107 = Icges(3,1) * t145 - t182;
t106 = Icges(3,1) * t144 + t137;
t105 = -Icges(3,2) * t144 + t137;
t104 = Icges(3,2) * t145 + t182;
...
t82 = V_base(5) * rSges(2,3) - t127 * t143 + t174;
t81 = t128 * t143 + V_base(2) + (-rSges(2,3) - pkin(5)) * V_base(4);
t80 = t127 * V_base(4) - t128 * V_base(5) + V_base(3);
t79 = rSges(6,3) * t134 + t135 * t166;
t78 = -rSges(6,3) * t135 + t134 * t166;
t71 = V_base(5) * rSges(3,3) - t108 * t140 + t160;
t70 = t109 * t140 + (-rSges(3,3) + t192) * V_base(4) + t176;
t69 = V_base(4) * t108 + (-t109 - t188) * V_base(5) + t175;
t68 = V_base(5) * rSges(4,3) + (-t99 - t187) * t140 + t158;
t67 = t100 * t140 + (-rSges(4,3) + t177) * V_base(4) + t170;
t66 = V_base(4) * t99 + (-t100 + t168) * V_base(5) + t167;
t65 = V_base(5) * rSges(5,3) - t133 * t89 + t157;
t64 = t133 * t90 + (-rSges(5,3) + t171) * V_base(4) + t169;
t63 = V_base(4) * t89 + (t161 - t90) * V_base(5) + t162;
t62 = t110 * t126 + (-t78 - t91) * t133 + t157;
t61 = -t111 * t126 + (t79 + t92) * t133 + t171 * V_base(4) + t169;
t60 = -t110 * t79 + t111 * t78 + V_base(4) * t91 + (t161 - t92) * V_base(5) + t162;
t1 = m(1) * (t113 ^ 2 + t114 ^ 2 + t115 ^ 2) / 0.2e1 + m(2) * (t80 ^ 2 + t81 ^ 2 + t82 ^ 2) / 0.2e1 + m(3) * (t69 ^ 2 + t70 ^ 2 + t71 ^ 2) / 0.2e1 + m(4) * (t66 ^ 2 + t67 ^ 2 + t68 ^ 2) / 0.2e1 + m(5) * (t63 ^ 2 + t64 ^ 2 + t65 ^ 2) / 0.2e1 + m(6) * (t60 ^ 2 + t61 ^ 2 + t62 ^ 2) / 0.2e1 + t111 * (t159 * t134 + t156 * t135) / 0.2e1 + t110 * (t156 * t134 - t159 * t135) / 0.2e1 + ((t152 * t77 + t154 * t75) * t111 + (t152 * t76 + t154 * t74) * t110 + (t154 * t120 + t152 * t123 + Icges(5,3)) * t133) * t133 / 0.2e1 + ((-t104 * t144 + t106 * t145 - t153 * t121 + t124 * t155 - t134 * t85 + t135 * t87 - t138 * t95 + t139 * t97 + Icges(1,4)) * V_base(5) + (-t144 * t105 + t145 * t107 - t153 * t122 + t155 * t125 - t134 * t86 + t135 * t88 - t138 * t96 + t139 * t98 + Icges(1,1)) * V_base(4)) * V_base(4) / 0.2e1 + ((t145 * t104 + t144 * t106 + t155 * t121 + t153 * t124 + t134 * t87 + t135 * t85 + t138 * t97 + t139 * t95 + Icges(1,2)) * V_base(5) + (t105 * t145 + t107 * t144 + t122 * t155 + t153 * t125 + t134 * t88 + t135 * t86 + t138 * t98 + t139 * t96 + Icges(1,4)) * V_base(4)) * V_base(5) / 0.2e1 + V_base(4) * t133 * (Icges(5,5) * t135 - Icges(5,6) * t134) + V_base(5) * t133 * (Icges(5,5) * t134 + Icges(5,6) * t135) + ((Icges(3,5) * t145 + Icges(4,5) * t139 - Icges(3,6) * t144 - Icges(4,6) * t138) * V_base(4) + (Icges(3,5) * t144 + Icges(4,5) * t138 + Icges(3,6) * t145 + Icges(4,6) * t139) * V_base(5) + (Icges(3,3) / 0.2e1 + Icges(4,3) / 0.2e1) * t140) * t140 + (Icges(1,5) * V_base(4) + Icges(1,6) * V_base(5) + Icges(1,3) * V_base(6) / 0.2e1) * V_base(6) + ((Icges(2,5) * t153 + Icges(2,6) * t155) * V_base(5) + (Icges(2,5) * t155 - Icges(2,6) * t153) * V_base(4) + Icges(2,3) * t143 / 0.2e1) * t143;
T = t1;
