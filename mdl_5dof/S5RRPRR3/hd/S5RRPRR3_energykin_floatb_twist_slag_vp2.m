...
t2 = t4 * t54 + t50 * t7;
t1 = -t4 * t50 + t54 * t7;
t8 = m(2) * (t37 ^ 2 + t38 ^ 2 + t58) / 0.2e1 + m(1) * (V_base(2) ^ 2 + V_base(3) ^ 2 + t58) / 0.2e1 + m(3) * (t25 ^ 2 + t26 ^ 2 + t39 ^ 2) / 0.2e1 + m(4) * (t12 ^ 2 + t13 ^ 2 + t29 ^ 2) / 0.2e1 + m(5) * (t21 ^ 2 + t5 ^ 2 + t6 ^ 2) / 0.2e1 + m(6) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) / 0.2e1 + (V_base(2) * mrSges(1,1) - V_base(1) * mrSges(1,2) + Ifges(1,3) * V_base(6) / 0.2e1) * V_base(6) + (t38 * mrSges(2,1) - t37 * mrSges(2,2) + Ifges(2,3) * t47 / 0.2e1) * t47 + (t5 * mrSges(5,1) - t6 * mrSges(5,2) + Ifges(5,3) * t43 / 0.2e1) * t43 + (t39 * mrSges(3,2) - t25 * mrSges(3,3) + Ifges(3,1) * t36 / 0.2e1) * t36 + (t29 * mrSges(4,2) - t12 * mrSges(4,3) + Ifges(4,1) * t28 / 0.2e1) * t28 + (t1 * mrSges(6,1) - t2 * mrSges(6,2) + Ifges(6,3) * t16 / 0.2e1) * t16 + (-V_base(3) * mrSges(1,1) + V_base(1) * mrSges(1,3) + Ifges(1,6) * V_base(6) + Ifges(1,2) * V_base(5) / 0.2e1) * V_base(5) + (-V_base(1) * mrSges(2,1) + t37 * mrSges(2,3) + Ifges(2,6) * t47 + Ifges(2,2) * t41 / 0.2e1) * t41 + (-t39 * mrSges(3,1) + t26 * mrSges(3,3) + Ifges(3,4) * t36 + Ifges(3,2) * t35 / 0.2e1) * t35 + (-t29 * mrSges(4,1) + t13 * mrSges(4,3) + Ifges(4,4) * t28 + Ifges(4,2) * t27 / 0.2e1) * t27 + (t21 * mrSges(5,2) - t5 * mrSges(5,3) + Ifges(5,5) * t43 + Ifges(5,1) * t18 / 0.2e1) * t18 + (t3 * mrSges(6,2) - t1 * mrSges(6,3) + Ifges(6,5) * t16 + Ifges(6,1) * t15 / 0.2e1) * t15 + (V_base(3) * mrSges(1,2) - V_base(2) * mrSges(1,3) + Ifges(1,4) * V_base(5) + Ifges(1,5) * V_base(6) + Ifges(1,1) * V_base(4) / 0.2e1) * V_base(4) + (V_base(1) * mrSges(2,2) - t38 * mrSges(2,3) + Ifges(2,4) * t41 + Ifges(2,5) * t47 + Ifges(2,1) * t40 / 0.2e1) * t40 + (-t21 * mrSges(5,1) + t6 * mrSges(5,3) + Ifges(5,4) * t18 + Ifges(5,6) * t43 + Ifges(5,2) * t17 / 0.2e1) * t17 + (-t3 * mrSges(6,1) + t2 * mrSges(6,3) + Ifges(6,4) * t15 + Ifges(6,6) * t16 + Ifges(6,2) * t14 / 0.2e1) * t14 + (t25 * mrSges(3,1) + t12 * mrSges(4,1) - t26 * mrSges(3,2) - t13 * mrSges(4,2) + Ifges(3,5) * t36 + Ifges(4,5) * t28 + Ifges(3,6) * t35 + Ifges(4,6) * t27 + (Ifges(4,3) / 0.2e1 + Ifges(3,3) / 0.2e1) * t46) * t46;
T = t8;
