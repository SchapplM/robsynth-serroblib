...
t34 = t48 * t72 + t52 * t75;
t28 = pkin(8) + t34;
t3 = t133 * t37 + m(6) * (t103 * t28 + t27 * t37) + m(5) * (-t33 * t37 + t34 * t38) + m(4) * (t52 * t55 + t54 * t98) + t131;
t111 = t3 * qJD(1);
t104 = t112 * t33;
t79 = -t33 * mrSges(5,2) + mrSges(6,3) * t104 + t133 * t34;
t4 = m(6) * (t104 * t28 + t27 * t34) + t79;
t110 = t4 * qJD(1);
t90 = t114 + t116;
t85 = t27 * t90;
t66 = Ifges(6,4) * t74;
...
t86 = pkin(4) * t90;
t92 = -t86 / 0.2e1 + t99;
t77 = (t101 * t28 + t102 * t33 + t27 * t53 + t34 * t49) * t130;
...
t6 = m(6) * (t101 * t50 + t49 * t53) + t78;
t89 = t2 * qJD(1) + t6 * qJD(2);
t84 = t49 * t90;
t16 = t84 + t99;
t8 = (mrSges(6,2) * t93 - t66) * t74 + (mrSges(6,1) * t93 - t138) * t71;
t88 = -t8 * qJD(1) + t16 * qJD(2);
t87 = -t114 / 0.2e1 - t116 / 0.2e1;
t10 = (mrSges(6,2) * t97 - t66) * t74 + (mrSges(6,1) * t97 - t138) * t71;
t12 = (mrSges(6,2) * t96 - t66) * t74 + (mrSges(6,1) * t96 - t138) * t71;
t17 = -t86 + t99;
...
t5 = [qJD(2) * t3 + qJD(4) * t4 + qJD(5) * t15, t1 * qJD(4) + t9 * qJD(5) + t111 + (t119 - t120 + 0.2e1 * (t102 * t38 + t37 * t49) * t130 + m(5) * (-t37 * t51 + t38 * t53) + m(4) * (t54 * t70 + t55 * t69) * pkin(2) + t131) * qJD(2), 0, t110 + t1 * qJD(2) + (m(6) * (-pkin(4) * t34 + pkin(8) * t104) + t79) * qJD(4) + t11 * qJD(5), t109 + t9 * qJD(2) + t11 * qJD(4) + (t28 * t61 + t100) * qJD(5); qJD(4) * t2 - qJD(5) * t8 - t111, qJD(4) * t6 + qJD(5) * t16, 0, (m(6) * (-pkin(4) * t53 + pkin(8) * t101) + t78) * qJD(4) + t13 * qJD(5) + t89, t13 * qJD(4) + (t50 * t61 + t100) * qJD(5) + t88; 0, 0, 0, 0, -t90 * qJD(5); -qJD(2) * t2 - qJD(5) * t10 - t110, -qJD(5) * t12 - t89, 0, t17 * qJD(5), (pkin(8) * t61 + t100) * qJD(5) - t81; qJD(2) * t8 + qJD(4) * t10 - t109, qJD(4) * t12 - t88, 0, t81, 0;];
Cq = t5;
