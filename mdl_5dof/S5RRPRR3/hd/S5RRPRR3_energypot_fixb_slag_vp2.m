...
t34 = cos(t38);
t33 = sin(t38);
t1 = (-m(3) * t43 - m(4) * t54 - t48 * mrSges(2,1) - t41 * mrSges(3,1) - t36 * mrSges(4,1) + t46 * mrSges(2,2) + t40 * mrSges(3,2) + t35 * mrSges(4,2) - mrSges(1,3) + t59 * (pkin(3) * t36 + t54) - t58 * t34 + t57 * t33) * g(3) + (m(3) * t55 - m(4) * t51 + t46 * mrSges(2,1) + t40 * mrSges(3,1) + t35 * mrSges(4,1) + t48 * mrSges(2,2) + t41 * mrSges(3,2) + t36 * mrSges(4,2) - mrSges(1,2) + t59 * (-pkin(3) * t35 + t51) + t57 * t34 + t58 * t33) * g(2) + (-m(2) * pkin(5) - m(3) * t56 - m(4) * t53 - t45 * mrSges(6,1) - t47 * mrSges(6,2) - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) - mrSges(5,3) + t59 * (pkin(7) + t53)) * g(1);
U = t1;
