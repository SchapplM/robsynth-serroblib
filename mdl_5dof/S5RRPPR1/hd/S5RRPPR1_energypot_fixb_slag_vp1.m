...
t31 = cos(t36);
t30 = sin(t36);
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (pkin(5) + rSges(2,3)) + g(2) * (-t45 * rSges(2,1) - rSges(2,2) * t46) + g(3) * (rSges(2,1) * t46 - t45 * rSges(2,2))) - m(3) * (g(1) * (rSges(3,3) + t56) + g(2) * (-rSges(3,1) * t37 - rSges(3,2) * t38 - t55) + g(3) * (rSges(3,1) * t38 - rSges(3,2) * t37 + t39)) - m(4) * (g(1) * (rSges(4,3) + t51) + g(2) * (-rSges(4,1) * t30 - rSges(4,2) * t31 + t50) + g(3) * (rSges(4,1) * t31 - rSges(4,2) * t30 + t53)) - m(5) * (g(1) * (rSges(5,1) * t42 + rSges(5,2) * t43 + t51) + (g(2) * t52 + g(3) * t49) * t31 + (-g(2) * t49 + g(3) * t52) * t30 + t47) - m(6) * (g(1) * (rSges(6,1) * t34 + rSges(6,2) * t35 + pkin(4) * t42 + t51) + (g(2) * t54 + g(3) * t48) * t31 + (-g(2) * t48 + g(3) * t54) * t30 + t47);
U = t1;
