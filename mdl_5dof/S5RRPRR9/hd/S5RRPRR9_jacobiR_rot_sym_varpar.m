...
function JR_rot = S5RRPRR9_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRR9_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRR9_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S5RRPRR9_jacobiR_rot_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t88 = -t92 * t101 + t100;
	t87 = t92 * t102 + t99;
	t1 = [t88, -t91 * t99, 0, t89, t89; t90, -t91 * t101, 0, -t87, -t87; 0, t92 * t94, 0, -t104, -t104; t87, t91 * t100, 0, -t90, -t90; t89, t91 * t102, 0, t88, t88; 0, -t92 * t93, 0, -t103, -t103; -t97 * t91, t98 * t92, 0, 0, 0; t98 * t91, t97 * t92, 0, 0, 0; 0, t91, 0, 0, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end