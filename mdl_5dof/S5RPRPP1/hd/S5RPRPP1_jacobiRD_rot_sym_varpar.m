...
function JRD_rot = S5RPRPP1_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPRPP1_jacobiRD_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'S5RPRPP1_jacobiRD_rot_sym_varpar: qJD has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPRPP1_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RPRPP1_jacobiRD_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t187 = qJD(3) * t182;
	t186 = qJD(3) * t183;
	t179 = -t181 * t188 + t182 * t189;
	t178 = -t180 * t189 - t181 * t187;
	t177 = -t180 * t186 - t182 * t190;
	t176 = t180 * t190 - t182 * t186;
	t1 = [-t179, 0, t176, 0, 0; t177, 0, t178, 0, 0; 0, 0, -t188, 0, 0; -t190, 0, 0, 0, 0; t189, 0, 0, 0, 0; 0, 0, 0, 0, 0; t178, 0, t177, 0, 0; -t176, 0, t179, 0, 0; 0, 0, t187, 0, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,5);
end