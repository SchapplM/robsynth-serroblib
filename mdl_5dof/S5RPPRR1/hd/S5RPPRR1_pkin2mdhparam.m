...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S5RPPRR1_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(7,1)}
assert(isreal(pkin) && all(size(pkin) == [7 1]), ...
  'S5RPPRR1_pkin2mdhparam: Kinematic parameters pkin have to be [7x1] (double)');
