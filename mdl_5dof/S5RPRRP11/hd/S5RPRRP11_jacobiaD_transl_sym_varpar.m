...
elseif link_index == 5
	...
	t267 = -pkin(3) + t271;
	t270 = t294 * t261 + t292 * t263;
	t296 = t270 * qJD(4) + qJD(5) * t261;
	t262 = sin(qJ(1));
	t291 = t262 * t261;
	t290 = t262 * t263;
	t264 = cos(qJ(1));
	...
	t274 = t258 * t288 + t291;
	t273 = t258 * t291 + t288;
	t272 = -pkin(3) * t258 - t295 * t257 - cos(pkin(8)) * pkin(2) - pkin(1);
	t269 = t261 * t281 + t263 * t287;
	t268 = t261 * t286 + t262 * t282;
	t266 = qJD(3) * t267;
	t265 = -t295 * qJD(3) - t296;
	t260 = -pkin(6) - qJ(2);
