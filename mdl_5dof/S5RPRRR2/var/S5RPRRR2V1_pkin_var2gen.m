% Umwandlung der Kinematikparameter von S5RPRRR2V1 zu S5RPRRR2
% Eingabe:
% pkin_var (6x1) double
...
%
% Siehe auch: S5RPRRR2_structural_kinematic_parameters.m
function pkin_gen = S5RPRRR2V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
