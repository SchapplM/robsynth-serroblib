...
%   see S5RRPPR3_invdynJ_fixb_regmin2vec.m
% MDP [17x1]
...
function tauJ = S5RRPPR3_invdynJ_fixb_mdp_slag_vr(RV, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(45,1), zeros(17,1)}
assert(isreal(MDP) && all(size(MDP) == [17 1]), ...
  'S5RRPPR3_invdynJ_fixb_mdp_slag_vr: MDP has to be [17x1] (double)'); 
