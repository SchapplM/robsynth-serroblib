...
function Ja = S5RRRRR2_jacobia_3_sym_varpar(qJ, r_i_i_C, ...
  pkin)

Ja_transl = S5RRRRR2_jacobia_transl_3_sym_varpar(qJ, r_i_i_C, ...
  pkin);
Ja_rot = S5RRRRR2_jacobia_rot_3_sym_varpar(qJ, ...
  pkin);
