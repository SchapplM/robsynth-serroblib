...
function JaD = S5RRRRR2_jacobiaD_0_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin)

JaD_transl = S5RRRRR2_jacobiaD_transl_0_sym_varpar(qJ, qJD, r_i_i_C, ...
  pkin);
JaD_rot = S5RRRRR2_jacobiaD_rot_0_sym_varpar(qJ, qJD, ...
  pkin);
