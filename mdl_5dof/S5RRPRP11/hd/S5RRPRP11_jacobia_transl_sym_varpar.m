...
function Ja_transl = S5RRPRP11_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRP11_jacobia_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RRPRP11_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRP11_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [7 1]), ...
  'S5RRPRP11_jacobia_transl_sym_varpar: pkin has to be [7x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t2 = t6 * t19 + t22;
	t1 = -t7 * t18 + t6 * t8;
	t5 = [t21 * t11 + t17 * t3 + t20 * t4 - t24 * t8, t12 * t11, t19, -t20 * t1 + t17 * t2, t1; t17 * t1 + t24 * t11 + t20 * t2 + t21 * t8, t12 * t8, t23, -t17 * t4 + t20 * t3, -t3; 0, t13 * t7 + t14, -t10, (-t17 * t6 - t20 * t9) * t10, t10 * t9;];
	Ja_transl = t5;
else
	Ja_transl=NaN(3,5);
end