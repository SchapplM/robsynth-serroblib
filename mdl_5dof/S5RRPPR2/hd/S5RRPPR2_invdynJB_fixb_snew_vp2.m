...
t563 = sin(qJ(1));
t566 = cos(qJ(1));
t543 = -t566 * g(2) - t563 * g(3);
t536 = qJDD(1) * pkin(1) + t543;
t542 = -t563 * g(2) + t566 * g(3);
t567 = qJD(1) ^ 2;
t537 = -t567 * pkin(1) + t542;
t562 = sin(qJ(2));
t565 = cos(qJ(2));
...
t463 = m(2) * t542 - t567 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t581;
t466 = t565 * t471 + t562 * t472;
t464 = m(2) * t543 + qJDD(1) * mrSges(2,1) - t567 * mrSges(2,2) + t466;
t587 = t563 * t463 + t566 * t464;
t484 = t557 * t489 + t559 * t496;
t482 = m(4) * t556 + t484;
t582 = -t566 * t463 + t563 * t464;
...
t568 = mrSges(2,1) * t543 - mrSges(2,2) * t542 + Ifges(2,3) * qJDD(1) + pkin(1) * t466 + t569;
...
t458 = -mrSges(3,2) * g(1) - mrSges(3,3) * t522 + Ifges(3,5) * t553 - t552 * Ifges(3,6) - qJ(3) * t474 + t560 * t459 - t558 * t467;
t457 = mrSges(3,1) * g(1) + mrSges(3,3) * t523 + t552 * Ifges(3,5) + Ifges(3,6) * t553 - pkin(2) * t482 + qJ(3) * t580 + t558 * t459 + t560 * t467;
t456 = -mrSges(2,2) * g(1) - mrSges(2,3) * t543 + Ifges(2,5) * qJDD(1) - t567 * Ifges(2,6) - pkin(6) * t466 - t562 * t457 + t565 * t458;
t455 = Ifges(2,6) * qJDD(1) + t567 * Ifges(2,5) + mrSges(2,1) * g(1) + mrSges(2,3) * t542 + t562 * t458 + t565 * t457 - pkin(1) * (-m(3) * g(1) + t482) + pkin(6) * t581;
t1 = [(-m(1) - m(2) - m(3)) * g(1) + t482; -m(1) * g(2) + t587; -m(1) * g(3) + t582; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t568; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) - pkin(5) * t582 + t566 * t455 + t563 * t456; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + pkin(5) * t587 + t563 * t455 - t566 * t456; t568; t569; t482; t491; t574 * t593 + t570;];
tauJB = t1;
