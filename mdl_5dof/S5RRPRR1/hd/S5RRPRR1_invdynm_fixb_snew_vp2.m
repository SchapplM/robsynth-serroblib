...
% OptimizationMode: 2
% StartTime: 2019-12-05 18:23:58
% EndTime: 2019-12-05 18:24:07
...
t180 = -qJD(4) * t208 - t220 * t244 + t221 * t248;
t207 = (t244 * t245 - t248 * t249) * qJD(1);
t190 = mrSges(5,1) * t207 + mrSges(5,2) * t208;
t236 = qJD(2) + qJD(4);
t194 = mrSges(5,1) * t236 - mrSges(5,3) * t208;
t235 = qJDD(2) + qJDD(4);
t153 = (t207 * t208 + t235) * pkin(4) + t157;
t227 = t246 * g(1) - t250 * g(2);
t260 = t223 * t269 + qJDD(3) - t227;
t166 = t278 * t221 + t226 * t269 + t276 * t275 + t260;
t181 = -qJD(4) * t207 + t220 * t248 + t221 * t244;
t158 = (t207 * t236 - t181) * pkin(4) + t166;
t243 = sin(qJ(5));
t247 = cos(qJ(5));
t151 = -t153 * t243 + t158 * t247;
t191 = -t208 * t243 + t236 * t247;
t162 = t191 * qJD(5) + t181 * t247 + t235 * t243;
t192 = t208 * t247 + t236 * t243;
t171 = -mrSges(6,1) * t191 + mrSges(6,2) * t192;
t179 = qJDD(5) - t180;
t200 = qJD(5) + t207;
t182 = -mrSges(6,2) * t200 + mrSges(6,3) * t191;
t149 = m(6) * t151 + mrSges(6,1) * t179 - mrSges(6,3) * t162 - t171 * t192 + t182 * t200;
t152 = t153 * t247 + t158 * t243;
t161 = -t192 * qJD(5) - t181 * t243 + t235 * t247;
t183 = mrSges(6,1) * t200 - mrSges(6,3) * t192;
t150 = m(6) * t152 - mrSges(6,2) * t179 + mrSges(6,3) * t161 + t171 * t191 - t183 * t200;
t263 = -t149 * t243 + t247 * t150;
t135 = m(5) * t157 - mrSges(5,2) * t235 + t180 * mrSges(5,3) - t190 * t207 - t194 * t236 + t263;
t156 = t248 * t163 - t244 * t164;
t154 = (-t208 ^ 2 - t236 ^ 2) * pkin(4) - t156;
t193 = -mrSges(5,2) * t236 - mrSges(5,3) * t207;
t145 = m(5) * t156 - m(6) * t154 + mrSges(5,1) * t235 + t161 * mrSges(6,1) - t162 * mrSges(6,2) - t181 * mrSges(5,3) + t191 * t182 - t192 * t183 - t190 * t208 + t193 * t236;
...
t128 = m(4) * t174 + qJDD(2) * mrSges(4,1) - mrSges(4,3) * t220 + qJD(2) * t225 - t219 * t269 + t131;
t198 = -t273 - t277;
...
t142 = -mrSges(6,1) * t154 + mrSges(6,3) * t152 + Ifges(6,4) * t162 + Ifges(6,2) * t161 + Ifges(6,6) * t179 - t167 * t192 + t169 * t200;
t168 = Ifges(6,4) * t192 + Ifges(6,2) * t191 + Ifges(6,6) * t200;
t143 = mrSges(6,2) * t154 - mrSges(6,3) * t151 + Ifges(6,1) * t162 + Ifges(6,4) * t161 + Ifges(6,5) * t179 + t167 * t191 - t168 * t200;
...
t136 = -mrSges(5,1) * t166 + mrSges(5,3) * t157 + Ifges(5,4) * t181 + Ifges(5,2) * t180 + Ifges(5,6) * t235 - t186 * t208 + t188 * t236 - t254;
...
t121 = t257 + Ifges(3,6) * qJDD(2) + ((pkin(1) * t225 + qJ(3) * t219) * t249 + (-pkin(1) * t224 - t201 - t202) * t245) * qJD(1) - pkin(1) * (m(4) * t185 - t221 * mrSges(4,1) + t220 * mrSges(4,2) + t137) + qJ(3) * (m(4) * t175 - qJDD(2) * mrSges(4,2) + mrSges(4,3) * t221 - qJD(2) * t224 + t264) + mrSges(3,3) * t199 + qJD(2) * t206 + Ifges(3,4) * t220 + Ifges(3,2) * t221 + mrSges(3,1) * t227;
...
t123 = t255 + Ifges(3,5) * qJDD(2) + (-t203 - t204) * qJD(2) + t202 * t268 - qJ(3) * t128 - mrSges(3,3) * t198 + Ifges(3,1) * t220 + Ifges(3,4) * t221 - mrSges(3,2) * t227;
...
t119 = -mrSges(2,2) * g(3) - mrSges(2,3) * t227 + Ifges(2,5) * qJDD(1) - Ifges(2,6) * t251 - t121 * t245 + t123 * t249;
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t119 * t250 - t124 * t246, t119, t123, -qJD(2) * t203 + t255, t127, t143; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + t119 * t246 + t124 * t250, t124, t121, -t201 * t269 + t257, t136, t142; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t259, t259, t280, -t205 * t268 - t253, -t256, t254;];
m_new = t1;
