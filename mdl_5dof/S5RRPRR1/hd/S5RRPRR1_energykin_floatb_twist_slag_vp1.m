...
t170 = sin(qJ(1));
t173 = cos(qJ(1));
t232 = t235 * t170 - t173 * t236;
t231 = t170 * t236 + t235 * t173;
...
t181 = (Icges(5,5) * t163 + Icges(5,6) * t164) * t159 + (-Icges(5,3) * t173 + t170 * t184) * t131 + (Icges(5,3) * t170 + t173 * t184) * t132;
...
t64 = -t101 * t91 + t139 * t80 + (t164 * t132 + t159 * t208) * pkin(4) + t178;
t63 = -t100 * t80 + t101 * t79 + (-t173 * t131 + t170 * t132) * t163 * pkin(4) + t182;
t1 = m(1) * (t136 ^ 2 + t137 ^ 2 + t138 ^ 2) / 0.2e1 + m(2) * (t102 ^ 2 + t103 ^ 2 + t85 ^ 2) / 0.2e1 + m(3) * (t72 ^ 2 + t81 ^ 2 + t82 ^ 2) / 0.2e1 + m(4) * (t69 ^ 2 + t70 ^ 2 + t71 ^ 2) / 0.2e1 + m(5) * (t66 ^ 2 + t67 ^ 2 + t68 ^ 2) / 0.2e1 + t132 * (t181 * t170 + t177 * t173) / 0.2e1 + t131 * (t177 * t170 - t181 * t173) / 0.2e1 + m(6) * (t63 ^ 2 + t64 ^ 2 + t65 ^ 2) / 0.2e1 + t101 * ((t125 * t76 + t126 * t78 + t74 * t208) * t101 + (t125 * t75 + t126 * t77 + t208 * t73) * t100 + (t125 * t89 + t126 * t90 + t208 * t88) * t139) / 0.2e1 + t100 * ((t123 * t76 + t124 * t78 + t209 * t74) * t101 + (t123 * t75 + t124 * t77 + t73 * t209) * t100 + (t123 * t89 + t124 * t90 + t209 * t88) * t139) / 0.2e1 + t139 * ((-t73 * t100 - t74 * t101 - t88 * t139) * t164 + ((-t168 * t76 + t171 * t78) * t101 + (-t168 * t75 + t171 * t77) * t100 + (-t168 * t89 + t171 * t90) * t139) * t163) / 0.2e1 + (t170 * t225 - t224 * t173) * t157 / 0.2e1 + (t224 * t170 + t173 * t225) * t158 / 0.2e1 + ((-t147 * t170 + t151 * t173 + Icges(1,4)) * V_base(5) + (-t148 * t170 + t152 * t173 + Icges(1,1)) * V_base(4)) * V_base(4) / 0.2e1 + ((t147 * t173 + t151 * t170 + Icges(1,2)) * V_base(5) + (t148 * t173 + t152 * t170 + Icges(1,4)) * V_base(4)) * V_base(5) / 0.2e1 + ((t163 * t97 + t164 * t95) * t132 + (t163 * t96 + t164 * t94) * t131 + (t229 * t169 + t231 * t172) * t158 + (t230 * t169 + t232 * t172) * t157 + (t128 * t164 + t129 * t163 + t227 * t169 + t228 * t172 + Icges(2,3)) * t159) * t159 / 0.2e1 + t159 * V_base(4) * (Icges(2,5) * t173 - Icges(2,6) * t170) + t159 * V_base(5) * (Icges(2,5) * t170 + Icges(2,6) * t173) + (Icges(1,5) * V_base(4) + Icges(1,6) * V_base(5) + Icges(1,3) * V_base(6) / 0.2e1) * V_base(6);
T = t1;
