...
t8 = cos(t16);
t6 = sin(t16);
t1 = -m(1) * (g(1) * (r_base(1) + rSges(1,1)) + g(2) * (r_base(2) + rSges(1,2)) + g(3) * (r_base(3) + rSges(1,3))) - m(2) * (g(1) * (t21 * rSges(2,1) - t19 * rSges(2,2) + r_base(1)) + g(2) * (t19 * rSges(2,1) + t21 * rSges(2,2) + r_base(2)) + g(3) * (rSges(2,3) + t30)) - m(3) * (g(1) * (t8 * rSges(3,1) - t6 * rSges(3,2) + t28) + g(2) * (t6 * rSges(3,1) + t8 * rSges(3,2) + t29) + g(3) * (rSges(3,3) + t27)) - m(4) * (g(3) * (t18 * rSges(4,1) + t20 * rSges(4,2) + t27) + (g(1) * t23 - g(2) * t33) * t8 + (g(1) * t33 + g(2) * t23) * t6 + t22) - m(5) * (g(3) * (t5 * rSges(5,1) + t7 * rSges(5,2) + t26) + (g(1) * t25 - g(2) * t32) * t8 + (g(1) * t32 + g(2) * t25) * t6 + t22) - m(6) * (g(3) * (t2 * rSges(6,1) + t3 * rSges(6,2) + pkin(4) * t5 + t26) + (g(1) * t24 - g(2) * t31) * t8 + (g(1) * t31 + g(2) * t24) * t6 + t22);
U = t1;
