...
t210 = sin(qJ(1));
t211 = cos(qJ(1));
t170 = g(1) * t211 + g(2) * t210;
t132 = -pkin(1) * t212 - t170;
t157 = sin(pkin(8));
t159 = cos(pkin(8));
t169 = g(1) * t210 - g(2) * t211;
t167 = qJDD(1) * pkin(1) + t169;
