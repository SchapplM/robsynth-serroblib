...
elseif link_index == 4
	...
	% Computational Cost: add. (50->15), mult. (33->14), div. (0->0), fcn. (35->8), ass. (0->11)
	t7 = qJ(3) + pkin(9);
	t2 = sin(t7);
	t4 = cos(t7);
...
elseif link_index == 5
	...
	% Computational Cost: add. (91->19), mult. (48->18), div. (0->0), fcn. (50->10), ass. (0->15)
	t14 = qJ(3) + pkin(9);
	t11 = qJ(5) + t14;
	t7 = sin(t11);
	t8 = cos(t11);
	...
	t1 = [0, 1, t26, 0, t18; cos(qJ(1)) * pkin(1) + t20 * t9 + t16 * t10, 0, (-t25 + t4) * t9, -t10, -t25 * t9; sin(qJ(1)) * pkin(1) - t20 * t10 + t16 * t9, 0, -t10 * t4 + t21, -t9, t21;];
	Ja_transl = t1;
else
	Ja_transl=NaN(3,5);
end