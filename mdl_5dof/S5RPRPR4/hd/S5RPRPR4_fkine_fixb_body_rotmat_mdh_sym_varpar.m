...
elseif link_index == 3
	...
	t43 = cos(t44);
	t42 = sin(t44);
	t1 = [t43 * t46, -t43 * t45, t42, t43 * pkin(2) + t42 * pkin(6) + cos(qJ(1)) * pkin(1) + 0; t42 * t46, -t42 * t45, -t43, t42 * pkin(2) - t43 * pkin(6) + sin(qJ(1)) * pkin(1) + 0; t45, t46, 0, qJ(2) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 4
	...
	t1 = [t51 * t50, -t51 * t48, t49, t51 * t47 - t49 * t54 + cos(qJ(1)) * pkin(1) + 0; t49 * t50, -t49 * t48, -t51, t49 * t47 + t51 * t54 + sin(qJ(1)) * pkin(1) + 0; t48, t50, 0, sin(qJ(3)) * pkin(3) + qJ(2) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 5
	...
	t1 = [t59 * t57, -t59 * t56, t58, t59 * t55 + t61 * t58 + cos(qJ(1)) * pkin(1) + 0; t58 * t57, -t58 * t56, -t59, t58 * t55 - t59 * t61 + sin(qJ(1)) * pkin(1) + 0; t56, t57, 0, pkin(4) * sin(t62) + sin(qJ(3)) * pkin(3) + qJ(2) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
end