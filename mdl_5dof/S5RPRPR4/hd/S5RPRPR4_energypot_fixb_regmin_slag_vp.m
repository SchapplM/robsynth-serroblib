...
% OptimizationMode: 2
% StartTime: 2022-01-23 09:23:09
% EndTime: 2022-01-23 09:23:09
...
t59 = cos(t65);
t58 = sin(t65);
t1 = [0, t73, g(1) * t70 - g(2) * t72, t73 * pkin(1) - g(3) * t75, 0, 0, 0, 0, 0, -g(3) * t69 - t74 * t71, -g(3) * t71 + t74 * t69, -g(3) * t61 - t74 * t63, -g(3) * t63 + t74 * t61, -g(1) * t62 + g(2) * t64, -g(1) * (t72 * pkin(1) + t64 * t60 - t62 * t68) - g(2) * (t70 * pkin(1) + t62 * t60 + t64 * t68) - g(3) * (t69 * pkin(3) + t75), 0, 0, 0, 0, 0, -g(3) * t58 - t74 * t59, -g(3) * t59 + t74 * t58;];
U_reg = t1;
