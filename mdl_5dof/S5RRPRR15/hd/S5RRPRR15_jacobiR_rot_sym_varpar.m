...
function JR_rot = S5RRPRR15_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRR15_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRR15_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRPRR15_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t79 = t83 * t91 + t87 * t84;
	t78 = -t87 * t83 + t84 * t91;
	t1 = [t81, t83 * t90, 0, t78, t78; t79, t87 * t82, 0, t80, t80; 0, t86 * t83, 0, -t92, -t92; -t80, t84 * t90, 0, -t79, -t79; t78, t87 * t92, 0, t81, t81; 0, t86 * t84, 0, t82, t82; -t87 * t88, -t91, 0, 0, 0; t90, -t93, 0, 0, 0; 0, t88, 0, 0, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end