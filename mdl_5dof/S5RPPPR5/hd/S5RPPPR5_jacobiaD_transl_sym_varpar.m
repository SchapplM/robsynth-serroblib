...
elseif link_index == 3
	...
	t1 = [-t52 * r_i_i_C(1) + t53 * r_i_i_C(2) + t57 * qJD(2) + (-qJ(2) * t56 + t58 * t57) * qJD(1), qJD(1) * t57, 0, 0, 0; t53 * r_i_i_C(1) + t52 * r_i_i_C(2) + t56 * qJD(2) + (qJ(2) * t57 + t58 * t56) * qJD(1), qJD(1) * t56, 0, 0, 0; 0, 0, 0, 0, 0;];
	JaD_transl = t1;
elseif link_index == 4
	%% Symbolic Calculation
...
elseif link_index == 5
	...
	t45 = t46 * qJD(1);
	t44 = t47 * qJD(1);
	t1 = [t57 * qJD(2) - t47 * qJD(4) + t63 * t45 - t46 * t58 - t59 * t44 + (-qJ(2) * t56 + t64 * t57) * qJD(1), qJD(1) * t57, 0, -t44, (-t45 * t51 + t47 * t62) * r_i_i_C(2) + (-t45 * t50 - t47 * t61) * r_i_i_C(1); t56 * qJD(2) + t46 * qJD(4) + t63 * t44 - t47 * t58 + t59 * t45 + (qJ(2) * t57 + t64 * t56) * qJD(1), qJD(1) * t56, 0, t45, (-t44 * t51 - t46 * t62) * r_i_i_C(2) + (-t44 * t50 + t46 * t61) * r_i_i_C(1); 0, 0, 0, 0, t58;];
	JaD_transl = t1;
else
	JaD_transl=NaN(3,5);
end