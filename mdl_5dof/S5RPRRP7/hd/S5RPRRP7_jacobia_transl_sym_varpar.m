...
function Ja_transl = S5RPRRP7_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPRRP7_jacobia_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RPRRP7_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPRRP7_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RPRRP7_jacobia_transl_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t2 = -t8 * t10 + t7 * t18;
	t1 = t8 * t12 + t7 * t19;
	t5 = [-sin(qJ(1)) * pkin(1) + t8 * pkin(6) - t21 * t2 - t17 * t1 - t23 * t7, 0, t14 * t8, t17 * t4 - t21 * t3, t3; cos(qJ(1)) * pkin(1) + t7 * pkin(6) + t21 * t4 + t17 * t3 + t23 * t8, 0, t14 * t7, -t21 * t1 + t17 * t2, t1; 0, 1, t22 * t13 + t16, (-t21 * t10 + t17 * t12) * t11, t11 * t10;];
	Ja_transl = t5;
else
	Ja_transl=NaN(3,5);
end