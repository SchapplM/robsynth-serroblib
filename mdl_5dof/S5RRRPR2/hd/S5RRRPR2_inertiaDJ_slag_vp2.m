...
t23 = t43 * t36;
t9 = pkin(8) + t11;
t12 = [-0.2e1 * t79 - 0.2e1 * t85 + 0.2e1 * t1 + 0.2e1 * t13 + 0.2e1 * t2 + 0.2e1 * t3 - 0.2e1 * t4 - 0.2e1 * t7 + 0.2e1 * t61 + (-t10 * t5 + t11 * t6) * t88 + (t8 * t5 + t9 * t66) * t87 + 0.2e1 * m(4) * (t32 * t14 + t31 * t15) + t62; t59 + (m(4) * (t14 * t54 + t15 * t57 - t31 * t70 + t32 * t69) - mrSges(4,1) * t70 - mrSges(4,2) * t69) * pkin(2) + m(6) * (t24 * t5 + t25 * t66 + t26 * t8 + t9 * t65) + t61 + m(5) * (-t26 * t10 + t27 * t11 - t29 * t5 + t30 * t6) + (-t27 - t6) * mrSges(5,2) + t89; -0.2e1 * t78 - 0.2e1 * t16 + 0.2e1 * t17 + 0.2e1 * t18 + 0.2e1 * t19 - 0.2e1 * t22 + 0.2e1 * t60 + (t24 * t26 + t25 * t65) * t87 + (-t29 * t26 + t30 * t27) * t88 + t62; t59 + m(6) * (t43 * t5 + t6 * t64) + (-t5 * t52 + t51 * t6) * t86 - t23 - t85; -t78 - t23 + t60 + m(6) * (t43 * t26 + t27 * t64) + (-t26 * t52 + t27 * t51) * t86 + t62 + t89; -0.2e1 * t23 + t62; 0; 0; 0; 0; t48 + t63 * t6 + (-t9 * t73 + (mrSges(6,2) * t9 - Ifges(6,6)) * t53) * qJD(5); t48 + t63 * t27 + (t37 * t25 - t80) * qJD(5); t48 + (t37 * t42 - t80) * qJD(5); t36; 0;];
