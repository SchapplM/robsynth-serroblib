...
if link_index == 0
	...
	% OptimizationMode: 2
	% StartTime: 2020-11-04 20:42:06
	% EndTime: 2020-11-04 20:42:06
...
elseif link_index == 3
	...
	t43 = cos(t44);
	t42 = sin(t44);
	t1 = [0, 0, 1, pkin(7) + pkin(6) + pkin(5) + 0; t42, t43, 0, pkin(2) * sin(t45) + sin(qJ(1)) * pkin(1) + 0; -t43, t42, 0, -pkin(2) * cos(t45) - cos(qJ(1)) * pkin(1) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 4
	...
	t47 = cos(t48);
	t46 = sin(t48);
	t1 = [0, 0, 1, qJ(4) + pkin(7) + pkin(6) + pkin(5) + 0; t46, t47, 0, pkin(3) * sin(t49) + pkin(2) * sin(t50) + sin(qJ(1)) * pkin(1) + 0; -t47, t46, 0, -pkin(3) * cos(t49) - pkin(2) * cos(t50) - cos(qJ(1)) * pkin(1) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 5
	...
	t52 = cos(t53);
	t51 = sin(t53);
	t1 = [t56, t57, 0, qJ(4) + pkin(7) + pkin(6) + pkin(5) + 0; t51 * t57, -t51 * t56, -t52, t51 * pkin(4) - t52 * pkin(8) + pkin(3) * sin(t54) + pkin(2) * sin(t55) + sin(qJ(1)) * pkin(1) + 0; -t52 * t57, t52 * t56, -t51, -t52 * pkin(4) - t51 * pkin(8) - pkin(3) * cos(t54) - pkin(2) * cos(t55) - cos(qJ(1)) * pkin(1) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
end