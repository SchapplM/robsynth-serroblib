...
t42 = cos(t46);
t50 = cos(qJ(1));
t57 = t50 * pkin(1) + pkin(2) * t42;
t44 = qJ(3) + t46;
t40 = cos(t44);
t55 = pkin(3) * t40 + t57;
t41 = sin(t46);
t48 = sin(qJ(1));
t54 = -t48 * pkin(1) - pkin(2) * t41;
t38 = pkin(9) + t44;
t34 = sin(t38);
t35 = cos(t38);
t53 = g(2) * t34 - g(3) * t35;
...
t47 = sin(qJ(5));
t33 = g(2) * t35 + g(3) * t34;
t1 = [0, 0, 0, 0, 0, 0, t52, g(2) * t50 + g(3) * t48, -g(1), -g(1) * pkin(5), 0, 0, 0, 0, 0, 0, g(2) * t41 - g(3) * t42, g(2) * t42 + g(3) * t41, -g(1), t52 * pkin(1) - g(1) * t59, 0, 0, 0, 0, 0, 0, g(2) * t39 - g(3) * t40, g(2) * t40 + g(3) * t39, -g(1), -g(1) * t56 - g(2) * t54 - g(3) * t57, 0, 0, 0, 0, 0, 0, t53, t33, -g(1), -g(2) * t51 - g(3) * t55 - t58, 0, 0, 0, 0, 0, 0, -g(1) * t47 + t53 * t49, -g(1) * t49 - t53 * t47, -t33, -t58 - g(2) * (-t34 * pkin(4) + t35 * pkin(8) + t51) - g(3) * (t35 * pkin(4) + t34 * pkin(8) + t55);];
U_reg = t1;
