...
t2 = cos(t6);
t1 = sin(t6);
t3 = (-m(3) * t22 - m(4) * t20 + mrSges(2,1) * t17 + t10 * mrSges(3,1) + t8 * mrSges(4,1) - t15 * mrSges(2,2) - t9 * mrSges(3,2) - t7 * mrSges(4,2) - mrSges(1,3) + t31 * r_base(3) + t29 * t2 + t30 * (-pkin(3) * t8 + t20) + t28 * t1) * g(3) + (-m(3) * t26 - m(4) * t24 - t15 * mrSges(2,1) - t9 * mrSges(3,1) - t7 * mrSges(4,1) - mrSges(2,2) * t17 - t10 * mrSges(3,2) - t8 * mrSges(4,2) - mrSges(1,2) + t31 * r_base(2) + t30 * (pkin(3) * t7 + t24) + t28 * t2 - t29 * t1) * g(2) + (-m(1) * r_base(1) - m(2) * t27 - m(3) * t25 - m(4) * t23 - mrSges(6,1) * t14 - mrSges(6,2) * t16 - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) - mrSges(5,3) + t30 * (qJ(4) + t23)) * g(1);
U = t3;
