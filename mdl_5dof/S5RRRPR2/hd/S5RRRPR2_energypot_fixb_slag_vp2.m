...
t33 = cos(t36);
t32 = sin(t36);
t1 = (m(3) * t55 - m(4) * t51 + t48 * mrSges(2,1) + t40 * mrSges(3,1) + t38 * mrSges(4,1) - t46 * mrSges(2,2) - t39 * mrSges(3,2) - t37 * mrSges(4,2) - mrSges(1,3) + t59 * (-pkin(3) * t38 + t51) + t58 * t33 + t57 * t32) * g(3) + (-m(3) * t43 - m(4) * t54 - t46 * mrSges(2,1) - t39 * mrSges(3,1) - t37 * mrSges(4,1) - t48 * mrSges(2,2) - t40 * mrSges(3,2) - t38 * mrSges(4,2) - mrSges(1,2) + t59 * (pkin(3) * t37 + t54) + t57 * t33 - t58 * t32) * g(2) + (-m(2) * pkin(5) - m(3) * t56 - m(4) * t53 - t45 * mrSges(6,1) - t47 * mrSges(6,2) - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) - mrSges(5,3) + t59 * (qJ(4) + t53)) * g(1);
U = t1;
