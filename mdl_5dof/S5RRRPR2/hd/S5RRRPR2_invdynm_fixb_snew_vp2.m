...
t172 = sin(qJ(1));
t176 = cos(qJ(1));
t152 = t172 * g(1) - t176 * g(2);
t149 = qJDD(1) * pkin(1) + t152;
t153 = -t176 * g(1) - t172 * g(2);
t177 = qJD(1) ^ 2;
t150 = -t177 * pkin(1) + t153;
t171 = sin(qJ(2));
t175 = cos(qJ(2));
...
t178 = mrSges(2,1) * t152 - mrSges(2,2) * t153 + Ifges(2,3) * qJDD(1) + pkin(1) * t78 + t179;
...
t80 = -mrSges(4,2) * g(3) - mrSges(4,3) * t126 + Ifges(4,5) * t158 - t157 * Ifges(4,6) - qJ(4) * t96 - t167 * t94 + t168 * t88;
t79 = mrSges(4,1) * g(3) + mrSges(4,3) * t127 + t157 * Ifges(4,5) + Ifges(4,6) * t158 - pkin(3) * t189 + qJ(4) * t186 + t167 * t88 + t168 * t94;
t76 = m(2) * t153 - t177 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t187;
t75 = m(2) * t152 + qJDD(1) * mrSges(2,1) - t177 * mrSges(2,2) + t78;
t74 = -mrSges(3,2) * g(3) - mrSges(3,3) * t134 + Ifges(3,5) * t163 - t162 * Ifges(3,6) - pkin(7) * t87 - t170 * t79 + t174 * t80;
t73 = Ifges(3,6) * t163 + t162 * Ifges(3,5) + mrSges(3,1) * g(3) + mrSges(3,3) * t135 + t170 * t80 + t174 * t79 - pkin(2) * (-m(4) * g(3) + t189) + pkin(7) * t188;
t72 = -mrSges(2,2) * g(3) - mrSges(2,3) * t152 + Ifges(2,5) * qJDD(1) - t177 * Ifges(2,6) - pkin(6) * t78 - t171 * t73 + t175 * t74;
t71 = Ifges(2,6) * qJDD(1) + t177 * Ifges(2,5) + mrSges(2,3) * t153 + t171 * t74 + t175 * t73 - pkin(1) * t189 + pkin(6) * t187 + (mrSges(2,1) - pkin(1) * (-m(3) - m(4))) * g(3);
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t176 * t72 - t172 * t71 - pkin(5) * (t172 * t76 + t176 * t75), t72, t74, t80, t88, t105; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + t172 * t72 + t176 * t71 + pkin(5) * (-t172 * t75 + t176 * t76), t71, t73, t79, t94, t104; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t178, t178, t179, t180, t183, t193;];
m_new = t1;
