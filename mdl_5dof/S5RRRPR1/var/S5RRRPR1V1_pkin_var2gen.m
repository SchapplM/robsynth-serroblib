% Umwandlung der Kinematikparameter von S5RRRPR1V1 zu S5RRRPR1
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S5RRRPR1_structural_kinematic_parameters.m
function pkin_gen = S5RRRPR1V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
