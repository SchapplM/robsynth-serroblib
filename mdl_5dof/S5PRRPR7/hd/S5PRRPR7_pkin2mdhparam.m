...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S5PRRPR7_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(10,1)}
assert(isreal(pkin) && all(size(pkin) == [10 1]), ...
  'S5PRRPR7_pkin2mdhparam: Kinematic parameters pkin have to be [10x1] (double)');
...
t1 = [pkin(9); 0; 0; pkin(10); 0;];
theta_mdh = t1;

% Aus parameters_mdh_d_matlab.m
t1 = [0; pkin(6); pkin(7); 0; pkin(8);];
d_mdh = t1;
