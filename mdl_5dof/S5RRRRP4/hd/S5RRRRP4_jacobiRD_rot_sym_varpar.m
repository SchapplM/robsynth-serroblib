...
function JRD_rot = S5RRRRP4_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP4_jacobiRD_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'S5RRRRP4_jacobiRD_rot_sym_varpar: qJD has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP4_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRRRP4_jacobiRD_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t262 = cos(t266);
	t258 = t264 * t262;
	t254 = t261 * t258 - t260 * t268;
	t253 = -t260 * t257 - t259 * t258;
	t252 = -t261 * t267 - t262 * t268;
	t251 = -t262 * t257 + t259 * t267;
	t1 = [-t254, -t254, t251, t251, 0; t252, t252, t253, t253, 0; 0, 0, -t268, -t268, 0; -t267, -t267, 0, 0, 0; t258, t258, 0, 0, 0; 0, 0, 0, 0, 0; t253, t253, t252, t252, 0; -t251, -t251, t254, t254, 0; 0, 0, t257, t257, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,5);
end