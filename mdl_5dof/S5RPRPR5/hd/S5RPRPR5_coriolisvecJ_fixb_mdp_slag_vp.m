...
% OptimizationMode: 2
% StartTime: 2021-01-15 11:55:21
% EndTime: 2021-01-15 11:55:30
% DurationCPUTime: 3.00s
% Computational Cost: add. (1863->254), mult. (5179->368), div. (0->0), fcn. (3720->8), ass. (0->134)
t313 = cos(pkin(9));
t312 = sin(pkin(8));
t318 = cos(qJ(3));
t356 = qJD(3) * t318;
...
t371 = t314 * t316;
t377 = qJ(4) * t312;
t324 = -qJ(2) * t371 - t318 * t377;
t249 = qJD(1) * t324 + t277;
t240 = pkin(3) * t396 + t249;
t378 = qJ(2) * t318;
t350 = t314 * t378;
t250 = -qJ(4) * t348 + qJD(1) * t350 + t281 * t316;
t372 = t313 * t250;
t217 = t311 * t240 + t372;
t382 = pkin(7) * t268;
t206 = t217 - t382;
