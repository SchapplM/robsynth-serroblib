...
% OptimizationMode: 2
% StartTime: 2019-12-05 17:56:05
% EndTime: 2019-12-05 17:56:23
% DurationCPUTime: 8.30s
% Computational Cost: add. (113962->288), mult. (293736->378), div. (0->0), fcn. (200705->10), ass. (0->125)
t264 = sin(qJ(1));
t267 = cos(qJ(1));
t243 = t264 * g(2) - t267 * g(3);
t268 = qJD(1) ^ 2;
t302 = -t268 * pkin(1) + qJDD(1) * qJ(2) + (2 * qJD(1) * qJD(2)) + t243;
t259 = sin(pkin(8));
t261 = cos(pkin(8));
t210 = -t261 * g(1) - t302 * t259;
t297 = qJD(1) * t259;
t295 = t261 * qJD(1);
t211 = -t259 * g(1) + t302 * t261;
t284 = -pkin(2) * t261 - pkin(6) * t259;
t238 = t284 * qJD(1);
t198 = t238 * t295 + t211;
t244 = t267 * g(2) + t264 * g(3);
t277 = -t268 * qJ(2) + qJDD(2) - t244;
...
t122 = -t269 + Ifges(3,2) * t292 + (Ifges(3,4) * qJDD(1) + (-t235 - t280) * qJD(1)) * t259 - mrSges(3,1) * t232 + mrSges(3,3) * t211 - pkin(2) * t132;
t274 = -m(3) * t232 + mrSges(3,1) * t292 - t132 + (t261 ^ 2 * t268 + t299) * mrSges(3,3);
t276 = -mrSges(2,2) * t243 + qJ(2) * t287 + t259 * t120 + t261 * t122 + pkin(1) * (-qJDD(1) * t300 + t274) + mrSges(2,1) * t244 + Ifges(2,3) * qJDD(1);
t128 = m(2) * t244 - t268 * mrSges(2,2) + (mrSges(2,1) - t300) * qJDD(1) + t274;
t127 = t259 * t130 + t261 * t152;
t125 = m(2) * t243 - t268 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t287;
t118 = mrSges(2,1) * g(1) + mrSges(2,3) * t243 + t268 * Ifges(2,5) - pkin(1) * t127 + (Ifges(2,6) - t282) * qJDD(1) + t301;
t117 = -mrSges(2,2) * g(1) - mrSges(2,3) * t244 + Ifges(2,5) * qJDD(1) - t268 * Ifges(2,6) - qJ(2) * t127 + t261 * t120 - t259 * t122;
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t276, t117, t120, t124, t135, t148; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) - t264 * t117 - t267 * t118 - pkin(5) * (t267 * t125 - t264 * t128), t118, t122, t123, t134, t147; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t267 * t117 - t264 * t118 + pkin(5) * (-t264 * t125 - t267 * t128), t276, t282 * qJDD(1) - t301, t280 * t297 + t269, -t270, -t275;];
m_new = t1;
