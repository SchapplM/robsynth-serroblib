...
t86 = cos(qJ(1));
t96 = -t86 * g(1) - t83 * g(2);
t63 = -t87 * pkin(1) + qJDD(1) * qJ(2) + t96;
t112 = -t80 * g(3) - t78 * t63;
...
t50 = t51 ^ 2;
t91 = t18 * mrSges(6,1) + t33 * t29 - m(6) * (-t39 * pkin(4) - t50 * pkin(7) + t52 * t43 + t90) - t19 * mrSges(6,2) - t34 * t30;
t89 = -m(5) * t90 + t39 * mrSges(5,1) - t40 * mrSges(5,2) + t51 * t41 - t52 * t42 + t91;
...
t99 = -t78 * g(3) + (t102 + t63) * t80;
t36 = t65 * t109 + t99;
t100 = t83 * g(1) - t86 * g(2);
t92 = -t87 * qJ(2) + qJDD(2) - t100;
t46 = (-pkin(1) + t97) * qJDD(1) + t92;
t45 = t85 * t46;
...
t115 = t80 * t10 + t78 * t4;
t93 = m(3) * (-qJDD(1) * pkin(1) + t92) + t85 * t5 + t82 * t6;
t2 = m(2) * t100 + (-mrSges(2,2) + t116) * t87 + (mrSges(2,1) - t95) * qJDD(1) - t93;
t1 = m(2) * t96 - t87 * mrSges(2,1) - qJDD(1) * mrSges(2,2) - t78 * t10 + t80 * t4;
t3 = [-m(1) * g(1) + t86 * t1 - t83 * t2, t1, t4, t6, t8, t12; -m(1) * g(2) + t83 * t1 + t86 * t2, t2, t10, t5, t7, t11; (-m(1) - m(2)) * g(3) + t115, -m(2) * g(3) + t115, t95 * qJDD(1) - t87 * t116 + t93, t94 * t110 + t88, -t89, -t91;];
f_new = t3;
