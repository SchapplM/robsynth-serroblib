...
% OptimizationMode: 2
% StartTime: 2022-01-23 09:25:17
% EndTime: 2022-01-23 09:25:20
% DurationCPUTime: 2.41s
% Computational Cost: add. (15870->240), mult. (40702->322), div. (0->0), fcn. (27700->10), ass. (0->105)
t417 = qJD(1) ^ 2;
t413 = sin(qJ(1));
t416 = cos(qJ(1));
t424 = -g(1) * t416 - g(2) * t413;
t443 = -pkin(1) * t417 + qJDD(1) * qJ(2) + (2 * qJD(1) * qJD(2)) + t424;
t408 = sin(pkin(8));
t410 = cos(pkin(8));
t370 = -t410 * g(3) - t443 * t408;
t371 = -g(3) * t408 + t443 * t410;
t425 = -t410 * pkin(2) - t408 * pkin(6);
t395 = t425 * qJD(1);
t438 = qJD(1) * t410;
t361 = t395 * t438 + t371;
t428 = g(1) * t413 - t416 * g(2);
t421 = -qJ(2) * t417 + qJDD(2) - t428;
t372 = (-pkin(1) + t425) * qJDD(1) + t421;
t415 = cos(qJ(3));
t369 = t415 * t372;
t412 = sin(qJ(3));
t434 = qJD(1) * qJD(3);
...
t405 = t408 ^ 2;
t440 = t405 * t417;
t342 = pkin(3) * t399 - qJ(4) * t389 + t369 + (-pkin(3) * t415 * t440 - qJ(4) * t400 * t436 - t361) * t412;
...
t360 = t395 * t436 - t370;
t423 = -t410 * mrSges(3,1) + t408 * mrSges(3,2);
t384 = -mrSges(4,2) * t400 - mrSges(4,3) * t431;
t387 = (t412 * mrSges(4,1) + t415 * mrSges(4,2)) * t436;
...
t374 = Ifges(4,6) * t400 + (t415 * Ifges(4,4) - t412 * Ifges(4,2)) * t436;
t375 = Ifges(4,5) * t400 + (t415 * Ifges(4,1) - t412 * Ifges(4,4)) * t436;
t422 = t415 * t374 + t412 * t375;
t349 = -pkin(3) * t388 - qJ(4) * t432 + t385 * t430 + qJDD(4) + t360;
t332 = -pkin(4) * t363 - pkin(7) * t379 + t367 * t381 + t349;
t420 = m(6) * t332 - t337 * mrSges(6,1) + t338 * mrSges(6,2) - t358 * t352 + t359 * t353;
t323 = m(5) * t349 - t363 * mrSges(5,1) + t364 * mrSges(5,2) - t380 * t365 + t381 * t366 + t420;
t394 = (Ifges(3,5) * t408 + Ifges(3,6) * t410) * qJD(1);
t393 = t423 * qJD(1);
t391 = -qJDD(1) * pkin(1) + t421;
...
t305 = -mrSges(5,1) * t349 + mrSges(5,3) * t330 + Ifges(5,4) * t364 + Ifges(5,2) * t363 + Ifges(5,6) * t399 - pkin(4) * t420 + pkin(7) * t426 + t414 * t316 + t411 * t317 - t381 * t354 + t400 * t356;
t303 = m(3) * t391 + t423 * qJDD(1) + (-t410 ^ 2 - t405) * t417 * mrSges(3,3) + t304;
t1 = [Ifges(2,3) * qJDD(1) + mrSges(2,1) * t428 - mrSges(2,2) * t424 + t408 * (mrSges(3,2) * t391 - mrSges(3,3) * t370 + t415 * (mrSges(4,2) * t360 - mrSges(4,3) * t350 + Ifges(4,1) * t389 + Ifges(4,4) * t388 + Ifges(4,5) * t399 - qJ(4) * t309 - t305 * t407 + t306 * t409 - t374 * t400) - t412 * (-mrSges(4,1) * t360 + mrSges(4,3) * t351 + Ifges(4,4) * t389 + Ifges(4,2) * t388 + Ifges(4,6) * t399 - pkin(3) * t323 + qJ(4) * t427 + t409 * t305 + t407 * t306 + t400 * t375) - pkin(6) * t304 + (Ifges(3,1) * t408 + Ifges(3,4) * t410) * qJDD(1) + t394 * t438) + t410 * ((Ifges(3,4) * qJDD(1) + (-t394 - t422) * qJD(1)) * t408 - mrSges(3,1) * t391 + mrSges(3,3) * t371 + Ifges(3,2) * t433 - pkin(2) * t304 + t442) - pkin(1) * t303 + qJ(2) * ((m(3) * t371 - t307 * t412 + t415 * t308 + (qJD(1) * t393 + t437) * t410) * t410 + (t323 - t388 * mrSges(4,1) + t389 * mrSges(4,2) - m(3) * t370 + m(4) * t360 + t408 * t437 + (t384 * t412 + t386 * t415 + t393) * t436) * t408); t303; t422 * t436 - t442; t323; -t419;];
tauJ = t1;
