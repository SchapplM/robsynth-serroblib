...
t10 = sin(t14);
t11 = cos(t14);
t30 = t11 * rSges(5,1) - rSges(5,2) * t10;
t9 = pkin(3) * t13;
t29 = t30 + t9;
t28 = -rSges(4,1) * t12 - rSges(4,2) * t13;
t27 = -rSges(5,1) * t10 - rSges(5,2) * t11;
t25 = t36 * t10 + t37 * t11;
t24 = t37 * t10 - t36 * t11;
t23 = t24 + t9;
t22 = t27 - t34;
...
t20 = cos(qJ(2));
t15 = t20 * pkin(2);
t1 = [(-m(2) - m(3) - m(4) - m(5) - m(6)) * g(3), -m(3) * (g(1) * (-t18 * rSges(3,1) - rSges(3,2) * t20) + g(2) * (rSges(3,1) * t20 - t18 * rSges(3,2))) - m(4) * (g(1) * (t28 - t35) + g(2) * (t15 + t31)) - m(5) * (g(1) * (t22 - t35) + g(2) * (t15 + t29)) - m(6) * (g(1) * (t21 - t35) + g(2) * (t15 + t23)), -m(4) * (g(1) * t28 + g(2) * t31) - m(5) * (g(1) * t22 + g(2) * t29) - m(6) * (g(1) * t21 + g(2) * t23), -m(5) * (g(1) * t27 + g(2) * t30) - m(6) * (g(1) * t25 + g(2) * t24), -m(6) * (-g(3) * t36 + (g(1) * t11 + g(2) * t10) * (-rSges(6,1) * t17 - rSges(6,2) * t19))];
taug = t1(:);
