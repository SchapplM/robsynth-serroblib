...
function Phi_dq = S5PRRRR2_constr2grad(q, xE, pkin, T_N_E, phiconv_W_E, I_EElink, reci)
...
%% Translatorisch
% Bein-Jacobi
J0_i_trans = S5PRRRR2_jacobia_transl_sym_varpar(q, I_EElink, T_N_E(1:3,4), pkin);
...
dRb_0N_dq = S5PRRRR2_jacobiR_rot_sym_varpar(q, I_EElink, pkin);
