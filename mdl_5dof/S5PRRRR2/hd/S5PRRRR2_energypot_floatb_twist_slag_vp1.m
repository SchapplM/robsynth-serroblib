...
t4 = cos(t7);
t3 = sin(t7);
t1 = -m(1) * (g(1) * (r_base(1) + rSges(1,1)) + g(2) * (r_base(2) + rSges(1,2)) + g(3) * (r_base(3) + rSges(1,3))) - m(2) * (g(1) * (r_base(1) + rSges(2,1)) + g(2) * (r_base(2) + rSges(2,2)) + g(3) * (rSges(2,3) + t21)) - m(3) * (g(1) * (rSges(3,1) * t14 - t12 * rSges(3,2) + t23) + g(2) * (t12 * rSges(3,1) + rSges(3,2) * t14 + r_base(2)) + g(3) * (rSges(3,3) + t21)) - m(4) * (g(1) * (rSges(4,1) * t6 - rSges(4,2) * t5 + t20) + g(2) * (rSges(4,1) * t5 + rSges(4,2) * t6 + t22) + g(3) * (rSges(4,3) + t18)) - m(5) * (g(1) * (rSges(5,1) * t4 - rSges(5,2) * t3 + t17) + g(2) * (rSges(5,1) * t3 + rSges(5,2) * t4 + t19) + g(3) * (rSges(5,3) + t16)) - m(6) * (g(1) * t17 + g(2) * t19 + g(3) * (rSges(6,1) * t11 + rSges(6,2) * t13 + t16) + (g(1) * t15 - g(2) * t24) * t4 + (g(1) * t24 + g(2) * t15) * t3);
U  = t1;
