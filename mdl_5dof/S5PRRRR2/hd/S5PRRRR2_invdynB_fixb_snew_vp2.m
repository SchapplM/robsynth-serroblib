...
t319 = sin(qJ(2));
t323 = cos(qJ(2));
t303 = t319 * g(1) - g(2) * t323;
t301 = qJDD(2) * pkin(2) + t303;
t304 = -g(1) * t323 - g(2) * t319;
t324 = qJD(2) ^ 2;
t302 = -pkin(2) * t324 + t304;
t318 = sin(qJ(3));
t322 = cos(qJ(3));
t288 = t322 * t301 - t302 * t318;
t313 = qJDD(2) + qJDD(3);
t286 = pkin(3) * t313 + t288;
t289 = t318 * t301 + t322 * t302;
t312 = t314 ^ 2;
t287 = -pkin(3) * t312 + t289;
t317 = sin(qJ(4));
t321 = cos(qJ(4));
t283 = t317 * t286 + t321 * t287;
t305 = t307 ^ 2;
t306 = qJDD(4) + t313;
t280 = pkin(6) * t306 + t283;
t315 = -g(3) + qJDD(1);
t278 = -t280 * t316 + t315 * t320;
t293 = (-mrSges(6,1) * t320 + mrSges(6,2) * t316) * t307;
t333 = qJD(5) * t307;
t294 = t306 * t316 + t320 * t333;
t300 = -qJD(5) * mrSges(6,2) + mrSges(6,3) * t336;
t276 = m(6) * t278 + qJDD(5) * mrSges(6,1) - mrSges(6,3) * t294 + qJD(5) * t300 - t293 * t337;
t279 = t280 * t320 + t315 * t316;
t295 = t306 * t320 - t316 * t333;
t299 = qJD(5) * mrSges(6,1) - mrSges(6,3) * t337;
t277 = m(6) * t279 - qJDD(5) * mrSges(6,2) + mrSges(6,3) * t295 - qJD(5) * t299 + t293 * t336;
t328 = -t276 * t316 + t320 * t277;
t267 = m(5) * t283 - mrSges(5,1) * t305 - mrSges(5,2) * t306 + t328;
t282 = t286 * t321 - t287 * t317;
t281 = -pkin(6) * t305 - t282;
t272 = m(5) * t282 - m(6) * t281 + mrSges(5,1) * t306 + mrSges(6,1) * t295 - mrSges(5,2) * t305 - mrSges(6,2) * t294 + (-t299 * t316 + t300 * t320) * t307;
t264 = t317 * t267 + t321 * t272;
t262 = m(4) * t288 + mrSges(4,1) * t313 - mrSges(4,2) * t312 + t264;
t329 = t321 * t267 - t272 * t317;
t263 = m(4) * t289 - mrSges(4,1) * t312 - mrSges(4,2) * t313 + t329;
t257 = t322 * t262 + t318 * t263;
t255 = m(3) * t303 + qJDD(2) * mrSges(3,1) - mrSges(3,2) * t324 + t257;
t330 = -t318 * t262 + t322 * t263;
t256 = m(3) * t304 - mrSges(3,1) * t324 - qJDD(2) * mrSges(3,2) + t330;
t335 = t323 * t255 + t319 * t256;
t334 = t320 * t276 + t316 * t277;
t332 = m(5) * t315 + t334;
t331 = -t255 * t319 + t323 * t256;
t327 = m(4) * t315 + t332;
t326 = m(2) * qJ(1) + mrSges(1,3) + mrSges(2,3);
t325 = m(3) * t315 + t327;
...
t268 = -mrSges(5,1) * t315 - mrSges(6,1) * t278 + mrSges(6,2) * t279 + mrSges(5,3) * t283 + Ifges(5,5) * t305 - Ifges(6,5) * t294 + Ifges(5,6) * t306 - Ifges(6,6) * t295 - Ifges(6,3) * qJDD(5) + (-t291 * t316 + t292 * t320) * t307;
t258 = mrSges(5,2) * t315 - mrSges(5,3) * t282 + Ifges(5,5) * t306 - t305 * Ifges(5,6) - pkin(6) * t334 - t316 * t269 + t320 * t270;
t251 = mrSges(4,2) * t315 - mrSges(4,3) * t288 + Ifges(4,5) * t313 - Ifges(4,6) * t312 - pkin(5) * t264 + t258 * t321 - t268 * t317;
t250 = -mrSges(4,1) * t315 + mrSges(4,3) * t289 + t312 * Ifges(4,5) + Ifges(4,6) * t313 - pkin(3) * t332 + pkin(5) * t329 + t317 * t258 + t321 * t268;
t249 = mrSges(3,2) * t315 - mrSges(3,3) * t303 + Ifges(3,5) * qJDD(2) - Ifges(3,6) * t324 - pkin(4) * t257 - t250 * t318 + t251 * t322;
