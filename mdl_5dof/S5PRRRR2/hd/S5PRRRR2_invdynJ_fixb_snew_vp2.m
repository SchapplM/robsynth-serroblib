...
t234 = sin(qJ(2));
t238 = cos(qJ(2));
t243 = t234 * g(1) - g(2) * t238;
t219 = qJDD(2) * pkin(2) + t243;
t241 = -g(1) * t238 - t234 * g(2);
t220 = -qJD(2) ^ 2 * pkin(2) + t241;
t233 = sin(qJ(3));
t237 = cos(qJ(3));
t206 = t237 * t219 - t220 * t233;
t228 = qJDD(2) + qJDD(3);
t203 = pkin(3) * t228 + t206;
t207 = t233 * t219 + t237 * t220;
t227 = t229 ^ 2;
t204 = -pkin(3) * t227 + t207;
t232 = sin(qJ(4));
t236 = cos(qJ(4));
t200 = t232 * t203 + t236 * t204;
t223 = t225 ^ 2;
t224 = qJDD(4) + t228;
t196 = pkin(6) * t224 + t200;
t230 = -g(3) + qJDD(1);
t194 = -t196 * t231 + t230 * t235;
t211 = (-mrSges(6,1) * t235 + mrSges(6,2) * t231) * t225;
t244 = qJD(5) * t225;
t212 = t224 * t231 + t235 * t244;
t218 = -qJD(5) * mrSges(6,2) + mrSges(6,3) * t246;
t192 = m(6) * t194 + qJDD(5) * mrSges(6,1) - mrSges(6,3) * t212 + qJD(5) * t218 - t211 * t247;
t195 = t196 * t235 + t230 * t231;
t213 = t224 * t235 - t231 * t244;
t217 = qJD(5) * mrSges(6,1) - mrSges(6,3) * t247;
t193 = m(6) * t195 - qJDD(5) * mrSges(6,2) + mrSges(6,3) * t213 - qJD(5) * t217 + t211 * t246;
t242 = -t192 * t231 + t235 * t193;
t185 = m(5) * t200 - mrSges(5,1) * t223 - mrSges(5,2) * t224 + t242;
t199 = t203 * t236 - t204 * t232;
t197 = -pkin(6) * t223 - t199;
...
t1 = [t235 * t192 + t231 * t193 + (m(2) + m(3) + m(4) + m(5)) * t230; t239 + Ifges(3,3) * qJDD(2) + pkin(2) * (t233 * (m(4) * t207 - mrSges(4,1) * t227 - mrSges(4,2) * t228 + t185 * t236 - t190 * t232) + t237 * (m(4) * t206 + mrSges(4,1) * t228 - mrSges(4,2) * t227 + t245)) + mrSges(3,1) * t243 - mrSges(3,2) * t241; t239; t240; mrSges(6,1) * t194 - mrSges(6,2) * t195 + Ifges(6,5) * t212 + Ifges(6,6) * t213 + Ifges(6,3) * qJDD(5) + (t209 * t231 - t210 * t235) * t225;];
tauJ  = t1;
