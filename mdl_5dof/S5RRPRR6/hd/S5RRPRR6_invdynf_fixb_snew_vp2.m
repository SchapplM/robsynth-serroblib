...
t100 = -m(2) - m(3);
t62 = qJD(1) + qJD(2);
t80 = -mrSges(4,1) * t65 + mrSges(4,2) * t64;
t43 = t80 * t62;
...
t21 = -qJD(5) * t35 + t41 * t70 - t42 * t66;
t34 = (-t66 * t71 - t67 * t70) * t96;
t22 = qJD(5) * t34 + t41 * t66 + t42 * t70;
t95 = t65 * t62;
t53 = qJD(4) - t95;
t51 = qJD(5) + t53;
t32 = -mrSges(6,2) * t51 + mrSges(6,3) * t34;
t33 = mrSges(6,1) * t51 - mrSges(6,3) * t35;
t87 = t71 * t96;
t40 = pkin(4) * t53 - pkin(8) * t87;
t97 = t60 * t58;
t89 = t67 ^ 2 * t97;
t76 = t21 * mrSges(6,1) + t34 * t32 - m(6) * (-pkin(4) * t41 - pkin(8) * t89 + t40 * t87 + t18) - t22 * mrSges(6,2) - t35 * t33;
t75 = m(5) * t18 - t41 * mrSges(5,1) + t42 * mrSges(5,2) - t76;
t88 = t67 * t96;
t37 = -mrSges(5,2) * t53 - mrSges(5,3) * t88;
t38 = mrSges(5,1) * t53 - mrSges(5,3) * t87;
t79 = t37 * t67 + t38 * t71;
t98 = t59 * mrSges(4,3);
t10 = m(4) * t93 + (-t98 + (-0.2e1 * m(4) * qJD(3) - t43 - t79) * t62) * t64 - t75;
t83 = -t64 * g(3) + (t31 + t86) * t65;
t19 = t44 * t95 + t83;
t84 = t72 * t48 - t68 * t49;
...
t94 = t71 * t19 + t67 * t26;
t14 = -pkin(4) * t89 + pkin(8) * t41 - t40 * t53 + t94;
t27 = -mrSges(6,1) * t34 + mrSges(6,2) * t35;
t50 = qJDD(5) + t52;
t11 = m(6) * (t13 * t70 - t14 * t66) - t22 * mrSges(6,3) + t50 * mrSges(6,1) - t35 * t27 + t51 * t32;
t12 = m(6) * (t13 * t66 + t14 * t70) + t21 * mrSges(6,3) - t50 * mrSges(6,2) + t34 * t27 - t51 * t33;
...
t6 = m(4) * t83 + t71 * t8 - t67 * t7 + (t43 * t62 + t98) * t65;
t99 = t65 * t10 + t64 * t6;
t78 = m(4) * (-pkin(2) * t59 + t77) + t67 * t8 + t71 * t7;
t4 = m(3) * t84 + (mrSges(3,1) - t80) * t59 + (-mrSges(3,2) + t101) * t58 - t78;
t3 = m(3) * t92 - t58 * mrSges(3,1) - t59 * mrSges(3,2) - t64 * t10 + t65 * t6;
t2 = m(2) * t81 - t74 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t72 * t3 - t68 * t4;
t1 = m(2) * t85 + qJDD(1) * mrSges(2,1) - t74 * mrSges(2,2) + t68 * t3 + t72 * t4;
t5 = [-m(1) * g(1) - t1 * t69 + t2 * t73, t2, t3, t6, t8, t12; -m(1) * g(2) + t1 * t73 + t2 * t69, t1, t4, t10, t7, t11; (-m(1) + t100) * g(3) + t99, g(3) * t100 + t99, -m(3) * g(3) + t99, -t101 * t58 + t59 * t80 + t78, t79 * t96 + t75, -t76;];
f_new = t5;
