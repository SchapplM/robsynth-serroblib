...
t506 = sin(qJ(1));
t510 = cos(qJ(1));
t489 = t506 * g(1) - g(2) * t510;
t481 = qJDD(1) * pkin(1) + t489;
t490 = -g(1) * t510 - g(2) * t506;
t511 = qJD(1) ^ 2;
t482 = -pkin(1) * t511 + t490;
t505 = sin(qJ(2));
t509 = cos(qJ(2));
...
t508 = cos(qJ(4));
t532 = t501 * t508;
t452 = -g(3) * t501 + t502 * t540;
t475 = (-mrSges(4,1) * t502 + t539) * t499;
t518 = -pkin(3) * t502 - pkin(7) * t501;
t477 = t518 * t499;
t440 = t477 * t534 + t452;
t463 = t481 * t509 - t505 * t482;
t515 = -qJ(3) * t496 + qJDD(3) - t463;
...
t485 = qJDD(4) - t536;
t486 = qJD(4) - t534;
t433 = pkin(4) * t485 - pkin(8) * t474 + t449 + (-pkin(4) * t508 * t537 - pkin(8) * t486 * t535 - t440) * t504;
...
t465 = (-t503 * t508 - t504 * t507) * t535;
t443 = qJD(5) * t465 + t473 * t503 + t474 * t507;
t466 = (-t503 * t504 + t507 * t508) * t535;
...
t471 = (mrSges(5,1) * t504 + mrSges(5,2) * t508) * t535;
...
t520 = -t419 * t504 + t420 * t508;
t416 = m(4) * t452 + (t475 * t499 + t538) * t502 + t520;
t439 = t477 * t535 - t451;
t437 = -pkin(4) * t473 - pkin(8) * t527 + t472 * t525 + t439;
t514 = m(6) * t437 - mrSges(6,1) * t442 + mrSges(6,2) * t443 - t465 * t458 + t459 * t466;
t512 = -m(5) * t439 + t473 * mrSges(5,1) - mrSges(5,2) * t474 - t514;
...
t417 = t419 * t508 + t420 * t504;
t456 = -pkin(2) * t497 + t515;
t513 = -m(4) * t456 + mrSges(4,1) * t536 - t417 + (t496 * t502 ^ 2 + t537) * mrSges(4,3);
t413 = m(3) * t463 - mrSges(3,2) * t496 + (mrSges(3,1) - t539) * t497 + t513;
t404 = t408 * t505 + t413 * t509;
t402 = m(2) * t489 + qJDD(1) * mrSges(2,1) - mrSges(2,2) * t511 + t404;
t522 = t408 * t509 - t413 * t505;
t403 = m(2) * t490 - mrSges(2,1) * t511 - qJDD(1) * mrSges(2,2) + t522;
t531 = t402 * t510 + t403 * t506;
t410 = t416 * t501 + t425 * t502;
t523 = -t402 * t506 + t403 * t510;
t517 = Ifges(4,1) * t501 + Ifges(4,4) * t502;
t516 = Ifges(4,5) * t501 + Ifges(4,6) * t502;
t476 = t516 * t499;
t462 = Ifges(5,5) * t486 + (Ifges(5,1) * t508 - Ifges(5,4) * t504) * t535;
t461 = Ifges(5,6) * t486 + (Ifges(5,4) * t508 - Ifges(5,2) * t504) * t535;
t460 = Ifges(5,3) * t486 + (Ifges(5,5) * t508 - Ifges(5,6) * t504) * t535;
...
t405 = Ifges(4,2) * t536 - mrSges(4,1) * t456 + mrSges(4,3) * t452 - Ifges(5,5) * t474 - Ifges(5,6) * t473 - Ifges(5,3) * t485 - mrSges(5,1) * t435 + mrSges(5,2) * t436 - Ifges(6,5) * t443 - Ifges(6,6) * t442 - Ifges(6,3) * t483 - t466 * t445 + t465 * t446 - mrSges(6,1) * t431 + mrSges(6,2) * t432 - pkin(4) * t421 - pkin(3) * t417 + (Ifges(4,4) * t497 + (-t461 * t508 - t462 * t504 - t476) * t499) * t501;
t398 = mrSges(4,2) * t456 - mrSges(4,3) * t451 - pkin(7) * t417 - t409 * t504 + t411 * t508 + t476 * t534 + t497 * t517;
t397 = t496 * Ifges(3,5) + mrSges(3,1) * g(3) + mrSges(3,3) * t464 - mrSges(4,1) * t451 + mrSges(4,2) * t452 - t504 * t411 - t508 * t409 - pkin(3) * t512 - pkin(7) * t520 - pkin(2) * t410 + (Ifges(3,6) - t516) * t497 + (-pkin(3) * (-t469 * t533 - t470 * t532) + (-t501 * (Ifges(4,4) * t501 + Ifges(4,2) * t502) + t502 * t517) * t499) * t499;
t396 = -mrSges(3,2) * g(3) - mrSges(3,3) * t463 + Ifges(3,5) * t497 - Ifges(3,6) * t496 - qJ(3) * t410 + t398 * t502 - t405 * t501;
t395 = -mrSges(2,2) * g(3) - mrSges(2,3) * t489 + Ifges(2,5) * qJDD(1) - Ifges(2,6) * t511 - pkin(6) * t404 + t396 * t509 - t397 * t505;
t394 = Ifges(2,6) * qJDD(1) + t511 * Ifges(2,5) + mrSges(2,1) * g(3) + mrSges(2,3) * t490 + t505 * t396 + t509 * t397 - pkin(1) * (-m(3) * g(3) + t410) + pkin(6) * t522;
t1 = [-m(1) * g(1) + t523; -m(1) * g(2) + t531; (-m(1) - m(2) - m(3)) * g(3) + t410; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t531 - t394 * t506 + t395 * t510; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t523 + t510 * t394 + t506 * t395; pkin(1) * t404 + mrSges(2,1) * t489 - mrSges(2,2) * t490 + t501 * t398 + t502 * t405 + pkin(2) * (-t497 * t539 + t513) + qJ(3) * t521 + mrSges(3,1) * t463 - mrSges(3,2) * t464 - mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + Ifges(3,3) * t497 + Ifges(2,3) * qJDD(1);];
tauB = t1;
