...
t3 = sin(t9);
t5 = cos(t9);
t36 = -mrSges(4,1) - m(5) * pkin(3) - t15 * mrSges(5,1) + t13 * mrSges(5,2) - m(6) * (t15 * pkin(4) + pkin(3)) - t5 * mrSges(6,1) + t3 * mrSges(6,2);
t35 = mrSges(4,2) - m(5) * pkin(7) + m(6) * (-pkin(8) - pkin(7)) - mrSges(5,3) - mrSges(6,3);
t30 = m(4) + m(5) + m(6);
t11 = sin(pkin(9));
t12 = cos(pkin(9));
t34 = t35 * t11 + t36 * t12 - mrSges(3,1);
t33 = -m(1) - m(2);
t29 = -m(3) - t30;
t28 = t3 * mrSges(6,1) + t15 * mrSges(5,2) + t5 * mrSges(6,2) - mrSges(3,2) + mrSges(4,3) + (m(6) * pkin(4) + mrSges(5,1)) * t13 + t30 * qJ(3);
t26 = pkin(5) + r_base(1);
t14 = sin(qJ(1));
...
t6 = cos(t10);
t4 = sin(t10);
t1 = (t16 * mrSges(2,1) - t14 * mrSges(2,2) - mrSges(1,3) + t33 * r_base(3) + (t30 * pkin(2) - t34) * t6 + t29 * (-t16 * pkin(1) + r_base(3)) + t28 * t4) * g(3) + (-m(3) * t25 - t14 * mrSges(2,1) - t16 * mrSges(2,2) - mrSges(1,2) + t33 * r_base(2) - t30 * (t4 * pkin(2) + t25) + t28 * t6 + t34 * t4) * g(2) + (-m(1) * r_base(1) - m(2) * t26 - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) + t29 * (pkin(6) + t26) - t35 * t12 + t36 * t11) * g(1);
U = t1;
