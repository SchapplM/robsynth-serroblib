...
function [v_mdh, sigma_mdh, mu_mdh, NL, NKP, NQJ, pkin_names] = S5PPRRR4_structural_kinematic_parameters()
...
pkin_names = {'a2', 'a3', 'a4', 'a5', 'alpha2', 'alpha3', 'd3', 'd4', 'd5', 'theta1', 'theta2'};
