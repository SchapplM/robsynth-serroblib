...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S5PPRRR4_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(11,1)}
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S5PPRRR4_pkin2mdhparam: Kinematic parameters pkin have to be [11x1] (double)');
...
t1 = [pkin(10); pkin(11); 0; 0; 0;];
theta_mdh = t1;

% Aus parameters_mdh_d_matlab.m
t1 = [0; 0; pkin(7); pkin(8); pkin(9);];
d_mdh = t1;
