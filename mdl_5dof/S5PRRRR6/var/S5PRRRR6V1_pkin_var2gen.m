% Umwandlung der Kinematikparameter von S5PRRRR6V1 zu S5PRRRR6
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S5PRRRR6_structural_kinematic_parameters.m
function pkin_gen = S5PRRRR6V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
