...
% OptimizationMode: 2
% StartTime: 2022-01-23 09:19:00
% EndTime: 2022-01-23 09:19:02
...
t584 = sin(qJ(1));
t587 = cos(qJ(1));
t559 = t584 * g(1) - t587 * g(2);
t554 = qJDD(1) * pkin(1) + t559;
t560 = -t587 * g(1) - t584 * g(2);
t588 = qJD(1) ^ 2;
t555 = -t588 * pkin(1) + t560;
t579 = sin(pkin(8));
t581 = cos(pkin(8));
...
t477 = m(2) * t559 + qJDD(1) * mrSges(2,1) - t588 * mrSges(2,2) + t480;
t604 = -t579 * t485 + t581 * t486;
t478 = m(2) * t560 - t588 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t604;
t609 = t587 * t477 + t584 * t478;
t498 = t580 * t502 + t578 * t503;
t606 = m(4) * t577 + t498;
t605 = -t584 * t477 + t587 * t478;
t496 = m(3) * t577 + t606;
...
t589 = mrSges(2,1) * t559 + mrSges(3,1) * t543 - mrSges(2,2) * t560 - mrSges(3,2) * t544 + pkin(1) * t480 + pkin(2) * t490 + t593 + (Ifges(2,3) + Ifges(3,3)) * qJDD(1);
...
t470 = -mrSges(2,2) * g(3) - mrSges(2,3) * t559 + Ifges(2,5) * qJDD(1) - t588 * Ifges(2,6) - qJ(2) * t480 - t579 * t471 + t581 * t472;
t469 = mrSges(2,1) * g(3) + mrSges(2,3) * t560 + t588 * Ifges(2,5) + Ifges(2,6) * qJDD(1) - pkin(1) * t496 + qJ(2) * t604 + t581 * t471 + t579 * t472;
t1 = [-m(1) * g(1) + t605; -m(1) * g(2) + t609; (-m(1) - m(2)) * g(3) + t496; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t609 - t584 * t469 + t587 * t470; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t605 + t587 * t469 + t584 * t470; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t589; t589; t496; t593; t510; t590;];
tauJB = t1;
