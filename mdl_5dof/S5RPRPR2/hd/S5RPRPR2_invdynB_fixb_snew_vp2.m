...
% OptimizationMode: 2
% StartTime: 2022-01-23 09:18:57
% EndTime: 2022-01-23 09:19:00
...
t440 = sin(qJ(1));
t443 = cos(qJ(1));
t418 = t440 * g(1) - t443 * g(2);
t414 = qJDD(1) * pkin(1) + t418;
t419 = -t443 * g(1) - t440 * g(2);
t444 = qJD(1) ^ 2;
t415 = -t444 * pkin(1) + t419;
t435 = sin(pkin(8));
t437 = cos(pkin(8));
...
t381 = -pkin(4) * t465 + pkin(7) * t464 + t384;
t438 = sin(qJ(5));
t441 = cos(qJ(5));
...
t445 = -m(5) * t386 + mrSges(5,1) * t464 - t446 + (t428 * t430 + t465) * mrSges(5,3);
...
t347 = m(2) * t418 + qJDD(1) * mrSges(2,1) - t444 * mrSges(2,2) + t349;
t458 = -t435 * t354 + t437 * t355;
t348 = m(2) * t419 - t444 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t458;
t463 = t443 * t347 + t440 * t348;
t362 = t436 * t366 + t434 * t367;
t460 = m(4) * t433 + t362;
t459 = -t440 * t347 + t443 * t348;
t454 = m(3) * t433 + t460;
...
t358 = mrSges(5,2) * t386 - mrSges(5,3) * t383 - pkin(7) * t368 - t438 * t369 + t441 * t370 + t453 * t429 + t436 * t466;
t356 = -mrSges(5,1) * t386 + mrSges(5,3) * t384 - pkin(4) * t446 + pkin(7) * t455 + t441 * t369 + t438 * t370 + t452 * t429 - t434 * t466;
...
t340 = -mrSges(2,2) * g(3) - mrSges(2,3) * t418 + Ifges(2,5) * qJDD(1) - t444 * Ifges(2,6) - qJ(2) * t349 - t435 * t341 + t437 * t342;
t339 = mrSges(2,1) * g(3) + mrSges(2,3) * t419 + t444 * Ifges(2,5) + Ifges(2,6) * qJDD(1) - pkin(1) * t454 + qJ(2) * t458 + t437 * t341 + t435 * t342;
t1 = [-m(1) * g(1) + t459; -m(1) * g(2) + t463; (-m(1) - m(2)) * g(3) + t454; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t463 - t440 * t339 + t443 * t340; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t459 + t443 * t339 + t440 * t340; pkin(1) * t349 + mrSges(2,1) * t418 - mrSges(2,2) * t419 + pkin(2) * t357 + mrSges(3,1) * t403 - mrSges(3,2) * t404 + t436 * t356 + pkin(3) * (-t429 * t467 + t445) + qJ(4) * t456 + t434 * t358 + mrSges(4,1) * t388 - mrSges(4,2) * t389 - mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + Ifges(4,3) * t429 + (Ifges(2,3) + Ifges(3,3)) * qJDD(1);];
tauB = t1;
