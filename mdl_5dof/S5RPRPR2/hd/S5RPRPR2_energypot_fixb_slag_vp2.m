...
t48 = sin(pkin(9));
t49 = cos(pkin(9));
t59 = -mrSges(4,1) - m(5) * pkin(3) - t49 * mrSges(5,1) + t48 * mrSges(5,2) - m(6) * (t49 * pkin(4) + pkin(3)) - t40 * mrSges(6,1) + t38 * mrSges(6,2);
...
t36 = cos(t42);
t35 = sin(t42);
t1 = (-m(2) * pkin(5) - m(3) * t57 - t38 * mrSges(6,1) - t49 * mrSges(5,2) - t40 * mrSges(6,2) - mrSges(1,3) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) + (-m(6) * pkin(4) - mrSges(5,1)) * t48 + t60 * (pkin(6) + t57)) * g(3) + (-m(3) * t43 - t51 * mrSges(2,1) - t39 * mrSges(3,1) - t52 * mrSges(2,2) - t41 * mrSges(3,2) - mrSges(1,2) + t60 * (pkin(2) * t39 + t43) + t58 * t36 + t59 * t35) * g(2) + (-m(3) * t44 - t52 * mrSges(2,1) - t41 * mrSges(3,1) + t51 * mrSges(2,2) + t39 * mrSges(3,2) - mrSges(1,1) + t60 * (pkin(2) * t41 + t44) + t59 * t36 - t58 * t35) * g(1);
U = t1;
