...
t33 = cos(t39);
t32 = sin(t39);
t1 = (-m(3) * t40 - t48 * mrSges(2,1) - t38 * mrSges(3,1) + t47 * mrSges(2,2) + t36 * mrSges(3,2) - mrSges(1,3) + t57 * (pkin(2) * t38 + t40) - t56 * t33 + t55 * t32) * g(3) + (m(3) * t54 + t47 * mrSges(2,1) + t36 * mrSges(3,1) + t48 * mrSges(2,2) + t38 * mrSges(3,2) - mrSges(1,2) + t57 * (-pkin(2) * t36 - t54) + t55 * t33 + t56 * t32) * g(2) + (-m(2) * pkin(5) - m(3) * t53 - t35 * mrSges(6,1) - t45 * mrSges(5,2) - t37 * mrSges(6,2) - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) + (-m(6) * pkin(4) - mrSges(5,1)) * t44 + t57 * (pkin(6) + t53)) * g(1);
U = t1;
