...
t37 = sin(t44);
t39 = cos(t44);
t52 = rSges(6,1) * t39 - rSges(6,2) * t37 + pkin(4) * t47 + pkin(3);
t51 = g(1) * t56 + g(2) * t57;
t41 = qJ(3) + t45;
t35 = cos(t41);
t34 = sin(t41);
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (rSges(2,1) * t50 - t49 * rSges(2,2)) + g(2) * (t49 * rSges(2,1) + rSges(2,2) * t50) + g(3) * (pkin(5) + rSges(2,3))) - m(3) * (g(1) * (rSges(3,1) * t40 - rSges(3,2) * t38 + t43) + g(2) * (rSges(3,1) * t38 + rSges(3,2) * t40 + t42) + g(3) * (rSges(3,3) + t58)) - m(4) * (g(1) * (rSges(4,1) * t35 - rSges(4,2) * t34 + t56) + g(2) * (rSges(4,1) * t34 + rSges(4,2) * t35 + t57) + g(3) * (rSges(4,3) + t54)) - m(5) * (g(3) * (rSges(5,1) * t46 + rSges(5,2) * t47 + t54) + (g(1) * t53 - g(2) * t55) * t35 + (g(1) * t55 + g(2) * t53) * t34 + t51) - m(6) * (g(3) * (rSges(6,1) * t37 + rSges(6,2) * t39 + pkin(4) * t46 + t54) + (g(1) * t52 - g(2) * t59) * t35 + (g(1) * t59 + g(2) * t52) * t34 + t51);
U = t1;
