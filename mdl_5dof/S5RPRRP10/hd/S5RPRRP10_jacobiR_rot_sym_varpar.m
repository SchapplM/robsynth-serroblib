...
function JR_rot = S5RPRRP10_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPRRP10_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPRRP10_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RPRRP10_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t69 = -t73 * t81 + t80;
	t68 = t73 * t82 + t79;
	t1 = [t69, 0, -t72 * t79, t70, 0; t71, 0, -t72 * t81, -t68, 0; 0, 0, t73 * t77, -t72 * t75, 0; t68, 0, t72 * t80, -t71, 0; t70, 0, t72 * t82, t69, 0; 0, 0, -t73 * t75, -t72 * t77, 0; -t76 * t72, 0, t78 * t73, 0, 0; t78 * t72, 0, t76 * t73, 0, 0; 0, 0, t72, 0, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end