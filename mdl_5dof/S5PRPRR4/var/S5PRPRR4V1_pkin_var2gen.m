% Umwandlung der Kinematikparameter von S5PRPRR4V1 zu S5PRPRR4
% Eingabe:
% pkin_var (8x1) double
...
%
% Siehe auch: S5PRPRR4_structural_kinematic_parameters.m
function pkin_gen = S5PRPRR4V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(10,1);
