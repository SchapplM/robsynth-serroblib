...
function Ja = S5RPRRR1_jacobia_4_sym_varpar(qJ, r_i_i_C, ...
  pkin)

Ja_transl = S5RPRRR1_jacobia_transl_4_sym_varpar(qJ, r_i_i_C, ...
  pkin);
Ja_rot = S5RPRRR1_jacobia_rot_4_sym_varpar(qJ, ...
  pkin);
