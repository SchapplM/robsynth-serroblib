...
t136 = t75 * t76;
t97 = -qJD(5) * t77 + qJD(3);
t11 = t97 * t136 + (-t96 * t78 + t110) * t73;
t154 = t11 / 0.2e1;
t140 = Ifges(6,4) * t73;
t89 = Ifges(6,1) * t76 - t140;
t32 = -Ifges(6,5) * t77 + t89 * t74;
t153 = t32 / 0.2e1;
t152 = t36 / 0.2e1;
t151 = t37 / 0.2e1;
t139 = Ifges(6,4) * t76;
...
t145 = t77 / 0.2e1;
t111 = t77 * t123;
t12 = t96 * t134 + (-t76 * t122 + t97 * t73) * t75;
t124 = qJD(3) * t75;
...
t35 = t83 * qJ(2);
t34 = t82 * qJ(2);
t33 = -t78 * Ifges(5,5) + t90 * t75;
t30 = -Ifges(6,6) * t77 + t87 * t74;
t28 = -mrSges(5,2) * t124 - t80 * mrSges(5,3);
t26 = -mrSges(6,2) * t122 + mrSges(6,3) * t160;
t25 = mrSges(6,1) * t122 + mrSges(6,3) * t161;
t24 = mrSges(6,1) * t137 - mrSges(6,3) * t37;
t23 = -mrSges(6,2) * t137 + mrSges(6,3) * t36;
t22 = mrSges(6,1) * t160 + mrSges(6,2) * t161;
t20 = -t56 * t121 + (Ifges(5,5) * t75 + t90 * t78) * qJD(3);
t19 = -t55 * t118 + (Ifges(6,5) * t74 + t89 * t77) * qJD(4);
t18 = -t54 * t121 + (Ifges(5,6) * t75 + t88 * t78) * qJD(3);
t17 = -t53 * t118 + (Ifges(6,6) * t74 + t87 * t77) * qJD(4);
t16 = -t52 * t118 + (Ifges(6,3) * t74 + t85 * t77) * qJD(4);
t8 = t80 * mrSges(6,1) - mrSges(6,3) * t12;
t7 = -t80 * mrSges(6,2) + mrSges(6,3) * t11;
t3 = Ifges(6,1) * t12 + Ifges(6,4) * t11 + t80 * Ifges(6,5);
t2 = Ifges(6,4) * t12 + Ifges(6,2) * t11 + t80 * Ifges(6,6);
t4 = [t11 * t14 + t12 * t15 + t36 * t2 + 0.2e1 * t5 * t23 + 0.2e1 * t6 * t24 + t37 * t3 + 0.2e1 * t34 * t8 + 0.2e1 * t35 * t7 + (m(3) * t155 + (2 * mrSges(3,3)) + 0.2e1 * (t69 + t72) * mrSges(4,3)) * qJD(2) + (t72 * t79 * t109 + t34 * t6 + t35 * t5 + t57) * t157 + 0.2e1 * m(5) * (t71 * t100 + t57 + t64) + 0.2e1 * m(4) * (t64 + t100) + ((t74 * t95 + 0.2e1 * t133) * qJD(2) + (0.2e1 * Ifges(4,4) * t78 + t77 * t33 + (t138 + t163) * t74) * qJD(3) + (qJD(3) * t156 + 0.2e1 * t77 * t28 - t144 * t112 + (-0.2e1 * t47 * t74 + t77 * t95) * qJD(4)) * qJ(2) + t128) * t78 + (qJD(2) * t156 + t77 * t20 + (t1 - t18) * t74 + (t93 * t75 * t155 + t163 * t77 - t74 * t33 + t78 * t86) * qJD(4) + ((Ifges(5,5) * t77 - Ifges(5,6) * t74 - 0.2e1 * Ifges(4,4)) * t75 + (-t130 * t112 - 0.2e1 * t133) * qJ(2) + ((2 * Ifges(4,1)) - (2 * Ifges(4,2)) + t92 * t155 - Ifges(5,3) + 0.4e1 * (-m(6) * t68 / 0.2e1 + m(5) * (0.1e1 - t126) / 0.2e1) * t79) * t78) * qJD(3)) * t75; t144 * t77 + (t75 * mrSges(4,1) + t78 * mrSges(4,2)) * qJD(3) + (m(6) * (t68 - t71) * t125 + (m(6) * (-t34 * t73 + t35 * t76) + t76 * t23 - t73 * t24 + t47) * t77) * qJD(4) + (m(6) * (-t34 * t117 - t35 * t119 + t162 * t77 + t94) - t23 * t119 + t76 * t7 - t24 * t117 - t73 * t8 + t28 + t130 * qJD(4)) * t74; (-0.1e1 + t127) * t109 * t157; t17 * t152 + t19 * t151 + t5 * t46 + t6 * t48 + t30 * t154 + t12 * t153 + t34 * t25 + t35 * t26 + (t18 / 0.2e1 - t1 / 0.2e1 + (t33 / 0.2e1 + t81) * qJD(4)) * t77 + (t20 / 0.2e1 + t3 * t146 + t2 * t149 + (t14 * t147 + t15 * t149) * qJD(5) + (-t31 / 0.2e1 + t13 / 0.2e1) * qJD(4)) * t74 + (Ifges(5,6) * t122 / 0.2e1 - t66 / 0.2e1 + (t38 * t120 - t74 * t22) * qJ(2) + t159 * qJD(2) + (t129 * qJ(2) + t101 * t74 + t56 * t145 + Ifges(4,5)) * qJD(3)) * t78 + (t45 * t145 + t43 * t148 + t74 * t16 / 0.2e1 + t129 * qJD(2) + (qJ(2) * t92 + t101 * t77 + t56 * t148) * qJD(4) + (t86 / 0.2e1 - Ifges(4,6) - t159 * qJ(2)) * qJD(3)) * t75; (t22 + (t46 * t76 - t48 * t73) * qJD(4)) * t77 + (qJD(4) * t38 - t25 * t73 + t26 * t76 + (-t46 * t73 - t48 * t76) * qJD(5)) * t74; (-t16 + t43 + (-t73 * t30 + t76 * t32 + t56) * qJD(4)) * t77 + (-t17 * t73 + t19 * t76 + t45 + (-t30 * t76 - t32 * t73) * qJD(5) + (t29 - t54) * qJD(4)) * t74; t2 * t146 + t73 * t3 / 0.2e1 + t53 * t154 + t12 * t150 + t42 * t152 + t44 * t151 + t81 * qJD(5) + ((-t34 * t76 - t35 * t73) * qJD(5) + t94) * mrSges(6,3) + (t162 * mrSges(5,2) + (t113 * t75 - t131 * t125) * qJD(4)) * t77 + ((-Ifges(5,5) * qJD(4) + t41 / 0.2e1 + t131 * t114) * t75 + (t113 * qJD(3) - t131 * qJD(2) + (mrSges(5,2) * qJD(4) + t40) * qJ(2)) * t78) * t74 - t128; -t40 * t77 + (-t131 * t74 + (t127 * mrSges(6,3) - mrSges(5,2)) * t77) * qJD(4); -t77 * t41 / 0.2e1 + t66 + (t120 * t150 + t17 / 0.2e1 + qJD(5) * t153) * t76 + (-t53 * t120 / 0.2e1 - qJD(5) * t30 / 0.2e1 + t19 / 0.2e1) * t73 + (t44 * t146 + t42 * t149 + (t53 * t147 + t55 * t149) * qJD(5) + t113 * qJD(4)) * t74; t42 * t76 + t44 * t73 + (-t53 * t73 + t55 * t76) * qJD(5); mrSges(6,1) * t6 - mrSges(6,2) * t5 + t1; t22; t16; t41; 0;];
