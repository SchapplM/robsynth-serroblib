...
%% Function calls
if link_index == 0
	Jg_rot=S5RPRRR1_jacobig_rot_0_sym_varpar(qJ, pkin);
elseif link_index == 1
	Jg_rot=S5RPRRR1_jacobig_rot_1_sym_varpar(qJ, pkin);
elseif link_index == 2
	Jg_rot=S5RPRRR1_jacobig_rot_2_sym_varpar(qJ, pkin);
elseif link_index == 3
	Jg_rot=S5RPRRR1_jacobig_rot_3_sym_varpar(qJ, pkin);
elseif link_index == 4
	Jg_rot=S5RPRRR1_jacobig_rot_4_sym_varpar(qJ, pkin);
elseif link_index == 5
	Jg_rot=S5RPRRR1_jacobig_rot_5_sym_varpar(qJ, pkin);
else
	Jg_rot=NaN(3,5);
end