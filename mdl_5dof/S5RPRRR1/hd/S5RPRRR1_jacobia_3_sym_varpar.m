...
function Ja = S5RPRRR1_jacobia_3_sym_varpar(qJ, r_i_i_C, ...
  pkin)

Ja_transl = S5RPRRR1_jacobia_transl_3_sym_varpar(qJ, r_i_i_C, ...
  pkin);
Ja_rot = S5RPRRR1_jacobia_rot_3_sym_varpar(qJ, ...
  pkin);
