...
t74 = sin(qJ(4));
t75 = sin(qJ(3));
t42 = t74 * t126 + (t130 * t75 + t133 * t74) * qJD(1);
t181 = t42 / 0.2e1;
t73 = sin(qJ(5));
t176 = -t73 / 0.2e1;
t137 = qJD(1) * t78;
...
t132 = qJD(4) * t59;
t128 = qJ(2) * qJD(3);
t57 = (qJD(2) * t78 - t128 * t75) * qJD(1);
t28 = t57 * t77 - t132;
t131 = qJD(4) * t74;
t125 = t75 * t131;
t41 = t77 * t126 + (t133 * t77 - t125) * qJD(1);
t195 = t28 * mrSges(5,2) - Ifges(5,5) * t41 + Ifges(5,6) * t42;
t154 = t59 * t74;
t135 = qJD(3) * mrSges(4,2);
t64 = mrSges(4,3) * t137 - t135;
t60 = qJD(2) * t74 + t121 * t77;
t99 = t60 * t77 + t154;
t89 = -m(5) * t99 - m(6) * t154 - t64;
t35 = t62 * t76 + t67 * t73;
t17 = -qJD(5) * t35 + t120 * t76 - t41 * t73;
t14 = Ifges(6,6) * t17;
t34 = -t62 * t73 + t67 * t76;
t16 = qJD(5) * t34 + t120 * t73 + t41 * t76;
t15 = Ifges(6,5) * t16;
t1 = Ifges(6,3) * t42 + t14 + t15;
t36 = t122 * t76 - t60 * t73;
t58 = (qJD(2) * t75 + t128 * t78) * qJD(1);
t7 = qJD(5) * t36 + t28 * t76 + t58 * t73;
t37 = t122 * t73 + t60 * t76;
t8 = -qJD(5) * t37 - t28 * t73 + t58 * t76;
...
t9 = t161 + t162 + t165;
t84 = t9 / 0.2e1 + t161 / 0.2e1 + t162 / 0.2e1 + t165 / 0.2e1 - t60 * mrSges(5,3) - t193 - t201;
t83 = t84 * t74;
t82 = t84 + t197;
...
t22 = t114 * t146 + (t115 * t73 - t131 * t76) * t75;
...
t4 = [(Ifges(6,5) * t22 + Ifges(6,6) * t21) * t179 + (Ifges(6,5) * t54 - Ifges(6,6) * t95) * t181 + t59 * (-mrSges(6,1) * t21 + mrSges(6,2) * t22) + t49 * t5 + t50 * t6 - t95 * t2 / 0.2e1 + t29 * (mrSges(6,1) * t95 + mrSges(6,2) * t54) + t54 * t189 + t22 * t11 / 0.2e1 + t12 * t23 + t13 * t24 + t21 * t10 / 0.2e1 + (Ifges(6,4) * t22 + Ifges(6,2) * t21) * t184 + (Ifges(6,4) * t54 - Ifges(6,2) * t95) * t186 + (Ifges(6,1) * t22 + Ifges(6,4) * t21) * t182 + (Ifges(6,1) * t54 - Ifges(6,4) * t95) * t187 + 0.2e1 * t117 * t127 + m(5) * t65 + m(6) * (t12 * t37 + t13 * t36 + t49 * t8 + t50 * t7) + m(4) * (t116 * t72 + t65) + (t21 * t37 - t22 * t36 - t54 * t8 - t7 * t95) * mrSges(6,3) + (t57 * mrSges(4,3) - t66 / 0.2e1 + t29 * mrSges(5,1) + (t143 * t74 + t145 - t89) * qJD(2) + (t77 * t31 + t173 * t74 + (t143 * t77 - t74 * t43) * qJD(4) + m(6) * t92 + m(5) * (-t131 * t60 + t28 * t77 + t92) + m(4) * t57) * qJ(2) + (0.3e1 / 0.2e1 * t69 + t119 + t88 * t77 + t83 + t191) * qJD(3) + t195) * t78 + (-t142 * qJD(2) + qJ(2) * (mrSges(5,1) * t42 + mrSges(5,2) * t41) + (t29 * mrSges(5,3) + t91) * t77 + t194 * t74 + (t74 * t87 + t77 * t82) * qJD(4) + (t118 + ((Ifges(5,5) * t77 / 0.2e1 - Ifges(5,6) * t74 / 0.2e1 - 0.3e1 / 0.2e1 * Ifges(4,4)) * t75 + (t174 + 0.3e1 / 0.2e1 * Ifges(4,1) - 0.3e1 / 0.2e1 * Ifges(4,2) - Ifges(5,3) / 0.2e1) * t78) * qJD(1) + ((mrSges(5,2) * t137 - t43) * t77 + (mrSges(5,1) * t137 - t143) * t74 + t89) * qJ(2) + t86) * qJD(3) + (mrSges(4,3) + (m(5) + m(4)) * qJ(2)) * t58) * t75; -t48 * t23 - t47 * t24 - t117 * t79 + (t93 * qJD(4) - t173) * t77 + ((t135 - t64 - t145) * t78 + (t136 + t142) * t75) * qJD(1) + (-t73 * t5 + t76 * t6 + t31 + (-t23 * t73 - t24 * t76) * qJD(5) + t67 * t143) * t74 - m(4) * (t141 * t72 + t68) + (-t137 * t154 - t36 * t47 - t37 * t48 + (-qJD(4) * t100 - t29) * t77 + (-qJD(5) * t101 + t110 + t132) * t74) * m(6) + (t28 * t74 - t29 * t77 + t67 * t99 - t68) * m(5); (Ifges(6,5) * t48 + Ifges(6,6) * t47) * t180 + (Ifges(6,4) * t48 + Ifges(6,2) * t47) * t185 + (Ifges(6,1) * t48 + Ifges(6,4) * t47) * t183 - t57 * mrSges(4,2) - t58 * mrSges(4,1) - t59 * (-mrSges(6,1) * t47 + mrSges(6,2) * t48) - t48 * t11 / 0.2e1 - t45 * t24 + t46 * t23 + t47 * t188 + (t36 * t48 - t37 * t47) * mrSges(6,3) - m(6) * (t36 * t45 - t37 * t46) - t75 * t78 * t79 * t174 - t194 * t77 + (t3 * t175 + t2 * t176 + t103 * t181 + t107 * t187 + t105 * t186 + t94 * t29 + (-t7 * t73 - t76 * t8) * mrSges(6,3) + (mrSges(6,3) * t100 + t102 * t180 + t104 * t185 + t106 * t183 + t109 * t59 + t11 * t176 + t188 * t76) * qJD(5) + t91) * t74 + (t83 + (t81 + t90 + t198) * t77) * qJD(4) + (((Ifges(5,5) * t74 + Ifges(5,6) * t77) * t202 + t118 + Ifges(4,4) * t199 + ((mrSges(5,2) * qJD(4) + t43) * t77 + (mrSges(5,1) * qJD(4) + t143) * t74 - t89) * qJ(2) - t86) * t75 + (t119 - t69 / 0.2e1 + (Ifges(4,2) / 0.2e1 - Ifges(4,1) / 0.2e1) * t138 + t87 * t77 - t82 * t74 - t191) * t78) * qJD(1); (-t143 + t172) * t60 + (-mrSges(5,1) - t109) * t29 + t110 * mrSges(6,3) + t66 + t73 * t189 + t102 * t181 + t104 * t186 + t106 * t187 + t2 * t175 + (t108 * t59 + t81) * qJD(5) + (-m(6) * (t100 + t60) + t93) * t59 + (-t196 - t166 / 0.2e1 + t103 * t180 + t107 * t183 + t105 * t185 - t198 - t190) * t61 + (Ifges(6,5) * t183 + Ifges(6,6) * t185 + Ifges(6,3) * t180 + t193 - t197 + t203) * t62 - (Ifges(5,1) * t61 - t170 + t9) * t62 / 0.2e1 - (-Ifges(5,2) * t62 + t147 + t27 + t55) * t61 / 0.2e1 - t195; -t59 * (mrSges(6,1) * t35 + mrSges(6,2) * t34) + (Ifges(6,1) * t34 - t169) * t183 + t10 * t182 + (Ifges(6,5) * t34 - Ifges(6,6) * t35) * t180 - t36 * t23 + t37 * t24 + (t34 * t36 + t35 * t37) * mrSges(6,3) + t111 + t1 + (-Ifges(6,2) * t35 + t11 + t33) * t185;];
tauc  = t4(:);
