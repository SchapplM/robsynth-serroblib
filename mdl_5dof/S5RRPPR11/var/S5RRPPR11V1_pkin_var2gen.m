% Umwandlung der Kinematikparameter von S5RRPPR11V1 zu S5RRPPR11
% Eingabe:
% pkin_var (6x1) double
...
%
% Siehe auch: S5RRPPR11_structural_kinematic_parameters.m
function pkin_gen = S5RRPPR11V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(8,1);
