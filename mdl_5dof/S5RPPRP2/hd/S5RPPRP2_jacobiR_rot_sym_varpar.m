...
function JR_rot = S5RPPRP2_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPPRP2_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPPRP2_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RPPRP2_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t51 = t48 * t45;
	t44 = t48 * t47;
	t1 = [-t52, 0, 0, -t51, 0; t44, 0, 0, -t53, 0; 0, 0, 0, t47, 0; t48, 0, 0, 0, 0; t46, 0, 0, 0, 0; 0, 0, 0, 0, 0; -t53, 0, 0, t44, 0; t51, 0, 0, t52, 0; 0, 0, 0, t45, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end