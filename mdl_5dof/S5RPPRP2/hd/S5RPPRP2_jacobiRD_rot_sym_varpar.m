...
function JRD_rot = S5RPPRP2_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPPRP2_jacobiRD_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'S5RPPRP2_jacobiRD_rot_sym_varpar: qJD has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPPRP2_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RPPRP2_jacobiRD_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	% OptimizationMode: 2
	% StartTime: 2019-12-29 15:56:47
	% EndTime: 2019-12-29 15:56:47
	% DurationCPUTime: 0.06s
	...
	t1 = [-t170, 0, 0, t167, 0; t168, 0, 0, t169, 0; 0, 0, 0, -t179, 0; -t181, 0, 0, 0, 0; t180, 0, 0, 0, 0; 0, 0, 0, 0, 0; t169, 0, 0, t168, 0; -t167, 0, 0, t170, 0; 0, 0, 0, t178, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,5);
end