...
function [T_mdh, T_stack] = S5RPPRP1_joint_trafo_rotmat_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
...
t38 = sin(pkin(7));
t37 = sin(pkin(8));
t1 = [t44, -t42, 0, 0; t42, t44, 0, 0; 0, 0, 1, pkin(5); t40, -t38, 0, pkin(1); t38, t40, 0, 0; 0, 0, 1, qJ(2); t39, -t37, 0, pkin(2); 0, 0, -1, -qJ(3); t37, t39, 0, 0; t43, -t41, 0, pkin(3); 0, 0, -1, -pkin(6); t41, t43, 0, 0; 1, 0, 0, pkin(4); 0, 1, 0, 0; 0, 0, 1, qJ(5);];
T_stack = t1;
