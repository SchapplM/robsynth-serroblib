...
t43 = V_base(6) * pkin(5) + V_base(2);
t44 = -V_base(5) * pkin(5) + V_base(3);
t50 = sin(qJ(1));
t52 = cos(qJ(1));
t35 = t52 * t43 + t50 * t44;
t38 = t50 * V_base(5) - t52 * V_base(6);
t45 = V_base(4) + qJD(1);
t28 = pkin(1) * t45 - qJ(2) * t38 + t35;
t34 = t50 * t43 - t44 * t52;
t39 = t50 * V_base(6) + t52 * V_base(5);
t31 = qJ(2) * t39 + t34;
t47 = sin(pkin(7));
t54 = cos(pkin(7));
t22 = t54 * t28 - t47 * t31;
