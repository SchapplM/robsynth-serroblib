...
t9 = [0.2e1 * t1 * t17 + 0.2e1 * t14 * t12 + 0.2e1 * t4 * t18 + 0.2e1 * t2 * t19 + 0.2e1 * t5 * t20 + (t26 + t27) * mrSges(4,3) * t62 + 0.2e1 * m(6) * (t6 * t1 + t14 * t16 + t3 * t2) + 0.2e1 * m(5) * (t8 * t4 + t7 * t5 + t22) + 0.2e1 * m(4) * (t27 * t46 + t22) + (0.2e1 * t25 * t13 + 0.2e1 * t16 * (mrSges(6,1) * t32 + mrSges(6,2) * t33) + (mrSges(5,1) * t32 + mrSges(5,2) * t33) * t30 * t62 + ((-0.2e1 * t8 * mrSges(5,3) - 0.2e1 * t6 * mrSges(6,3) - t34 * t53 + t39 * t51) * t33 + (0.2e1 * t3 * mrSges(6,3) + 0.2e1 * t7 * mrSges(5,3) + t53 * t32 * t40 + t52 * t39 + (-Ifges(5,1) - Ifges(6,1) + Ifges(5,2) + Ifges(6,2)) * t34) * t32) * qJD(4)) * t30; (-t13 - t61) * t31 + ((-t32 * t50 + t33 * t49) * qJD(4) + m(5) * (-t32 * t5 + t33 * t4 - t42 * t7 - t43 * t8 - t45) + m(6) * (t1 * t33 - t2 * t32 - t3 * t42 - t43 * t6)) * t30 + (mrSges(5,3) + mrSges(6,3)) * t26 * qJD(4) * (-t32 ^ 2 - t33 ^ 2); 0; (t49 * t32 + t50 * t33) * qJD(4) + m(6) * (t32 * t1 + t33 * t2 + (-t3 * t32 + t33 * t6) * qJD(4)) + m(5) * (t32 * t4 + t33 * t5 + (-t32 * t7 + t33 * t8) * qJD(4)); 0; 0; t5 * mrSges(5,1) - t4 * mrSges(5,2) - t1 * mrSges(6,2) + t35 * t2 + (-t51 * t33 + (mrSges(6,3) * pkin(4) - t52) * t32) * t44; -t23 + ((-mrSges(5,1) - t60) * t33 + t54 * t32) * t44; (-t54 * t33 + (-mrSges(5,1) - t35) * t32) * qJD(4); 0; t61; 0; 0; 0; 0;];
