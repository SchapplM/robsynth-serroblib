...
t1 = qJD(2) ^ 2 * t83 + m(6) * (t55 ^ 2 + t56 ^ 2 + t59 ^ 2) / 0.2e1 + m(5) * (t57 ^ 2 + t58 ^ 2 + t84) / 0.2e1 + m(4) * (t66 ^ 2 + t67 ^ 2 + t84) / 0.2e1 + (t57 * mrSges(5,1) + t55 * mrSges(6,1) - t58 * mrSges(5,2) - t56 * mrSges(6,2) + (Ifges(6,3) / 0.2e1 + Ifges(5,3) / 0.2e1) * t69) * t69 + ((-t67 * mrSges(4,1) + t66 * mrSges(4,3) + Ifges(4,2) * t81 / 0.2e1) * t73 + (t67 * mrSges(4,2) + t64 * mrSges(4,3) + (t64 * mrSges(5,2) + t59 * mrSges(6,2) - t57 * mrSges(5,3) - t55 * mrSges(6,3) + (Ifges(6,1) / 0.2e1 + Ifges(5,1) / 0.2e1) * t76 * t82 + (Ifges(5,5) + Ifges(6,5)) * t69) * t76 + (t64 * mrSges(5,1) + t59 * mrSges(6,1) - t58 * mrSges(5,3) - t56 * mrSges(6,3) + (-Ifges(6,6) - Ifges(5,6)) * t69 + ((Ifges(6,2) / 0.2e1 + Ifges(5,2) / 0.2e1) * t75 + (-Ifges(5,4) - Ifges(6,4)) * t76) * t82) * t75) * t71 + (Ifges(2,3) / 0.2e1 + Ifges(3,3) / 0.2e1 + (t74 * mrSges(3,1) - t72 * mrSges(3,2) + (t72 ^ 2 + t74 ^ 2) * t83 * pkin(1)) * pkin(1) + (Ifges(4,4) * t73 + Ifges(4,1) * t71 / 0.2e1) * t71) * qJD(1)) * qJD(1);
T = t1;
