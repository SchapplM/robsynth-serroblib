...
function JgD_rot = S5RRRRP10_jacobigD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),zeros(5,1),uint8(0),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP10_jacobigD_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'S5RRRRP10_jacobigD_rot_sym_varpar: qJD has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP10_jacobigD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'S5RRRRP10_jacobigD_rot_sym_varpar: pkin has to be [9x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t166 = t158 * t173 + t172;
	t165 = -t158 * t174 + t171;
	t1 = [0, t164 * t170, t168 * qJD(1) + t165 * qJD(2), (t161 * t157 * t159 + t165 * t162) * qJD(3) - t167 * t169 + (-t166 * t159 - t162 * t175) * qJD(1), 0; 0, t161 * t170, t167 * qJD(1) + t166 * qJD(2), (-t159 * t175 + t166 * t162) * qJD(3) + t168 * t169 + (t165 * t159 - t161 * t176) * qJD(1), 0; 0, 0, t157 * qJD(2) * t160, t157 * t163 * t169 + (t158 * t159 + t160 * t176) * qJD(3), 0;];
	JgD_rot = t1;
else
	JgD_rot=NaN(3,5);
end