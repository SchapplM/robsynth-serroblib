...
t7 = sin(t12);
t9 = cos(t12);
t28 = m(5) * pkin(3) + t16 * mrSges(5,1) - t14 * mrSges(5,2) + mrSges(4,1) + m(6) * (pkin(4) * t16 + pkin(3)) + t9 * mrSges(6,1) - t7 * mrSges(6,2);
...
t2 = cos(t6);
t1 = sin(t6);
t3 = (-m(3) * t22 + mrSges(2,1) * t17 + t10 * mrSges(3,1) - mrSges(2,2) * t15 - t8 * mrSges(3,2) - mrSges(1,3) + t30 * r_base(3) + t29 * (-pkin(2) * t10 + t22) + t28 * t2 + t27 * t1) * g(3) + (-m(3) * t25 - mrSges(2,1) * t15 - t8 * mrSges(3,1) - mrSges(2,2) * t17 - t10 * mrSges(3,2) - mrSges(1,2) + t30 * r_base(2) + t29 * (pkin(2) * t8 + t25) + t27 * t2 - t28 * t1) * g(2) + (-m(1) * r_base(1) - m(2) * t26 - m(3) * t24 - t7 * mrSges(6,1) - mrSges(5,2) * t16 - t9 * mrSges(6,2) - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) + (-m(6) * pkin(4) - mrSges(5,1)) * t14 + t29 * (qJ(3) + t24)) * g(1);
U = t3;
