...
t585 = sin(qJ(1));
t589 = cos(qJ(1));
t563 = t585 * g(1) - t589 * g(2);
t557 = qJDD(1) * pkin(1) + t563;
t564 = -t589 * g(1) - t585 * g(2);
t590 = qJD(1) ^ 2;
t558 = -t590 * pkin(1) + t564;
t584 = sin(qJ(2));
t588 = cos(qJ(2));
...
t471 = m(2) * t563 + qJDD(1) * mrSges(2,1) - t590 * mrSges(2,2) + t474;
t602 = -t584 * t481 + t588 * t482;
t472 = m(2) * t564 - t590 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t602;
t606 = t589 * t471 + t585 * t472;
t492 = t587 * t496 + t583 * t497;
t490 = m(4) * t579 + t492;
t603 = -t585 * t471 + t589 * t472;
...
t593 = mrSges(2,1) * t563 - mrSges(2,2) * t564 + Ifges(2,3) * qJDD(1) + pkin(1) * t474 + t594;
...
t466 = -mrSges(3,2) * g(3) - mrSges(3,3) * t540 + Ifges(3,5) * t574 - t572 * Ifges(3,6) - qJ(3) * t484 + t581 * t467 - t580 * t475;
t465 = mrSges(3,1) * g(3) + mrSges(3,3) * t541 + t572 * Ifges(3,5) + Ifges(3,6) * t574 - pkin(2) * t490 + qJ(3) * t601 + t580 * t467 + t581 * t475;
t464 = -mrSges(2,2) * g(3) - mrSges(2,3) * t563 + Ifges(2,5) * qJDD(1) - t590 * Ifges(2,6) - pkin(6) * t474 - t584 * t465 + t588 * t466;
t463 = Ifges(2,6) * qJDD(1) + t590 * Ifges(2,5) + mrSges(2,1) * g(3) + mrSges(2,3) * t564 + t584 * t466 + t588 * t465 - pkin(1) * (-m(3) * g(3) + t490) + pkin(6) * t602;
t1 = [-m(1) * g(1) + t603; -m(1) * g(2) + t606; (-m(1) - m(2) - m(3)) * g(3) + t490; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t606 - t585 * t463 + t589 * t464; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t603 + t589 * t463 + t585 * t464; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t593; t593; t594; t490; t609; -t595;];
tauJB = t1;
