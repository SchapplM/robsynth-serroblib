...
% OptimizationMode: 2
% StartTime: 2022-01-20 12:01:50
% EndTime: 2022-01-20 12:01:57
...
t202 = sin(qJ(1));
t207 = cos(qJ(1));
t182 = t202 * g(1) - t207 * g(2);
t179 = qJDD(1) * pkin(1) + t182;
t183 = -t207 * g(1) - t202 * g(2);
t208 = qJD(1) ^ 2;
t180 = -t208 * pkin(1) + t183;
t201 = sin(qJ(2));
t206 = cos(qJ(2));
...
t223 = t199 * t138;
t226 = pkin(4) * t187;
t131 = qJDD(4) * pkin(4) - t171 * pkin(9) - t223 + (pkin(9) * t222 + t199 * t226 - g(3)) * t204;
t135 = -t199 * g(3) + t204 * t138;
...
t211 = mrSges(2,1) * t182 - mrSges(2,2) * t183 + Ifges(2,3) * qJDD(1) + pkin(1) * t94 + t212;
t95 = mrSges(4,1) * g(3) + mrSges(4,3) * t141 + t187 * Ifges(4,5) + Ifges(4,6) * t188 - pkin(3) * t111 - t227;
t92 = m(2) * t183 - t208 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t221;
t91 = m(2) * t182 + qJDD(1) * mrSges(2,1) - t208 * mrSges(2,2) + t94;
t90 = -mrSges(4,2) * g(3) - mrSges(4,3) * t140 + Ifges(4,5) * t188 - t187 * Ifges(4,6) - pkin(8) * t111 + t204 * t106 - t199 * t97;
t89 = -mrSges(3,2) * g(3) - mrSges(3,3) * t159 + Ifges(3,5) * t193 - t191 * Ifges(3,6) - pkin(7) * t104 - t200 * t95 + t205 * t90;
t88 = Ifges(3,6) * t193 + t191 * Ifges(3,5) + mrSges(3,1) * g(3) + mrSges(3,3) * t160 + t200 * t90 + t205 * t95 - pkin(2) * (-m(4) * g(3) + t111) + pkin(7) * t220;
t87 = -mrSges(2,2) * g(3) - mrSges(2,3) * t182 + Ifges(2,5) * qJDD(1) - t208 * Ifges(2,6) - pkin(6) * t94 - t201 * t88 + t206 * t89;
t86 = Ifges(2,6) * qJDD(1) + t208 * Ifges(2,5) + mrSges(2,3) * t183 + t201 * t89 + t206 * t88 - pkin(1) * t111 + pkin(6) * t221 + (mrSges(2,1) - pkin(1) * (-m(3) - m(4))) * g(3);
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t207 * t87 - t202 * t86 - pkin(5) * (t202 * t92 + t207 * t91), t87, t89, t90, t106, t119; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + t202 * t87 + t207 * t86 + pkin(5) * (-t202 * t91 + t207 * t92), t86, t88, t95, t97, t118; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t211, t211, t212, t215, t227, -t213;];
m_new = t1;
