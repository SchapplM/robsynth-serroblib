...
t2 = [t80 + m(3) * (t66 ^ 2 + t70 ^ 2) * pkin(1) ^ 2 + m(5) * (t88 * t29 ^ 2 + t28 ^ 2) + m(6) * (t24 ^ 2 + t3 ^ 2 + t4 ^ 2) + m(4) * (t30 ^ 2 + t31 ^ 2) + 0.2e1 * t25 + 0.2e1 * t22 + 0.2e1 * t23 + 0.2e1 * t16 + 0.2e1 * t5 - 0.2e1 * t91 + 0.2e1 * t1 + Ifges(2,3) + 0.2e1 * t77 + t3 * t87; t100 + (-t31 - t97) * mrSges(4,2) + m(5) * (t52 * t28 + t29 * t84) + t80 + t77 + m(6) * (t13 * t3 + t14 * t4 + t43 * t24) + m(4) * (t30 * t69 + t31 * t65) * pkin(2) + (-t13 - t3) * t90 + t101; -0.2e1 * t86 + t13 * t87 + 0.2e1 * t32 + 0.2e1 * t41 + 0.2e1 * t42 + 0.2e1 * t57 + 0.2e1 * t6 + 0.2e1 * t9 + m(6) * (t13 ^ 2 + t14 ^ 2 + t43 ^ 2) + m(5) * (t88 * t51 ^ 2 + t52 ^ 2) + m(4) * (t65 ^ 2 + t69 ^ 2) * pkin(2) ^ 2 + t80; t75 + m(5) * (t88 * t29 * pkin(8) - pkin(3) * t28) + m(6) * (t20 * t3 + t21 * t4 + t54 * t24) - t91 + (-t20 - t3) * t90 + t101; t75 + m(5) * (-pkin(3) * t52 + pkin(8) * t84) + m(6) * (t20 * t13 + t21 * t14 + t54 * t43) + (-t13 - t20) * t90 - t86 + t100; t20 * t87 - 0.2e1 * t98 + 0.2e1 * t10 + 0.2e1 * t12 + 0.2e1 * t55 + 0.2e1 * t56 + m(6) * (t20 ^ 2 + t21 ^ 2 + t54 ^ 2) + m(5) * (t88 * pkin(8) ^ 2 + pkin(3) ^ 2) + t83; t82 * t29 + (-t85 + m(6) * (t3 * t67 + t4 * t63)) * pkin(4) + t81 + t102; t82 * t51 + (-t85 + m(6) * (t13 * t67 + t14 * t63)) * pkin(4) + t79 + t102; t82 * pkin(8) + (-t85 + m(6) * (t20 * t67 + t21 * t63)) * pkin(4) + t78 + t102; Ifges(5,3) + Ifges(6,3) + m(6) * (t63 ^ 2 + t67 ^ 2) * pkin(4) ^ 2 + 0.2e1 * t76; t81; t79; t78; Ifges(6,3) + t76; Ifges(6,3);];
