...
t441 = sin(qJ(1));
t446 = cos(qJ(1));
t426 = -g(2) * t446 - g(3) * t441;
t423 = qJDD(1) * pkin(1) + t426;
t425 = -g(2) * t441 + t446 * g(3);
t447 = qJD(1) ^ 2;
t424 = -pkin(1) * t447 + t425;
t440 = sin(qJ(2));
t445 = cos(qJ(2));
...
t380 = qJDD(4) * pkin(4) - pkin(9) * t415 - t460 + (pkin(9) * t456 + t438 * t461 - g(1)) * t443;
t384 = -g(1) * t438 + t443 * t387;
t416 = t428 * t443 - t438 * t456;
t422 = qJD(4) * pkin(4) - pkin(9) * t459;
t436 = t443 ^ 2;
...
t421 = -qJD(4) * mrSges(5,2) + mrSges(5,3) * t458;
t366 = m(5) * t383 + qJDD(4) * mrSges(5,1) - mrSges(5,3) * t415 + qJD(4) * t421 - t414 * t459 + t368;
t420 = qJD(4) * mrSges(5,1) - mrSges(5,3) * t459;
t451 = -t376 * t437 + t442 * t377;
t367 = m(5) * t384 - qJDD(4) * mrSges(5,2) + mrSges(5,3) * t416 - qJD(4) * t420 + t414 * t458 + t451;
...
t382 = t422 * t459 - pkin(4) * t416 + (-pkin(9) * t436 - pkin(8)) * t427 + t450;
t449 = m(6) * t382 - t391 * mrSges(6,1) + mrSges(6,2) * t392 - t410 * t405 + t406 * t411;
t448 = -m(5) * t386 + t416 * mrSges(5,1) - mrSges(5,2) * t415 - t420 * t459 + t421 * t458 - t449;
...
t454 = -t440 * t355 + t445 * t356;
t347 = m(2) * t425 - mrSges(2,1) * t447 - qJDD(1) * mrSges(2,2) + t454;
t349 = t445 * t355 + t440 * t356;
t348 = m(2) * t426 + qJDD(1) * mrSges(2,1) - mrSges(2,2) * t447 + t349;
t457 = t441 * t347 + t446 * t348;
t362 = t443 * t366 + t438 * t367;
t455 = -t347 * t446 + t441 * t348;
...
t358 = mrSges(5,2) * t386 - mrSges(5,3) * t383 + Ifges(5,1) * t415 + Ifges(5,4) * t416 + Ifges(5,5) * qJDD(4) - pkin(9) * t368 - qJD(4) * t408 - t369 * t437 + t370 * t442 + t407 * t458;
t351 = -mrSges(5,1) * t386 + mrSges(5,3) * t384 + Ifges(5,4) * t415 + Ifges(5,2) * t416 + Ifges(5,6) * qJDD(4) - pkin(4) * t449 + pkin(9) * t451 + qJD(4) * t409 + t442 * t369 + t437 * t370 - t407 * t459;
t350 = Ifges(4,6) * t428 + t427 * Ifges(4,5) + mrSges(4,1) * g(1) + mrSges(4,3) * t389 - Ifges(5,5) * t415 - Ifges(5,6) * t416 - Ifges(5,3) * qJDD(4) - mrSges(5,1) * t383 + mrSges(5,2) * t384 - Ifges(6,5) * t392 - Ifges(6,6) * t391 - Ifges(6,3) * t432 - t411 * t394 + t410 * t395 - mrSges(6,1) * t378 + mrSges(6,2) * t379 - pkin(4) * t368 - pkin(3) * t362 + (-t408 * t438 + t409 * t443) * t429;
t343 = -mrSges(4,2) * g(1) - mrSges(4,3) * t388 + Ifges(4,5) * t428 - Ifges(4,6) * t427 - pkin(8) * t362 - t351 * t438 + t358 * t443;
t342 = -mrSges(3,2) * g(1) - mrSges(3,3) * t403 + Ifges(3,5) * t433 - Ifges(3,6) * t431 - pkin(7) * t357 + t343 * t444 - t350 * t439;
t341 = Ifges(3,6) * t433 + t431 * Ifges(3,5) + mrSges(3,1) * g(1) + mrSges(3,3) * t404 + t439 * t343 + t444 * t350 - pkin(2) * (-m(4) * g(1) + t362) + pkin(7) * t453;
t340 = -mrSges(2,2) * g(1) - mrSges(2,3) * t426 + Ifges(2,5) * qJDD(1) - Ifges(2,6) * t447 - pkin(6) * t349 - t341 * t440 + t342 * t445;
t339 = Ifges(2,6) * qJDD(1) + t447 * Ifges(2,5) + mrSges(2,3) * t425 + t440 * t342 + t445 * t341 - pkin(1) * t362 + pkin(6) * t454 + (-pkin(1) * t462 + mrSges(2,1)) * g(1);
t1 = [(-m(1) - m(2) + t462) * g(1) + t362; -m(1) * g(2) + t457; -m(1) * g(3) + t455; pkin(1) * t349 + pkin(2) * t357 + mrSges(3,1) * t403 - mrSges(3,2) * t404 + t438 * t358 + t443 * t351 + pkin(3) * t448 + pkin(8) * t452 + mrSges(4,1) * t388 - mrSges(4,2) * t389 + mrSges(2,1) * t426 - mrSges(2,2) * t425 + Ifges(2,3) * qJDD(1) + Ifges(3,3) * t433 + Ifges(4,3) * t428 - mrSges(1,2) * g(3) + mrSges(1,3) * g(2); mrSges(1,1) * g(3) - mrSges(1,3) * g(1) - pkin(5) * t455 + t446 * t339 + t441 * t340; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + pkin(5) * t457 + t441 * t339 - t446 * t340;];
tauB = t1;
