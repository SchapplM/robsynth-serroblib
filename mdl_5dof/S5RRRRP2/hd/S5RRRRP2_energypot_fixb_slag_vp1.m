...
t34 = sin(t43);
t36 = cos(t43);
t51 = rSges(5,1) * t36 - rSges(5,2) * t34 + t33;
t50 = -rSges(6,2) * t34 + t59 * t36 + t33;
t44 = qJ(1) + qJ(2);
t37 = cos(t44);
t35 = sin(t44);
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (t48 * rSges(2,1) - t46 * rSges(2,2)) + g(2) * (t46 * rSges(2,1) + t48 * rSges(2,2)) + g(3) * (pkin(5) + rSges(2,3))) - m(3) * (g(1) * (t37 * rSges(3,1) - t35 * rSges(3,2) + t41) + g(2) * (t35 * rSges(3,1) + t37 * rSges(3,2) + t39) + g(3) * (rSges(3,3) + t58)) - m(4) * (g(3) * (t45 * rSges(4,1) + t47 * rSges(4,2) + t58) + (g(1) * t52 - g(2) * t57) * t37 + (g(1) * t57 + g(2) * t52) * t35 + t53) - m(5) * (g(3) * (t34 * rSges(5,1) + t36 * rSges(5,2) + t54) + (g(1) * t51 - g(2) * t56) * t37 + (g(1) * t56 + g(2) * t51) * t35 + t53) - m(6) * (g(3) * (t36 * rSges(6,2) + t59 * t34 + t54) + (g(1) * t50 - g(2) * t55) * t37 + (g(1) * t55 + g(2) * t50) * t35 + t53);
U = t1;
