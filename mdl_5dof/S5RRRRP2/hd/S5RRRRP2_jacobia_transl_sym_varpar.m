...
elseif link_index == 5
	...
	% Computational Cost: add. (113->20), mult. (71->22), div. (0->0), fcn. (73->8), ass. (0->20)
	...
	t23 = t11 * t12;
	t25 = r_i_i_C(2) * t13;
	t26 = r_i_i_C(1) * t23 + t12 * t25;
	t24 = t11 * r_i_i_C(2);
	t15 = cos(qJ(3)) * pkin(3);
	t22 = -t15 - pkin(2) - t27;
	t21 = -t24 + t27;
	t14 = cos(t18);
	t20 = (t22 + t24) * t14 - t28 * t12;
	t19 = r_i_i_C(2) * t23 + t22 * t12 + t28 * t14;
	t2 = -pkin(4) * t11 - sin(qJ(3)) * pkin(3);
	t1 = [0, 0, t15 + t21, t21, 0; -cos(qJ(1)) * pkin(1) + t20, t20, -t12 * t2 + t26, pkin(4) * t23 + t26, t14; -sin(qJ(1)) * pkin(1) + t19, t19, (-r_i_i_C(1) * t11 + t2 - t25) * t14, (-t29 * t11 - t25) * t14, t12;];
	Ja_transl = t1;
else
	Ja_transl=NaN(3,5);
end