...
t3 = sin(t13);
t5 = cos(t13);
t28 = -m(4) * pkin(2) - t17 * mrSges(4,1) + t15 * mrSges(4,2) - mrSges(3,1) + t30 * (t17 * pkin(3) + pkin(2)) + t33 * t5 + t34 * t3;
t19 = -pkin(8) - pkin(7);
t27 = m(4) * pkin(7) - m(5) * t19 + m(6) * (qJ(5) - t19) - mrSges(3,2) + mrSges(4,3) + mrSges(5,3) + mrSges(6,3);
t26 = pkin(5) + r_base(3);
t7 = pkin(6) + t26;
t18 = cos(qJ(1));
t16 = sin(qJ(1));
...
t6 = cos(t14);
t4 = sin(t14);
t1 = (-m(1) * r_base(3) - m(2) * t26 - t15 * mrSges(4,1) - t17 * mrSges(4,2) - mrSges(1,3) - mrSges(2,3) - mrSges(3,3) + t31 * t7 - t34 * t5 + t30 * (t15 * pkin(3) + t7) + t33 * t3) * g(3) + (-t16 * mrSges(2,1) - t18 * mrSges(2,2) - mrSges(1,2) + t32 * r_base(2) + t29 * (t16 * pkin(1) + r_base(2)) + t27 * t6 + t28 * t4) * g(2) + (-t18 * mrSges(2,1) + t16 * mrSges(2,2) - mrSges(1,1) + t32 * r_base(1) + t28 * t6 + t29 * (t18 * pkin(1) + r_base(1)) - t27 * t4) * g(1);
U = t1;
