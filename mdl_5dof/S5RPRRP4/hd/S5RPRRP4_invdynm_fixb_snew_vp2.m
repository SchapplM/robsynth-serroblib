...
% OptimizationMode: 2
% StartTime: 2019-12-05 18:05:39
% EndTime: 2019-12-05 18:05:51
% DurationCPUTime: 4.83s
% Computational Cost: add. (49974->283), mult. (120788->358), div. (0->0), fcn. (79109->8), ass. (0->116)
t266 = sin(qJ(1));
t269 = cos(qJ(1));
t247 = t266 * g(2) - t269 * g(3);
t270 = qJD(1) ^ 2;
t311 = -t270 * pkin(1) + qJDD(1) * qJ(2) + (2 * qJD(1) * qJD(2)) + t247;
t264 = sin(qJ(4));
t265 = sin(qJ(3));
t267 = cos(qJ(4));
t268 = cos(qJ(3));
...
t263 = cos(pkin(8));
t214 = -t262 * g(1) + t311 * t263;
t288 = -pkin(2) * t263 - pkin(6) * t262;
t239 = t288 * qJD(1);
t301 = t263 * qJD(1);
t202 = t239 * t301 + t214;
t248 = t269 * g(2) + t266 * g(3);
t278 = -t270 * qJ(2) + qJDD(2) - t248;
t215 = (-pkin(1) + t288) * qJDD(1) + t278;
t212 = t268 * t215;
t298 = t263 * qJDD(1);
t250 = qJDD(3) - t298;
t251 = qJD(3) - t301;
...
t280 = -mrSges(6,1) * t154 + mrSges(6,2) * t157 - Ifges(6,5) * t190 - Ifges(6,6) * t189 - Ifges(6,3) * t246 - t222 * t193;
t310 = mrSges(5,1) * t159 - mrSges(5,2) * t160 + Ifges(5,5) * t190 + Ifges(5,6) * t189 + Ifges(5,3) * t246 + pkin(4) * t151 + t222 * t194 - t280 + (-t196 - t195) * t221;
...
t281 = -mrSges(6,1) * t163 + mrSges(6,3) * t157 + Ifges(6,4) * t190 + Ifges(6,2) * t189 + Ifges(6,6) * t246 + t249 * t195;
t285 = m(6) * t163 - t189 * mrSges(6,1) + t190 * mrSges(6,2) - t221 * t206 + t222 * t209;
t137 = Ifges(5,4) * t190 + Ifges(5,2) * t189 + Ifges(5,6) * t246 + t249 * t196 - mrSges(5,1) * t169 + mrSges(5,3) * t160 - pkin(4) * t285 + qJ(5) * (-t246 * mrSges(6,2) - t249 * t209 + t295) + (-t192 - t191) * t222 + t281;
t279 = mrSges(6,2) * t163 - mrSges(6,3) * t154 + Ifges(6,1) * t190 + Ifges(6,4) * t189 + Ifges(6,5) * t246 + t221 * t191;
t141 = mrSges(5,2) * t169 - mrSges(5,3) * t159 + Ifges(5,1) * t190 + Ifges(5,4) * t189 + Ifges(5,5) * t246 - qJ(5) * t151 + t221 * t192 + (-t193 - t194) * t249 + t279;
...
t148 = t272 + m(3) * t213 + (-t302 + (-t235 + t283) * qJD(1)) * t262;
t290 = t263 * t133 - t262 * t148;
t286 = Ifges(3,5) * t262 + Ifges(3,6) * t263;
t135 = t268 * t139 + t265 * t140;
t284 = t217 * t268 + t218 * t265;
t233 = -qJDD(1) * pkin(1) + t278;
t236 = t286 * qJD(1);
t123 = mrSges(3,2) * t233 - mrSges(3,3) * t213 - pkin(6) * t135 + t287 * qJDD(1) - t265 * t126 + t268 * t127 + t236 * t301;
t125 = Ifges(3,2) * t298 - mrSges(3,1) * t233 + mrSges(3,3) * t214 - pkin(2) * t135 + (Ifges(3,4) * qJDD(1) + (-t236 - t284) * qJD(1)) * t262 + t309;
t276 = -m(3) * t233 + mrSges(3,1) * t298 - t135 + (t263 ^ 2 * t270 + t306) * mrSges(3,3);
t277 = -mrSges(2,2) * t247 + qJ(2) * t290 + t262 * t123 + t263 * t125 + pkin(1) * (-qJDD(1) * t307 + t276) + mrSges(2,1) * t248 + Ifges(2,3) * qJDD(1);
t131 = m(2) * t248 - t270 * mrSges(2,2) + (mrSges(2,1) - t307) * qJDD(1) + t276;
t130 = t262 * t133 + t263 * t148;
t128 = m(2) * t247 - t270 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t290;
t121 = mrSges(2,1) * g(1) + mrSges(2,3) * t247 + t270 * Ifges(2,5) - pkin(1) * t130 + (Ifges(2,6) - t286) * qJDD(1) + t308;
t120 = -mrSges(2,2) * g(1) - mrSges(2,3) * t248 + Ifges(2,5) * qJDD(1) - t270 * Ifges(2,6) - qJ(2) * t130 + t263 * t123 - t262 * t125;
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t277, t120, t123, t127, t141, -t249 * t193 + t279; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) - t266 * t120 - t269 * t121 - pkin(5) * (t269 * t128 - t266 * t131), t121, t125, t126, t137, -t222 * t191 + t281; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t269 * t120 - t266 * t121 + pkin(5) * (-t266 * t128 - t269 * t131), t277, t286 * qJDD(1) - t308, t284 * t303 - t309, t310, -t221 * t195 - t280;];
m_new = t1;
