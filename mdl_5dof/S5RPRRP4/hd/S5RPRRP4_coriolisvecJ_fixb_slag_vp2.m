...
t1 = [t84 * t162 + (t12 * t64 + t14 * t65 + t18 * t54 + t21 * t55) * mrSges(6,3) + (t19 * t64 + t20 * t65 + t28 * t54 + t29 * t55) * mrSges(5,3) + t119 * (-mrSges(5,1) * t55 - mrSges(5,2) * t54) - (-mrSges(5,1) * t112 - mrSges(6,1) * t34 + mrSges(5,3) * t7 + mrSges(6,3) * t2 - t196 * t54 + t220 * t55) * t107 - (mrSges(5,2) * t112 + mrSges(6,2) * t34 - mrSges(5,3) * t8 - mrSges(6,3) * t3 + t196 * t55 - t222 * t54) * t108 + t114 * (-mrSges(5,1) * t65 - mrSges(5,2) * t64) + t73 * (-mrSges(6,1) * t65 - mrSges(6,2) * t64) + (t219 * t65 - t221 * t64) * t126 / 0.2e1 - (-t196 * t64 + t220 * t65) * t102 / 0.2e1 + (t196 * t65 - t222 * t64) * t204 + t116 * t60 + t85 * t109 + t86 * t110 + t9 * t80 + t5 * t81 + t10 * t82 + t4 * t79 + t35 * t59 + m(5) * (t10 * t19 + t112 * t119 + t114 * t116 + t20 * t9 + t28 * t8 + t29 * t7) + m(6) * (t12 * t5 + t14 * t4 + t18 * t3 + t2 * t21 + t34 * t84 + t35 * t73) + (t52 / 0.2e1 - t50 / 0.2e1 + t53 / 0.2e1 - t51 / 0.2e1 + (-Ifges(6,6) / 0.2e1 - Ifges(5,6) / 0.2e1) * t55 - (-Ifges(6,5) / 0.2e1 - Ifges(5,5) / 0.2e1) * t54 + t211 + t213) * t143 + (((mrSges(4,2) * t138 + (-t100 * mrSges(4,3) + Ifges(4,6) * t143 + (0.2e1 * qJ(2) * mrSges(4,1) - 0.3e1 / 0.2e1 * t190) * t142) * qJD(3)) * t147 + (mrSges(4,1) * t138 + (t99 * mrSges(4,3) + Ifges(4,5) * t143 + (-0.2e1 * qJ(2) * mrSges(4,2) + 0.3e1 / 0.2e1 * t191 + (-0.3e1 / 0.2e1 * Ifges(4,1) + 0.3e1 / 0.2e1 * Ifges(4,2)) * t147) * t142) * qJD(3)) * t145) * t142 + 0.2e1 * (t216 + (m(3) * t177 + m(4) * t140) * qJ(2)) * qJD(2)) * qJD(1) + (t157 * mrSges(4,3) + qJD(2) * t111 + t210 * qJD(3)) * t142 + m(4) * (t100 * t66 + t67 * t99 + t85 * t92 + t86 * t91) - t217 * t64 / 0.2e1 + t218 * t65 / 0.2e1; t155 * qJD(3) - t148 * t216 + (-t155 * t143 + (-t111 - t59 - t60) * t142) * qJD(1) - m(3) * (t141 * t184 + t135) + t214 * t195 + t215 * t194 + (mrSges(6,3) + mrSges(5,3)) * (t121 * t55 - t154 * t54) + (t12 * t215 + t121 * t2 + t14 * t214 - t154 * t3 - t73 * t176) * m(6) + (-t114 * t176 + t121 * t7 - t154 * t8 + t19 * t215 + t20 * t214) * m(5) + (-t132 * t156 - t135 - t157) * m(4); (mrSges(6,3) * t186 + (t146 * t54 + t186) * mrSges(5,3) + (-t144 * t194 + t146 * t195) * qJD(4) + m(5) * (t144 * t7 + t146 * t8 + t171 * t20 - t172 * t19)) * pkin(3) + t149 + (t104 * t14 + t137 * t54) * mrSges(6,3) - t91 * t109 + t92 * t110 + t20 * t189 - m(5) * (t19 * t22 + t20 * t23) - t23 * t80 - t16 * t81 - t22 * t82 - t88 * t59 - t17 * t79 + ((t145 * (-Ifges(4,2) * t147 - t191) / 0.2e1 - qJ(2) * (mrSges(4,1) * t147 - mrSges(4,2) * t145) + (-Ifges(4,1) * t145 - t190) * t201) * t176 + t159 * qJD(3) + (-m(5) * t114 - t60) * t147 * pkin(3) - t210) * t176 + ((-t12 * t172 + t14 * t171 + t144 * t2) * pkin(3) + t137 * t3 - t12 * t16 - t14 * t17 - t73 * t88) * m(6) - t213; (t20 * mrSges(5,3) + t14 * mrSges(6,3) - pkin(4) * t59) * t104 + (-t73 * t200 - (-t12 + t13) * t14 + t3 * pkin(4)) * m(6) + t149 + pkin(4) * t54 * mrSges(6,3) - t19 * t80 + t14 * t81 + t20 * t82 - t13 * t79; t102 * t79 + t104 * t81 + 0.2e1 * (t34 / 0.2e1 + t14 * t207 + t12 * t204) * m(6) + t162;];
tauc = t1(:);
