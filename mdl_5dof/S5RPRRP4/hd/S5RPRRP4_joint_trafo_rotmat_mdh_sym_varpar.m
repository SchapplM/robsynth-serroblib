...
function [T_mdh, T_stack] = S5RPRRP4_joint_trafo_rotmat_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
...
t47 = cos(pkin(8));
t46 = sin(pkin(8));
t1 = [t53, -t50, 0, 0; t50, t53, 0, 0; 0, 0, 1, pkin(5); t47, -t46, 0, pkin(1); 0, 0, -1, -qJ(2); t46, t47, 0, 0; t52, -t49, 0, pkin(2); 0, 0, -1, -pkin(6); t49, t52, 0, 0; t51, -t48, 0, pkin(3); t48, t51, 0, 0; 0, 0, 1, pkin(7); 1, 0, 0, pkin(4); 0, 1, 0, 0; 0, 0, 1, qJ(5);];
T_stack = t1;
