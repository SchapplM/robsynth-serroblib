...
function JR_rot = S5RRPRP9_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRP9_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRP9_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRPRP9_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t77 = -t86 * t80 + t84 * t89;
	t76 = -t86 * t81 - t84 * t90;
	t1 = [-t77, -t81 * t88, 0, -t78, 0; t79, -t81 * t91, 0, t76, 0; 0, t89, 0, -t83 * t80, 0; -t91, t87, 0, 0, 0; t88, t84 * t85, 0, 0, 0; 0, t83, 0, 0, 0; t76, -t80 * t88, 0, t79, 0; t78, -t80 * t91, 0, t77, 0; 0, t90, 0, t83 * t81, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end