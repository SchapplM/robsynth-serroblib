...
%   see S5RRPRP9_invdynJ_fixb_regmin2vec.m
% MDP [25x1]
...
function tauJ = S5RRPRP9_invdynJ_fixb_mdp_slag_vr(RV, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(71,1), zeros(25,1)}
assert(isreal(MDP) && all(size(MDP) == [25 1]), ...
  'S5RRPRP9_invdynJ_fixb_mdp_slag_vr: MDP has to be [25x1] (double)'); 
