% Umwandlung der Kinematikparameter von S5RRPRP9V1 zu S5RRPRP9
% Eingabe:
% pkin_var (6x1) double
...
%
% Siehe auch: S5RRPRP9_structural_kinematic_parameters.m
function pkin_gen = S5RRPRP9V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(8,1);
