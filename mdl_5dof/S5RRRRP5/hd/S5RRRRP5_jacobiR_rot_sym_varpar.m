...
function JR_rot = S5RRRRP5_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRRRP5_jacobiR_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRRRP5_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRRRP5_jacobiR_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t72 = t77 * t74;
	t71 = t76 * t74;
	t1 = [-t71, -t78, -t78, -t78, 0; t72, -t79, -t79, -t79, 0; 0, t74, t74, t74, 0; t77, 0, 0, 0, 0; t76, 0, 0, 0, 0; 0, 0, 0, 0, 0; -t79, t72, t72, t72, 0; t78, t71, t71, t71, 0; 0, t73, t73, t73, 0;];
	JR_rot = t1;
else
	JR_rot=NaN(9,5);
end