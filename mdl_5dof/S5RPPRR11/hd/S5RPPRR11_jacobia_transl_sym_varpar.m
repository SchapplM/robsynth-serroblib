...
elseif link_index == 3
	...
	t2 = cos(qJ(1));
	t1 = sin(qJ(1));
	t5 = [-t3 * t1 + t4 * t2, t1, t2, 0, 0; t4 * t1 + t3 * t2, -t2, t1, 0, 0; 0, 0, 0, 0, 0;];
	Ja_transl = t5;
elseif link_index == 4
	%% Symbolic Calculation
	% From jacobia_transl_4_floatb_twist_matlab.m
	% OptimizationMode: 2
	% StartTime: 2019-12-29 16:27:01
	% EndTime: 2019-12-29 16:27:02
	% DurationCPUTime: 0.13s
	...
	t4 = cos(qJ(1));
	t2 = sin(qJ(1));
	t9 = [-t2 * t5 + t4 * t8, t2, t4, t7 * t4, 0; t2 * t8 + t4 * t5, -t4, t2, t7 * t2, 0; 0, 0, 0, t6, 0;];
	Ja_transl = t9;
elseif link_index == 5
	%% Symbolic Calculation
