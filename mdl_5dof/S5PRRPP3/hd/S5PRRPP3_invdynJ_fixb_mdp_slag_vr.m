...
%   see S5PRRPP3_invdynJ_fixb_regmin2vec.m
% MDP [19x1]
...
function tauJ = S5PRRPP3_invdynJ_fixb_mdp_slag_vr(RV, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(57,1), zeros(19,1)}
assert(isreal(MDP) && all(size(MDP) == [19 1]), ...
  'S5PRRPP3_invdynJ_fixb_mdp_slag_vr: MDP has to be [19x1] (double)'); 
