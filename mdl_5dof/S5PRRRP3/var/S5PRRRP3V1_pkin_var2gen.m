% Umwandlung der Kinematikparameter von S5PRRRP3V1 zu S5PRRRP3
% Eingabe:
% pkin_var (6x1) double
...
%
% Siehe auch: S5PRRRP3_structural_kinematic_parameters.m
function pkin_gen = S5PRRRP3V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(8,1);
