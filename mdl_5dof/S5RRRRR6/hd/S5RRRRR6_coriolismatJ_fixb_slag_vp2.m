...
% OptimizationMode: 2
% StartTime: 2019-12-05 19:00:08
% EndTime: 2019-12-05 19:00:19
...
t223 = -t250 * t255 - t254 * t251;
t249 = sin(qJ(5));
t253 = cos(qJ(5));
t175 = t222 * t249 - t223 * t253;
t300 = t253 * t222 + t223 * t249;
...
t219 = t375 * t251;
t220 = t375 * t255;
t166 = -t219 * t250 + t254 * t220;
t388 = pkin(9) * t222;
t128 = t166 + t388;
t218 = t223 * pkin(9);
t430 = -t254 * t219 - t250 * t220;
t443 = t430 + t218;
...
t235 = t399 * t251;
t236 = t399 * t255;
t185 = t235 * t250 - t254 * t236;
t147 = t185 + t388;
t429 = t254 * t235 + t250 * t236;
t444 = t429 + t218;
...
t244 = -t255 * pkin(3) - pkin(2);
t256 = cos(qJ(2));
t393 = pkin(1) * t256;
t229 = t244 - t393;
t189 = -t222 * pkin(4) + t244;
t186 = t189 - t393;
...
t61 = t205 * mrSges(6,2) + t197;
t341 = qJD(5) * t61;
t15 = t451 + t462;
t334 = t15 * qJD(1);
t269 = (t454 * mrSges(4,3) - mrSges(3,2)) * t256 + (-mrSges(3,1) + t104 + t177 + t426) * t252;
t21 = m(6) * (t130 * t481 + t131 * t74) + m(5) * (t166 * t193 + t192 * t430) + (t186 * t394 + t229 * t395 + m(4) * (t427 * t241 + t243 * t252) + t269) * pkin(1) + t416;
t328 = t21 * qJD(1);
t316 = t205 * t366;
t314 = t253 * t366;
...
t1 = (mrSges(4,2) * t311 + t246) * t255 + t257 + (mrSges(4,1) * t311 + t278) * t251 - t485;
t7 = m(5) * t230 + m(6) * t148 - pkin(2) * t232 + t452 + t517;
t294 = t1 * qJD(1) + t7 * qJD(2);
t293 = -t157 + t298;
t10 = -t189 * t477 + t261 + t517;
t258 = t422 + t510;
t286 = m(6) * (t130 * t253 + t131 * t249);
t3 = t258 + 0.2e1 * (-t286 / 0.4e1 + m(6) * t301 / 0.4e1) * pkin(4) - t423;
t292 = t3 * qJD(1) + t10 * qJD(2);
t18 = t451 + t461;
t8 = t263 - t318;
t291 = t8 * qJD(1) + t18 * qJD(2);
...
t281 = -t12 * qJD(1) - t14 * qJD(2) - t60 * qJD(3);
t280 = t61 * qJD(3);
t228 = (t253 * mrSges(6,2) + t346) * pkin(4);
t49 = -t207 / 0.2e1 + (t209 / 0.2e1 + t296) * mrSges(6,2) + t289;
t274 = -qJD(3) * t49 + qJD(4) * t228;
t271 = t205 * t310 + t298 + t398 - t417;
t270 = t223 * mrSges(5,3) * t392 + Ifges(4,5) * t255 - Ifges(4,6) * t251 - t119 + t298 - t316;
t221 = t228 * qJD(5);
t50 = -t347 / 0.2e1 + t207 / 0.2e1 + t296 * mrSges(6,2) + t289;
t13 = t271 + (t282 + t299) * pkin(4) + t420 + t446;
t11 = t271 + (t283 + t299) * pkin(4) + t419 + t445;
t9 = t263 + t318;
t4 = t258 + t423 + (t301 * t413 + t286 / 0.2e1) * pkin(4);
t2 = t257 - t232 * t393 / 0.2e1 + t428 + t485;
t16 = [qJD(2) * t21 + qJD(3) * t5 + qJD(4) * t6 + qJD(5) * t15, t2 * qJD(3) + t4 * qJD(4) + t9 * qJD(5) + t328 + (0.2e1 * (t130 * t480 + t131 * t98) * t413 + 0.2e1 * (t185 * t193 + t192 * t429) * t415 + (t189 * t394 + t244 * t395 + m(4) * (-pkin(2) * t252 + t427 * pkin(7)) + t269) * pkin(1) + t416) * qJD(2), t345 + t2 * qJD(2) + (t270 + m(6) * (-t205 * t74 + t206 * t481) + t426 * t241 + t513) * qJD(3) + t11 * qJD(4) + t521 + (-t313 + m(5) * (-t166 * t254 + t250 * t430)) * t362, t344 + t4 * qJD(2) + t11 * qJD(3) + (t293 + t513) * qJD(4) + t521 + (m(6) * t495 - t314) * t361, t334 + t9 * qJD(2) + (t487 + t482) * qJD(5) + t522 * t515; qJD(3) * t1 + qJD(4) * t3 + qJD(5) * t8 - t328, qJD(3) * t7 + qJD(4) * t10 + qJD(5) * t18, (t270 + m(6) * (-t205 * t98 + t206 * t480) + t426 * pkin(7) + t514) * qJD(3) + t13 * qJD(4) + t520 + (-t313 + m(5) * (-t185 * t254 + t250 * t429)) * t362 + t294, t13 * qJD(3) + (t293 + t514) * qJD(4) + t520 + (m(6) * t494 - t314) * t361 + t292, (t487 + t483) * qJD(5) + t291 + t522 * t516; -qJD(2) * t1 - qJD(4) * t12 - t345, -qJD(4) * t14 - t294, -qJD(4) * t60 - t341, (m(6) * (t249 * t209 + t253 * t284) * pkin(4) + t276) * qJD(4) + t50 * qJD(5) + t281, t50 * qJD(4) - t280 - t341; -qJD(2) * t3 + qJD(3) * t12 - t344, qJD(3) * t14 - t292, qJD(5) * t49 - t281, -t221, -t221 - t274; -qJD(2) * t8 - t334, -t291, -qJD(4) * t49 + t280, t274, 0;];
Cq = t16;
