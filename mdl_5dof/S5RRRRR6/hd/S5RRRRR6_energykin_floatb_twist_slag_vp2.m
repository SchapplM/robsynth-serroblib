...
t62 = cos(qJ(1));
t41 = t62 * t49 + t57 * t50;
t44 = t57 * V_base(5) - t62 * V_base(6);
t52 = V_base(4) + qJD(1);
t31 = pkin(1) * t52 - pkin(6) * t44 + t41;
t40 = t57 * t49 - t50 * t62;
t45 = t57 * V_base(6) + t62 * V_base(5);
t36 = pkin(6) * t45 + t40;
t56 = sin(qJ(2));
t61 = cos(qJ(2));
t27 = t56 * t31 + t61 * t36;
