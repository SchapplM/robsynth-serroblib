...
t40 = cos(t47);
t38 = sin(t47);
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (pkin(5) + rSges(2,3)) + g(2) * (-rSges(2,1) * t49 - rSges(2,2) * t51) + g(3) * (rSges(2,1) * t51 - t49 * rSges(2,2))) - m(3) * (g(1) * (rSges(3,3) + t62) + g(2) * (-rSges(3,1) * t38 - rSges(3,2) * t40 - t61) + g(3) * (rSges(3,1) * t40 - rSges(3,2) * t38 + t44)) - m(4) * (g(1) * (rSges(4,1) * t48 + rSges(4,2) * t50 + t62) + (g(2) * t60 + g(3) * t55) * t40 + (-g(2) * t55 + g(3) * t60) * t38 + t56) - m(5) * (g(1) * (rSges(5,1) * t37 + rSges(5,2) * t39 + t57) + (g(2) * t59 + g(3) * t54) * t40 + (-g(2) * t54 + g(3) * t59) * t38 + t56) - m(6) * (g(1) * (rSges(6,1) * t34 + rSges(6,2) * t35 + pkin(4) * t37 + t57) + (g(2) * t58 + g(3) * t53) * t40 + (-g(2) * t53 + g(3) * t58) * t38 + t56);
U = t1;
