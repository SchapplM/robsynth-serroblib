...
t55 = -pkin(8) - pkin(7);
t61 = m(4) * pkin(7) - m(5) * t55 + m(6) * (pkin(9) - t55) - mrSges(3,2) + mrSges(4,3) + mrSges(5,3) + mrSges(6,3);
t56 = pkin(6) + pkin(5);
t60 = t51 * pkin(3) + t56;
t54 = cos(qJ(1));
t52 = sin(qJ(1));
...
t42 = cos(t50);
t40 = sin(t50);
t1 = (-mrSges(1,3) - m(2) * pkin(5) - mrSges(2,3) - mrSges(3,3) - t51 * mrSges(4,1) - t53 * mrSges(4,2) - m(5) * t60 - t39 * mrSges(5,1) - t41 * mrSges(5,2) - m(6) * (pkin(4) * t39 + t60) - t36 * mrSges(6,1) - t37 * mrSges(6,2) + t64 * t56) * g(3) + (-t54 * mrSges(2,2) + t63 * t40 + t61 * t42 + t65 * t52 - mrSges(1,2)) * g(2) + (t52 * mrSges(2,2) - t61 * t40 + t63 * t42 + t65 * t54 - mrSges(1,1)) * g(1);
U = t1;
