...
% OptimizationMode: 2
% StartTime: 2022-01-20 12:08:04
% EndTime: 2022-01-20 12:08:07
...
t378 = sin(qJ(1));
t383 = cos(qJ(1));
t395 = t378 * g(1) - t383 * g(2);
t357 = qJDD(1) * pkin(1) + t395;
t391 = -t383 * g(1) - t378 * g(2);
t358 = -qJD(1) ^ 2 * pkin(1) + t391;
t377 = sin(qJ(2));
t382 = cos(qJ(2));
...
t313 = qJDD(3) * pkin(3) - t352 * pkin(8) - t397 + (pkin(8) * t396 + t376 * t400 - g(3)) * t381;
t325 = -t376 * g(3) + t381 * t335;
...
t1 = [Ifges(2,3) * qJDD(1) + mrSges(2,1) * t395 - mrSges(2,2) * t391 + pkin(1) * (t377 * (m(3) * t338 - t368 * mrSges(3,1) - t370 * mrSges(3,2) + t394) + t382 * (m(3) * t337 + t370 * mrSges(3,1) - t368 * mrSges(3,2) + t384)) + t388; t388; t385 + Ifges(4,3) * qJDD(3) + (t376 * t344 - t381 * t345) * t372 + Ifges(4,5) * t352 + Ifges(4,6) * t353 + mrSges(4,1) * t324 - mrSges(4,2) * t325 + pkin(3) * t271; t385; t387;];
tauJ = t1;
