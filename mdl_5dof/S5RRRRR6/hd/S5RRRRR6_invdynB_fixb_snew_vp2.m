...
t521 = sin(qJ(1));
t526 = cos(qJ(1));
t507 = -t526 * g(2) - t521 * g(3);
t501 = qJDD(1) * pkin(1) + t507;
t506 = -t521 * g(2) + t526 * g(3);
t527 = qJD(1) ^ 2;
t502 = -t527 * pkin(1) + t506;
t520 = sin(qJ(2));
t525 = cos(qJ(2));
...
t461 = qJDD(3) * pkin(3) - t496 * pkin(8) - t539 + (pkin(8) * t537 + t519 * t542 - g(1)) * t524;
t470 = -t519 * g(1) + t524 * t480;
...
t410 = m(2) * t506 - t527 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t535;
t412 = t520 * t415 + t525 * t434;
t411 = m(2) * t507 + qJDD(1) * mrSges(2,1) - t527 * mrSges(2,2) + t412;
t538 = t521 * t410 + t526 * t411;
t416 = t524 * t422 + t519 * t423;
t536 = -t526 * t410 + t521 * t411;
...
t404 = mrSges(3,1) * g(1) - Ifges(4,3) * qJDD(3) + (-t519 * t488 + t524 * t489) * t515 + t511 * Ifges(3,5) - Ifges(5,3) * t512 + Ifges(3,6) * t513 - Ifges(4,6) * t497 - Ifges(6,3) * t508 + t490 * t473 - t491 * t472 - Ifges(4,5) * t496 - t476 * t453 + mrSges(3,3) * t482 - Ifges(5,6) * t465 - Ifges(5,5) * t466 - mrSges(4,1) * t469 + mrSges(4,2) * t470 + t475 * t454 - mrSges(5,1) * t446 + mrSges(5,2) * t447 - Ifges(6,6) * t450 - Ifges(6,5) * t451 + mrSges(6,2) * t441 - mrSges(6,1) * t440 - pkin(4) * t430 - pkin(3) * t424 - pkin(2) * t416;
t403 = -mrSges(3,2) * g(1) - mrSges(3,3) * t481 + Ifges(3,5) * t513 - t511 * Ifges(3,6) - pkin(7) * t416 - t519 * t405 + t524 * t406;
t402 = -mrSges(2,2) * g(1) - mrSges(2,3) * t507 + Ifges(2,5) * qJDD(1) - t527 * Ifges(2,6) - pkin(6) * t412 + t525 * t403 - t520 * t404;
t401 = Ifges(2,6) * qJDD(1) + t527 * Ifges(2,5) + mrSges(2,1) * g(1) + mrSges(2,3) * t506 + t520 * t403 + t525 * t404 - pkin(1) * (-m(3) * g(1) + t416) + pkin(6) * t535;
t1 = [(-m(1) - m(2) - m(3)) * g(1) + t416; -m(1) * g(2) + t538; -m(1) * g(3) + t536; mrSges(2,1) * t507 + mrSges(3,1) * t481 - mrSges(1,2) * g(3) - mrSges(2,2) * t506 - mrSges(3,2) * t482 + mrSges(1,3) * g(2) + Ifges(2,3) * qJDD(1) + Ifges(3,3) * t513 + pkin(1) * t412 + pkin(2) * t528 + pkin(7) * t534 + t524 * t405 + t519 * t406; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) - pkin(5) * t536 + t526 * t401 + t521 * t402; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + pkin(5) * t538 + t521 * t401 - t526 * t402;];
tauB = t1;
