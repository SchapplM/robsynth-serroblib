...
t30 = cos(t34);
t29 = sin(t34);
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (pkin(5) + rSges(2,3)) + g(2) * (-t39 * rSges(2,1) - t41 * rSges(2,2)) + g(3) * (t41 * rSges(2,1) - t39 * rSges(2,2))) - m(3) * (g(1) * (rSges(3,3) + t48) + g(2) * (-t32 * rSges(3,1) - t33 * rSges(3,2) - t51) + g(3) * (t33 * rSges(3,1) - t32 * rSges(3,2) + t35)) - m(4) * (g(1) * (rSges(4,3) + t46) + g(2) * (-t29 * rSges(4,1) - t30 * rSges(4,2) + t45) + g(3) * (t30 * rSges(4,1) - t29 * rSges(4,2) + t47)) - m(5) * (g(1) * (t38 * rSges(5,1) + t40 * rSges(5,2) + t46) + (g(2) * t50 + g(3) * t44) * t30 + (-g(2) * t44 + g(3) * t50) * t29 + t42) - m(6) * (g(1) * (t40 * rSges(6,2) + t52 * t38 + t46) + (g(2) * t49 + g(3) * t43) * t30 + (-g(2) * t43 + g(3) * t49) * t29 + t42);
U = t1;
