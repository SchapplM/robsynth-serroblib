...
t206 = sin(qJ(1));
t209 = cos(qJ(1));
t184 = t206 * g(1) - t209 * g(2);
t176 = qJDD(1) * pkin(1) + t184;
t185 = -t209 * g(1) - t206 * g(2);
t210 = qJD(1) ^ 2;
t177 = -t210 * pkin(1) + t185;
t202 = sin(pkin(8));
t203 = cos(pkin(8));
t145 = t203 * t176 - t202 * t177;
t142 = qJDD(1) * pkin(2) + t145;
t146 = t202 * t176 + t203 * t177;
t143 = -t210 * pkin(2) + t146;
t205 = sin(qJ(3));
t208 = cos(qJ(3));
t138 = t205 * t142 + t208 * t143;
t191 = t193 ^ 2;
t135 = -t191 * pkin(3) + t192 * pkin(7) + t138;
t201 = -g(3) + qJDD(2);
t187 = t207 * t201;
t228 = qJD(5) * t193;
t236 = pkin(4) * t191;
...
t171 = t207 * t192 - t204 * t229;
t178 = qJD(4) * pkin(4) - qJ(5) * t234;
t200 = t207 ^ 2;
t128 = t171 * qJ(5) - qJD(4) * t178 - t200 * t236 + 0.2e1 * t207 * t228 + t132;
...
t121 = m(5) * t132 + t171 * mrSges(5,3) + t230 * qJD(4) + t235 * qJDD(4) + t169 * t233 + t226;
t221 = -t204 * t120 + t207 * t121;
t111 = m(4) * t138 - t191 * mrSges(4,1) - t192 * mrSges(4,2) + t221;
t137 = t208 * t142 - t205 * t143;
t219 = -t192 * pkin(3) - t137;
t134 = -t191 * pkin(7) + t219;
t130 = t178 * t234 - t171 * pkin(4) + qJDD(5) + (-qJ(5) * t200 - pkin(7)) * t191 + t219;
t220 = -m(6) * t130 + t171 * mrSges(6,1) + t181 * t233;
t213 = -m(5) * t134 + t171 * mrSges(5,1) + t235 * t170 + t182 * t233 + t230 * t234 + t220;
t115 = m(4) * t137 + t192 * mrSges(4,1) - t191 * mrSges(4,2) + t213;
t104 = t205 * t111 + t208 * t115;
t101 = m(3) * t145 + qJDD(1) * mrSges(3,1) - t210 * mrSges(3,2) + t104;
t222 = t208 * t111 - t205 * t115;
t102 = m(3) * t146 - t210 * mrSges(3,1) - qJDD(1) * mrSges(3,2) + t222;
t96 = t203 * t101 + t202 * t102;
t113 = t207 * t120 + t204 * t121;
t225 = m(4) * t201 + t113;
t223 = -t202 * t101 + t203 * t102;
...
t215 = mrSges(4,1) * t137 - mrSges(4,2) * t138 + Ifges(4,3) * t192 + pkin(3) * t213 + pkin(7) * t221 + t207 * t106 + t204 * t108;
t214 = mrSges(3,1) * t145 - mrSges(3,2) * t146 + Ifges(3,3) * qJDD(1) + pkin(2) * t104 + t215;
t212 = mrSges(2,1) * t184 - mrSges(2,2) * t185 + Ifges(2,3) * qJDD(1) + pkin(1) * t96 + t214;
t97 = -mrSges(4,1) * t201 + mrSges(4,3) * t138 + t191 * Ifges(4,5) + Ifges(4,6) * t192 - pkin(3) * t113 - t238;
t94 = m(2) * t185 - t210 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t223;
t93 = m(2) * t184 + qJDD(1) * mrSges(2,1) - t210 * mrSges(2,2) + t96;
t92 = mrSges(4,2) * t201 - mrSges(4,3) * t137 + Ifges(4,5) * t192 - t191 * Ifges(4,6) - pkin(7) * t113 - t204 * t106 + t207 * t108;
t91 = mrSges(3,2) * t201 - mrSges(3,3) * t145 + Ifges(3,5) * qJDD(1) - t210 * Ifges(3,6) - pkin(6) * t104 - t205 * t97 + t208 * t92;
t90 = -mrSges(3,1) * t201 + mrSges(3,3) * t146 + t210 * Ifges(3,5) + Ifges(3,6) * qJDD(1) - pkin(2) * t225 + pkin(6) * t222 + t205 * t92 + t208 * t97;
t89 = -mrSges(2,2) * g(3) - mrSges(2,3) * t184 + Ifges(2,5) * qJDD(1) - t210 * Ifges(2,6) - qJ(2) * t96 - t202 * t90 + t203 * t91;
t88 = Ifges(2,6) * qJDD(1) + t210 * Ifges(2,5) + mrSges(2,1) * g(3) + mrSges(2,3) * t185 + t202 * t91 + t203 * t90 - pkin(1) * (m(3) * t201 + t225) + qJ(2) * t223;
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t209 * t89 - t206 * t88 - pkin(5) * (t206 * t94 + t209 * t93), t89, t91, t92, t108, -qJD(4) * t153 + t216; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + t206 * t89 + t209 * t88 + pkin(5) * (-t206 * t93 + t209 * t94), t88, t90, t97, t106, -t151 * t234 + t218; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t212, t212, t214, t215, t238, -t155 * t233 - t217;];
m_new = t1;
