...
t3 = cos(t8);
t2 = sin(t8);
t1 = (-m(3) * t19 + mrSges(2,1) * t15 + t7 * mrSges(3,1) - t13 * mrSges(2,2) - t6 * mrSges(3,2) - mrSges(1,3) + t27 * r_base(3) + t25 * t3 + t26 * (-pkin(2) * t7 + t19) + t24 * t2) * g(3) + (-m(3) * t22 - t13 * mrSges(2,1) - t6 * mrSges(3,1) - mrSges(2,2) * t15 - t7 * mrSges(3,2) - mrSges(1,2) + t27 * r_base(2) + t26 * (pkin(2) * t6 + t22) + t24 * t3 - t25 * t2) * g(2) + (-m(1) * r_base(1) - m(2) * t23 - m(3) * t20 - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) + t29 * t14 + t26 * (pkin(6) + t20) - t28 * t12) * g(1);
U = t1;
