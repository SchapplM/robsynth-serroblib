...
t13 = [t6 * t78 + 0.2e1 * t9 * t20 + 0.2e1 * t71 - 0.2e1 * t7 * mrSges(4,2) + (t4 * t1 + t3 * t2 + t6 * t5) * t79 + 0.2e1 * m(5) * (t10 * t51 + t9 * t8) + 0.2e1 * m(4) * (-t49 * t8 + t61 * t7) + (t1 * t76 + t2 * t77 + (-t3 * t43 - t4 * t41) * t55) * mrSges(6,3) + 0.2e1 * t50 * t7 + 0.2e1 * t52 + t82; m(6) * (t1 * t41 + t2 * t43 + (-t3 * t41 + t4 * t43) * qJD(4)); 0; t71 + t52 + (-pkin(3) + t9) * t20 + (t6 + t31) * t19 + (-mrSges(4,2) + t50) * t7 + (pkin(4) * t22 + t62) * t57 + m(6) * (t24 * t1 + t11 * t4 + t12 * t3 + t21 * t2 + t31 * t5 + t6 * t54) + m(5) * (-pkin(3) * t8 + pkin(7) * t51) + ((t1 + t11) * t43 + (-t12 - t2) * t41 + ((-t21 - t3) * t43 + (-t24 - t4) * t41) * qJD(4)) * mrSges(6,3) + t45; m(6) * (t11 * t41 + t12 * t43 + (-t21 * t41 + t24 * t43) * qJD(4)); 0.2e1 * t22 * t54 + t31 * t78 - 0.2e1 * pkin(3) * t20 + (t24 * t11 + t21 * t12 + t31 * t54) * t79 + (t11 * t76 + t12 * t77 + (-t21 * t43 - t24 * t41) * t55) * mrSges(6,3) + t82; -t1 * mrSges(6,2) - t46 * t7 + t53 * t2 + ((-mrSges(5,1) * t10 - t74) * t43 + (mrSges(5,2) * t10 + t64) * t41) * qJD(4) + t60; (-t70 + (-mrSges(5,1) - t75) * t41) * qJD(4) - t19; -t11 * mrSges(6,2) + t53 * t12 + ((-mrSges(5,1) * pkin(7) - t74) * t43 + (mrSges(5,2) * pkin(7) + t64) * t41) * qJD(4) + t60; 0; m(6) * t5 + t19; 0; m(6) * t54 + t19; 0; 0;];
