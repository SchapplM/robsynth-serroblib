...
t5 = -t123 * t22 + t130;
t94 = t15 * (mrSges(6,1) * t90 + mrSges(6,2) * t92) * qJD(4) + (-t6 * mrSges(5,3) - t3 * mrSges(6,3)) * t90 + t5 * t132 + t21 * t99 + t2 * t92 * mrSges(6,3) - t31 * mrSges(4,2) + t19 * t107 + t153 * t32 + (t154 * t92 - t143 - t145) * t118 + ((Ifges(5,5) + Ifges(6,5)) * t92 + (-Ifges(5,6) - Ifges(6,6)) * t90) * qJD(4) ^ 2 / 0.2e1 - (t100 + t101 + t47 + t46) * t123 / 0.2e1 + (t49 + t48 + ((-0.2e1 * Ifges(5,2) - 0.2e1 * Ifges(6,2) + t154) * t90 + 0.3e1 * (Ifges(5,4) + Ifges(6,4)) * t92) * t85) * t122 / 0.2e1;
t84 = t92 * qJ(5);
t70 = pkin(7) * t92 + t84;
t69 = t131 * t90;
t60 = t107 * t85;
...
t1 = [t115 * t45 + (-t90 * t65 + t92 * t67 - t135) * t44 + m(5) * (t137 * t5 + t138 * t17 - t140 * t44 - t147 * t57 + t21 * t45 + t32 * t56) + m(4) * (-t114 * t32 + t127 * t31 - t38 * t45 + t39 * t44) + m(6) * (t10 * t8 + t13 * t7 + t15 * t26 + t19 * t37 + t2 * t24 + t23 * t3) + t94 + t37 * t50 + (t105 * mrSges(5,3) + (m(5) * t105 - t92 * t65 - t90 * t67) * t57 + (-t10 * t92 - t13 * t90 + (-t23 * t92 - t24 * t90) * t85) * mrSges(6,3)) * qJD(4) + t56 * t51 + t26 * t60 + t8 * t64 + t7 * t66; m(5) * (t5 * t90 + t6 * t92) + m(6) * (t2 * t90 + t3 * t92) + (m(5) * t104 + t102 + (mrSges(5,3) + mrSges(6,3)) * t85 * (-t90 ^ 2 - t92 ^ 2) + t149) * qJD(4); ((-t141 - pkin(7) * t65 + (-t69 * t85 - t10) * mrSges(6,3)) * t92 + (-t139 + pkin(4) * t60 - pkin(7) * t67 + (-t70 * t85 - t13) * mrSges(6,3)) * t90) * qJD(4) + (t135 - t149) * t38 + (-t115 - t60) * t39 + t94 + t81 * t50 - pkin(3) * t51 + t59 * t64 + t58 * t66 + (t10 * t59 - t106 * t38 + t13 * t58 + t19 * t81 + t2 * t70 + t3 * t69 + (t119 - t39) * t15) * m(6) + ((qJD(4) * t105 + t5 * t92 - t147) * pkin(7) - t32 * pkin(3) - t104 * t38 - t21 * t39) * m(5); t6 * mrSges(5,1) - t5 * mrSges(5,2) - t2 * mrSges(6,2) - t12 * t66 - t16 * t67 + t17 * t65 + (m(6) * pkin(4) + mrSges(6,1)) * t3 + (-m(6) * (-t10 + t12) + t64) * t13 + ((-t75 / 0.2e1 - t76 / 0.2e1 - t49 / 0.2e1 - t48 / 0.2e1 + t10 * mrSges(6,3) + t141 - t15 * mrSges(6,2) - t21 * mrSges(5,2) + (Ifges(6,5) / 0.2e1 + Ifges(5,5) / 0.2e1 - pkin(4) * mrSges(6,3)) * qJD(4)) * t92 + (t46 / 0.2e1 + t47 / 0.2e1 + t13 * mrSges(6,3) + t139 - t15 * mrSges(6,1) - t21 * mrSges(5,1) + (Ifges(6,4) / 0.2e1 + Ifges(5,4) / 0.2e1) * t134 + (-Ifges(6,6) / 0.2e1 - Ifges(5,6) / 0.2e1) * qJD(4) + (-m(6) * t15 - t60) * pkin(4) + (Ifges(6,2) / 0.2e1 + Ifges(5,2) / 0.2e1 - Ifges(6,1) / 0.2e1 - Ifges(5,1) / 0.2e1) * t133) * t90) * t85; m(6) * t19 + (t90 * t64 - t92 * t66 - t102) * t85 + t50;];
tauc = t1(:);
