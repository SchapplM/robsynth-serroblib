...
function Ja_transl = S5RRPRR11_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRR11_jacobia_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RRPRR11_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRR11_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRPRR11_jacobia_transl_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 5
	...
	t30 = pkin(4) * t18 + qJ(3);
	t21 = cos(qJ(4));
	t35 = t21 * pkin(4) + pkin(2) + pkin(3);
	t26 = t30 * t19 + t35 * t22;
	t38 = pkin(1) + t26;
	t34 = -t28 * r_i_i_C(1) + t29 * r_i_i_C(2);
	t31 = pkin(6) - r_i_i_C(3) - pkin(8) - pkin(7);
	t27 = pkin(4) * (-t18 * t22 + t19 * t21);
	t25 = -t35 * t19 + t30 * t22;
	t1 = [-t6 * r_i_i_C(1) + t5 * r_i_i_C(2) - t38 * t20 + t31 * t23, t25 * t23 - t36, t32, t23 * t27 + t36, t36; t8 * r_i_i_C(1) - t7 * r_i_i_C(2) + t31 * t20 + t38 * t23, t25 * t20 - t37, t20 * t19, t20 * t27 + t37, t37; 0, t26 - t34, -t22, (-t18 * t19 - t21 * t22) * pkin(4) + t34, t34;];
	Ja_transl = t1;
else
	Ja_transl=NaN(3,5);
end