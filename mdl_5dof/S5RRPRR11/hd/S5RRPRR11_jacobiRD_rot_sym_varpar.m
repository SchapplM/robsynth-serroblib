...
function JRD_rot = S5RRPRR11_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),zeros(5,1),uint8(0),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRR11_jacobiRD_rot_sym_varpar: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'S5RRPRR11_jacobiRD_rot_sym_varpar: qJD has to be [5x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRR11_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRPRR11_jacobiRD_rot_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
	%% Symbolic Calculation
	% From jacobiRD_rot_0_floatb_twist_matlab.m
	% OptimizationMode: 2
	% StartTime: 2019-12-29 19:16:28
...
elseif link_index == 5
	...
	% Computational Cost: add. (263->32), mult. (338->32), div. (0->0), fcn. (338->6), ass. (0->28)
	t149 = qJ(4) + qJ(5);
	t146 = sin(t149);
	t147 = cos(t149);
	t152 = cos(qJ(2));
	...
	t161 = t147 * t168;
	t160 = t151 * t165;
	t158 = t146 * t150 + t147 * t152;
	t157 = qJD(1) * t158;
	t156 = t158 * qJD(2);
	t134 = -t146 * t169 + t156 - t161;
	t132 = -t147 * t160 + t171 * t151 + t153 * t157;
	t131 = -t166 * t170 + (-t147 * t164 + t161) * t151 + (t151 * t169 + t152 * t166 - t160) * t146;
	t130 = -t133 * t153 + t151 * t157;
	t129 = (t146 * t152 - t170) * t167 + (-t158 * t148 + t156) * t153;
	t1 = [-t132, -t129, 0, t129, t129; -t130, t131, 0, -t131, -t131; 0, t133, 0, -t133, -t133; t131, -t130, 0, t130, t130; t129, t132, 0, -t132, -t132; 0, t134, 0, -t134, -t134; t167, 0, 0, 0, 0; -t166, 0, 0, 0, 0; 0, 0, 0, 0, 0;];
	JRD_rot = t1;
else
	JRD_rot=NaN(9,5);
end