...
t12 = t34 * pkin(3) * t23;
t8 = t24 - t52;
t1 = [Ifges(2,3) + Ifges(3,3) - 0.2e1 * t24 * t16 + 0.2e1 * t8 * t46 + Ifges(4,2) * t56 + 0.2e1 * t27 * t42 + (0.2e1 * t24 * mrSges(5,2) - 0.2e1 * t5 * mrSges(5,3) - 0.2e1 * t2 * mrSges(6,3) + (Ifges(6,1) + Ifges(5,1)) * t23) * t23 + m(6) * (t2 ^ 2 + t3 ^ 2 + t8 ^ 2) + m(5) * (t24 ^ 2 + t5 ^ 2 + t6 ^ 2) + m(4) * (t45 * t26 ^ 2 + t27 ^ 2) + m(3) * (t32 ^ 2 + t33 ^ 2) * pkin(1) ^ 2 + (Ifges(4,1) * t35 + 0.2e1 * Ifges(4,4) * t37) * t35 + 0.2e1 * (t33 * mrSges(3,1) - t32 * mrSges(3,2)) * pkin(1) + 0.2e1 * t45 * t26 * mrSges(4,3) + (0.2e1 * t6 * mrSges(5,3) + 0.2e1 * t3 * mrSges(6,3) + 0.2e1 * (Ifges(5,4) + Ifges(6,4)) * t23 + (Ifges(6,2) + Ifges(5,2)) * t22) * t22; m(5) * (t5 * t22 + t6 * t23) + m(6) * (t2 * t22 + t3 * t23); m(3) + m(4) * t45 + 0.2e1 * (m(5) / 0.2e1 + m(6) / 0.2e1) * (t22 ^ 2 + t23 ^ 2); Ifges(4,5) * t35 + Ifges(4,6) * t37 + t43 * t28 + (-t35 * mrSges(4,1) - t37 * mrSges(4,2)) * t26 + (mrSges(6,3) * t49 + (-t36 * t23 + t49) * mrSges(5,3) + m(6) * t3 * t34 + m(5) * (t34 * t6 + t36 * t5)) * pkin(3) + t40; m(5) * (t22 * t51 + t12) + m(6) * (t28 * t22 + t12) + t41 - t42; t28 * t54 + Ifges(4,3) + m(6) * (t28 ^ 2 + t29) + m(5) * (t36 ^ 2 * t38 + t29) + 0.2e1 * t55 + t47; t43 * pkin(4) + t40; m(6) * t52 + t41; t28 * t53 + (pkin(4) + t28) * mrSges(6,1) + t55 + t47; (t54 + t53) * pkin(4) + t47; m(6) * t8 + t46; 0; 0; 0; m(6);];
