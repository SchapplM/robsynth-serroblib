...
function [T_mdh, T_stack] = S5RPRRP3_joint_trafo_rotmat_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
...
t29 = cos(pkin(8));
t28 = sin(pkin(8));
t1 = [t35, -t32, 0, 0; t32, t35, 0, 0; 0, 0, 1, pkin(5); t29, -t28, 0, pkin(1); t28, t29, 0, 0; 0, 0, 1, qJ(2); t34, -t31, 0, pkin(2); 0, 0, -1, -pkin(6); t31, t34, 0, 0; t33, -t30, 0, pkin(3); t30, t33, 0, 0; 0, 0, 1, pkin(7); 1, 0, 0, pkin(4); 0, 1, 0, 0; 0, 0, 1, qJ(5);];
T_stack = t1;
