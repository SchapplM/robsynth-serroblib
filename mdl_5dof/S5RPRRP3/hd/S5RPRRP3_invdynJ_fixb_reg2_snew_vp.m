...
t183 = sin(qJ(1));
t184 = cos(qJ(1));
t152 = t184 * g(1) + t183 * g(2);
t111 = -t147 * pkin(1) - t152;
t139 = sin(pkin(8));
t140 = cos(pkin(8));
t151 = t183 * g(1) - t184 * g(2);
t149 = qJDD(1) * pkin(1) + t151;
