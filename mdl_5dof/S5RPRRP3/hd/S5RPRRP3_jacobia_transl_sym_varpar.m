...
elseif link_index == 5
	...
	% Computational Cost: add. (81->18), mult. (53->21), div. (0->0), fcn. (55->8), ass. (0->16)
	...
	t21 = t7 * t9;
	t18 = r_i_i_C(2) * t10;
	t19 = r_i_i_C(1) * t21 + t7 * t18;
	t17 = r_i_i_C(3) + qJ(5) + pkin(7) + pkin(6);
	t15 = -pkin(2) - t22;
	t8 = cos(t13);
	t2 = -pkin(4) * t9 - sin(qJ(3)) * pkin(3);
	t1 = [0, 1, t22, t16, 0; -cos(qJ(1)) * pkin(1) - t17 * t7 + t15 * t8, 0, -t7 * t2 + t19, pkin(4) * t21 + t19, t8; -sin(qJ(1)) * pkin(1) + t17 * t8 + t15 * t7, 0, (-r_i_i_C(1) * t9 - t18 + t2) * t8, (-t23 * t9 - t18) * t8, t7;];
	Ja_transl = t1;
else
	Ja_transl=NaN(3,5);
end