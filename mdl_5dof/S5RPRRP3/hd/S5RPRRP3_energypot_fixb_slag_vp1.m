...
t35 = sin(t42);
t36 = cos(t42);
t49 = rSges(5,1) * t36 - rSges(5,2) * t35 + t32;
t48 = -rSges(6,2) * t35 + t58 * t36 + t32;
t41 = qJ(1) + pkin(8);
t34 = cos(t41);
t33 = sin(t41);
t1 = -m(1) * (g(1) * rSges(1,1) + g(2) * rSges(1,2) + g(3) * rSges(1,3)) - m(2) * (g(1) * (pkin(5) + rSges(2,3)) + g(2) * (-t44 * rSges(2,1) - t46 * rSges(2,2)) + g(3) * (t46 * rSges(2,1) - t44 * rSges(2,2))) - m(3) * (g(1) * (rSges(3,3) + t53) + g(2) * (-t33 * rSges(3,1) - t34 * rSges(3,2) - t57) + g(3) * (t34 * rSges(3,1) - t33 * rSges(3,2) + t39)) - m(4) * (g(1) * (t43 * rSges(4,1) + t45 * rSges(4,2) + t53) + (g(2) * t56 + g(3) * t50) * t34 + (-g(2) * t50 + g(3) * t56) * t33 + t51) - m(5) * (g(1) * (t35 * rSges(5,1) + t36 * rSges(5,2) + t52) + (g(2) * t55 + g(3) * t49) * t34 + (-g(2) * t49 + g(3) * t55) * t33 + t51) - m(6) * (g(1) * (t36 * rSges(6,2) + t58 * t35 + t52) + (g(2) * t54 + g(3) * t48) * t34 + (-g(2) * t48 + g(3) * t54) * t33 + t51);
U = t1;
