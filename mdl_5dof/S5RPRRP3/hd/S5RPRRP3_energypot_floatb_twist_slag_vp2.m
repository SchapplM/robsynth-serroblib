...
t4 = cos(t12);
t3 = sin(t12);
t1 = (-t17 * mrSges(2,1) + t15 * mrSges(2,2) - mrSges(1,3) + t31 * r_base(3) - t27 * t4 + t28 * (t17 * pkin(1) + r_base(3)) + t26 * t3) * g(3) + (t15 * mrSges(2,1) + t17 * mrSges(2,2) - mrSges(1,2) + t31 * r_base(2) + t28 * (-t15 * pkin(1) + r_base(2)) + t26 * t4 + t27 * t3) * g(2) + (-m(1) * r_base(1) - m(2) * t25 - t14 * mrSges(4,1) - t16 * mrSges(4,2) - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) + t33 * t7 - t34 * (t14 * pkin(3) + t5) - t32 * t6 + t30 * t5) * g(1);
U = t1;
