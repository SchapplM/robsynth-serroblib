...
t1 = qJD(2) ^ 2 * t87 + m(5) * (t58 ^ 2 + t59 ^ 2 + t70 ^ 2) / 0.2e1 + m(4) * (t66 ^ 2 + t67 ^ 2 + t73 ^ 2) / 0.2e1 + m(6) * (t56 ^ 2 + t57 ^ 2 + t60 ^ 2) / 0.2e1 + (t66 * mrSges(4,1) - t67 * mrSges(4,2) + Ifges(4,3) * qJD(3) / 0.2e1) * qJD(3) + (t58 * mrSges(5,1) + t56 * mrSges(6,1) - t59 * mrSges(5,2) - t57 * mrSges(6,2) + (Ifges(6,3) / 0.2e1 + Ifges(5,3) / 0.2e1) * t76) * t76 + (t70 * mrSges(5,2) + t60 * mrSges(6,2) - t58 * mrSges(5,3) - t56 * mrSges(6,3) + (Ifges(6,1) / 0.2e1 + Ifges(5,1) / 0.2e1) * t69 + (Ifges(5,5) + Ifges(6,5)) * t76) * t69 + (-t70 * mrSges(5,1) - t60 * mrSges(6,1) + t59 * mrSges(5,3) + t57 * mrSges(6,3) + (Ifges(5,2) / 0.2e1 + Ifges(6,2) / 0.2e1) * t68 + (Ifges(5,6) + Ifges(6,6)) * t76 + (Ifges(5,4) + Ifges(6,4)) * t69) * t68 + (t73 * (-mrSges(4,1) * t82 + mrSges(4,2) * t80) + (-t66 * t80 + t67 * t82) * mrSges(4,3) + qJD(3) * (Ifges(4,5) * t80 + Ifges(4,6) * t82) + (Ifges(2,3) / 0.2e1 + Ifges(3,3) / 0.2e1 + (t78 * mrSges(3,1) - t77 * mrSges(3,2) + (t77 ^ 2 + t78 ^ 2) * t87 * pkin(1)) * pkin(1) + Ifges(4,2) * t82 ^ 2 / 0.2e1 + (Ifges(4,4) * t82 + Ifges(4,1) * t80 / 0.2e1) * t80) * qJD(1)) * qJD(1);
T = t1;
