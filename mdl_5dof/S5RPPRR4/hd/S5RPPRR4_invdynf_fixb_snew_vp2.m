...
t82 = sin(qJ(1));
t85 = cos(qJ(1));
t106 = t82 * g(1) - t85 * g(2);
t86 = qJD(1) ^ 2;
t91 = -t86 * qJ(2) + qJDD(2) - t106;
t79 = cos(pkin(8));
t99 = -pkin(2) * t79 - qJ(3) * t77;
t121 = -0.2e1 * qJD(3) * t112 + (-pkin(1) + t99) * qJDD(1) + t91;
t74 = t77 ^ 2;
t120 = (t79 ^ 2 + t74) * mrSges(3,3);
t76 = sin(pkin(9));
t78 = cos(pkin(9));
t100 = mrSges(4,1) * t76 + mrSges(4,2) * t78;
t102 = -t85 * g(1) - t82 * g(2);
t58 = -t86 * pkin(1) + qJDD(1) * qJ(2) + t102;
t114 = -t79 * g(3) - t77 * t58;
...
t48 = t49 ^ 2;
t90 = t18 * mrSges(6,1) + t33 * t29 - m(6) * (-t39 * pkin(4) - t48 * pkin(7) + t50 * t45 + t89) - t19 * mrSges(6,2) - t34 * t30;
t88 = -m(5) * t89 + t39 * mrSges(5,1) - t40 * mrSges(5,2) + t49 * t41 - t50 * t42 + t90;
t87 = m(4) * t35 - t88;
...
t57 = t96 * qJD(1);
t98 = t56 * t76 + t57 * t78;
t10 = ((-mrSges(3,3) - t100) * qJDD(1) + (-0.2e1 * m(3) * qJD(2) - t61 - t98) * qJD(1)) * t77 + m(3) * t114 - t87;
t103 = -t77 * g(3) + (t108 + t58) * t79;
t115 = t121 * t78;
t36 = t60 * t111 + t103;
t53 = t100 * t112;
...
t119 = t79 * t10 + t77 * t4;
t92 = m(3) * (-qJDD(1) * pkin(1) + t91) + t78 * t5 + t76 * t6;
t2 = m(2) * t106 + (-mrSges(2,2) + t120) * t86 + (mrSges(2,1) - t101) * qJDD(1) - t92;
t1 = m(2) * t102 - t86 * mrSges(2,1) - qJDD(1) * mrSges(2,2) - t77 * t10 + t79 * t4;
t3 = [-m(1) * g(1) + t85 * t1 - t82 * t2, t1, t4, t6, t8, t12; -m(1) * g(2) + t82 * t1 + t85 * t2, t2, t10, t5, t7, t11; (-m(1) - m(2)) * g(3) + t119, -m(2) * g(3) + t119, t101 * qJDD(1) - t86 * t120 + t92, (t98 * qJD(1) + t100 * qJDD(1)) * t77 + t87, -t88, -t90;];
f_new = t3;
