...
t6 = sin(t14);
t7 = cos(t14);
t41 = -mrSges(3,1) - m(4) * pkin(2) - t18 * mrSges(4,1) + t16 * mrSges(4,2) - m(6) * (pkin(4) * t7 + t5) - t4 * mrSges(6,1) + t3 * mrSges(6,2) - m(5) * t5 - t7 * mrSges(5,1) + t6 * mrSges(5,2);
t20 = -pkin(6) - qJ(3);
t40 = mrSges(3,2) - m(4) * qJ(3) + m(5) * t20 + m(6) * (-pkin(7) + t20) - mrSges(4,3) - mrSges(5,3) - mrSges(6,3);
t17 = sin(pkin(8));
t19 = cos(pkin(8));
t39 = t40 * t17 + t41 * t19 - mrSges(2,1);
t38 = -m(1) - m(2);
t35 = m(3) + m(4) + m(5) + m(6);
t32 = t16 * pkin(3);
t34 = -m(5) * t32 - t6 * mrSges(5,1) - t7 * mrSges(5,2) + mrSges(2,2) - mrSges(3,3) - m(6) * (pkin(4) * t6 + t32) - t3 * mrSges(6,1) - t4 * mrSges(6,2) - t16 * mrSges(4,1) - t18 * mrSges(4,2);
t22 = cos(qJ(1));
t21 = sin(qJ(1));
t1 = (-mrSges(1,3) + t38 * r_base(3) - t35 * (t22 * pkin(1) + t21 * qJ(2) + r_base(3)) + t39 * t22 + t34 * t21) * g(3) + (-mrSges(1,2) + t38 * r_base(2) - t35 * (t22 * qJ(2) + r_base(2)) + t34 * t22 + (t35 * pkin(1) - t39) * t21) * g(2) + (-m(1) * r_base(1) - mrSges(1,1) - mrSges(2,3) + (-m(2) - t35) * (pkin(5) + r_base(1)) - t40 * t19 + t41 * t17) * g(1);
U = t1;
