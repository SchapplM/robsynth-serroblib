...
t37 = [t65 * t25 + m(4) * (t97 * t156 + t72 * t104 + t96 * (-t128 * t160 + t110) + t71 * t103 + t121 + t119 * t152) + m(5) * (t14 * t40 + t15 * t39 + t23 * t36 + t24 * t35 + (qJD(1) * t113 + t102) * t152) + 0.2e1 * m(3) * (t127 * t144 + t121) - t113 * t75 + (-t14 * t98 + t15 * t99 + t35 * t89 + t36 * t90) * mrSges(5,3) + t4 * t41 + t5 * t42 + t31 * t20 / 0.2e1 + m(6) * (t10 * t3 + t11 * t2 + t4 * t7 + t5 * t6 + t58 * t74 + t65 * t68) + (-t27 / 0.2e1 - t26 / 0.2e1 - t1 + t77 / 0.2e1 - t76 / 0.2e1 + t97 * mrSges(4,2) - t96 * mrSges(4,1) + t139) * t131 + t143 * (Ifges(6,4) * t31 + Ifges(6,2) * t32) / 0.2e1 + (-t142 * mrSges(4,3) + ((mrSges(5,1) * t98 - mrSges(5,2) * t99 + t140) * qJD(1) - t161) * qJD(2)) * t129 + (-t113 * mrSges(5,1) + t40 * mrSges(5,3) - Ifges(5,4) * t99 - Ifges(5,2) * t98 + Ifges(5,6) * t167) * t80 - (-t39 * mrSges(5,3) - Ifges(5,1) * t99 - Ifges(5,4) * t98 + Ifges(5,5) * t167) * t79 + (t2 * t56 - t3 * t57 - t6 * t31 + t7 * t32) * mrSges(6,3) + (-Ifges(5,1) * t89 + Ifges(5,4) * t90) * t170 - t85 * (-Ifges(5,4) * t89 + Ifges(5,2) * t90) / 0.2e1 + t102 * (-t90 * mrSges(5,1) - t89 * mrSges(5,2)) + t123 * (-Ifges(5,5) * t89 + Ifges(5,6) * t90) / 0.2e1 + t32 * t184 + (Ifges(6,1) * t31 + Ifges(6,4) * t32) * t172 + (-t65 * mrSges(6,1) + t11 * mrSges(6,3) + Ifges(6,4) * t57 + Ifges(6,2) * t56 + Ifges(6,6) * t167) * t29 + (-t10 * mrSges(6,3) + Ifges(6,1) * t57 + Ifges(6,4) * t56 + Ifges(6,5) * t167) * t28 + t58 * (-mrSges(6,1) * t32 + mrSges(6,2) * t31) + t68 * (-mrSges(6,1) * t56 + mrSges(6,2) * t57) + t23 * t69 + t24 * t70 + t74 * t30 - t89 * t44 / 0.2e1 + t90 * t43 / 0.2e1 + t104 * t107 + t103 * t108 + t118 * (Ifges(6,5) * t31 + Ifges(6,6) * t32) / 0.2e1 + 0.2e1 * t155 * mrSges(3,3) * t147; t177 * t70 + t176 * t69 + t181 * t42 + t182 * t41 + (-t28 * t66 + t29 * t67) * mrSges(6,3) + (t112 * t80 - t141 * t79) * mrSges(5,3) + (-t58 * t154 + t181 * t6 + t182 * t7 + t2 * t67 + t3 * t66) * m(6) + (-t102 * t154 + t14 * t112 - t141 * t15 + t176 * t36 + t177 * t35) * m(5) + m(4) * t142 + ((-t107 * t130 + t108 * t128) * t131 + (-t30 + t161) * t129 + (-t119 * t129 - (-t128 * t71 + t130 * t72) * t131) * m(4) + (-m(3) * qJ(2) - mrSges(3,3)) * t155 * qJD(1)) * qJD(1); -t80 * mrSges(5,1) - t29 * mrSges(6,1) - t143 * t41 + t50 * t42 + t85 * t69 + t87 * t70 + t25 - t75 - m(5) * (-t35 * t87 - t36 * t85) + (m(5) * qJD(2) + t128 * t107 + t130 * t108 + (t128 * t72 + t130 * t71 + qJD(2)) * m(4)) * t154 + (-t143 * t7 + t50 * t6 + t68) * m(6); (-Ifges(5,2) * t87 + t44 - t81) * t85 / 0.2e1 + t50 * t184 - t87 * (-Ifges(5,1) * t85 - t166) / 0.2e1 + (-t35 * t85 + t36 * t87) * mrSges(5,3) - t102 * (mrSges(5,1) * t87 - mrSges(5,2) * t85) - t123 * (-Ifges(5,5) * t85 - Ifges(5,6) * t87) / 0.2e1 - t9 * t41 - t8 * t42 - m(6) * (t6 * t8 + t7 * t9) - t139 + t43 * t170 + (-t87 * t30 + (-t132 * t42 + t134 * t41) * qJD(5) + (t132 * t29 - t134 * t28) * mrSges(6,3) + (t132 * t2 + t134 * t3 - t58 * t87 + (-t132 * t6 + t134 * t7) * qJD(5)) * m(6)) * pkin(4) - t35 * t69 + t36 * t70 + t76 - t77 + t186; t19 * t172 - t6 * t41 + t7 * t42 - t169 + t186;];
tauc = t37(:);
