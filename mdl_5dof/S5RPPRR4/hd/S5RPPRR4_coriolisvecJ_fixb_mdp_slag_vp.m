...
% OptimizationMode: 2
% StartTime: 2019-12-05 17:45:03
% EndTime: 2019-12-05 17:45:11
...
t173 = qJD(5) * t271 - t205 * t258 + t260 * t206;
t179 = t213 * t258 + t305;
t257 = cos(pkin(8));
t299 = qJD(1) * t257;
t320 = qJD(4) - t299;
...
t311 = t179 * t243;
t312 = t271 * t243;
t321 = t179 * t271 * MDP(19) + (-t173 - t312) * MDP(22) + (-t179 ^ 2 + t271 ^ 2) * MDP(20) + (t172 - t311) * MDP(21);
t238 = -pkin(2) * t257 - qJ(3) * t255 - pkin(1);
t226 = qJD(1) * t238 + qJD(2);
t218 = t256 * t226;
t265 = -pkin(6) * t255 * t256 + (-qJ(2) * t254 - pkin(3)) * t257;
t185 = qJD(1) * t265 + t218;
t288 = qJ(2) * t299;
