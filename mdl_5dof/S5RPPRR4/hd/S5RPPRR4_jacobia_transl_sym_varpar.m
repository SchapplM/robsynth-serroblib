...
elseif link_index == 4
	...
	% Computational Cost: add. (51->24), mult. (60->31), div. (0->0), fcn. (73->8), ass. (0->16)
	t11 = cos(pkin(8));
	t13 = sin(qJ(1));
	t18 = t11 * t13;
	t14 = cos(qJ(1));
...
elseif link_index == 5
	...
	% Computational Cost: add. (116->33), mult. (96->40), div. (0->0), fcn. (113->10), ass. (0->24)
	t17 = pkin(9) + qJ(4);
	t15 = qJ(5) + t17;
	t12 = cos(t15);
	t19 = cos(pkin(8));
