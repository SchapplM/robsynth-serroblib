...
t267 = sin(qJ(1));
t270 = cos(qJ(1));
t246 = -t270 * g(1) - t267 * g(2);
t271 = qJD(1) ^ 2;
t317 = -t271 * pkin(1) + qJDD(1) * qJ(2) + (2 * qJD(1) * qJD(2)) + t246;
t245 = t267 * g(1) - t270 * g(2);
t282 = -t271 * qJ(2) + qJDD(2) - t245;
t262 = sin(pkin(8));
t264 = cos(pkin(8));
t292 = -pkin(2) * t264 - qJ(3) * t262;
t308 = qJD(1) * t262;
t316 = (-pkin(1) + t292) * qJDD(1) + t282 - 0.2e1 * qJD(3) * t308;
t215 = -t264 * g(3) - t317 * t262;
t307 = t264 * qJD(1);
t216 = -t262 * g(3) + t317 * t264;
t234 = t292 * qJD(1);
t203 = t234 * t307 + t216;
t259 = t262 ^ 2;
t261 = sin(pkin(9));
...
t218 = (-Ifges(4,3) * t264 + t262 * t293) * qJD(1);
...
t315 = -((Ifges(3,4) * t262 + Ifges(3,2) * t264) * t308 - t295 * t307) * qJD(1) - mrSges(3,1) * t215 + mrSges(3,2) * t216 - pkin(2) * ((qJD(1) * t289 - qJDD(1) * t296) * t262 + t274) - qJ(3) * t138 - t263 * t128 - t261 * t129;
t314 = mrSges(3,2) * t262;
t235 = (-mrSges(3,1) * t264 + t314) * qJD(1);
t135 = m(3) * t216 + (qJDD(1) * mrSges(3,3) + qJD(1) * t235) * t264 + t138;
t154 = t274 + m(3) * t215 + ((-mrSges(3,3) - t296) * qJDD(1) + (-t235 + t289) * qJD(1)) * t262;
...
t236 = t294 * qJD(1);
t125 = mrSges(3,2) * t229 - mrSges(3,3) * t215 - qJ(3) * t137 + qJDD(1) * t295 - t261 * t128 + t263 * t129 + t236 * t307;
...
t127 = (Ifges(3,2) + Ifges(4,3)) * t304 - t272 - mrSges(3,1) * t229 + mrSges(3,3) * t216 - pkin(2) * t137 + ((Ifges(3,4) - t293) * qJDD(1) + (-t236 - t290) * qJD(1)) * t262;
t277 = -m(3) * t229 + mrSges(3,1) * t304 - t137 + (t264 ^ 2 * t271 + t313) * mrSges(3,3);
t281 = -mrSges(2,2) * t246 + qJ(2) * t300 + t262 * t125 + t264 * t127 + pkin(1) * (-mrSges(3,2) * t305 + t277) + mrSges(2,1) * t245 + Ifges(2,3) * qJDD(1);
t133 = m(2) * t245 - t271 * mrSges(2,2) + (mrSges(2,1) - t314) * qJDD(1) + t277;
t132 = t262 * t135 + t264 * t154;
t130 = m(2) * t246 - t271 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t300;
t123 = mrSges(2,1) * g(3) + mrSges(2,3) * t246 + t271 * Ifges(2,5) - pkin(1) * t132 + (Ifges(2,6) - t294) * qJDD(1) + t315;
t122 = -mrSges(2,2) * g(3) - mrSges(2,3) * t245 + Ifges(2,5) * qJDD(1) - t271 * Ifges(2,6) - qJ(2) * t132 + t264 * t125 - t262 * t127;
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t270 * t122 - t267 * t123 - pkin(5) * (t267 * t130 + t270 * t133), t122, t125, t129, t140, t153; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + t267 * t122 + t270 * t123 + pkin(5) * (t270 * t130 - t267 * t133), t123, t127, t128, t139, t152; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t281, t281, qJDD(1) * t294 - t315, t272 - Ifges(4,3) * t304 + (qJD(1) * t290 + t293 * qJDD(1)) * t262, -t273, -t278;];
m_new = t1;
