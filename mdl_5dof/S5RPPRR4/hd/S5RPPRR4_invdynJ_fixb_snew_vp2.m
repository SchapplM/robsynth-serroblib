...
% OptimizationMode: 2
% StartTime: 2022-01-23 09:16:35
% EndTime: 2022-01-23 09:16:37
% DurationCPUTime: 2.27s
% Computational Cost: add. (13893->231), mult. (38009->320), div. (0->0), fcn. (26039->10), ass. (0->112)
t433 = qJD(1) ^ 2;
t429 = sin(qJ(1));
t432 = cos(qJ(1));
t450 = -g(1) * t432 - g(2) * t429;
t470 = -pkin(1) * t433 + qJDD(1) * qJ(2) + (2 * qJD(1) * qJD(2)) + t450;
t454 = g(1) * t429 - t432 * g(2);
t439 = -qJ(2) * t433 + qJDD(2) - t454;
t424 = sin(pkin(8));
t426 = cos(pkin(8));
t447 = -pkin(2) * t426 - qJ(3) * t424;
t462 = qJD(1) * t424;
t469 = (-pkin(1) + t447) * qJDD(1) + t439 - 0.2e1 * qJD(3) * t462;
t387 = -t426 * g(3) - t470 * t424;
t425 = cos(pkin(9));
t468 = Ifges(4,4) * t425;
t423 = sin(pkin(9));
t467 = Ifges(4,2) * t423;
t466 = t423 * t424;
t465 = t424 * t425;
t388 = -g(3) * t424 + t470 * t426;
t406 = t447 * qJD(1);
t461 = qJD(1) * t426;
t377 = t406 * t461 + t388;
t422 = t424 ^ 2;
t445 = -pkin(3) * t426 - pkin(6) * t465;
t464 = t469 * t425;
...
t441 = (-t423 * t431 - t425 * t428) * t424;
t395 = qJD(1) * t441;
t440 = (-t423 * t428 + t425 * t431) * t424;
...
t449 = -mrSges(3,1) * t426 + mrSges(3,2) * t424;
t448 = mrSges(4,1) * t423 + mrSges(4,2) * t425;
t363 = -t377 * t423 + t464;
t399 = t448 * t462;
t442 = mrSges(4,2) * t426 - mrSges(4,3) * t466;
t402 = t442 * qJD(1);
t443 = -mrSges(4,1) * t426 - mrSges(4,3) * t465;
...
t444 = -t425 * Ifges(4,5) + t423 * Ifges(4,6) + Ifges(3,4);
t366 = t425 * t405 * t462 + pkin(3) * t455 - pkin(6) * t457 + t376;
t346 = -pkin(4) * t380 - pkin(7) * t394 + t386 * t396 + t366;
t438 = m(6) * t346 - t351 * mrSges(6,1) + t352 * mrSges(6,2) - t374 * t367 + t375 * t368;
...
t436 = m(5) * t366 - t380 * mrSges(5,1) + t381 * mrSges(5,2) - t395 * t382 + t396 * t383 + t438;
t435 = m(4) * t376 + t436;
...
t320 = -mrSges(5,1) * t366 + mrSges(5,3) * t344 + Ifges(5,4) * t381 + Ifges(5,2) * t380 + Ifges(5,6) * t415 - pkin(4) * t438 + pkin(7) * t452 + t430 * t331 + t427 * t332 - t396 * t369 + t416 * t371;
t318 = m(3) * t401 + t449 * qJDD(1) + (-t426 ^ 2 - t422) * t433 * mrSges(3,3) + t319;
t1 = [Ifges(2,3) * qJDD(1) + mrSges(2,1) * t454 - mrSges(2,2) * t450 + t424 * (t408 * t461 + mrSges(3,2) * t401 - mrSges(3,3) * t387 + t425 * (mrSges(4,2) * t376 - mrSges(4,3) * t363 - pkin(6) * t324 - t320 * t428 + t431 * t321 + t391 * t461) - t423 * (-mrSges(4,1) * t376 + mrSges(4,3) * t364 - pkin(3) * t436 + pkin(6) * t453 + t431 * t320 + t428 * t321 - t392 * t461) - qJ(3) * t319 + (t426 * t444 + (Ifges(4,1) * t425 ^ 2 + Ifges(3,1) + (t467 - 0.2e1 * t468) * t423) * t424) * qJDD(1)) + t426 * (-t434 + (Ifges(3,2) + Ifges(4,3)) * t458 - mrSges(3,1) * t401 + mrSges(3,3) * t388 - mrSges(4,1) * t363 + mrSges(4,2) * t364 - pkin(3) * t324 - pkin(2) * t319 + (t444 * qJDD(1) + (-t391 * t425 - t392 * t423 - t408) * qJD(1)) * t424) - pkin(1) * t318 + qJ(2) * ((m(3) * t388 - t423 * t322 + t425 * t323 + (qJDD(1) * mrSges(3,3) + qJD(1) * t407) * t426) * t426 + (t435 + (t407 + t446) * t462 + (mrSges(3,3) + t448) * t459 - m(3) * t387) * t424); t318; (t446 * qJD(1) + t448 * qJDD(1)) * t424 + t435; t434; -t437;];
tauJ = t1;
