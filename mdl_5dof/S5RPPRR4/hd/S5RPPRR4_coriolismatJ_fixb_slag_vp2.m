...
% OptimizationMode: 2
% StartTime: 2020-01-03 11:30:33
% EndTime: 2020-01-03 11:30:39
...
t159 = sin(qJ(4));
t161 = cos(qJ(4));
t138 = t154 * t161 + t159 * t156;
t155 = sin(pkin(8));
t129 = t138 * t155;
t137 = -t159 * t154 + t156 * t161;
t131 = t137 * t155;
t158 = sin(qJ(5));
t160 = cos(qJ(5));
t103 = -t129 * t158 + t131 * t160;
t244 = t103 * mrSges(6,1);
t176 = t244 / 0.2e1;
t186 = t154 * t155;
t179 = pkin(3) * t186 + t155 * qJ(2);
t171 = -pkin(4) * t129 - t179;
t173 = -t160 * t129 - t131 * t158;
t175 = t173 * mrSges(6,2) + t244;
t250 = t171 * t175;
t118 = t137 * t158 + t138 * t160;
t172 = t160 * t137 - t138 * t158;
...
t229 = m(6) * pkin(4);
t178 = t229 / 0.2e1;
t213 = t101 * mrSges(6,1) / 0.2e1 - t104 * mrSges(6,2) / 0.2e1;
t248 = t130 * mrSges(5,1) / 0.2e1 + t132 * mrSges(5,2) / 0.2e1 - (t101 * t160 + t104 * t158) * t178 - t213;
...
t190 = qJ(2) * t157;
t123 = t154 * t143 + t156 * t190;
t119 = -pkin(6) * t186 + t123;
t74 = t159 * t114 + t119 * t161;
t63 = -t129 * pkin(7) + t74;
t196 = t158 * t63;
t73 = t161 * t114 - t119 * t159;
t62 = -pkin(7) * t131 + t73;
t59 = -pkin(4) * t157 + t62;
t32 = t160 * t59 - t196;
...
t174 = t131 * mrSges(5,1) - t129 * mrSges(5,2);
t60 = -mrSges(6,1) * t173 + mrSges(6,2) * t103;
t1 = -m(6) * (-t171 * t219 + t32 * t36 + t33 * t37) - t60 * t219 + t250 - t37 * t83 - t36 * t84 - t179 * t174 + (-t129 ^ 2 + t131 ^ 2) * Ifges(5,4) + t167 * t157 + (-Ifges(6,1) * t103 + t234) * t173 - (-mrSges(6,3) * t33 - Ifges(6,2) * t173 - t240) * t103 + (t197 + t121) * t74 + (-t120 - t198) * t73 - (-Ifges(5,1) + Ifges(5,2)) * t129 * t131;
t209 = t1 * qJD(1);
t194 = t160 * t103;
t2 = t250 - t32 * t83 + t103 * (-Ifges(6,6) * t157 + t240) + (Ifges(6,5) * t157 + (-Ifges(6,1) + Ifges(6,2)) * t103 + t234) * t173 + (t204 + t84) * t33;
t193 = t2 * qJD(1);
t165 = t172 * t228 + t246;
t7 = t165 - t213;
t192 = t7 * qJD(1);
...
t182 = t19 * qJD(1);
t20 = (t131 / 0.2e1 - t188 / 0.2e1 + t194 / 0.2e1) * t229 + t174 + t175;
t181 = t20 * qJD(1);
t38 = 0.2e1 * t227 * mrSges(6,2) + 0.2e1 * t176;
t180 = t38 * qJD(1);
t177 = m(4) * t222;
...
t6 = (t227 - t173 / 0.2e1) * Ifges(6,5) + (-t32 / 0.2e1 + t37 / 0.2e1) * mrSges(6,2) + (-t33 / 0.2e1 - t36 / 0.2e1) * mrSges(6,1) + t163;
...
t3 = t162 - t248;
t11 = [qJD(2) * t9 + qJD(3) * t10 - qJD(4) * t1 - qJD(5) * t2, t191 + 0.2e1 * ((t101 * t172 + t104 * t118) * t230 + (-t130 * t137 + t132 * t138) * t231) * qJD(2) + t18 * qJD(3) + t3 * qJD(4) + t8 * qJD(5), qJD(2) * t18 + qJD(4) * t52 + qJD(5) * t39 + t189, t3 * qJD(2) + t52 * qJD(3) + t5 * qJD(5) - t209 + (-t74 * mrSges(5,1) - t73 * mrSges(5,2) + t167 - t214 + t215 + (m(6) * (t158 * t37 + t160 * t36) + (-t158 * t103 - t236) * mrSges(6,3)) * pkin(4)) * qJD(4), -t193 + t8 * qJD(2) + t39 * qJD(3) + t5 * qJD(4) + (-t216 - t218 + t247) * qJD(5); qJD(3) * t19 + qJD(4) * t4 + qJD(5) * t7 - t191, 0, t182, (-t138 * mrSges(5,1) - t137 * mrSges(5,2) + (-t118 * t160 + t158 * t172) * t229 + t28) * qJD(4) + t249 + t170, t28 * qJD(4) + t192 + t249; -qJD(2) * t19 + qJD(4) * t20 + qJD(5) * t38 - t189, -t182, 0, t181, t180; -qJD(2) * t4 - qJD(3) * t20 + qJD(5) * t6 + t209, qJD(5) * t27 - t170, -t181, -t139, -t139 - t168; -qJD(2) * t7 - qJD(3) * t38 - qJD(4) * t6 + t193, -t27 * qJD(4) - t192, -t180, t168, 0;];
Cq = t11;
