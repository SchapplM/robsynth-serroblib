...
t687 = qJD(1) * qJD(2);
t649 = t667 * qJDD(1) + t672 * t687;
t686 = t667 * t687;
t650 = t672 * qJDD(1) - t686;
t617 = -t645 * qJD(3) - t666 * t649 + t671 * t650;
t688 = qJD(1) * t672;
t689 = qJD(1) * t667;
t644 = -t666 * t689 + t671 * t688;
t624 = -t644 * mrSges(4,1) + t645 * mrSges(4,2);
t662 = qJD(2) + qJD(3);
t635 = t662 * mrSges(4,1) - t645 * mrSges(4,3);
t661 = qJDD(2) + qJDD(3);
t618 = t644 * qJD(3) + t671 * t649 + t666 * t650;
t654 = t668 * g(1) - t673 * g(2);
t627 = -t654 + (-t650 + t686) * pkin(1);
t586 = (-t644 * t662 - t618) * pkin(5) + (t645 * t662 - t617) * pkin(2) + t627;
t625 = -t644 * pkin(2) - t645 * pkin(5);
t660 = t662 ^ 2;
t594 = -t660 * pkin(2) + t661 * pkin(5) + t644 * t625 + t606;
t665 = sin(qJ(4));
t670 = cos(qJ(4));
t575 = t670 * t586 - t665 * t594;
t616 = qJDD(4) - t617;
t631 = -t665 * t645 + t670 * t662;
t632 = t670 * t645 + t665 * t662;
...
t664 = sin(qJ(5));
t669 = cos(qJ(5));
t571 = t669 * t573 - t664 * t574;
t596 = -t632 * qJD(4) - t665 * t618 + t670 * t661;
t597 = t631 * qJD(4) + t670 * t618 + t665 * t661;
t607 = t669 * t631 - t664 * t632;
t582 = t607 * qJD(5) + t664 * t596 + t669 * t597;
t608 = t664 * t631 + t669 * t632;
t592 = -t607 * mrSges(6,1) + t608 * mrSges(6,2);
t636 = qJD(5) + t640;
t598 = -t636 * mrSges(6,2) + t607 * mrSges(6,3);
t612 = qJDD(5) + t616;
t568 = m(6) * t571 + t612 * mrSges(6,1) - t582 * mrSges(6,3) - t608 * t592 + t636 * t598;
t572 = t664 * t573 + t669 * t574;
t581 = -t608 * qJD(5) + t669 * t596 - t664 * t597;
t599 = t636 * mrSges(6,1) - t608 * mrSges(6,3);
t569 = m(6) * t572 - t612 * mrSges(6,2) + t581 * mrSges(6,3) + t607 * t592 - t636 * t599;
t559 = t669 * t568 + t664 * t569;
t609 = -t631 * mrSges(5,1) + t632 * mrSges(5,2);
t619 = -t640 * mrSges(5,2) + t631 * mrSges(5,3);
t557 = m(5) * t575 + t616 * mrSges(5,1) - t597 * mrSges(5,3) - t632 * t609 + t640 * t619 + t559;
t620 = t640 * mrSges(5,1) - t632 * mrSges(5,3);
t558 = m(5) * t576 - t616 * mrSges(5,2) + t596 * mrSges(5,3) - t664 * t568 + t669 * t569 + t631 * t609 - t640 * t620;
t684 = -t665 * t557 + t670 * t558;
t546 = m(4) * t606 - t661 * mrSges(4,2) + t617 * mrSges(4,3) + t644 * t624 - t662 * t635 + t684;
t605 = t671 * t630 - t666 * t633;
t634 = -t662 * mrSges(4,2) + t644 * mrSges(4,3);
t593 = -t661 * pkin(2) - t660 * pkin(5) + t645 * t625 - t605;
t577 = (t632 * t640 - t596) * pkin(3) + t593;
t681 = m(6) * t577 - t581 * mrSges(6,1) + t582 * mrSges(6,2) - t607 * t598 + t608 * t599;
t677 = -m(5) * t593 + t596 * mrSges(5,1) - t597 * mrSges(5,2) + t631 * t619 - t632 * t620 - t681;
t563 = m(4) * t605 + t661 * mrSges(4,1) - t618 * mrSges(4,3) - t645 * t624 + t662 * t634 + t677;
...
t560 = -mrSges(6,1) * t577 + mrSges(6,3) * t572 + Ifges(6,4) * t582 + Ifges(6,2) * t581 + Ifges(6,6) * t612 - t608 * t587 + t636 * t589;
t588 = Ifges(6,4) * t608 + Ifges(6,2) * t607 + Ifges(6,6) * t636;
t561 = mrSges(6,2) * t577 - mrSges(6,3) * t571 + Ifges(6,1) * t582 + Ifges(6,4) * t581 + Ifges(6,5) * t612 + t607 * t587 - t636 * t588;
...
t553 = mrSges(5,2) * t593 - mrSges(5,3) * t575 + Ifges(5,1) * t597 + Ifges(5,4) * t596 + Ifges(5,5) * t616 - t664 * t560 + t669 * t561 + t631 * t600 - t640 * t601;
...
t691 = mrSges(3,1) * t638 - mrSges(3,2) * t639 + Ifges(3,5) * t649 + Ifges(3,6) * t650 + Ifges(3,3) * qJDD(2) + pkin(1) * t542 + (t667 * t642 - t672 * t643) * qJD(1) - t679;
t648 = (-mrSges(3,1) * t672 + mrSges(3,2) * t667) * qJD(1);
t653 = -qJD(2) * mrSges(3,2) + mrSges(3,3) * t688;
t540 = m(3) * t638 + qJDD(2) * mrSges(3,1) - t649 * mrSges(3,3) + qJD(2) * t653 - t648 * t689 + t542;
t652 = qJD(2) * mrSges(3,1) - mrSges(3,3) * t689;
t541 = m(3) * t639 - qJDD(2) * mrSges(3,2) + t650 * mrSges(3,3) - qJD(2) * t652 + t671 * t546 - t666 * t563 + t648 * t688;
t538 = m(2) * t655 - t674 * mrSges(2,1) - qJDD(1) * mrSges(2,2) - t667 * t540 + t672 * t541;
...
t685 = t673 * t538 - t668 * t544;
t621 = Ifges(4,5) * t645 + Ifges(4,6) * t644 + Ifges(4,3) * t662;
t535 = mrSges(4,2) * t627 - mrSges(4,3) * t605 + Ifges(4,1) * t618 + Ifges(4,4) * t617 + Ifges(4,5) * t661 - pkin(5) * t548 - t665 * t551 + t670 * t553 + t644 * t621 - t662 * t622;
...
t533 = -mrSges(3,2) * t654 - mrSges(3,3) * t638 + Ifges(3,1) * t649 + Ifges(3,4) * t650 + Ifges(3,5) * qJDD(2) - qJD(2) * t642 + t671 * t535 - t666 * t539 + t641 * t688;
...
t529 = -mrSges(2,2) * g(3) - mrSges(2,3) * t654 + Ifges(2,5) * qJDD(1) - t674 * Ifges(2,6) - t667 * t531 + t672 * t533;
