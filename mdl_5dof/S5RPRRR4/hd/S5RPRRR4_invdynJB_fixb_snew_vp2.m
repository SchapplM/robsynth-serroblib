...
t499 = sin(qJ(1));
t503 = cos(qJ(1));
t477 = t499 * g(1) - t503 * g(2);
t474 = qJDD(1) * pkin(1) + t477;
t478 = -t503 * g(1) - t499 * g(2);
t504 = qJD(1) ^ 2;
t475 = -t504 * pkin(1) + t478;
t494 = sin(pkin(9));
t495 = cos(pkin(9));
...
t399 = m(2) * t477 + qJDD(1) * mrSges(2,1) - t504 * mrSges(2,2) + t402;
t515 = -t494 * t408 + t495 * t409;
t400 = m(2) * t478 - t504 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t515;
t519 = t503 * t399 + t499 * t400;
t426 = t500 * t437 + t496 * t438;
t517 = m(5) * t493 + t426;
t516 = -t499 * t399 + t503 * t400;
t511 = m(4) * t493 + t517;
t424 = m(3) * t493 + t511;
...
t505 = mrSges(2,1) * t477 + mrSges(3,1) * t459 - mrSges(2,2) * t478 - mrSges(3,2) * t460 + pkin(1) * t402 + pkin(2) * t411 + t506 + (Ifges(2,3) + Ifges(3,3)) * qJDD(1);
...
t393 = -mrSges(2,2) * g(3) - mrSges(2,3) * t477 + Ifges(2,5) * qJDD(1) - t504 * Ifges(2,6) - qJ(2) * t402 - t494 * t394 + t495 * t395;
t392 = mrSges(2,1) * g(3) + mrSges(2,3) * t478 + t504 * Ifges(2,5) + Ifges(2,6) * qJDD(1) - pkin(1) * t424 + qJ(2) * t515 + t495 * t394 + t494 * t395;
t1 = [-m(1) * g(1) + t516; -m(1) * g(2) + t519; (-m(1) - m(2)) * g(3) + t424; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t519 - t499 * t392 + t503 * t393; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t516 + t503 * t392 + t499 * t393; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t505; t505; t424; t506; t509; t522;];
tauJB = t1;
