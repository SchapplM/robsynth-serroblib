...
t38 = cos(t43);
t37 = sin(t43);
t1 = (-m(2) * pkin(5) - m(3) * t61 - m(4) * t58 - t51 * mrSges(6,1) - t53 * mrSges(6,2) - mrSges(1,3) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) - mrSges(5,3) + t64 * (pkin(7) + t58)) * g(3) + (-m(3) * t48 - m(4) * t60 - t52 * mrSges(2,1) - t44 * mrSges(3,1) - t41 * mrSges(4,1) - t54 * mrSges(2,2) - t45 * mrSges(3,2) - t42 * mrSges(4,2) - mrSges(1,2) + t64 * (pkin(3) * t41 + t60) + t62 * t38 + t63 * t37) * g(2) + (-m(3) * t49 - m(4) * t59 - t54 * mrSges(2,1) - t45 * mrSges(3,1) - t42 * mrSges(4,1) + t52 * mrSges(2,2) + t44 * mrSges(3,2) + t41 * mrSges(4,2) - mrSges(1,1) + t64 * (pkin(3) * t42 + t59) + t63 * t38 - t62 * t37) * g(1);
U = t1;
