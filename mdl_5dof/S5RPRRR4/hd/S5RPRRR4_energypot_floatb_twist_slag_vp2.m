...
t4 = cos(t10);
t3 = sin(t10);
t1 = (-m(1) * r_base(3) - m(2) * t30 - m(3) * t25 - m(4) * t22 - mrSges(6,1) * t17 - t19 * mrSges(6,2) - mrSges(1,3) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) - mrSges(5,3) + t33 * (pkin(7) + t22)) * g(3) + (-m(3) * t29 - m(4) * t27 - t18 * mrSges(2,1) - t11 * mrSges(3,1) - t8 * mrSges(4,1) - mrSges(2,2) * t20 - t12 * mrSges(3,2) - t9 * mrSges(4,2) - mrSges(1,2) + t34 * r_base(2) + t33 * (pkin(3) * t8 + t27) + t31 * t4 + t32 * t3) * g(2) + (-m(3) * t28 - m(4) * t26 - mrSges(2,1) * t20 - t12 * mrSges(3,1) - t9 * mrSges(4,1) + t18 * mrSges(2,2) + t11 * mrSges(3,2) + t8 * mrSges(4,2) - mrSges(1,1) + t34 * r_base(1) + t32 * t4 + t33 * (pkin(3) * t9 + t26) - t31 * t3) * g(1);
U = t1;
