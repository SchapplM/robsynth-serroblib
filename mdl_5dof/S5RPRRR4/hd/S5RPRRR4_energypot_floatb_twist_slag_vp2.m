...
t3 = cos(t8);
t2 = sin(t8);
t1 = (-m(3) * t26 - m(4) * t25 - mrSges(2,1) * t17 - t10 * mrSges(3,1) - t7 * mrSges(4,1) + t15 * mrSges(2,2) + t9 * mrSges(3,2) + t6 * mrSges(4,2) - mrSges(1,3) + t31 * r_base(3) - t29 * t3 + t30 * (pkin(3) * t7 + t25) + t28 * t2) * g(3) + (-m(3) * t23 - m(4) * t20 + t15 * mrSges(2,1) + t9 * mrSges(3,1) + t6 * mrSges(4,1) + mrSges(2,2) * t17 + t10 * mrSges(3,2) + t7 * mrSges(4,2) - mrSges(1,2) + t31 * r_base(2) + t30 * (-pkin(3) * t6 + t20) + t28 * t3 + t29 * t2) * g(2) + (-m(1) * r_base(1) - m(2) * t27 - m(3) * t24 - m(4) * t21 - mrSges(6,1) * t14 - mrSges(6,2) * t16 - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) - mrSges(5,3) + t30 * (pkin(7) + t21)) * g(1);
U = t1;
