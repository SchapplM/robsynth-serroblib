...
t16 = [t63 * (-Ifges(6,5) * t36 + Ifges(6,6) * t37) / 0.2e1 + t48 * t13 + t50 * t53 + t49 * t54 - t36 * t12 / 0.2e1 + t21 * (-t37 * mrSges(6,1) - t36 * mrSges(6,2)) - t32 * (-Ifges(6,4) * t36 + Ifges(6,2) * t37) / 0.2e1 + (-Ifges(6,1) * t36 + Ifges(6,4) * t37) * t101 + t37 * t11 / 0.2e1 + t3 * t19 + t4 * t20 - t80 * t68 * mrSges(5,3) + (-t39 * mrSges(5,1) + t40 * mrSges(5,2) + t26 / 0.2e1 - t25 / 0.2e1 + t81) * t71 + (-t1 * t43 + t2 * t44 + t5 * t36 + t6 * t37) * mrSges(6,3) + (0.2e1 * t104 + ((mrSges(6,1) * t43 - mrSges(6,2) * t44 + t77) * qJD(1) - t93) * t68) * qJD(3) + m(6) * (t1 * t8 + t2 * t7 + t3 * t6 + t4 * t5 + (qJD(1) * t48 + t21) * t86) + m(4) * (t60 + (t66 * t62 + t79) * qJD(3)) + m(5) * (t40 * t92 + t15 * t50 + t39 * (-t64 * t97 + t46) + t14 * t49 + t60 + t38 * t86) + (t8 * mrSges(6,3) - Ifges(6,4) * t44 - Ifges(6,2) * t43 + Ifges(6,6) * t100) * t28 - (-t7 * mrSges(6,3) - Ifges(6,1) * t44 - Ifges(6,4) * t43 + Ifges(6,5) * t100) * t27; -t71 * t13 - t36 * t19 + t37 * t20 + (-t43 * t27 - t44 * t28) * mrSges(6,3) + m(6) * (-t1 * t44 - t2 * t43 - t36 * t6 + t37 * t5) + 0.2e1 * (m(5) * (-t39 * t67 + t40 * t70 - t82) / 0.2e1 + t82 * t103) * t68; t105 * t20 + t106 * t19 + (-t27 * t78 + t28 * t58) * mrSges(6,3) + m(5) * t80 + (t1 * t58 + t105 * t5 + t106 * t6 - t2 * t78) * m(6) + ((-t53 * t70 + t54 * t67) * t71 - m(4) * t79 - m(5) * (-t14 * t97 + t15 * t95) - t104 + (-m(5) * t38 + 0.2e1 * t21 * t103 + t93) * t68) * qJD(1); -m(6) * (-t32 * t6 - t34 * t5) + t32 * t19 + t34 * t20 + (m(6) * qJD(3) + t67 * t53 + t70 * t54 + (t14 * t70 + t15 * t67 + qJD(3)) * m(5)) * t87 + t13; -t26 + t25 - t21 * (mrSges(6,1) * t34 - mrSges(6,2) * t32) - t34 * (-Ifges(6,1) * t32 - t99) / 0.2e1 + t11 * t101 - t63 * (-Ifges(6,5) * t32 - Ifges(6,6) * t34) / 0.2e1 - t5 * t19 + t6 * t20 + (-t32 * t5 + t34 * t6) * mrSges(6,3) - t81 + (-Ifges(6,2) * t34 + t12 - t29) * t32 / 0.2e1;];
tauc = t16(:);
