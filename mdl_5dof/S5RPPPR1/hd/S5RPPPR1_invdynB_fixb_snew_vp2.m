...
% OptimizationMode: 2
% StartTime: 2022-01-20 09:12:29
% EndTime: 2022-01-20 09:12:32
% DurationCPUTime: 3.76s
% Computational Cost: add. (31387->236), mult. (72890->326), div. (0->0), fcn. (44132->10), ass. (0->114)
t514 = sin(qJ(1));
t516 = cos(qJ(1));
t492 = t514 * g(1) - g(2) * t516;
t488 = qJDD(1) * pkin(1) + t492;
t493 = -g(1) * t516 - g(2) * t514;
t517 = qJD(1) ^ 2;
t489 = -pkin(1) * t517 + t493;
t509 = sin(pkin(7));
t512 = cos(pkin(7));
t471 = t509 * t488 + t512 * t489;
t557 = -pkin(2) * t517 + qJDD(1) * qJ(3) + (2 * qJD(1) * qJD(3)) + t471;
...
t495 = qJD(5) - t546;
t468 = -mrSges(6,2) * t495 + mrSges(6,3) * t475;
t543 = qJDD(1) * t511;
t494 = qJDD(5) - t543;
t439 = m(6) * t441 + mrSges(6,1) * t494 - mrSges(6,3) * t463 - t460 * t476 + t468 * t495;
t442 = t443 * t513 + t444 * t515;
t462 = -t476 * qJD(5) + qJDD(1) * t525;
t469 = mrSges(6,1) * t495 - mrSges(6,3) * t476;
t440 = m(6) * t442 - mrSges(6,2) * t494 + mrSges(6,3) * t462 + t460 * t475 - t469 * t495;
...
t537 = t511 * t426 - t435 * t508;
t418 = m(3) * t471 - mrSges(3,1) * t517 - qJDD(1) * mrSges(3,2) + t537;
...
t412 = m(2) * t492 + qJDD(1) * mrSges(2,1) - mrSges(2,2) * t517 + t414;
t538 = t512 * t418 - t423 * t509;
t413 = m(2) * t493 - mrSges(2,1) * t517 - qJDD(1) * mrSges(2,2) + t538;
t549 = t516 * t412 + t514 * t413;
t419 = t508 * t426 + t511 * t435;
t541 = m(3) * t506 + t419;
t539 = -t412 * t514 + t516 * t413;
...
t433 = mrSges(6,2) * t447 - mrSges(6,3) * t441 + Ifges(6,1) * t463 + Ifges(6,4) * t462 + Ifges(6,5) * t494 + t451 * t475 - t452 * t495;
t432 = -mrSges(6,1) * t447 + mrSges(6,3) * t442 + Ifges(6,4) * t463 + Ifges(6,2) * t462 + Ifges(6,6) * t494 - t451 * t476 + t453 * t495;
t421 = mrSges(5,2) * t449 - mrSges(5,3) * t445 - pkin(6) * t431 - t513 * t432 + t515 * t433 + (-t472 * t551 + t473 * t511) * qJD(1) + t521 * qJDD(1);
t420 = -mrSges(5,1) * t449 + mrSges(5,3) * t446 + t513 * t433 + t515 * t432 - pkin(4) * t522 + pkin(6) * t535 + (-t472 * t550 - t474 * t511) * qJD(1) + t520 * qJDD(1);
...
t406 = mrSges(3,2) * t506 - mrSges(3,3) * t470 + Ifges(3,5) * qJDD(1) - Ifges(3,6) * t517 - qJ(3) * t419 + t408 * t511 - t415 * t508;
t405 = -mrSges(2,2) * g(3) - mrSges(2,3) * t492 + Ifges(2,5) * qJDD(1) - Ifges(2,6) * t517 - qJ(2) * t414 + t406 * t512 - t407 * t509;
t404 = mrSges(2,1) * g(3) + mrSges(2,3) * t493 + t517 * Ifges(2,5) + Ifges(2,6) * qJDD(1) - pkin(1) * t541 + qJ(2) * t538 + t509 * t406 + t512 * t407;
t1 = [-m(1) * g(1) + t539; -m(1) * g(2) + t549; (-m(1) - m(2)) * g(3) + t541; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t549 - t514 * t404 + t516 * t405; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t539 + t516 * t404 + t514 * t405; pkin(1) * t414 + mrSges(2,1) * t492 - mrSges(2,2) * t493 + t508 * t408 + t511 * t415 + pkin(2) * t519 + qJ(3) * t537 + mrSges(3,1) * t470 - mrSges(3,2) * t471 - mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + (-pkin(2) * t554 + Ifges(2,3) + Ifges(3,3)) * qJDD(1);];
tauB = t1;
