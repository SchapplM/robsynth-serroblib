...
function [T_mdh, T_stack] = S5RPPPR1_joint_trafo_rotmat_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
...
t37 = sin(pkin(8));
t36 = sin(pkin(9));
t1 = [t45, -t43, 0, 0; t43, t45, 0, 0; 0, 0, 1, pkin(5); t41, -t38, 0, pkin(1); t38, t41, 0, 0; 0, 0, 1, qJ(2); t40, -t37, 0, pkin(2); 0, 0, -1, -qJ(3); t37, t40, 0, 0; t39, -t36, 0, pkin(3); 0, 0, -1, -qJ(4); t36, t39, 0, 0; t44, -t42, 0, pkin(4); t42, t44, 0, 0; 0, 0, 1, pkin(6);];
T_stack = t1;
