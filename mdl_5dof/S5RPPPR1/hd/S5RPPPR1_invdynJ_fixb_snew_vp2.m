...
t364 = sin(qJ(1));
t366 = cos(qJ(1));
t387 = t364 * g(1) - g(2) * t366;
t341 = qJDD(1) * pkin(1) + t387;
t367 = qJD(1) ^ 2;
t382 = -g(1) * t366 - g(2) * t364;
t342 = -pkin(1) * t367 + t382;
t359 = sin(pkin(7));
t362 = cos(pkin(7));
...
t394 = t358 * qJD(1);
t402 = (-pkin(2) + t380) * qJDD(1) + t372 - 0.2e1 * qJD(4) * t394;
t356 = -g(3) + qJDD(2);
...
t389 = t357 ^ 2 * t398;
t391 = qJDD(1) * t358;
t296 = -pkin(6) * t357 * t391 - pkin(4) * t389 + t337 * t393 + t298;
t363 = sin(qJ(5));
t365 = cos(qJ(5));
...
t1 = [Ifges(2,3) * qJDD(1) + mrSges(2,1) * t387 - mrSges(2,2) * t382 + Ifges(3,3) * qJDD(1) + mrSges(3,1) * t323 - mrSges(3,2) * t324 + t358 * (t340 * t393 + mrSges(4,2) * t319 - mrSges(4,3) * t309 + t360 * (mrSges(5,2) * t302 - mrSges(5,3) * t297 - pkin(6) * t284 - t363 * t285 + t365 * t286 + t326 * t393) - t357 * (-mrSges(5,1) * t302 + mrSges(5,3) * t298 + pkin(4) * t371 + pkin(6) * t385 + t365 * t285 + t363 * t286 - t327 * t393) - qJ(4) * t281 + (t377 * t361 + (Ifges(5,1) * t360 ^ 2 + Ifges(4,1) + (t400 - 0.2e1 * t401) * t357) * t358) * qJDD(1)) + t361 * (-mrSges(4,1) * t319 - mrSges(5,1) * t297 + mrSges(5,2) * t298 + mrSges(4,3) * t310 - pkin(3) * t281 - pkin(4) * t284 + (Ifges(4,2) + Ifges(5,3)) * t390 + (t377 * qJDD(1) + (-t326 * t360 - t327 * t357 - t340) * qJD(1)) * t358 - t368) - pkin(2) * t280 + qJ(3) * t386 + pkin(1) * (t359 * (m(3) * t324 - mrSges(3,1) * t367 - qJDD(1) * mrSges(3,2) + t386) + t362 * (m(3) * t323 - mrSges(3,2) * t367 + (mrSges(3,1) - t399) * qJDD(1) + t369)); m(3) * t356 + t279 * t358 + t287 * t361; t280; (t379 * qJD(1) + t381 * qJDD(1)) * t358 + t370; t368;];
tauJ = t1;
