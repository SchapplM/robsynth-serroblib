...
t63 = t64 * t88 + t65 * t89;
t62 = t64 * t89 - t65 * t88;
t1 = qJD(2) ^ 2 * t96 + m(5) * (t66 ^ 2 + t67 ^ 2 + t75 ^ 2) / 0.2e1 + m(4) * (t76 ^ 2 + t77 ^ 2 + t79 ^ 2) / 0.2e1 + m(6) * (t62 ^ 2 + t63 ^ 2 + t68 ^ 2) / 0.2e1 + (t62 * mrSges(6,1) - t63 * mrSges(6,2) + Ifges(6,3) * t81 / 0.2e1) * t81 + (t68 * mrSges(6,2) - t62 * mrSges(6,3) + Ifges(6,5) * t81 + Ifges(6,1) * t74 / 0.2e1) * t74 + (-t68 * mrSges(6,1) + t63 * mrSges(6,3) + Ifges(6,4) * t74 + Ifges(6,6) * t81 + Ifges(6,2) * t73 / 0.2e1) * t73 + ((t75 * (mrSges(5,1) * t82 + mrSges(5,2) * t85) + t79 * mrSges(4,2) - t76 * mrSges(4,3) + (Ifges(4,1) / 0.2e1 + Ifges(5,1) * t85 ^ 2 / 0.2e1 + (-Ifges(5,4) * t85 + Ifges(5,2) * t82 / 0.2e1) * t82) * t95 + (-t66 * t85 - t67 * t82) * mrSges(5,3)) * t83 + (t67 * mrSges(5,2) - t79 * mrSges(4,1) - t66 * mrSges(5,1) + t77 * mrSges(4,3) + (Ifges(4,2) / 0.2e1 + Ifges(5,3) / 0.2e1) * t94 + (-Ifges(5,5) * t85 + Ifges(5,6) * t82 + Ifges(4,4)) * t95) * t86 + (Ifges(3,3) / 0.2e1 + Ifges(2,3) / 0.2e1 + (mrSges(3,1) * t87 - mrSges(3,2) * t84 + (t84 ^ 2 + t87 ^ 2) * t96 * pkin(1)) * pkin(1)) * qJD(1)) * qJD(1);
T = t1;
