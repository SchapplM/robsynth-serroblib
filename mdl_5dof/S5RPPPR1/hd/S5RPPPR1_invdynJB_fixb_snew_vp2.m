...
% OptimizationMode: 2
% StartTime: 2022-01-20 09:12:32
% EndTime: 2022-01-20 09:12:36
% DurationCPUTime: 4.05s
% Computational Cost: add. (35992->234), mult. (83592->324), div. (0->0), fcn. (50610->10), ass. (0->118)
t680 = sin(qJ(1));
t682 = cos(qJ(1));
t656 = t680 * g(1) - t682 * g(2);
t651 = qJDD(1) * pkin(1) + t656;
t657 = -t682 * g(1) - t680 * g(2);
t683 = qJD(1) ^ 2;
t652 = -t683 * pkin(1) + t657;
t675 = sin(pkin(7));
t678 = cos(pkin(7));
t634 = t675 * t651 + t678 * t652;
t724 = -t683 * pkin(2) + qJDD(1) * qJ(3) + (2 * qJD(1) * qJD(3)) + t634;
...
t711 = t673 ^ 2 * t721;
t713 = qJDD(1) * t674;
t606 = -t673 * pkin(6) * t713 - pkin(4) * t711 + t647 * t715 + t608;
t679 = sin(qJ(5));
t681 = cos(qJ(5));
t603 = t681 * t605 - t679 * t606;
t693 = (-t673 * t681 - t676 * t679) * t674;
t638 = qJD(1) * t693;
t692 = (-t673 * t679 + t676 * t681) * t674;
t639 = qJD(1) * t692;
t622 = -t638 * mrSges(6,1) + t639 * mrSges(6,2);
t625 = t638 * qJD(5) + qJDD(1) * t692;
t659 = qJD(5) - t715;
t631 = -t659 * mrSges(6,2) + t638 * mrSges(6,3);
t712 = t677 * qJDD(1);
t658 = qJDD(5) - t712;
t600 = m(6) * t603 + t658 * mrSges(6,1) - t625 * mrSges(6,3) - t639 * t622 + t659 * t631;
t604 = t679 * t605 + t681 * t606;
t624 = -t639 * qJD(5) + qJDD(1) * t693;
t632 = t659 * mrSges(6,1) - t639 * mrSges(6,3);
t601 = m(6) * t604 - t658 * mrSges(6,2) + t624 * mrSges(6,3) + t638 * t622 - t659 * t632;
...
t707 = t677 * t585 - t674 * t596;
t575 = m(3) * t634 - t683 * mrSges(3,1) - qJDD(1) * mrSges(3,2) + t707;
...
t567 = m(2) * t656 + qJDD(1) * mrSges(2,1) - t683 * mrSges(2,2) + t570;
t708 = t678 * t575 - t675 * t582;
t568 = m(2) * t657 - t683 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t708;
t718 = t682 * t567 + t680 * t568;
t578 = t674 * t585 + t677 * t596;
t576 = m(3) * t672 + t578;
t709 = -t680 * t567 + t682 * t568;
...
t593 = -mrSges(6,1) * t609 + mrSges(6,3) * t604 + Ifges(6,4) * t625 + Ifges(6,2) * t624 + Ifges(6,6) * t658 - t639 * t613 + t659 * t615;
t614 = Ifges(6,4) * t639 + Ifges(6,2) * t638 + Ifges(6,6) * t659;
t594 = mrSges(6,2) * t609 - mrSges(6,3) * t603 + Ifges(6,1) * t625 + Ifges(6,4) * t624 + Ifges(6,5) * t658 + t638 * t613 - t659 * t614;
t635 = (-Ifges(5,3) * t677 + t674 * t699) * qJD(1);
t637 = t689 * qJD(1);
t579 = -mrSges(5,1) * t611 + mrSges(5,3) * t608 + t679 * t594 + t681 * t593 - pkin(4) * t690 + pkin(6) * t705 + (-t635 * t719 - t677 * t637) * qJD(1) + t688 * qJDD(1);
t636 = t688 * qJD(1);
t580 = mrSges(5,2) * t611 - mrSges(5,3) * t607 - pkin(6) * t592 - t679 * t593 + t681 * t594 + (-t635 * t720 + t636 * t677) * qJD(1) + t689 * qJDD(1);
t650 = t700 * qJD(1);
t563 = mrSges(4,2) * t628 - mrSges(4,3) * t618 - qJ(4) * t588 + qJDD(1) * t701 - t673 * t579 + t676 * t580 + t650 * t715;
...
t685 = mrSges(2,1) * t656 + mrSges(3,1) * t633 - mrSges(2,2) * t657 - mrSges(3,2) * t634 + pkin(1) * t570 - pkin(2) * t587 + qJ(3) * t707 + t674 * t563 + t677 * t572 + (Ifges(2,3) + Ifges(3,3)) * qJDD(1);
t602 = (qJD(1) * t697 + qJDD(1) * t702) * t674 + t686;
...
t560 = mrSges(3,2) * t672 - mrSges(3,3) * t633 + Ifges(3,5) * qJDD(1) - t683 * Ifges(3,6) - qJ(3) * t578 + t677 * t563 - t674 * t572;
t559 = -mrSges(2,2) * g(3) - mrSges(2,3) * t656 + Ifges(2,5) * qJDD(1) - t683 * Ifges(2,6) - qJ(2) * t570 + t678 * t560 - t675 * t561;
t558 = mrSges(2,1) * g(3) + mrSges(2,3) * t657 + t683 * Ifges(2,5) + Ifges(2,6) * qJDD(1) - pkin(1) * t576 + qJ(2) * t708 + t675 * t560 + t678 * t561;
t1 = [-m(1) * g(1) + t709; -m(1) * g(2) + t718; (-m(1) - m(2)) * g(3) + t576; -mrSges(1,2) * g(3) + mrSges(1,3) * g(2) - pkin(5) * t718 - t680 * t558 + t682 * t559; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + pkin(5) * t709 + t682 * t558 + t680 * t559; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t685; t685; t576; t587; t602; t684;];
tauJB = t1;
