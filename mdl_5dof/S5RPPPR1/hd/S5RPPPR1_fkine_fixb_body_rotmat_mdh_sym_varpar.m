...
elseif link_index == 3
	...
	t52 = cos(t53);
	t51 = sin(t53);
	t1 = [t52 * t55, -t52 * t54, t51, t52 * pkin(2) + t51 * qJ(3) + cos(qJ(1)) * pkin(1) + 0; t51 * t55, -t51 * t54, -t52, t51 * pkin(2) - t52 * qJ(3) + sin(qJ(1)) * pkin(1) + 0; t54, t55, 0, qJ(2) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 4
	...
	t57 = cos(t58);
	t56 = sin(t58);
	t1 = [t56 * t59 + t57 * t64, t56 * t61 - t57 * t65, t57 * t60, cos(qJ(1)) * pkin(1) + t56 * qJ(3) + 0 + t63 * t57; t56 * t64 - t57 * t59, -t56 * t65 - t57 * t61, t56 * t60, sin(qJ(1)) * pkin(1) - t57 * qJ(3) + 0 + t63 * t56; t60 * t61, -t60 * t59, -t62, t60 * pkin(3) - t62 * qJ(4) + pkin(5) + qJ(2) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 5
	...
	t69 = cos(t71);
	t67 = sin(t71);
	t1 = [t68 * t67 + t69 * t79, -t67 * t79 + t68 * t69, t70 * t74, cos(qJ(1)) * pkin(1) + 0 + t78 * t68 + t77 * t70; -t70 * t67 + t69 * t80, -t67 * t80 - t70 * t69, t68 * t74, sin(qJ(1)) * pkin(1) + 0 - t78 * t70 + t77 * t68; t74 * t69, -t74 * t67, -t75, t74 * t66 + t75 * t76 + pkin(5) + qJ(2) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
end