...
%   see S5RPRRP13_invdynJ_fixb_regmin2vec.m
% MDP [24x1]
...
function tauJ = S5RPRRP13_invdynJ_fixb_mdp_slag_vr(RV, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(67,1), zeros(24,1)}
assert(isreal(MDP) && all(size(MDP) == [24 1]), ...
  'S5RPRRP13_invdynJ_fixb_mdp_slag_vr: MDP has to be [24x1] (double)'); 
