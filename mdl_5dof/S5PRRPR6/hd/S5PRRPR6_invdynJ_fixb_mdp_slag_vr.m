...
%   see S5PRRPR6_invdynJ_fixb_regmin2vec.m
% MDP [22x1]
...
function tauJ = S5PRRPR6_invdynJ_fixb_mdp_slag_vr(RV, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(62,1), zeros(22,1)}
assert(isreal(MDP) && all(size(MDP) == [22 1]), ...
  'S5PRRPR6_invdynJ_fixb_mdp_slag_vr: MDP has to be [22x1] (double)'); 
