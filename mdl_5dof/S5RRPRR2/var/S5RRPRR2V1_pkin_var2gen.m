% Umwandlung der Kinematikparameter von S5RRPRR2V1 zu S5RRPRR2
% Eingabe:
% pkin_var (7x1) double
...
%
% Siehe auch: S5RRPRR2_structural_kinematic_parameters.m
function pkin_gen = S5RRPRR2V1_pkin_var2gen(pkin_var)
pkin_gen = zeros(9,1);
