...
t63 = t91 * t64 + t93 * t65;
t62 = t93 * t64 - t91 * t65;
t1 = qJD(2) ^ 2 * t99 + m(5) * (t66 ^ 2 + t67 ^ 2 + t78 ^ 2) / 0.2e1 + m(4) * (t76 ^ 2 + t77 ^ 2 + t82 ^ 2) / 0.2e1 + m(6) * (t62 ^ 2 + t63 ^ 2 + t70 ^ 2) / 0.2e1 + (t62 * mrSges(6,1) - t63 * mrSges(6,2) + Ifges(6,3) * t86 / 0.2e1) * t86 + (t78 * mrSges(5,2) - t66 * mrSges(5,3) + Ifges(5,1) * t80 / 0.2e1) * t80 + (-t78 * mrSges(5,1) + t67 * mrSges(5,3) + Ifges(5,4) * t80 + Ifges(5,2) * t79 / 0.2e1) * t79 + (t70 * mrSges(6,2) - t62 * mrSges(6,3) + Ifges(6,5) * t86 + Ifges(6,1) * t69 / 0.2e1) * t69 + (-t70 * mrSges(6,1) + t63 * mrSges(6,3) + Ifges(6,4) * t69 + Ifges(6,6) * t86 + Ifges(6,2) * t68 / 0.2e1) * t68 + (t66 * mrSges(5,1) - t67 * mrSges(5,2) + Ifges(5,5) * t80 + Ifges(5,6) * t79 + Ifges(5,3) * qJD(4) / 0.2e1) * qJD(4) + (t82 * (-mrSges(4,1) * t89 + mrSges(4,2) * t87) + (-t76 * t87 + t77 * t89) * mrSges(4,3) + (Ifges(3,3) / 0.2e1 + Ifges(2,3) / 0.2e1 + (t90 * mrSges(3,1) - t88 * mrSges(3,2) + (t88 ^ 2 + t90 ^ 2) * t99 * pkin(1)) * pkin(1) + Ifges(4,2) * t89 ^ 2 / 0.2e1 + (Ifges(4,4) * t89 + Ifges(4,1) * t87 / 0.2e1) * t87) * qJD(1)) * qJD(1);
T = t1;
