...
t5 = sin(t15);
t7 = cos(t15);
t30 = m(4) * pkin(2) + t18 * mrSges(4,1) - t17 * mrSges(4,2) + mrSges(3,1) + m(6) * (pkin(4) * t7 + t4) + t3 * mrSges(6,1) - t2 * mrSges(6,2) + m(5) * t4 + t7 * mrSges(5,1) - t5 * mrSges(5,2);
t19 = -pkin(6) - qJ(3);
t29 = -m(4) * qJ(3) + m(5) * t19 + m(6) * (-pkin(7) + t19) + mrSges(3,2) - mrSges(4,3) - mrSges(5,3) - mrSges(6,3);
t28 = pkin(5) + r_base(1);
t10 = qJ(2) + t28;
t25 = t17 * pkin(3) + t10;
t21 = cos(qJ(1));
...
t8 = cos(t16);
t6 = sin(t16);
t1 = (-mrSges(2,1) * t21 + t20 * mrSges(2,2) - mrSges(1,3) + t33 * r_base(3) - t30 * t8 + t31 * (t21 * pkin(1) + r_base(3)) + t29 * t6) * g(3) + (t20 * mrSges(2,1) + mrSges(2,2) * t21 - mrSges(1,2) + t33 * r_base(2) + t31 * (-pkin(1) * t20 + r_base(2)) + t29 * t8 + t30 * t6) * g(2) + (-m(1) * r_base(1) - mrSges(1,1) - m(2) * t28 - mrSges(2,3) - mrSges(3,3) - mrSges(4,1) * t17 - mrSges(4,2) * t18 - m(5) * t25 - t5 * mrSges(5,1) - t7 * mrSges(5,2) - m(6) * (pkin(4) * t5 + t25) - t2 * mrSges(6,1) - t3 * mrSges(6,2) + t32 * t10) * g(1);
U = t1;
