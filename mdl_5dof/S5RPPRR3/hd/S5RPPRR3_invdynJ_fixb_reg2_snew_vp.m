...
t195 = sin(qJ(1));
t196 = cos(qJ(1));
t165 = t196 * g(1) + t195 * g(2);
t197 = qJD(1) ^ 2;
t128 = -t197 * pkin(1) - t165;
t148 = sin(pkin(8));
t150 = cos(pkin(8));
t164 = t195 * g(1) - t196 * g(2);
t161 = qJDD(1) * pkin(1) + t164;
