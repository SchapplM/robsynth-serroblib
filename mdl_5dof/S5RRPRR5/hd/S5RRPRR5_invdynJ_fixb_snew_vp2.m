...
t371 = sin(qJ(1));
t375 = cos(qJ(1));
t390 = t371 * g(1) - t375 * g(2);
t349 = qJDD(1) * pkin(1) + t390;
t385 = -t375 * g(1) - t371 * g(2);
t350 = -qJD(1) ^ 2 * pkin(1) + t385;
t370 = sin(qJ(2));
t374 = cos(qJ(2));
t337 = t370 * t349 + t374 * t350;
t334 = -t359 * pkin(2) + t361 * qJ(3) + t337;
t392 = qJD(3) * t365;
t389 = -t367 * g(3) - 0.2e1 * t366 * t392;
t315 = (-pkin(7) * t361 + t359 * t398 - t334) * t366 + t389;
t319 = -t366 * g(3) + (t334 + 0.2e1 * t392) * t367;
t316 = -pkin(3) * t395 + pkin(7) * t394 + t319;
t369 = sin(qJ(4));
t373 = cos(qJ(4));
t297 = t373 * t315 - t369 * t316;
...
t340 = qJD(4) * pkin(4) - t343 * pkin(8);
t341 = t342 ^ 2;
t294 = -t341 * pkin(4) + t332 * pkin(8) - qJD(4) * t340 + t298;
t368 = sin(qJ(5));
t372 = cos(qJ(5));
t291 = t372 * t293 - t368 * t294;
t325 = t372 * t342 - t368 * t343;
t305 = t325 * qJD(5) + t368 * t332 + t372 * t333;
t326 = t368 * t342 + t372 * t343;
t311 = -t325 * mrSges(6,1) + t326 * mrSges(6,2);
t364 = qJD(4) + qJD(5);
t320 = -t364 * mrSges(6,2) + t325 * mrSges(6,3);
t360 = qJDD(4) + qJDD(5);
t288 = m(6) * t291 + t360 * mrSges(6,1) - t305 * mrSges(6,3) - t326 * t311 + t364 * t320;
t292 = t368 * t293 + t372 * t294;
t304 = -t326 * qJD(5) + t372 * t332 - t368 * t333;
t321 = t364 * mrSges(6,1) - t326 * mrSges(6,3);
t289 = m(6) * t292 - t360 * mrSges(6,2) + t304 * mrSges(6,3) + t325 * t311 - t364 * t321;
t280 = t372 * t288 + t368 * t289;
t330 = -t342 * mrSges(5,1) + t343 * mrSges(5,2);
t338 = -qJD(4) * mrSges(5,2) + t342 * mrSges(5,3);
t278 = m(5) * t297 + qJDD(4) * mrSges(5,1) - t333 * mrSges(5,3) + qJD(4) * t338 - t343 * t330 + t280;
t339 = qJD(4) * mrSges(5,1) - t343 * mrSges(5,3);
t386 = -t368 * t288 + t372 * t289;
t279 = m(5) * t298 - qJDD(4) * mrSges(5,2) + t332 * mrSges(5,3) - qJD(4) * t339 + t342 * t330 + t386;
t393 = t373 * t278 + t369 * t279;
t318 = -t366 * t334 + t389;
t382 = mrSges(4,3) * t361 + (-mrSges(4,1) * t367 + t397) * t359;
t387 = -t369 * t278 + t373 * t279;
t388 = -t366 * (m(4) * t318 - t382 * t366 + t393) + t367 * (m(4) * t319 + t382 * t367 + t387);
t336 = t374 * t349 - t370 * t350;
t384 = qJDD(3) - t336;
t362 = t366 ^ 2;
t317 = (-pkin(2) - t398) * t361 + (-qJ(3) + (-t362 - t363) * pkin(7)) * t359 + t384;
t296 = -t332 * pkin(4) - t341 * pkin(8) + t343 * t340 + t317;
...
t281 = -mrSges(6,1) * t296 + mrSges(6,3) * t292 + Ifges(6,4) * t305 + Ifges(6,2) * t304 + Ifges(6,6) * t360 - t326 * t306 + t364 * t308;
t307 = Ifges(6,4) * t326 + Ifges(6,2) * t325 + Ifges(6,6) * t364;
t282 = mrSges(6,2) * t296 - mrSges(6,3) * t291 + Ifges(6,1) * t305 + Ifges(6,4) * t304 + Ifges(6,5) * t360 + t325 * t306 - t364 * t307;
...
t272 = mrSges(5,2) * t317 - mrSges(5,3) * t297 + Ifges(5,1) * t333 + Ifges(5,4) * t332 + Ifges(5,5) * qJDD(4) - pkin(8) * t280 - qJD(4) * t323 - t368 * t281 + t372 * t282 + t342 * t322;
t331 = -t361 * pkin(2) - t359 * qJ(3) + t384;
t377 = m(5) * t317 - t332 * mrSges(5,1) + t333 * mrSges(5,2) - t342 * t338 + t343 * t339 + t383;
...
t1 = [Ifges(2,3) * qJDD(1) + mrSges(2,1) * t390 - mrSges(2,2) * t385 + pkin(1) * (t370 * (m(3) * t337 - t359 * mrSges(3,1) - t361 * mrSges(3,2) + t388) + t374 * ((mrSges(3,1) - t397) * t361 + t376 - t359 * mrSges(3,2) + m(3) * t336)) + t379; t379; t284; mrSges(5,1) * t297 - mrSges(5,2) * t298 + Ifges(5,5) * t333 + Ifges(5,6) * t332 + Ifges(5,3) * qJDD(4) + pkin(4) * t280 + t323 * t343 - t324 * t342 + t378; t378;];
tauJ = t1;
