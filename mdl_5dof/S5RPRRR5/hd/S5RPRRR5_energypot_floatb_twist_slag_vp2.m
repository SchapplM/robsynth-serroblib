...
t16 = cos(qJ(4));
t9 = sin(t13);
t28 = m(5) * pkin(3) + mrSges(5,1) * t16 - mrSges(5,2) * t14 + mrSges(4,1) + m(6) * (pkin(4) * t16 + pkin(3)) + t10 * mrSges(6,1) - t9 * mrSges(6,2);
...
t23 = qJ(2) + t26;
t17 = cos(qJ(1));
t22 = -pkin(1) * t17 + r_base(3);
t8 = qJ(3) + t12;
t7 = cos(t12);
t6 = sin(t12);
t3 = cos(t8);
t2 = sin(t8);
t1 = (-m(3) * t22 + mrSges(2,1) * t17 + t7 * mrSges(3,1) - mrSges(2,2) * t15 - t6 * mrSges(3,2) - mrSges(1,3) + t30 * r_base(3) + t28 * t3 + t29 * (-pkin(2) * t7 + t22) + t27 * t2) * g(3) + (-m(3) * t25 - mrSges(2,1) * t15 - t6 * mrSges(3,1) - mrSges(2,2) * t17 - t7 * mrSges(3,2) - mrSges(1,2) + t30 * r_base(2) + t29 * (pkin(2) * t6 + t25) + t27 * t3 - t28 * t2) * g(2) + (-m(1) * r_base(1) - m(2) * t26 - m(3) * t23 - t9 * mrSges(6,1) - mrSges(5,2) * t16 - t10 * mrSges(6,2) - mrSges(1,1) - mrSges(2,3) - mrSges(3,3) - mrSges(4,3) + (-m(6) * pkin(4) - mrSges(5,1)) * t14 + t29 * (pkin(6) + t23)) * g(1);
U = t1;
