...
t54 = -mrSges(5,1) * t42 - mrSges(5,2) * t45;
t8 = (-pkin(8) - t15) * t42;
t36 = t45 * pkin(8);
t9 = t15 * t45 + t36;
t2 = -t41 * t9 + t44 * t8;
...
t50 = (mrSges(6,1) * t44 - mrSges(6,2) * t41) * pkin(4);
t33 = -pkin(3) - t63;
t12 = t14 - t63;
t1 = [0.2e1 * t62 - 0.2e1 * t61 + t12 * t65 + 0.2e1 * t14 * t26 + Ifges(2,3) + Ifges(3,3) + (-t2 * t25 + t3 * t24) * t58 + t15 * t52 + m(6) * (t12 ^ 2 + t2 ^ 2 + t3 ^ 2) + m(5) * (t15 ^ 2 * t59 + t14 ^ 2) + m(4) * (t17 ^ 2 + t18 ^ 2) + t55 + (0.2e1 * t40 * mrSges(3,1) - 0.2e1 * t39 * mrSges(3,2) + m(3) * (t39 ^ 2 + t40 ^ 2) * pkin(1)) * pkin(1); m(6) * (t2 * t24 + t25 * t3); m(3) + m(4) + m(5) * t59 + m(6) * (t24 ^ 2 + t68); t62 - t61 + (t12 + t33) * t6 + (t14 - pkin(3)) * t26 + m(6) * (t10 * t2 + t11 * t3 + t12 * t33) + m(5) * (-pkin(3) * t14 + pkin(7) * t56) + ((-t10 - t2) * t25 + (t11 + t3) * t24) * mrSges(6,3) + (pkin(7) * t59 + t56) * mrSges(5,3) + t55; m(6) * (t10 * t24 + t11 * t25); -0.2e1 * pkin(3) * t26 + t33 * t65 + (-t10 * t25 + t11 * t24) * t58 + pkin(7) * t52 + m(6) * (t10 ^ 2 + t11 ^ 2 + t33 ^ 2) + m(5) * (pkin(7) ^ 2 * t59 + pkin(3) ^ 2) + t55; t54 * t15 + (-t57 + m(6) * (t2 * t44 + t3 * t41)) * pkin(4) + t53 + t66; m(6) * (t24 * t44 + t25 * t41) * pkin(4) - t26 - t6; t54 * pkin(7) + (-t57 + m(6) * (t10 * t44 + t11 * t41)) * pkin(4) + t51 + t66; Ifges(5,3) + Ifges(6,3) + m(6) * (t41 ^ 2 + t44 ^ 2) * pkin(4) ^ 2 + 0.2e1 * t50; t53; -t6; t51; Ifges(6,3) + t50; Ifges(6,3);];
