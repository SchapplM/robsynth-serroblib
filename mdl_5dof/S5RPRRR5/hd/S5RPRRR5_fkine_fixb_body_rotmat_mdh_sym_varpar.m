...
if link_index == 0
	...
	% OptimizationMode: 2
	% StartTime: 2022-01-20 09:48:28
	% EndTime: 2022-01-20 09:48:28
...
elseif link_index == 4
	...
	t47 = cos(t48);
	t46 = sin(t48);
	t1 = [t47 * t51, -t47 * t50, t46, t47 * pkin(3) + t46 * pkin(7) + pkin(2) * cos(t49) + cos(qJ(1)) * pkin(1) + 0; t46 * t51, -t46 * t50, -t47, t46 * pkin(3) - t47 * pkin(7) + pkin(2) * sin(t49) + sin(qJ(1)) * pkin(1) + 0; t50, t51, 0, pkin(6) + qJ(2) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
elseif link_index == 5
	...
	t53 = cos(t55);
	t52 = sin(t55);
	t1 = [t53 * t57, -t53 * t56, t52, t53 * t54 - t52 * t60 + pkin(2) * cos(t58) + cos(qJ(1)) * pkin(1) + 0; t52 * t57, -t52 * t56, -t53, t52 * t54 + t53 * t60 + pkin(2) * sin(t58) + sin(qJ(1)) * pkin(1) + 0; t56, t57, 0, sin(qJ(4)) * pkin(4) + pkin(6) + qJ(2) + pkin(5) + 0; 0, 0, 0, 1;];
	Tc_mdh = t1;
end