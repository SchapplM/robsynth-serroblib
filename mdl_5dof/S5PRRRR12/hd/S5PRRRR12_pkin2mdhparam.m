...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = S5PRRRR12_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(11,1)}
assert(isreal(pkin) && all(size(pkin) == [11 1]), ...
  'S5PRRRR12_pkin2mdhparam: Kinematic parameters pkin have to be [11x1] (double)');
