...
t236 = -pkin(4) * t149 + pkin(6) * t150 + t77;
t161 = sin(qJ(1));
t156 = t161 ^ 2;
t164 = cos(qJ(1));
t152 = sin(t158);
...
t226 = -t86 - t88;
t206 = t150 * t164;
t87 = rSges(5,1) * t206 - rSges(5,2) * t207 - rSges(5,3) * t161;
t126 = t164 * t134;
t146 = t164 * t151;
t89 = -t146 + t126;
t225 = -t87 - t89;
...
t196 = -t88 + t216;
t195 = -t89 + t215;
t133 = -rSges(4,1) * t152 - rSges(4,2) * t153;
t194 = t133 - t230;
...
t193 = t8 * t208 / 0.2e1 + t3 * t233 + t4 * t234 + t150 * (-t217 + t218) / 0.2e1 + t9 * t207 / 0.2e1;
t192 = -t229 - t230;
t191 = t222 - t224;
...
t101 = -rSges(4,2) * t205 - rSges(4,3) * t161 + t164 * t223;
t166 = t161 * t235 + t199;
...
t148 = t164 * t224;
t145 = rSges(2,1) * t164 - rSges(2,2) * t161;
t144 = -rSges(2,1) * t161 - rSges(2,2) * t164;
t143 = -rSges(3,1) * t160 - rSges(3,2) * t163;
t128 = -pkin(1) * t164 + t146;
t127 = (-pkin(1) + t151) * t161;
t124 = -rSges(5,1) * t149 - rSges(5,2) * t150;
t113 = t164 * t124;
t112 = t161 * t124;
...
t1 = [-t150 * t122 - t153 * t131 - t152 * t132 - t163 * (-Icges(3,2) * t163 - t214) - t160 * (-Icges(3,1) * t160 - t213) + Icges(2,3) + (-t123 - t221) * t149 + m(6) * (t37 ^ 2 + t38 ^ 2) + m(5) * (t64 ^ 2 + t65 ^ 2) + m(4) * (t70 ^ 2 + t71 ^ 2) + m(3) * (t98 ^ 2 + t99 ^ 2) + m(2) * (t144 ^ 2 + t145 ^ 2) + t227; t165 + (t157 / 0.2e1 + t156 / 0.2e1) * (-Icges(3,5) * t160 - Icges(3,6) * t163) + m(6) * (t37 * t44 + t38 * t43) + m(5) * (t64 * t69 + t65 * t68) + m(4) * (t70 * t91 + t71 * t90) + m(3) * (t161 * t99 + t164 * t98) * t143 + (-t163 * (-Icges(3,6) * t161 + t164 * t180) - t160 * (-Icges(3,5) * t161 + t164 * t183)) * t234 + (-t163 * (Icges(3,6) * t164 + t161 * t180) - t160 * (Icges(3,5) * t164 + t161 * t183)) * t233; m(6) * (t11 ^ 2 + t43 ^ 2 + t44 ^ 2) + m(5) * (t26 ^ 2 + t68 ^ 2 + t69 ^ 2) + m(4) * (t36 ^ 2 + t90 ^ 2 + t91 ^ 2) + t164 * t157 * t106 + m(3) * (t143 ^ 2 * t200 + t63 ^ 2) + t199 + (-t156 * t107 + (t161 * t106 - t164 * t107) * t164 + t235) * t161; t165 + m(6) * (t37 * t50 + t38 * t49) + m(5) * (t64 * t79 + t65 * t78) + m(4) * (t161 * t71 + t164 * t70) * t133; m(6) * (t11 * t12 + t43 * t49 + t44 * t50) + m(5) * (t26 * t33 + t68 * t78 + t69 * t79) + m(4) * (t52 * t36 + (t161 * t90 + t164 * t91) * t133) + t166; m(6) * (t12 ^ 2 + t49 ^ 2 + t50 ^ 2) + m(5) * (t33 ^ 2 + t78 ^ 2 + t79 ^ 2) + m(4) * (t133 ^ 2 * t200 + t52 ^ 2) + t166; m(6) * (t37 * t60 + t38 * t59) + m(5) * (t161 * t65 + t164 * t64) * t124 + t167; m(6) * (t11 * t25 + t43 * t59 + t44 * t60) + m(5) * (t51 * t26 + (t161 * t68 + t164 * t69) * t124) + t170; m(6) * (t12 * t25 + t49 * t59 + t50 * t60) + m(5) * (t51 * t33 + (t161 * t78 + t164 * t79) * t124) + t170; m(5) * (t124 ^ 2 * t200 + t51 ^ 2) + m(6) * (t25 ^ 2 + t59 ^ 2 + t60 ^ 2) + t170; m(6) * (t34 * t37 + t35 * t38) + t32 + ((t30 / 0.2e1 + t24 / 0.2e1) * t164 + (t29 / 0.2e1 + t23 / 0.2e1) * t161) * t149; m(6) * (t11 * t31 + t34 * t44 + t35 * t43) + t193; m(6) * (t12 * t31 + t34 * t50 + t35 * t49) + t193; m(6) * (t25 * t31 + t34 * t60 + t35 * t59) + t193; m(6) * (t31 ^ 2 + t34 ^ 2 + t35 ^ 2) + t150 * t32 + (t164 * t4 + t161 * t3 + t150 * (t161 * t23 + t164 * t24)) * t149;];
