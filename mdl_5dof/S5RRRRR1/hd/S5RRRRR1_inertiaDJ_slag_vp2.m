...
t1 = [0.2e1 * t72 * (-mrSges(4,1) * t45 + mrSges(4,2) * t44) + 0.2e1 * t57 * Ifges(4,2) * t45 - 0.2e1 * t44 * t93 * Ifges(4,1) + (t25 * t134 + t20 * t15) * t81 + (t24 * t134 - t20 * t14) * t77 + 0.2e1 * (t57 * t44 - t45 * t93) * Ifges(4,4) + (m(6) * t113 * t134 + 0.2e1 * qJD(5) * t95 + 0.2e1 * t81 * t6 + 0.2e1 * t77 * t7) * t22 - (mrSges(5,1) * t133 + ((2 * Ifges(5,2)) + Ifges(6,3)) * t21 + t102 * t20 + t114) * t94 + (mrSges(5,2) * t133 + 0.2e1 * Ifges(5,1) * t20 - t77 * t3 + t81 * t4 + (Ifges(6,5) * t81 + t102) * t21 + (-t81 * t14 - t77 * t15 + t94 * t96) * qJD(5)) * t40 + ((-pkin(1) * mrSges(3,2) + Ifges(3,4) * t84) * t107 + (-0.2e1 * pkin(1) * mrSges(3,1) - 0.2e1 * Ifges(3,4) * t80 + (-Ifges(3,2) + Ifges(3,1)) * t107 - 0.2e1 * (m(4) * t72 - mrSges(4,1) * t57 - mrSges(4,2) * t93) * pkin(2)) * t80) * qJD(2) + 0.2e1 * (m(5) * t34 + mrSges(5,1) * t21 + mrSges(5,2) * t20) * t46; t85 + t48 * t5 + t37 * t23 + t88 * t49 + t95 * t36 + (-Ifges(3,5) * t84 + Ifges(3,6) * t80) * qJD(2) + (-t50 * t20 - t51 * t21 + t36 * t94 + t37 * t40) * mrSges(5,3) + (-t44 * t83 + t45 * t79 + (t57 * t83 - t79 * t93) * qJD(3)) * pkin(2) * mrSges(4,3); -0.2e1 * t124 + 0.2e1 * t31 + 0.2e1 * t32 + 0.2e1 * t33 - 0.2e1 * t35 + 0.2e1 * t43 + 0.2e1 * t89 + 0.2e1 * m(5) * (t36 * t51 - t37 * t50) + 0.2e1 * m(6) * (t104 * t49 + t37 * t48) + t90; t70 * t5 + t85 + t88 * t69 + ((-t20 * t82 - t21 * t78) * mrSges(5,3) + ((mrSges(5,3) * t40 + t23) * t78 + (mrSges(5,3) * t94 + t95) * t82) * qJD(4)) * pkin(3); t86 + m(6) * (t37 * t70 + (t122 + t123) * t69) + (m(5) * (t36 * t78 - t37 * t82) + (m(5) * (-t50 * t78 + t51 * t82) + m(6) * (t138 * t49 + t48 * t78) + t100) * qJD(4)) * pkin(3) + t89 + t136; 0.2e1 * t47 + 0.2e1 * t55 + 0.2e1 * t65 + 0.2e1 * t66 + 0.2e1 * (m(6) * (t138 * t69 + t70 * t78) + t100) * t112 + t90; -pkin(4) * t5 + pkin(6) * t88 + t87; -t130 + m(6) * (-pkin(4) * t37 + pkin(6) * t104) + t86; -t130 + (m(6) * (-pkin(4) * t78 + t138 * pkin(6)) + t100) * t112 + t90 + t136; t90 - 0.2e1 * t130; t8 * t129 + (-mrSges(6,2) * t8 - Ifges(6,6) * t20) * t77 + (-t22 * t99 - t40 * t96) * qJD(5) + t114; t73 - t99 * t36 + (t49 * t62 - t126) * qJD(5); t73 - t99 * t106 + (t62 * t69 - t126) * qJD(5); t73 + (pkin(6) * t62 - t126) * qJD(5); 0;];
