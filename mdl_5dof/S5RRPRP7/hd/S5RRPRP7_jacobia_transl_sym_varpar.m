...
function Ja_transl = S5RRPRP7_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RRPRP7_jacobia_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RRPRP7_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RRPRP7_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RRPRP7_jacobia_transl_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t2 = -t7 * t21 + t23;
	t1 = t7 * t22 + t20;
	t5 = [t2 * r_i_i_C(1) + t1 * r_i_i_C(2) - t15 * t10 - t25 * t13, t16 * t15, t13, r_i_i_C(1) * t3 - r_i_i_C(2) * t4, 0; t4 * r_i_i_C(1) + t3 * r_i_i_C(2) - t13 * t10 + t25 * t15, t16 * t13, -t15, -r_i_i_C(1) * t1 + r_i_i_C(2) * t2, 0; 0, t17 * t7 + t26, 0, (-r_i_i_C(1) * t11 - r_i_i_C(2) * t14) * t6, 0;];
	Ja_transl = t5;
elseif link_index == 5
	%% Symbolic Calculation
	...
	t2 = t9 * t24 - t22;
	t1 = t9 * t25 + t23;
	t5 = [-t21 * t1 - t12 * t17 - t29 * t15 - t27 * t2, t18 * t17, t15, t21 * t4 - t27 * t3, t3; -t15 * t12 + t29 * t17 + t21 * t3 + t27 * t4, t18 * t15, -t17, -t27 * t1 + t21 * t2, t1; 0, t28 * t9 + t30, 0, (-t27 * t13 + t21 * t16) * t8, t8 * t13;];
	Ja_transl = t5;
else
	Ja_transl=NaN(3,5);
end