...
function JaD_transl = S5RPRRR11_jacobiaD_transl_sym_varpar(qJ, qJD, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'S5RPRRR11_jacobiaD_transl_sym_varpar: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'S5RPRRR11_jacobiaD_transl_sym_varpar: qJD has to be [5x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'S5RPRRR11_jacobiaD_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'S5RPRRR11_jacobiaD_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'S5RPRRR11_jacobiaD_transl_sym_varpar: pkin has to be [8x1] (double)');
if link_index == 0
...
elseif link_index == 4
	...
	t35 = t44 * t52;
	t1 = [t46 * t44 + (-t47 * t42 + t54 * t44) * qJD(1), t56, t35 + (-t60 + t62) * t56 + (-pkin(3) * t55 + t39 * t49) * t42, -t42 * t53 + t35 + (-t37 * t56 - t42 * t58) * r_i_i_C(2), 0; t46 * t42 + (t54 * t42 + t47 * t44) * qJD(1), t57, (t43 * t57 + t44 * t55) * pkin(3) + t48, t48, 0; 0, 0, t50 - t51, t50, 0;];
	JaD_transl = t1;
elseif link_index == 5
	%% Symbolic Calculation
	...
	t45 = t60 * t70;
	t39 = -t57 * t78 - t74;
	t1 = [t61 * t60 + (-t64 * t58 + t75 * t60) * qJD(1), t76, t45 + t60 * t66 + (t39 + t65) * t58, t45 + t85 * t76 + (t65 - t74) * t58, -t58 * t72 + t45 + (-t48 * t76 - t58 * t80) * r_i_i_C(2); t61 * t58 + (t75 * t58 + t64 * t60) * qJD(1), t77, -t60 * t39 + t58 * t66 + t71, (t52 * t77 + t60 * t79) * pkin(4) + t63, t63; 0, 0, t62 - t69, t62, t68;];
	JaD_transl = t1;
else
	JaD_transl=NaN(3,5);
end