...
% OptimizationMode: 2
% StartTime: 2022-01-23 08:59:19
% EndTime: 2022-01-23 08:59:21
...
t403 = sin(qJ(1));
t405 = cos(qJ(1));
t419 = -g(1) * t405 - g(2) * t403;
t444 = -pkin(1) * t406 + qJDD(1) * qJ(2) + (2 * qJD(1) * qJD(2)) + t419;
t359 = -g(3) * t398 + t444 * t401;
...
t397 = sin(pkin(8));
t400 = cos(pkin(8));
t424 = g(1) * t403 - t405 * g(2);
t409 = -qJ(2) * t406 + qJDD(2) - t424;
t435 = qJD(1) * t398;
t443 = (-pkin(1) + t416) * qJDD(1) + t409 - 0.2e1 * qJD(3) * t435;
t330 = -t397 * t350 + t443 * t400;
t358 = -t401 * g(3) - t444 * t398;
t396 = sin(pkin(9));
t399 = cos(pkin(9));
t438 = t398 * t400;
