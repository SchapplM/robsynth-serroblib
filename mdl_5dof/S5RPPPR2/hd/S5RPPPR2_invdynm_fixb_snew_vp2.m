...
t248 = sin(qJ(1));
t250 = cos(qJ(1));
t227 = -t250 * g(1) - t248 * g(2);
t251 = qJD(1) ^ 2;
t298 = -t251 * pkin(1) + qJDD(1) * qJ(2) + (2 * qJD(1) * qJD(2)) + t227;
t195 = -t243 * g(3) + t298 * t246;
...
t242 = sin(pkin(8));
t245 = cos(pkin(8));
t226 = t248 * g(1) - t250 * g(2);
t260 = -t251 * qJ(2) + qJDD(2) - t226;
t285 = qJD(1) * t243;
t297 = (-pkin(1) + t268) * qJDD(1) + t260 - 0.2e1 * qJD(3) * t285;
t166 = -t242 * t186 + t297 * t245;
t194 = -t246 * g(3) - t298 * t243;
t241 = sin(pkin(9));
t244 = cos(pkin(9));
t288 = t243 * t245;
...
t124 = t252 + (-t292 + (t293 + (-Ifges(4,2) - Ifges(5,3)) * t242) * t243) * qJDD(1) + (-t198 * t288 - t246 * t200) * qJD(1) - mrSges(4,1) * t185 + mrSges(4,3) * t167 - pkin(3) * t140;
...
t296 = -((Ifges(3,4) * t243 + Ifges(3,2) * t246) * t285 - t271 * t284) * qJD(1) - mrSges(3,1) * t194 + mrSges(3,2) * t195 - pkin(2) * ((t265 * qJD(1) - t272 * qJDD(1)) * t243 + t259) - qJ(3) * t133 - t242 * t123 - t245 * t124;
t294 = mrSges(3,2) * t243;
t219 = (-mrSges(3,1) * t246 + t294) * qJD(1);
t130 = m(3) * t195 + (qJDD(1) * mrSges(3,3) + qJD(1) * t219) * t246 + t133;
t136 = m(3) * t194 + ((-mrSges(3,3) - t272) * qJDD(1) + (-t219 + t265) * qJD(1)) * t243 + t259;
t274 = t246 * t130 - t243 * t136;
t270 = Ifges(3,5) * t243 + Ifges(3,6) * t246;
t132 = t242 * t138 + t245 * t142;
t266 = t199 * t245 + t200 * t242;
t214 = -qJDD(1) * pkin(1) + t260;
t220 = t270 * qJD(1);
...
t258 = -mrSges(2,2) * t227 + qJ(2) * t274 + t243 * t120 + t246 * t122 + pkin(1) * (-mrSges(3,2) * t282 + t256) + mrSges(2,1) * t226 + Ifges(2,3) * qJDD(1);
t128 = m(2) * t226 - t251 * mrSges(2,2) + (mrSges(2,1) - t294) * qJDD(1) + t256;
t127 = t243 * t130 + t246 * t136;
t125 = m(2) * t227 - t251 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t274;
t118 = mrSges(2,1) * g(3) + mrSges(2,3) * t227 + t251 * Ifges(2,5) - pkin(1) * t127 + (Ifges(2,6) - t270) * qJDD(1) + t296;
t117 = -mrSges(2,2) * g(3) - mrSges(2,3) * t226 + Ifges(2,5) * qJDD(1) - t251 * Ifges(2,6) - qJ(2) * t127 + t246 * t120 - t243 * t122;
t1 = [-mrSges(1,2) * g(3) + mrSges(1,3) * g(2) + t250 * t117 - t248 * t118 - pkin(5) * (t248 * t125 + t250 * t128), t117, t120, t123, t134, t149; mrSges(1,1) * g(3) - mrSges(1,3) * g(1) + t248 * t117 + t250 * t118 + pkin(5) * (t250 * t125 - t248 * t128), t118, t122, t124, t135, t148; -mrSges(1,1) * g(2) + mrSges(1,2) * g(1) + t258, t258, t270 * qJDD(1) - t296, -Ifges(4,3) * t281 + (t266 * qJD(1) + t269 * qJDD(1)) * t243 + t254, Ifges(5,3) * t275 - t252, t253;];
m_new = t1;
