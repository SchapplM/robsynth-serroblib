...
t39 = -t57 * t47 - t55 * t48;
t49 = V_base(4) + qJD(1);
t34 = -pkin(1) * t49 + qJD(2) - t39;
t41 = -t55 * V_base(5) + t57 * V_base(6);
t52 = sin(pkin(7));
t60 = cos(pkin(7));
t36 = t41 * t52 - t60 * t49;
t37 = t60 * t41 + t52 * t49;
t20 = pkin(2) * t36 - qJ(3) * t37 + t34;
t42 = t55 * V_base(6) + t57 * V_base(5);
...
t2 = t4 * t56 + t54 * t7;
t1 = -t4 * t54 + t56 * t7;
t8 = m(2) * (t38 ^ 2 + t39 ^ 2 + t58) / 0.2e1 + m(1) * (V_base(2) ^ 2 + V_base(3) ^ 2 + t58) / 0.2e1 + m(3) * (t26 ^ 2 + t27 ^ 2 + t34 ^ 2) / 0.2e1 + m(4) * (t13 ^ 2 + t14 ^ 2 + t21 ^ 2) / 0.2e1 + m(6) * (t1 ^ 2 + t2 ^ 2 + t3 ^ 2) / 0.2e1 + m(5) * (t5 ^ 2 + t6 ^ 2 + t9 ^ 2) / 0.2e1 + (V_base(2) * mrSges(1,1) - V_base(1) * mrSges(1,2) + Ifges(1,3) * V_base(6) / 0.2e1) * V_base(6) + (t39 * mrSges(2,1) - t38 * mrSges(2,2) + Ifges(2,3) * t49 / 0.2e1) * t49 + (t34 * mrSges(3,2) - t26 * mrSges(3,3) + Ifges(3,1) * t37 / 0.2e1) * t37 + (t21 * mrSges(4,2) - t13 * mrSges(4,3) + Ifges(4,1) * t29 / 0.2e1) * t29 + (t9 * mrSges(5,2) - t5 * mrSges(5,3) + Ifges(5,1) * t25 / 0.2e1) * t25 + (t1 * mrSges(6,1) - t2 * mrSges(6,2) + Ifges(6,3) * t23 / 0.2e1) * t23 + (-V_base(3) * mrSges(1,1) + V_base(1) * mrSges(1,3) + Ifges(1,6) * V_base(6) + Ifges(1,2) * V_base(5) / 0.2e1) * V_base(5) + (V_base(1) * mrSges(2,2) - t39 * mrSges(2,3) + Ifges(2,5) * t49 + Ifges(2,1) * t41 / 0.2e1) * t41 + (-t9 * mrSges(5,1) + t6 * mrSges(5,3) + Ifges(5,4) * t25 + Ifges(5,2) * t24 / 0.2e1) * t24 + (t3 * mrSges(6,2) - t1 * mrSges(6,3) + Ifges(6,5) * t23 + Ifges(6,1) * t16 / 0.2e1) * t16 + (V_base(3) * mrSges(1,2) - V_base(2) * mrSges(1,3) + Ifges(1,4) * V_base(5) + Ifges(1,5) * V_base(6) + Ifges(1,1) * V_base(4) / 0.2e1) * V_base(4) + (-t3 * mrSges(6,1) + t2 * mrSges(6,3) + Ifges(6,4) * t16 + Ifges(6,6) * t23 + Ifges(6,2) * t15 / 0.2e1) * t15 + (t34 * mrSges(3,1) + t13 * mrSges(4,1) - t14 * mrSges(4,2) - t27 * mrSges(3,3) - Ifges(3,4) * t37 + Ifges(4,5) * t29 + (Ifges(3,2) / 0.2e1 + Ifges(4,3) / 0.2e1) * t36) * t36 + (V_base(1) * mrSges(2,1) + t26 * mrSges(3,1) - t27 * mrSges(3,2) - t38 * mrSges(2,3) - Ifges(2,4) * t41 + Ifges(3,5) * t37 - Ifges(2,6) * t49 - Ifges(3,6) * t36 + (Ifges(2,2) / 0.2e1 + Ifges(3,3) / 0.2e1) * t42) * t42 + (t21 * mrSges(4,1) + t5 * mrSges(5,1) - t6 * mrSges(5,2) - t14 * mrSges(4,3) - Ifges(4,4) * t29 + Ifges(5,5) * t25 - Ifges(4,6) * t36 + Ifges(5,6) * t24 + (Ifges(4,2) / 0.2e1 + Ifges(5,3) / 0.2e1) * t28) * t28;
T = t8;
