...
elseif link_index == 4
	...
	% Computational Cost: add. (34->20), mult. (73->27), div. (0->0), fcn. (97->8), ass. (0->16)
	t10 = cos(pkin(7));
	t11 = sin(qJ(1));
	t17 = t10 * t11;
	t12 = cos(qJ(1));
	...
	t5 = sin(pkin(9));
	t8 = cos(pkin(9));
	t14 = r_i_i_C(1) * t8 - r_i_i_C(2) * t5 + pkin(3);
	t7 = sin(pkin(7));
	t13 = -t10 * pkin(2) - pkin(1) + (-r_i_i_C(1) * t5 - r_i_i_C(2) * t8 - qJ(3)) * t7;
	t9 = cos(pkin(8));
	t6 = sin(pkin(8));
	t3 = -t11 * t9 + t6 * t16;
	t1 = t12 * t9 + t6 * t17;
	t2 = [0, 0, -t10, t7 * t6, 0; -t11 * qJ(2) + t15 * t3 + t14 * (-t11 * t6 - t9 * t16) + t13 * t12, t12, -t11 * t7, -t1, 0; t12 * qJ(2) + t15 * t1 + t14 * (t12 * t6 - t9 * t17) + t13 * t11, t11, t12 * t7, t3, 0;];
	Ja_transl = t2;
elseif link_index == 5
	%% Symbolic Calculation
	...
	% Computational Cost: add. (79->38), mult. (189->59), div. (0->0), fcn. (251->10), ass. (0->30)
	t15 = sin(pkin(8));
	t18 = cos(pkin(8));
	t21 = sin(qJ(1));
	t26 = t21 * t18;
