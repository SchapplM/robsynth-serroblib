...
% Computational Cost: add. (8467->362), mult. (24370->545), div. (0->0), fcn. (17131->10), ass. (0->212)
t152 = sin(pkin(9));
t153 = sin(pkin(8));
t154 = sin(pkin(7));
t208 = t154 * qJDD(1);
...
t159 = sin(qJ(1));
t161 = cos(qJ(1));
t179 = t161 * g(1) + t159 * g(2);
t168 = -t162 * pkin(1) + qJDD(1) * qJ(2) - t179;
t240 = 2 * qJD(2);
t245 = qJD(1) * t240 + t168;
t181 = t123 * t195;
t244 = t242 - t181;
t216 = t157 * t162;
t178 = t159 * g(1) - t161 * g(2);
t215 = t162 * qJ(2);
t170 = qJDD(2) - t178 - t215;
t227 = qJDD(1) * pkin(1);
t126 = -t170 + t227;
...
t187 = qJDD(3) + t236;
t165 = ((-pkin(1) + (-pkin(3) * t156 - qJ(4) * t153) * t157) * t162 + (qJ(2) + t176) * qJDD(1) + t167 - t179) * t154 + t187;
t194 = qJD(3) * t213;
...
t189 = t154 * (t245 * t154 + t236) + t157 * t180;
t183 = t153 * t198;
t182 = t121 * t195;
