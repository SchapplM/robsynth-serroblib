...
t4 = -t8 * qJD(5) - t103 * t26 + t104 * t74;
t3 = t7 * qJD(5) + t103 * t74 + t104 * t26;
t15 = [t65 * mrSges(5,2) * t73 + t152 * (Ifges(6,5) * t40 - Ifges(6,6) * t41) / 0.2e1 + (t65 * mrSges(4,1) + t66 * mrSges(4,2)) * t102 + t75 * t78 + t23 * (-mrSges(6,1) * t47 + mrSges(6,2) * t48) + t40 * t10 / 0.2e1 - t41 * t9 / 0.2e1 + t26 * t43 + t19 * t14 + t3 * t21 + t4 * t22 + 0.2e1 * m(3) * (t96 * t117 + t91) + ((-t23 * mrSges(5,1) - t24 * mrSges(5,2)) * t98 + 0.2e1 * qJD(2) * t69 + t110 * mrSges(4,3)) * t99 + 0.2e1 * t138 * mrSges(3,3) * t124 - (t8 * mrSges(6,3) + Ifges(6,4) * t48 + Ifges(6,2) * t47 + Ifges(6,6) * t147) * t34 + (-t7 * mrSges(6,3) + Ifges(6,1) * t48 + Ifges(6,4) * t47 + Ifges(6,5) * t147) * t33 + (t30 / 0.2e1 - t29 / 0.2e1 + t65 * mrSges(5,1) + t114) * t72 + m(5) * (-t23 * t111 + t65 * t115 + t24 * t140 - t16 * t25 + t17 * t26 + t31 * t74) + t141 * t74 + t142 * t25 + m(4) * (qJD(2) * t145 - t65 * t116 + t66 * t139 - t45 * t74 + t46 * t75 + t91) + m(6) * (t1 * t8 + t12 * t25 + t19 * t23 + t2 * t7 + t3 * t6 + t4 * t5) + (t1 * t47 - t2 * t48 - t5 * t40 - t6 * t41) * mrSges(6,3) + t36 * (Ifges(6,4) * t40 - Ifges(6,2) * t41) / 0.2e1 + t12 * (mrSges(6,1) * t41 + mrSges(6,2) * t40) + (Ifges(6,1) * t40 - Ifges(6,4) * t41) * t148 + (t23 * t73 - t24 * t72) * mrSges(5,3); t14 * t144 - t64 * t43 - t142 * t62 + t151 * t22 + t150 * t21 + (t108 * t33 - t34 * t77) * mrSges(6,3) + (t1 * t77 - t108 * t2 - t12 * t62 + t23 * t144 + t150 * t6 + t151 * t5) * m(6) - m(4) * t110 + (-t132 + (t100 * t24 + t23 * t97) * t98 + t16 * t62 - t17 * t64) * m(5) + (-t99 * t69 + (-t101 * t78 - t141 * t98) * t102 + (-t46 * t128 + t45 * t136 - t145) * m(4) - m(5) * t31 * t136 + (-m(3) * qJ(2) - mrSges(3,3)) * t138 * qJD(1)) * qJD(1); -t100 * t14 + t54 * t21 - t53 * t22 + ((-t103 * t21 - t104 * t22) * qJD(5) + (t103 * t33 - t104 * t34) * mrSges(6,3)) * t97 + m(5) * (t24 * t97 - t133) + (-t141 * t101 + (t100 * t43 + t142 * t97 + t78) * t98 - m(5) * (-t100 * t17 * t98 + t101 * t31 + t16 * t144) + (t101 * t45 + t46 * t98 + qJD(2)) * m(4)) * t130 + (-t133 + (t1 * t104 - t103 * t2 + (-t103 * t6 - t104 * t5) * qJD(5)) * t97 - t5 * t53 + t6 * t54 + t12 * t144 * t130) * m(6); t61 * t43 - t142 * t63 + (-t33 * mrSges(6,3) + t152 * t21) * t104 + (-t34 * mrSges(6,3) - t152 * t22) * t103 + (t1 * t103 + t2 * t104 - t12 * t63 + t152 * (-t103 * t5 + t104 * t6)) * m(6) + (t16 * t63 + t17 * t61 + t65) * m(5); t30 - t29 - t12 * (mrSges(6,1) * t38 + mrSges(6,2) * t36) - t38 * (Ifges(6,1) * t36 - t146) / 0.2e1 + t9 * t148 - t152 * (Ifges(6,5) * t36 - Ifges(6,6) * t38) / 0.2e1 - t5 * t21 + t6 * t22 + (t36 * t5 + t38 * t6) * mrSges(6,3) + t114 - (-Ifges(6,2) * t38 + t10 + t35) * t36 / 0.2e1;];
tauc = t15(:);
