...
t2 = m(2) * t91 + (-mrSges(2,2) + t114) * t78 + (mrSges(2,1) - t90) * qJDD(1) - t83;
t1 = m(2) * t94 - t78 * mrSges(2,1) - qJDD(1) * mrSges(2,2) + t73 * t4 - t70 * t6;
t3 = [(-m(1) - m(2)) * g(1) + t112, t1, t4, t7, t9, t12; -m(1) * g(2) - t75 * t1 - t77 * t2, t2, t6, t8, t10, t11; -m(1) * g(3) + t77 * t1 - t75 * t2, -m(2) * g(1) + t112, t90 * qJDD(1) - t78 * t114 + t83, (t86 * qJD(1) + t89 * qJDD(1)) * t70 + t82, t79, t80;];
f_new = t3;
